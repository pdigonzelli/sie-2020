     ...
     do:
        ...
        FOR EACH rb_items_tarja WHERE 
            ...
            DO:
               ...
               find first liq_conceptos where liq_conceptos.id_concepto = rb_items_tarja.codigo_hs_complementarias
                     no-lock no-error.
                if available liq_conceptos Then     
                    rb_tarja.nombre_concepto[j] = liq_conceptos.descripcion.
        ...
        FOR EACH rb_items_tarja WHERE 
            ...
            DO:
               ...
               find first liq_conceptos where liq_conceptos.id_concepto = rb_items_tarja.codigo_licencias
                     no-lock no-error.
                if available liq_conceptos Then     
                    rb_tarja.nombre_concepto[j] = liq_conceptos.descripcion.
