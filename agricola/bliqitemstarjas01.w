...
&Scoped-define FIELDS-IN-QUERY-br_table id_sucursal fecha id_empresa legajo ~
nombre id_tarea descripcion cant_horas cant_hs_norm ~
hs_adicionales_tareas_trabajadas id_lote desc-lote cantidad 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_sucursal COLUMN-LABEL "Suc" FORMAT ">>9":U
      fecha FORMAT "99/99/9999":U
      id_empresa FORMAT ">>>,>>9":U
      legajo FORMAT ">>>,>>9":U
      nombre FORMAT "x(30)":U
      id_tarea FORMAT ">>>,>>9":U
      descripcion FORMAT "X(60)":U WIDTH 30
      cant_horas FORMAT ">>9.99":U
      cant_hs_norm FORMAT "->>,>>9.99":U
      hs_adicionales_tareas_trabajadas COLUMN-LABEL "Hs AdicTT" FORMAT "->>,>>9.99":U
...
"id_sucursal" "Suc" ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.fecha
"fecha" ? ? "date" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = _<SDO>.rowObject.id_empresa
     _FldNameList[4]   > _<SDO>.rowObject.legajo
"legajo" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = _<SDO>.rowObject.nombre
     _FldNameList[6]   = _<SDO>.rowObject.id_tarea
     _FldNameList[7]   > _<SDO>.rowObject.descripcion
"descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > _<SDO>.rowObject.cant_horas
"cant_horas" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > _<SDO>.rowObject.cant_hs_norm
"cant_hs_norm" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > _<SDO>.rowObject.hs_adicionales_tareas_trabajadas
"hs_adicionales_tareas_trabajadas" "Hs AdicTT" ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > _<SDO>.rowObject.id_lote
"id_lote" "Cod" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   = _<SDO>.rowObject.desc-lote
