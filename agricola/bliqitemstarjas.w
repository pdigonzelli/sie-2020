...
rowObject.id_tarea rowObject.cant_hs_norm rowObject.cantidad ~
rowObject.id_unidad_liquidacion rowObject.id_lote rowObject.desc-lote 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.id_lote COLUMN-LABEL "Cod" FORMAT ">>>9":U
      rowObject.desc-lote FORMAT "x(15)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"rowObject.legajo" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[3]   = _<SDO>.rowObject.id_tarea
     _FldNameList[4]   > _<SDO>.rowObject.cant_hs_norm
...
"rowObject.cantidad" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > _<SDO>.rowObject.id_unidad_liquidacion
"rowObject.id_unidad_liquidacion" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > _<SDO>.rowObject.id_lote
"rowObject.id_lote" "Cod" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   = _<SDO>.rowObject.desc-lote
