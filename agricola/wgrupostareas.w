...
DEFINE VARIABLE h_bgrupostareas AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dgrupostareas AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vgrupostareas AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Grupos de tareas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Grupos de tareas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dgrupostareas ( 1.71 , 67.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'bgrupostareas.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_bgrupostareas ).
       RUN repositionObject IN h_bgrupostareas ( 1.95 , 6.00 ) NO-ERROR.
       RUN resizeObject IN h_bgrupostareas ( 6.67 , 66.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vgrupostareas.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vgrupostareas ).
       RUN repositionObject IN h_vgrupostareas ( 11.24 , 9.00 ) NO-ERROR.
       /* Size in AB:  ( 4.00 , 57.00 ) */
       ...
       RUN constructObject (
             ...
             OUTPUT h_dyntoolbar ).
       RUN repositionObject IN h_dyntoolbar ( 9.10 , 9.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 67.20 ) NO-ERROR.

       /* Links to SmartDataObject h_dgrupostareas. */
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dgrupostareas ).

       /* Links to SmartDataBrowser h_bgrupostareas. */
       RUN addLink ( h_dgrupostareas , 'Data':U , h_bgrupostareas ).

       /* Links to SmartDataViewer h_vgrupostareas. */
       RUN addLink ( h_dgrupostareas , 'Data':U , h_vgrupostareas ).
       RUN addLink ( h_vgrupostareas , 'Update':U , h_dgrupostareas ).
       RUN addLink ( h_dyntoolbar , 'Tableio':U , h_vgrupostareas ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_dyntoolbar ,
             h_bgrupostareas , 'AFTER':U ).
       RUN adjustTabOrder ( h_vgrupostareas ,
