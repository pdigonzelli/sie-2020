...
DEFINE FRAME fMain
     Btn_OK AT ROW 1.48 COL 79.2 WIDGET-ID 4
     FI-sector AT ROW 2.19 COL 21 COLON-ALIGNED WIDGET-ID 12
     nombre-sector AT ROW 2.19 COL 30 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     Btn_Cancel AT ROW 2.67 COL 79.2 WIDGET-ID 2
     FI-desde-fecha AT ROW 3.62 COL 21 COLON-ALIGNED WIDGET-ID 6
     FI-hasta-fecha AT ROW 4.81 COL 21 COLON-ALIGNED WIDGET-ID 8
     "  Filtros" VIEW-AS TEXT
          SIZE 70 BY .71 AT ROW 1 COL 5 WIDGET-ID 10
          BGCOLOR 1 FGCOLOR 15 
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 94.2 BY 5.62 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Resumen de Tarja x Fecha"
         HEIGHT             = 5.62
         WIDTH              = 94.2
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Resumen de Tarja x Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Resumen de Tarja x Fecha */
DO:
...
RB-MEMO-FILE = SESSION:TEMP-DIRECTORY + STRING(RANDOM(1,1000000)) + '.TXT'.
 ...
 RUN  aderb\_prntrb2(
       ...
       "resumen_fecha_tarea", /* RB-REPORT-NAME */
       "",                             /* RB-DB-CONNECTION */
