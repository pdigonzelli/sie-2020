...
&Scoped-define FIELDS-IN-QUERY-br_table fecha id_sucursal id_empresa ~
id_sector nro_planilla 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_sector COLUMN-LABEL "Sec" FORMAT ">>9":U
      nro_planilla FORMAT "->,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"fecha" ? ? "date" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = _<SDO>.rowObject.id_sucursal
     _FldNameList[3]   = _<SDO>.rowObject.id_empresa
     _FldNameList[4]   > _<SDO>.rowObject.id_sector
"id_sector" "Sec" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = _<SDO>.rowObject.nro_planilla
