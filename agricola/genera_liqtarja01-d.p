...
/***********************************************************************/   
/* El 29/01/08 se agrega la cant. de horas excedentes - cod ABACUS (952) */
/************************************************************************/
...
define var v_excedente as decimal.
              ...
              if items_control_tareas.cantidad <> 0 Then
               ...
               if last-of(items_control_tareas.fecha) Then
                  do:
                      ...
                      t-personal.cantidad = t-personal.cantidad + v_excedente.
                      v_excedente = 0.
                   end.
       end.          
end.      
