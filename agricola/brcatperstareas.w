...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_convenio ~
rowObject.id_categoria rowObject.desc-cat-legajo ~
rowObject.id_categoria_tarea rowObject.desc-cat-tarea ~
rowObject.id_codigo_abacus rowObject.desc-abacus rowObject.id_diferencial ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_convenio FORMAT "->,>>>,>>9":U
      rowObject.id_categoria FORMAT "->,>>>,>>9":U
      rowObject.desc-cat-legajo FORMAT "x(30)":U
      rowObject.id_categoria_tarea FORMAT ">>9":U
      rowObject.desc-cat-tarea FORMAT "x(20)":U
      rowObject.id_codigo_abacus FORMAT ">>9":U
      rowObject.desc-abacus FORMAT "X(30)":U
      rowObject.id_diferencial FORMAT ">>9":U
      rowObject.id_codigo_abacus_diferencial FORMAT ">>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_convenio
"rowObject.id_convenio" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = _<SDO>.rowObject.id_categoria
     _FldNameList[3]   = _<SDO>.rowObject.desc-cat-legajo
     _FldNameList[4]   = _<SDO>.rowObject.id_categoria_tarea
     _FldNameList[5]   = _<SDO>.rowObject.desc-cat-tarea
     _FldNameList[6]   = _<SDO>.rowObject.id_codigo_abacus
     _FldNameList[7]   = _<SDO>.rowObject.desc-abacus
     _FldNameList[8]   = _<SDO>.rowObject.id_diferencial
     _FldNameList[9]   = _<SDO>.rowObject.id_codigo_abacus_diferencial
