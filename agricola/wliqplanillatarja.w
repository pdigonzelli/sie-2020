...
Fi-sector T-sector FI-sucursal T-sucursal FI-desde-fecha FI-hasta-fecha ~
FI-impresora B-cambiar 
&Scoped-Define DISPLAYED-OBJECTS nombre-empresa fi-empresa T-empresa ~
nombre-sector Fi-sector T-sector FI-sucursal nombre-sucursal T-sucursal ~
FI-desde-fecha FI-hasta-fecha FI-impresora 
...
DEFINE FRAME fMain
     ...
     T-sector AT ROW 3.86 COL 75 WIDGET-ID 48
     ...
     T-sucursal AT ROW 5.29 COL 75 WIDGET-ID 50
     FI-desde-fecha AT ROW 7.19 COL 21 COLON-ALIGNED WIDGET-ID 6
     FI-hasta-fecha AT ROW 8.38 COL 21 COLON-ALIGNED WIDGET-ID 10
     FI-impresora AT ROW 9.81 COL 21 COLON-ALIGNED WIDGET-ID 34
     B-cambiar AT ROW 9.81 COL 83 WIDGET-ID 32
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 102.4 BY 10.67 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Planilla Tarja x Persona"
         HEIGHT             = 10.67
         WIDTH              = 102.4
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Planilla Tarja x Persona */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Planilla Tarja x Persona */
DO:
...
DO:
  ...
  define var v_titulo as character format "x(60)".
      ...
      v_filtro = "liq_items_tarjas.fecha >= date('" + fi-desde-fecha:screen-value  + "')" + 
      ...
      DO:
          v_filtro = v_filtro + " and liq_items_tarjas.id_sucursal = " + fi-sucursal:screen-value in frame {&frame-name}.   
      END.
...
DO:
    if t-empresa:screen-value = 'yes' Then
      ASSIGN  fi-empresa:SCREEN-VALUE = ""
...
DO:
    if t-sucursal:screen-value = 'yes' Then
       ASSIGN fi-sucursal:SCREEN-VALUE = ""
...
------------------------------------------------------------------------------*/
  DISPLAY nombre-empresa fi-empresa T-empresa nombre-sector Fi-sector T-sector 
          FI-sucursal nombre-sucursal T-sucursal FI-desde-fecha FI-hasta-fecha 
          FI-impresora 
      WITH FRAME fMain IN WINDOW wWin.
  ENABLE Btn_OK Btn_Cancel fi-empresa T-empresa Fi-sector T-sector FI-sucursal 
         T-sucursal FI-desde-fecha FI-hasta-fecha FI-impresora B-cambiar 
      WITH FRAME fMain IN WINDOW wWin.
