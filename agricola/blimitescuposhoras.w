...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_limite ~
rowObject.descripcion rowObject.valor 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_limite FORMAT "->>9":U
      rowObject.descripcion FORMAT "x(40)":U
      rowObject.valor FORMAT "->>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_limite
