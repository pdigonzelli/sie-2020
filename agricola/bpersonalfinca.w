...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_empresa_cosechera ~
rowObject.legajo rowObject.dni_cuil rowObject.nombre 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_empresa_cosechera FORMAT ">>>,>>9":U
      rowObject.legajo FORMAT ">>>,>>9":U
      rowObject.dni_cuil FORMAT "X(12)":U
      rowObject.nombre FORMAT "x(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_empresa_cosechera
"rowObject.id_empresa_cosechera" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = _<SDO>.rowObject.legajo
     _FldNameList[3]   = _<SDO>.rowObject.dni_cuil
