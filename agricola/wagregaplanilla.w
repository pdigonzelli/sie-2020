...
DEFINE FRAME fMain
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1.14
         SIZE 106.4 BY 8.52 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Modifica LEGAJOS en PLANILLAS"
         HEIGHT             = 8.81
         WIDTH              = 106.8
         MAX-HEIGHT         = 29.33
         MAX-WIDTH          = 217.6
...
ON END-ERROR OF wWin /* Modifica LEGAJOS en PLANILLAS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Modifica LEGAJOS en PLANILLAS */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dcontroltareas ( 1.00 , 94.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN repositionObject IN h_ditemscontroltareasextras ( 1.00 , 84.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN repositionObject IN h_vitemscontroltareasextras ( 3.86 , 5.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dyntoolbar-1 ( 1.48 , 9.00 ) NO-ERROR.
