...
DEFINE FRAME fMain
     ...
     RADIO-SET-1 AT ROW 4.33 COL 57 NO-LABEL WIDGET-ID 16
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 98.8 BY 7.52 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Comparativo Periodo Actual vs Periodo Anterior"
         HEIGHT             = 7.52
         WIDTH              = 98.8
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Comparativo Periodo Actual vs Periodo Anterior */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Comparativo Periodo Actual vs Periodo Anterior */
DO:
...
run p_genera_comp-01.p (input v_reporte, 
                        input v_sector,
                        input v_desde_fecha, 
                        input v_hasta_fecha).
    ...
    RUN  aderb\_prntrb2(
      (if index(propath,"supervisor.pl") > 0 then vlc_dir_objetos else vlc_dir_fuentes) +  "agricola~\agricola.prl", /* RB-REPORT-LIBRARY */
       ...
       "",                              /* RB-OUTPUT-FILE */
        ...
        0,                              /* RB-END-PAGE - zero */
       no,                              /* RB-TEST-PATTERN */
       "Resumen Propias y de Terceros (Zona-Finca-Tarea)",   /* RB-WINDOW-TITLE */
       yes,                           /* RB-DISPLAY-ERRORS */
       yes,                           /* RB-DISPLAY-STATUS */
       no,                              /* RB-NO-WAIT */
       "v_general = " + fi-desde-fecha:screen-value + ";" + fi-hasta-fecha:screen-value + ";" +
       string(v_desde_anterior) + ";" + string(v_hasta_anterior) + ";" + v_desc_sector + ";" +
       radio-set-1:SCREEN-VALUE IN FRAME {&FRAME-NAME} + ";"
       /* RB-OTHER-PARAMETERS */,
       ""
       ).   
...
disconnect value("repagri") no-error.
