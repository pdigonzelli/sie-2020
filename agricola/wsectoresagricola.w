...
DEFINE VARIABLE h_bsectoresagricola AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dsectoresagricola AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vsectoresagricola AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Sectores Agricola */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Sectores Agricola */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dsectoresagricola ( 1.48 , 70.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'bsectoresagricola.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_bsectoresagricola ).
       RUN repositionObject IN h_bsectoresagricola ( 2.43 , 7.00 ) NO-ERROR.
       RUN resizeObject IN h_bsectoresagricola ( 6.67 , 66.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vsectoresagricola.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vsectoresagricola ).
       RUN repositionObject IN h_vsectoresagricola ( 12.43 , 12.00 ) NO-ERROR.
       /* Size in AB:  ( 3.00 , 51.00 ) */
       ...
       RUN constructObject (
             ...
             OUTPUT h_dyntoolbar ).
       RUN repositionObject IN h_dyntoolbar ( 9.81 , 8.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 67.20 ) NO-ERROR.

       /* Links to SmartDataObject h_dsectoresagricola. */
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dsectoresagricola ).

       /* Links to SmartDataBrowser h_bsectoresagricola. */
       RUN addLink ( h_dsectoresagricola , 'Data':U , h_bsectoresagricola ).

       /* Links to SmartDataViewer h_vsectoresagricola. */
       RUN addLink ( h_dsectoresagricola , 'Data':U , h_vsectoresagricola ).
       RUN addLink ( h_vsectoresagricola , 'Update':U , h_dsectoresagricola ).
       RUN addLink ( h_dyntoolbar , 'Tableio':U , h_vsectoresagricola ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_dyntoolbar ,
             h_bsectoresagricola , 'AFTER':U ).
       RUN adjustTabOrder ( h_vsectoresagricola ,
