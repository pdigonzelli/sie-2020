...
&Scoped-define FIELDS-IN-QUERY-br_table id_planilla_adicional item ~
codigo_trazabilidad id_lote desc-lote cantidad fecha_inicio fecha_fin ~
id_dosis-1 id_dosis-2 id_dosis-3 id_dosis-4 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_planilla_adicional FORMAT "->,>>>,>>9":U
      item FORMAT ">>9":U
      codigo_trazabilidad FORMAT "X(5)":U
      id_lote FORMAT ">>>9":U
      desc-lote FORMAT "x(15)":U WIDTH 35.2
      cantidad FORMAT "->>,>>9.99":U
      fecha_inicio FORMAT "99/99/9999":U
      fecha_fin FORMAT "99/99/9999":U
      id_dosis-1 FORMAT ">>9":U
      id_dosis-2 FORMAT ">>9":U
      id_dosis-3 FORMAT ">>9":U
      id_dosis-4 FORMAT ">>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 91 BY 6.67 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_planilla_adicional
"id_planilla_adicional" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = _<SDO>.rowObject.item
     _FldNameList[3]   = _<SDO>.rowObject.codigo_trazabilidad
     _FldNameList[4]   = _<SDO>.rowObject.id_lote
     _FldNameList[5]   > _<SDO>.rowObject.desc-lote
"desc-lote" ? ? "character" ? ? ? ? ? ? no ? no no "35.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = _<SDO>.rowObject.cantidad
     _FldNameList[7]   = _<SDO>.rowObject.fecha_inicio
     _FldNameList[8]   = _<SDO>.rowObject.fecha_fin
     _FldNameList[9]   = _<SDO>.rowObject.id_dosis-1
     _FldNameList[10]   = _<SDO>.rowObject.id_dosis-2
     _FldNameList[11]   = _<SDO>.rowObject.id_dosis-3
     _FldNameList[12]   = _<SDO>.rowObject.id_dosis-4
