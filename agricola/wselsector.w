...
&Scoped-Define ENABLED-OBJECTS RECT-19 Btn_OK B-cancel FI-sector ~
FI-sucursal 
...
DEFINE FRAME fMain
     ...
     FI-sector AT ROW 3.62 COL 11 COLON-ALIGNED WIDGET-ID 6
     nombre-sector AT ROW 3.62 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     FI-sucursal AT ROW 5.29 COL 11 COLON-ALIGNED WIDGET-ID 8
     nombre-sucursal AT ROW 5.29 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     "Selecci¢n" VIEW-AS TEXT
          SIZE 54 BY .95 AT ROW 1.71 COL 4 WIDGET-ID 16
          BGCOLOR 1 FGCOLOR 15 
     RECT-19 AT ROW 1.24 COL 2 WIDGET-ID 14
...
v_sucursal = integer(fi-sucursal:screen-value in frame {&FRAME-NAME}).
  ...
  run wcontroltareas.w (input integer(fi-sector:screen-value in frame {&FRAME-NAME}),
                        input integer(fi-sucursal:screen-value in frame {&FRAME-NAME})).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY FI-sector nombre-sector FI-sucursal nombre-sucursal 
      WITH FRAME fMain IN WINDOW wWin.
  ENABLE RECT-19 Btn_OK B-cancel FI-sector FI-sucursal 
      WITH FRAME fMain IN WINDOW wWin.
