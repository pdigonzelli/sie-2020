...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_empresa_liq ~
rowObject.legajo rowObject.apellido_nombre rowObject.cuil ~
rowObject.tipo_liquidacion rowObject.liquida 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_empresa_liq FORMAT "->,>>>,>>9":U
      rowObject.legajo FORMAT "->,>>>,>>9":U
      rowObject.apellido_nombre FORMAT "x(30)":U
      rowObject.cuil FORMAT "x(15)":U
      rowObject.tipo_liquidacion FORMAT "x(1)":U
      rowObject.liquida FORMAT "si/no":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_empresa_liq
     _FldNameList[2]   = _<SDO>.rowObject.legajo
     _FldNameList[3]   = _<SDO>.rowObject.apellido_nombre
     _FldNameList[4]   = _<SDO>.rowObject.cuil
     _FldNameList[5]   = _<SDO>.rowObject.tipo_liquidacion
     _FldNameList[6]   = _<SDO>.rowObject.liquida
