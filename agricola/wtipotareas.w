...
DEFINE VARIABLE h_btipotareas AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dtipotareas AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vtipotareas AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Tipos de tareas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Tipos de tareas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dtipotareas ( 2.67 , 70.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'btipotareas.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_btipotareas ).
       RUN repositionObject IN h_btipotareas ( 2.67 , 6.00 ) NO-ERROR.
       RUN resizeObject IN h_btipotareas ( 6.67 , 66.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vtipotareas.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vtipotareas ).
       RUN repositionObject IN h_vtipotareas ( 12.67 , 14.00 ) NO-ERROR.
       /* Size in AB:  ( 2.00 , 47.00 ) */
       ...
       RUN constructObject (
             ...
             OUTPUT h_dyntoolbar ).
       RUN repositionObject IN h_dyntoolbar ( 10.29 , 7.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 67.20 ) NO-ERROR.

       /* Links to SmartDataObject h_dtipotareas. */
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dtipotareas ).

       /* Links to SmartDataBrowser h_btipotareas. */
       RUN addLink ( h_dtipotareas , 'Data':U , h_btipotareas ).

       /* Links to SmartDataViewer h_vtipotareas. */
       RUN addLink ( h_dtipotareas , 'Data':U , h_vtipotareas ).
       RUN addLink ( h_vtipotareas , 'Update':U , h_dtipotareas ).
       RUN addLink ( h_dyntoolbar , 'Tableio':U , h_vtipotareas ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_dyntoolbar ,
             h_btipotareas , 'AFTER':U ).
       RUN adjustTabOrder ( h_vtipotareas ,
