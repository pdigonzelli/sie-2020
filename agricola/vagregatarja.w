...
&Scoped-Define ENABLED-FIELDS RowObject.legajo 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define DISPLAYED-FIELDS RowObject.nombre RowObject.legajo 
...
DEFINE FRAME F-Main
     RowObject.nombre AT ROW 1.95 COL 25 COLON-ALIGNED NO-LABEL WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 52 BY 1
     RowObject.legajo AT ROW 2 COL 11 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
...
DO:
   ...
   run wsellegajos.w (INPUT v-empresa,
                      OUTPUT v-legajo).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
FIND FIRST liq_legajos WHERE liq_legajos.id_empresa_liq = v-empresa
...
RUN devuelve-empresa IN hContainer (OUTPUT v-empresa) NO-ERROR.
