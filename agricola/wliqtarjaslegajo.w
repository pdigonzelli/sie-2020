...
&Scoped-Define ENABLED-OBJECTS T-sucursal Fi-tipo-liq fi-empresa ~
FI-sucursal Fi-sector FI-desde-fecha FI-hasta-fecha Btn_OK Btn_Cancel ~
T-todos T-fincas FI-impresora B-cambiar T-sector T-tipo 
&Scoped-Define DISPLAYED-OBJECTS T-sucursal Fi-tipo-liq fi-empresa ~
...
FI-id_proveedor nombre-finca T-fincas FI-impresora T-sector T-tipo 
...
DEFINE FRAME fMain
     T-sucursal AT ROW 4.1 COL 88 WIDGET-ID 50
     ...
     Btn_OK AT ROW 1.24 COL 101 WIDGET-ID 6
     Btn_Cancel AT ROW 2.43 COL 101 WIDGET-ID 4
     ...
     T-sector AT ROW 5.29 COL 88 WIDGET-ID 48
     T-tipo AT ROW 9.57 COL 85 WIDGET-ID 52
...
DO:
 ...
 v_legajo = INTEGER(fi-legajo:SCREEN-VALUE IN FRAME {&FRAME-NAME}).
             ...
             IF v_legajo = 0 THEN
             DO:
                 run p_liq_imprime_tarja.p ( INPUT v_empresa, INPUT v_sector,
                                         INPUT v_sucursal,
                                         INPUT v_fecha_desde,
                                         INPUT v_fecha_hasta,
                                         INPUT v_finca,
             ...
             ELSE
             DO:
                 run p_liq_imprime_tarja_legajo.p ( INPUT v_empresa, INPUT v_sector,
                                             INPUT v_sucursal,
                                             INPUT v_fecha_desde,
                                             INPUT v_fecha_hasta,
                                             INPUT v_finca,
...
------------------------------------------------------------------------------*/
  DISPLAY T-sucursal Fi-tipo-liq fi-empresa nombre-empresa FI-sucursal 
          ...
          FI-impresora T-sector T-tipo 
      WITH FRAME fMain IN WINDOW wWin.
  ENABLE T-sucursal Fi-tipo-liq fi-empresa FI-sucursal Fi-sector FI-desde-fecha 
         FI-hasta-fecha Btn_OK Btn_Cancel T-todos T-fincas FI-impresora 
         B-cambiar T-sector T-tipo 
      WITH FRAME fMain IN WINDOW wWin.
