...
DEFINE VARIABLE h_bunidadesliquidacion AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dunidadesliquidacion AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vunidadesliquidacion AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Unidades de Liquidacion */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Unidades de Liquidacion */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN constructObject (
             INPUT  'bunidadesliquidacion.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_bunidadesliquidacion ).
       RUN repositionObject IN h_bunidadesliquidacion ( 1.48 , 13.00 ) NO-ERROR.
       RUN resizeObject IN h_bunidadesliquidacion ( 6.67 , 66.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vunidadesliquidacion.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vunidadesliquidacion ).
       RUN repositionObject IN h_vunidadesliquidacion ( 11.00 , 6.00 ) NO-ERROR.
       /* Size in AB:  ( 5.05 , 85.00 ) */
       ...
       RUN constructObject (
             ...
             OUTPUT h_dyntoolbar ).
       RUN repositionObject IN h_dyntoolbar ( 8.86 , 9.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 67.20 ) NO-ERROR.

       /* Links to SmartDataObject h_dunidadesliquidacion. */
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dunidadesliquidacion ).

       /* Links to SmartDataBrowser h_bunidadesliquidacion. */
       RUN addLink ( h_dunidadesliquidacion , 'Data':U , h_bunidadesliquidacion ).

       /* Links to SmartDataViewer h_vunidadesliquidacion. */
       RUN addLink ( h_dunidadesliquidacion , 'Data':U , h_vunidadesliquidacion ).
       RUN addLink ( h_vunidadesliquidacion , 'Update':U , h_dunidadesliquidacion ).
       RUN addLink ( h_dyntoolbar , 'Tableio':U , h_vunidadesliquidacion ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_dyntoolbar ,
             h_bunidadesliquidacion , 'AFTER':U ).
       RUN adjustTabOrder ( h_vunidadesliquidacion ,
