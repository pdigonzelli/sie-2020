...
DEFINE VAR v_legajo LIKE liq_items_control_tareas.legajo.
      ...
      ,each liq_items_control_tareas of liq_control_tareas no-lock,
       ...
       by liq_items_control_tareas.id_empresa by legajo by liq_items_control_tareas.fecha:
        ...
        do:
          ...
          find first centros_costos_abacus where centros_costos_abacus.id_proveedor = liq_control_tareas.id_proveedor and
          centros_costos_abacus.id_origen = liq_control_tareas.id_origen and
          centros_costos_abacus.tipo_liquidacion = liq_legajos.tipo_liquidacion no-lock no-error.
          if available centros_costos_abacus Then
            v_finca = centros_costos_abacus.id_centro_abacus.
           Else
            v_finca = liq_legajos.id_centro_costo.
