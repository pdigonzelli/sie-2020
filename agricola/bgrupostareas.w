...
&Scoped-define FIELDS-IN-QUERY-br_table id_grupo_tarea abreviatura ~
descripcion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_grupo_tarea FORMAT ">>>,>>9":U
      abreviatura FORMAT "X(6)":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_grupo_tarea
