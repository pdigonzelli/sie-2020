...
&Scoped-define FIELDS-IN-QUERY-br_table id_planilla_adicional fecha ~
id_proveedor id_origen desc-finca id_tarea id_tipo_tratamiento 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_proveedor FORMAT ">>,>>9":U
      id_origen FORMAT ">,>>9":U
      desc-finca FORMAT "x(15)":U WIDTH 25
      id_tarea FORMAT ">>>,>>9":U
      id_tipo_tratamiento FORMAT ">>9":U WIDTH 2.8
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 77 BY 6.67 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = _<SDO>.rowObject.id_proveedor
     _FldNameList[4]   = _<SDO>.rowObject.id_origen
     _FldNameList[5]   > _<SDO>.rowObject.desc-finca
"desc-finca" ? ? "character" ? ? ? ? ? ? no ? no no "25" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = _<SDO>.rowObject.id_tarea
     _FldNameList[7]   > _<SDO>.rowObject.id_tipo_tratamiento
"id_tipo_tratamiento" ? ? "integer" ? ? ? ? ? ? no ? no no "2.8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
