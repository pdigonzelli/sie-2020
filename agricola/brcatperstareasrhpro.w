...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_cconvenio_liq ~
rowObject.id_ccategoria_liq rowObject.desc-categoria ~
rowObject.id_categoria_tarea rowObject.des-cat-tareas ~
rowObject.id_codigo_rhpro rowObject.desc-concepto rowObject.id_diferencial ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_cconvenio_liq FORMAT "->,>>>,>>9":U
      rowObject.id_ccategoria_liq FORMAT "->,>>>,>>9":U
      rowObject.desc-categoria FORMAT "x(30)":U
      rowObject.id_categoria_tarea FORMAT ">>9":U
      rowObject.des-cat-tareas FORMAT "x(20)":U
      rowObject.id_codigo_rhpro FORMAT ">>>>>>9":U
      rowObject.desc-concepto FORMAT "X(30)":U
      rowObject.id_diferencial FORMAT ">>9":U
      rowObject.id_codigo_rhpro_diferencial FORMAT ">>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_cconvenio_liq
"rowObject.id_cconvenio_liq" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.id_ccategoria_liq
"rowObject.id_ccategoria_liq" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.desc-categoria
"rowObject.desc-categoria" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > _<SDO>.rowObject.id_categoria_tarea
"rowObject.id_categoria_tarea" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > _<SDO>.rowObject.des-cat-tareas
"rowObject.des-cat-tareas" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = _<SDO>.rowObject.id_codigo_rhpro
     _FldNameList[7]   = _<SDO>.rowObject.desc-concepto
     _FldNameList[8]   = _<SDO>.rowObject.id_diferencial
     _FldNameList[9]   = _<SDO>.rowObject.id_codigo_rhpro_diferencial
