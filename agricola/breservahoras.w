...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_reserva ~
rowObject.id_empresa rowObject.id_sector rowObject.id_sucursal ~
rowObject.fecha rowObject.legajo rowObject.cant_horas 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_reserva
     _FldNameList[2]   = _<SDO>.rowObject.id_empresa
     _FldNameList[3]   = _<SDO>.rowObject.id_sector
     _FldNameList[4]   = _<SDO>.rowObject.id_sucursal
     _FldNameList[5]   = _<SDO>.rowObject.fecha
     _FldNameList[6]   = _<SDO>.rowObject.legajo
     _FldNameList[7]   = _<SDO>.rowObject.cant_horas
