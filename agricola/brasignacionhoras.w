...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_tipo_asignacion ~
rowObject.descripcion rowObject.horas_trabajadas rowObject.hs_norm ~
rowObject.hs_asig 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_tipo_asignacion FORMAT "->,>>>,>>9":U
      rowObject.descripcion FORMAT "x(40)":U
      rowObject.horas_trabajadas FORMAT "->>,>>9.99":U
      rowObject.hs_norm FORMAT "->>,>>9.99":U
      rowObject.hs_asig FORMAT "->>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "drasignacionhoras.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_tipo_asignacion
     _FldNameList[2]   = _<SDO>.rowObject.descripcion
     _FldNameList[3]   = _<SDO>.rowObject.horas_trabajadas
     _FldNameList[4]   = _<SDO>.rowObject.hs_norm
     _FldNameList[5]   = _<SDO>.rowObject.hs_asig
