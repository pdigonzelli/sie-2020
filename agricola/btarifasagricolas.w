...
&Scoped-define FIELDS-IN-QUERY-br_table fecha id_empresa razon_social ~
id_tarea tareas-abreviatura id_unidad_liquidacion abreviatura precio 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      razon_social FORMAT "x(40)":U
      id_tarea FORMAT ">>>,>>9":U
      tareas-abreviatura FORMAT "X(12)":U
...
"fecha" ? ? "date" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[3]   = _<SDO>.rowObject.razon_social
     _FldNameList[4]   = _<SDO>.rowObject.id_tarea
     _FldNameList[5]   = _<SDO>.rowObject.tareas-abreviatura
...
"abreviatura" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   = _<SDO>.rowObject.precio
