...
&Scoped-define FIELDS-IN-QUERY-br_table id_tarea_liviana id_empresa legajo ~
apellido_nombre fecha_desde fecha_hasta 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_tarea_liviana FORMAT "->,>>>,>>9":U
      id_empresa FORMAT ">>>,>>9":U
      legajo FORMAT ">>>,>>9":U
      apellido_nombre FORMAT "x(30)":U
      fecha_desde FORMAT "99/99/99":U
      fecha_hasta FORMAT "99/99/99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_tarea_liviana
     _FldNameList[2]   = _<SDO>.rowObject.id_empresa
     _FldNameList[3]   = _<SDO>.rowObject.legajo
     _FldNameList[4]   = _<SDO>.rowObject.apellido_nombre
     _FldNameList[5]   = _<SDO>.rowObject.fecha_desde
     _FldNameList[6]   = _<SDO>.rowObject.fecha_hasta
