...
DEFINE FRAME fMain
     ...
     FI-sucursal AT ROW 3.38 COL 12 COLON-ALIGNED WIDGET-ID 8
     nombre-sucursal AT ROW 3.38 COL 23 COLON-ALIGNED NO-LABEL WIDGET-ID 12
...
ON END-ERROR OF wWin /* Tratamientos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Tratamientos */
DO:
...
v_sucursal = integer(fi-sucursal:screen-value in frame {&FRAME-NAME}).
 ...
 run wplanillasadictareas.w (input integer(fi-sucursal:screen-value in frame {&FRAME-NAME})).
