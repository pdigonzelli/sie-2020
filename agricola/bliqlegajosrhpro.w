...
&Scoped-define FIELDS-IN-QUERY-br_table id_empresa_liq legajo_rhpro ~
apellido_nombre cuil liquida 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_empresa_liq FORMAT "->,>>>,>>9":U
      legajo_rhpro FORMAT ">>>>>>>>9":U
      apellido_nombre FORMAT "x(30)":U
      cuil FORMAT "x(15)":U
      liquida FORMAT "si/no":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"id_empresa_liq" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = _<SDO>.rowObject.legajo_rhpro
     _FldNameList[3]   = _<SDO>.rowObject.apellido_nombre
     _FldNameList[4]   = _<SDO>.rowObject.cuil
     _FldNameList[5]   = _<SDO>.rowObject.liquida
