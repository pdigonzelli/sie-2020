...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Comparativo Periodo Actual vs Periodo Anterior Tarea-Finca"
         HEIGHT             = 7.48
         WIDTH              = 98.8
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Comparativo Periodo Actual vs Periodo Anterior Tarea-Finca */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Comparativo Periodo Actual vs Periodo Anterior Tarea-Finca */
DO:
