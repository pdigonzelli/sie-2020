...
&Scoped-define FIELDS-IN-QUERY-br_table id_tarea abreviatura descripcion ~
id_unidad_liquidacion descripcion-2 id_concepto 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      descripcion FORMAT "X(60)":U WIDTH 24.2
      id_unidad_liquidacion FORMAT ">>>,>>9":U
      descripcion-2 FORMAT "X(60)":U WIDTH 36
      id_concepto FORMAT ">,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_tarea
...
"descripcion" ? ? "character" ? ? ? ? ? ? no "?" no no "24.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = _<SDO>.rowObject.id_unidad_liquidacion
     _FldNameList[5]   > _<SDO>.rowObject.descripcion-2
"descripcion-2" ? ? "character" ? ? ? ? ? ? no ? no no "36" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = _<SDO>.rowObject.id_concepto
