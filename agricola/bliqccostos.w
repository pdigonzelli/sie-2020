...
&Scoped-define FIELDS-IN-QUERY-br_table id_centro_costo_liq descripcion ~
id_origen id_proveedor descripcion-2 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_centro_costo_liq
     _FldNameList[2]   = _<SDO>.rowObject.descripcion
     _FldNameList[3]   = _<SDO>.rowObject.id_origen
     _FldNameList[4]   = _<SDO>.rowObject.id_proveedor
