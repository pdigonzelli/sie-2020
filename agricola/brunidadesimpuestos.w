...
&Scoped-define FIELDS-IN-QUERY-br_table id_unidad_liquidacion abreviatura ~
id_sector id_impuesto id_tipo_impuesto descripcion porcentaje 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_sector FORMAT "->,>>>,>>9":U
      id_impuesto FORMAT ">>9":U
      id_tipo_impuesto FORMAT ">>9":U
      descripcion FORMAT "X(20)":U
      porcentaje FORMAT ">>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_unidad_liquidacion
     _FldNameList[2]   > _<SDO>.rowObject.abreviatura
"abreviatura" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = _<SDO>.rowObject.id_sector
     _FldNameList[4]   = _<SDO>.rowObject.id_impuesto
     _FldNameList[5]   = _<SDO>.rowObject.id_tipo_impuesto
     _FldNameList[6]   > _<SDO>.rowObject.descripcion
"descripcion" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   = _<SDO>.rowObject.porcentaje
