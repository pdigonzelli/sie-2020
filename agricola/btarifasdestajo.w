...
&Scoped-define FIELDS-IN-QUERY-br_table id_empresa nombre id_proveedor ~
id_origen desc-origen id_lote fecha id_tarea desc-tarea precio 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      nombre FORMAT "x(30)":U WIDTH 20
      id_proveedor FORMAT ">>,>>9":U
      id_origen FORMAT ">,>>9":U
      desc-origen FORMAT "x(30)":U
      id_lote FORMAT ">>>9":U
      fecha FORMAT "99/99/9999":U
      id_tarea FORMAT ">>>,>>9":U
      desc-tarea FORMAT "X(60)":U
      precio FORMAT "->>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_empresa
"id_empresa" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.nombre
"nombre" ? ? "character" ? ? ? ? ? ? no ? no no "20" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = _<SDO>.rowObject.id_proveedor
     _FldNameList[4]   = _<SDO>.rowObject.id_origen
     _FldNameList[5]   = _<SDO>.rowObject.desc-origen
     _FldNameList[6]   = _<SDO>.rowObject.id_lote
     _FldNameList[7]   = _<SDO>.rowObject.fecha
     _FldNameList[8]   = _<SDO>.rowObject.id_tarea
     _FldNameList[9]   > _<SDO>.rowObject.desc-tarea
"desc-tarea" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   = _<SDO>.rowObject.precio
