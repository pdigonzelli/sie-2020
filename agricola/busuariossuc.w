...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_usuario ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_usuario FORMAT "x(15)":U WIDTH 20.2
      rowObject.id_sucursal FORMAT ">>>>9":U WIDTH 40.6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_usuario
"rowObject.id_usuario" ? ? "character" ? ? ? ? ? ? no ? no no "20.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.id_sucursal
"rowObject.id_sucursal" ? ? "integer" ? ? ? ? ? ? no ? no no "40.6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
