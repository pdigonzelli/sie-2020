...
&Scoped-define FIELDS-IN-QUERY-br_table id_usuario descripcion fecha_cierre 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_usuario FORMAT ">>9":U
      descripcion FORMAT "X(20)":U
      fecha_cierre FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"id_usuario" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = _<SDO>.rowObject.descripcion
     _FldNameList[3]   = _<SDO>.rowObject.fecha_cierre
