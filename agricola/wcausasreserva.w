...
DEFINE VARIABLE h_bcausasreserva AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcausasreserva AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vcausasreserva AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Causas Reservas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Causas Reservas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dcausasreserva ( 2.91 , 63.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'bcausasreserva.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_bcausasreserva ).
       RUN repositionObject IN h_bcausasreserva ( 1.48 , 7.00 ) NO-ERROR.
       RUN resizeObject IN h_bcausasreserva ( 6.67 , 66.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vcausasreserva.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vcausasreserva ).
       RUN repositionObject IN h_vcausasreserva ( 11.71 , 5.00 ) NO-ERROR.
       /* Size in AB:  ( 2.00 , 77.00 ) */
       ...
       RUN constructObject (
             ...
             OUTPUT h_dyntoolbar ).
       RUN repositionObject IN h_dyntoolbar ( 8.62 , 5.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 67.20 ) NO-ERROR.

       /* Links to SmartDataObject h_dcausasreserva. */
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dcausasreserva ).

       /* Links to SmartDataBrowser h_bcausasreserva. */
       RUN addLink ( h_dcausasreserva , 'Data':U , h_bcausasreserva ).

       /* Links to SmartDataViewer h_vcausasreserva. */
       RUN addLink ( h_dcausasreserva , 'Data':U , h_vcausasreserva ).
       RUN addLink ( h_vcausasreserva , 'Update':U , h_dcausasreserva ).
       RUN addLink ( h_dyntoolbar , 'Tableio':U , h_vcausasreserva ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_dyntoolbar ,
             h_bcausasreserva , 'AFTER':U ).
       RUN adjustTabOrder ( h_vcausasreserva ,
