...
T-fincas FI-grupo T-grupo FI-grupo-consulta T-legajos FI-desde-fecha ~
FI-hasta-fecha 
...
T-grupo FI-grupo-consulta nombre-grupo-consulta FI-legajo nombre-legajo ~
T-legajos FI-desde-fecha FI-hasta-fecha 
...
DEFINE FRAME fMain
     ...
     FI-desde-fecha AT ROW 13.38 COL 21 COLON-ALIGNED WIDGET-ID 6
     FI-hasta-fecha AT ROW 14.57 COL 21 COLON-ALIGNED WIDGET-ID 10
...
ON END-ERROR OF wWin /* Control Tachadas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Control Tachadas */
DO:
...
DO:
  run p_liq_excel_tachadas.p (INPUT INTEGER(fi-empresa:SCREEN-VALUE),
...
ON LEAVE OF FI-grupo-consulta IN FRAME fMain /* Grupo Consulta */
DO:
  RUN descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FI-grupo-consulta wWin
ON MOUSE-SELECT-DBLCLICK OF FI-grupo-consulta IN FRAME fMain /* Grupo Consulta */
DO:
    DEFINE VAR hfield AS HANDLE NO-UNDO.
  DEFINE VAR xFieldResult AS CHARACTER.
  RUN adm2/support/gConsultas.w (INPUT "bgrupoconsulta.w",
                                 INPUT "dgrupoconsulta.w",
...
------------------------------------------------------------------------------*/
  DISPLAY fi-empresa nombre-empresa T-empresa nombre-sector Fi-sector T-sector 
          ...
          nombre-finca T-fincas FI-grupo nombre-grupo T-grupo FI-grupo-consulta 
          nombre-grupo-consulta FI-legajo nombre-legajo T-legajos FI-desde-fecha 
          FI-hasta-fecha 
  ...
  ENABLE Btn_OK Btn_Cancel fi-empresa T-empresa Fi-sector T-sector FI-sucursal 
         ...
         FI-grupo-consulta T-legajos FI-desde-fecha FI-hasta-fecha 
      WITH FRAME fMain IN WINDOW wWin.
