...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_empresa ~
rowObject.legajo rowObject.nombre rowObject.dni_cuil rowObject.fecha ~
rowObject.id_tarea rowObject.abreviatura rowObject.id_origen ~
rowObject.id_lote 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.dni_cuil FORMAT "X(12)":U
