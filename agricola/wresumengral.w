...
DEFINE FRAME fMain
     ...
     FI-desde-fecha AT ROW 5.29 COL 21 COLON-ALIGNED WIDGET-ID 6
     FI-hasta-fecha AT ROW 6.48 COL 21 COLON-ALIGNED WIDGET-ID 8
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 111 BY 8.05 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Resumen Gral de Certificacion"
         HEIGHT             = 8.05
         WIDTH              = 111
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Resumen Gral de Certificacion */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Resumen Gral de Certificacion */
DO:
...
case integer(fi-sector:screen-value in frame {&FRAME-NAME}):
   when 1 or when 5 or when 6 Then
     ...
     RUN  aderb\_prntrb2(
      (if index(propath,"supervisor.pl") > 0 then vlc_dir_objetos else vlc_dir_fuentes) +  "agricola~\agricola.prl", /* RB-REPORT-LIBRARY */
       ...
       "",                              /* RB-OUTPUT-FILE */
        ...
        0,                              /* RB-END-PAGE - zero */
       no,                              /* RB-TEST-PATTERN */
       "Resumen Certificacion",         /* RB-WINDOW-TITLE */
    ...
    when 2 Then
     ...
     RUN  aderb\_prntrb2(
      (if index(propath,"supervisor.pl") > 0 then vlc_dir_objetos else vlc_dir_fuentes) +  "agricola~\agricola.prl", /* RB-REPORT-LIBRARY */
       "resumen_finca_3eros_total_v_cos1", /* RB-REPORT-NAME */
       "",                             /* RB-DB-CONNECTION */
       "O",                             /* RB-INCLUDE-RECORDS */
       v_filtro,                              /* RB-FILTER */
       RB-MEMO-FILE,                              /* RB-MEMO-FILE */
