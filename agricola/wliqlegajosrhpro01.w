...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Personal RHPRO (Actualizaci¢n)"
         HEIGHT             = 31.52
         WIDTH              = 166.6
         MAX-HEIGHT         = 31.52
         MAX-WIDTH          = 174.4
...
ON END-ERROR OF wWin /* Personal RHPRO (Actualizaci¢n) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Personal RHPRO (Actualizaci¢n) */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN resizeObject IN h_bliqlegajosrhpro ( 5.24 , 93.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dyntoolbar-2 ( 12.67 , 9.00 ) NO-ERROR.
       ...
       RUN addLink ( h_dyntoolbar-2 , 'Navigation':U , h_dliqlegajos ).
       ...
       RUN addLink ( h_dyntoolbar-2 , 'Tableio':U , h_vliqlegajosrhpro ).
