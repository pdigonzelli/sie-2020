...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Agricola - Liquidacion Personal - RHPRO (Nuevo Tarjado)"
         HEIGHT             = 8.91
         WIDTH              = 104.8
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Agricola - Liquidacion Personal - RHPRO (Nuevo Tarjado) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Agricola - Liquidacion Personal - RHPRO (Nuevo Tarjado) */
DO:
...
DO:
  ...
  run liq_rhpro01-c1.p (input integer(fi-empresa:screen-value),
