...
*/
        FIND FIRST lotes_plantacion WHERE
            lotes_plantacion.codigo_trazabilidad = '21B01' 
            NO-LOCK NO-ERROR.
        ...
        IF AVAILABLE lotes_plantacion THEN DO:
            ...
            XUP = ORIGENES.ZONA_UP + "-" + STRING(ORIGENES.ID_FINCA_SENASA, '9999') +  "-" + STRING(LOTE.ID_LOTE_SENASA,'999').
            ...
            PUT CONTROL "^FO030,045^BY4,3.0^B2B,300,Y,R,N^FR^FD" STRING(PCNROBIN,"999999999999") "^FS".

            IF PCNROBIN > 20000000 THEN
                PUT CONTROL "^FO380,130^A0B,40,40^FD---- ESPECIAL ----^FS".
            ELSE            
                PUT CONTROL "^FO380,130^A0B,40,40^FD---------------------------^FS".
            
            PUT CONTROL "^FO420,130^A0B,80,40^FD" "FINCA:" ORIGENES.DESCRIPCION "^FS".
            PUT CONTROL "^FO480,130^A0B,80,40^FD" "LOTE :" LOTES_PLANTACION.DESCRIPCION "^FS".
            PUT CONTROL "^FO540,130^A0B,80,40^FD" "UP :" XUP "^FS".
            PUT CONTROL "^FO600,130^A0B,80,40^FD" "TRAZ.:" LOTES_PLANTACION.CODIGO_TRAZABILIDAD "^FS".
/*            
