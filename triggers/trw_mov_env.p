TRIGGER PROCEDURE FOR WRITE OF movimientos_envases OLD movi.
    ...
    saldos_envases.cant_envases = saldos_envases.cant_envases + movimientos_envases.cant_envases - movi.cant_envases.
    ...
    find saldos_envases where 
        ...
        saldos_envases.id_envase    = movimientos_envases.id_envase exclusive-lock no-error.
