TRIGGER PROCEDURE FOR replication-delete OF brix .
find first registros_actualizados_publica where registros_actualizados_publica.host = "tucuman1" and registros_actualizados_publica.servicio = "industria" and registros_actualizados_publica.protocolo = "TCP" and registros_actualizados_publica.nombre = "brix" and registros_actualizados_publica.rowid_registro = string(rowid(brix)) no-lock no-error.
if not available registros_actualizados_publica Then 
do:
CREATE registros_actualizados_publica.
RAW-TRANSFER industria.brix TO registros_actualizados_publica.registro.
ASSIGN  
   ...
   registros_actualizados_publica.nombre  = "brix"
   registros_actualizados_publica.rowid_registro  = string(rowid(brix))
...
RAW-TRANSFER brix TO registros_actualizados_publica.registro.
ASSIGN  
   registros_actualizados_publica.serial_de_publicacion = 0
   registros_actualizados_publica.condicion = "B"
   registros_actualizados_publica.fecha_de_actualizacion = today
