...
define temp-table tt_etiqueta
    ...
    field id_lote_destino as integer.
...
&Scoped-define FIELDS-IN-QUERY-br_table tt_etiqueta.tipo_movimiento tt_etiqueta.tipo_mov_existente tt_etiqueta.etiqueta tt_etiqueta.id_lote_destino   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      tt_etiqueta.id_lote_destino label "Lote Destino"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
define var v_lote_destino as integer.

run get-container (output hcon).

run get-parametros in hcon (output p1, output p2).
run dame_lote_destino in hcon (output v_lote_destino).
    ...
    do:
      ...
      if available tambores_industria then
       do:
             ...
             tt_etiqueta.id_lote_destino = v_lote_destino.
            ...
            assign items_movimientos_industria.id_empresa = 1
                   ...
                   items_movimientos_industria.id_lote_destino = v_lote_destino
