...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-13 
...
DEFINE VARIABLE h_b_sel_lote_aceite_protocolos AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 16.95 COL 110
     salir AT ROW 16.95 COL 122
     RECT-1 AT ROW 16.71 COL 107
     RECT-13 AT ROW 1.24 COL 3
     SPACE(2.19) SKIP(2.18)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_sel_lote_aceite_protocolos.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_sel_lote_aceite_protocolos ).
       RUN set-position IN h_b_sel_lote_aceite_protocolos ( 1.48 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b_sel_lote_aceite_protocolos ( 13.81 , 125.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_sel_lote_aceite_protocolos ,
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE dame-articulo D-Dialog 
PROCEDURE dame-articulo :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
DEFINE OUTPUT PARAMETER p_art AS INTEGER.
p_art = p_articulo.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-13 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
