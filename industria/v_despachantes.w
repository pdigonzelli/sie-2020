...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES despachantes
&Scoped-define FIRST-EXTERNAL-TABLE despachantes


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR despachantes.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS despachantes.id_despachante ~
despachantes.descripcion 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_despachante ~{&FP2}id_despachante ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}
&Scoped-define ENABLED-TABLES despachantes
&Scoped-define FIRST-ENABLED-TABLE despachantes
&Scoped-Define DISPLAYED-FIELDS despachantes.id_despachante ~
despachantes.descripcion 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS despachantes.id_despachante 
...
DEFINE FRAME F-Main
     despachantes.id_despachante AT ROW 1 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     despachantes.descripcion AT ROW 2 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.despachantes
...
/* SETTINGS FOR FILL-IN despachantes.id_despachante IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME despachantes.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL despachantes.descripcion V-table-Win
ON LEAVE OF despachantes.descripcion IN FRAME F-Main /* Descripcion */
DO:
...
&Scoped-define SELF-NAME despachantes.id_despachante
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL despachantes.id_despachante V-table-Win
ON LEAVE OF despachantes.id_despachante IN FRAME F-Main /* Cod.Despachante */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "despachantes"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "despachantes"}
