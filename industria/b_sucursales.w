...
sucursales.nombre sucursales.abreviatura 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      sucursales.id_sucursal COLUMN-LABEL "Suc" FORMAT ">>9":U
      sucursales.nombre FORMAT "x(30)":U WIDTH 36.2
...
"id_sucursal" "Suc" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > comercial.sucursales.nombre
"nombre" ? ? "character" ? ? ? ? ? ? no ? no no "36.2" yes no no "U" "" ""
...
case p:
  ...
  WHEN 'sucursales.abreviatura' then  
