...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tambores_industria.id_lote FORMAT ">>>>9":U WIDTH 10.2
      tambores_industria.id_tambor FORMAT ">>>9":U WIDTH 9.2
      tambores_industria.Fecha FORMAT "99/99/9999":U WIDTH 14.2
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_industria OF general.items_orden_entrega ,general.productos_terminados OF general.tambores_industria,general.calidades OF general.tambores_industria"
...
"tambores_industria.id_lote" ? ">>>>9" "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
...
"tambores_industria.Fecha" ? ? "date" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" ""
     _FldNameList[4]   > general.productos_terminados.abreviatura
"productos_terminados.abreviatura" "Articulo" ? "character" ? ? ? ? ? ? no ? no no "19.2" yes no no "U" "" ""
     _FldNameList[5]   > general.calidades.abreviatura
"calidades.abreviatura" "Calidad" ? "character" ? ? ? ? ? ? no ? no no "21.2" yes no no "U" "" ""
