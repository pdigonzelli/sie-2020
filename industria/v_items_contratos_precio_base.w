...
&Scoped-Define ENABLED-FIELDS items_contratos.precio_base_calculo ~
items_contratos.precio_fob_base_400 items_contratos.precio_comision ~
items_contratos.comision_broker items_contratos.comision_otros 
&Scoped-define ENABLED-TABLES items_contratos
&Scoped-define FIRST-ENABLED-TABLE items_contratos
&Scoped-Define DISPLAYED-FIELDS items_contratos.precio_base_calculo ~
items_contratos.precio_fob_base_400 items_contratos.precio_comision ~
items_contratos.comision_broker items_contratos.comision_otros 
...
DEFINE FRAME F-Main
     items_contratos.precio_base_calculo AT ROW 1 COL 24.2 COLON-ALIGNED
          LABEL "FOB Facturacion"
          VIEW-AS FILL-IN 
          SIZE 28.6 BY 1
     items_contratos.precio_fob_base_400 AT ROW 1 COL 68 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 30 BY 1
     items_contratos.precio_comision AT ROW 1.95 COL 24 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 28.6 BY 1
     items_contratos.comision_broker AT ROW 1.95 COL 65 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     items_contratos.comision_otros AT ROW 1.95 COL 90 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
...
/* SETTINGS FOR FILL-IN items_contratos.precio_base_calculo IN FRAME F-Main
   EXP-LABEL                                                            */
...
&Scoped-define SELF-NAME items_contratos.comision_broker
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.comision_broker V-table-Win
ON LEAVE OF items_contratos.comision_broker IN FRAME F-Main /* Comision */
DO:
...
&Scoped-define SELF-NAME items_contratos.comision_otros
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.comision_otros V-table-Win
ON LEAVE OF items_contratos.comision_otros IN FRAME F-Main /* Comision otros */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME items_contratos.precio_base_calculo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.precio_base_calculo V-table-Win
ON LEAVE OF items_contratos.precio_base_calculo IN FRAME F-Main /* FOB Facturacion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME items_contratos.precio_comision
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.precio_comision V-table-Win
ON LEAVE OF items_contratos.precio_comision IN FRAME F-Main /* Precio Comision */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME items_contratos.precio_fob_base_400
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.precio_fob_base_400 V-table-Win
ON LEAVE OF items_contratos.precio_fob_base_400 IN FRAME F-Main /* Fob Base 400 */
DO:
{custom/support/validacion.i}
END.
