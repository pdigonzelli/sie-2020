...
DEFINE VARIABLE h_bc_legajo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_legajo.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_legajo ).
       RUN set-position IN h_bc_legajo ( 2.14 , 7.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 76.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_legajo ,
