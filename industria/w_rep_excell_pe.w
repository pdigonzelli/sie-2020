...
&Scoped-Define ENABLED-OBJECTS despachante BUTTON-19 RECT-2 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-3 despachante 
...
DEFINE VARIABLE FILL-IN-3 AS CHARACTER FORMAT "X(256)":U INITIAL "Reportes de Permisos de Embarque" 
     VIEW-AS FILL-IN 
     SIZE 66 BY 1
...
DEFINE FRAME F-Main
     ...
     despachante AT ROW 3.86 COL 23 COLON-ALIGNED
     BUTTON-19 AT ROW 5.05 COL 12
...
ON CHOOSE OF BUTTON-19 IN FRAME F-Main /* Reporte Despachantes */
DO:
  IF date(fecha_liq:SCREEN-VALUE IN FRAME F-Main) <> ? THEN DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             BUTTON-19:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-3 despachante 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE despachante BUTTON-19 RECT-2 
      WITH FRAME F-Main IN WINDOW W-Win.
