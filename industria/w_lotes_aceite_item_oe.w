...
DEFINE VARIABLE h_b_lotes_aceite_contratos AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_lotes_aceite_contratos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_lotes_aceite_contratos ).
       RUN set-position IN h_b_lotes_aceite_contratos ( 4.57 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b_lotes_aceite_contratos ( 6.71 , 81.00 ) NO-ERROR.
       ...
       /* Links to csmartbrowser h_b_lotes_aceite_contratos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_lotes_aceite_contratos ).

       /* Links to SmartViewer h_v_lotes_aceite_item_oe. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_aceite_contratos , 'Record':U , h_v_lotes_aceite_item_oe ).
