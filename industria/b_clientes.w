...
<FOREIGN-KEYS>
id_cliente||y|general.clientes.id_cliente
id_provincia||y|general.clientes.id_provincia
id_tipo_cliente||y|general.clientes.id_tipo_cliente
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_cliente,id_provincia,id_tipo_cliente"':U).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_cliente" "clientes" "id_cliente"}
  {src/adm/template/sndkycas.i "id_provincia" "clientes" "id_provincia"}
  {src/adm/template/sndkycas.i "id_tipo_cliente" "clientes" "id_tipo_cliente"}
