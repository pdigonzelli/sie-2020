...
DEFINE VARIABLE h_b_usuarios_listas AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_usuarios_listas AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Usuarios Listas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Usuarios Listas */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 12.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 46.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 69.80 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_usuarios_listas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_usuarios_listas ).
       RUN set-position IN h_b_usuarios_listas ( 3.86 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b_usuarios_listas ( 6.71 , 107.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_usuarios_listas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_usuarios_listas ).
       RUN set-position IN h_v_usuarios_listas ( 11.48 , 23.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.05 , 71.00 ) */

       /* Links to csmartbrowser h_b_usuarios_listas. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_usuarios_listas ).

       /* Links to SmartViewer h_v_usuarios_listas. */
       RUN add-link IN adm-broker-hdl ( h_b_usuarios_listas , 'Record':U , h_v_usuarios_listas ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_usuarios_listas ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_usuarios_listas ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_usuarios_listas ,
             h_b_usuarios_listas , 'AFTER':U ).
    END. /* Page 0 */
