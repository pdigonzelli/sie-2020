...
&Scoped-define FIELDS-IN-QUERY-br_table gastos_venta.abreviatura ~
gastos_orden_entrega.importe 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH gastos_orden_entrega WHERE gastos_orden_entrega.id_orden_entrega = permisos_embarque.id_orden_entrega NO-LOCK, ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 42 BY 5.71
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.gastos_orden_entrega WHERE general.permisos_embarque <external> ...,industria.gastos_venta OF general.gastos_orden_entrega"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "general.gastos_orden_entrega.id_orden_entrega = general.permisos_embarque.id_orden_entrega"
     _FldNameList[1]   = general.gastos_venta.abreviatura
     _FldNameList[2]   = general.gastos_orden_entrega.importe
