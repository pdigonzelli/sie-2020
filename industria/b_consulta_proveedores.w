...
&Scoped-define INTERNAL-TABLES proveedores

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table proveedores.id_proveedor ~
proveedores.nombre proveedores.razon_social 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH proveedores WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table proveedores
&Scoped-define FIRST-TABLE-IN-QUERY-br_table proveedores
...
<FOREIGN-KEYS>
id_proveedor||y|comercial.proveedores.id_proveedor
id_ret_ganancias||y|comercial.proveedores.id_ret_ganancias
id_ret_ingbrutos||y|comercial.proveedores.id_ret_ingbrutos
id_ret_iva||y|comercial.proveedores.id_ret_iva
id_documento||y|comercial.proveedores.id_documento
id_interno_contribuyente||y|comercial.proveedores.id_interno_contribuyente
id_tipo_proveedor||y|comercial.proveedores.id_tipo_proveedor
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_proveedor,id_ret_ganancias,id_ret_ingbrutos,id_ret_iva,id_documento,id_interno_contribuyente,id_tipo_proveedor"':U).
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 122 BY 16
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "comercial.proveedores"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = comercial.proveedores.id_proveedor
     _FldNameList[2]   = comercial.proveedores.nombre
     _FldNameList[3]   = comercial.proveedores.razon_social
...
define sub-menu Ordena 
  menu-item proveedores-id_proveedor
label 'id_proveedor( proveedores ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=proveedores.id_proveedor').
                  run set-attribute-list('titulo=Cód.Proveedor').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by proveedores.id_proveedor
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item proveedores-nombre
label 'nombre( proveedores ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=proveedores.nombre').
                  run set-attribute-list('titulo=Nombre').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by proveedores.nombre
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item proveedores-razon_social
label 'razon_social( proveedores ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=proveedores.razon_social').
                  run set-attribute-list('titulo=Razón social').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by proveedores.razon_social
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by proveedores.id_proveedor
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_proveedor" "proveedores" "id_proveedor"}
  {src/adm/template/sndkycas.i "id_ret_ganancias" "proveedores" "id_ret_ganancias"}
  {src/adm/template/sndkycas.i "id_ret_ingbrutos" "proveedores" "id_ret_ingbrutos"}
  {src/adm/template/sndkycas.i "id_ret_iva" "proveedores" "id_ret_iva"}
  {src/adm/template/sndkycas.i "id_documento" "proveedores" "id_documento"}
  {src/adm/template/sndkycas.i "id_interno_contribuyente" "proveedores" "id_interno_contribuyente"}
  {src/adm/template/sndkycas.i "id_tipo_proveedor" "proveedores" "id_tipo_proveedor"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "proveedores"}
