...
&Scoped-Define ENABLED-FIELDS lotes_ind.id_sucursal lotes_ind.anio ~
lotes_ind.id_lote lotes_ind.Fecha lotes_ind.citral lotes_ind.descripcion 
&Scoped-define ENABLED-TABLES lotes_ind
&Scoped-define FIRST-ENABLED-TABLE lotes_ind
&Scoped-define DISPLAYED-TABLES lotes_ind
&Scoped-define FIRST-DISPLAYED-TABLE lotes_ind
&Scoped-Define DISPLAYED-FIELDS lotes_ind.id_sucursal lotes_ind.anio ~
lotes_ind.id_lote lotes_ind.Fecha lotes_ind.citral lotes_ind.descripcion 
&Scoped-Define DISPLAYED-OBJECTS fi-sucursales-nombre 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS lotes_ind.id_sucursal lotes_ind.anio ~
lotes_ind.id_lote 
...
DEFINE FRAME F-Main
     lotes_ind.id_sucursal AT ROW 1 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5 BY 1
     fi-sucursales-nombre AT ROW 1 COL 18 COLON-ALIGNED NO-LABEL
     lotes_ind.anio AT ROW 1.95 COL 34 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     lotes_ind.id_lote AT ROW 2 COL 12 COLON-ALIGNED
          LABEL "Proceso"
          VIEW-AS FILL-IN 
          SIZE 11 BY 1
     lotes_ind.Fecha AT ROW 2.91 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     lotes_ind.citral AT ROW 3.91 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     lotes_ind.descripcion AT ROW 4.81 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* SETTINGS FOR FILL-IN lotes_ind.anio IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN fi-sucursales-nombre IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN lotes_ind.id_lote IN FRAME F-Main
   1 EXP-LABEL                                                          */
/* SETTINGS FOR FILL-IN lotes_ind.id_sucursal IN FRAME F-Main
   1                                                                    */
...
general.lotes_ind.id_sucursal;wc_sucursales.w;sucursales.nombre;;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME lotes_ind.anio
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_ind.anio V-table-Win
ON LEAVE OF lotes_ind.anio IN FRAME F-Main /* Año */
DO:
...
&Scoped-define SELF-NAME lotes_ind.citral
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_ind.citral V-table-Win
ON LEAVE OF lotes_ind.citral IN FRAME F-Main /* Citral */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME lotes_ind.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_ind.descripcion V-table-Win
ON LEAVE OF lotes_ind.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME lotes_ind.Fecha
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_ind.Fecha V-table-Win
ON LEAVE OF lotes_ind.Fecha IN FRAME F-Main /* Fecha */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME lotes_ind.id_lote
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_ind.id_lote V-table-Win
ON LEAVE OF lotes_ind.id_lote IN FRAME F-Main /* Proceso */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME lotes_ind.id_sucursal
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_ind.id_sucursal V-table-Win
ON GO OF lotes_ind.id_sucursal IN FRAME F-Main /* IdSucursal */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_ind.id_sucursal V-table-Win
ON LEAVE OF lotes_ind.id_sucursal IN FRAME F-Main /* IdSucursal */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_ind.id_sucursal V-table-Win
ON MOUSE-SELECT-DBLCLICK OF lotes_ind.id_sucursal IN FRAME F-Main /* IdSucursal */
do: 
define var r as rowid no-undo.
run wc_sucursales.w(output r).
find sucursales where rowid(sucursales) = r no-lock no-error.
if available sucursales then 
general.lotes_ind.id_sucursal:screen-value = string(sucursales.id_sucursal).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_ind.id_sucursal V-table-Win
ON U1 OF lotes_ind.id_sucursal IN FRAME F-Main /* IdSucursal */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
assign lotes_ind.id_empresa         = 1
       lotes_ind.id_tipo_lote_ind   = 2
       lotes_ind.nro_partida        = next-value(nro_partida,industria)
       lotes_ind.c_usuario          = userid("userdb")
       lotes_ind.c_fecha            = today
       lotes_ind.c_hora             = string(time,"HH:MM:SS").
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
FIND FIRST lotes_aceite WHERE lotes_aceite.id_empresa = lotes_ind.id_empresa
                          AND lotes_aceite.id_sucursal = lotes_ind.id_sucursal
                          AND lotes_aceite.nro_partida = lotes_ind.nro_partida
                          NO-LOCK NO-ERROR.
IF AVAILABLE lotes_aceite THEN DO:
    MESSAGE "No puede eliminar el lote " lotes_ind.id_lote 
            " porque ya tiene etapas creadas. " VIEW-AS ALERT-BOX.
    RETURN "ADM-ERROR".
END.
END PROCEDURE.
...
find first sucursales where sucursales.id_sucursal = integer(lotes_ind.id_sucursal:screen-value in frame F-Main)  no-lock no-error .
if available sucursales then 
...
define var lista_relacion as character no-undo initial "id_sucursal".
...
------------------------------------------------------------------------------*/
  case nombre:
    when "anio" then
        if integer(valor) < YEAR(TODAY) - 1 OR INTEGER(valor) > YEAR(TODAY) + 1 THEN DO:
            mensaje = "Tiene que vargar un año valido".
            return false.
         end.
    end case.
