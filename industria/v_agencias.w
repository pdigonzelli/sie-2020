...
&Scoped-Define ENABLED-FIELDS agencias.id_agencia agencias.descripcion ~
agencias.abreviatura agencias.razon_social 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_agencia ~{&FP2}id_agencia ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}~
 ~{&FP1}abreviatura ~{&FP2}abreviatura ~{&FP3}~
 ~{&FP1}razon_social ~{&FP2}razon_social ~{&FP3}
&Scoped-define ENABLED-TABLES agencias
&Scoped-define FIRST-ENABLED-TABLE agencias
&Scoped-Define DISPLAYED-FIELDS agencias.id_agencia agencias.descripcion ~
agencias.abreviatura agencias.razon_social 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS agencias.id_agencia 
...
DEFINE FRAME F-Main
     agencias.id_agencia AT ROW 1 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     agencias.descripcion AT ROW 2 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     agencias.abreviatura AT ROW 3 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
     agencias.razon_social AT ROW 4 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 52 BY 1
...
/* SETTINGS FOR FILL-IN agencias.id_agencia IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME agencias.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL agencias.abreviatura V-table-Win
ON LEAVE OF agencias.abreviatura IN FRAME F-Main /* Agencia */
DO:
...
&Scoped-define SELF-NAME agencias.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL agencias.descripcion V-table-Win
ON LEAVE OF agencias.descripcion IN FRAME F-Main /* Agencia */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME agencias.id_agencia
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL agencias.id_agencia V-table-Win
ON LEAVE OF agencias.id_agencia IN FRAME F-Main /* Cod.Agencia */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME agencias.razon_social
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL agencias.razon_social V-table-Win
ON LEAVE OF agencias.razon_social IN FRAME F-Main /* Razon Social */
DO:
{custom/support/validacion.i}
END.
