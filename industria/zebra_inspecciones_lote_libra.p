...
/*****************GENERO LA ETIQUETA NUMERO CERO***********************************************************/
          ...
          if lotes_jugo.id_envase = 527 then
              do:
                  peso_neto_balde = lotes_jugo.peso_neto * 2.2046.
                  peso_bruto_balde = (lotes_jugo.peso_neto + 1.05) * 2.2046.                    
              end.
          else
              do:
                  peso_neto = lotes_jugo.peso_neto.
                  peso_bruto = (lotes_jugo.peso_neto + envases_prod.tara) * 2.2046.    
              end.
            ...
            if lotes_jugo.id_envase = 527 then
                do:
                    put control "^FO600,690^A0N,45,45^FD" string(peso_bruto_balde,">99.99") "^FS".
                end.
            else
                do:
                    put control "^FO600,690^A0N,45,45^FD" string(peso_bruto,">999.99") "^FS".
                end.

            put control "^FO770,726^A0N,34,25^FD" "Pd." "^FS". 
            ...
            if lotes_jugo.id_envase = 527 then
                do:
                    put control "^FO600,810^A0N,45,45^FD" string((1.05 * 2.2046),">9.99") "^FS".
                end.
            else
                do:
                    put control "^FO600,810^A0N,45,45^FD" string((envases_prod.tara * 2.2046),"99.99") "^FS".
                end.

            put control "^FO770,854^A0N,34,25^FD" "Pd." "^FS". 
            ...
            if lotes_jugo.id_envase = 527 then
                do:
                    put control "^FO600,938^A0N,45,45^FD" string(peso_neto_balde,">99.99") "^FS".
                end.
            else
                do:
                    peso_neto = peso_neto * 2.2046.
                    put control "^FO600,938^A0N,45,45^FD" string(peso_neto,">999.99") "^FS".
                end.
            
            put control "^FO770,966^A0N,34,25^FD" "Pd." "^FS".
           end.
