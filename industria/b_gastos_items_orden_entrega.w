...
&Scoped-define INTERNAL-TABLES gastos_items_orden_entrega gastos_venta

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table gastos_items_orden_entrega.id_gasto ~
gastos_venta.descripcion gastos_items_orden_entrega.importe 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table ~
gastos_items_orden_entrega.id_gasto gastos_items_orden_entrega.importe 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table gastos_items_orden_entrega
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table gastos_items_orden_entrega
&Scoped-define QUERY-STRING-br_table FOR EACH gastos_items_orden_entrega OF items_orden_entrega WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH gastos_venta OF gastos_items_orden_entrega NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH gastos_items_orden_entrega OF items_orden_entrega WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH gastos_venta OF gastos_items_orden_entrega NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table gastos_items_orden_entrega ~
gastos_venta
&Scoped-define FIRST-TABLE-IN-QUERY-br_table gastos_items_orden_entrega
...
<FOREIGN-KEYS>
id_gasto||y|general.gastos_items_orden_entrega.id_gasto
id_orden_entrega||y|general.gastos_items_orden_entrega.id_orden_entrega
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      gastos_items_orden_entrega.id_gasto COLUMN-LABEL "Cod" FORMAT ">>9":U
            WIDTH 5.2
      gastos_venta.descripcion COLUMN-LABEL "Gasto" FORMAT "X(30)":U
            WIDTH 33.2
      gastos_items_orden_entrega.importe FORMAT ">>>>>9.9999":U
            WIDTH 20.4
  ENABLE
      gastos_items_orden_entrega.id_gasto
      gastos_items_orden_entrega.importe
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.gastos_items_orden_entrega OF general.items_orden_entrega,industria.gastos_venta OF general.gastos_items_orden_entrega"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.gastos_items_orden_entrega.id_gasto
"gastos_items_orden_entrega.id_gasto" "Cod" ">>9" "integer" ? ? ? ? ? ? yes ? no no "5.2" yes no no "U" "" ""
     _FldNameList[2]   > general.gastos_venta.descripcion
"gastos_venta.descripcion" "Gasto" ? "character" ? ? ? ? ? ? no ? no no "33.2" yes no no "U" "" ""
     _FldNameList[3]   > general.gastos_items_orden_entrega.importe
"gastos_items_orden_entrega.importe" ? ">>>>>9.9999" "decimal" ? ? ? ? ? ? yes ? no no "20.4" yes no no "U" "" ""
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_gasto" "gastos_items_orden_entrega" "id_gasto"}
  {src/adm/template/sndkycas.i "id_orden_entrega" "gastos_items_orden_entrega" "id_orden_entrega"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "gastos_items_orden_entrega"}
