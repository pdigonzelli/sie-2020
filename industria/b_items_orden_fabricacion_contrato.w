...
&Scoped-define FIELDS-IN-QUERY-br_table items_orden_fabricacion.id_contrato ~
items_orden_fabricacion.anio items_orden_fabricacion.Cantidad ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH items_orden_fabricacion WHERE ~{&KEY-PHRASE} ~
      AND items_orden_fabricacion.id_contrato = v_contrato ~
 AND items_orden_fabricacion.id_tipo_contrato = v_tipo_contrato ~
 AND items_orden_fabricacion.anio = v_anio NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      items_orden_fabricacion.id_contrato
      items_orden_fabricacion.anio
      items_orden_fabricacion.Cantidad FORMAT ">>>,>>9.99"
      productos_terminados.descripcion
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.items_orden_fabricacion,general.productos_terminados OF general.items_orden_fabricacion"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "general.items_orden_fabricacion.id_contrato = v_contrato
 AND general.items_orden_fabricacion.id_tipo_contrato = v_tipo_contrato
 AND general.items_orden_fabricacion.anio = v_anio"
     _FldNameList[1]   = general.items_orden_fabricacion.id_contrato
     _FldNameList[2]   = general.items_orden_fabricacion.anio
     _FldNameList[3]   > general.items_orden_fabricacion.Cantidad
"items_orden_fabricacion.Cantidad" ? ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ?
...
define sub-menu Ordena 
  menu-item items_orden_fabricacion-id_contrato
label 'id_contrato( items_orden_fabricacion ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=items_orden_fabricacion.id_contrato').
                  run set-attribute-list('titulo=Contract').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by items_orden_fabricacion.id_contrato
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item items_orden_fabricacion-anio
label 'anio( items_orden_fabricacion ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=items_orden_fabricacion.anio').
                  run set-attribute-list('titulo=Año').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by items_orden_fabricacion.anio
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
define var h_con as handle.
  ...
  /* Dispatch standard ADM method.                             */
    ...
    run paso_rowid in h_con (output v_contrato, output v_tipo_contrato, output v_anio).
