...
rowObject.id_tipo_contrato rowObject.anio rowObject.orden_fabricacion ~
rowObject.id_cliente rowObject.item rowObject.id_articulo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_tipo_contrato FORMAT ">>9":U
      anio FORMAT "9999":U
      orden_fabricacion FORMAT ">>,>>>,>>9":U
      id_cliente FORMAT "->,>>>,>>9":U
      item FORMAT ">>>,>>9":U
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dqContratosPartes.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.id_tipo_contrato
     _FldNameList[3]   = _<SDO>.rowObject.anio
     _FldNameList[4]   = _<SDO>.rowObject.orden_fabricacion
