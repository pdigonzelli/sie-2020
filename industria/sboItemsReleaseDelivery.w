...
&Scoped-Define UpdTable2 dvapores
&Scoped-Define SDOInclude2 "dVapores.i"
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_ditemsreleasedelivery ( 1.29 , 2.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'dvapores.wDB-AWARE':U ,
             INPUT  {&WINDOW-NAME} ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsvapores.id_vapor,id_vaporRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedvaporesUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dvapores ).
       RUN repositionObject IN h_dvapores ( 1.29 , 12.60 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       /* Links to SmartDataObject h_dvapores. */
       RUN addLink ( h_ditemsreleasedelivery , 'Data':U , h_dvapores ).
