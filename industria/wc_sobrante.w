...
&Scoped-Define ENABLED-OBJECTS RECT-18 RECT-1 aceptar salir 
...
DEFINE VARIABLE h_bc_sobrante AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.67 COL 124
     salir AT ROW 10.67 COL 136
     RECT-18 AT ROW 1.86 COL 4
     RECT-1 AT ROW 10.43 COL 121
     SPACE(7.19) SKIP(0.42)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_sobrante.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_sobrante ).
       RUN set-position IN h_bc_sobrante ( 2.52 , 7.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 143.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_sobrante ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-18 RECT-1 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
