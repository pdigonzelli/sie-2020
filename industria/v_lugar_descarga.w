...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES lugar_descarga
&Scoped-define FIRST-EXTERNAL-TABLE lugar_descarga


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR lugar_descarga.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS lugar_descarga.id_lugdes ~
lugar_descarga.descripcion lugar_descarga.id_sucursal 
&Scoped-define ENABLED-TABLES lugar_descarga
&Scoped-define FIRST-ENABLED-TABLE lugar_descarga
&Scoped-define DISPLAYED-TABLES lugar_descarga
&Scoped-define FIRST-DISPLAYED-TABLE lugar_descarga
&Scoped-Define DISPLAYED-FIELDS lugar_descarga.id_lugdes ~
lugar_descarga.descripcion lugar_descarga.id_sucursal 
&Scoped-Define DISPLAYED-OBJECTS fi-sucursales-nombre 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS lugar_descarga.id_lugdes 
...
DEFINE FRAME F-Main
     lugar_descarga.id_lugdes AT ROW 1 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     lugar_descarga.descripcion AT ROW 2 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     lugar_descarga.id_sucursal AT ROW 3.14 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
     fi-sucursales-nombre AT ROW 3.14 COL 30 COLON-ALIGNED NO-LABEL
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: comercial.lugar_descarga
...
/* SETTINGS FOR FILL-IN fi-sucursales-nombre IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN lugar_descarga.id_lugdes IN FRAME F-Main
   1                                                                    */
...
comercial.lugar_descarga.id_sucursal;wc_sucursales.w;sucursales.nombre;;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME lugar_descarga.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lugar_descarga.descripcion V-table-Win
ON LEAVE OF lugar_descarga.descripcion IN FRAME F-Main /* Descripción */
DO:
...
&Scoped-define SELF-NAME lugar_descarga.id_lugdes
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lugar_descarga.id_lugdes V-table-Win
ON LEAVE OF lugar_descarga.id_lugdes IN FRAME F-Main /* Lugar de descarga */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME lugar_descarga.id_sucursal
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lugar_descarga.id_sucursal V-table-Win 
ON GO OF lugar_descarga.id_sucursal IN FRAME F-Main /* CodSucursal */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lugar_descarga.id_sucursal V-table-Win 
ON LEAVE OF lugar_descarga.id_sucursal IN FRAME F-Main /* CodSucursal */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lugar_descarga.id_sucursal V-table-Win
ON MOUSE-SELECT-DBLCLICK OF lugar_descarga.id_sucursal IN FRAME F-Main /* CodSucursal */
do: 
define var r as rowid no-undo.
run wc_sucursales.w(output r).
find comercial.sucursales where rowid(comercial.sucursales) = r no-lock no-error.
if available comercial.sucursales then 
comercial.lugar_descarga.id_sucursal:screen-value = string(comercial.sucursales.id_sucursal).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lugar_descarga.id_sucursal V-table-Win 
ON U1 OF lugar_descarga.id_sucursal IN FRAME F-Main /* CodSucursal */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "lugar_descarga"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "lugar_descarga"}
...
find first comercial.sucursales where comercial.sucursales.id_sucursal = integer(lugar_descarga.id_sucursal:screen-value in frame F-Main)  no-lock no-error .
if available comercial.sucursales then 
fi-sucursales-nombre:screen-value in frame F-Main = string(comercial.sucursales.nombre).
else
