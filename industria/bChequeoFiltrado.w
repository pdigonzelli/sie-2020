...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.presion rowObject.hora ~
rowObject.lavado 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.presion FORMAT "X(50)":U
      rowObject.hora FORMAT "99:99":U
      rowObject.lavado FORMAT "X(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dChequeoFiltrado.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.presion
     _FldNameList[2]   = _<SDO>.rowObject.hora
     _FldNameList[3]   = _<SDO>.rowObject.lavado
