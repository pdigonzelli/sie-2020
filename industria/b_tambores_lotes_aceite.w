...
&Scoped-define INTERNAL-TABLES tambores_lotes_aceite

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tambores_lotes_aceite.id_tambor ~
tambores_lotes_aceite.id_lote tambores_lotes_aceite.fecha_elaboracion ~
tambores_lotes_aceite.id_etiqueta 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_lotes_aceite OF lotes_aceite WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table tambores_lotes_aceite
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tambores_lotes_aceite
...
<FOREIGN-KEYS>
id_envase||y|general.tambores_lotes_aceite.id_envase
nro||y|general.tambores_lotes_aceite.nro
id_sucursal||y|general.tambores_lotes_aceite.id_sucursal
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_envase,nro,id_sucursal"':U).
...
DEFINE QUERY br_table FOR 
      tambores_lotes_aceite SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tambores_lotes_aceite.id_tambor COLUMN-LABEL "Tambor" FORMAT ">>>9"
      tambores_lotes_aceite.id_lote FORMAT ">,>>9"
      tambores_lotes_aceite.fecha_elaboracion FORMAT "99/99/9999"
      tambores_lotes_aceite.id_etiqueta
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 54 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_lotes_aceite OF general.lotes_aceite"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.tambores_lotes_aceite.id_tambor
"tambores_lotes_aceite.id_tambor" "Tambor" ">>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   > general.tambores_lotes_aceite.id_lote
"tambores_lotes_aceite.id_lote" ? ">,>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[3]   > general.tambores_lotes_aceite.fecha_elaboracion
"tambores_lotes_aceite.fecha_elaboracion" ? "99/99/9999" "date" ? ? ? ? ? ? no ?
     _FldNameList[4]   = general.tambores_lotes_aceite.id_etiqueta
...
define sub-menu Ordena 
  menu-item tambores_lotes_aceite-id_tambor
label 'id_tambor( tambores_lotes_aceite ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_lotes_aceite.id_tambor').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tambores_lotes_aceite.id_tambor
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tambores_lotes_aceite-id_lote
label 'id_lote( tambores_lotes_aceite ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_lotes_aceite.id_lote').
                  run set-attribute-list('titulo=Lote').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tambores_lotes_aceite.id_lote
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tambores_lotes_aceite-fecha_elaboracion
label 'fecha_elaboracion( tambores_lotes_aceite ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_lotes_aceite.fecha_elaboracion').
                  run set-attribute-list('titulo=Fecha Elaboración').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tambores_lotes_aceite.fecha_elaboracion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tambores_lotes_aceite-id_etiqueta
label 'id_etiqueta( tambores_lotes_aceite ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_lotes_aceite.id_etiqueta').
                  run set-attribute-list('titulo=Etiqueta').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tambores_lotes_aceite.id_etiqueta
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tambores_lotes_aceite.id_tambor
...
case p:
  WHEN 'tambores_lotes_aceite.id_tambor' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tambor = integer(valor)  no-lock no-error .
  WHEN 'tambores_lotes_aceite.id_lote' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_lote = integer(valor)  no-lock no-error .
  WHEN 'tambores_lotes_aceite.fecha_elaboracion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  fecha_elaboracion = date(valor)  no-lock no-error .
  WHEN 'tambores_lotes_aceite.id_etiqueta' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_envase" "tambores_lotes_aceite" "id_envase"}
  {src/adm/template/sndkycas.i "nro" "tambores_lotes_aceite" "nro"}
  {src/adm/template/sndkycas.i "id_sucursal" "tambores_lotes_aceite" "id_sucursal"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tambores_lotes_aceite"}
