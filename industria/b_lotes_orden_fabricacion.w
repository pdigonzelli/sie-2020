...
&Scoped-define INTERNAL-TABLES lotes_jugo productos_terminados calidades ~
sucursales tambores_industria

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table lotes_jugo.id_sucursal ~
sucursales.abreviatura lotes_jugo.id_lote lotes_jugo.id_articulo ~
productos_terminados.descripcion lotes_jugo.Fecha lotes_jugo.id_contrato_of ~
lotes_jugo.id_tipocontrato_of lotes_jugo.anio_of ~
lotes_jugo.id_orden_entrega lotes_jugo.item_oe 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH lotes_jugo WHERE ~{&KEY-PHRASE} ~
      AND lotes_jugo.id_articulo < 100 NO-LOCK, ~
      EACH productos_terminados OF lotes_jugo NO-LOCK, ~
      EACH calidades OF lotes_jugo NO-LOCK, ~
      EACH sucursales OF lotes_jugo NO-LOCK, ~
      FIRST tambores_industria OF lotes_jugo ~
      WHERE tambores_industria.id_locacion_ubicacion = 4 ~
and tambores_industria.id_sucursal_ubicacion <> 950  ~
and tambores_industria.id_sucursal_ubicacion <> 960 NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH lotes_jugo WHERE ~{&KEY-PHRASE} ~
      AND lotes_jugo.id_articulo < 100 NO-LOCK, ~
      EACH productos_terminados OF lotes_jugo NO-LOCK, ~
      EACH calidades OF lotes_jugo NO-LOCK, ~
      EACH sucursales OF lotes_jugo NO-LOCK, ~
...
and tambores_industria.id_sucursal_ubicacion <> 960 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table lotes_jugo productos_terminados ~
calidades sucursales tambores_industria
&Scoped-define FIRST-TABLE-IN-QUERY-br_table lotes_jugo
&Scoped-define SECOND-TABLE-IN-QUERY-br_table productos_terminados
&Scoped-define THIRD-TABLE-IN-QUERY-br_table calidades
&Scoped-define FOURTH-TABLE-IN-QUERY-br_table sucursales
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      lotes_jugo.id_sucursal COLUMN-LABEL "Suc" FORMAT ">>9":U
      sucursales.abreviatura COLUMN-LABEL "Sucursal" FORMAT "X(10)":U
      lotes_jugo.id_lote COLUMN-LABEL "Lote" FORMAT ">,>>9":U
      lotes_jugo.id_articulo COLUMN-LABEL "Art." FORMAT ">>9":U
            WIDTH 5.8
      productos_terminados.descripcion COLUMN-LABEL "Producto" FORMAT "x(25)":U
      lotes_jugo.Fecha FORMAT "99/99/9999":U
      lotes_jugo.id_contrato_of FORMAT "X(12)":U
      lotes_jugo.id_tipocontrato_of COLUMN-LABEL "T.Con" FORMAT ">>9":U
      lotes_jugo.anio_of FORMAT ">>>9":U WIDTH 7.4
      lotes_jugo.id_orden_entrega FORMAT ">>>>9":U WIDTH 9.2
      lotes_jugo.item_oe COLUMN-LABEL "ParteOE" FORMAT ">>>9":U
            WIDTH 11.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_jugo,general.productos_terminados OF general.lotes_jugo,general.calidades OF general.lotes_jugo,comercial.sucursales OF general.lotes_jugo,industria.tambores_industria OF general.lotes_jugo"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ",,,, FIRST"
     _Where[1]         = "general.lotes_jugo.id_articulo < 100"
     _Where[5]         = "general.tambores_industria.id_locacion_ubicacion = 4
and general.tambores_industria.id_sucursal_ubicacion <> 950 
and general.tambores_industria.id_sucursal_ubicacion <> 960"
     _FldNameList[1]   > general.lotes_jugo.id_sucursal
"lotes_jugo.id_sucursal" "Suc" ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > comercial.sucursales.abreviatura
"sucursales.abreviatura" "Sucursal" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > general.lotes_jugo.id_lote
"lotes_jugo.id_lote" "Lote" ">,>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > general.lotes_jugo.id_articulo
"lotes_jugo.id_articulo" "Art." ">>9" "integer" ? ? ? ? ? ? no ? no no "5.8" yes no no "U" "" ""
     _FldNameList[5]   > general.productos_terminados.descripcion
"productos_terminados.descripcion" "Producto" "x(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   = general.lotes_jugo.Fecha
     _FldNameList[7]   = general.lotes_jugo.id_contrato_of
     _FldNameList[8]   > general.lotes_jugo.id_tipocontrato_of
"lotes_jugo.id_tipocontrato_of" "T.Con" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[9]   > general.lotes_jugo.anio_of
"lotes_jugo.anio_of" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "7.4" yes no no "U" "" ""
     _FldNameList[10]   > general.lotes_jugo.id_orden_entrega
"lotes_jugo.id_orden_entrega" ? ">>>>9" "integer" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" ""
     _FldNameList[11]   > general.lotes_jugo.item_oe
"lotes_jugo.item_oe" "ParteOE" ? "integer" ? ? ? ? ? ? no ? no no "11.4" yes no no "U" "" ""
...
define sub-menu Ordena 
  menu-item lotes_jugo-id_sucursal
label 'id_sucursal( lotes_jugo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_jugo.id_sucursal').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_jugo.id_sucursal
...
label 'Fecha( lotes_jugo ) '
  ...
  menu-item lotes_jugo-id_contrato_of
label 'id_contrato_of( lotes_jugo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_jugo.id_contrato_of').
                  run set-attribute-list('titulo=Contract').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_jugo.id_contrato_of
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item lotes_jugo-id_tipocontrato_of
label 'id_tipocontrato_of( lotes_jugo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_jugo.id_tipocontrato_of').
                  run set-attribute-list('titulo=Tipo Contrato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_jugo.id_tipocontrato_of
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item lotes_jugo-anio_of
label 'anio_of( lotes_jugo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_jugo.anio_of').
                  run set-attribute-list('titulo=Año').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_jugo.anio_of
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item lotes_jugo-id_orden_entrega
label 'id_orden_entrega( lotes_jugo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_jugo.id_orden_entrega').
                  run set-attribute-list('titulo=OE').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_jugo.id_orden_entrega
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item lotes_jugo-item_oe
label 'item_oe( lotes_jugo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_jugo.item_oe').
                  run set-attribute-list('titulo=Parte OE').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_jugo.item_oe
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by lotes_jugo.id_sucursal
...
case p:
  WHEN 'lotes_jugo.id_sucursal' then  
  ...
  WHEN 'lotes_jugo.id_contrato_of' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_contrato_of begins valor  no-lock no-error .
  WHEN 'lotes_jugo.id_tipocontrato_of' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipocontrato_of = integer(valor)  no-lock no-error .
  WHEN 'lotes_jugo.anio_of' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  anio_of = integer(valor)  no-lock no-error .
  WHEN 'lotes_jugo.id_orden_entrega' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_orden_entrega = integer(valor)  no-lock no-error .
  WHEN 'lotes_jugo.item_oe' then  
...
if valor <> "" then
do:
    run custom-busca (input p , input valor).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE custom-busca B-table-Win 
PROCEDURE custom-busca :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
case p:
  WHEN 'lotes_jugo.id_sucursal' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where id_sucursal = integer(valor)  no-lock no-error .
  WHEN 'lotes_jugo.id_lote' then do:
       for each {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where id_lote = integer(valor)
                                                           and id_articulo < 100 no-lock ,
                       first tambores_industria of {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}
                                               where tambores_industria.id_locacion_ubicacion = 4  
                                                           .
  ...
  WHEN 'lotes_jugo.id_articulo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.id_articulo = integer(valor)  no-lock no-error .
  WHEN 'lotes_jugo.id_calidad' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.id_calidad = integer(valor)  no-lock no-error .
  WHEN 'lotes_jugo.Fecha' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.Fecha = date(valor)  no-lock no-error .
  WHEN 'lotes_jugo.id_orden_entrega' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.id_orden_entrega = integer(valor)  no-lock no-error .
end.
END PROCEDURE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE descriptivos B-table-Win 
