...
DEFINE INPUT PARAMETER x5 AS INTEGER. /* SUC ORIGEN */
DEFINE INPUT PARAMETER x6 AS INTEGER. /* SUC DESTINO */
...
FOR EACH items_factura WHERE items_factura.id_sucursal     = x1 
    ...
    ASSIGN stock.id_articulo        = items_factura.id_articulo
        ...
        assign
            ...
            bstock.id_suc_des         = X5
            bstock.id_suc_origen      = X6
