...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-29 
...
DEFINE FRAME D-Dialog
     ...
     RECT-29 AT ROW 2.19 COL 5
     SPACE(7.99) SKIP(2.23)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_tipos_origenes_materia_prima ( 2.67 , 7.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_origenes_materia_prima ( 6.71 , 72.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-29 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
