...
&Scoped-Define ENABLED-OBJECTS RECT-3 RECT-1 aceptar salir 
...
DEFINE VARIABLE h_bc_calidades AS HANDLE NO-UNDO.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Consulta de Calidades */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_calidades.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_calidades ).
       RUN set-position IN h_bc_calidades ( 2.43 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 75.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_calidades ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-3 RECT-1 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
