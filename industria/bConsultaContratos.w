...
rowObject.anio rowObject.fecha rowObject.id_cliente rowObject.razon_social 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_contrato FORMAT "X(12)":U WIDTH 15.2
      anio FORMAT "9999":U WIDTH 8.2
      fecha FORMAT "99/99/9999":U WIDTH 11.2
      id_cliente FORMAT "->,>>>,>>9":U WIDTH 12.2
      razon_social FORMAT "x(70)":U WIDTH 50.6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 105 BY 6.67 EXPANDABLE.
...
"id_contrato" ? ? "character" ? ? ? ? ? ? no ? no no "15.2" yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.anio
"anio" ? ? "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.fecha
"fecha" ? ? "date" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.id_cliente
"id_cliente" ? ? "integer" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[5]   > _<SDO>.rowObject.razon_social
"razon_social" ? ? "character" ? ? ? ? ? ? no ? no no "50.6" yes no no "U" "" ""
