...
&Scoped-define FIELDS-IN-QUERY-br_table tipos_contratos.descripcion ~
contratos.id_contrato contratos.orden_fabricacion contratos.anio ~
clientes.nombre contratos.fecha contratos.id_po_cliente[1] 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH contratos WHERE ~{&KEY-PHRASE} NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      contratos.id_po_cliente[1] FORMAT "X(10)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 139 BY 6.43
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = general.tipos_contratos.descripcion
     ...
     _FldNameList[6]   = general.contratos.fecha
     _FldNameList[7]   > general.contratos.id_po_cliente[1]
"contratos.id_po_cliente[1]" ? "X(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
