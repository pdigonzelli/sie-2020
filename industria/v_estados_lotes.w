...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES estados_lotes
&Scoped-define FIRST-EXTERNAL-TABLE estados_lotes


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR estados_lotes.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS estados_lotes.id_estado_lote ~
estados_lotes.descripcion 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_estado_lote ~{&FP2}id_estado_lote ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}
&Scoped-define ENABLED-TABLES estados_lotes
&Scoped-define FIRST-ENABLED-TABLE estados_lotes
&Scoped-Define DISPLAYED-FIELDS estados_lotes.id_estado_lote ~
estados_lotes.descripcion 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS estados_lotes.id_estado_lote 
...
DEFINE FRAME F-Main
     estados_lotes.id_estado_lote AT ROW 1 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     estados_lotes.descripcion AT ROW 2 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.estados_lotes
...
/* SETTINGS FOR FILL-IN estados_lotes.id_estado_lote IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME estados_lotes.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL estados_lotes.descripcion V-table-Win
ON LEAVE OF estados_lotes.descripcion IN FRAME F-Main /* Descripcion */
DO:
...
&Scoped-define SELF-NAME estados_lotes.id_estado_lote
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL estados_lotes.id_estado_lote V-table-Win
ON LEAVE OF estados_lotes.id_estado_lote IN FRAME F-Main /* Cod.Estado Lote */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "estados_lotes"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "estados_lotes"}
