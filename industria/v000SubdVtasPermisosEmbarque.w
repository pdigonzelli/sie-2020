...
DEFINE TEMP-TABLE RowObject
       {"d000subdvtaspermisosembarque.i"}.
...
&Scoped-Define ENABLED-FIELDS RowObject.anio_permiso RowObject.nro_embarque 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define ENABLED-OBJECTS RECT-6 
&Scoped-Define DISPLAYED-FIELDS RowObject.anio_permiso ~
RowObject.nro_embarque 
...
DEFINE FRAME F-Main
     RowObject.anio_permiso AT ROW 1.95 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     RowObject.nro_embarque AT ROW 4.33 COL 16 COLON-ALIGNED
          LABEL "Nro. Embarque"
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     RECT-6 AT ROW 1.24 COL 1
     "Completar Datos" VIEW-AS TEXT
          SIZE 20 BY .62 AT ROW 1 COL 2
          FONT 6
     SPACE(46.00) SKIP(2.52)
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "d000subdvtaspermisosembarque.w"
...
/* SETTINGS FOR FILL-IN RowObject.nro_embarque IN FRAME F-Main
   EXP-LABEL                                                            */
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_d000aduanas ( 1.71 , 38.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_dynselect ).
       RUN repositionObject IN h_dynselect ( 3.14 , 18.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_dynselect ,
             RowObject.anio_permiso:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
