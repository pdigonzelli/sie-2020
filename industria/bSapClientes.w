...
rowObject.BUKRS rowObject.VKORG rowObject.VTWEG rowObject.SPART 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.KUNNR FORMAT "X(100)":U WIDTH 15
      rowObject.NAME1 FORMAT "X(100)":U WIDTH 25
      rowObject.BUKRS FORMAT "X(100)":U WIDTH 10
      rowObject.VKORG FORMAT "X(100)":U WIDTH 10
      rowObject.VTWEG FORMAT "X(100)":U WIDTH 10
      rowObject.SPART FORMAT "X(100)":U WIDTH 10
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"rowObject.KUNNR" ? ? "character" ? ? ? ? ? ? no "?" no no "15" yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.NAME1
"rowObject.NAME1" ? ? "character" ? ? ? ? ? ? no "?" no no "25" yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.BUKRS
"rowObject.BUKRS" ? ? "character" ? ? ? ? ? ? no "?" no no "10" yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.VKORG
"rowObject.VKORG" ? ? "character" ? ? ? ? ? ? no "?" no no "10" yes no no "U" "" ""
     _FldNameList[5]   > _<SDO>.rowObject.VTWEG
"rowObject.VTWEG" ? ? "character" ? ? ? ? ? ? no "?" no no "10" yes no no "U" "" ""
     _FldNameList[6]   > _<SDO>.rowObject.SPART
"rowObject.SPART" ? ? "character" ? ? ? ? ? ? no "?" no no "10" yes no no "U" "" ""
