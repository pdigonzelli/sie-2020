...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Silo ~
rowObject.hora_comienzo rowObject.hora_termino rowObject.kilos ~
rowObject.kilos_descarte_packing rowObject.id_pesada 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Silo FORMAT "x(15)":U
      hora_comienzo FORMAT "X(8)":U
      hora_termino FORMAT "X(8)":U
      kilos FORMAT ">>>,>>>,>>9.99":U
      kilos_descarte_packing FORMAT ">>>,>>>,>>9.99":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Silo
     _FldNameList[2]   = _<SDO>.rowObject.hora_comienzo
     _FldNameList[3]   = _<SDO>.rowObject.hora_termino
     _FldNameList[4]   = _<SDO>.rowObject.kilos
     _FldNameList[5]   = _<SDO>.rowObject.kilos_descarte_packing
     _FldNameList[6]   = _<SDO>.rowObject.id_pesada
...
DO:
  ...
  CASE INTEGER(DYNAMIC-FUNCTION('columnValue' IN hSource, 'id_turno')):
    WHEN 1 THEN iBgColor = 23.
    WHEN 2 THEN iBgColor = 19.
    WHEN 3 THEN iBgColor = 25.
  END CASE.

  IF (rowObject.rowNum MODULO 2 <> 0) THEN iBgColor = 15.

  ASSIGN rowObject.silo:BGCOLOR IN BROWSE br_table                    = ibgcolor
         rowObject.hora_comienzo:BGCOLOR IN BROWSE br_table           = ibgcolor
         rowObject.hora_termino:BGCOLOR IN BROWSE br_table            = ibgcolor
         rowObject.kilos:BGCOLOR IN BROWSE br_table                   = ibgcolor
         rowObject.kilos_descarte_packing:BGCOLOR IN BROWSE br_table  = ibgcolor
         .
END.
