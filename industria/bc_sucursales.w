...
&Scoped-define INTERNAL-TABLES comercial.sucursales

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table comercial.sucursales.id_sucursal ~
comercial.sucursales.nombre 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH comercial.sucursales WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table comercial.sucursales
&Scoped-define FIRST-TABLE-IN-QUERY-br_table comercial.sucursales
...
<FOREIGN-KEYS>
id_tipo_sucursal|y|y|comercial.comercial.sucursales.id_tipo_sucursal
id_categoria||y|comercial.comercial.sucursales.id_categoria
id_sucursal||y|comercial.comercial.sucursales.id_sucursal
codigo_dgi||y|comercial.comercial.sucursales.codigo_dgi
abreviatura||y|comercial.comercial.sucursales.abreviatura
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
DEFINE QUERY br_table FOR 
      comercial.sucursales SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      comercial.sucursales.id_sucursal
      comercial.sucursales.nombre
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "comercial.comercial.sucursales"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = comercial.comercial.sucursales.id_sucursal
     _FldNameList[2]   = comercial.comercial.sucursales.nombre
...
label 'id_sucursal( comercial.sucursales ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=comercial.sucursales.id_sucursal').
                  run set-attribute-list('titulo=Sucursal').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by comercial.sucursales.id_sucursal
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item sucursales-nombre
label 'nombre( comercial.sucursales ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=comercial.sucursales.nombre').
                  run set-attribute-list('titulo=Nombre').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by comercial.sucursales.nombre
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by comercial.sucursales.id_sucursal
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_tipo_sucursal':U THEN DO:
       &Scope KEY-PHRASE comercial.sucursales.id_tipo_sucursal eq INTEGER(key-value)
       {&OPEN-QUERY-{&BROWSE-NAME}}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_sucursal" "comercial.sucursales" "id_tipo_sucursal"}
  {src/adm/template/sndkycas.i "id_categoria" "comercial.sucursales" "id_categoria"}
  {src/adm/template/sndkycas.i "id_sucursal" "comercial.sucursales" "id_sucursal"}
  {src/adm/template/sndkycas.i "codigo_dgi" "comercial.sucursales" "codigo_dgi"}
  {src/adm/template/sndkycas.i "abreviatura" "comercial.sucursales" "abreviatura"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "comercial.sucursales"}
