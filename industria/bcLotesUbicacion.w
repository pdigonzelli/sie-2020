...
rowObject.loteDesposito rowObject.id_articulo rowObject.cantidad ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      lote FORMAT "XXXXXX/XXXX":U WIDTH 15.6
      loteDesposito FORMAT "x(8)":U
      id_articulo FORMAT ">>>,>>9":U
      cantidad FORMAT ">>>>>9":U
      cantidad_comprometida FORMAT ">>>,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 99 BY 14.05 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dclotesubicacion.w"
   Allow: Basic,Browse
   Frames: 1
...
"lote" ? ? "character" ? ? ? ? ? ? no "?" no no "15.6" yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.loteDesposito
     _FldNameList[3]   = _<SDO>.rowObject.id_articulo
     _FldNameList[4]   = _<SDO>.rowObject.cantidad
     _FldNameList[5]   = _<SDO>.rowObject.cantidad_comprometida
