...
&Scoped-Define ENABLED-OBJECTS fiCant RECT-1 
&Scoped-Define DISPLAYED-OBJECTS fiCant 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Reproceso de Producciones"
         HEIGHT             = 17.95
         WIDTH              = 67.2
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Reproceso de Producciones */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Reproceso de Producciones */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dproduccioncascara ( 1.71 , 55.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_bproduccioncascara ( 7.43 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_bproduccioncascara ( 11.43 , 67.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsid_sucursal,Fecha,id_produccionOperatorStyleImplicitOperatorViewAsCombo-boxOperator=UseBeginsyesUseContainsyesDefaultWidth16DefaultCharWidth20DefaultEditorLines1ViewAsFieldsFieldOperatorStylesFieldFormatsFieldWidthsFieldLabelsFieldToolTipsFieldHelpIdsFecha0id_sucursal0id_produccion0DesignDataObjectFieldColumn20HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynfilter ).
       RUN repositionObject IN h_dynfilter ( 2.67 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_dynfilter ( 4.43 , 65.00 ) NO-ERROR.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  DEFINE VARIABLE vlRep AS LOGICAL    NO-UNDO.

  vlRep = DYNAMIC-FUNCTION('reprocesarProduccion' IN h_dProduccionCascara, DYNAMIC-FUNCTION('columnValue' IN h_dProduccionCascara, 'id_empresa'), 
                                                                           ...
                                                                           INTEGER(fiCant:SCREEN-VALUE IN FRAME fMain)).
  RUN refreshRow IN h_dProduccionCascara.
  IF NOT vlRep THEN 
    MESSAGE "Error en la rutina dProduccionCascara.reprocesarProduccion(). La transaccion no se realizara." VIEW-AS ALERT-BOX.
END PROCEDURE.
