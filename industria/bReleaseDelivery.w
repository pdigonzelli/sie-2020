...
rowObject.Cantidad rowObject.fecha_creacion rowObject.fecha_entrega ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.numero_release FORMAT "->,>>>,>>9":U
      rowObject.Cantidad FORMAT "zzz,zz9.99":U
      rowObject.fecha_creacion FORMAT "99/99/9999":U
      rowObject.fecha_entrega FORMAT "99/99/9999":U
      rowObject.fecha_confirmacion_entrega FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"rowObject.numero_release" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.Cantidad
     _FldNameList[3]   = _<SDO>.rowObject.fecha_creacion
     _FldNameList[4]   > _<SDO>.rowObject.fecha_entrega
"rowObject.fecha_entrega" ? ? "date" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[5]   = _<SDO>.rowObject.fecha_confirmacion_entrega
...
DO:
  ...
  RUN openQueryLoteUbicacion IN hContainer (DYNAMIC-FUNCTION('columnValue' IN hData, 'id_cliente')).
  RUN enableReleaseUpdate IN hContainer (DYNAMIC-FUNCTION('columnValue' IN hData, 'id_release_delivery')).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE recorreBrowser bTableWin 
PROCEDURE recorreBrowser :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  ...
  hBro = DYNAMIC-FUNCTION('getBrowseHandle').
  hCol = hBro:GET-BROWSE-COLUMN(1).
