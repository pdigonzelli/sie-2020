...
define var art_sobrante as integer.
define var art_arrastre as integer.
...
tambores_industria.id_tambor productos_terminados.descripcion ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria WHERE ~{&KEY-PHRASE} ~
 ...
 AND (industria.tambores_industria.id_tipotambor = 4 ~
      OR tambores_industria.id_tipotambor = 5) ~
 AND (industria.tambores_industria.id_articulo = art_sobrante ~
      OR tambores_industria.id_articulo = art_arrastre) ~
 AND tambores_industria.Fecha <= fecha ~
 AND tambores_industria.id_lote <> lote ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      sucursales.abreviatura COLUMN-LABEL "Sucursal" FORMAT "X(10)":U
            WIDTH 12.2
      tambores_industria.id_lote FORMAT ">>>9":U WIDTH 6.6
      tambores_industria.Anio FORMAT ">>>9":U WIDTH 6.2
      tambores_industria.id_tambor FORMAT ">>9":U WIDTH 8.2
      productos_terminados.descripcion COLUMN-LABEL "Producto" FORMAT "x(30)":U
      tambores_industria.kilos_tambor FORMAT ">>>9.99":U WIDTH 11.4
      tambores_industria.Fecha FORMAT "99/99/9999":U WIDTH 13.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS MULTIPLE SIZE 132 BY 15.14
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
 ...
 AND (industria.tambores_industria.id_tipotambor = 4
      OR general.tambores_industria.id_tipotambor = 5)
 AND (industria.tambores_industria.id_articulo = art_sobrante
      OR general.tambores_industria.id_articulo = art_arrastre)
 AND general.tambores_industria.Fecha <= fecha
 AND general.tambores_industria.id_lote <> lote
...
"comercial.sucursales.abreviatura" "Sucursal" ? "character" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[2]   > general.tambores_industria.id_lote
"general.tambores_industria.id_lote" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "6.6" yes no no "U" "" ""
     _FldNameList[3]   > general.tambores_industria.Anio
"general.tambores_industria.Anio" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "6.2" yes no no "U" "" ""
     _FldNameList[4]   > general.tambores_industria.id_tambor
...
"general.productos_terminados.descripcion" "Producto" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > general.tambores_industria.kilos_tambor
"general.tambores_industria.kilos_tambor" ? ">>>9.99" "decimal" ? ? ? ? ? ? no ? no no "11.4" yes no no "U" "" ""
     _FldNameList[7]   > general.tambores_industria.Fecha
"general.tambores_industria.Fecha" ? ? "date" ? ? ? ? ? ? no ? no no "13.2" yes no no "U" "" ""
...
run get-articulo in hcontainer (output art_sobrante, 
                                output art_arrastre, 
                                output fecha, 
                                output lote, 
                                output sucursal).

/* message articulo fecha lote. */
