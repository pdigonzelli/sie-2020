...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipos_contratos
&Scoped-define FIRST-EXTERNAL-TABLE tipos_contratos


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipos_contratos.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipos_contratos.id_tipo_contrato ~
tipos_contratos.descripcion tipos_contratos.id_articulo ~
tipos_contratos.id_calidad 
...
&Scoped-define ENABLED-TABLES tipos_contratos
&Scoped-define FIRST-ENABLED-TABLE tipos_contratos
&Scoped-Define DISPLAYED-FIELDS tipos_contratos.id_tipo_contrato ~
tipos_contratos.descripcion tipos_contratos.id_articulo ~
tipos_contratos.id_calidad 
...
&Scoped-define ADM-CREATE-FIELDS tipos_contratos.id_tipo_contrato 
...
DEFINE FRAME F-Main
     tipos_contratos.id_tipo_contrato AT ROW 1 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     tipos_contratos.descripcion AT ROW 2 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.6 BY 1
     tipos_contratos.id_articulo AT ROW 3.14 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
     fi-productos_terminados-descrip AT ROW 3.14 COL 29 COLON-ALIGNED NO-LABEL
     tipos_contratos.id_calidad AT ROW 4.1 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     fi-calidades-descripcion AT ROW 4.1 COL 30 COLON-ALIGNED NO-LABEL
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipos_contratos
...
/* SETTINGS FOR FILL-IN fi-productos_terminados-descrip IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN tipos_contratos.id_tipo_contrato IN FRAME F-Main
   1                                                                    */
...
general.tipos_contratos.id_articulo;wc_articulos.w;productos_terminados.descripcion;;
general.tipos_contratos.id_calidad;wc_calidades.w;calidades.descripcion;;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME tipos_contratos.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.descripcion V-table-Win
ON LEAVE OF tipos_contratos.descripcion IN FRAME F-Main /* Descripción */
DO:
...
&Scoped-define SELF-NAME tipos_contratos.id_articulo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.id_articulo V-table-Win
ON GO OF tipos_contratos.id_articulo IN FRAME F-Main /* Artículo */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.id_articulo V-table-Win
ON LEAVE OF tipos_contratos.id_articulo IN FRAME F-Main /* Artículo */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.id_articulo V-table-Win
ON MOUSE-SELECT-DBLCLICK OF tipos_contratos.id_articulo IN FRAME F-Main /* Artículo */
do: 
define var r as rowid no-undo.
run wc_articulos.w(output r).
find productos_terminados where rowid(productos_terminados) = r no-lock no-error.
if available productos_terminados then 
general.tipos_contratos.id_articulo:screen-value = string(productos_terminados.id_articulo).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.id_articulo V-table-Win
ON U1 OF tipos_contratos.id_articulo IN FRAME F-Main /* Artículo */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&Scoped-define SELF-NAME tipos_contratos.id_calidad
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.id_calidad V-table-Win
ON GO OF tipos_contratos.id_calidad IN FRAME F-Main /* Cod. Calidad */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.id_calidad V-table-Win
ON LEAVE OF tipos_contratos.id_calidad IN FRAME F-Main /* Cod. Calidad */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.id_calidad V-table-Win
ON MOUSE-SELECT-DBLCLICK OF tipos_contratos.id_calidad IN FRAME F-Main /* Cod. Calidad */
do: 
define var r as rowid no-undo.
run wc_calidades.w(output r).
find calidades where rowid(calidades) = r no-lock no-error.
if available calidades then 
general.tipos_contratos.id_calidad:screen-value = string(calidades.id_calidad).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.id_calidad V-table-Win
ON U1 OF tipos_contratos.id_calidad IN FRAME F-Main /* Cod. Calidad */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&Scoped-define SELF-NAME tipos_contratos.id_tipo_contrato
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contratos.id_tipo_contrato V-table-Win
ON LEAVE OF tipos_contratos.id_tipo_contrato IN FRAME F-Main /* Tipo de contrato */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipos_contratos"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipos_contratos"}
...
find first productos_terminados where productos_terminados.id_articulo = integer(tipos_contratos.id_articulo:screen-value in frame F-Main)  no-lock no-error .
if available productos_terminados then 
...
find first calidades where calidades.id_calidad = integer(tipos_contratos.id_calidad:screen-value in frame F-Main)  no-lock no-error .
if available calidades then 
...
define var lista_relacion as character no-undo initial "id_articulo,id_calidad".
