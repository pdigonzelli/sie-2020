...
&Scoped-define INTERNAL-TABLES distribucion_contratos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table distribucion_contratos.item ~
distribucion_contratos.semana distribucion_contratos.cantidad_pallets 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH distribucion_contratos OF items_contratos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table distribucion_contratos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table distribucion_contratos
...
<FOREIGN-KEYS>
id_tipo_contrato||y|general.distribucion_contratos.id_tipo_contrato
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
DEFINE QUERY br_table FOR 
      distribucion_contratos SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      distribucion_contratos.item FORMAT ">>9":U WIDTH 8.2
      distribucion_contratos.semana FORMAT ">>9":U WIDTH 8.4
      distribucion_contratos.cantidad_pallets FORMAT "->>,>>9.99":U
            WIDTH 23.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.distribucion_contratos OF general.items_contratos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.distribucion_contratos.item
"distribucion_contratos.item" ? ">>9" "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[2]   > general.distribucion_contratos.semana
"distribucion_contratos.semana" ? ? "integer" ? ? ? ? ? ? no ? no no "8.4" yes no no "U" "" ""
     _FldNameList[3]   > general.distribucion_contratos.cantidad_pallets
"distribucion_contratos.cantidad_pallets" ? ? "decimal" ? ? ? ? ? ? no ? no no "23.2" yes no no "U" "" ""
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_contrato" "distribucion_contratos" "id_tipo_contrato"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "distribucion_contratos"}
