...
DEFINE VARIABLE h_bc_lotes_orden_fabricacion AS HANDLE NO-UNDO.
...
/******************************************************/
  run devuelve-valor (output p1, output p2, output p3).
  /*r=rresult.  */
  r1 = p1.
  r2 = p2.
  r3 = p3.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_lotes_orden_fabricacion.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_lotes_orden_fabricacion ).
       RUN set-position IN h_bc_lotes_orden_fabricacion ( 2.24 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 150.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_lotes_orden_fabricacion ,
...
do:
    ...
    do:
        run devuelve-rowid in h (output p1, output p2, output p3).
        /*cresult = r.*/
    end.
    else
        do:
