...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-8 
...
DEFINE VARIABLE h_b_tipo_venta AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-8 AT ROW 1.71 COL 7
     SPACE(9.99) SKIP(2.47)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipo_venta.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipo_venta ).
       RUN set-position IN h_b_tipo_venta ( 2.43 , 11.00 ) NO-ERROR.
       RUN set-size IN h_b_tipo_venta ( 6.71 , 66.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipo_venta ,
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-8 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
