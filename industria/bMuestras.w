...
rowObject.anio_muestra rowObject.fecha rowObject.directo_cliente 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      directo_cliente FORMAT "si/no":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
ASSIGN 
       rowObject.directo_cliente:AUTO-RESIZE IN BROWSE br_table = TRUE.
...
"id_muestra" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[4]   > _<SDO>.rowObject.directo_cliente
"directo_cliente" ? ? "logical" ? ? ? ? ? ? no ? no no ? yes yes no "U" "" ""
