...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-9 aceptar salir 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_tipo_contenedor ( 2.43 , 11.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-1 RECT-9 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
