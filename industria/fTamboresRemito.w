...
DEFINE FRAME fMain
     ...
     fiLote AT ROW 2.91 COL 44 COLON-ALIGNED
     fiArticulo AT ROW 4.1 COL 44 COLON-ALIGNED
     fiCalidad AT ROW 5.29 COL 44 COLON-ALIGNED
     fiEnvase AT ROW 6.48 COL 44 COLON-ALIGNED
     fiDesde AT ROW 7.67 COL 44 COLON-ALIGNED
     fiHasta AT ROW 8.86 COL 44 COLON-ALIGNED
...
ON CHOOSE OF btnAdd IN FRAME fMain /* Agregar */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY RADIO-SET-1 fiLote fiArticulo fiCalidad fiEnvase fiDesde fiHasta 
      WITH FRAME fMain.
  ENABLE btnAdd btnDel RADIO-SET-1 RECT-25 RECT-6 RECT-7 
      WITH FRAME fMain.
