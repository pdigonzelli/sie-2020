...
DEFINE VAR v_of AS INTEGER.
DEFINE VAR v_anio_of AS INTEGER.
...
&Scoped-Define ENABLED-FIELDS remitos.mercado remitos.id_orden_entrega ~
remitos.item_oe remitos.nro_orden_fab remitos.id_destino remitos.id_lugdes ~
remitos.id_cliente remitos.id_vapor remitos.id_proveedor ~
remitos.nro_ord_carga remitos.chofer remitos.pat_chasis remitos.Pat_acopla ~
remitos.Peso_bruto remitos.Peso_neto remitos.bultos remitos.Valor_declarado ~
remitos.id_ciaseg remitos.nro_precinto remitos.anio_produccion ~
remitos.nro_per_embarque remitos.nro_contenedor remitos.nro_iascav ~
remitos.observaciones 
&Scoped-define ENABLED-TABLES remitos
&Scoped-define FIRST-ENABLED-TABLE remitos
&Scoped-Define DISPLAYED-FIELDS remitos.mercado remitos.id_orden_entrega ~
remitos.item_oe remitos.nro_orden_fab remitos.id_destino remitos.id_lugdes ~
remitos.id_cliente remitos.id_vapor remitos.id_proveedor ~
remitos.nro_ord_carga remitos.chofer remitos.pat_chasis remitos.Pat_acopla ~
remitos.Peso_bruto remitos.Peso_neto remitos.bultos remitos.Valor_declarado ~
...
DEFINE FRAME F-Main
     remitos.mercado AT ROW 1 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 3.4 BY 1
     remitos.id_orden_entrega AT ROW 1 COL 88 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
     remitos.item_oe AT ROW 1 COL 108 COLON-ALIGNED
          LABEL "Item OE" FORMAT ">9"
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     remitos.nro_orden_fab AT ROW 1 COL 125 COLON-ALIGNED
          LABEL "OF" FORMAT "x(8)"
          VIEW-AS FILL-IN 
          SIZE 13.6 BY 1
     remitos.id_destino AT ROW 1.95 COL 21 COLON-ALIGNED
          LABEL "Destino" FORMAT ">>>9"
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
     remitos.id_lugdes AT ROW 1.95 COL 88 COLON-ALIGNED
          LABEL "Lugar descarga" FORMAT ">>>9"
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     remitos.id_cliente AT ROW 2.95 COL 21 COLON-ALIGNED
          LABEL "Cliente" FORMAT ">>>>>9"
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     remitos.id_vapor AT ROW 2.91 COL 88 COLON-ALIGNED
          LABEL "Vapor" FORMAT ">>>>9"
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     remitos.id_proveedor AT ROW 3.86 COL 21 COLON-ALIGNED
          LABEL "Transporte" FORMAT ">>>>>9"
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     remitos.nro_ord_carga AT ROW 3.86 COL 88 COLON-ALIGNED
          LABEL "N° Orden Carga" FORMAT ">>>>>>9"
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     remitos.chofer AT ROW 4.81 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 46 BY 1
     remitos.pat_chasis AT ROW 4.81 COL 88 COLON-ALIGNED
          LABEL "Chasis/Acoplado"
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
     remitos.Pat_acopla AT ROW 4.81 COL 106 COLON-ALIGNED NO-LABEL FORMAT "X(10)"
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
     remitos.Peso_bruto AT ROW 5.76 COL 21 COLON-ALIGNED
          LABEL "Peso Bruto" FORMAT "->>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 21 BY 1
     remitos.Peso_neto AT ROW 5.76 COL 56 COLON-ALIGNED
          LABEL "Peso Neto" FORMAT "->>>,>>9.9999"
          VIEW-AS FILL-IN 
          SIZE 21 BY 1
     remitos.bultos AT ROW 5.76 COL 88 COLON-ALIGNED
          LABEL "Bultos" FORMAT ">>>>9.99"
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     remitos.Valor_declarado AT ROW 6.71 COL 21 COLON-ALIGNED FORMAT "->>>>>>9.99"
          VIEW-AS FILL-IN 
          SIZE 19 BY 1
     remitos.id_ciaseg AT ROW 6.71 COL 52 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     remitos.nro_precinto AT ROW 6.71 COL 114 COLON-ALIGNED
          LABEL "Nro Precinto" FORMAT "X(30)"
          VIEW-AS FILL-IN 
          SIZE 34 BY 1
     remitos.anio_produccion AT ROW 7.67 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     remitos.nro_per_embarque AT ROW 7.67 COL 52 COLON-ALIGNED
          LABEL "Nro Perm Embarque" FORMAT "x(10)"
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
     remitos.nro_contenedor AT ROW 7.67 COL 87 COLON-ALIGNED
          LABEL "Nro Contenedor"
          VIEW-AS FILL-IN 
          SIZE 21 BY 1
     remitos.nro_iascav AT ROW 8.62 COL 21 COLON-ALIGNED
          LABEL "IASCAV" FORMAT "x(80)"
          VIEW-AS FILL-IN 
          SIZE 63 BY 1
...
DEFINE FRAME F-Main
     remitos.observaciones AT ROW 9.57 COL 9.8 FORMAT "x(200)"
          VIEW-AS FILL-IN 
          SIZE 126 BY 1
     fi-destinos-descripcion AT ROW 1.95 COL 30 COLON-ALIGNED NO-LABEL
     fi-lugar_descarga-descripcion AT ROW 1.95 COL 95 COLON-ALIGNED NO-LABEL
     fi-clientes-razon_social AT ROW 2.91 COL 33 COLON-ALIGNED NO-LABEL
     fi-vapores-descripcion AT ROW 2.91 COL 98 COLON-ALIGNED NO-LABEL
     fi-proveedores-nombre AT ROW 3.86 COL 33 COLON-ALIGNED NO-LABEL
     fi-cia_seguro-descripcion AT ROW 6.71 COL 59 COLON-ALIGNED NO-LABEL
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE .
...
/* SETTINGS FOR FILL-IN remitos.id_destino IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN remitos.id_lugdes IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN remitos.id_proveedor IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
...
/* SETTINGS FOR FILL-IN remitos.nro_precinto IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN remitos.observaciones IN FRAME F-Main
   ALIGN-L EXP-FORMAT                                                   */
...
ON LEAVE OF remitos.anio_produccion IN FRAME F-Main /* Año producción */
DO:
...
ON GO OF remitos.id_ciaseg IN FRAME F-Main /* Cía.seguro */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL remitos.id_ciaseg V-table-Win
ON LEAVE OF remitos.id_ciaseg IN FRAME F-Main /* Cía.seguro */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL remitos.id_ciaseg V-table-Win
ON MOUSE-SELECT-DBLCLICK OF remitos.id_ciaseg IN FRAME F-Main /* Cía.seguro */
do: 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL remitos.id_ciaseg V-table-Win
ON U1 OF remitos.id_ciaseg IN FRAME F-Main /* Cía.seguro */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
ON GO OF remitos.id_proveedor IN FRAME F-Main /* Transporte */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL remitos.id_proveedor V-table-Win
ON LEAVE OF remitos.id_proveedor IN FRAME F-Main /* Transporte */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL remitos.id_proveedor V-table-Win
ON MOUSE-SELECT-DBLCLICK OF remitos.id_proveedor IN FRAME F-Main /* Transporte */
do: 
define var r as rowid no-undo.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL remitos.id_proveedor V-table-Win
ON U1 OF remitos.id_proveedor IN FRAME F-Main /* Transporte */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&Scoped-define SELF-NAME remitos.observaciones
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL remitos.observaciones V-table-Win
ON LEAVE OF remitos.observaciones IN FRAME F-Main /* Observación */
DO:
{custom/support/validacion.i}
END.
...
/**********EMPIEZA-TIPO-DETALLE*********/
  run set-attribute-list ('tipo-detalle=items'). 
    ...
    IF items_factura.id_tipotambor <> 11 THEN DO:
        ...
        FOR EACH tambores_industria WHERE tambores_industria.id_sucursal_remito = items_factura.id_sucursal
            ...
            IF tambores_industria.tara = 0 THEN
              v_kilos_bruto    = v_kilos_bruto + tambores_industria.kilos_tambor + envases_prod.tara.
            ELSE
              v_kilos_bruto    = v_kilos_bruto + tambores_industria.kilos_tambor + tambores_industria.tara.
        END.
    END.
    ELSE DO:
        v_kilos = v_kilos + items_factura.kilos.
        v_tambores = v_tambores + items_factura.cantidad.
        FIND FIRST envases_prod OF items_factura NO-LOCK NO-ERROR.
        v_kilos_bruto = v_kilos_bruto + IF AVAILABLE envases_prod THEN (items_factura.kilos * envases_prod.tara)
                                                                  ELSE items_factura.kilos.
    END.
END.
...
IF v_kilos <> remitos.peso_neto THEN DO:
    ...
    remitos.bultos:SCREEN-VALUE IN FRAME F-Main = STRING(v_tambores).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN remitos.orden_fabricacion = v_of
       remitos.anio_of           = v_anio_of.
END PROCEDURE.
...
FIND FIRST destinos WHERE destinos.id_destino = INTEGER(remitos.id_destino:SCREEN-VALUE IN FRAME F-Main) NO-LOCK NO-ERROR.
  IF AVAILABLE destinos THEN
    fi-destinos-descripcion:SCREEN-VALUE IN FRAME F-Main = destinos.descripcion.
  ELSE
  ...
  IF AVAILABLE clientes THEN
    fi-clientes-razon_social:SCREEN-VALUE IN FRAME F-Main = clientes.razon_social.
  ELSE
  ...
  IF AVAILABLE lugar_descarga THEN
    fi-lugar_descarga-descripcion:SCREEN-VALUE IN FRAME F-Main = lugar_descarga.descripcion.
  ELSE
  ...
  IF AVAILABLE vapores THEN
    fi-vapores-descripcion:SCREEN-VALUE IN FRAME F-Main = vapores.descripcion.
  ELSE
  ...
  IF AVAILABLE proveedores THEN
    fi-proveedores-nombre:SCREEN-VALUE IN FRAME F-Main = proveedores.nombre.
  ELSE
  ...
  IF AVAILABLE proveedores THEN
    fi-cia_seguro-descripcion:SCREEN-VALUE IN FRAME F-Main = cia_seg.descripcion.
  ELSE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE descriptivos-oe V-table-Win 
PROCEDURE descriptivos-oe :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF INTEGER(remitos.id_orden_entrega:SCREEN-VALUE IN FRAME f-Main) <> 0 THEN DO:
    
    FIND FIRST orden_entrega WHERE orden_entrega.id_orden_entrega = 
                                   INTEGER(remitos.id_orden_entrega:SCREEN-VALUE IN FRAME f-Main) 
                                NO-LOCK NO-ERROR.
    IF AVAILABLE orden_entrega THEN DO:
        remitos.id_destino:SCREEN-VALUE IN FRAME F-Main = STRING(orden_entrega.id_destino).
        remitos.id_lugdes:SCREEN-VALUE IN FRAME F-Main = STRING(orden_entrega.id_lugdes).
        remitos.id_vapor:SCREEN-VALUE IN FRAME F-Main = STRING(orden_entrega.id_vapor).
    END.
    
    FIND FIRST items_orden_entrega WHERE items_orden_entrega.id_orden_entrega = 
                                         INTEGER(remitos.id_orden_entrega:SCREEN-VALUE IN FRAME f-Main)
                                     AND items_orden_entrega.ITEM_oe =
                                         INTEGER(remitos.ITEM_oe:SCREEN-VALUE IN FRAME f-Main) 
                                NO-LOCK NO-ERROR.
    IF AVAILABLE items_orden_entrega THEN DO:
        remitos.id_cliente:SCREEN-VALUE IN FRAME F-Main = STRING(items_orden_entrega.id_cliente).
        FIND FIRST contratos OF items_orden_entrega NO-LOCK NO-ERROR.
        IF AVAILABLE contratos THEN DO:
            remitos.nro_orden_fab:SCREEN-VALUE IN FRAME F-Main = STRING(contratos.orden_fabricacion)
                                                               + "/"
                                                               + SUBSTRING(STRING(industria.contratos.anio),3,2)
                                                                .
            v_of        = contratos.orden_fabricacion.
            v_anio_of   = contratos.anio.
        END.
    END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
remitos.id_ciaseg:SCREEN-VALUE IN FRAME F-Main = "17".
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  case nombre:
    ...
    END.
        ...
        WHEN "id_proveedor" THEN DO:
            FIND FIRST proveedores WHERE proveedores.id_proveedor = INTEGER(valor)
                                     NO-LOCK NO-ERROR.
            IF AVAILABLE proveedores THEN DO:
                IF NOT proveedores.estado THEN DO:
                    mensaje = "El transportistas ingresado no esta habilitado".
                    RETURN FALSE.
                END.
            END.
            ELSE DO:
                mensaje = "No existe el transportista ingresado.!".
                RETURN FALSE.
            END.
        END.
    end case.
