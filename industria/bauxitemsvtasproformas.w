...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.item rowObject.nro_lote ~
rowObject.desde_lote rowObject.hasta_lote rowObject.nro_contenedor ~
rowObject.cantidad_bolsas rowObject.kilos_item rowObject.abreviatura ~
rowObject.abreviatura-2 rowObject.abreviatura-3 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.nro_lote FORMAT "X(8)":U
      rowObject.desde_lote FORMAT ">>>>>9":U
      rowObject.hasta_lote FORMAT ">>>>>9":U
      rowObject.nro_contenedor FORMAT "X(18)":U
      rowObject.cantidad_bolsas FORMAT ">>>,>>9":U
      rowObject.kilos_item FORMAT "->>,>>9.99":U WIDTH 13
      rowObject.abreviatura FORMAT "X(12)":U WIDTH 14.8
      rowObject.abreviatura-2 FORMAT "X(10)":U WIDTH 13.2
      rowObject.abreviatura-3 FORMAT "x(12)":U WIDTH 22.6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 138 BY 6.67 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dauxitemsvtasproformas.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.nro_lote
     _FldNameList[3]   = _<SDO>.rowObject.desde_lote
     _FldNameList[4]   = _<SDO>.rowObject.hasta_lote
     _FldNameList[5]   = _<SDO>.rowObject.nro_contenedor
     _FldNameList[6]   = _<SDO>.rowObject.cantidad_bolsas
     _FldNameList[7]   > _<SDO>.rowObject.kilos_item
"rowObject.kilos_item" ? ? "decimal" ? ? ? ? ? ? no ? no no "13" yes no no "U" "" ""
     _FldNameList[8]   > _<SDO>.rowObject.abreviatura
"rowObject.abreviatura" ? ? "character" ? ? ? ? ? ? no ? no no "14.8" yes no no "U" "" ""
     _FldNameList[9]   > _<SDO>.rowObject.abreviatura-2
"rowObject.abreviatura-2" ? ? "character" ? ? ? ? ? ? no ? no no "13.2" yes no no "U" "" ""
     _FldNameList[10]   > _<SDO>.rowObject.abreviatura-3
"rowObject.abreviatura-3" ? ? "character" ? ? ? ? ? ? no ? no no "22.6" yes no no "U" "" ""
