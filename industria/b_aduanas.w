...
&Scoped-define INTERNAL-TABLES aduanas

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table aduanas.id_aduana ~
aduanas.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH aduanas WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table aduanas
&Scoped-define FIRST-TABLE-IN-QUERY-br_table aduanas
...
<FOREIGN-KEYS>
id_aduana||y|general.aduanas.id_aduana
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.aduanas"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.aduanas.id_aduana
     _FldNameList[2]   = general.aduanas.descripcion
...
define sub-menu Ordena 
  menu-item aduanas-id_aduana
label 'id_aduana( aduanas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=aduanas.id_aduana').
                  run set-attribute-list('titulo=id_aduana').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by aduanas.id_aduana
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_aduana" "aduanas" "id_aduana"}
