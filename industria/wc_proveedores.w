...
DEFINE VARIABLE h_bc_proveedores AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_proveedores.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_proveedores ).
       RUN set-position IN h_bc_proveedores ( 2.52 , 11.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 69.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_proveedores ,
