...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-10 
...
DEFINE VARIABLE h_bc_tipo_pallets AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-10 AT ROW 1.71 COL 2
     SPACE(2.99) SKIP(2.95)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_tipo_pallets.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_tipo_pallets ).
       RUN set-position IN h_bc_tipo_pallets ( 2.19 , 4.00 ) NO-ERROR.
       RUN set-size IN h_bc_tipo_pallets ( 6.71 , 81.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_tipo_pallets ,
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-10 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
