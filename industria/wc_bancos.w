...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.29 COL 128
     salir AT ROW 10.29 COL 140
     RECT-1 AT ROW 10.05 COL 125
     SPACE(3.99) SKIP(0.80)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b_bancos ).
       RUN set-position IN h_b_bancos ( 2.43 , 2.00 ) NO-ERROR.
