...
FIND LAST lotes_jugo WHERE id_lote = 23
                       AND id_sucursal = 96
                       AND anio = 2003
                       AND id_articulo = 53.
...
/*****************GENERO LA ETIQUETA NUMERO CERO***********************************************************/
            ...
            if lotes_jugo.id_articulo = 52 then
                do:
                  put control "^FO30,100^A0N,40,40^FD" "PRODUCT: CONCENTRATED LEMON JUICE" "^FS".
                end.
            if lotes_jugo.id_articulo = 53 then
                do:
                    put control "^FO30,100^A0N,40,35^FD" "PRODUCT: CONCENTRATED LEMON JUICE CLEAR" "^FS".
                end.


            put control "^FO45,220^A0N,36,23^FD" "RNE:23001973" "^FS".
            put control "^FO446,220^A0N,36,23^FD" "RNPA:23026750" "^FS".
...
/*********************************************************************************************************/            
            ...
            */         
            ...
            do:  
                ...
                if available r_productos_calidad and r_productos_calidad.rnpa <> "" then
                  do:
                    put control "^FO45,220^A0N,36,23^FD" "RNE:23000573 " "^FS".
                    put control "^FO446,220^A0N,36,23^FD" "RNPA:" + r_productos_calidad.rnpa + "^FS".
                  end.
                else 
                  do:
                    MESSAGE "Esta por imprimir una etiqueta que no tiene asociado un RNPA definido. Desea imprimir
