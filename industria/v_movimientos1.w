...
&Scoped-Define ENABLED-FIELDS movimientos_industria.id_empresa ~
movimientos_industria.fecha movimientos_industria.id_tipo_movimiento ~
movimientos_industria.id_sucursal ~
movimientos_industria.id_tipo_mov_existente movimientos_industria.estado ~
movimientos_industria.id_movimiento movimientos_industria.id_etiqueta ~
movimientos_general.items_movimientos ~
movimientos_industria.id_empresa_origen ~
movimientos_industria.id_empresa_destino ~
movimientos_industria.id_sucursal_destino ~
movimientos_industria.id_sucursal_origen ~
movimientos_industria.id_locacion_destino ~
movimientos_industria.id_locacion_origen ~
movimientos_industria.id_posicion_origen ~
movimientos_industria.id_posicion_destino 
&Scoped-define FIELD-PAIRS~
 ...
 ~{&FP1}id_movimiento ~{&FP2}id_movimiento ~{&FP3}~
 ~{&FP1}id_etiqueta ~{&FP2}id_etiqueta ~{&FP3}~
 ~{&FP1}items_movimientos ~{&FP2}items_movimientos ~{&FP3}~
...
&Scoped-Define DISPLAYED-FIELDS movimientos_industria.id_empresa ~
movimientos_industria.fecha movimientos_industria.id_tipo_movimiento ~
movimientos_industria.id_sucursal ~
movimientos_industria.id_tipo_mov_existente movimientos_industria.estado ~
movimientos_industria.id_movimiento movimientos_industria.id_etiqueta ~
...
&Scoped-define ADM-CREATE-FIELDS movimientos_industria.id_empresa ~
movimientos_industria.id_tipo_movimiento movimientos_industria.id_sucursal ~
movimientos_industria.id_tipo_mov_existente ~
movimientos_industria.id_movimiento 
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_sucursal,id_etiqueta,id_tipo_movimiento"':U).
/**************************
</EXECUTING-CODE> */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     movimientos_industria.id_empresa AT ROW 1 COL 13 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     movimientos_industria.fecha AT ROW 1 COL 92 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     movimientos_industria.id_tipo_movimiento AT ROW 1.1 COL 62 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     movimientos_industria.id_sucursal AT ROW 2 COL 13 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     movimientos_industria.id_tipo_mov_existente AT ROW 2.1 COL 62 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     movimientos_industria.estado AT ROW 2.14 COL 92 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.6 BY 1
     movimientos_industria.id_movimiento AT ROW 3 COL 13 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     movimientos_industria.id_etiqueta AT ROW 3.1 COL 62 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.4 BY 1
     movimientos_general.items_movimientos AT ROW 4.05 COL 13 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     movimientos_industria.id_empresa_origen AT ROW 5.48 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     movimientos_industria.id_empresa_destino AT ROW 5.48 COL 75 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     movimientos_industria.id_sucursal_destino AT ROW 6.48 COL 75 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     movimientos_industria.id_sucursal_origen AT ROW 6.52 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     movimientos_industria.id_locacion_destino AT ROW 7.48 COL 75 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     movimientos_industria.id_locacion_origen AT ROW 7.52 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     movimientos_industria.id_posicion_origen AT ROW 8.52 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     movimientos_industria.id_posicion_destino AT ROW 8.57 COL 75 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
...
/* SETTINGS FOR FILL-IN movimientos_industria.id_empresa IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN movimientos_industria.id_movimiento IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN movimientos_industria.id_sucursal IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN movimientos_industria.id_tipo_movimiento IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN movimientos_industria.id_tipo_mov_existente IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME movimientos_industria.estado
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL movimientos_industria.estado V-table-Win
ON LEAVE OF movimientos_industria.estado IN FRAME F-Main /* Estado */
DO:
...
&Scoped-define SELF-NAME movimientos_industria.fecha
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL movimientos_industria.fecha V-table-Win
ON LEAVE OF movimientos_industria.fecha IN FRAME F-Main /* Fecha */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME movimientos_industria.id_empresa
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL movimientos_industria.id_empresa V-table-Win
ON LEAVE OF movimientos_industria.id_empresa IN FRAME F-Main /* Empresa */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME movimientos_industria.id_movimiento
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL movimientos_industria.id_movimiento V-table-Win
ON LEAVE OF movimientos_industria.id_movimiento IN FRAME F-Main /* Movimiento */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME movimientos_industria.id_sucursal_origen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL movimientos_industria.id_sucursal_origen V-table-Win
ON LEAVE OF movimientos_industria.id_sucursal_origen IN FRAME F-Main /* Sucursal */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME movimientos_general.items_movimientos
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL movimientos_general.items_movimientos V-table-Win
ON LEAVE OF movimientos_general.items_movimientos IN FRAME F-Main /* Items */
DO:
{custom/support/validacion.i}
END.
