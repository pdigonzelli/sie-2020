...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES conceptos_reembolso
&Scoped-define FIRST-EXTERNAL-TABLE conceptos_reembolso


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR conceptos_reembolso.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS conceptos_reembolso.id_concepto ~
conceptos_reembolso.descripcion 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_concepto ~{&FP2}id_concepto ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}
&Scoped-define ENABLED-TABLES conceptos_reembolso
&Scoped-define FIRST-ENABLED-TABLE conceptos_reembolso
&Scoped-Define DISPLAYED-FIELDS conceptos_reembolso.id_concepto ~
conceptos_reembolso.descripcion 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS conceptos_reembolso.id_concepto 
...
DEFINE FRAME F-Main
     conceptos_reembolso.id_concepto AT ROW 1 COL 24 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     conceptos_reembolso.descripcion AT ROW 2 COL 24 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.conceptos_reembolso
...
/* SETTINGS FOR FILL-IN conceptos_reembolso.id_concepto IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME conceptos_reembolso.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL conceptos_reembolso.descripcion V-table-Win
ON LEAVE OF conceptos_reembolso.descripcion IN FRAME F-Main /* Descripcion Concepto */
DO:
...
&Scoped-define SELF-NAME conceptos_reembolso.id_concepto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL conceptos_reembolso.id_concepto V-table-Win
ON LEAVE OF conceptos_reembolso.id_concepto IN FRAME F-Main /* Cod.Concepto */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "conceptos_reembolso"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "conceptos_reembolso"}
