...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Caracteristicas_quimicas
&Scoped-define FIRST-EXTERNAL-TABLE Caracteristicas_quimicas


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Caracteristicas_quimicas.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Caracteristicas_quimicas.id_caracteristica ~
Caracteristicas_quimicas.descripcion Caracteristicas_quimicas.programa 
&Scoped-define ENABLED-TABLES Caracteristicas_quimicas
&Scoped-define FIRST-ENABLED-TABLE Caracteristicas_quimicas
&Scoped-define DISPLAYED-TABLES Caracteristicas_quimicas
&Scoped-define FIRST-DISPLAYED-TABLE Caracteristicas_quimicas
&Scoped-Define DISPLAYED-FIELDS Caracteristicas_quimicas.id_caracteristica ~
Caracteristicas_quimicas.descripcion Caracteristicas_quimicas.programa 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS Caracteristicas_quimicas.id_caracteristica 
...
DEFINE FRAME F-Main
     Caracteristicas_quimicas.id_caracteristica AT ROW 1 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     Caracteristicas_quimicas.descripcion AT ROW 2 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 58 BY 1
     Caracteristicas_quimicas.programa AT ROW 2.91 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 48 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.Caracteristicas_quimicas
...
/* SETTINGS FOR FILL-IN Caracteristicas_quimicas.id_caracteristica IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME Caracteristicas_quimicas.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Caracteristicas_quimicas.descripcion V-table-Win
ON LEAVE OF Caracteristicas_quimicas.descripcion IN FRAME F-Main /* Descripcion */
DO:
...
&Scoped-define SELF-NAME Caracteristicas_quimicas.id_caracteristica
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Caracteristicas_quimicas.id_caracteristica V-table-Win
ON LEAVE OF Caracteristicas_quimicas.id_caracteristica IN FRAME F-Main /* CodCaracteristica */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "Caracteristicas_quimicas"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "Caracteristicas_quimicas"}
