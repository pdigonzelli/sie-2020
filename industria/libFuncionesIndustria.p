...
hLibTam = DYNAMIC-FUNCTION('getPersistentLib' IN hLibCom, '..\industria\libTamboresIndustria.p').
hLibRep = DYNAMIC-FUNCTION('getPersistentLib' IN hLibCom, '..\industria\libTamboresReportes.p').
hLibOE  = DYNAMIC-FUNCTION('getPersistentLib' IN hLibCom, '..\industria\libTamboresOrdenEntrega.p').
hLibRem = DYNAMIC-FUNCTION('getPersistentLib' IN hLibCom, '..\industria\libTamboresRemitos.p').
