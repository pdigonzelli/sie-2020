...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Insumo rowObject.Unidad ~
rowObject.cantidad 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Insumo FORMAT "x(30)":U
      Unidad FORMAT "x(25)":U
      cantidad FORMAT ">>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Insumo
     _FldNameList[2]   > _<SDO>.rowObject.Unidad
"Unidad" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.cantidad
"cantidad" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
