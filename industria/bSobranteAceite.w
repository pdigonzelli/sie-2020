...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_sobrante ~
rowObject.fecha_elaboracion rowObject.tipo_almacenamiento ~
rowObject.Articulo rowObject.Envase rowObject.kilos rowObject.cantidad ~
rowObject.identificacion rowObject.nromov_sobrante ~
rowObject.id_tipotambor_sobrante 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_sobrante FORMAT "->,>>>,>>9":U
      rowObject.fecha_elaboracion FORMAT "99/99/99":U
      rowObject.tipo_almacenamiento FORMAT "tanque/envases":U
      rowObject.Articulo FORMAT "x(25)":U
      rowObject.Envase FORMAT "x(25)":U
      rowObject.kilos FORMAT "->>,>>9.999":U
      rowObject.cantidad FORMAT "->>,>>9.99":U
      rowObject.identificacion FORMAT "X(20)":U
      rowObject.nromov_sobrante FORMAT ">>>,>>>,>>9":U
      rowObject.id_tipotambor_sobrante FORMAT ">,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_sobrante
     _FldNameList[2]   = _<SDO>.rowObject.fecha_elaboracion
     _FldNameList[3]   = _<SDO>.rowObject.tipo_almacenamiento
     ...
     _FldNameList[8]   = _<SDO>.rowObject.identificacion
     _FldNameList[9]   = _<SDO>.rowObject.nromov_sobrante
     _FldNameList[10]   = _<SDO>.rowObject.id_tipotambor_sobrante
