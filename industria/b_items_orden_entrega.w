...
calidades.abreviatura items_orden_entrega.cantidad_tambores ~
items_orden_entrega.total_factura items_orden_entrega.kgs_netos_tambores ~
items_orden_entrega.semana_entrega 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH items_orden_entrega WHERE ~{&KEY-PHRASE} ~
      AND items_orden_entrega.id_orden_entrega = v_oe NO-LOCK, ~
      EACH contratos OF items_orden_entrega OUTER-JOIN NO-LOCK, ~
      EACH productos_terminados OF items_orden_entrega OUTER-JOIN NO-LOCK, ~
      EACH calidades OF items_orden_entrega OUTER-JOIN NO-LOCK ~
    BY items_orden_entrega.item_oe
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH items_orden_entrega WHERE ~{&KEY-PHRASE} ~
      AND items_orden_entrega.id_orden_entrega = v_oe NO-LOCK, ~
      EACH contratos OF items_orden_entrega OUTER-JOIN NO-LOCK, ~
      EACH productos_terminados OF items_orden_entrega OUTER-JOIN NO-LOCK, ~
      EACH calidades OF items_orden_entrega OUTER-JOIN NO-LOCK ~
...
&Scoped-define FOURTH-TABLE-IN-QUERY-br_table calidades
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      items_orden_entrega.id_orden_entrega FORMAT ">>>>9":U WIDTH 8.2
      items_orden_entrega.item_oe COLUMN-LABEL "Parte" FORMAT ">>9":U
            WIDTH 7.4
      items_orden_entrega.fecha FORMAT "99/99/99":U WIDTH 11
      items_orden_entrega.id_contrato FORMAT "X(12)":U WIDTH 17.2
      ...
      calidades.abreviatura COLUMN-LABEL "Calidad" FORMAT "X(10)":U
            WIDTH 17.2
      items_orden_entrega.cantidad_tambores FORMAT ">>>>>9":U WIDTH 11.2
      items_orden_entrega.total_factura FORMAT ">>>>>>>9.999":U
            WIDTH 18.2
      items_orden_entrega.kgs_netos_tambores FORMAT ">>>>>>9.999":U
            WIDTH 15.2
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.items_orden_entrega,industria.contratos OF general.items_orden_entrega,general.productos_terminados OF general.items_orden_entrega,general.calidades OF general.items_orden_entrega"
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ", OUTER, OUTER, OUTER"
     _OrdList          = "general.items_orden_entrega.item_oe|yes"
     _Where[1]         = "general.items_orden_entrega.id_orden_entrega = v_oe"
     _FldNameList[1]   > general.items_orden_entrega.id_orden_entrega
"items_orden_entrega.id_orden_entrega" ? ">>>>9" "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[2]   > general.items_orden_entrega.item_oe
"items_orden_entrega.item_oe" "Parte" ">>9" "integer" ? ? ? ? ? ? no ? no no "7.4" yes no no "U" "" ""
     _FldNameList[3]   > general.items_orden_entrega.fecha
"items_orden_entrega.fecha" ? ? "date" ? ? ? ? ? ? no ? no no "11" yes no no "U" "" ""
     _FldNameList[4]   > general.items_orden_entrega.id_contrato
"items_orden_entrega.id_contrato" ? ? "character" ? ? ? ? ? ? no ? no no "17.2" yes no no "U" "" ""
...
"productos_terminados.abreviatura" "Articulo" ? "character" ? ? ? ? ? ? no ? no no "16.6" yes no no "U" "" ""
     _FldNameList[7]   > general.calidades.abreviatura
"calidades.abreviatura" "Calidad" ? "character" ? ? ? ? ? ? no ? no no "17.2" yes no no "U" "" ""
     _FldNameList[8]   > general.items_orden_entrega.cantidad_tambores
"items_orden_entrega.cantidad_tambores" ? ? "integer" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[9]   > general.items_orden_entrega.total_factura
"items_orden_entrega.total_factura" ? ? "decimal" ? ? ? ? ? ? no ? no no "18.2" yes no no "U" "" ""
     _FldNameList[10]   > general.items_orden_entrega.kgs_netos_tambores
"items_orden_entrega.kgs_netos_tambores" ? ? "decimal" ? ? ? ? ? ? no ? no no "15.2" yes no no "U" "" ""
     _FldNameList[11]   > general.items_orden_entrega.semana_entrega
"items_orden_entrega.semana_entrega" "Semana" ? "integer" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" ""
...
label 'item_oe( items_orden_entrega ) '
  ...
  menu-item items_orden_entrega-fecha
label 'fecha( items_orden_entrega ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=items_orden_entrega.fecha').
                  run set-attribute-list('titulo=Fecha').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by items_orden_entrega.fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
------------------------------------------------------------------------------*/
  ...
  RUN get-oe IN h_con (OUTPUT v_oe).
