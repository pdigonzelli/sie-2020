...
calidades.descripcion calidades.tipo_calidad calidades.RNPA 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table calidades.id_calidad ~
calidades.descripcion calidades.tipo_calidad calidades.RNPA 
...
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table calidades
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table calidades
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH calidades WHERE ~{&KEY-PHRASE} ~
      AND calidades.tipo_calidad = 2 NO-LOCK ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 81 BY 18.1
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "general.calidades.tipo_calidad = 2"
     _FldNameList[1]   > general.calidades.id_calidad
"id_calidad" ? ? "integer" ? ? ? ? ? ? yes ?
     _FldNameList[2]   > general.calidades.descripcion
"descripcion" ? ? "character" ? ? ? ? ? ? yes ?
     _FldNameList[3]   > general.calidades.tipo_calidad
"tipo_calidad" ? ? "integer" ? ? ? ? ? ? yes ?
     _FldNameList[4]   > general.calidades.RNPA
"RNPA" ? ? "character" ? ? ? ? ? ? yes ?
