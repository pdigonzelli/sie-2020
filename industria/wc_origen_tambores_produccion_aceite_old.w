...
DO:
  ...
  run get-seleccion in h_bc_origen_tambores_produccion_ (output elegidos, output num).
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_origen_tambores_produccion_aceite.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_origen_tambores_produccion_ ).
       RUN set-position IN h_bc_origen_tambores_produccion_ ( 2.62 , 3.20 ) NO-ERROR.
       RUN set-size IN h_bc_origen_tambores_produccion_ ( 16.33 , 155.00 ) NO-ERROR.
