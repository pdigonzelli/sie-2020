...
&Scoped-define INTERNAL-TABLES arrastre_lote tambores_industria locaciones ~
envases_prod sucursales
...
tambores_industria.id_tambor tambores_industria.id_sucursal_ubicacion ~
sucursales.nombre tambores_industria.id_locacion_ubicacion ~
locaciones.descripcion tambores_industria.id_envase ~
tambores_industria.kilos_tambor tambores_industria.id_etiqueta 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table tambores_industria.id_lote ~
tambores_industria.id_tambor tambores_industria.id_sucursal_ubicacion ~
tambores_industria.id_locacion_ubicacion tambores_industria.id_envase ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH arrastre_lote OF lotes_jugo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH tambores_industria WHERE tambores_industria.id_empresa = arrastre_lote.id_empresa ~
  ...
  AND tambores_industria.nromov = arrastre_lote.nromov_arrastre NO-LOCK, ~
  ...
  AND locaciones.id_locacion = tambores_industria.id_locacion_ubicacion NO-LOCK, ~
    ...
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table arrastre_lote tambores_industria ~
locaciones envases_prod sucursales
...
nromov||y|general.arrastre_lote.nromov
id_sucursal||y|general.arrastre_lote.id_sucursal
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tambores_industria.id_lote FORMAT ">>,>>9"
      tambores_industria.id_tambor FORMAT ">>9"
      tambores_industria.id_sucursal_ubicacion
      sucursales.nombre FORMAT "x(20)"
      tambores_industria.id_locacion_ubicacion FORMAT ">>9"
      locaciones.descripcion FORMAT "x(25)"
      tambores_industria.id_envase FORMAT ">>9"
      tambores_industria.kilos_tambor FORMAT ">>>>9.999"
      tambores_industria.id_etiqueta FORMAT ">,>>>,>>9"
  ENABLE
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 153 BY 7.14
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.arrastre_lote OF general.lotes_jugo,industria.tambores_industria WHERE general.arrastre_lote ...,industria.locaciones WHERE general.tambores_industria ...,general.envases_prod OF general.tambores_industria,comercial.sucursales WHERE general.tambores_industria ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[2]      = "general.tambores_industria.id_empresa = general.arrastre_lote.id_empresa
  AND general.tambores_industria.id_sucursal = general.arrastre_lote.id_sucursal
  AND general.tambores_industria.id_tipotambor = general.arrastre_lote.id_tipotambor_arrastre
  AND general.tambores_industria.nromov = general.arrastre_lote.nromov_arrastre"
     _JoinCode[3]      = "general.locaciones.id_empresa = general.tambores_industria.id_empresa_ubicacion
  ...
  AND general.locaciones.id_locacion = general.tambores_industria.id_locacion_ubicacion"
     _JoinCode[5]      = "comercial.sucursales.id_sucursal = general.tambores_industria.id_sucursal_ubicacion"
     _FldNameList[1]   > general.tambores_industria.id_lote
"general.tambores_industria.id_lote" ? ">>,>>9" "integer" ? ? ? ? ? ? yes ?
     _FldNameList[2]   > general.tambores_industria.id_tambor
"general.tambores_industria.id_tambor" ? ">>9" "integer" ? ? ? ? ? ? yes ?
     _FldNameList[3]   > general.tambores_industria.id_sucursal_ubicacion
"general.tambores_industria.id_sucursal_ubicacion" ? ? "integer" ? ? ? ? ? ? yes ?
     _FldNameList[4]   > comercial.sucursales.nombre
"comercial.sucursales.nombre" ? "x(20)" "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > general.tambores_industria.id_locacion_ubicacion
"general.tambores_industria.id_locacion_ubicacion" ? ">>9" "integer" ? ? ? ? ? ? yes ?
     _FldNameList[6]   > general.locaciones.descripcion
"general.locaciones.descripcion" ? "x(25)" "character" ? ? ? ? ? ? no ?
     _FldNameList[7]   > general.tambores_industria.id_envase
"general.tambores_industria.id_envase" ? ">>9" "integer" ? ? ? ? ? ? yes ?
     _FldNameList[8]   > general.tambores_industria.kilos_tambor
"general.tambores_industria.kilos_tambor" ? ">>>>9.999" "decimal" ? ? ? ? ? ? yes ?
     _FldNameList[9]   > general.tambores_industria.id_etiqueta
"general.tambores_industria.id_etiqueta" ? ">,>>>,>>9" "integer" ? ? ? ? ? ? no ?
...
label 'id_posicion_ubicacion( tambores_industria ) '
  ...
  menu-item tambores_industria-id_envase
label 'id_envase( tambores_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_industria.id_envase').
                  run set-attribute-list('titulo=Envase').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by tambores_industria.id_envase
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tambores_industria.id_tambor
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nromov" "arrastre_lote" "nromov"}
  {src/adm/template/sndkycas.i "id_sucursal" "arrastre_lote" "id_sucursal"}
