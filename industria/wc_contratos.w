...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.29 COL 122
     salir AT ROW 10.29 COL 134
     RECT-1 AT ROW 10.05 COL 119
     SPACE(6.99) SKIP(0.80)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_contratos ( 2.19 , 4.00 ) NO-ERROR.
