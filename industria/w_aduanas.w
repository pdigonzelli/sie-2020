...
DEFINE VARIABLE h_b_aduanas AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_aduanas AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Aduanas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_aduanas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_aduanas ).
       RUN set-position IN h_b_aduanas ( 3.86 , 8.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_aduanas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_aduanas ).
       RUN set-position IN h_v_aduanas ( 11.71 , 17.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 47.00 ) */

       /* Links to csmartbrowser h_b_aduanas. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_aduanas ).

       /* Links to SmartViewer h_v_aduanas. */
       RUN add-link IN adm-broker-hdl ( h_b_aduanas , 'Record':U , h_v_aduanas ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_aduanas ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_aduanas ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_aduanas ,
             h_b_aduanas , 'AFTER':U ).
    END. /* Page 0 */
