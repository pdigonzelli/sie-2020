...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_lotes_aceite_ubicacion ( 2.43 , 6.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b_lotes_aceite_ubicacion , 'Record':U , h_b_tambores_lotes_aceite_ubicac ).
