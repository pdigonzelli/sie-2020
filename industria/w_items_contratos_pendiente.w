...
DEFINE VARIABLE h_bc_items_contratos_todos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_items_contratos_pendiente AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_contratos_ro.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_contratos_ro ).
       RUN set-position IN h_b_contratos_ro ( 3.86 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b_contratos_ro ( 6.71 , 146.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_items_contratos_todos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_items_contratos_todos ).
       RUN set-position IN h_bc_items_contratos_todos ( 11.00 , 3.00 ) NO-ERROR.
       RUN set-size IN h_bc_items_contratos_todos ( 6.71 , 72.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 11.24 , 83.00 ) NO-ERROR.
       RUN set-size IN h_cus-updsav ( 1.91 , 35.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_items_contratos_pendiente.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_items_contratos_pendiente ).
       RUN set-position IN h_v_items_contratos_pendiente ( 14.33 , 98.00 ) NO-ERROR.
       ...
       /* Links to csmartbrowser h_bc_items_contratos_todos. */
       RUN add-link IN adm-broker-hdl ( h_b_contratos_ro , 'Record':U , h_bc_items_contratos_todos ).

       /* Links to SmartViewer h_v_items_contratos_pendiente. */
       RUN add-link IN adm-broker-hdl ( h_bc_items_contratos_todos , 'record':U , h_v_items_contratos_pendiente ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_items_contratos_pendiente ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_contratos_ro ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_items_contratos_todos ,
             h_b_contratos_ro , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-updsav ,
             h_bc_items_contratos_todos , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_items_contratos_pendiente ,
