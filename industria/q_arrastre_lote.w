...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH arrastre_lote OF lotes_jugo WHERE ~{&KEY-PHRASE} NO-LOCK ~
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "general.arrastre_lote OF general.lotes_jugo"
