...
&Scoped-define INTERNAL-TABLES gastos_fijos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table gastos_fijos.id_gasto_fijo ~
gastos_fijos.abreviatura gastos_fijos.importe gastos_fijos.fecha_inicio ~
gastos_fijos.fecha_fin 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH gastos_fijos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table gastos_fijos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table gastos_fijos
...
<FOREIGN-KEYS>
id_gasto_fijo||y|general.gastos_fijos.id_gasto_fijo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      gastos_fijos.abreviatura
      gastos_fijos.importe
      gastos_fijos.fecha_inicio
      gastos_fijos.fecha_fin
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.gastos_fijos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.gastos_fijos.id_gasto_fijo
     _FldNameList[2]   = general.gastos_fijos.abreviatura
     _FldNameList[3]   = general.gastos_fijos.importe
     _FldNameList[4]   = general.gastos_fijos.fecha_inicio
     _FldNameList[5]   = general.gastos_fijos.fecha_fin
...
define sub-menu Ordena 
  menu-item gastos_fijos-id_gasto_fijo
label 'id_gasto_fijo( gastos_fijos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_fijos.id_gasto_fijo').
                  run set-attribute-list('titulo=Cod. Gasto Fijo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_fijos.id_gasto_fijo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item gastos_fijos-abreviatura
label 'abreviatura( gastos_fijos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_fijos.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_fijos.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item gastos_fijos-importe
label 'importe( gastos_fijos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_fijos.importe').
                  run set-attribute-list('titulo=Importe').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_fijos.importe
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item gastos_fijos-fecha_inicio
label 'fecha_inicio( gastos_fijos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_fijos.fecha_inicio').
                  run set-attribute-list('titulo=Fecha Inicio').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_fijos.fecha_inicio
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item gastos_fijos-fecha_fin
label 'fecha_fin( gastos_fijos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_fijos.fecha_fin').
                  run set-attribute-list('titulo=Fecha Fin').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_fijos.fecha_fin
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by gastos_fijos.id_gasto_fijo
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_gasto_fijo" "gastos_fijos" "id_gasto_fijo"}
