...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_lotes_orden_fabricacion ( 3.86 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b_lotes_orden_fabricacion ( 6.71 , 142.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b_lotes_orden_fabricacion , 'Record':U , h_v_lotes_jugo_items_oe ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_lotes_jugo_items_oe ,
             h_b_lotes_orden_fabricacion , 'AFTER':U ).
    END. /* Page 0 */
