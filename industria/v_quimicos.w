...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES quimicos
&Scoped-define FIRST-EXTERNAL-TABLE quimicos


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR quimicos.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS quimicos.id_quimico quimicos.nombre ~
quimicos.usuario quimicos.nombre_ingles quimicos.titulo 
&Scoped-define ENABLED-TABLES quimicos
&Scoped-define FIRST-ENABLED-TABLE quimicos
&Scoped-define DISPLAYED-TABLES quimicos
&Scoped-define FIRST-DISPLAYED-TABLE quimicos
&Scoped-Define DISPLAYED-FIELDS quimicos.id_quimico quimicos.nombre ~
quimicos.usuario quimicos.nombre_ingles quimicos.titulo 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS quimicos.id_quimico 
...
DEFINE FRAME F-Main
     quimicos.id_quimico AT ROW 1 COL 24 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
     quimicos.nombre AT ROW 2 COL 24 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     quimicos.usuario AT ROW 3 COL 24 COLON-ALIGNED
          LABEL "Usuario"
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
     quimicos.nombre_ingles AT ROW 4.1 COL 24 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 47.8 BY 1
     quimicos.titulo AT ROW 5.05 COL 24 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 33 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.quimicos
...
/* SETTINGS FOR FILL-IN quimicos.id_quimico IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN quimicos.usuario IN FRAME F-Main
   EXP-LABEL                                                            */
...
&Scoped-define SELF-NAME quimicos.id_quimico
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL quimicos.id_quimico V-table-Win
ON LEAVE OF quimicos.id_quimico IN FRAME F-Main /* Quimicos */
DO:
...
&Scoped-define SELF-NAME quimicos.nombre
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL quimicos.nombre V-table-Win
ON LEAVE OF quimicos.nombre IN FRAME F-Main /* Nombre */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME quimicos.nombre_ingles
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL quimicos.nombre_ingles V-table-Win 
ON LEAVE OF quimicos.nombre_ingles IN FRAME F-Main /* Nombre Completo Ingles */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME quimicos.usuario
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL quimicos.usuario V-table-Win
ON LEAVE OF quimicos.usuario IN FRAME F-Main /* Usuario */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "quimicos"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "quimicos"}
