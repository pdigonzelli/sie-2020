...
DEFINE VARIABLE h_v_microbiologia_lotes AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_microbiologia_lotes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_microbiologia_lotes ).
       RUN set-position IN h_v_microbiologia_lotes ( 11.95 , 37.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.95 , 64.00 ) */
       ...
       /* Links to SmartViewer h_v_microbiologia_lotes. */
       RUN add-link IN adm-broker-hdl ( h_b_control_calidad_lotes , 'Record':U , h_v_microbiologia_lotes ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_microbiologia_lotes ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_control_calidad_lotes ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_microbiologia_lotes ,
