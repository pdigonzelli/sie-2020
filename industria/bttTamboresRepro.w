...
rowObject.cantidad rowObject.kilos rowObject.kilos400 rowObject.brix_20_20 ~
rowObject.acidez_w_w rowObject.nromov rowObject.id_tipotambor ~
rowObject.litros rowObject.solidos 
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dttTamboresRepro.w"
   Allow: Basic,Browse
   Frames: 1
...
"id_lote" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[6]   = _<SDO>.rowObject.brix_20_20
     _FldNameList[7]   = _<SDO>.rowObject.acidez_w_w
     _FldNameList[8]   = _<SDO>.rowObject.nromov
     _FldNameList[9]   = _<SDO>.rowObject.id_tipotambor
     _FldNameList[10]   = _<SDO>.rowObject.litros
     _FldNameList[11]   = _<SDO>.rowObject.solidos
