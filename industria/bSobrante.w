...
rowObject.fecha_elaboracion rowObject.volumen rowObject.Envase ~
rowObject.cantidad rowObject.kilos_tambor rowObject.identificacion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_sobrante FORMAT "->,>>>,>>9":U
      fecha_elaboracion FORMAT "99/99/99":U
      volumen FORMAT "->>,>>9.99":U
      Envase FORMAT "x(20)":U
      cantidad FORMAT "->>,>>9.99":U
      kilos_tambor FORMAT ">>>,>>9.999":U
      identificacion FORMAT "X(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = _<SDO>.rowObject.volumen
     _FldNameList[4]   = _<SDO>.rowObject.Envase
     _FldNameList[5]   = _<SDO>.rowObject.cantidad
     _FldNameList[6]   = _<SDO>.rowObject.kilos_tambor
     _FldNameList[7]   = _<SDO>.rowObject.identificacion
