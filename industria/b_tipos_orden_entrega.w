...
&Scoped-define INTERNAL-TABLES tipos_orden_entrega
...
tipos_orden_entrega.id_tipo_orden_entrega tipos_orden_entrega.descripcion ~
tipos_orden_entrega.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_orden_entrega WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipos_orden_entrega
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_orden_entrega
...
<FOREIGN-KEYS>
id_tipo_orden_entrega||y|general.tipos_orden_entrega.id_tipo_orden_entrega
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_tipo_orden_entrega"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_orden_entrega.id_tipo_orden_entrega
      tipos_orden_entrega.descripcion
      tipos_orden_entrega.abreviatura
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_orden_entrega"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tipos_orden_entrega.id_tipo_orden_entrega
     _FldNameList[2]   = general.tipos_orden_entrega.descripcion
     _FldNameList[3]   = general.tipos_orden_entrega.abreviatura
...
define sub-menu Ordena 
  menu-item tipos_orden_entrega-id_tipo_orden_entrega
label 'id_tipo_orden_entrega( tipos_orden_entrega ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_orden_entrega.id_tipo_orden_entrega').
                  run set-attribute-list('titulo=Cod.TipoOE').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_orden_entrega.id_tipo_orden_entrega
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipos_orden_entrega-descripcion
label 'descripcion( tipos_orden_entrega ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_orden_entrega.descripcion').
                  run set-attribute-list('titulo=Tipo OE').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_orden_entrega.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
case p:
  WHEN 'tipos_orden_entrega.id_tipo_orden_entrega' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_orden_entrega = integer(valor)  no-lock no-error .
  WHEN 'tipos_orden_entrega.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'tipos_orden_entrega.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_orden_entrega" "tipos_orden_entrega" "id_tipo_orden_entrega"}
