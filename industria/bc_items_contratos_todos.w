...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH items_contratos OF contratos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
<FOREIGN-KEYS>
id_articulo||y|general.items_contratos.id_articulo
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_articulo,id_tipo_contrato,id_tipo_empaque,id_tipo_tratamiento,id_tipo_unidad_venta"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      items_contratos.item FORMAT ">>9":U WIDTH 8.2
      ...
      items_contratos.semana_entrega_hasta COLUMN-LABEL "hasta" FORMAT ">>9":U
            WIDTH 12.2
      items_contratos.anio_semana_entrega FORMAT "9999":U WIDTH 11.2
      items_contratos.cantidad FORMAT ">>>,>>9.99":U WIDTH 16.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.items_contratos OF general.contratos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.items_contratos.item
"items_contratos.item" ? ">>9" "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[2]   > general.items_contratos.semana_entrega
"items_contratos.semana_entrega" "Semana" ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[3]   > general.items_contratos.semana_entrega_hasta
"items_contratos.semana_entrega_hasta" "hasta" ? "integer" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[4]   > general.items_contratos.anio_semana_entrega
"items_contratos.anio_semana_entrega" ? ? "integer" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[5]   > general.items_contratos.cantidad
"items_contratos.cantidad" ? ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "16.2" yes no no "U" "" ""
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_articulo" "items_contratos" "id_articulo"}
