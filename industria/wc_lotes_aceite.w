...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-13 aceptar salir 
...
DEFINE VARIABLE h_b_consulta_lote_aceite AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-13 AT ROW 1.24 COL 7
     SPACE(7.19) SKIP(2.18)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_lote_aceite.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_lote_aceite ).
       RUN set-position IN h_b_consulta_lote_aceite ( 1.71 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.81 , 128.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_lote_aceite ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-1 RECT-13 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
