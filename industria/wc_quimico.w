...
DEFINE VARIABLE h_bc_quimicos AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-2 AT ROW 1.48 COL 4
     SPACE(4.99) SKIP(2.70)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_quimicos.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_quimicos ).
       RUN set-position IN h_bc_quimicos ( 2.05 , 7.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 76.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_quimicos ,
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
define output parameter pp1 as integer.
pp1 = p1.
END PROCEDURE.
