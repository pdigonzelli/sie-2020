...
&Scoped-define INTERNAL-TABLES tipos_contacto_industria
...
tipos_contacto_industria.id_tipo_contacto ~
tipos_contacto_industria.descripcion tipos_contacto_industria.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_contacto_industria WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipos_contacto_industria
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_contacto_industria
...
<FOREIGN-KEYS>
id_tipo_contacto||y|general.tipos_contacto_industria.id_tipo_contacto
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_tipo_contacto"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_contacto_industria.id_tipo_contacto COLUMN-LABEL "Cod" FORMAT ">>9":U
      tipos_contacto_industria.descripcion FORMAT "X(30)":U
      tipos_contacto_industria.abreviatura FORMAT "X(12)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 79 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_contacto_industria"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.tipos_contacto_industria.id_tipo_contacto
"id_tipo_contacto" "Cod" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = general.tipos_contacto_industria.descripcion
     _FldNameList[3]   = general.tipos_contacto_industria.abreviatura
...
define sub-menu Ordena 
  menu-item tipos_contacto_industria-id_tipo_contacto
label 'id_tipo_contacto( tipos_contacto_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_contacto_industria.id_tipo_contacto').
                  run set-attribute-list('titulo=Cod.TipContacto').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_contacto_industria.id_tipo_contacto
...
label 'descripcion( tipos_contacto_industria ) '
  ...
  menu-item tipos_contacto_industria-abreviatura
label 'abreviatura( tipos_contacto_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_contacto_industria.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_contacto_industria.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipos_contacto_industria.id_tipo_contacto
...
case p:
  WHEN 'tipos_contacto_industria.id_tipo_contacto' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_contacto = integer(valor)  no-lock no-error .
  WHEN 'tipos_contacto_industria.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'tipos_contacto_industria.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_contacto" "tipos_contacto_industria" "id_tipo_contacto"}
