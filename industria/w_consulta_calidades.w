...
DEFINE VARIABLE h_b_consulta_calidades AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Calidades */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Calidades */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_calidades.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_calidades ).
       RUN set-position IN h_b_consulta_calidades ( 4.33 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 18.10 , 81.00 ) */

       /* Links to csmartbrowser h_b_consulta_calidades. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_consulta_calidades ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_b_consulta_calidades ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_calidades ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
