...
do:   
    for each tambores_industria where tambores_industria.id_empresa_destino = produccion_jugo.id_empresa and
                                      tambores_industria.id_sucursal_destino = produccion_jugo.id_sucursal and
                                      tambores_industria.id_tipotambor_destino = produccion_jugo.id_tipotambor and
                                      tambores_industria.nromov_destino = produccion_jugo.nromov no-lock.
