...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipos_plazo
&Scoped-define FIRST-EXTERNAL-TABLE tipos_plazo


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipos_plazo.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipos_plazo.id_tipo_plazo ~
...
&Scoped-define ENABLED-TABLES tipos_plazo
&Scoped-define FIRST-ENABLED-TABLE tipos_plazo
&Scoped-Define DISPLAYED-FIELDS tipos_plazo.id_tipo_plazo ~
tipos_plazo.descripcion tipos_plazo.descripcion_ingles 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipos_plazo.id_tipo_plazo 
...
<FOREIGN-KEYS>
id_tipo_plazo|y|y|general.tipos_plazo.id_tipo_plazo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
DEFINE FRAME F-Main
     tipos_plazo.id_tipo_plazo AT ROW 1 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     tipos_plazo.descripcion AT ROW 2 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipos_plazo.descripcion_ingles AT ROW 2.91 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipos_plazo
...
/* SETTINGS FOR FILL-IN tipos_plazo.id_tipo_plazo IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipos_plazo.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_plazo.descripcion V-table-Win
ON LEAVE OF tipos_plazo.descripcion IN FRAME F-Main /* Tipo de Pazo */
DO:
...
&Scoped-define SELF-NAME tipos_plazo.descripcion_ingles
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_plazo.descripcion_ingles V-table-Win
ON LEAVE OF tipos_plazo.descripcion_ingles IN FRAME F-Main /* Tipos Plazos Ingles */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tipos_plazo.id_tipo_plazo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_plazo.id_tipo_plazo V-table-Win
ON LEAVE OF tipos_plazo.id_tipo_plazo IN FRAME F-Main /* Cod Tipo Plazo */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_tipo_plazo':U THEN
       {src/adm/template/find-tbl.i
           &TABLE = tipos_plazo
           &WHERE = "WHERE tipos_plazo.id_tipo_plazo eq INTEGER(key-value)"
       }
  END CASE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipos_plazo"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipos_plazo"}
