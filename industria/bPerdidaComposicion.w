...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Articulo ~
rowObject.cantidad rowObject.kilos rowObject.kilos_400 rowObject.brix_20_20 ~
rowObject.acidez_p_p rowObject.id_sucursal rowObject.id_articulo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.Articulo FORMAT "x(35)":U
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dPerdidaComposicion.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Articulo
     _FldNameList[2]   = _<SDO>.rowObject.cantidad
     _FldNameList[3]   = _<SDO>.rowObject.kilos
     _FldNameList[4]   = _<SDO>.rowObject.kilos_400
     _FldNameList[5]   = _<SDO>.rowObject.brix_20_20
     _FldNameList[6]   = _<SDO>.rowObject.acidez_p_p
