...
&ELSE
  ...
  DEFINE VARIABLE Importance AS INTEGER    NO-UNDO.
...
ELSE 
  /*RUN utils/gethostname.p(OUTPUT vLocalHostName).*/
  vLocalHostName = "facundoj".
...
PROCEDURE dofiles:
  ...
  IF cFileType = "Binary" THEN DO:
    ...
    IF useffwdir THEN
      ...
      RUN b64encode.p(cBinaryFile, cLocalFile) NO-ERROR. /*by facundo*/
    ELSE 
