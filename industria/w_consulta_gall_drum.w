...
DEFINE VARIABLE h_b_consulta_gall_drum AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Consulta Gall/Drum */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Consulta Gall/Drum */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_gall_drum.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_gall_drum ).
       RUN set-position IN h_b_consulta_gall_drum ( 3.86 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_consulta_gall_drum ( 15.95 , 77.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_gall_drum ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
