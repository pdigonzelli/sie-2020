...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-6 
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.76 COL 74
     salir AT ROW 10.76 COL 86
     RECT-1 AT ROW 10.52 COL 71
     RECT-6 AT ROW 2.19 COL 7
     SPACE(7.19) SKIP(2.23)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_prioridades.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_prioridades ).
       RUN set-position IN h_b_prioridades ( 2.67 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-6 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
