...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipostambor
&Scoped-define FIRST-EXTERNAL-TABLE tipostambor


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipostambor.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipostambor.id_tipotambor ~
tipostambor.descripcion tipostambor.tabla tipostambor.cabecera ~
tipostambor.abreviatura 
&Scoped-define ENABLED-TABLES tipostambor
&Scoped-define FIRST-ENABLED-TABLE tipostambor
&Scoped-define DISPLAYED-TABLES tipostambor
&Scoped-define FIRST-DISPLAYED-TABLE tipostambor
&Scoped-Define DISPLAYED-FIELDS tipostambor.id_tipotambor ~
tipostambor.descripcion tipostambor.tabla tipostambor.cabecera ~
tipostambor.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipostambor.id_tipotambor 
...
DEFINE FRAME F-Main
     tipostambor.id_tipotambor AT ROW 1 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     tipostambor.descripcion AT ROW 1.95 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipostambor.tabla AT ROW 2.91 COL 22 COLON-ALIGNED
          LABEL "Tabla Almacenamiento"
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipostambor.cabecera AT ROW 3.86 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipostambor.abreviatura AT ROW 4.81 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipostambor
...
/* SETTINGS FOR FILL-IN tipostambor.id_tipotambor IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN tipostambor.tabla IN FRAME F-Main
   EXP-LABEL                                                            */
...
&Scoped-define SELF-NAME tipostambor.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipostambor.descripcion V-table-Win
ON LEAVE OF tipostambor.descripcion IN FRAME F-Main /* Tipos de Tambor */
DO:
...
&Scoped-define SELF-NAME tipostambor.id_tipotambor
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipostambor.id_tipotambor V-table-Win
ON LEAVE OF tipostambor.id_tipotambor IN FRAME F-Main /* Tipo tambor */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tipostambor.tabla
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipostambor.tabla V-table-Win 
ON LEAVE OF tipostambor.tabla IN FRAME F-Main /* Tabla Almacenamiento */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipostambor"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipostambor"}
