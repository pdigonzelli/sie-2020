...
&Scoped-Define ENABLED-OBJECTS id_sucursal aceptar salir RECT-1 
&Scoped-Define DISPLAYED-OBJECTS id_sucursal 
...
DEFINE VARIABLE id_sucursal AS INTEGER FORMAT ">99":U INITIAL 0 
     LABEL "Sucursal" 
     VIEW-AS FILL-IN 
     SIZE 9 BY 1 NO-UNDO.
...
------------------------------------------------------------------------------*/
  DISPLAY id_sucursal 
      WITH FRAME D-Dialog.
  ENABLE id_sucursal aceptar salir RECT-1 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
