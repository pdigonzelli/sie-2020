...
&Scoped-define INTERNAL-TABLES despachantes

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table despachantes.id_despachante ~
despachantes.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH despachantes WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table despachantes
&Scoped-define FIRST-TABLE-IN-QUERY-br_table despachantes
...
<FOREIGN-KEYS>
id_despachante||y|general.despachantes.id_despachante
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_despachante"':U).
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.despachantes"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.despachantes.id_despachante
     _FldNameList[2]   = general.despachantes.descripcion
...
define sub-menu Ordena 
  menu-item despachantes-id_despachante
label 'id_despachante( despachantes ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=despachantes.id_despachante').
                  run set-attribute-list('titulo=Cod.Despachante').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by despachantes.id_despachante
...
case p:
  WHEN 'despachantes.id_despachante' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_despachante = integer(valor)  no-lock no-error .
  WHEN 'despachantes.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_despachante" "despachantes" "id_despachante"}
