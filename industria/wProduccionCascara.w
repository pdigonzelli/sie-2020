...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dproduccioncascara ( 13.14 , 70.00 ) NO-ERROR.
       ...
       RUN resizeObject IN h_bproduccioncascara ( 6.67 , 89.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsid_sucursal,id_turno,cantidad_bolsasOperatorStyleImplicitOperatorViewAsCombo-boxOperator=UseBeginsyesUseContainsyesDefaultWidth16DefaultCharWidth20DefaultEditorLines1ViewAsFieldsFieldOperatorStylesFieldFormatsFieldWidthsFieldLabelsid_turnoAñoFieldToolTipsFieldHelpIdscantidad_bolsas0id_sucursal0id_turno0DesignDataObjectFieldColumn20HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynfilter ).
       ...
       RUN constructObject (
             ...
             OUTPUT h_folder ).
       RUN repositionObject IN h_folder ( 14.57 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_folder ( 8.10 , 89.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN repositionObject IN h_vproduccioncascara ( 16.24 , 6.00 ) NO-ERROR.
       /* Size in AB:  ( 5.76 , 67.80 ) */
...
------------------------------------------------------------------------------*/
  ...
  pcFieldNames = REPLACE(pcFieldNames, "RowObject.id_turno", "RowObject.Fecha").
  

  RUN SUPER( INPUT-OUTPUT pcFieldNames, INPUT-OUTPUT pcFieldValues, INPUT-OUTPUT pcOperators).
  MESSAGE pcFieldNames VIEW-AS ALERT-BOX.
