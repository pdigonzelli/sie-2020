...
DEFINE VARIABLE h_vreleasedeliveryconfirmacionen AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Confirmacion Release */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Confirmacion Release */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dreleasedelivery ( 13.86 , 61.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_breleasedelivery ( 6.48 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_breleasedelivery ( 6.67 , 70.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vreleasedeliveryconfirmacionenvio.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_vreleasedeliveryconfirmacionen ).
       RUN repositionObject IN h_vreleasedeliveryconfirmacionen ( 14.33 , 9.00 ) NO-ERROR.
       /* Size in AB:  ( 1.14 , 50.00 ) */

       RUN constructObject (
             INPUT  'adm2/dyntoolbar.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'FlatButtonsyesMenunoShowBorderyesToolbaryesActionGroupsTableio,NavigationSubModulesTableIOTypeUpdateSupportedLinksNavigation-source,Tableio-sourceToolbarBandsToolbarParentMenuToolbarAutoSizeyesToolbarDrawDirectionHorizontalToolbarInitialStateLogicalObjectNameAutoResizeDisabledActionsHiddenActionsHiddenToolbarBandsHiddenMenuBandsMenuMergeOrder0EdgePixels2PanelTypeToolbarDeactivateTargetOnHidenoDisabledActionsNavigationTargetNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dyntoolbar ).
       RUN repositionObject IN h_dyntoolbar ( 1.00 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 71.20 ) NO-ERROR.
       ...
       /* Links to SmartDataViewer h_vreleasedeliveryconfirmacionen. */
       RUN addLink ( h_dreleasedelivery , 'Data':U , h_vreleasedeliveryconfirmacionen ).
       RUN addLink ( h_vreleasedeliveryconfirmacionen , 'Update':U , h_dreleasedelivery ).
       RUN addLink ( h_dyntoolbar , 'TableIO':U , h_vreleasedeliveryconfirmacionen ).
       ...
       RUN adjustTabOrder ( h_breleasedelivery ,
             h_dynfilter , 'AFTER':U ).
       RUN adjustTabOrder ( h_vreleasedeliveryconfirmacionen ,
