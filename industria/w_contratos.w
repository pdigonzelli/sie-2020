...
&Scoped-Define ENABLED-OBJECTS BUTTON-14 BUTTON-1 BUTTON-15 BUTTON-19 ~
RECT-2 
...
DEFINE FRAME F-Main
     ...
     BUTTON-1 AT ROW 1.1 COL 120
     BUTTON-15 AT ROW 2.19 COL 8
     BUTTON-19 AT ROW 2.24 COL 120
     RECT-2 AT Y 0 X 175
...
ON CHOOSE OF BUTTON-19 IN FRAME F-Main /* Pedido de Muestra */
DO:
  RUN w_muestras.w.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_b_contratos ( 6.71 , 146.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-14 BUTTON-1 BUTTON-15 BUTTON-19 RECT-2 
...
lista_reportes = "Contratos Martin,Contratos por Semana,Exportacion Excell Contratos-Semana,Nuevo reporte Contratos".
...
/*            when "Contratos detallado" then 
  ...
  */          
           ...
           when "Nuevo reporte Contratos" then 
                do:
