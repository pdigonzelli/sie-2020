...
DEFINE VARIABLE h_bc_tipostambor AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 15.52 COL 61
     salir AT ROW 15.52 COL 73
     RECT-1 AT ROW 15.29 COL 58
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_tipostambor.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_tipostambor ).
       RUN set-position IN h_bc_tipostambor ( 1.95 , 6.00 ) NO-ERROR.
       RUN set-size IN h_bc_tipostambor ( 12.14 , 79.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_tipostambor ,
