...
r_muestras_protocolos muestras
...
&Scoped-Define DATA-FIELDS  id_protocolo id_articulo anio id_empresa id_sucursal id_tipotambor nromov~
 id_lote id_muestra anio_muestra
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH protocolos NO-LOCK, ~
      FIRST tambores_industria WHERE tambores_industria.nromov = protocolos.nromov NO-LOCK, ~
      FIRST r_muestras_protocolos OF protocolos OUTER-JOIN NO-LOCK, ~
      FIRST muestras OF r_muestras_protocolos NO-LOCK ~
    BY tambores_industria.id_lote INDEXED-REPOSITION
{&DB-REQUIRED-START}
...
&Scoped-define THIRD-TABLE-IN-QUERY-Query-Main r_muestras_protocolos
&Scoped-define FOURTH-TABLE-IN-QUERY-Query-Main muestras
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "general.protocolos,industria.tambores_industria WHERE general.protocolos ...,industria.r_muestras_protocolos OF general.protocolos,industria.muestras OF general.r_muestras_protocolos"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ", FIRST, FIRST OUTER, FIRST"
     _OrdList          = "general.tambores_industria.id_lote|yes"
     _JoinCode[2]      = "general.tambores_industria.nromov = general.protocolos.nromov"
     _JoinCode[4]      = "general.tambores_industria.nromov = general.protocolos.nromov"
...
"anio" "anio" ? ? "integer" ? ? ? ? ? ? no ? no 4.8 yes
     _FldNameList[4]   > general.tambores_industria.id_empresa
"id_empresa" "id_empresa" ? ? "integer" ? ? ? ? ? ? no ? no 8.2 yes
     _FldNameList[5]   > general.tambores_industria.id_sucursal
"id_sucursal" "id_sucursal" ? ? "integer" ? ? ? ? ? ? no ? yes 6.6 yes
     _FldNameList[6]   > general.tambores_industria.id_tipotambor
"id_tipotambor" "id_tipotambor" ? ? "integer" ? ? ? ? ? ? no ? no 9.2 yes
     _FldNameList[7]   > general.tambores_industria.nromov
