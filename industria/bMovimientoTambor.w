...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.origen rowObject.destino ~
rowObject.movimiento rowObject.Lote rowObject.articulo ~
rowObject.nro_movimiento rowObject.tambor_desde rowObject.tambor_hasta ~
rowObject.cantidad 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      origen FORMAT "x(40)":U
      destino FORMAT "x(40)":U
      movimiento FORMAT "x(40)":U
      Lote FORMAT "x(15)":U
      articulo FORMAT "x(25)":U
      nro_movimiento FORMAT ">>>,>,>>>,>>9":U
      tambor_desde FORMAT ">>>,>>9":U
      tambor_hasta FORMAT ">>>,>>9":U
      cantidad FORMAT ">>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 109 BY 7.62 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.origen
     _FldNameList[2]   = _<SDO>.rowObject.destino
     _FldNameList[3]   = _<SDO>.rowObject.movimiento
     _FldNameList[4]   = _<SDO>.rowObject.Lote
     _FldNameList[5]   = _<SDO>.rowObject.articulo
     _FldNameList[6]   = _<SDO>.rowObject.nro_movimiento
     _FldNameList[7]   = _<SDO>.rowObject.tambor_desde
     _FldNameList[8]   = _<SDO>.rowObject.tambor_hasta
     _FldNameList[9]   = _<SDO>.rowObject.cantidad
