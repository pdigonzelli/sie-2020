...
DEFINE VARIABLE h_b_gastos_venta AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_gastos_venta AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Gastos Venta */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Gastos Venta */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_gastos_venta.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_gastos_venta ).
       RUN set-position IN h_b_gastos_venta ( 4.10 , 8.00 ) NO-ERROR.
       RUN set-size IN h_b_gastos_venta ( 6.71 , 61.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_gastos_venta.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_gastos_venta ).
       RUN set-position IN h_v_gastos_venta ( 11.95 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 51.00 ) */

       /* Links to csmartbrowser h_b_gastos_venta. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_gastos_venta ).

       /* Links to SmartViewer h_v_gastos_venta. */
       RUN add-link IN adm-broker-hdl ( h_b_gastos_venta , 'Record':U , h_v_gastos_venta ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_gastos_venta ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_gastos_venta ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_gastos_venta ,
             h_b_gastos_venta , 'AFTER':U ).
    END. /* Page 0 */
