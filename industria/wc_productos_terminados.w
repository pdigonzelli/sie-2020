...
DEFINE VARIABLE h_bc_productos_terminados AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-19 AT ROW 1.86 COL 7
     SPACE(8.99) SKIP(2.42)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_productos_terminados.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_productos_terminados ).
       RUN set-position IN h_bc_productos_terminados ( 2.43 , 12.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_productos_terminados ,
