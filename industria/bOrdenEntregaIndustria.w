...
rowObject.fecha rowObject.abreviatura rowObject.abreviatura-3 ~
rowObject.abreviatura-2 rowObject.descripcion-3 rowObject.semana_embarque 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      abreviatura-3 FORMAT "x(10)":U
      abreviatura-2 FORMAT "X(12)":U
      descripcion-3 FORMAT "X(30)":U
      semana_embarque FORMAT ">9":U WIDTH 30
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 116 BY 6.67 EXPANDABLE.
...
"id_orden_entrega" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.fecha
     _FldNameList[3]   > _<SDO>.rowObject.abreviatura
"abreviatura" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[4]   = _<SDO>.rowObject.abreviatura-3
     _FldNameList[5]   > _<SDO>.rowObject.abreviatura-2
"abreviatura-2" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[6]   = _<SDO>.rowObject.descripcion-3
     _FldNameList[7]   > _<SDO>.rowObject.semana_embarque
"semana_embarque" ? ? "integer" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" ""
