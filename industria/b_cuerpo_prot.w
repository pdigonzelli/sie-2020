...
&Scoped-define INTERNAL-TABLES cuerpo_prot

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table cuerpo_prot.id_cuerpo ~
cuerpo_prot.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH cuerpo_prot WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table cuerpo_prot
&Scoped-define FIRST-TABLE-IN-QUERY-br_table cuerpo_prot
...
<FOREIGN-KEYS>
id_cuerpo||y|general.cuerpo_prot.id_cuerpo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      cuerpo_prot.id_cuerpo FORMAT ">>9":U WIDTH 10.2
      cuerpo_prot.descripcion FORMAT "X(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 64 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.cuerpo_prot"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.cuerpo_prot.id_cuerpo
"id_cuerpo" ? ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[2]   = general.cuerpo_prot.descripcion
...
define sub-menu Ordena 
  menu-item cuerpo_prot-id_cuerpo
label 'id_cuerpo( cuerpo_prot ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=cuerpo_prot.id_cuerpo').
                  run set-attribute-list('titulo=CodCuerpo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by cuerpo_prot.id_cuerpo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item cuerpo_prot-descripcion
label 'descripcion( cuerpo_prot ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=cuerpo_prot.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by cuerpo_prot.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item cuerpo_prot-abreviatura
label 'abreviatura( cuerpo_prot ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=cuerpo_prot.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by cuerpo_prot.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by cuerpo_prot.id_cuerpo
...
case p:
  WHEN 'cuerpo_prot.id_cuerpo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_cuerpo = integer(valor)  no-lock no-error .
  WHEN 'cuerpo_prot.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'cuerpo_prot.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_cuerpo" "cuerpo_prot" "id_cuerpo"}
