...
DEFINE VARIABLE h_b_consulta_remitos AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_items_factura_remitos AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_lotes_jugo_todos AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_lotes_jugo_todos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_lotes_jugo_todos ).
       RUN set-position IN h_b_lotes_jugo_todos ( 3.62 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_lotes_jugo_todos ( 6.71 , 145.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_remitos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_remitos ).
       RUN set-position IN h_b_consulta_remitos ( 10.76 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_consulta_remitos ( 6.71 , 146.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_items_factura_remitos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_items_factura_remitos ).
       RUN set-position IN h_b_items_factura_remitos ( 17.91 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_items_factura_remitos ( 6.71 , 144.00 ) NO-ERROR.

       /* Links to csmartbrowser h_b_lotes_jugo_todos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_lotes_jugo_todos ).

       /* Links to csmartbrowser h_b_consulta_remitos. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_jugo_todos , 'Record':U , h_b_consulta_remitos ).

       /* Links to csmartbrowser h_b_items_factura_remitos. */
       RUN add-link IN adm-broker-hdl ( h_b_consulta_remitos , 'Record':U , h_b_items_factura_remitos ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_lotes_jugo_todos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_remitos ,
             h_b_lotes_jugo_todos , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_items_factura_remitos ,
             h_b_consulta_remitos , 'AFTER':U ).
    END. /* Page 0 */
