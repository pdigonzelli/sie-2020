...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-24 
...
DEFINE FRAME D-Dialog
     ...
     RECT-24 AT ROW 1.95 COL 5
     SPACE(4.99) SKIP(2.71)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_tipos_protocolos ( 2.43 , 8.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_protocolos ( 6.71 , 74.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-24 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
