...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-4 
...
DEFINE VARIABLE h_bc_envases_new AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-4 AT ROW 1.95 COL 3
     SPACE(3.99) SKIP(2.47)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Consulta de Envases".
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Consulta de Envases */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_envases_new.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_envases_new ).
       RUN set-position IN h_bc_envases_new ( 2.43 , 8.00 ) NO-ERROR.
       RUN set-size IN h_bc_envases_new ( 6.71 , 77.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_envases_new ,
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE dame-datos D-Dialog 
PROCEDURE dame-datos :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEFINE OUTPUT PARAMETER p_cal AS INTEGER.
p_art = p_articulo.
p_cal = p_calidad.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-4 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
