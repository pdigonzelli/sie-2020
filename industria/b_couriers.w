...
&Scoped-define INTERNAL-TABLES couriers

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table couriers.id_courier ~
couriers.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH couriers WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table couriers
&Scoped-define FIRST-TABLE-IN-QUERY-br_table couriers
...
<FOREIGN-KEYS>
id_courier||y|general.couriers.id_courier
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      couriers.id_courier FORMAT ">>>>>9":U WIDTH 10.2
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.couriers"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.couriers.id_courier
"id_courier" ? ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[2]   = general.couriers.descripcion
...
define sub-menu Ordena 
  menu-item couriers-id_courier
label 'id_courier( couriers ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=couriers.id_courier').
                  run set-attribute-list('titulo=Cod Courier').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by couriers.id_courier
...
case p:
  WHEN 'couriers.id_courier' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_courier = integer(valor)  no-lock no-error .
  WHEN 'couriers.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_courier" "couriers" "id_courier"}
