...
DEFINE FRAME D-Dialog
     ...
     RECT-4 AT ROW 2.43 COL 5
     SPACE(8.99) SKIP(2.47)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_tipos_contacto_industria ( 2.67 , 7.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_contacto_industria ( 6.71 , 71.00 ) NO-ERROR.
