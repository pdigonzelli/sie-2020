...
DEFINE VARIABLE h_b_consultamuestras_2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consultamuestras_2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consultamuestras_2 ).
       RUN set-position IN h_b_consultamuestras_2 ( 4.10 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b_consultamuestras_2 ( 20.24 , 117.00 ) NO-ERROR.

       /* Links to csmartbrowser h_b_consultamuestras_2. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_consultamuestras_2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consultamuestras_2 ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
