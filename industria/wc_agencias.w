...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.76 COL 75
     salir AT ROW 10.76 COL 87
     RECT-1 AT ROW 10.52 COL 72
     RECT-4 AT ROW 2.19 COL 6
     SPACE(5.79) SKIP(2.47)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b_agencias ).
       RUN set-position IN h_b_agencias ( 2.67 , 10.00 ) NO-ERROR.
