...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipos_articulos
&Scoped-define FIRST-EXTERNAL-TABLE tipos_articulos


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipos_articulos.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipos_articulos.id_tipo_articulo ~
tipos_articulos.descripcion tipos_articulos.abreviatura 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_tipo_articulo ~{&FP2}id_tipo_articulo ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}~
 ~{&FP1}abreviatura ~{&FP2}abreviatura ~{&FP3}
&Scoped-define ENABLED-TABLES tipos_articulos
&Scoped-define FIRST-ENABLED-TABLE tipos_articulos
&Scoped-Define DISPLAYED-FIELDS tipos_articulos.id_tipo_articulo ~
tipos_articulos.descripcion tipos_articulos.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipos_articulos.id_tipo_articulo 
...
DEFINE FRAME F-Main
     tipos_articulos.id_tipo_articulo AT ROW 1 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     tipos_articulos.descripcion AT ROW 2 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipos_articulos.abreviatura AT ROW 3 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipos_articulos
...
/* SETTINGS FOR FILL-IN tipos_articulos.id_tipo_articulo IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipos_articulos.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_articulos.abreviatura V-table-Win
ON LEAVE OF tipos_articulos.abreviatura IN FRAME F-Main /* Descripción */
DO:
...
&Scoped-define SELF-NAME tipos_articulos.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_articulos.descripcion V-table-Win
ON LEAVE OF tipos_articulos.descripcion IN FRAME F-Main /* Descripción */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tipos_articulos.id_tipo_articulo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_articulos.id_tipo_articulo V-table-Win
ON LEAVE OF tipos_articulos.id_tipo_articulo IN FRAME F-Main /* Tipo de Articulo */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipos_articulos"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipos_articulos"}
