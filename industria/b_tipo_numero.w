...
&Scoped-define INTERNAL-TABLES tipo_numero

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipo_numero.id_sucursal ~
tipo_numero.id_tipo_movsto tipo_numero.nro tipo_numero.id_punto_venta 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipo_numero WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipo_numero
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipo_numero
...
<FOREIGN-KEYS>
id_sucursal|y|y|comercial.tipo_numero.id_sucursal
id_tipo_movsto||y|comercial.tipo_numero.id_tipo_movsto
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "id_sucursal",
     Keys-Supplied = "id_sucursal,id_tipo_movsto"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipo_numero.id_sucursal FORMAT ">>9":U WIDTH 12.2
      tipo_numero.id_tipo_movsto FORMAT ">>9":U WIDTH 10.2
      tipo_numero.nro FORMAT ">>>>>>9":U WIDTH 13.2
      tipo_numero.id_punto_venta FORMAT ">>>9":U WIDTH 12.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "comercial.tipo_numero"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > comercial.tipo_numero.id_sucursal
"id_sucursal" ? ? "integer" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[2]   > comercial.tipo_numero.id_tipo_movsto
"id_tipo_movsto" ? ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[3]   > comercial.tipo_numero.nro
"nro" ? ">>>>>>9" "integer" ? ? ? ? ? ? no ? no no "13.2" yes no no "U" "" ""
     _FldNameList[4]   > comercial.tipo_numero.id_punto_venta
"id_punto_venta" ? ? "integer" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
...
define sub-menu Ordena 
  menu-item tipo_numero-id_sucursal
label 'id_sucursal( tipo_numero ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_numero.id_sucursal').
                  run set-attribute-list('titulo=Sucursal').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_numero.id_sucursal
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_numero-id_tipo_movsto
label 'id_tipo_movsto( tipo_numero ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_numero.id_tipo_movsto').
                  run set-attribute-list('titulo=Tipo comprobante').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_numero.id_tipo_movsto
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_numero-id_punto_venta
label 'id_punto_venta( tipo_numero ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_numero.id_punto_venta').
                  run set-attribute-list('titulo=Pto.Vta').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_numero.id_punto_venta
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipo_numero.id_sucursal
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_sucursal':U THEN DO:
       &Scope KEY-PHRASE tipo_numero.id_sucursal eq INTEGER(key-value)
       {&OPEN-QUERY-{&BROWSE-NAME}}
    END. /* id_sucursal */
    OTHERWISE DO:
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_sucursal" "tipo_numero" "id_sucursal"}
  {src/adm/template/sndkycas.i "id_tipo_movsto" "tipo_numero" "id_tipo_movsto"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tipo_numero"}
