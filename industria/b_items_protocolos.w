...
&Scoped-define FIELDS-IN-QUERY-br_table items_protocolos.orden ~
Caracteristicas_quimicas.descripcion items_protocolos.valor_caracter 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH items_protocolos WHERE items_protocolos.id_protocolo = protocolos.id_protocolo ~
  AND items_protocolos.anio = protocolos.anio ~
  AND items_protocolos.id_articulo = protocolos.id_articulo NO-LOCK, ~
      EACH Caracteristicas_quimicas OF items_protocolos NO-LOCK ~
    BY items_protocolos.orden
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH items_protocolos WHERE items_protocolos.id_protocolo = protocolos.id_protocolo ~
  AND items_protocolos.anio = protocolos.anio ~
  AND items_protocolos.id_articulo = protocolos.id_articulo NO-LOCK, ~
      EACH Caracteristicas_quimicas OF items_protocolos NO-LOCK ~
    BY items_protocolos.orden.
&Scoped-define TABLES-IN-QUERY-br_table items_protocolos ~
Caracteristicas_quimicas
&Scoped-define FIRST-TABLE-IN-QUERY-br_table items_protocolos
...
<FOREIGN-KEYS>
id_caracteristica||y|general.items_protocolos.id_caracteristica
id_protocolo||y|general.items_protocolos.id_protocolo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_caracteristica,id_protocolo"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      items_protocolos.orden COLUMN-LABEL "Nro" FORMAT ">9":U WIDTH 4.2
      Caracteristicas_quimicas.descripcion COLUMN-LABEL "Characteristic" FORMAT "X(50)":U
            WIDTH 56.2
      items_protocolos.valor_caracter FORMAT "X(12)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 82 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.items_protocolos WHERE general.protocolos <external> ...,industria.Caracteristicas_quimicas OF general.items_protocolos"
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ","
     _OrdList          = "general.items_protocolos.orden|yes"
     _JoinCode[1]      = "general.items_protocolos.id_protocolo = general.protocolos.id_protocolo
  AND general.items_protocolos.anio = general.protocolos.anio
  AND general.items_protocolos.id_articulo = general.protocolos.id_articulo"
     _FldNameList[1]   > general.items_protocolos.orden
"items_protocolos.orden" "Nro" ">9" "integer" ? ? ? ? ? ? no ? no no "4.2" yes no no "U" "" ""
     _FldNameList[2]   > general.Caracteristicas_quimicas.descripcion
"Caracteristicas_quimicas.descripcion" "Characteristic" "X(50)" "character" ? ? ? ? ? ? no ? no no "56.2" yes no no "U" "" ""
     _FldNameList[3]   > general.items_protocolos.valor_caracter
"items_protocolos.valor_caracter" ? "X(12)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
case p:
  WHEN 'items_protocolos.valor' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  valor = decimal(valor)  no-lock no-error .
end.*/
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_caracteristica" "items_protocolos" "id_caracteristica"}
  {src/adm/template/sndkycas.i "id_protocolo" "items_protocolos" "id_protocolo"}
