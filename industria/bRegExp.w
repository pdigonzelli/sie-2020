...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.anio rowObject.semana ~
rowObject.Origen rowObject.Cantidad rowObject.id_puerto_origen 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.id_puerto_origen FORMAT ">>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.anio
     _FldNameList[2]   = _<SDO>.rowObject.semana
     _FldNameList[3]   = _<SDO>.rowObject.Origen
     _FldNameList[4]   = _<SDO>.rowObject.Cantidad
     _FldNameList[5]   = _<SDO>.rowObject.id_puerto_origen
