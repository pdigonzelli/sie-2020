...
DEFINE VARIABLE h_b_tipos_orden_entrega AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_orden_entrega AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tipos Orden Entrega */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipos Orden Entrega */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 3.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 37.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 60.80 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_orden_entrega.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_orden_entrega ).
       RUN set-position IN h_b_tipos_orden_entrega ( 3.86 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_orden_entrega ( 6.71 , 81.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_orden_entrega.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_orden_entrega ).
       RUN set-position IN h_v_tipos_orden_entrega ( 12.67 , 18.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 47.00 ) */

       /* Links to csmartbrowser h_b_tipos_orden_entrega. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_orden_entrega ).

       /* Links to SmartViewer h_v_tipos_orden_entrega. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_orden_entrega , 'Record':U , h_v_tipos_orden_entrega ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_orden_entrega ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_orden_entrega ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_orden_entrega ,
             h_b_tipos_orden_entrega , 'AFTER':U ).
    END. /* Page 0 */
