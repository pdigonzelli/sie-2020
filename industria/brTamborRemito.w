...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Lote rowObject.Anio ~
rowObject.fecha rowObject.id_tambor rowObject.Kilos rowObject.Ubicacion ~
rowObject.id_sucursal rowObject.nromov rowObject.nro_remito 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.fecha ~
rowObject.id_tambor rowObject.id_sucursal rowObject.nromov ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_tambor FORMAT ">>>,>>>,>>9":U
      Kilos FORMAT "->>,>>>,>>9.99":U
      Ubicacion FORMAT "x(15)":U
      id_sucursal FORMAT ">>,>>9":U
      nromov FORMAT ">>>,>>>,>>9":U
      nro_remito FORMAT ">>,>>>,>>9":U
  ENABLE
      fecha
      id_tambor HELP "?"
      id_sucursal HELP "?"
...
"Lote" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Anio
"Anio" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.fecha
"fecha" ? ? "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.id_tambor
"id_tambor" ? ? "integer" ? ? ? ? ? ? yes "?" no no ? yes no no "U" "" ""
     _FldNameList[5]   > _<SDO>.rowObject.Kilos
"Kilos" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[6]   > _<SDO>.rowObject.Ubicacion
"Ubicacion" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[7]   > _<SDO>.rowObject.id_sucursal
"id_sucursal" ? ? "integer" ? ? ? ? ? ? yes "?" no no ? yes no no "U" "" ""
     _FldNameList[8]   > _<SDO>.rowObject.nromov
"nromov" ? ? "integer" ? ? ? ? ? ? yes "?" no no ? yes no no "U" "" ""
     _FldNameList[9]   > _<SDO>.rowObject.nro_remito
"nro_remito" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND (hCont:FILE-NAME MATCHES "*wRemitos.w" ) THEN DO:
    ...
    ASSIGN rowObject.lote:BGCOLOR IN BROWSE br_table        = ibgcolor
