...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_pedido ~
rowObject.estado rowObject.id_proveedor rowObject.nombre rowObject.recibido ~
rowObject.cantidad rowObject.cant_recibida 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_pedido FORMAT ">>,>>>,>>9":U
      estado FORMAT "Vigente/Anulado":U
      id_proveedor FORMAT ">>>,>>9":U
      nombre FORMAT "x(30)":U
      recibido FORMAT "Si/No":U
      cantidad FORMAT ">,>>>,>>9.999":U
      cant_recibida FORMAT ">>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 100 BY 6.67 EXPANDABLE.
