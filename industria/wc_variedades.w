...
DEFINE VARIABLE h_b_variedades AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-2 AT ROW 1.95 COL 3
     SPACE(1.99) SKIP(2.23)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_variedades.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_variedades ).
       RUN set-position IN h_b_variedades ( 2.43 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 80.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_variedades ,
