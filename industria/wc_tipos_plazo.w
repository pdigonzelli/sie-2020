...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.52 COL 96
     salir AT ROW 10.52 COL 108
     RECT-1 AT ROW 10.29 COL 93
     RECT-4 AT ROW 1.71 COL 2
     SPACE(0.79) SKIP(2.47)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_tipos_plazo ( 2.43 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 89.00 ) */
