...
&Scoped-define FIELDS-IN-QUERY-br_table tt_etiqueta.etiqueta tt_etiqueta.tipotambor tt_etiqueta.id_lote tt_etiqueta.id_tambor   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      tt_etiqueta.etiqueta label "Etiqueta"
      tt_etiqueta.tipotambor label "Tipotambor"
...
run get-parametros in hcon (output p1, output p2, output p3, output p4).

find tambores_industria where id_etiqueta = integer(eti) no-error.
if available tambores_industria then
 do:
    assign tambores_industria.id_empresa_ubicacion = p1
           tambores_industria.id_sucursal_ubicacion = p2
           tambores_industria.id_locacion_ubicacion = p3
           tambores_industria.id_posicion_ubicacion = p4.
    
    create tt_etiqueta.
    assign  tt_etiqueta.etiqueta = eti
            tt_etiqueta.tipotambor = tambores_industria.id_tipotambor
    ...
    do:
        ...
        bell.
        bell.
        message "No se encuantra el tambor con etiqueta " eti view-as alert-box error.
    end.
END PROCEDURE.
