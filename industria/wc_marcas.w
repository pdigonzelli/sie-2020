...
DEFINE VARIABLE h_b_marcas AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_marcas.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_marcas ).
       RUN set-position IN h_b_marcas ( 2.19 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b_marcas ( 6.71 , 97.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_marcas ,
