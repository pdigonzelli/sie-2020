...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES cuerpo_prot
&Scoped-define FIRST-EXTERNAL-TABLE cuerpo_prot


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR cuerpo_prot.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS cuerpo_prot.id_cuerpo cuerpo_prot.descripcion ~
cuerpo_prot.abreviatura 
&Scoped-define ENABLED-TABLES cuerpo_prot
&Scoped-define FIRST-ENABLED-TABLE cuerpo_prot
&Scoped-define DISPLAYED-TABLES cuerpo_prot
&Scoped-define FIRST-DISPLAYED-TABLE cuerpo_prot
&Scoped-Define DISPLAYED-FIELDS cuerpo_prot.id_cuerpo ~
cuerpo_prot.descripcion cuerpo_prot.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS cuerpo_prot.id_cuerpo 
...
DEFINE FRAME F-Main
     cuerpo_prot.id_cuerpo AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     cuerpo_prot.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 48 BY 1
     cuerpo_prot.abreviatura AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.cuerpo_prot
...
/* SETTINGS FOR FILL-IN cuerpo_prot.id_cuerpo IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME cuerpo_prot.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL cuerpo_prot.abreviatura V-table-Win 
ON LEAVE OF cuerpo_prot.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME cuerpo_prot.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL cuerpo_prot.descripcion V-table-Win 
ON LEAVE OF cuerpo_prot.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME cuerpo_prot.id_cuerpo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL cuerpo_prot.id_cuerpo V-table-Win 
ON LEAVE OF cuerpo_prot.id_cuerpo IN FRAME F-Main /* CodCuerpo */
DO:
{custom/support/validacion.i}
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN cuerpo_prot.c_usuario = USERID("userdb")
       cuerpo_prot.c_fecha   = TODAY
       cuerpo_prot.c_hora    = STRING(TIME,"HH:MM:SS").
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "cuerpo_prot"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "cuerpo_prot"}
