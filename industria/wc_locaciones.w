...
&Scoped-Define ENABLED-OBJECTS RECT-17 RECT-1 aceptar salir 
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.48 COL 118
     salir AT ROW 10.48 COL 130
     RECT-17 AT ROW 2.05 COL 6
     RECT-1 AT ROW 10.24 COL 115
     SPACE(9.79) SKIP(0.61)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_bc_locaciones ( 2.62 , 9.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-17 RECT-1 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
