...
"valor_caracter" "valor_caracter" ? ? "character" ? ? ? ? ? ? no ? no 100 yes
     _FldNameList[7]   > general.Caracteristicas_quimicas.id_caracteristica
"id_caracteristica" "id_caracteristica" ? ? "integer" ? ? ? ? ? ? no ? no 16.6 yes
     _FldNameList[8]   > general.Caracteristicas_quimicas.descripcion
"descripcion" "descripcion" ? ? "character" ? ? ? ? ? ? no ? no 60 yes
     _FldNameList[9]   > general.Caracteristicas_quimicas.calculo
"calculo" "calculo" ? ? "logical" ? ? ? ? ? ? no ? no 7 yes
     _FldNameList[10]   > general.Caracteristicas_quimicas.programa
