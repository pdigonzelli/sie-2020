...
rowObject.id_tipo_movsto rowObject.nro_comprobante rowObject.fecha ~
rowObject.FechaArribo rowObject.Destino rowObject.LugarDescarga ~
rowObject.nro rowObject.id_orden_entrega rowObject.estado ~
rowObject.fecha_proceso rowObject.c_usuario 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.FechaArribo FORMAT "99/99/9999":U
      rowObject.Destino FORMAT "x(20)":U
      rowObject.LugarDescarga FORMAT "x(20)":U
      rowObject.nro FORMAT ">>>,>>9":U
      rowObject.id_orden_entrega FORMAT ">>>>>9":U
      rowObject.estado FORMAT "Vigente/Anulado":U
      rowObject.fecha_proceso FORMAT "99/99/99":U
      rowObject.c_usuario FORMAT "x(12)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = _<SDO>.rowObject.nro_comprobante
     _FldNameList[4]   = _<SDO>.rowObject.fecha
     _FldNameList[5]   = _<SDO>.rowObject.FechaArribo
     _FldNameList[6]   = _<SDO>.rowObject.Destino
     _FldNameList[7]   = _<SDO>.rowObject.LugarDescarga
     _FldNameList[8]   = _<SDO>.rowObject.nro
     _FldNameList[9]   = _<SDO>.rowObject.id_orden_entrega
     _FldNameList[10]   = _<SDO>.rowObject.estado
     _FldNameList[11]   = _<SDO>.rowObject.fecha_proceso
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND (hCont:FILE-NAME MATCHES "*wRemitos.w" ) THEN DO:
    ...
    IF rowObject.fecha_proceso <> ? THEN
      iBgColor = 23.

    IF rowObject.estado = FALSE THEN
      iBgColor = 12.
    ...
    ASSIGN rowObject.id_sucursal:BGCOLOR IN BROWSE br_table           = ibgcolor
           ...
           rowObject.fecha_proceso:BGCOLOR IN BROWSE br_table         = ibgcolor
...
DO:
  ...
  IF VALID-HANDLE(hCont) THEN DO:
    IF rowObject.fecha_proceso:SCREEN-VALUE <> "" THEN 
      RUN customEnableFunctions IN hCont (FALSE).
