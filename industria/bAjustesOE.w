...
rowObject.item_oe rowObject.Lote rowObject.tambor_desde ~
rowObject.tambor_hasta rowObject.id_orden_entrega_new rowObject.item_oe_new 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_orden_entrega_new FORMAT ">>>>>9":U
      item_oe_new FORMAT ">>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = _<SDO>.rowObject.Lote
     _FldNameList[4]   = _<SDO>.rowObject.tambor_desde
     _FldNameList[5]   = _<SDO>.rowObject.tambor_hasta
     _FldNameList[6]   = _<SDO>.rowObject.id_orden_entrega_new
     _FldNameList[7]   = _<SDO>.rowObject.item_oe_new
...
DO:
  ...
  ASSIGN rowObject.id_orden_entrega:BGCOLOR IN BROWSE br_table     = ibgcolor
         ...
         rowObject.id_orden_entrega_new:BGCOLOR IN BROWSE br_table = ibgcolor
         rowObject.ITEM_oe_new:BGCOLOR IN BROWSE br_table          = ibgcolor
         .
