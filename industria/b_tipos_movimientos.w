...
tipos_movimientos.id_tipo_movimiento tipos_movimientos.descripcion ~
tipos_movimientos.codigo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_movimientos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table tipos_movimientos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_movimientos
...
<FOREIGN-KEYS>
id_tipo_movimiento||y|general.tipos_movimientos.id_tipo_movimiento
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_movimientos.id_tipo_movimiento FORMAT ">,>>9"
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > general.tipos_movimientos.id_tipo_movimiento
"id_tipo_movimiento" ? ">,>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   = general.tipos_movimientos.descripcion
     _FldNameList[3]   = general.tipos_movimientos.codigo
...
define sub-menu Ordena 
  menu-item tipos_movimientos-id_tipo_movimiento
label 'id_tipo_movimiento( tipos_movimientos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_movimientos.id_tipo_movimiento').
                  run set-attribute-list('titulo=Tipo Movimiento').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_movimientos.id_tipo_movimiento
...
label 'descripcion( tipos_movimientos ) '
  ...
  menu-item tipos_movimientos-codigo
label 'codigo( tipos_movimientos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_movimientos.codigo').
                  run set-attribute-list('titulo=Codigo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_movimientos.codigo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipos_movimientos.id_tipo_movimiento
...
case p:
  WHEN 'tipos_movimientos.id_tipo_movimiento' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_movimiento = integer(valor)  no-lock no-error .
  WHEN 'tipos_movimientos.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'tipos_movimientos.codigo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  codigo begins valor  no-lock no-error .
end.
END PROCEDURE.
