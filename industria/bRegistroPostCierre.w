...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_registro ~
rowObject.fecha rowObject.Lote_Proc rowObject.Anio rowObject.Producto ~
rowObject.FechaInicio rowObject.FechaCierre 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_registro FORMAT "->,>>>,>>9":U
      fecha FORMAT "99/99/9999":U
      Lote_Proc FORMAT "x(10)":U
      Anio FORMAT ">>>9":U
      Producto FORMAT "x(25)":U
      FechaInicio FORMAT "99/99/9999":U
      FechaCierre FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_registro
     _FldNameList[2]   = _<SDO>.rowObject.fecha
     _FldNameList[3]   = _<SDO>.rowObject.Lote_Proc
     _FldNameList[4]   = _<SDO>.rowObject.Anio
     _FldNameList[5]   = _<SDO>.rowObject.Producto
     _FldNameList[6]   = _<SDO>.rowObject.FechaInicio
     _FldNameList[7]   = _<SDO>.rowObject.FechaCierre
