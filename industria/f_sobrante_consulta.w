...
DEFINE VARIABLE h_b_sobrante_consulta AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_sobrante_consulta.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_sobrante_consulta ).
       RUN set-position IN h_b_sobrante_consulta ( 5.29 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.71 , 143.00 ) */

       /* Links to csmartbrowser h_b_sobrante_consulta. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_sobrante_consulta ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_sobrante_consulta ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
