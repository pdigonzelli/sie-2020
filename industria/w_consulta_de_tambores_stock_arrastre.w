...
DEFINE VARIABLE h_b_tambores_arrastre AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_tambores_de_lote AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_lotes_jugo_consulta ( 3.57 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.76 , 150.00 ) */
       ...
       RUN set-position IN h_cus-updsav-2 ( 8.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_cus-updsav-2 ( 1.81 , 36.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tambores_de_lote.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tambores_de_lote ).
       RUN set-position IN h_b_tambores_de_lote ( 10.43 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.95 , 149.00 ) */
       ...
       RUN set-position IN h_cus-updsav-3 ( 15.76 , 2.00 ) NO-ERROR.
       RUN set-size IN h_cus-updsav-3 ( 1.91 , 36.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tambores_arrastre.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tambores_arrastre ).
       RUN set-position IN h_b_tambores_arrastre ( 17.95 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.52 , 153.00 ) */

       /* Links to csmartbrowser h_b_lotes_jugo_consulta. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_lotes_jugo_consulta ).

       /* Links to csmartbrowser h_b_tambores_de_lote. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_jugo_consulta , 'Record':U , h_b_tambores_de_lote ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav-2 , 'TableIO':U , h_b_tambores_de_lote ).

       /* Links to csmartbrowser h_b_tambores_arrastre. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_jugo_consulta , 'Record':U , h_b_tambores_arrastre ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav-3 , 'TableIO':U , h_b_tambores_arrastre ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-updsav-2 ,
             h_b_lotes_jugo_consulta , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tambores_de_lote ,
             h_cus-updsav-2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-updsav-3 ,
             h_b_tambores_de_lote , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tambores_arrastre ,
