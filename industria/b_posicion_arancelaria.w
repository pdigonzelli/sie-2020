...
&Scoped-define INTERNAL-TABLES posicion_arancelaria
...
posicion_arancelaria.descripcion posicion_arancelaria.fecha 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH posicion_arancelaria WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table posicion_arancelaria
&Scoped-define FIRST-TABLE-IN-QUERY-br_table posicion_arancelaria
...
<FOREIGN-KEYS>
id_posicion_arancelaria||y|general.posicion_arancelaria.id_posicion_arancelaria
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_posicion_arancelaria"':U).
...
DEFINE QUERY br_table FOR 
      posicion_arancelaria SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      posicion_arancelaria.id_posicion_arancelaria
      posicion_arancelaria.descripcion
      posicion_arancelaria.fecha
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.posicion_arancelaria"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.posicion_arancelaria.id_posicion_arancelaria
     _FldNameList[2]   = general.posicion_arancelaria.descripcion
     _FldNameList[3]   = general.posicion_arancelaria.fecha
...
define sub-menu Ordena 
  menu-item posicion_arancelaria-id_posicion_arancelaria
label 'id_posicion_arancelaria( posicion_arancelaria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=posicion_arancelaria.id_posicion_arancelaria').
                  run set-attribute-list('titulo=Posicion arancelaria').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by posicion_arancelaria.id_posicion_arancelaria
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item posicion_arancelaria-descripcion
label 'descripcion( posicion_arancelaria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=posicion_arancelaria.descripcion').
                  run set-attribute-list('titulo=Des.Pos.Aranc.').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by posicion_arancelaria.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item posicion_arancelaria-fecha
label 'fecha( posicion_arancelaria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=posicion_arancelaria.fecha').
                  run set-attribute-list('titulo=Fecha').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by posicion_arancelaria.fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by posicion_arancelaria.id_posicion_arancelaria
...
case p:
  WHEN 'posicion_arancelaria.id_posicion_arancelaria' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_posicion_arancelaria begins valor  no-lock no-error .
  WHEN 'posicion_arancelaria.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'posicion_arancelaria.fecha' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_posicion_arancelaria" "posicion_arancelaria" "id_posicion_arancelaria"}
