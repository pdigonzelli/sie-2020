...
&Scoped-define INTERNAL-TABLES produccion_cascara sucursales

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table produccion_cascara.id_empresa ~
sucursales.nombre produccion_cascara.id_produccion produccion_cascara.Fecha ~
produccion_cascara.cantidad_bolsas 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH produccion_cascara WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH sucursales OF produccion_cascara NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table produccion_cascara sucursales
&Scoped-define FIRST-TABLE-IN-QUERY-br_table produccion_cascara
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.produccion_cascara,comercial.sucursales OF general.produccion_cascara"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.produccion_cascara.id_empresa
     _FldNameList[2]   = comercial.sucursales.nombre
     _FldNameList[3]   = general.produccion_cascara.id_produccion
     _FldNameList[4]   = general.produccion_cascara.Fecha
     _FldNameList[5]   = general.produccion_cascara.cantidad_bolsas
...
define sub-menu Ordena 
  menu-item produccion_cascara-id_empresa
label 'id_empresa( produccion_cascara ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=produccion_cascara.id_empresa').
                  run set-attribute-list('titulo=Empresa').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by produccion_cascara.id_empresa
...
label 'nombre( sucursales ) '
  ...
  menu-item produccion_cascara-id_produccion
label 'id_produccion( produccion_cascara ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=produccion_cascara.id_produccion').
                  run set-attribute-list('titulo=Produccion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by produccion_cascara.id_produccion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item produccion_cascara-Fecha
label 'Fecha( produccion_cascara ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=produccion_cascara.Fecha').
                  run set-attribute-list('titulo=Fecha').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by produccion_cascara.Fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item produccion_cascara-cantidad_bolsas
label 'cantidad_bolsas( produccion_cascara ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=produccion_cascara.cantidad_bolsas').
                  run set-attribute-list('titulo=Cantidad Bolsas').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by produccion_cascara.cantidad_bolsas
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by produccion_cascara.id_empresa
