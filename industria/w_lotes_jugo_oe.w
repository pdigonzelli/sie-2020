...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b_lotes_orden_fabricacion , 'Record':U , h_v_lotes_jugo_orden_entrega ).
       RUN add-link IN adm-broker-hdl ( h_cus-update-only , 'TableIO':U , h_v_lotes_jugo_orden_entrega ).
