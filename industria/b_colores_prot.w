...
&Scoped-define INTERNAL-TABLES colores_prot

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table colores_prot.id_color ~
colores_prot.descripcion colores_prot.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH colores_prot WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table colores_prot
&Scoped-define FIRST-TABLE-IN-QUERY-br_table colores_prot
...
<FOREIGN-KEYS>
id_color||y|general.colores_prot.id_color
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      colores_prot.id_color FORMAT ">>9":U WIDTH 12.2
      colores_prot.descripcion FORMAT "X(40)":U WIDTH 44.2
      colores_prot.abreviatura FORMAT "X(12)":U WIDTH 15.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.colores_prot"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.colores_prot.id_color
"id_color" ? ? "integer" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[2]   > general.colores_prot.descripcion
"descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "44.2" yes no no "U" "" ""
     _FldNameList[3]   > general.colores_prot.abreviatura
"abreviatura" ? ? "character" ? ? ? ? ? ? no ? no no "15.4" yes no no "U" "" ""
...
define sub-menu Ordena 
  menu-item colores_prot-id_color
label 'id_color( colores_prot ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=colores_prot.id_color').
                  run set-attribute-list('titulo=CodColores').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by colores_prot.id_color
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item colores_prot-descripcion
label 'descripcion( colores_prot ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=colores_prot.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by colores_prot.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item colores_prot-abreviatura
label 'abreviatura( colores_prot ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=colores_prot.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by colores_prot.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by colores_prot.id_color
...
case p:
  WHEN 'colores_prot.id_color' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_color = integer(valor)  no-lock no-error .
  WHEN 'colores_prot.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'colores_prot.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_color" "colores_prot" "id_color"}
