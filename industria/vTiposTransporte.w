...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dtipostransporte ( 16.00 , 70.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_btipostransporte ( 2.91 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_btipostransporte ( 9.76 , 78.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_vtipotransporte ( 13.86 , 10.00 ) NO-ERROR.
