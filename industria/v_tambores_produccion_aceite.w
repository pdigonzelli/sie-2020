...
ON GO OF tambores_aceite.id_articulo IN FRAME F-Main /* Artículo */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tambores_aceite.id_articulo V-table-Win
ON LEAVE OF tambores_aceite.id_articulo IN FRAME F-Main /* Artículo */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tambores_aceite.id_articulo V-table-Win
ON MOUSE-SELECT-DBLCLICK OF tambores_aceite.id_articulo IN FRAME F-Main /* Artículo */
do: 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tambores_aceite.id_articulo V-table-Win
ON U1 OF tambores_aceite.id_articulo IN FRAME F-Main /* Artículo */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
