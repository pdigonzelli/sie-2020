...
rowObject.id_tanque rowObject.descripcion rowObject.abreviatura ~
rowObject.capacidad rowObject.volumen 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_tanque FORMAT "->,>>>,>>9":U
      descripcion FORMAT "X(100)":U
      abreviatura FORMAT "X(25)":U
      capacidad FORMAT ">>,>>9.99":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.id_tanque
     _FldNameList[3]   = _<SDO>.rowObject.descripcion
     _FldNameList[4]   = _<SDO>.rowObject.abreviatura
     _FldNameList[5]   = _<SDO>.rowObject.capacidad
     _FldNameList[6]   = _<SDO>.rowObject.volumen
