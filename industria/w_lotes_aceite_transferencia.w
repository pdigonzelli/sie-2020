...
DEFINE VARIABLE h_b_lotes_aceite_transferencia AS HANDLE NO-UNDO.
...
ON CHOOSE OF BUTTON-1 IN FRAME F-Main /* Transferencia */
DO:
  define var r as rowid.

  run get-rowid1 in h_b_lotes_aceite_transferencia (output r).
  
  FOR EACH lotes_aceite WHERE ROWID(lotes_aceite) = r.
    IF lotes_aceite.id_articulo = 74 THEN DO:
        ...
        FOR each tambores_industria of lotes_aceite
            ...
            ASSIGN lotes_aceite.id_articulo = 90.
            ...
            ASSIGN tambores_industria.id_articulo = 90
                   tambores_industria.id_calidad = 600
        ...
        MESSAGE "Se realizó la trasnferencia " lotes_aceite.id_lote view-as alert-box.
            
    END.
    ELSE DO:
        IF lotes_aceite.id_articulo = 90 THEN DO:
            
            FOR EACH tambores_industria of lotes_aceite
                                        WHERE tambores_industria.id_sucursal_ubicacion <> 85
                                          AND tambores_industria.id_sucursal_ubicacion <> 91
                                          AND tambores_industria.id_orden_entrega       = 0.
                ASSIGN lotes_aceite.id_articulo = 74.
                RUN y_gstkcre.p (INPUT tambores_industria.id_empresa,
                                 INPUT tambores_industria.id_sucursal,
                                 INPUT tambores_industria.id_tipotambor,
                                 INPUT tambores_industria.nromov,
                ...
                ASSIGN tambores_industria.id_articulo = 74
                       tambores_industria.id_articulo = 604
                       tambores_industria.id_contrato_of        = ""
                       tambores_industria.id_tipocontrato_of    = 0
                       tambores_industria.anio_of               = 0
                       tambores_industria.id_orden_entrega      = 0
  ...
  RUN dispatch in h_b_lotes_aceite_transferencia ('open-query':U).
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_lotes_aceite_transferencia.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_lotes_aceite_transferencia ).
       RUN set-position IN h_b_lotes_aceite_transferencia ( 3.86 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_lotes_aceite_transferencia ( 9.29 , 138.00 ) NO-ERROR.

       /* Links to csmartbrowser h_b_lotes_aceite_transferencia. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_lotes_aceite_transferencia ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_lotes_aceite_transferencia ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
