...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-17 aceptar salir 
...
DEFINE FRAME D-Dialog
     ...
     RECT-17 AT ROW 1.86 COL 7
     SPACE(9.99) SKIP(2.42)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_centros_stock ( 2.52 , 11.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-1 RECT-17 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
