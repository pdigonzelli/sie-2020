...
rowObject.anio_lote rowObject.tambores rowObject.articulo rowObject.calidad ~
rowObject.envase rowObject.fecha rowObject.kilos rowObject.kilos_400 ~
rowObject.id_sucursal rowObject.id_sucursal_ubicacion ~
rowObject.id_tipotambor rowObject.sucursal rowObject.id_estado ~
rowObject.estado 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_lote FORMAT ">,>>9":U
      anio_lote FORMAT "99":U
      tambores FORMAT ">>,>>9":U
      articulo FORMAT "X(12)":U
      calidad FORMAT "X(12)":U
      envase FORMAT "X(12)":U
      fecha FORMAT "99/99/99":U
      kilos FORMAT ">>>,>>9.999":U
      kilos_400 FORMAT ">,>>>,>>9.999":U
      id_sucursal FORMAT ">>9":U
      id_sucursal_ubicacion FORMAT ">>9":U
      id_tipotambor FORMAT ">>9":U
      sucursal FORMAT "X(12)":U
      id_estado FORMAT ">>9":U
      estado FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.anio_lote
     ...
     _FldNameList[8]   = _<SDO>.rowObject.kilos
     _FldNameList[9]   = _<SDO>.rowObject.kilos_400
     _FldNameList[10]   = _<SDO>.rowObject.id_sucursal
     _FldNameList[11]   = _<SDO>.rowObject.id_sucursal_ubicacion
     _FldNameList[12]   = _<SDO>.rowObject.id_tipotambor
     _FldNameList[13]   = _<SDO>.rowObject.sucursal
     _FldNameList[14]   = _<SDO>.rowObject.id_estado
     _FldNameList[15]   = _<SDO>.rowObject.estado
