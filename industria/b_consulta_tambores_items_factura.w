...
tambores_industria.id_articulo tambores_industria.id_sucursal_ubicacion ~
tambores_industria.id_locacion_ubicacion tambores_industria.kilos_tambor 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria WHERE tambores_industria.id_sucursal_remito = items_factura.id_sucursal ~
  AND tambores_industria.id_tipo_movsto = items_factura.id_tipo_movsto ~
  AND tambores_industria.nro_remito = items_factura.nro ~
  AND tambores_industria.item_factura = items_factura.item NO-LOCK ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tambores_industria.id_lote FORMAT ">>>9":U WIDTH 7.2
      tambores_industria.Anio FORMAT ">>>9":U WIDTH 7.2
      tambores_industria.id_tambor FORMAT ">>>9":U WIDTH 8.2
      tambores_industria.id_articulo COLUMN-LABEL "Art" FORMAT ">>9":U
            WIDTH 5.2
      tambores_industria.id_sucursal_ubicacion COLUMN-LABEL "SUbi" FORMAT ">>9":U
            WIDTH 5.2
      tambores_industria.id_locacion_ubicacion COLUMN-LABEL "LUbi" FORMAT ">9":U
            WIDTH 6.2
      tambores_industria.kilos_tambor FORMAT ">>>>9.99":U WIDTH 10.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_industria WHERE general.items_factura <external> ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _OrdList          = "general.tambores_industria.id_tambor|yes"
     _JoinCode[1]      = "general.tambores_industria.id_sucursal_remito = general.items_factura.id_sucursal
  AND general.tambores_industria.id_tipo_movsto = general.items_factura.id_tipo_movsto
  AND general.tambores_industria.nro_remito = general.items_factura.nro
  AND general.tambores_industria.item_factura = general.items_factura.item"
     _FldNameList[1]   > general.tambores_industria.id_lote
"general.tambores_industria.id_lote" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
     _FldNameList[2]   > general.tambores_industria.Anio
"general.tambores_industria.Anio" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
     _FldNameList[3]   > general.tambores_industria.id_tambor
"general.tambores_industria.id_tambor" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[4]   > general.tambores_industria.id_articulo
"general.tambores_industria.id_articulo" "Art" ">>9" "integer" ? ? ? ? ? ? no ? no no "5.2" yes no no "U" "" ""
     _FldNameList[5]   > general.tambores_industria.id_sucursal_ubicacion
"general.tambores_industria.id_sucursal_ubicacion" "SUbi" ">>9" "integer" ? ? ? ? ? ? no ? no no "5.2" yes no no "U" "" ""
     _FldNameList[6]   > general.tambores_industria.id_locacion_ubicacion
"general.tambores_industria.id_locacion_ubicacion" "LUbi" ">9" "integer" ? ? ? ? ? ? no ? no no "6.2" yes no no "U" "" ""
     _FldNameList[7]   > general.tambores_industria.kilos_tambor
"general.tambores_industria.kilos_tambor" ? ">>>>9.99" "decimal" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
