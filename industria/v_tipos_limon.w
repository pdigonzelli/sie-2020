...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Tipos_limon
&Scoped-define FIRST-EXTERNAL-TABLE Tipos_limon


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Tipos_limon.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Tipos_limon.id_tipolimon ~
Tipos_limon.descripcion 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_tipolimon ~{&FP2}id_tipolimon ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}
&Scoped-define ENABLED-TABLES Tipos_limon
&Scoped-define FIRST-ENABLED-TABLE Tipos_limon
&Scoped-Define DISPLAYED-FIELDS Tipos_limon.id_tipolimon ~
Tipos_limon.descripcion 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS Tipos_limon.id_tipolimon 
...
<FOREIGN-KEYS>
id_tipolimon|y|y|general.Tipos_limon.id_tipolimon
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "id_tipolimon",
     Keys-Supplied = "id_tipolimon"':U).
/**************************
</EXECUTING-CODE> */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     Tipos_limon.id_tipolimon AT ROW 1 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
     Tipos_limon.descripcion AT ROW 2 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.Tipos_limon
...
/* SETTINGS FOR FILL-IN Tipos_limon.id_tipolimon IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME Tipos_limon.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Tipos_limon.descripcion V-table-Win
ON LEAVE OF Tipos_limon.descripcion IN FRAME F-Main /* Tipo Limon */
DO:
...
&Scoped-define SELF-NAME Tipos_limon.id_tipolimon
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Tipos_limon.id_tipolimon V-table-Win
ON LEAVE OF Tipos_limon.id_tipolimon IN FRAME F-Main /* Id TipoLimon */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_tipolimon':U THEN
       {src/adm/template/find-tbl.i
           &TABLE = Tipos_limon
           &WHERE = "WHERE Tipos_limon.id_tipolimon eq INTEGER(key-value)"
       }
  END CASE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "Tipos_limon"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "Tipos_limon"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipolimon" "Tipos_limon" "id_tipolimon"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "Tipos_limon"}
