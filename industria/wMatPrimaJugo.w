...
&Scoped-Define ENABLED-OBJECTS btnAdd btnDel fiTL fiMP RECT-1 RECT-25 
&Scoped-Define DISPLAYED-OBJECTS fiTL fiMP 
...
DEFINE VARIABLE fiMP AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 29 BY .62
     BGCOLOR 4 FGCOLOR 15 FONT 6 NO-UNDO.

DEFINE VARIABLE fiTL AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 29 BY .62
...
DEFINE FRAME fMain
     btnAdd AT ROW 13.71 COL 63.4
     btnDel AT ROW 14.95 COL 63.4
     fiTL AT ROW 20.76 COL 1 NO-LABEL
     fiMP AT ROW 20.76 COL 130 RIGHT-ALIGNED NO-LABEL
     RECT-1 AT ROW 1 COL 1
     RECT-25 AT ROW 13.62 COL 63
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Transferencia a Materia Prima"
         HEIGHT             = 20.57
         WIDTH              = 130.4
         MAX-HEIGHT         = 34.33
         MAX-WIDTH          = 204.8
...
/* SETTINGS FOR FILL-IN fiMP IN FRAME fMain
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fiTL IN FRAME fMain
   ALIGN-L                                                              */
...
ON END-ERROR OF wWin /* Transferencia a Materia Prima */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Transferencia a Materia Prima */
DO:
...
DO:
  RUN setEstado(h_dTamboresIndustria, 
                h_bTamboresIndustria, 
                2).
...
DO:
  RUN setEstado(h_dTamboresIndustria-2, 
                h_bTamboresIndustria-2, 
                4).
END.
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             OUTPUT h_dlotesjugo ).
       RUN repositionObject IN h_dlotesjugo ( 3.86 , 52.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_blotesjugo ).
       RUN repositionObject IN h_blotesjugo ( 2.43 , 59.00 ) NO-ERROR.
       RUN resizeObject IN h_blotesjugo ( 7.14 , 72.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dtamboresindustria ( 5.76 , 52.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN repositionObject IN h_btamboresindustria ( 9.81 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_btamboresindustria ( 10.81 , 58.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dtamboresindustria-2 ( 7.67 , 52.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN repositionObject IN h_btamboresindustria-2 ( 9.81 , 73.00 ) NO-ERROR.
       RUN resizeObject IN h_btamboresindustria-2 ( 10.81 , 58.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'adm2/dyntoolbar.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'FlatButtonsyesMenunoShowBorderyesToolbaryesActionGroupsNavigation,Function,Banda1SubModulesTableIOTypeSupportedLinksNavigation-sourceToolbarBandsToolbarParentMenuToolbarAutoSizenoToolbarDrawDirectionHorizontalToolbarInitialStateLogicalObjectNameAutoResizeDisabledActionsHiddenActionsUpdate,Filter,PrintactionHiddenToolbarBandsHiddenMenuBandsMenuMergeOrder0EdgePixels2PanelTypeToolbarDeactivateTargetOnHidenoDisabledActionsNavigationTargetNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dyntoolbar ).
       RUN repositionObject IN h_dyntoolbar ( 1.00 , 59.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 72.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'adm2/dynfilter.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsid_sucursal,id_lote,anio,id_articuloOperatorStyleImplicitOperatorViewAsCombo-boxOperator=UseBeginsyesUseContainsyesDefaultWidth16DefaultCharWidth20DefaultEditorLines1ViewAsFieldsFieldOperatorStylesFieldFormatsFieldWidthsFieldLabelsid_loteLoteid_sucursalSucursalFieldToolTipsFieldHelpIdsid_lote0id_sucursal0id_articulo0Fecha0DesignDataObjectFieldColumn20HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynfilter ).
       RUN repositionObject IN h_dynfilter ( 1.24 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_dynfilter ( 5.57 , 55.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE btnAdd btnDel fiTL fiMP RECT-1 RECT-25 
      WITH FRAME fMain IN WINDOW wWin.
...
------------------------------------------------------------------------------*/
  ...
  fiTL:SCREEN-VALUE IN FRAME fMain = "Tambores Lote".
  fiMP:SCREEN-VALUE IN FRAME fMain = "Tambores MP p/Reproc.".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setEstado wWin 
PROCEDURE setEstado :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
  ...
  RUN setEstado IN phSdo (cRows, piEstado).
