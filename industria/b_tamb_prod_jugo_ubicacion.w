...
&Scoped-define INTERNAL-TABLES tambores_industria sucursales locaciones
...
sucursales.abreviatura tambores_industria.id_locacion_ubicacion ~
locaciones.descripcion tambores_industria.id_etiqueta ~
tambores_industria.id_envase tambores_industria.kilos_tambor 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria OF produccion_jugo WHERE ~{&KEY-PHRASE} OUTER-JOIN NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tambores_industria.id_locacion_ubicacion FORMAT ">>9":U
      locaciones.descripcion FORMAT "x(20)":U
      tambores_industria.id_etiqueta FORMAT ">>>,>>>,>>9":U
      tambores_industria.id_envase FORMAT ">>>,>>9":U
      tambores_industria.kilos_tambor FORMAT ">>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 137 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_industria OF general.produccion_jugo,comercial.sucursales WHERE general.tambores_industria ...,industria.locaciones WHERE general.tambores_industria ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = "OUTER, OUTER, OUTER"
     _JoinCode[2]      = "comercial.sucursales.id_sucursal = general.tambores_industria.id_sucursal_ubicacion"
...
"tambores_industria.id_sucursal_ubicacion" ? ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   = comercial.sucursales.abreviatura
     _FldNameList[5]   > general.tambores_industria.id_locacion_ubicacion
"tambores_industria.id_locacion_ubicacion" ? ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
