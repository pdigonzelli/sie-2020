...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 aceptar salir 
...
DEFINE FRAME D-Dialog
     ...
     RECT-2 AT ROW 1.86 COL 6
     SPACE(5.19) SKIP(2.51)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_tipos_movimientos ( 2.52 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-1 RECT-2 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
