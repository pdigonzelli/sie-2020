...
orden_entrega.anio orden_entrega.fecha orden_entrega.semana_embarque 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH orden_entrega OF items_contratos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table orden_entrega
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_despachante,id_estado,id_orden_entrega,id_tipo_contrato,id_tipo_plazo,id_tipo_contenedor"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      orden_entrega.anio FORMAT "9999":U
      orden_entrega.fecha FORMAT "99/99/99":U
      orden_entrega.semana_embarque COLUMN-LABEL "Semana" FORMAT ">9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 51 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.orden_entrega OF general.items_contratos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.orden_entrega.id_orden_entrega
     _FldNameList[2]   = general.orden_entrega.anio
     _FldNameList[3]   = general.orden_entrega.fecha
     _FldNameList[4]   > general.orden_entrega.semana_embarque
"orden_entrega.semana_embarque" "Semana" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
label 'id_orden_entrega( orden_entrega ) '
  ...
  menu-item orden_entrega-anio
label 'anio( orden_entrega ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=orden_entrega.anio').
                  run set-attribute-list('titulo=Año').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by orden_entrega.anio
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item orden_entrega-cantidad_tambores
label 'cantidad_tambores( orden_entrega ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=orden_entrega.cantidad_tambores').
                  run set-attribute-list('titulo=Tambores').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by orden_entrega.cantidad_tambores
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'total_factura( orden_entrega ) '
  ...
  menu-item orden_entrega-kgs_netos_tambores
label 'kgs_netos_tambores( orden_entrega ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=orden_entrega.kgs_netos_tambores').
                  run set-attribute-list('titulo=Kgs Netos').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by orden_entrega.kgs_netos_tambores
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by orden_entrega.id_orden_entrega
...
case p:
  ...
  WHEN 'orden_entrega.semana_entrega' then  
  ...
  WHEN 'orden_entrega.kgs_netos_tambores' then  
