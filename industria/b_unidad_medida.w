...
&Scoped-define INTERNAL-TABLES unidad_medida

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table unidad_medida.id_um ~
unidad_medida.id_medicion unidad_medida.descripcion ~
unidad_medida.abreviatura unidad_medida.decimales 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH unidad_medida WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table unidad_medida
&Scoped-define FIRST-TABLE-IN-QUERY-br_table unidad_medida
...
<FOREIGN-KEYS>
id_medicion||y|comercial.unidad_medida.id_medicion
abreviatura||y|comercial.unidad_medida.abreviatura
id_um||y|comercial.unidad_medida.id_um
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_medicion,abreviatura,id_um"':U).
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "comercial.unidad_medida"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = comercial.unidad_medida.id_um
     _FldNameList[2]   = comercial.unidad_medida.id_medicion
     _FldNameList[3]   = comercial.unidad_medida.descripcion
     _FldNameList[4]   = comercial.unidad_medida.abreviatura
     _FldNameList[5]   = comercial.unidad_medida.decimales
...
define sub-menu Ordena 
  menu-item unidad_medida-id_um
label 'id_um( unidad_medida ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=unidad_medida.id_um').
                  run set-attribute-list('titulo=Tipo UM').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by unidad_medida.id_um
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item unidad_medida-id_medicion
label 'id_medicion( unidad_medida ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=unidad_medida.id_medicion').
                  run set-attribute-list('titulo=Tipo medición').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by unidad_medida.id_medicion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item unidad_medida-descripcion
label 'descripcion( unidad_medida ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=unidad_medida.descripcion').
                  run set-attribute-list('titulo=Descripción').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by unidad_medida.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item unidad_medida-abreviatura
label 'abreviatura( unidad_medida ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=unidad_medida.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by unidad_medida.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item unidad_medida-decimales
label 'decimales( unidad_medida ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=unidad_medida.decimales').
                  run set-attribute-list('titulo=Decimales').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by unidad_medida.decimales
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by unidad_medida.id_um
...
case p:
  WHEN 'unidad_medida.id_um' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_um = integer(valor)  no-lock no-error .
  WHEN 'unidad_medida.id_medicion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_medicion = integer(valor)  no-lock no-error .
  WHEN 'unidad_medida.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'unidad_medida.abreviatura' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  abreviatura begins valor  no-lock no-error .
  WHEN 'unidad_medida.decimales' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  decimales no-lock no-error .
end.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_medicion" "unidad_medida" "id_medicion"}
  {src/adm/template/sndkycas.i "abreviatura" "unidad_medida" "abreviatura"}
  {src/adm/template/sndkycas.i "id_um" "unidad_medida" "id_um"}
