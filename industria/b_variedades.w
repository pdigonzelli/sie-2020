...
&Scoped-define INTERNAL-TABLES variedades

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table variedades.id_variedad ~
variedades.descripcion variedades.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH variedades WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table variedades
&Scoped-define FIRST-TABLE-IN-QUERY-br_table variedades
...
<FOREIGN-KEYS>
id_articulo||y|general.variedades.id_articulo
id_variedad||y|general.variedades.id_variedad
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_articulo,id_variedad"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      variedades.id_variedad COLUMN-LABEL "CodVar"
      variedades.descripcion COLUMN-LABEL "Variedad"
      variedades.abreviatura
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.variedades"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.variedades.id_variedad
"id_variedad" "CodVar" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   > general.variedades.descripcion
"descripcion" "Variedad" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   = general.variedades.abreviatura
...
define sub-menu Ordena 
  menu-item variedades-id_variedad
label 'id_variedad( variedades ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=variedades.id_variedad').
                  run set-attribute-list('titulo=variedad').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by variedades.id_variedad
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item variedades-descripcion
label 'descripcion( variedades ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=variedades.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by variedades.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item variedades-abreviatura
label 'abreviatura( variedades ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=variedades.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by variedades.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by variedades.id_variedad
...
case p:
  WHEN 'variedades.id_variedad' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_variedad = integer(valor)  no-lock no-error .
  WHEN 'variedades.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'variedades.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_articulo" "variedades" "id_articulo"}
  {src/adm/template/sndkycas.i "id_variedad" "variedades" "id_variedad"}
