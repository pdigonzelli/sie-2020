...
rowObject.id_suc_origen rowObject.id_suc_des rowObject.descripcion ~
rowObject.cantidad_tambores rowObject.fecha rowObject.c_usuario 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.id_suc_origen
     _FldNameList[3]   = _<SDO>.rowObject.id_suc_des
     _FldNameList[4]   = _<SDO>.rowObject.descripcion
     _FldNameList[5]   = _<SDO>.rowObject.cantidad_tambores
     _FldNameList[6]   = _<SDO>.rowObject.fecha
     _FldNameList[7]   = _<SDO>.rowObject.c_usuario
