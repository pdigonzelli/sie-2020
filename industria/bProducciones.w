...
rowObject.Anio rowObject.Fecha rowObject.id_tambor rowObject.id_articulo ~
rowObject.kilos_tambor rowObject.Producto rowObject.Calidad ~
rowObject.id_lote rowObject.nromov rowObject.id_calidad ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      kilos_tambor FORMAT ">>>,>>9.999":U
      Producto FORMAT "x(50)":U
      Calidad FORMAT "x(50)":U
      id_lote FORMAT "->,>>>,>>9":U
      nromov FORMAT ">>>,>>>,>>9":U
      id_calidad FORMAT ">>,>>9":U
...
"id_articulo" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[6]   = _<SDO>.rowObject.kilos_tambor
     _FldNameList[7]   > _<SDO>.rowObject.Producto
"Producto" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[8]   = _<SDO>.rowObject.Calidad
     _FldNameList[9]   = _<SDO>.rowObject.id_lote
     _FldNameList[10]   = _<SDO>.rowObject.nromov
     _FldNameList[11]   > _<SDO>.rowObject.id_calidad
"id_calidad" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
