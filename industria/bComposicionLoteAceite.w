...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Numeracion_desde ~
rowObject.Numeracion_hasta rowObject.tara rowObject.cantidad_tambores ~
rowObject.id_lote 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Numeracion_desde FORMAT ">>>9":U
      Numeracion_hasta FORMAT ">>>9":U
      tara FORMAT "->>>9.99":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Numeracion_desde
     _FldNameList[2]   = _<SDO>.rowObject.Numeracion_hasta
     _FldNameList[3]   = _<SDO>.rowObject.tara
