...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES clausulas
&Scoped-define FIRST-EXTERNAL-TABLE clausulas


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR clausulas.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS clausulas.id_clausula clausulas.descripcion ~
clausulas.id_termino 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_clausula ~{&FP2}id_clausula ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}~
 ~{&FP1}id_termino ~{&FP2}id_termino ~{&FP3}
&Scoped-define ENABLED-TABLES clausulas
&Scoped-define FIRST-ENABLED-TABLE clausulas
&Scoped-Define DISPLAYED-FIELDS clausulas.id_clausula clausulas.descripcion ~
clausulas.id_termino 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS clausulas.id_clausula 
...
DEFINE FRAME F-Main
     clausulas.id_clausula AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     clausulas.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     clausulas.id_termino AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.2 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.clausulas
...
/* SETTINGS FOR FILL-IN clausulas.id_clausula IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME clausulas.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clausulas.descripcion V-table-Win
ON LEAVE OF clausulas.descripcion IN FRAME F-Main /* Descripcion */
DO:
...
&Scoped-define SELF-NAME clausulas.id_clausula
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clausulas.id_clausula V-table-Win
ON LEAVE OF clausulas.id_clausula IN FRAME F-Main /* Clausula */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME clausulas.id_termino
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clausulas.id_termino V-table-Win
ON LEAVE OF clausulas.id_termino IN FRAME F-Main /* id_termino */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "clausulas"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "clausulas"}
