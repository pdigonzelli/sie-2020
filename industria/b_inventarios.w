...
&Scoped-define INTERNAL-TABLES inventarios_industria empresas sucursales

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table inventarios_industria.id_empresa ~
empresas.razon_social inventarios_industria.id_sucursal sucursales.nombre ~
inventarios_industria.id_inventario inventarios_industria.fecha 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH inventarios_industria WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH empresas OF inventarios_industria NO-LOCK, ~
      EACH sucursales OF inventarios_industria NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table inventarios_industria empresas sucursales
&Scoped-define FIRST-TABLE-IN-QUERY-br_table inventarios_industria
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      inventarios_industria.id_empresa
      empresas.razon_social FORMAT "x(20)"
      inventarios_industria.id_sucursal FORMAT ">,>>9"
      sucursales.nombre
      inventarios_industria.id_inventario FORMAT ">>9"
      inventarios_industria.fecha
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.inventarios_industria,comercial.empresas OF general.inventarios_industria,comercial.sucursales OF general.inventarios_industria"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.inventarios_industria.id_empresa
     _FldNameList[2]   > comercial.empresas.razon_social
"comercial.empresas.razon_social" ? "x(20)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > general.inventarios_industria.id_sucursal
"general.inventarios_industria.id_sucursal" ? ">,>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[4]   = comercial.sucursales.nombre
     _FldNameList[5]   > general.inventarios_industria.id_inventario
"general.inventarios_industria.id_inventario" ? ">>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[6]   = general.inventarios_industria.fecha
...
define sub-menu Ordena 
  menu-item inventarios_industria-id_empresa
label 'id_empresa( inventarios_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=inventarios_industria.id_empresa').
                  run set-attribute-list('titulo=Empresa').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by inventarios_industria.id_empresa
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item empresas-razon_social
label 'razon_social( empresas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=empresas.razon_social').
                  run set-attribute-list('titulo=Razón social').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by empresas.razon_social
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item inventarios_industria-id_sucursal
label 'id_sucursal( inventarios_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=inventarios_industria.id_sucursal').
                  run set-attribute-list('titulo=Sucursal').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by inventarios_industria.id_sucursal
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'nombre( sucursales ) '
  ...
  menu-item inventarios_industria-id_inventario
label 'id_inventario( inventarios_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=inventarios_industria.id_inventario').
                  run set-attribute-list('titulo=Inventario').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by inventarios_industria.id_inventario
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item inventarios_industria-fecha
label 'fecha( inventarios_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=inventarios_industria.fecha').
                  run set-attribute-list('titulo=Fecha').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by inventarios_industria.fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by inventarios_industria.id_empresa
...
case p:
  WHEN 'inventarios_industria.id_empresa' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_empresa = integer(valor)  no-lock no-error .
  WHEN 'inventarios_industria.id_sucursal' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_sucursal = integer(valor)  no-lock no-error .
  WHEN 'inventarios_industria.id_inventario' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_inventario = integer(valor)  no-lock no-error .
  WHEN 'inventarios_industria.fecha' then  
