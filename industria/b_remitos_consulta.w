...
&Scoped-define INTERNAL-TABLES remitos items_factura destinos ~
lugar_descarga
...
remitos.fecha items_factura.nro_lote items_factura.id_articulo ~
destinos.descripcion lugar_descarga.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH remitos WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH items_factura OF remitos NO-LOCK, ~
      EACH destinos OF remitos NO-LOCK, ~
      EACH lugar_descarga OF remitos NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table remitos items_factura destinos ~
lugar_descarga
&Scoped-define FIRST-TABLE-IN-QUERY-br_table remitos
&Scoped-define SECOND-TABLE-IN-QUERY-br_table items_factura
&Scoped-define THIRD-TABLE-IN-QUERY-br_table destinos
&Scoped-define FOURTH-TABLE-IN-QUERY-br_table lugar_descarga
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      remitos.nro_comprobante FORMAT "xxxx-xxxxxxxx":U
      remitos.fecha FORMAT "99/99/99":U
      items_factura.nro_lote FORMAT "999/9999":U
      items_factura.id_articulo FORMAT ">>>>9":U
      destinos.descripcion COLUMN-LABEL "Destino" FORMAT "x(30)":U
      lugar_descarga.descripcion COLUMN-LABEL "Lugar Desc" FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 127 BY 15.95
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.remitos,general.items_factura OF general.remitos,comercial.destinos OF general.remitos,comercial.lugar_descarga OF general.remitos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.remitos.nro_comprobante
     _FldNameList[2]   = general.remitos.fecha
     _FldNameList[3]   = general.items_factura.nro_lote
     _FldNameList[4]   > general.items_factura.id_articulo
"general.items_factura.id_articulo" ? ">>>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > comercial.destinos.descripcion
"comercial.destinos.descripcion" "Destino" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > comercial.lugar_descarga.descripcion
"comercial.lugar_descarga.descripcion" "Lugar Desc" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
label 'fecha( remitos ) '
  ...
  menu-item items_factura-nro_lote
label 'nro_lote( items_factura ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=items_factura.nro_lote').
                  run set-attribute-list('titulo=Lote').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by items_factura.nro_lote
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item items_factura-id_articulo
label 'id_articulo( items_factura ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=items_factura.id_articulo').
                  run set-attribute-list('titulo=Artículo').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by items_factura.id_articulo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'descripcion( destinos ) '
  ...
  menu-item lugar_descarga-descripcion
label 'descripcion( lugar_descarga ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lugar_descarga.descripcion').
                  run set-attribute-list('titulo=Descripción').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by lugar_descarga.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by remitos.nro_comprobante
