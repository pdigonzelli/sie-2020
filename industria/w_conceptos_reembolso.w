...
DEFINE VARIABLE h_b_conceptos_reembolso AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_conceptos_reembolso AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Conceptos Reembolsos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Conceptos Reembolsos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_conceptos_reembolso.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_conceptos_reembolso ).
       RUN set-position IN h_b_conceptos_reembolso ( 3.86 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_conceptos_reembolso.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_conceptos_reembolso ).
       RUN set-position IN h_v_conceptos_reembolso ( 11.48 , 15.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 57.00 ) */

       /* Links to csmartbrowser h_b_conceptos_reembolso. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_conceptos_reembolso ).

       /* Links to SmartViewer h_v_conceptos_reembolso. */
       RUN add-link IN adm-broker-hdl ( h_b_conceptos_reembolso , 'Record':U , h_v_conceptos_reembolso ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_conceptos_reembolso ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_conceptos_reembolso ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_conceptos_reembolso ,
             h_b_conceptos_reembolso , 'AFTER':U ).
    END. /* Page 0 */
