...
rowObject.id_contrato rowObject.orden_fabricacion rowObject.anio ~
rowObject.razon_social rowObject.fecha rowObject.id_po_cliente1 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.descripcion FORMAT "X(8)":U
      rowObject.id_contrato FORMAT "X(12)":U
      rowObject.orden_fabricacion FORMAT ">>,>>>,>>9":U
      rowObject.anio FORMAT "9999":U
      rowObject.razon_social FORMAT "x(70)":U
      rowObject.fecha FORMAT "99/99/9999":U
      rowObject.id_po_cliente1 FORMAT "X(30)":U WIDTH 11.6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dseleccioncontratosoe.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.id_contrato
     _FldNameList[3]   = _<SDO>.rowObject.orden_fabricacion
     _FldNameList[4]   = _<SDO>.rowObject.anio
     _FldNameList[5]   = _<SDO>.rowObject.razon_social
     _FldNameList[6]   = _<SDO>.rowObject.fecha
     _FldNameList[7]   > _<SDO>.rowObject.id_po_cliente1
"rowObject.id_po_cliente1" ? ? "character" ? ? ? ? ? ? no ? no no "11.6" yes no no "U" "" ""
