...
&Scoped-define FIELDS-IN-QUERY-br_table tt_origen_jugo.id_empresa /* tt_origen_jugo.id_sucursal */ tt_origen_jugo.descripcion_sucursal tt_origen_jugo.id_lote tt_origen_jugo.id_tambor tt_origen_jugo.descripcion_envase tt_origen_jugo.id_etiqueta tt_origen_jugo.fecha   
...
/*    tt_origen_jugo.id_sucursal           label "" */
    ...
    tt_origen_jugo.id_etiqueta           label "Etiqueta"
...
do:   
    for each tambores_industria where tambores_industria.id_empresa_destino = lotes_jugo.id_empresa and
                                      tambores_industria.id_sucursal_destino = lotes_jugo.id_sucursal and
                                      tambores_industria.id_tipotambor_destino = lotes_jugo.id_tipotambor and
                                      tambores_industria.nromov_destino = lotes_jugo.nromov no-lock.
        ...
        assign tt_origen_jugo.id_empresa             = tambores_industria.id_empresa
               ...
               tt_origen_jugo.descripcion_sucursal   = IF AVAILABLE sucursales THEN sucursales.nombre
                                                                               ELSE "NONE"
               tt_origen_jugo.id_lote                = tambores_industria.id_lote
               tt_origen_jugo.id_tambor              = tambores_industria.id_tambor
               tt_origen_jugo.descripcion_envase     = IF AVAILABLE envases_prod THEN envases_prod.descripcion
                                                                                 ELSE "NONE"
               tt_origen_jugo.id_etiqueta            = tambores_industria.id_etiqueta       
...
FIND FIRST tambores_industria where tambores_industria.id_empresa      = tt_origen_jugo.id_empresa and
                                    tambores_industria.id_sucursal     = tt_origen_jugo.id_sucursal and 
                                    tambores_industria.id_tipotambor   = tt_origen_jugo.id_tipotambor and
                                    tambores_industria.nromov          = tt_origen_jugo.nromov and
                                    tambores_industria.id_tambor       = tt_origen_jugo.id_tambor 
...
if available lotes_jugo then
do:   
    for each tambores_produccion_jugo where tambores_produccion_jugo.id_empresa_destino = lotes_jugo.id_empresa and
                                            tambores_produccion_jugo.id_sucursal_destino = lotes_jugo.id_sucursal and
                                            tambores_produccion_jugo.id_lote_destino = lotes_jugo.id_lote no-lock.
    
        create tt_origen_jugo.
        assign tt_origen_jugo.id_empresa = tambores_produccion_jugo.id_empresa_destino
               tt_origen_jugo.id_sucursal = tambores_produccion_jugo.id_sucursal_destino
               tt_origen_jugo.id_lote = tambores_produccion_jugo.id_lote_destino
               tt_origen_jugo.id_empresa = tambores_produccion_jugo.id_empresa.
