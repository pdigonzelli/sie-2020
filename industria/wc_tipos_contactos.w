...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-5 
...
DEFINE FRAME D-Dialog
     ...
     RECT-5 AT ROW 1.95 COL 6
     SPACE(5.99) SKIP(2.23)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_tipos_contactos ( 2.67 , 9.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_contactos ( 6.71 , 72.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-5 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
