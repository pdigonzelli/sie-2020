...
&Scoped-define INTERNAL-TABLES contramarcas

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table contramarcas.id_contramarca ~
contramarcas.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH contramarcas WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table contramarcas
&Scoped-define FIRST-TABLE-IN-QUERY-br_table contramarcas
...
<FOREIGN-KEYS>
id_contramarca||y|general.contramarcas.id_contramarca
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_contramarca"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      contramarcas.id_contramarca FORMAT ">>>>9":U
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.contramarcas"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.contramarcas.id_contramarca
     _FldNameList[2]   = general.contramarcas.descripcion
...
define sub-menu Ordena 
  menu-item contramarcas-id_contramarca
label 'id_contramarca( contramarcas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=contramarcas.id_contramarca').
                  run set-attribute-list('titulo=Cod Contramarca').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by contramarcas.id_contramarca
...
case p:
  WHEN 'contramarcas.id_contramarca' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_contramarca = integer(valor)  no-lock no-error .
  WHEN 'contramarcas.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_contramarca" "contramarcas" "id_contramarca"}
