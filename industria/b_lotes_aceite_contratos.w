...
lotes_aceite.fecha productos_terminados.descripcion 
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_aceite,general.productos_terminados OF general.lotes_aceite,industria.tambores_industria OF general.lotes_aceite"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ",, FIRST"
     _Where[3]         = "general.tambores_industria.id_locacion_ubicacion = 4"
     _FldNameList[1]   = general.lotes_aceite.id_lote
     _FldNameList[2]   = general.lotes_aceite.fecha
...
case p:
  WHEN 'lotes_aceite.id_lote' then do: 
       for each {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_lote = integer(valor)  no-lock ,
  ...
  WHEN 'lotes_aceite.fecha' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where lotes_aceite.fecha = date(valor)  no-lock no-error .
end.
