...
&Scoped-define INTERNAL-TABLES lotes_aceite productos_terminados

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table lotes_aceite.id_lote ~
lotes_aceite.anio lotes_aceite.fecha ~
productos_terminados.abreviatura_ingles 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH lotes_aceite OF protocolos WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH productos_terminados OF lotes_aceite NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH lotes_aceite OF protocolos WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH productos_terminados OF lotes_aceite NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
<FOREIGN-KEYS>
id_orden_entrega||y|general.lotes_aceite.id_orden_entrega
id_articulo||y|general.lotes_aceite.id_articulo
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_orden_entrega,id_articulo,id_tipotambor"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      lotes_aceite.id_lote COLUMN-LABEL "Batch" FORMAT ">>>9":U
            WIDTH 11.2
      lotes_aceite.anio COLUMN-LABEL "Year" FORMAT ">>>9":U WIDTH 9.2
      lotes_aceite.fecha COLUMN-LABEL "Date" FORMAT "99/99/99":U
            WIDTH 15.2
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_aceite OF general.protocolos,general.productos_terminados OF general.lotes_aceite"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.lotes_aceite.id_lote
"lotes_aceite.id_lote" "Batch" ">>>9" "integer" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[2]   > general.lotes_aceite.anio
"lotes_aceite.anio" "Year" ? "integer" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" ""
     _FldNameList[3]   > general.lotes_aceite.fecha
"lotes_aceite.fecha" "Date" ? "date" ? ? ? ? ? ? no ? no no "15.2" yes no no "U" "" ""
     _FldNameList[4]   > general.productos_terminados.abreviatura_ingles
"productos_terminados.abreviatura_ingles" "Merchandise" ? "character" ? ? ? ? ? ? no ? no no "21.2" yes no no "U" "" ""
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_orden_entrega" "lotes_aceite" "id_orden_entrega"}
  {src/adm/template/sndkycas.i "id_articulo" "lotes_aceite" "id_articulo"}
