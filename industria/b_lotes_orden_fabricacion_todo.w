...
calidades.descripcion lotes_jugo.Fecha 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      lotes_jugo.id_sucursal COLUMN-LABEL "Suc" FORMAT ">>9"
      sucursales.abreviatura
      lotes_jugo.id_lote COLUMN-LABEL "Lote" FORMAT ">,>>9"
      lotes_jugo.id_articulo COLUMN-LABEL "Art." FORMAT ">>9"
      productos_terminados.descripcion COLUMN-LABEL "Descripción Artículo" FORMAT "x(25)"
      lotes_jugo.id_calidad COLUMN-LABEL "Cod." FORMAT ">>9"
      calidades.descripcion COLUMN-LABEL "Descripcion Calidad" FORMAT "X(25)"
      lotes_jugo.Fecha
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 136 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_jugo,general.productos_terminados OF general.lotes_jugo,general.calidades OF general.lotes_jugo,comercial.sucursales OF general.lotes_jugo"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ",,,, FIRST"
     _Where[1]         = "general.lotes_jugo.id_articulo < 100"
     _FldNameList[1]   > general.lotes_jugo.id_sucursal
"lotes_jugo.id_sucursal" "Suc" ">>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   = comercial.sucursales.abreviatura
     _FldNameList[3]   > general.lotes_jugo.id_lote
"lotes_jugo.id_lote" "Lote" ">,>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[4]   > general.lotes_jugo.id_articulo
"lotes_jugo.id_articulo" "Art." ">>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[5]   > general.productos_terminados.descripcion
"productos_terminados.descripcion" "Descripción Artículo" "x(25)" "character" ? ? ? ? ? ? no ?
     _FldNameList[6]   > general.lotes_jugo.id_calidad
"lotes_jugo.id_calidad" "Cod." ">>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[7]   > general.calidades.descripcion
"calidades.descripcion" "Descripcion Calidad" "X(25)" "character" ? ? ? ? ? ? no ?
