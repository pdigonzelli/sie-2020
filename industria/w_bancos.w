...
DEFINE VARIABLE h_b_bancos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_bancos AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_bancos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_bancos ).
       RUN set-position IN h_b_bancos ( 4.33 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 150.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_bancos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_bancos ).
       RUN set-position IN h_v_bancos ( 11.95 , 33.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.86 , 87.00 ) */

       /* Links to csmartbrowser h_b_bancos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_bancos ).

       /* Links to SmartViewer h_v_bancos. */
       RUN add-link IN adm-broker-hdl ( h_b_bancos , 'Record':U , h_v_bancos ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_bancos ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_bancos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_bancos ,
             h_b_bancos , 'AFTER':U ).
    END. /* Page 0 */
