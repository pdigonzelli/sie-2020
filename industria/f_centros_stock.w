...
DEFINE VARIABLE h_b_centros_stock AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_centros_stock AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_centros_stock.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_centros_stock ).
       RUN set-position IN h_b_centros_stock ( 4.14 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_centros_stock.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_centros_stock ).
       RUN set-position IN h_v_centros_stock ( 11.95 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 49.00 ) */

       /* Links to csmartbrowser h_b_centros_stock. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_centros_stock ).

       /* Links to SmartViewer h_v_centros_stock. */
       RUN add-link IN adm-broker-hdl ( h_b_centros_stock , 'Record':U , h_v_centros_stock ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_centros_stock ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_centros_stock ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_centros_stock ,
             h_b_centros_stock , 'AFTER':U ).
    END. /* Page 0 */
