...
/*****************GENERO LA ETIQUETA NUMERO CERO***********************************************************/
            ...
            put control "^FO020,70^A0N,45,70^FD" "Produced by S.A. SAN MIGUEL" "^FS".
            ...
            do:
                ...
                put control "^FO30,106^A0N,36,23^FD" "Country of Origin: ARGENTINA" "^FS".            
                put control "^FO30,106^A0N,36,23^FD" "Industrial Plant N° 2 - Ruta Provincial 38 -Tel: (0381) 4512650" "^FS".            
                put control "^FO25,144^GB785,0,3^FS".
                find r_productos_calidad where r_productos_calidad.id_calidad = lotes_jugo.id_calidad
                                           and r_productos_calidad.id_articulo = lotes_jugo.id_articulo no-error.
