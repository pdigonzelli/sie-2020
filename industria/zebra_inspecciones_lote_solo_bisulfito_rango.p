...
do:
  ...
  /*cZebraPrinter = "\\192.168.1.58\zebra105".*/
        ...
        for each tambores_industria where tambores_industria.id_empresa = lotes_jugo.id_empresa 
                                      ...
                                      AND tambores_industria.id_tambor >= piDesde
                                      AND tambores_industria.id_tambor <= piHasta
                                    no-lock
                                      by id_tambor desc.
/**********************************************************************************************************/
          ...
          if available inspecciones_lote then
           do:                                     
            ...
            if lotes_jugo.id_articulo = 52 then  do:   /*turbio*/
              ...
              put control "^FO030,929^A0N,18,25^FD" "Additives: Sodium Metabisulphite " "^FS".
            ...
            ELSE DO: /*claro*/           
              ...
              put control "^FO030,898^A0N,20,25^FD" "Additives: Sodium Metabisulphite " "^FS".
