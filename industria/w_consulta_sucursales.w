...
DEFINE VARIABLE h_b_consulta_sucursales AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Sucursales */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Sucursales */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_sucursales.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_sucursales ).
       RUN set-position IN h_b_consulta_sucursales ( 4.52 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.43 , 77.00 ) */

       /* Links to csmartbrowser h_b_consulta_sucursales. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_consulta_sucursales ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_b_consulta_sucursales ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_sucursales ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
