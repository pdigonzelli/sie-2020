...
rowObject.item_release_delivery rowObject.id_lote_deposito ~
rowObject.id_lote rowObject.tambores rowObject.id_contrato rowObject.nombre 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      item_release_delivery COLUMN-LABEL "item" FORMAT "->,>>>,>>9":U
...
"item_release_delivery" "item" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     ...
     _FldNameList[6]   = _<SDO>.rowObject.id_contrato
