...
productos_terminados.descripcion lotes_jugo.id_calidad ~
calidades.descripcion lotes_jugo.Fecha lotes_jugo.id_orden_entrega ~
lotes_jugo.item_oe 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      productos_terminados.descripcion COLUMN-LABEL "Descripción Artículo" FORMAT "x(25)":U
      lotes_jugo.id_calidad COLUMN-LABEL "Cod." FORMAT ">>9":U
      calidades.descripcion COLUMN-LABEL "Descripcion Calidad" FORMAT "X(20)":U
      lotes_jugo.Fecha FORMAT "99/99/9999":U
      lotes_jugo.id_orden_entrega FORMAT ">>>>9":U
      lotes_jugo.item_oe FORMAT ">>>9":U WIDTH 11.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"lotes_jugo.id_articulo" "Art." ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > general.productos_terminados.descripcion
"productos_terminados.descripcion" "Descripción Artículo" "x(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > general.lotes_jugo.id_calidad
"lotes_jugo.id_calidad" "Cod." ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[7]   > general.calidades.descripcion
"calidades.descripcion" "Descripcion Calidad" "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[8]   = general.lotes_jugo.Fecha
     _FldNameList[9]   > general.lotes_jugo.id_orden_entrega
"lotes_jugo.id_orden_entrega" ? ">>>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[10]   > general.lotes_jugo.item_oe
"lotes_jugo.item_oe" ? ? "integer" ? ? ? ? ? ? no ? no no "11.4" yes no no "U" "" ""
...
label 'id_calidad( lotes_jugo ) '
  ...
  menu-item calidades-descripcion
label 'descripcion( calidades ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=calidades.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by calidades.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'Orden_entrega( lotes_jugo ) '
          triggers: 
              on choose 
                       do:
