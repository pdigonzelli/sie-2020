...
&Scoped-define INTERNAL-TABLES Tipos_limon

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Tipos_limon.id_tipolimon ~
Tipos_limon.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Tipos_limon WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Tipos_limon
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Tipos_limon
...
<FOREIGN-KEYS>
id_tipolimon||y|general.Tipos_limon.id_tipolimon
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.Tipos_limon"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.Tipos_limon.id_tipolimon
     _FldNameList[2]   = general.Tipos_limon.descripcion
...
define sub-menu Ordena 
  menu-item Tipos_limon-id_tipolimon
label 'id_tipolimon( Tipos_limon ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=Tipos_limon.id_tipolimon').
                  run set-attribute-list('titulo=Id TipoLimon').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by Tipos_limon.id_tipolimon
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item Tipos_limon-descripcion
label 'descripcion( Tipos_limon ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=Tipos_limon.descripcion').
                  run set-attribute-list('titulo=Tipo Limon').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by Tipos_limon.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by Tipos_limon.id_tipolimon
...
case p:
  WHEN 'Tipos_limon.id_tipolimon' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipolimon = integer(valor)  no-lock no-error .
  WHEN 'Tipos_limon.descripcion' then  
