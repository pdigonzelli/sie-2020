...
rowObject.fecha rowObject.Sucursal rowObject.NroComp 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.NroComp FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = _<SDO>.rowObject.Sucursal
     _FldNameList[4]   = _<SDO>.rowObject.NroComp
