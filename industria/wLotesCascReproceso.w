...
DEFINE FRAME fMain
     fiCant AT ROW 1.15 COL 27 COLON-ALIGNED NO-LABEL
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dlotescascara ( 6.48 , 56.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_blotescascara ( 7.43 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_blotescascara ( 10.71 , 67.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_blotescascara ,
             h_dynfilter , 'AFTER':U ).
    END. /* Page 0 */
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN transferirLoteCascara IN h_dLotesCascara (DYNAMIC-FUNCTION('columnValue' IN h_dLotesCascara, 'id_empresa'), 
                                                DYNAMIC-FUNCTION('columnValue' IN h_dLotesCascara, 'id_sucursal'), 
                                                DYNAMIC-FUNCTION('columnValue' IN h_dLotesCascara, 'nromov'),
                                                INTEGER(DYNAMIC-FUNCTION('columnValue' IN h_dLotesCascara, 'id_sucursal')) * 10, 
