...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-4 aceptar salir 
...
DEFINE VARIABLE h_bc_contactos_industria AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.52 COL 85
     salir AT ROW 10.52 COL 97
     RECT-1 AT ROW 10.29 COL 82
     RECT-4 AT ROW 1.71 COL 4
     SPACE(1.19) SKIP(2.47)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_contactos_industria.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_contactos_industria ).
       RUN set-position IN h_bc_contactos_industria ( 2.43 , 7.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 104.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_contactos_industria ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-1 RECT-4 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
