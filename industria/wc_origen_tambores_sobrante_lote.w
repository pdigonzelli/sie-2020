...
DEFINE VARIABLE h_bc_origen_tambores_sobrante_lo AS HANDLE NO-UNDO.
...
DO:
  ...
  RUN get-seleccion IN h_bc_origen_tambores_sobrante_lo (OUTPUT elegidos, 
                                                         OUTPUT num).
  ...
  CASE choice:
    WHEN TRUE THEN /* Yes */ DO:
        DO i = 1 TO num:
            FIND FIRST tambores_industria WHERE ROWID(tambores_industria) = TO-ROWID(ENTRY(i,elegidos)) NO-ERROR.
            ...
            END.
            ELSE  MESSAGE "No encontro los tambores seleccionados como origen de lote. Avisar a sistemas." 
                        VIEW-AS ALERT-BOX.  
        END.
    END.
  END CASE.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_origen_tambores_sobrante_lote.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_origen_tambores_sobrante_lo ).
       RUN set-position IN h_bc_origen_tambores_sobrante_lo ( 2.33 , 6.00 ) NO-ERROR.
       RUN set-size IN h_bc_origen_tambores_sobrante_lo ( 15.14 , 132.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_origen_tambores_sobrante_lo ,
...
IF AVAILABLE lotes_jugo THEN DO:
    IF lotes_jugo.id_articulo = 52 THEN DO:
        art_sobrante = 524.
        art_arrastre = 523.
    END.
    ELSE DO:
        IF lotes_jugo.id_articulo = 53 THEN DO:
            art_sobrante = 534.
            art_arrastre = 535.
        END.
    END.
...
END.
ELSE DO:
    FIND FIRST produccion_jugo WHERE ROWID(produccion_jugo) = r NO-LOCK NO-ERROR.
    IF AVAILABLE produccion_jugo THEN DO:
        IF produccion_jugo.id_articulo = 52 THEN DO:
            art_sobrante = 524.
            art_arrastre = 523.
        END.
        ELSE DO:
            IF produccion_jugo.id_articulo = 53 THEN DO:
                art_sobrante = 534.
                art_arrastre = 535.
            END.
        END.
    ...
    ELSE DO:
        ...
        IF AVAILABLE cargas THEN DO:
            IF cargas.id_articulo = 521 THEN DO:
                art_sobrante = 524.
                art_arrastre = 523.
            END.
            ELSE DO:
                IF produccion_jugo.id_articulo = 532 THEN DO:
                    art_sobrante = 534.
                    art_arrastre = 535.
                END.
            END.
