...
rowObject.id_tambor rowObject.kilos rowObject.Articulo rowObject.Calidad ~
rowObject.Envase rowObject.id_articulo rowObject.nromov 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.Articulo FORMAT "x(30)":U
      rowObject.Calidad FORMAT "x(30)":U
      rowObject.Envase FORMAT "x(30)":U
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dttLecturaTambores.w"
   Allow: Basic,Browse
   Frames: 1
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND ((hCont:FILE-NAME MATCHES "*fLecturaTambores.w" )) THEN DO:
    iBgColor = IF rowObject.rowNum MODULO 2 = 0 THEN 23 /*11 light blue*/ ELSE ? /*default*/.
