...
DEFINE VARIABLE h_f_lotes_aceite_todos AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Todos los lotes de Aceite"
         HEIGHT             = 25.38
         WIDTH              = 151.2
         MAX-HEIGHT         = 26.33
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Todos los lotes de Aceite */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Todos los lotes de Aceite */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/f_lotes_aceite_todos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_f_lotes_aceite_todos ).
       RUN set-position IN h_f_lotes_aceite_todos ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 25.24 , 151.40 ) */
