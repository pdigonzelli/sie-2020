...
define temp-table tt-orden_fabricacion
...
&Scoped-define INTERNAL-TABLES tt-orden_fabricacion

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tt-orden_fabricacion.nro tt-orden_fabricacion.anio tt-orden_fabricacion.item tt-orden_fabricacion.id_cliente tt-orden_fabricacion.nombre   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table   
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define SELF-NAME br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH tt-orden_fabricacion NO-LOCK     ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tt-orden_fabricacion
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tt-orden_fabricacion
...
DEFINE QUERY br_table FOR 
      tt-orden_fabricacion SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      tt-orden_fabricacion.nro        label "Nro"
tt-orden_fabricacion.anio       label "Año"
tt-orden_fabricacion.item       label "Item"
tt-orden_fabricacion.id_cliente label "Cliente"
tt-orden_fabricacion.nombre     label "Nombre"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH tt-orden_fabricacion NO-LOCK
    ~{&SORTBY-PHRASE}.
     _END_FREEFORM
...
p1 = tt-orden_fabricacion.nro.
p2 = tt-orden_fabricacion.anio.
p3 = tt-orden_fabricacion.item.
...
define var descr as char format "x(32)".
define var descr1 as char format "x(32)".
...
FOR EACH contratos NO-LOCK.
       c = 0.
      FOR EACH clientes OF contratos  NO-LOCK.
        descr = clientes.razon_social.
      end.
      FOR EACH items_orden_fabricacion OF contratos  NO-LOCK.
        
        find lotes_jugo where lotes_jugo.nro_orden_fabricacion = items_orden_fabricacion.id_contrato and
                              lotes_jugo.anio_orden_fabricacion = items_orden_fabricacion.anio and
                              lotes_jugo.item_orden_fabricacion = items_orden_fabricacion.item no-lock no-error.
        if not available lotes_jugo then
            do:                          
                create tt-orden_fabricacion.
                assign tt-orden_fabricacion.nro = items_orden_fabricacion.nro
                tt-orden_fabricacion.anio = items_orden_fabricacion.anio
                tt-orden_fabricacion.item = items_orden_fabricacion.item
                tt-orden_fabricacion.id_cliente = orden_fabricacion.id_cliente
                tt-orden_fabricacion.nombre = descr.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tt-orden_fabricacion"}
