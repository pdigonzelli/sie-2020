...
DEFINE VARIABLE h_b_agencias AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_gastos_agencias AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_agencias AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Agencias */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Agencias */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 7.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 41.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 64.80 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_agencias.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_agencias ).
       RUN set-position IN h_b_agencias ( 3.38 , 7.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 84.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_agencias.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_agencias ).
       RUN set-position IN h_v_agencias ( 10.76 , 16.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 68.00 ) */
       ...
       RUN set-position IN h_cus-updsav-2 ( 15.29 , 5.00 ) NO-ERROR.
       RUN set-size IN h_cus-updsav-2 ( 1.91 , 36.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_gastos_agencias.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_gastos_agencias ).
       RUN set-position IN h_b_gastos_agencias ( 17.67 , 11.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 78.00 ) */

       /* Links to csmartbrowser h_b_agencias. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_agencias ).

       /* Links to SmartViewer h_v_agencias. */
       RUN add-link IN adm-broker-hdl ( h_b_agencias , 'Record':U , h_v_agencias ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_agencias ).

       /* Links to csmartbrowser h_b_gastos_agencias. */
       RUN add-link IN adm-broker-hdl ( h_b_agencias , 'Record':U , h_b_gastos_agencias ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav-2 , 'TableIO':U , h_b_gastos_agencias ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_agencias ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_agencias ,
             h_b_agencias , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-updsav-2 ,
             h_v_agencias , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_gastos_agencias ,
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE dame-agencia W-Win 
PROCEDURE dame-agencia :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
run get-rowid1 in h_b_agencias (output r).
END PROCEDURE.
