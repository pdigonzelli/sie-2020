...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES couriers
&Scoped-define FIRST-EXTERNAL-TABLE couriers


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR couriers.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS couriers.id_courier couriers.descripcion ~
couriers.abreviatura 
&Scoped-define ENABLED-TABLES couriers
&Scoped-define FIRST-ENABLED-TABLE couriers
&Scoped-define DISPLAYED-TABLES couriers
&Scoped-define FIRST-DISPLAYED-TABLE couriers
&Scoped-Define DISPLAYED-FIELDS couriers.id_courier couriers.descripcion ~
couriers.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS couriers.id_courier 
...
DEFINE FRAME F-Main
     couriers.id_courier AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6 BY 1
     couriers.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     couriers.abreviatura AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.couriers
...
/* SETTINGS FOR FILL-IN couriers.id_courier IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME couriers.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL couriers.abreviatura V-table-Win 
ON LEAVE OF couriers.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME couriers.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL couriers.descripcion V-table-Win 
ON LEAVE OF couriers.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME couriers.id_courier
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL couriers.id_courier V-table-Win 
ON LEAVE OF couriers.id_courier IN FRAME F-Main /* Cod Courier */
DO:
{custom/support/validacion.i}
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN couriers.c_usuario = USERID("userdb")
       couriers.c_fecha   = TODAY
       couriers.c_hora    = STRING(TIME,"HH:MM:SS").
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "couriers"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "couriers"}
