...
&Scoped-define INTERNAL-TABLES r_carga_tambor

/* Definitions for QUERY Query-Main                                     */
&Scoped-Define ENABLED-FIELDS  c_fecha c_hora c_usuario id_empresa id_empresa_carga id_sucursal~
 id_sucursal_carga id_tambor id_tipotambor id_tipotambor_carga nromov~
 nromov_carga observaciones
&Scoped-define ENABLED-FIELDS-IN-r_carga_tambor c_fecha c_hora c_usuario ~
id_empresa id_empresa_carga id_sucursal id_sucursal_carga id_tambor ~
id_tipotambor id_tipotambor_carga nromov nromov_carga observaciones 
&Scoped-Define DATA-FIELDS  c_fecha c_hora c_usuario id_empresa id_empresa_carga id_sucursal~
 id_sucursal_carga id_tambor id_tipotambor id_tipotambor_carga nromov~
 nromov_carga observaciones Lote Anio Articulo Calidad Envase Kilos Litros
&Scoped-define DATA-FIELDS-IN-r_carga_tambor c_fecha c_hora c_usuario ~
id_empresa id_empresa_carga id_sucursal id_sucursal_carga id_tambor ~
id_tipotambor id_tipotambor_carga nromov nromov_carga observaciones 
&Scoped-Define MANDATORY-FIELDS  id_sucursal id_sucursal_carga id_tambor
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST 
&Scoped-Define DATA-FIELD-DEFS "drcargatambor.i"
&Scoped-define QUERY-STRING-Query-Main FOR EACH r_carga_tambor NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH r_carga_tambor NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main r_carga_tambor
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main r_carga_tambor
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "general.r_carga_tambor"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   > general.r_carga_tambor.c_fecha
"c_fecha" "c_fecha" ? ? "date" ? ? ? ? ? ? yes ? no 9.2 yes
     _FldNameList[2]   > general.r_carga_tambor.c_hora
"c_hora" "c_hora" ? ? "character" ? ? ? ? ? ? yes ? no 8 yes
     _FldNameList[3]   > general.r_carga_tambor.c_usuario
"c_usuario" "c_usuario" ? ? "character" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[4]   > general.r_carga_tambor.id_empresa
"id_empresa" "id_empresa" ? ? "integer" ? ? ? ? ? ? yes ? no 8.2 yes
     _FldNameList[5]   > general.r_carga_tambor.id_empresa_carga
"id_empresa_carga" "id_empresa_carga" ? ? "integer" ? ? ? ? ? ? yes ? no 8.2 yes
     _FldNameList[6]   > general.r_carga_tambor.id_sucursal
"id_sucursal" "id_sucursal" ? ? "integer" ? ? ? ? ? ? yes ? yes 6.6 yes
     _FldNameList[7]   > general.r_carga_tambor.id_sucursal_carga
"id_sucursal_carga" "id_sucursal_carga" ? ? "integer" ? ? ? ? ? ? yes ? yes 10.2 yes
     _FldNameList[8]   > general.r_carga_tambor.id_tambor
"id_tambor" "id_tambor" ? ? "integer" ? ? ? ? ? ? yes ? yes 12 yes
     _FldNameList[9]   > general.r_carga_tambor.id_tipotambor
"id_tipotambor" "id_tipotambor" ? ? "integer" ? ? ? ? ? ? yes ? no 9.2 yes
     _FldNameList[10]   > general.r_carga_tambor.id_tipotambor_carga
"id_tipotambor_carga" "id_tipotambor_carga" ? ? "integer" ? ? ? ? ? ? yes ? no 9.2 yes
     _FldNameList[11]   > general.r_carga_tambor.nromov
"nromov" "nromov" ? ? "integer" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[12]   > general.r_carga_tambor.nromov_carga
"nromov_carga" "nromov_carga" ? ? "integer" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[13]   > general.r_carga_tambor.observaciones
...
"getKilos()" "Kilos" "Kilos" ">>>9.99" "Decimal" ? ? ? ? ? ? no ? no 7.8 no
     _FldNameList[20]   > "_<CALC>"
"getLitros()" "Litros" "Litros" ">>>,>>9.99" "Decimal" ? ? ? ? ? ? no ? no 10.8 no
