...
rowObject.anio rowObject.fecha rowObject.razon_social ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[4]   = _<SDO>.rowObject.razon_social
     _FldNameList[5]   = _<SDO>.rowObject.id_tipo_contrato
