...
DEFINE VARIABLE h_b_porcentajes_reint_articulo AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_porcentajes_reint_articulo AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_porcentajes_reint_articulo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_porcentajes_reint_articulo ).
       RUN set-position IN h_b_porcentajes_reint_articulo ( 3.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b_porcentajes_reint_articulo ( 6.71 , 87.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_porcentajes_reint_articulo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_porcentajes_reint_articulo ).
       RUN set-position IN h_v_porcentajes_reint_articulo ( 11.24 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 64.00 ) */

       /* Links to csmartbrowser h_b_porcentajes_reint_articulo. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_porcentajes_reint_articulo ).

       /* Links to SmartViewer h_v_porcentajes_reint_articulo. */
       RUN add-link IN adm-broker-hdl ( h_b_porcentajes_reint_articulo , 'Record':U , h_v_porcentajes_reint_articulo ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_porcentajes_reint_articulo ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_porcentajes_reint_articulo ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_porcentajes_reint_articulo ,
             h_b_porcentajes_reint_articulo , 'AFTER':U ).
    END. /* Page 0 */
