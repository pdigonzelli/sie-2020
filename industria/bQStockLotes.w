...
rowObject.tambor_desde rowObject.tambor_hasta rowObject.cantidad_tambores ~
rowObject.id_articulo rowObject.id_tipo_movimiento rowObject.nromov ~
rowObject.id_serial rowObject.c_fecha rowObject.c_usuario ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_suc_origen FORMAT ">>9":U
      id_suc_des FORMAT ">>9":U
      tambor_desde FORMAT ">>>,>>9":U
      tambor_hasta FORMAT ">>>,>>9":U
      cantidad_tambores FORMAT "x(8)":U
      id_articulo FORMAT ">>>,>>9":U
      id_tipo_movimiento FORMAT ">9":U
      nromov FORMAT ">>>,>>>,>>9":U
      id_serial FORMAT ">>>>>>>>>>>>9":U
      c_fecha FORMAT "99/99/99":U
      c_usuario FORMAT "x(8)":U WIDTH 16.8
      descripcion FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[4]   = _<SDO>.rowObject.id_suc_origen
     _FldNameList[5]   = _<SDO>.rowObject.id_suc_des
     _FldNameList[6]   = _<SDO>.rowObject.tambor_desde
     _FldNameList[7]   = _<SDO>.rowObject.tambor_hasta
     ...
     _FldNameList[12]   = _<SDO>.rowObject.id_serial
     _FldNameList[13]   = _<SDO>.rowObject.c_fecha
     _FldNameList[14]   > _<SDO>.rowObject.c_usuario
"c_usuario" ? ? "character" ? ? ? ? ? ? no ? no no "16.8" yes no no "U" "" ""
     _FldNameList[15]   = _<SDO>.rowObject.descripcion
