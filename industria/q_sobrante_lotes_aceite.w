...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH sobrante_lotes_aceite OF lotes_aceite WHERE ~{&KEY-PHRASE} NO-LOCK ~
...
<FOREIGN-KEYS>
id_envase||y|general.sobrante_lotes_aceite.id_envase
id_sucursal||y|general.sobrante_lotes_aceite.id_sucursal
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "general.sobrante_lotes_aceite OF general.lotes_aceite"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_envase" "sobrante_lotes_aceite" "id_envase"}
  {src/adm/template/sndkycas.i "id_sucursal" "sobrante_lotes_aceite" "id_sucursal"}
