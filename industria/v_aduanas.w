...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES aduanas
&Scoped-define FIRST-EXTERNAL-TABLE aduanas


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR aduanas.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS aduanas.id_aduana aduanas.descripcion 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_aduana ~{&FP2}id_aduana ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}
&Scoped-define ENABLED-TABLES aduanas
&Scoped-define FIRST-ENABLED-TABLE aduanas
&Scoped-Define DISPLAYED-FIELDS aduanas.id_aduana aduanas.descripcion 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS aduanas.id_aduana 
...
DEFINE FRAME F-Main
     aduanas.id_aduana AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     aduanas.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.aduanas
...
/* SETTINGS FOR FILL-IN aduanas.id_aduana IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME aduanas.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL aduanas.descripcion V-table-Win
ON LEAVE OF aduanas.descripcion IN FRAME F-Main /* descripcion */
DO:
...
&Scoped-define SELF-NAME aduanas.id_aduana
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL aduanas.id_aduana V-table-Win
ON LEAVE OF aduanas.id_aduana IN FRAME F-Main /* id_aduana */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "aduanas"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "aduanas"}
