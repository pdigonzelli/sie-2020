...
DEFINE VARIABLE h_b_tipo_numero AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipo_numero AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tipo Numero */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipo Numero */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipo_numero.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipo_numero ).
       RUN set-position IN h_b_tipo_numero ( 3.86 , 8.00 ) NO-ERROR.
       RUN set-size IN h_b_tipo_numero ( 6.71 , 60.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipo_numero.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipo_numero ).
       RUN set-position IN h_v_tipo_numero ( 11.71 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.95 , 58.00 ) */

       /* Links to csmartbrowser h_b_tipo_numero. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipo_numero ).

       /* Links to SmartViewer h_v_tipo_numero. */
       RUN add-link IN adm-broker-hdl ( h_b_tipo_numero , 'Record':U , h_v_tipo_numero ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipo_numero ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipo_numero ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipo_numero ,
             h_b_tipo_numero , 'AFTER':U ).
    END. /* Page 0 */
