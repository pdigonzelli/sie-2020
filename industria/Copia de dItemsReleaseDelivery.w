...
&Scoped-Define ENABLED-FIELDS  cantidad contenedor id_envase id_lote id_lote_deposito id_release_delivery~
 id_sucursal id_unidad_medida id_vapor item tambores id_sucursal_ubicacion~
 id_empresa id_tipotambor nromov id_contrato anio_contrato id_tipo_contrato~
 item_contrato c_usuario c_fecha c_hora
&Scoped-define ENABLED-FIELDS-IN-items_release_delivery cantidad contenedor ~
id_envase id_lote id_lote_deposito id_release_delivery id_sucursal ~
id_unidad_medida id_vapor item tambores id_sucursal_ubicacion id_empresa ~
id_tipotambor nromov id_contrato anio_contrato id_tipo_contrato ~
item_contrato c_usuario c_fecha c_hora 
&Scoped-Define DATA-FIELDS  cantidad Calidad contenedor id_envase id_lote id_lote_deposito~
 id_release_delivery id_sucursal id_unidad_medida id_vapor item tambores~
 id_sucursal_ubicacion id_empresa id_tipotambor nromov Vapor id_contrato~
 Peso anio_contrato id_tipo_contrato item_contrato c_usuario c_fecha Envase~
 c_hora Galones
&Scoped-define DATA-FIELDS-IN-items_release_delivery cantidad contenedor ~
id_envase id_lote id_lote_deposito id_release_delivery id_sucursal ~
id_unidad_medida id_vapor item tambores id_sucursal_ubicacion id_empresa ~
id_tipotambor nromov id_contrato anio_contrato id_tipo_contrato ~
item_contrato c_usuario c_fecha c_hora 
...
&Scoped-Define ASSIGN-LIST   rowObject.item = items_release_delivery.item_release_delivery~
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH items_release_delivery NO-LOCK, ~
      FIRST vapores OF items_release_delivery NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
...
FUNCTION getVapor RETURNS INTEGER
  ( /* parameter-definitions */ )  FORWARD.
...
DEFINE QUERY Query-Main FOR 
    ...
    FIELDS(items_release_delivery.cantidad
      items_release_delivery.contenedor
      items_release_delivery.id_envase
      items_release_delivery.id_lote
      items_release_delivery.id_lote_deposito
      items_release_delivery.id_release_delivery
      items_release_delivery.id_sucursal
      items_release_delivery.id_unidad_medida
      items_release_delivery.id_vapor
      items_release_delivery.item_release_delivery
      items_release_delivery.tambores
      items_release_delivery.id_sucursal_ubicacion
      items_release_delivery.id_empresa
      items_release_delivery.id_tipotambor
      items_release_delivery.nromov
      items_release_delivery.id_contrato
      items_release_delivery.anio_contrato
      items_release_delivery.id_tipo_contrato
      items_release_delivery.item_contrato
      items_release_delivery.c_usuario
      items_release_delivery.c_fecha
      items_release_delivery.c_hora), 
      vapores
    FIELDS(vapores.descripcion) SCROLLING.
&ANALYZE-RESUME
{&DB-REQUIRED-END}
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _FldNameList[1]   > general.items_release_delivery.cantidad
"cantidad" "cantidad" ? ? "integer" ? ? ? ? ? ? yes ? no 8.4 yes
     _FldNameList[2]   > "_<CALC>"
"getCalidad()" "Calidad" ? "x(15)" "character" ? ? ? ? ? ? no ? no 15 no
     _FldNameList[3]   > general.items_release_delivery.contenedor
"contenedor" "contenedor" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes
     _FldNameList[4]   > general.items_release_delivery.id_envase
"id_envase" "id_envase" ? ? "integer" ? ? ? ? ? ? yes ? no 11 yes
     _FldNameList[5]   > general.items_release_delivery.id_lote
"id_lote" "id_lote" ? ? "integer" ? ? ? ? ? ? yes ? no 10.2 yes
     _FldNameList[6]   > general.items_release_delivery.id_lote_deposito
"id_lote_deposito" "id_lote_deposito" ? "x(40)" "character" ? ? ? ? ? ? yes ? no 40 yes
     _FldNameList[7]   > general.items_release_delivery.id_release_delivery
"id_release_delivery" "id_release_delivery" ? ? "integer" ? ? ? ? ? ? yes ? no 18 yes
     _FldNameList[8]   > general.items_release_delivery.id_sucursal
"id_sucursal" "id_sucursal" ? ? "integer" ? ? ? ? ? ? yes ? yes 10.6 yes
     _FldNameList[9]   > general.items_release_delivery.id_unidad_medida
"id_unidad_medida" "id_unidad_medida" ? ? "integer" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[10]   > general.items_release_delivery.id_vapor
"id_vapor" "id_vapor" ? ? "integer" ? ? ? ? ? ? yes ? no 10.2 yes
     _FldNameList[11]   > general.items_release_delivery.item_release_delivery
"item_release_delivery" "item" "item" ? "integer" ? ? ? ? ? ? yes ? no 20.2 yes
     _FldNameList[12]   > general.items_release_delivery.tambores
"tambores" "tambores" ? ? "integer" ? ? ? ? ? ? yes ? no 10.2 yes
     _FldNameList[13]   > general.items_release_delivery.id_sucursal_ubicacion
"id_sucursal_ubicacion" "id_sucursal_ubicacion" ? ? "integer" ? ? ? ? ? ? yes ? yes 21 yes
     _FldNameList[14]   > general.items_release_delivery.id_empresa
"id_empresa" "id_empresa" ? ? "integer" ? ? ? ? ? ? yes ? no 8 yes
     _FldNameList[15]   > general.items_release_delivery.id_tipotambor
"id_tipotambor" "id_tipotambor" ? ? "integer" ? ? ? ? ? ? yes ? no 6.8 yes
     _FldNameList[16]   > general.items_release_delivery.nromov
"nromov" "nromov" ? ? "integer" ? ? ? ? ? ? yes ? no 8.4 yes
     _FldNameList[17]   > comercial.vapores.descripcion
"descripcion" "Vapor" "Vapor" ? "character" ? ? ? ? ? ? no ? no 30 yes
     _FldNameList[18]   > general.items_release_delivery.id_contrato
"id_contrato" "id_contrato" ? ? "character" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[19]   > "_<CALC>"
"getPeso()" "Peso" "Peso" "zzz,zz9.99" "Decimal" ? ? ? ? ? ? no ? no 9.8 no
     _FldNameList[20]   > general.items_release_delivery.anio_contrato
"anio_contrato" "anio_contrato" ? ? "integer" ? ? ? ? ? ? yes ? no 4.8 yes
     _FldNameList[21]   > general.items_release_delivery.id_tipo_contrato
"id_tipo_contrato" "id_tipo_contrato" ? ? "integer" ? ? ? ? ? ? yes ? no 10 yes
     _FldNameList[22]   > general.items_release_delivery.item_contrato
"item_contrato" "item_contrato" ? ? "integer" ? ? ? ? ? ? yes ? no 7.8 yes
     _FldNameList[23]   > general.items_release_delivery.c_usuario
"c_usuario" "c_usuario" ? ? "character" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[24]   > general.items_release_delivery.c_fecha
"c_fecha" "c_fecha" ? ? "date" ? ? ? ? ? ? yes ? no 9.2 yes
     _FldNameList[25]   > "_<CALC>"
"getEnvase()" "Envase" ? "x(20)" "character" ? ? ? ? ? ? no ? no 20 no
     _FldNameList[26]   > general.items_release_delivery.c_hora
"c_hora" "c_hora" ? ? "character" ? ? ? ? ? ? yes ? no 8 yes
     _FldNameList[27]   > "_<CALC>"
"getGalones()" "Galones" "Galones" "zzz,zz9.99" "Decimal" ? ? ? ? ? ? no ? no 9.8 no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE id_contratoValidate dTables  _DB-REQUIRED
PROCEDURE id_contratoValidate :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  DEFINE INPUT PARAMETER pcValorContrato AS CHARACTER NO-UNDO.

  DEFINE VARIABLE hRel     AS HANDLE     NO-UNDO.
  DEFINE VARIABLE cCliente AS HANDLE     NO-UNDO.
  DEFINE VARIABLE iFlag    AS INTEGER    NO-UNDO.

  hRel = DYNAMIC-FUNCTION('getDataSource').
  cCliente = DYNAMIC-FUNCTION('columnValue' IN hRel, 'id_cliente').

  FOR FIRST contratos  WHERE contratos.id_contrato = pcValorContrato AND 
                             contratos.id_cliente  = INTEGER(cCliente)
                             NO-LOCK.
    iFlag = iFlag + 1.
  END.

  IF iFlag <= 0 THEN DO:
    RETURN "El Cliente del Contrato seleccionado debe coincidir con el cliente del Release.".
  END.
  RETURN "".
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH RowObjUpd WHERE RowObjUpd.RowMod = "U".
    RUN setCantidadComprometida IN hProg (RowObjUpd.id_empresa, 
                                          RowObjUpd.id_sucursal, 
                                          RowObjUpd.id_tipotambor, 
                                          RowObjUpd.nromov).
  END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE tamboresValidate dTables  _DB-REQUIRED
PROCEDURE tamboresValidate :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  DEFINE INPUT PARAMETER pcValorTambores AS CHARACTER NO-UNDO.

  FIND CURRENT RowObjUpd NO-ERROR.
/*
  IF INTEGER(pcValorTambores) > RowObjUpd.tambores THEN DO:
    RETURN "Cantidad Invalida de Tambores".
  END.
  */
  RETURN "".
...
FUNCTION getLote RETURNS CHARACTER
  ( /* parameter-definitions */ ) :
/*------------------------------------------------------------------------------
  Purpose: devuelve una lista con los valores correspondientes a la clave de lote
