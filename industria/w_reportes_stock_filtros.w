...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-4 articulo calidad BUTTON-3 ~
nombre_articulo nombre_calidad 
&Scoped-Define DISPLAYED-OBJECTS articulo calidad nombre_articulo ~
nombre_calidad 
...
DEFINE FRAME F-Main
     ...
     "Reporte de Stock de Lotes:" VIEW-AS TEXT
...
------------------------------------------------------------------------------*/
  DISPLAY articulo calidad nombre_articulo nombre_calidad 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-2 RECT-4 articulo calidad BUTTON-3 nombre_articulo nombre_calidad 
      WITH FRAME F-Main IN WINDOW W-Win.
...
v_filtro = "tambores_industria.id_sucursal = 96 and " +
           "tambores_industria.id_sucursal_ubicacion = 96 and " +
