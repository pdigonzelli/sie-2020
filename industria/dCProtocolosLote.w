...
&Scoped-Define DATA-FIELDS  id_protocolo anio id_articulo id_empresa id_sucursal id_tipotambor nromov
...
&Scoped-Define DATA-FIELD-DEFS "dcprotocoloslote.i"
&Scoped-define QUERY-STRING-Query-Main FOR EACH protocolos ~
      WHERE protocolos.id_empresa <> 0 ~
 AND protocolos.id_sucursal <> 0 ~
 AND protocolos.id_tipotambor <> 0 ~
 AND protocolos.nromov <> 0 NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH protocolos ~
      WHERE protocolos.id_empresa <> 0 ~
 AND protocolos.id_sucursal <> 0 ~
 AND protocolos.id_tipotambor <> 0 ~
 AND protocolos.nromov <> 0 NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main protocolos
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _Where[1]         = "general.protocolos.id_empresa <> 0
 AND general.protocolos.id_sucursal <> 0
 AND general.protocolos.id_tipotambor <> 0
 AND general.protocolos.nromov <> 0"
