...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES r_clausulas_gastos_item_oe
&Scoped-define FIRST-EXTERNAL-TABLE r_clausulas_gastos_item_oe


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR r_clausulas_gastos_item_oe.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS r_clausulas_gastos_item_oe.id_clausula ~
r_clausulas_gastos_item_oe.id_gasto_venta ~
r_clausulas_gastos_item_oe.programa 
&Scoped-define ENABLED-TABLES r_clausulas_gastos_item_oe
&Scoped-define FIRST-ENABLED-TABLE r_clausulas_gastos_item_oe
&Scoped-define DISPLAYED-TABLES r_clausulas_gastos_item_oe
&Scoped-define FIRST-DISPLAYED-TABLE r_clausulas_gastos_item_oe
&Scoped-Define DISPLAYED-FIELDS r_clausulas_gastos_item_oe.id_clausula ~
r_clausulas_gastos_item_oe.id_gasto_venta ~
r_clausulas_gastos_item_oe.programa 
...
DEFINE FRAME F-Main
     r_clausulas_gastos_item_oe.id_clausula AT ROW 1 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     r_clausulas_gastos_item_oe.id_gasto_venta AT ROW 2 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     r_clausulas_gastos_item_oe.programa AT ROW 3 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.r_clausulas_gastos_item_oe
...
&Scoped-define SELF-NAME r_clausulas_gastos_item_oe.id_clausula
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL r_clausulas_gastos_item_oe.id_clausula V-table-Win 
ON LEAVE OF r_clausulas_gastos_item_oe.id_clausula IN FRAME F-Main /* Cod. Clausula */
DO:
...
&Scoped-define SELF-NAME r_clausulas_gastos_item_oe.id_gasto_venta
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL r_clausulas_gastos_item_oe.id_gasto_venta V-table-Win 
ON LEAVE OF r_clausulas_gastos_item_oe.id_gasto_venta IN FRAME F-Main /* Cod.Gastos */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME r_clausulas_gastos_item_oe.programa
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL r_clausulas_gastos_item_oe.programa V-table-Win 
ON LEAVE OF r_clausulas_gastos_item_oe.programa IN FRAME F-Main /* Programa */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "r_clausulas_gastos_item_oe"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "r_clausulas_gastos_item_oe"}
