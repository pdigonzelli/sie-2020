...
DEFINE OUTPUT PARAMETER pfKilos  AS DECIMAL    NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS fiKilos btnNum-7 btnNum-8 btnNum-9 btnNum-4 ~
btnNum-5 btnNum-6 btnNum-1 btnNum-2 btnNum-3 btnCorregir btnNum-0 btnEnter ~
Btn_Cancel-2 Btn_OK-2 RECT-4 
&Scoped-Define DISPLAYED-OBJECTS fiKilosTotal fiKilos 
...
DEFINE VARIABLE fiKilosTotal AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 32 BY 1.91
...
DEFINE FRAME gDialog
     fiKilosTotal AT ROW 1.24 COL 39 NO-LABEL
     fiKilos AT ROW 3.95 COL 2 NO-LABEL
     ...
     "Kgs Pesada:" VIEW-AS TEXT
          SIZE 37 BY 1.67 AT ROW 1.24 COL 2
          FONT 25
     SPACE(32.99) SKIP(24.79)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Kilos Molienda Directa".
...
/* SETTINGS FOR FILL-IN fiKilos IN FRAME gDialog
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiKilosTotal IN FRAME gDialog
   NO-ENABLE ALIGN-L                                                    */
...
ON WINDOW-CLOSE OF FRAME gDialog /* Kilos Molienda Directa */
DO:  
...
DO:
  fiKilos:SCREEN-VALUE = SUBSTRING(fiKilos:SCREEN-VALUE, 1, LENGTH(fiKilos:SCREEN-VALUE) - 1).
END.
...
DO:
  pfKilos = DECIMAL(fiKilos:SCREEN-VALUE). 
END.
...
------------------------------------------------------------------------------*/
  DISPLAY fiKilosTotal fiKilos 
      WITH FRAME gDialog.
  ENABLE fiKilos btnNum-7 btnNum-8 btnNum-9 btnNum-4 btnNum-5 btnNum-6 btnNum-1 
         btnNum-2 btnNum-3 btnCorregir btnNum-0 btnEnter Btn_Cancel-2 Btn_OK-2 
         RECT-4 
      WITH FRAME gDialog.
  VIEW FRAME gDialog.
...
------------------------------------------------------------------------------*/
  ...
  fiKilosTotal:SCREEN-VALUE IN FRAME {&FRAME-NAME} = DYNAMIC-FUNCTION('getPesoFromNroPesada' IN hLib, piPesada).
...
------------------------------------------------------------------------------*/
  ...
  fiKilos:SCREEN-VALUE IN FRAME {&FRAME-NAME} = fiKilos:SCREEN-VALUE + STRING(piNum).
  BELL.
