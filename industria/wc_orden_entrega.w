...
DEFINE VARIABLE h_bc_orden_entrega AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_orden_entrega.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_orden_entrega ).
       RUN set-position IN h_bc_orden_entrega ( 3.14 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.48 , 118.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_orden_entrega ,
