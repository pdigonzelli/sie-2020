...
&Scoped-Define ENABLED-FIELDS  id_origen id_puerto_origen semana anio
&Scoped-define ENABLED-FIELDS-IN-registro_exportacion id_origen ~
id_puerto_origen semana anio 
&Scoped-Define DATA-FIELDS  id_origen id_puerto_origen semana Cantidad anio Origen
&Scoped-define DATA-FIELDS-IN-registro_exportacion id_origen ~
id_puerto_origen semana anio 
&Scoped-Define MANDATORY-FIELDS 
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST 
&Scoped-Define DATA-FIELD-DEFS "dregistroexportacion.i"
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _FldNameList[1]   > general.registro_exportacion.id_origen
"id_origen" "id_origen" ? ? "integer" ? ? ? ? ? ? yes ? no 10.6 yes
     _FldNameList[2]   > general.registro_exportacion.id_puerto_origen
"id_puerto_origen" "id_puerto_origen" ? ? "integer" ? ? ? ? ? ? yes ? no 17.4 yes
     _FldNameList[3]   > general.registro_exportacion.semana
"semana" "semana" ? ? "integer" ? ? ? ? ? ? yes ? no 7.8 yes
     _FldNameList[4]   > "_<CALC>"
"getCantidad()" "Cantidad" ? ">>>>>>9" "Integer" ? ? ? ? ? ? no ? no 8.4 no
     _FldNameList[5]   > general.registro_exportacion.anio
"anio" "anio" ? ? "integer" ? ? ? ? ? ? yes ? no 4.8 yes
     _FldNameList[6]   > "_<CALC>"
"getPuertoOrigen()" "Origen" "Origen" "x(50)" "character" ? ? ? ? ? ? no ? no 50 no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE getDataForTT dTables 
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH registro_exportacion ,
      EACH items_registro_exportacion OF registro_exportacion WHERE registro_exportacion.anio = items_registro_exportacion.anio
    ...
    FIND FIRST lugar_descarga WHERE lugar_descarga.id_lugdes = registro_exportacion.id_puerto_origen NO-LOCK NO-ERROR.
    ...
    vcEmp = IF AVAILABLE empresa_exportadora THEN empresa_exportadora.nombre ELSE "#".
    ...
    ASSIGN ttCompetencia.semana         = STRING(registro_exportacion.semana)
           ...
           ttCompetencia.anio           = registro_exportacion.anio.
  END.
