...
rowObject.item_oe rowObject.cantidad rowObject.Lote rowObject.Anio ~
rowObject.LoteCliente 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.LoteCliente FORMAT ">>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[6]   = _<SDO>.rowObject.LoteCliente
