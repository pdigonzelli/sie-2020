...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.signo rowObject.fecha ~
rowObject.nro_ingreso rowObject.observacion rowObject.id_sucursal_ubicacion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.signo FORMAT "+/-":U
      rowObject.fecha FORMAT "99/99/9999":U
      rowObject.nro_ingreso FORMAT ">,>>>,>>9":U
      rowObject.observacion FORMAT "X(40)":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.signo
     _FldNameList[2]   = _<SDO>.rowObject.fecha
     _FldNameList[3]   = _<SDO>.rowObject.nro_ingreso
     _FldNameList[4]   = _<SDO>.rowObject.observacion
