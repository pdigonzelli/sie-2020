...
DEFINE VARIABLE h_b_instrumentos_pagos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_instrumentos_pagos AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Instrumentos de Pago */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Instrumentos de Pago */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_instrumentos_pagos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_instrumentos_pagos ).
       RUN set-position IN h_b_instrumentos_pagos ( 3.86 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 113.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_instrumentos_pagos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_instrumentos_pagos ).
       RUN set-position IN h_v_instrumentos_pagos ( 11.24 , 30.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.91 , 55.00 ) */

       /* Links to csmartbrowser h_b_instrumentos_pagos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_instrumentos_pagos ).

       /* Links to SmartViewer h_v_instrumentos_pagos. */
       RUN add-link IN adm-broker-hdl ( h_b_instrumentos_pagos , 'Record':U , h_v_instrumentos_pagos ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_instrumentos_pagos ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_instrumentos_pagos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_instrumentos_pagos ,
             h_b_instrumentos_pagos , 'AFTER':U ).
    END. /* Page 0 */
