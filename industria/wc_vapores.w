...
DEFINE VARIABLE h_bc_vapores AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_vapores.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_vapores ).
       RUN set-position IN h_bc_vapores ( 2.43 , 11.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_vapores ,
