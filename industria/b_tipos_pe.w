...
&Scoped-define INTERNAL-TABLES tipos_pe

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipos_pe.id_tipo_pe ~
tipos_pe.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_pe WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipos_pe
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_pe
...
<FOREIGN-KEYS>
id_tipo_pe||y|general.tipos_pe.id_tipo_pe
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_pe.id_tipo_pe FORMAT ">>9":U
      tipos_pe.descripcion FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_pe"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tipos_pe.id_tipo_pe
     _FldNameList[2]   = general.tipos_pe.descripcion
...
define sub-menu Ordena 
  menu-item tipos_pe-id_tipo_pe
label 'id_tipo_pe( tipos_pe ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_pe.id_tipo_pe').
                  run set-attribute-list('titulo=Cod.TipoPE').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_pe.id_tipo_pe
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipos_pe-descripcion
label 'descripcion( tipos_pe ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_pe.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_pe.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipos_pe.id_tipo_pe
...
case p:
  WHEN 'tipos_pe.id_tipo_pe' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_pe = integer(valor)  no-lock no-error .
  WHEN 'tipos_pe.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_pe" "tipos_pe" "id_tipo_pe"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tipos_pe"}
