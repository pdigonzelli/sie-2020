...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.LoteDeposito ~
rowObject.lote rowObject.id_sucursal rowObject.nombre rowObject.cantidad ~
rowObject.calidad rowObject.envase rowObject.nromov rowObject.id_lote ~
rowObject.cantidad_comprometida 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.LoteDeposito FORMAT "x(20)":U
      rowObject.lote FORMAT "XXXXXX/XXXX":U
      rowObject.id_sucursal FORMAT ">>9":U
      rowObject.nombre FORMAT "x(30)":U WIDTH 23
      rowObject.cantidad FORMAT ">>>>>9":U
      rowObject.calidad FORMAT "X(40)":U
      rowObject.envase FORMAT "X(40)":U
      rowObject.nromov FORMAT ">>>,>>>,>>9":U
      rowObject.id_lote FORMAT "->,>>>,>>9":U WIDTH .6
      rowObject.cantidad_comprometida FORMAT ">>>,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 143 BY 6.67 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.LoteDeposito
     _FldNameList[2]   > _<SDO>.rowObject.lote
"rowObject.lote" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[3]   = _<SDO>.rowObject.id_sucursal
     _FldNameList[4]   > _<SDO>.rowObject.nombre
"rowObject.nombre" ? ? "character" ? ? ? ? ? ? no ? no no "23" yes no no "U" "" ""
...
"rowObject.id_lote" ? ? "integer" ? ? ? ? ? ? no "?" no no ".6" yes no no "U" "" ""
     _FldNameList[10]   = _<SDO>.rowObject.cantidad_comprometida
