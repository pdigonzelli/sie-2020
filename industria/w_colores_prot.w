...
&Scoped-Define ENABLED-OBJECTS RECT-17 RECT-2 
...
DEFINE VARIABLE h_b_colores_prot AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_colores_prot AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Colores de Protocolos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Colores de Protocolos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_colores_prot.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_colores_prot ).
       RUN set-position IN h_b_colores_prot ( 3.86 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b_colores_prot ( 6.71 , 79.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_colores_prot.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_colores_prot ).
       RUN set-position IN h_v_colores_prot ( 11.71 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 72.00 ) */

       /* Links to csmartbrowser h_b_colores_prot. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_colores_prot ).

       /* Links to SmartViewer h_v_colores_prot. */
       RUN add-link IN adm-broker-hdl ( h_b_colores_prot , 'Record':U , h_v_colores_prot ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_colores_prot ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_colores_prot ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_colores_prot ,
             h_b_colores_prot , 'AFTER':U ).
    END. /* Page 0 */
