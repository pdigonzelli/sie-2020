...
rowObject.id_lote rowObject.anio rowObject.id_tambor rowObject.camara ~
rowObject.nro_fila rowObject.nro_columna rowObject.articulo ~
rowObject.calidad rowObject.envase rowObject.nromov 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.camara FORMAT "X(20)":U
      rowObject.nro_fila FORMAT "X(10)":U
      rowObject.nro_columna FORMAT "X(10)":U
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dttUbicacionCamara.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[5]   = _<SDO>.rowObject.camara
     _FldNameList[6]   = _<SDO>.rowObject.nro_fila
     _FldNameList[7]   = _<SDO>.rowObject.nro_columna
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND hCont:FILE-NAME MATCHES "*fCompoMovCamara*" THEN DO:
