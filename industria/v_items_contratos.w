...
&Scoped-Define ENABLED-FIELDS items_contratos.observaciones ~
...
DEFINE FRAME F-Main
     items_contratos.observaciones AT ROW 1 COL 65.6
          VIEW-AS FILL-IN 
          SIZE 66 BY 1
     fi-productos_terminados-descrip AT ROW 1.95 COL 21 COLON-ALIGNED NO-LABEL
     items_contratos.marca_tambores AT ROW 1.95 COL 60.8
          VIEW-AS FILL-IN 
          SIZE 66 BY 1
     fi-calidades-descripcion AT ROW 6.71 COL 23 COLON-ALIGNED NO-LABEL
     fi-envases_prod-descripcion AT ROW 6.71 COL 87 COLON-ALIGNED NO-LABEL
     fi-tipo_moneda-descripcion AT ROW 9.57 COL 67 COLON-ALIGNED NO-LABEL
...
/* SETTINGS FOR FILL-IN fi-tipo_moneda-descripcion IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN items_contratos.marca_tambores IN FRAME F-Main
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN items_contratos.observaciones IN FRAME F-Main
   ALIGN-L                                                              */
...
general.items_contratos.id_moneda_base;wc_tipo_moneda.w;tipo_moneda.descripcion;;
general.items_contratos.id_envase;wc_envases.w;envases_prod.descripcion;;
...
&Scoped-define SELF-NAME items_contratos.marca_tambores
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.marca_tambores V-table-Win
ON LEAVE OF items_contratos.marca_tambores IN FRAME F-Main /* Marca de Tambores */
DO:
...
&Scoped-define SELF-NAME items_contratos.observaciones
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.observaciones V-table-Win
ON LEAVE OF items_contratos.observaciones IN FRAME F-Main /* Observaciones */
DO:
{custom/support/validacion.i}
END.
...
find first tipo_moneda where tipo_moneda.id_moneda_base = integer(items_contratos.id_moneda_base:screen-value in frame F-Main)  no-lock no-error .
...
define var lista_relacion as character no-undo initial "id_articulo,id_moneda_base,id_envase,id_calidad".
