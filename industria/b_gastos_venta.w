...
&Scoped-define FIELDS-IN-QUERY-br_table gastos_venta.id_gasto ~
gastos_venta.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH gastos_venta WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table gastos_venta
&Scoped-define FIRST-TABLE-IN-QUERY-br_table gastos_venta
...
<FOREIGN-KEYS>
id_gasto||y|general.gastos_venta.id_gasto
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      gastos_venta.id_gasto FORMAT ">>>,>>9":U
      gastos_venta.descripcion FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 60 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = general.gastos_venta.id_gasto
...
define sub-menu Ordena 
  menu-item gastos_venta-id_gasto
label 'id_gasto( gastos_venta ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_venta.id_gasto').
                  run set-attribute-list('titulo=Codigo Gasto').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_venta.id_gasto
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_gasto" "gastos_venta" "id_gasto"}
