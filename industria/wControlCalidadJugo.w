...
DEFINE VARIABLE h_vcontrolcalidadjugo AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Control Calidad Jugo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Control Calidad Jugo */
DO:
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             OUTPUT h_dlotesjugo ).
       RUN repositionObject IN h_dlotesjugo ( 15.05 , 83.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_blotesjugo ).
       RUN repositionObject IN h_blotesjugo ( 7.67 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_blotesjugo ( 8.10 , 93.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vcontrolcalidadjugo.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_vcontrolcalidadjugo ).
       RUN repositionObject IN h_vcontrolcalidadjugo ( 17.91 , 13.00 ) NO-ERROR.
       /* Size in AB:  ( 5.91 , 70.20 ) */
       ...
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 93.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'adm2/dynfilter.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsid_articulo,id_lote,anioOperatorStyleImplicitOperatorViewAsCombo-boxOperator=UseBeginsyesUseContainsyesDefaultWidth16DefaultCharWidth20DefaultEditorLines1ViewAsFieldsFieldOperatorStylesFieldFormatsFieldWidthsFieldLabelsFieldToolTipsFieldHelpIdscontrol_calidad0DesignDataObjectFieldColumn20HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynfilter ).
       RUN repositionObject IN h_dynfilter ( 2.67 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_dynfilter ( 4.43 , 91.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dyntoolbar-2 ( 16.00 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartDataViewer h_vcontrolcalidadjugo. */
       RUN addLink ( h_dlotesjugo , 'Data':U , h_vcontrolcalidadjugo ).
       RUN addLink ( h_vcontrolcalidadjugo , 'Update':U , h_dlotesjugo ).
       RUN addLink ( h_dyntoolbar-2 , 'TableIo':U , h_vcontrolcalidadjugo ).
       ...
       RUN adjustTabOrder ( h_vcontrolcalidadjugo ,
