...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-1 FILL-IN-2 FILL-IN-4 FILL-IN-3 
...
DEFINE VARIABLE h_b_consulta_contratos_2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_consulta_items_contratos_2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_consulta_oe_2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_consulta_oe_item_oe AS HANDLE NO-UNDO.
...
DEFINE VARIABLE FILL-IN-2 AS CHARACTER FORMAT "X(256)":U INITIAL "PARTES DE CONTRATOS" 
     VIEW-AS FILL-IN 
     SIZE 114 BY .95
     BGCOLOR 4 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FILL-IN-3 AS CHARACTER FORMAT "X(256)":U INITIAL "PARTES DE OE" 
     VIEW-AS FILL-IN 
     SIZE 102 BY .95
     BGCOLOR 2 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FILL-IN-4 AS CHARACTER FORMAT "X(256)":U INITIAL "OE" 
     VIEW-AS FILL-IN 
     SIZE 43 BY .95
...
DEFINE FRAME F-Main
     FILL-IN-1 AT ROW 3.86 COL 2 NO-LABEL
     FILL-IN-2 AT ROW 3.86 COL 35 NO-LABEL
     FILL-IN-4 AT ROW 12.43 COL 2 NO-LABEL
     FILL-IN-3 AT ROW 12.43 COL 49 NO-LABEL
     RECT-2 AT Y 0 X 170
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_contratos_2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_contratos_2 ).
       RUN set-position IN h_b_consulta_contratos_2 ( 5.05 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b_consulta_contratos_2 ( 6.71 , 31.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_items_contratos_2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_items_contratos_2 ).
       RUN set-position IN h_b_consulta_items_contratos_2 ( 5.05 , 35.00 ) NO-ERROR.
       RUN set-size IN h_b_consulta_items_contratos_2 ( 6.71 , 114.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_oe_2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_oe_2 ).
       RUN set-position IN h_b_consulta_oe_2 ( 13.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b_consulta_oe_2 ( 6.71 , 43.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_oe_item_oe.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_oe_item_oe ).
       RUN set-position IN h_b_consulta_oe_item_oe ( 13.62 , 49.00 ) NO-ERROR.
       RUN set-size IN h_b_consulta_oe_item_oe ( 6.71 , 102.00 ) NO-ERROR.

       /* Links to csmartbrowser h_b_consulta_contratos_2. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_consulta_contratos_2 ).

       /* Links to csmartbrowser h_b_consulta_items_contratos_2. */
       RUN add-link IN adm-broker-hdl ( h_b_consulta_contratos_2 , 'Record':U , h_b_consulta_items_contratos_2 ).

       /* Links to csmartbrowser h_b_consulta_oe_2. */
       RUN add-link IN adm-broker-hdl ( h_b_consulta_items_contratos_2 , 'Record':U , h_b_consulta_oe_2 ).

       /* Links to csmartbrowser h_b_consulta_oe_item_oe. */
       RUN add-link IN adm-broker-hdl ( h_b_consulta_oe_2 , 'Record':U , h_b_consulta_oe_item_oe ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_contratos_2 ,
             FILL-IN-2:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_items_contratos_2 ,
             h_b_consulta_contratos_2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_oe_2 ,
             FILL-IN-3:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_oe_item_oe ,
             h_b_consulta_oe_2 , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-1 FILL-IN-2 FILL-IN-4 FILL-IN-3 
