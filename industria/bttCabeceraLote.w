...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_lote rowObject.anio ~
rowObject.cantidad rowObject.kilos rowObject.kilos400 ~
rowObject.id_tambor_desde rowObject.id_tambor_hasta rowObject.articulo ~
rowObject.calidad rowObject.envase rowObject.id_contrato rowObject.item_of ~
rowObject.ubicacion rowObject.nromov rowObject.id_sucursal_ubicacion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.id_tambor_desde FORMAT ">>>9":U
      rowObject.id_tambor_hasta FORMAT ">>>9":U
      rowObject.articulo FORMAT "X(20)":U
      rowObject.calidad FORMAT "X(20)":U
      rowObject.envase FORMAT "X(20)":U
      rowObject.id_contrato FORMAT "X(15)":U
      rowObject.item_of FORMAT "->,>>>,>>9":U
      rowObject.ubicacion FORMAT "X(20)":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_lote
     _FldNameList[2]   = _<SDO>.rowObject.anio
     _FldNameList[3]   = _<SDO>.rowObject.cantidad
     _FldNameList[4]   = _<SDO>.rowObject.kilos
     _FldNameList[5]   = _<SDO>.rowObject.kilos400
     _FldNameList[6]   = _<SDO>.rowObject.id_tambor_desde
     _FldNameList[7]   = _<SDO>.rowObject.id_tambor_hasta
     _FldNameList[8]   = _<SDO>.rowObject.articulo
     _FldNameList[9]   = _<SDO>.rowObject.calidad
     _FldNameList[10]   = _<SDO>.rowObject.envase
     _FldNameList[11]   = _<SDO>.rowObject.id_contrato
     _FldNameList[12]   = _<SDO>.rowObject.item_of
     _FldNameList[13]   = _<SDO>.rowObject.ubicacion
     _FldNameList[14]   = _<SDO>.rowObject.nromov
     _FldNameList[15]   = _<SDO>.rowObject.id_sucursal_ubicacion
...
DO:
  ...
  {get ContainerSource hCont}.
   ...
   iBgColor = IF rowObject.rowNum MODULO 2 = 0 THEN 19 /*11 light blue*/ ELSE ? /*default*/.
    ...
    ASSIGN rowObject.id_lote:BGCOLOR IN BROWSE br_table               = ibgcolor
           rowObject.anio:BGCOLOR IN BROWSE br_table                  = ibgcolor
           rowObject.id_tambor_desde:BGCOLOR IN BROWSE br_table             = ibgcolor
           rowObject.id_tambor_hasta:BGCOLOR IN BROWSE br_table             = ibgcolor
           rowObject.kilos:BGCOLOR IN BROWSE br_table          = ibgcolor
           rowObject.kilos400:BGCOLOR IN BROWSE br_table          = ibgcolor
           ...
           rowObject.ubicacion:BGCOLOR IN BROWSE br_table               = ibgcolor
