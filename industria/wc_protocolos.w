...
DEFINE VARIABLE h_bc_protocolos AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 15.05 COL 108
     salir AT ROW 15.05 COL 120
     RECT-1 AT ROW 14.81 COL 105
     SPACE(27.79) SKIP(0.61)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_protocolos.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_protocolos ).
       RUN set-position IN h_bc_protocolos ( 2.19 , 2.00 ) NO-ERROR.
       RUN set-size IN h_bc_protocolos ( 11.19 , 155.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_protocolos ,
