...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-18 aceptar salir 
...
DEFINE VARIABLE h_bc_unidad_medida AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-18 AT ROW 1.67 COL 12
     SPACE(9.99) SKIP(2.70)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_unidad_medida.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_unidad_medida ).
       RUN set-position IN h_bc_unidad_medida ( 2.33 , 19.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 53.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_unidad_medida ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-1 RECT-18 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
