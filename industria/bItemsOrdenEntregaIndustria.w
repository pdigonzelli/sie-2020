...
rowObject.item_oe rowObject.fecha rowObject.id_contrato ~
rowObject.orden_fabricacion rowObject.abreviatura-2 rowObject.abreviatura ~
rowObject.cantidad_tambores rowObject.Vapor rowObject.Cliente ~
rowObject.total_factura rowObject.kgs_netos_tambores ~
rowObject.semana_entrega rowObject.id_estado 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_orden_entrega FORMAT ">>>>>9":U WIDTH 7.2
      item_oe FORMAT ">>>9":U
      fecha FORMAT "99/99/99":U
      id_contrato FORMAT "X(12)":U
      orden_fabricacion FORMAT ">>,>>>,>>9":U
      abreviatura-2 FORMAT "X(12)":U
      abreviatura FORMAT "X(10)":U
      cantidad_tambores FORMAT ">>>>>9":U
      Vapor FORMAT "x(30)":U
      Cliente FORMAT "x(25)":U
      total_factura FORMAT ">>>>>>>9.999":U WIDTH 15.8
      kgs_netos_tambores FORMAT ">>>>>>9.999":U WIDTH 18.2
      semana_entrega FORMAT ">>9":U WIDTH 9.6
      id_estado FORMAT ">>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 134 BY 6.67 EXPANDABLE.
...
"id_orden_entrega" ? ? "integer" ? ? ? ? ? ? no "?" no no "7.2" yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.item_oe
     _FldNameList[3]   = _<SDO>.rowObject.fecha
     _FldNameList[4]   = _<SDO>.rowObject.id_contrato
     _FldNameList[5]   = _<SDO>.rowObject.orden_fabricacion
     _FldNameList[6]   = _<SDO>.rowObject.abreviatura-2
     _FldNameList[7]   = _<SDO>.rowObject.abreviatura
     _FldNameList[8]   = _<SDO>.rowObject.cantidad_tambores
     _FldNameList[9]   > _<SDO>.rowObject.Vapor
"Vapor" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[10]   = _<SDO>.rowObject.Cliente
     _FldNameList[11]   > _<SDO>.rowObject.total_factura
"total_factura" ? ? "decimal" ? ? ? ? ? ? no ? no no "15.8" yes no no "U" "" ""
     _FldNameList[12]   > _<SDO>.rowObject.kgs_netos_tambores
"kgs_netos_tambores" ? ? "decimal" ? ? ? ? ? ? no ? no no "18.2" yes no no "U" "" ""
     _FldNameList[13]   > _<SDO>.rowObject.semana_entrega
"semana_entrega" ? ? "integer" ? ? ? ? ? ? no ? no no "9.6" yes no no "U" "" ""
     _FldNameList[14]   = _<SDO>.rowObject.id_estado
