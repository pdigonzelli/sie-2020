...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.SucLote rowObject.id_lote ~
rowObject.anio rowObject.citral rowObject.Fecha rowObject.descripcion ~
rowObject.id_tipo_lote_ind rowObject.nro_partida 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.SucLote FORMAT "x(25)":U
      rowObject.id_lote FORMAT "->,>>>,>>9":U
      rowObject.anio FORMAT ">>>9":U
      rowObject.citral FORMAT "->>,>>9.99":U
      rowObject.Fecha FORMAT "99/99/9999":U
      rowObject.descripcion FORMAT "X(30)":U
      rowObject.id_tipo_lote_ind FORMAT ">>9":U
      rowObject.nro_partida FORMAT ">>>,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.SucLote
     _FldNameList[2]   = _<SDO>.rowObject.id_lote
     _FldNameList[3]   = _<SDO>.rowObject.anio
     _FldNameList[4]   = _<SDO>.rowObject.citral
     _FldNameList[5]   = _<SDO>.rowObject.Fecha
     _FldNameList[6]   = _<SDO>.rowObject.descripcion
     _FldNameList[7]   = _<SDO>.rowObject.id_tipo_lote_ind
     _FldNameList[8]   = _<SDO>.rowObject.nro_partida
