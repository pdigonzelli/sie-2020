...
lotes_jugo.id_articulo lotes_jugo.Fecha 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      lotes_jugo.id_calidad COLUMN-LABEL "Calidad" FORMAT ">>>9"
      lotes_jugo.id_articulo FORMAT ">>>9"
      lotes_jugo.Fecha
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 142 BY 9.05
         FONT 0.
...
"lotes_jugo.id_calidad" "Calidad" ">>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[5]   > general.lotes_jugo.id_articulo
"lotes_jugo.id_articulo" ? ">>>9" "integer" ? ? ? ? ? ? no ?
