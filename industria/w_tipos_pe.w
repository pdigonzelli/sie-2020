...
DEFINE VARIABLE h_b_tipos_pe AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_pe AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_pe.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_pe ).
       RUN set-position IN h_b_tipos_pe ( 3.86 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_pe ( 6.71 , 66.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_pe.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_pe ).
       RUN set-position IN h_v_tipos_pe ( 11.95 , 16.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 47.00 ) */

       /* Links to csmartbrowser h_b_tipos_pe. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_pe ).

       /* Links to SmartViewer h_v_tipos_pe. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_pe , 'Record':U , h_v_tipos_pe ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_pe ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_pe ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_pe ,
             h_b_tipos_pe , 'AFTER':U ).
    END. /* Page 0 */
