...
&Scoped-Define DATA-FIELDS  id_sucursal Sucursal nombre abreviatura
&Scoped-define DATA-FIELDS-IN-sucursales id_sucursal nombre abreviatura 
...
DEFINE QUERY Query-Main FOR 
      sucursales
    FIELDS(sucursales.id_sucursal
      sucursales.nombre
      sucursales.abreviatura) SCROLLING.
&ANALYZE-RESUME
{&DB-REQUIRED-END}
...
"string(RowObject.id_sucursal) + "" - "" + RowObject.nombre" "Sucursal" "Sucursal" "x(50)" "character" ? ? ? ? ? ? no ? no 50 no
...
------------------------------------------------------------------------------*/
      ASSIGN 
         rowObject.Sucursal = (string(RowObject.id_sucursal) + " - " + RowObject.nombre)
      .
