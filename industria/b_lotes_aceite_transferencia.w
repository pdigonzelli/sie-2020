...
lotes_aceite.id_lote productos_terminados.descripcion ~
lotes_aceite.id_articulo lotes_aceite.fecha 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH lotes_aceite WHERE ~{&KEY-PHRASE} ~
      AND lotes_aceite.id_articulo = 74 ~
 OR lotes_aceite.id_articulo = 90 NO-LOCK, ~
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_orden_entrega,id_tipotambor"':U).
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 138 BY 9.29
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _TblOptList       = ",,, FIRST"
     _Where[1]         = "general.lotes_aceite.id_articulo = 74
 OR general.lotes_aceite.id_articulo = 90"
     ...
     _FldNameList[4]   = general.lotes_aceite.id_articulo
     _FldNameList[5]   = general.lotes_aceite.fecha
