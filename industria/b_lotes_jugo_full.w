...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      lotes_jugo.id_articulo COLUMN-LABEL "Prod" FORMAT ">>>9":U
            WIDTH 7.6
      productos_terminados.descripcion COLUMN-LABEL "Producto" FORMAT "x(30)":U
      calidades.descripcion COLUMN-LABEL "Calidades" FORMAT "X(25)":U
      lotes_jugo.Fecha FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 150 BY 5.62
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_jugo,general.productos_terminados OF general.lotes_jugo,comercial.sucursales OF general.lotes_jugo,general.calidades OF general.lotes_jugo"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ",,,"
     _OrdList          = "general.lotes_jugo.Fecha|no"
     _FldNameList[1]   > comercial.sucursales.nombre
"comercial.sucursales.nombre" "Sucursal" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > general.lotes_jugo.id_lote
"general.lotes_jugo.id_lote" "Lote" ">>>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > general.lotes_jugo.id_articulo
"general.lotes_jugo.id_articulo" "Prod" ">>>9" "integer" ? ? ? ? ? ? no ? no no "7.6" yes no no "U" "" ""
...
"general.productos_terminados.descripcion" "Producto" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > general.calidades.descripcion
"general.calidades.descripcion" "Calidades" "X(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
