...
&Scoped-define INTERNAL-TABLES conceptos_reembolso

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table conceptos_reembolso.id_concepto ~
conceptos_reembolso.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH conceptos_reembolso WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table conceptos_reembolso
&Scoped-define FIRST-TABLE-IN-QUERY-br_table conceptos_reembolso
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      conceptos_reembolso.id_concepto
      conceptos_reembolso.descripcion
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.conceptos_reembolso"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.conceptos_reembolso.id_concepto
...
define sub-menu Ordena 
  menu-item conceptos_reembolso-id_concepto
label 'id_concepto( conceptos_reembolso ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=conceptos_reembolso.id_concepto').
                  run set-attribute-list('titulo=Cod.Concepto').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by conceptos_reembolso.id_concepto
