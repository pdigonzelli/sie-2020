...
rowObject.abreviatura rowObject.abreviatura-2 rowObject.importe 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      abreviatura-2 FORMAT "X(10)":U
      importe FORMAT ">>>,>>>,>>9.9999":U WIDTH 14.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 69 BY 6.67 EXPANDABLE.
...
"abreviatura" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[4]   = _<SDO>.rowObject.abreviatura-2
     _FldNameList[5]   > _<SDO>.rowObject.importe
"importe" ? ? "decimal" ? ? ? ? ? ? no ? no no "21.6" yes no no "U" "" ""
