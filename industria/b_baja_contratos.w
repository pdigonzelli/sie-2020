...
&Scoped-define INTERNAL-TABLES baja_contratos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table baja_contratos.id_tipo_contrato ~
baja_contratos.id_contrato baja_contratos.anio baja_contratos.item ~
baja_contratos.c_usuario baja_contratos.c_fecha baja_contratos.c_hora 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH baja_contratos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table baja_contratos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table baja_contratos
...
<FOREIGN-KEYS>
id_tipo_contrato||y|general.baja_contratos.id_tipo_contrato
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_tipo_contrato"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      baja_contratos.id_tipo_contrato
      baja_contratos.id_contrato
      baja_contratos.anio
      baja_contratos.item
      baja_contratos.c_usuario
      baja_contratos.c_fecha
      baja_contratos.c_hora
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 104 BY 12.14
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.baja_contratos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.baja_contratos.id_tipo_contrato
     _FldNameList[2]   = general.baja_contratos.id_contrato
     _FldNameList[3]   = general.baja_contratos.anio
     _FldNameList[4]   = general.baja_contratos.item
     _FldNameList[5]   = general.baja_contratos.c_usuario
     _FldNameList[6]   = general.baja_contratos.c_fecha
     _FldNameList[7]   = general.baja_contratos.c_hora
...
define sub-menu Ordena 
  menu-item baja_contratos-id_tipo_contrato
label 'id_tipo_contrato( baja_contratos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=baja_contratos.id_tipo_contrato').
                  run set-attribute-list('titulo=Tipo Contrato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by baja_contratos.id_tipo_contrato
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item baja_contratos-id_contrato
label 'id_contrato( baja_contratos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=baja_contratos.id_contrato').
                  run set-attribute-list('titulo=Contract').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by baja_contratos.id_contrato
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item baja_contratos-anio
label 'anio( baja_contratos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=baja_contratos.anio').
                  run set-attribute-list('titulo=Año').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by baja_contratos.anio
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item baja_contratos-item
label 'item( baja_contratos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=baja_contratos.item').
                  run set-attribute-list('titulo=Parte').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by baja_contratos.item
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item baja_contratos-c_usuario
label 'c_usuario( baja_contratos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=baja_contratos.c_usuario').
                  run set-attribute-list('titulo=Usuario').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by baja_contratos.c_usuario
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item baja_contratos-c_fecha
label 'c_fecha( baja_contratos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=baja_contratos.c_fecha').
                  run set-attribute-list('titulo=Fecha').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by baja_contratos.c_fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item baja_contratos-c_hora
label 'c_hora( baja_contratos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=baja_contratos.c_hora').
                  run set-attribute-list('titulo=Hora').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by baja_contratos.c_hora
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by baja_contratos.id_tipo_contrato
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_contrato" "baja_contratos" "id_tipo_contrato"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "baja_contratos"}
