...
&Scoped-Define ENABLED-FIELDS lotes_jugo.microbiologia ~
lotes_jugo.quimico_microbiologia 
&Scoped-define ENABLED-TABLES lotes_jugo
&Scoped-define FIRST-ENABLED-TABLE lotes_jugo
&Scoped-Define DISPLAYED-FIELDS lotes_jugo.microbiologia ~
lotes_jugo.quimico_microbiologia 
...
DEFINE FRAME F-Main
     lotes_jugo.microbiologia AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16.6 BY 1
     lotes_jugo.quimico_microbiologia AT ROW 1.95 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
...
general.lotes_jugo.quimico_microbiologia;wc_quimicos.w;quimicos.nombre;id_quimico;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME lotes_jugo.microbiologia
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_jugo.microbiologia V-table-Win
ON LEAVE OF lotes_jugo.microbiologia IN FRAME F-Main /* Estado Lote */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME lotes_jugo.quimico_microbiologia
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_jugo.quimico_microbiologia V-table-Win
ON GO OF lotes_jugo.quimico_microbiologia IN FRAME F-Main /* Quimico */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_jugo.quimico_microbiologia V-table-Win
ON LEAVE OF lotes_jugo.quimico_microbiologia IN FRAME F-Main /* Quimico */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_jugo.quimico_microbiologia V-table-Win
ON MOUSE-SELECT-DBLCLICK OF lotes_jugo.quimico_microbiologia IN FRAME F-Main /* Quimico */
do: 
define var r as rowid no-undo.
run wc_quimicos.w(output r).
find quimicos where rowid(quimicos) = r no-lock no-error.
if available quimicos then 
general.lotes_jugo.quimico_microbiologia:screen-value = string(quimicos.id_quimico).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lotes_jugo.quimico_microbiologia V-table-Win
ON U1 OF lotes_jugo.quimico_microbiologia IN FRAME F-Main /* Quimico */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
if lotes_jugo.microbiologia:screen-value in frame F-Main = "Aprobado" and 
   integer(lotes_jugo.quimico_microbiologia:screen-value in frame F-Main) <> 0 then
   do:
        assign lotes_jugo.estado_lote = 5.
...
if lotes_jugo.microbiologia:screen-value in frame F-Main = "Desaprobado" and 
   integer(lotes_jugo.quimico_microbiologia:screen-value in frame F-Main) <> 0 then
   do:
...
find first quimicos where quimicos.id_quimico = integer(lotes_jugo.quimico_microbiologia:screen-value in frame F-Main)  no-lock no-error .
if available quimicos then 
...
define var lista_relacion as character no-undo initial "quimico_microbiologia".
