...
rowObject.anio_lote rowObject.Tambores rowObject.Proveedor ~
rowObject.Producto rowObject.Calidad rowObject.fecha rowObject.estado 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.anio_lote FORMAT "9999":U
      ...
      rowObject.estado FORMAT "Nuestro/Externo":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND hCont:FILE-NAME MATCHES "*wProductosTerceros*" THEN DO:
...
DO:
  ...
  ASSIGN   rowObject.id_lote:BGCOLOR IN BROWSE br_table    = ibgcolor
           rowObject.anio_lote:BGCOLOR IN BROWSE br_table  = ibgcolor
