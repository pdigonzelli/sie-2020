...
general.items_orden_entrega.id_tipo_venta;w_tipo_venta.w;tipo_venta.descripcion;;
general.items_orden_entrega.id_moneda;wc_tipo_moneda.w;tipo_moneda.descripcion;;
general.items_orden_entrega.id_tipo_unidad_venta;wc_tipo_unidad_venta.w;tipo_unidad_venta.descripcion;;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
general.items_orden_entrega.id_moneda:screen-value = string(tipo_moneda.id_moneda).
apply 'U1' to self.
end.
...
general.items_orden_entrega.id_tipo_unidad_venta:screen-value = string(tipo_unidad_venta.id_tipo_unidad_venta).
apply 'U1' to self.
end.
...
general.items_orden_entrega.id_tipo_venta:screen-value = string(tipo_venta.id_tipo_venta).
apply 'U1' to self.
end.
