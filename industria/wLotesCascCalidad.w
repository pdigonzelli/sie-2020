...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Control de Calidad Lotes Cascara"
         HEIGHT             = 17.29
         WIDTH              = 66.2
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Control de Calidad Lotes Cascara */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Control de Calidad Lotes Cascara */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dlotescascara ( 6.71 , 54.00 ) NO-ERROR.
       ...
       RUN resizeObject IN h_blotescascara ( 10.71 , 66.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  vlEstado = NOT DYNAMIC-FUNCTION('columnValue' IN h_dLotesCascara, 'control_calidad').
  RUN setControlCalidad IN h_dLotesCascara (vlEstado).
