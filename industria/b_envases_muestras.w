...
&Scoped-define INTERNAL-TABLES envases_muestras

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table envases_muestras.id_envase ~
envases_muestras.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH envases_muestras WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table envases_muestras
&Scoped-define FIRST-TABLE-IN-QUERY-br_table envases_muestras
...
<FOREIGN-KEYS>
id_envase||y|general.envases_muestras.id_envase
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      envases_muestras.id_envase COLUMN-LABEL "Cod" FORMAT ">>9":U
            WIDTH 7.2
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.envases_muestras"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.envases_muestras.id_envase
"id_envase" "Cod" ? "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
...
define sub-menu Ordena 
  menu-item envases_muestras-id_envase
label 'id_envase( envases_muestras ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=envases_muestras.id_envase').
                  run set-attribute-list('titulo=CodEnvase').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by envases_muestras.id_envase
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_envase" "envases_muestras" "id_envase"}
