...
&Scoped-Define ENABLED-FIELDS clientes.domicilio clientes.municipalidad ~
clientes.fax clientes.localidad clientes.telefono[1] clientes.postal ~
clientes.telefono[2] clientes.provincia clientes.telefono[3] clientes.pais 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}domicilio ~{&FP2}domicilio ~{&FP3}~
 ~{&FP1}municipalidad ~{&FP2}municipalidad ~{&FP3}~
 ~{&FP1}fax ~{&FP2}fax ~{&FP3}~
...
&Scoped-Define DISPLAYED-FIELDS clientes.domicilio clientes.municipalidad ~
clientes.fax clientes.localidad clientes.telefono[1] clientes.postal ~
clientes.telefono[2] clientes.provincia clientes.telefono[3] clientes.pais 
...
DEFINE FRAME F-Main
     clientes.domicilio AT ROW 1 COL 8.4
          VIEW-AS FILL-IN 
          SIZE 107 BY 1
     clientes.municipalidad AT ROW 1.95 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12.6 BY 1
     clientes.fax AT ROW 2.43 COL 80 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 31 BY 1
     clientes.localidad AT ROW 2.91 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 43 BY 1
     clientes.telefono[1] AT ROW 3.62 COL 80 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 31 BY 1
     clientes.postal AT ROW 3.86 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     clientes.telefono[2] AT ROW 4.62 COL 80 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 31 BY 1
     clientes.provincia AT ROW 4.81 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 43 BY 1
     clientes.telefono[3] AT ROW 5.62 COL 80 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 31 BY 1
     clientes.pais AT ROW 5.76 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 43 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.clientes
...
/* SETTINGS FOR FILL-IN clientes.domicilio IN FRAME F-Main
   ALIGN-L                                                              */
...
&Scoped-define SELF-NAME clientes.domicilio
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.domicilio V-table-Win
ON LEAVE OF clientes.domicilio IN FRAME F-Main /* Domicilio */
DO:
...
&Scoped-define SELF-NAME clientes.fax
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.fax V-table-Win
ON LEAVE OF clientes.fax IN FRAME F-Main /* Fax */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME clientes.localidad
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.localidad V-table-Win
ON LEAVE OF clientes.localidad IN FRAME F-Main /* Localidad */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME clientes.municipalidad
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.municipalidad V-table-Win
ON LEAVE OF clientes.municipalidad IN FRAME F-Main /* Municipalidad */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME clientes.pais
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.pais V-table-Win
ON LEAVE OF clientes.pais IN FRAME F-Main /* País */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME clientes.postal
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.postal V-table-Win
ON LEAVE OF clientes.postal IN FRAME F-Main /* Cód. Postal */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME clientes.provincia
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.provincia V-table-Win
ON LEAVE OF clientes.provincia IN FRAME F-Main /* Provincia */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME clientes.telefono[1]
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.telefono[1] V-table-Win
ON LEAVE OF clientes.telefono[1] IN FRAME F-Main /* Teléfono[1] */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME clientes.telefono[2]
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.telefono[2] V-table-Win
ON LEAVE OF clientes.telefono[2] IN FRAME F-Main /* Teléfono[2] */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME clientes.telefono[3]
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clientes.telefono[3] V-table-Win
ON LEAVE OF clientes.telefono[3] IN FRAME F-Main /* Teléfono[3] */
DO:
{custom/support/validacion.i}
END.
