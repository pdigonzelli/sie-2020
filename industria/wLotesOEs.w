...
&Scoped-Define ENABLED-OBJECTS RECT-33 
...
ON END-ERROR OF wWin /* Lotes OE's */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Lotes OE's */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_ditemsordenentrega ( 11.71 , 97.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_bitemsoe ).
       RUN repositionObject IN h_bitemsoe ( 6.95 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_bitemsoe ( 5.48 , 125.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'dordenentrega.wDB-AWARE':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsorden_entrega.id_orden_entrega,id_orden_entregaRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedordenentregaUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dordenentrega ).
       RUN repositionObject IN h_dordenentrega ( 11.71 , 106.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'dttcabeceralote.wDB-AWARE':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsttCabeceraLote.id_orden_entrega,id_orden_entrega,ttCabeceraLote.item_oe,item_oeRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedttcabeceraloteUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dttcabeceralote ).
       RUN repositionObject IN h_dttcabeceralote ( 11.71 , 117.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'adm2/dyntoolbar.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'FlatButtonsyesMenunoShowBorderyesToolbaryesActionGroupsNavigation,Banda1SubModulesTableIOTypeSupportedLinksNavigation-sourceToolbarBandsToolbarParentMenuToolbarAutoSizenoToolbarDrawDirectionHorizontalToolbarInitialStateLogicalObjectNameAutoResizeDisabledActionsHiddenActionsUpdate,Filter,PrintactionHiddenToolbarBandsHiddenMenuBandsMenuMergeOrder0EdgePixels2PanelTypeToolbarDeactivateTargetOnHidenoDisabledActionsNavigationTargetNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dyntoolbar ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsid_orden_entrega,id_contratoOperatorStyleImplicitOperatorViewAsCombo-boxOperator=UseBeginsyesUseContainsyesDefaultWidth16DefaultCharWidth20DefaultEditorLines1ViewAsFieldsFieldOperatorStylesFieldFormatsFieldWidthsFieldLabelsFieldToolTipsFieldHelpIdsDesignDataObjectFieldColumn20HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynfilter ).
       RUN repositionObject IN h_dynfilter ( 2.67 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_dynfilter ( 3.71 , 124.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'adm2/folder.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'FolderLabels':U + 'OE|Producto' + 'FolderTabWidth0FolderFont-1HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_folder ).
       RUN repositionObject IN h_folder ( 12.67 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_folder ( 12.86 , 125.00 ) NO-ERROR.
       ...
       RUN addLink ( h_ditemsordenentrega , 'Data':U , h_dordenentrega ).

       /* Links to SmartDataObject h_dttcabeceralote. */
       RUN addLink ( h_ditemsordenentrega , 'Data':U , h_dttcabeceralote ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN repositionObject IN h_voeindustria ( 14.10 , 5.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN repositionObject IN h_bttcabeceralote ( 15.29 , 3.00 ) NO-ERROR.
       RUN resizeObject IN h_bttcabeceralote ( 10.00 , 123.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dyntoolbar-2 ( 13.86 , 3.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar-2 ( 1.24 , 123.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  SUBSCRIBE TO 'oeChanged' IN h_bItemsOE.

  cSrt = "BY id_orden_entrega DESCENDING".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE oeChanged wWin 
PROCEDURE oeChanged :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
  ...
  RUN fillTamboresOE IN h_dttCabeceraLote   (DYNAMIC-FUNCTION('columnValue' IN h_dItemsOrdenEntrega, 'id_orden_entrega'),
...
------------------------------------------------------------------------------*/
  ...
  iTip = DYNAMIC-FUNCTION('getTipotamborFromArticulo' IN hLib, DYNAMIC-FUNCTION('columnValue' IN h_dItemsOrdenEntrega, 'id_articulo')).

  RUN wdPickUpDrums.w (0, iTip, OUTPUT cRet).
  ...
  DO i = 1 TO NUM-ENTRIES(cRet, CHR(10)):
    ...
    RUN asocTamboresOE IN hLib (INTEGER(ENTRY(1, cRow, CHR(1))), 
  ...
  RUN mailingTamboresItemOE IN hLib (DYNAMIC-FUNCTION('columnValue' IN h_dttCabeceraLote, 'id_empresa'), 
...
------------------------------------------------------------------------------*/
  ...
  RUN asocTamboresOE IN hLib (DYNAMIC-FUNCTION('columnValue' IN h_dttCabeceraLote, 'id_empresa'), 
                              DYNAMIC-FUNCTION('columnValue' IN h_dttCabeceraLote, 'id_sucursal'),
                              DYNAMIC-FUNCTION('columnValue' IN h_dttCabeceraLote, 'id_tipotambor'),
                              DYNAMIC-FUNCTION('columnValue' IN h_dttCabeceraLote, 'nromov'),
                              DYNAMIC-FUNCTION('columnValue' IN h_dttCabeceraLote, 'id_tambor_desde'),
