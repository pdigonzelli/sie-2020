...
rowObject.id_tambor rowObject.Kilos rowObject.Litros rowObject.Articulo ~
rowObject.Calidad rowObject.Envase rowObject.nromov rowObject.nromov_carga 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.Envase FORMAT "x(15)":U
      rowObject.nromov FORMAT ">>>,>>>,>>9":U
      rowObject.nromov_carga COLUMN-LABEL "NromovCarga" FORMAT ">>>,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"rowObject.nromov" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[10]   > _<SDO>.rowObject.nromov_carga
"rowObject.nromov_carga" "NromovCarga" ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND (hCont:FILE-NAME MATCHES "*wProcesos.w") THEN DO:
    ...
    ASSIGN rowObject.lote:BGCOLOR IN BROWSE br_table          = ibgcolor
           ...
           rowObject.nromov_carga:BGCOLOR IN BROWSE br_table  = ibgcolor.
  END. 
END.
