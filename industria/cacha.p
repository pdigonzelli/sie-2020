...
define VARI vtipo like tipos_movimientos.id_tipo_movimiento INITIAL 0. 
define vari vsucursal like bstock.id_sucursal INITIAL 95.
define vari varticulo like bstock.id_articulo INITIAL 521.
define vari vlote like bstock.id_lote INITIAL 1035.
define vari vano like bstock.anio INITIAL 2004.
define vari vdesde as DATE .
define vari vfecha as date.
define vari vdetalle  as LOGICAL INITIAL TRUE.
define vari vstock0 as logical INITIAL TRUE.

vdesde = DATE("01/05/2003").
vfecha = DATE("03/05/2004").
...
/*           if bstock.signo = "B" and
  ...
  */
           ...
           IF tipos_movimientos.codigo = "+" AND vhaber <> 0 THEN ASSIGN vdebe = vhaber vhaber = 0.
           
           /* DISPLA bstock.id_tipo_movimiento
                  tipos_movimientos.alta
                  tipos_movimientos.codigo COLUMN-LABEL "Signo tabla"
                  bstock.signo COLUMN-LABEL "Signo bsto"
                  vdebe
                  vhaber WITH SCROLLABLE. */
...
FOR EACH repstock.
    FIND TIPOS_MOVIMIENTOS WHERE 
        tipos_movimientos.alta = REPSTOCK.nommov NO-LOCK NO-ERROR.
    
     DISPLA 
               repstock.id_articulo    
               repstock.nomart         
               repstock.id_serial      
/*               repstock.id_tipotambor  
               repstock.nomtambor 
       */      repstock.id_lote   
               repstock.anio      
               repstock.fecha     
               ...
               repstock.haber      
               repstock.saldo      
               repstock.tambor_desde   
               repstock.tambor_hasta   
/*               repstock.cantidad       
               repstock.cantidad_400   
               repstock.nomcalidad     */
               repstock.usuario        
