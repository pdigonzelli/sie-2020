...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-18 
...
DEFINE FRAME D-Dialog
     ...
     RECT-18 AT ROW 1.71 COL 2
     SPACE(2.99) SKIP(2.47)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_colores_prot ( 2.43 , 5.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-18 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
