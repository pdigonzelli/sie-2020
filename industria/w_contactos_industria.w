...
DEFINE VARIABLE h_b_contactos_industria AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_contactos_industria AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Contactos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Contactos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 29.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 63.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 86.80 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_contactos_industria.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_contactos_industria ).
       RUN set-position IN h_b_contactos_industria ( 3.86 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b_contactos_industria ( 6.71 , 147.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_contactos_industria.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_contactos_industria ).
       RUN set-position IN h_v_contactos_industria ( 11.24 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.67 , 141.00 ) */

       /* Links to csmartbrowser h_b_contactos_industria. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_contactos_industria ).

       /* Links to SmartViewer h_v_contactos_industria. */
       RUN add-link IN adm-broker-hdl ( h_b_contactos_industria , 'Record':U , h_v_contactos_industria ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_contactos_industria ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_contactos_industria ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_contactos_industria ,
             h_b_contactos_industria , 'AFTER':U ).
    END. /* Page 0 */
