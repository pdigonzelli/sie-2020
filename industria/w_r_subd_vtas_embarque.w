...
DEFINE VARIABLE h_r_subd_vtas_embarque AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v_r_subd_vtas_embarque AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/r_subd_vtas_embarque.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_r_subd_vtas_embarque ).
       RUN set-position IN h_r_subd_vtas_embarque ( 3.62 , 2.00 ) NO-ERROR.
       RUN set-size IN h_r_subd_vtas_embarque ( 13.57 , 138.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_r_subd_vtas_embarque.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_r_subd_vtas_embarque ).
       RUN set-position IN h_v_r_subd_vtas_embarque ( 18.14 , 52.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 41.80 ) */

       /* Links to csmartbrowser h_r_subd_vtas_embarque. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_r_subd_vtas_embarque ).

       /* Links to SmartViewer h_v_r_subd_vtas_embarque. */
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_r_subd_vtas_embarque ).
       RUN add-link IN adm-broker-hdl ( h_r_subd_vtas_embarque , 'Record':U , h_v_r_subd_vtas_embarque ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_r_subd_vtas_embarque ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_r_subd_vtas_embarque ,
             h_r_subd_vtas_embarque , 'AFTER':U ).
    END. /* Page 0 */
...
estados = "btn-delete,btn-copy,btn-add,btn-reset,btn-cancel".
END PROCEDURE.
