...
rowObject.item_release_delivery rowObject.id_articulo ~
rowObject.fecha_confirmacion_entrega rowObject.cantidad rowObject.tambores 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      numero_release COLUMN-LABEL "Nro Release" FORMAT "->,>>>,>>9":U
            WIDTH 12.2
      item_release_delivery COLUMN-LABEL "Parte" FORMAT "->,>>>,>>9":U
            WIDTH 7.4
      id_articulo FORMAT ">9":U
      fecha_confirmacion_entrega COLUMN-LABEL "Fecha Conf Entrega" FORMAT "99/99/9999":U
            WIDTH 20.2
      cantidad FORMAT ">>>>>9":U
      tambores COLUMN-LABEL "Tambores" FORMAT "->,>>>,>>9":U WIDTH 33.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 97 BY 6.67 ROW-HEIGHT-CHARS .57 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "sdoreleasecontratos.w"
   Allow: Basic,Browse
   Frames: 1
...
"numero_release" "Nro Release" ? "integer" ? ? ? ? ? ? no "?" no no "12.2" yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.item_release_delivery
"item_release_delivery" "Parte" ? "integer" ? ? ? ? ? ? no "?" no no "7.4" yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.id_articulo
"id_articulo" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.fecha_confirmacion_entrega
"fecha_confirmacion_entrega" "Fecha Conf Entrega" ? "date" ? ? ? ? ? ? no "?" no no "20.2" yes no no "U" "" ""
     _FldNameList[5]   = _<SDO>.rowObject.cantidad
     _FldNameList[6]   > _<SDO>.rowObject.tambores
"tambores" "Tambores" ? "integer" ? ? ? ? ? ? no "?" no no "33.4" yes no no "U" "" ""
