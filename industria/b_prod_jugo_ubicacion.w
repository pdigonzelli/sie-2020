...
&Scoped-define INTERNAL-TABLES produccion_jugo sucursales ~
...
produccion_jugo.Fecha sucursales.abreviatura ~
productos_terminados.descripcion envases_prod.descripcion ~
produccion_jugo.litros 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH produccion_jugo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      ...
      EACH envases_prod WHERE envases_prod.id_envase = produccion_jugo.id_envase_1 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
<FOREIGN-KEYS>
nromov||y|general.produccion_jugo.nromov
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      produccion_jugo.id_produccion COLUMN-LABEL "Prod."
      produccion_jugo.Fecha FORMAT "99/99/99"
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.produccion_jugo,comercial.sucursales OF general.produccion_jugo,general.productos_terminados OF general.produccion_jugo,general.envases_prod WHERE general.produccion_jugo ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ",,,"
     _JoinCode[4]      = "general.envases_prod.id_envase = general.produccion_jugo.id_envase_1"
     _FldNameList[1]   > general.produccion_jugo.id_produccion
"general.produccion_jugo.id_produccion" "Prod." ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   > general.produccion_jugo.Fecha
"general.produccion_jugo.Fecha" ? "99/99/99" "date" ? ? ? ? ? ? no ?
     _FldNameList[3]   = comercial.sucursales.abreviatura
     _FldNameList[4]   > general.productos_terminados.descripcion
"general.productos_terminados.descripcion" ? "x(20)" "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > general.envases_prod.descripcion
"general.envases_prod.descripcion" ? "x(20)" "character" ? ? ? ? ? ? no ?
     _FldNameList[6]   > general.produccion_jugo.litros
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nromov" "produccion_jugo" "nromov"}
