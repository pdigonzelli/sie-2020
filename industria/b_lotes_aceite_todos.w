...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 145 BY 6.1
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_aceite,general.productos_terminados OF general.lotes_aceite,comercial.sucursales OF general.lotes_aceite"
...
case p:
  ...
  WHEN 'lotes_aceite.citral' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  citral = integer(valor)  no-lock no-error .
end.
END PROCEDURE.
