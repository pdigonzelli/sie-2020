...
DEFINE VARIABLE h_b_mov_tam_mat_prima_aceite AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_mov_tam_mat_prima_aceite.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_mov_tam_mat_prima_aceite ).
       RUN set-position IN h_b_mov_tam_mat_prima_aceite ( 3.62 , 9.00 ) NO-ERROR.
       RUN set-size IN h_b_mov_tam_mat_prima_aceite ( 19.29 , 114.00 ) NO-ERROR.

       /* Links to csmartbrowser h_b_mov_tam_mat_prima_aceite. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_mov_tam_mat_prima_aceite ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_b_mov_tam_mat_prima_aceite ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_mov_tam_mat_prima_aceite ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
