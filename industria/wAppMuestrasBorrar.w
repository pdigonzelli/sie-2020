...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  '../industria/dcmuestras_cl.w':U ,
             ...
             OUTPUT h_dcmuestras ).
       RUN repositionObject IN h_dcmuestras ( 11.24 , 6.00 ) NO-ERROR.
       /* Size in AB:  ( 2.14 , 8.00 ) */
       ...
       RUN constructObject (
             ...
             OUTPUT h_bcmuestras ).
       RUN repositionObject IN h_bcmuestras ( 3.86 , 7.00 ) NO-ERROR.
       RUN resizeObject IN h_bcmuestras ( 6.67 , 66.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_bcmuestras ,
