...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipos_orden_entrega
&Scoped-define FIRST-EXTERNAL-TABLE tipos_orden_entrega


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipos_orden_entrega.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipos_orden_entrega.id_tipo_orden_entrega ~
tipos_orden_entrega.descripcion tipos_orden_entrega.abreviatura 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_tipo_orden_entrega ~{&FP2}id_tipo_orden_entrega ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}~
 ~{&FP1}abreviatura ~{&FP2}abreviatura ~{&FP3}
&Scoped-define ENABLED-TABLES tipos_orden_entrega
&Scoped-define FIRST-ENABLED-TABLE tipos_orden_entrega
&Scoped-Define DISPLAYED-FIELDS tipos_orden_entrega.id_tipo_orden_entrega ~
tipos_orden_entrega.descripcion tipos_orden_entrega.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipos_orden_entrega.id_tipo_orden_entrega 
...
DEFINE FRAME F-Main
     tipos_orden_entrega.id_tipo_orden_entrega AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     tipos_orden_entrega.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipos_orden_entrega.abreviatura AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipos_orden_entrega
...
/* SETTINGS FOR FILL-IN tipos_orden_entrega.id_tipo_orden_entrega IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipos_orden_entrega.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_orden_entrega.abreviatura V-table-Win
ON LEAVE OF tipos_orden_entrega.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME tipos_orden_entrega.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_orden_entrega.descripcion V-table-Win
ON LEAVE OF tipos_orden_entrega.descripcion IN FRAME F-Main /* Tipo OE */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tipos_orden_entrega.id_tipo_orden_entrega
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_orden_entrega.id_tipo_orden_entrega V-table-Win
ON LEAVE OF tipos_orden_entrega.id_tipo_orden_entrega IN FRAME F-Main /* Cod.TipoOE */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipos_orden_entrega"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipos_orden_entrega"}
