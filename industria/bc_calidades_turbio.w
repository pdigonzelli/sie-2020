...
&Scoped-define FIELDS-IN-QUERY-br_table calidades.id_calidad ~
calidades.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH calidades WHERE ~{&KEY-PHRASE} ~
      AND calidades.id_calidad = 80 ~
 OR calidades.id_calidad = 316 ~
 OR calidades.id_calidad = 320 ~
 OR calidades.id_calidad = 313 ~
 OR calidades.id_calidad = 311 ~
 OR calidades.id_calidad = 410 ~
 OR calidades.id_calidad = 325 ~
 OR calidades.id_calidad = 326 ~
 OR calidades.id_calidad = 330 ~
 OR calidades.id_calidad = 323 ~
 OR calidades.id_calidad = 327 ~
 OR calidades.id_calidad = 336 ~
 OR calidades.id_calidad = 337 ~
 OR calidades.id_calidad = 338 ~
 OR calidades.id_calidad = 339 ~
 OR calidades.id_calidad = 340 ~
 OR calidades.id_calidad = 335 ~
 OR calidades.id_calidad = 331 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table calidades
&Scoped-define FIRST-TABLE-IN-QUERY-br_table calidades
...
<FOREIGN-KEYS>
id_calidad||y|general.calidades.id_calidad
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "general.calidades.id_calidad = 80
 OR general.calidades.id_calidad = 316
 OR general.calidades.id_calidad = 320
 OR general.calidades.id_calidad = 313
 OR general.calidades.id_calidad = 311
 OR general.calidades.id_calidad = 410
 OR general.calidades.id_calidad = 325
 OR general.calidades.id_calidad = 326
 OR general.calidades.id_calidad = 330
 OR general.calidades.id_calidad = 323
 OR general.calidades.id_calidad = 327
 OR general.calidades.id_calidad = 336
 OR general.calidades.id_calidad = 337
 OR general.calidades.id_calidad = 338
 OR general.calidades.id_calidad = 339
 OR general.calidades.id_calidad = 340
 OR general.calidades.id_calidad = 335
 OR general.calidades.id_calidad = 331"
     _FldNameList[1]   = general.calidades.id_calidad
     _FldNameList[2]   = general.calidades.descripcion
...
define sub-menu Ordena 
  menu-item calidades-id_calidad
label 'id_calidad( calidades ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=calidades.id_calidad').
                  run set-attribute-list('titulo=Calidad').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by calidades.id_calidad
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_calidad" "calidades" "id_calidad"}
