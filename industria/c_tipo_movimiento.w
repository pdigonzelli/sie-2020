...
DEFINE VARIABLE h_b_tipo_movimiento AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 9.57 COL 59
     salir AT ROW 9.57 COL 71
     RECT-1 AT ROW 9.33 COL 56
     SPACE(4.19) SKIP(0.61)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipo_movimiento.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipo_movimiento ).
       RUN set-position IN h_b_tipo_movimiento ( 1.71 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipo_movimiento ,
