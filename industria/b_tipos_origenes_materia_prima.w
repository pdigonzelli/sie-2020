...
&Scoped-define INTERNAL-TABLES tipos_origenes_materia_prima
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_origenes_materia_prima WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipos_origenes_materia_prima
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_origenes_materia_prima
...
<FOREIGN-KEYS>
id_tipo_origen|y|y|general.tipos_origenes_materia_prima.id_tipo_origen
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "id_tipo_origen",
     Keys-Supplied = "id_tipo_origen"':U).
...
DEFINE QUERY br_table FOR 
      tipos_origenes_materia_prima SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_origenes_materia_prima.id_tipo_origen FORMAT ">>>9":U
      tipos_origenes_materia_prima.descripcion FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_origenes_materia_prima"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tipos_origenes_materia_prima.id_tipo_origen
     _FldNameList[2]   = general.tipos_origenes_materia_prima.descripcion
...
define sub-menu Ordena 
  menu-item tipos_origenes_materia_prima-id_tipo_origen
label 'id_tipo_origen( tipos_origenes_materia_prima ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_origenes_materia_prima.id_tipo_origen').
                  run set-attribute-list('titulo=CodTOrigen').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_origenes_materia_prima.id_tipo_origen
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipos_origenes_materia_prima-descripcion
label 'descripcion( tipos_origenes_materia_prima ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_origenes_materia_prima.descripcion').
                  run set-attribute-list('titulo=Decripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_origenes_materia_prima.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipos_origenes_materia_prima.id_tipo_origen
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_tipo_origen':U THEN DO:
       &Scope KEY-PHRASE tipos_origenes_materia_prima.id_tipo_origen eq INTEGER(key-value)
       {&OPEN-QUERY-{&BROWSE-NAME}}
    END. /* id_tipo_origen */
    OTHERWISE DO:
...
case p:
  WHEN 'tipos_origenes_materia_prima.id_tipo_origen' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_origen = integer(valor)  no-lock no-error .
  WHEN 'tipos_origenes_materia_prima.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_origen" "tipos_origenes_materia_prima" "id_tipo_origen"}
