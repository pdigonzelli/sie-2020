...
DEFINE VARIABLE h_vitemscontratospendiente AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Partes de Contratos Pendientes de OE"
         HEIGHT             = 19.86
         WIDTH              = 110.2
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Partes de Contratos Pendientes de OE */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Partes de Contratos Pendientes de OE */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_ditemscontratos ( 17.91 , 89.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_bitemscontratos ( 7.19 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_bitemscontratos ( 8.81 , 110.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vitemscontratospendiente.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_vitemscontratospendiente ).
       RUN repositionObject IN h_vitemscontratospendiente ( 16.95 , 31.00 ) NO-ERROR.
       /* Size in AB:  ( 3.19 , 46.00 ) */
       ...
       /* Links to SmartDataViewer h_vitemscontratospendiente. */
       RUN addLink ( h_ditemscontratos , 'Data':U , h_vitemscontratospendiente ).
       RUN addLink ( h_vitemscontratospendiente , 'Update':U , h_ditemscontratos ).
       RUN addLink ( h_dyntoolbar , 'TableIo':U , h_vitemscontratospendiente ).
       ...
       RUN adjustTabOrder ( h_bitemscontratos ,
             h_dynfilter , 'AFTER':U ).
       RUN adjustTabOrder ( h_vitemscontratospendiente ,
