...
&Scoped-define FIELDS-IN-QUERY-br_table contratos.id_contrato ~
contratos.orden_fabricacion contratos.anio clientes.nombre contratos.fecha ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH contratos WHERE ~{&KEY-PHRASE} NO-LOCK, ~
    ...
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table contratos clientes
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[4]   = general.clientes.nombre
     _FldNameList[5]   = general.contratos.fecha
     _FldNameList[6]   > general.contratos.id_po_cliente[1]
