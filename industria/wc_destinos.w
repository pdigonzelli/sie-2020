...
DEFINE VARIABLE h_bc_destinos AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_destinos.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_destinos ).
       RUN set-position IN h_bc_destinos ( 2.67 , 5.00 ) NO-ERROR.
       RUN set-size IN h_bc_destinos ( 6.71 , 123.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_destinos ,
