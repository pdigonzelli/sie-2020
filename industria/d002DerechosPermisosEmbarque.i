  ...
  FIELD Despachante LIKE despachantes.descripcion VALIDATE  LABEL "Despachante"~
  FIELD Estado LIKE estados_pe.descripcion VALIDATE  LABEL "Estado"~
  FIELD descripcion LIKE aduanas.descripcion VALIDATE  LABEL "Aduana"
