...
lotes_jugo.id_lote lotes_jugo.Fecha lotes_jugo.id_articulo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH lotes_jugo WHERE lotes_jugo.id_empresa = tambores_industria.id_empresa_destino ~
  AND lotes_jugo.id_sucursal = tambores_industria.id_sucursal_destino ~
  AND lotes_jugo.id_tipotambor = tambores_industria.id_tipotambor ~
  AND lotes_jugo.nromov = tambores_industria.nromov NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table lotes_jugo
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_orden_entrega,id_tipotambor,id_tipolimon"':U).
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_jugo WHERE general.tambores_industria ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "general.lotes_jugo.id_empresa = general.tambores_industria.id_empresa_destino
  AND general.lotes_jugo.id_sucursal = general.tambores_industria.id_sucursal_destino
  AND general.lotes_jugo.id_tipotambor = general.tambores_industria.id_tipotambor
  AND general.lotes_jugo.nromov = general.tambores_industria.nromov"
