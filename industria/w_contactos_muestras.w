...
DEFINE VARIABLE h_b_contactos_muestras AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_contactos_muestras AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Contactos Muestras */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Contactos Muestras */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_contactos_muestras.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_contactos_muestras ).
       RUN set-position IN h_b_contactos_muestras ( 3.86 , 11.00 ) NO-ERROR.
       RUN set-size IN h_b_contactos_muestras ( 6.71 , 68.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_contactos_muestras.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_contactos_muestras ).
       RUN set-position IN h_v_contactos_muestras ( 11.48 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.48 , 83.00 ) */

       /* Links to csmartbrowser h_b_contactos_muestras. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_contactos_muestras ).

       /* Links to SmartViewer h_v_contactos_muestras. */
       RUN add-link IN adm-broker-hdl ( h_b_contactos_muestras , 'Record':U , h_v_contactos_muestras ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_contactos_muestras ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_contactos_muestras ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_contactos_muestras ,
             h_b_contactos_muestras , 'AFTER':U ).
    END. /* Page 0 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE dame-tipo-contacto W-Win 
PROCEDURE dame-tipo-contacto :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
DEFINE OUTPUT PARAMETER p_e AS INTEGER.
