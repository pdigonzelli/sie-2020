...
&Scoped-define QUERY-STRING-br_table FOR EACH tambores_industria WHERE tambores_industria.id_sucursal_remito = items_factura.id_sucursal ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tambores_industria.id_articulo FORMAT ">>>9":U WIDTH 11.2
...
"tambores_industria.id_lote" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
...
"tambores_industria.id_tambor" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[4]   > general.tambores_industria.id_articulo
"tambores_industria.id_articulo" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
