...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH lotes_aceite WHERE ~{&KEY-PHRASE} NO-LOCK, ~
    ...
    BY lotes_aceite.fecha DESCENDING ~
       BY lotes_aceite.id_lote DESCENDING.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      lotes_aceite.fecha FORMAT "99/99/9999"
      productos_terminados.descripcion
      lotes_aceite.citral FORMAT ">9.99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
