...
&Scoped-define INTERNAL-TABLES tipo_sucursales

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipo_sucursales.id_tipo_sucursal ~
tipo_sucursales.descripcion tipo_sucursales.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipo_sucursales WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipo_sucursales
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipo_sucursales
...
<FOREIGN-KEYS>
id_tipo_sucursal||y|comercial.tipo_sucursales.id_tipo_sucursal
abreviatura||y|comercial.tipo_sucursales.abreviatura
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_tipo_sucursal,abreviatura"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipo_sucursales.id_tipo_sucursal FORMAT ">9":U WIDTH 10.2
      tipo_sucursales.descripcion FORMAT "x(20)":U WIDTH 28.6
      tipo_sucursales.abreviatura FORMAT "X(12)":U WIDTH 16.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "comercial.tipo_sucursales"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > comercial.tipo_sucursales.id_tipo_sucursal
"id_tipo_sucursal" ? ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[2]   > comercial.tipo_sucursales.descripcion
"descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "28.6" yes no no "U" "" ""
     _FldNameList[3]   > comercial.tipo_sucursales.abreviatura
"abreviatura" ? ? "character" ? ? ? ? ? ? no ? no no "16.2" yes no no "U" "" ""
...
define sub-menu Ordena 
  menu-item tipo_sucursales-id_tipo_sucursal
label 'id_tipo_sucursal( tipo_sucursales ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_sucursales.id_tipo_sucursal').
                  run set-attribute-list('titulo=T/Sucursal').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_sucursales.id_tipo_sucursal
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_sucursales-descripcion
label 'descripcion( tipo_sucursales ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_sucursales.descripcion').
                  run set-attribute-list('titulo=Nombre').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_sucursales.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_sucursales-abreviatura
label 'abreviatura( tipo_sucursales ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_sucursales.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_sucursales.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipo_sucursales.id_tipo_sucursal
...
case p:
  WHEN 'tipo_sucursales.id_tipo_sucursal' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_sucursal = integer(valor)  no-lock no-error .
  WHEN 'tipo_sucursales.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'tipo_sucursales.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_sucursal" "tipo_sucursales" "id_tipo_sucursal"}
  {src/adm/template/sndkycas.i "abreviatura" "tipo_sucursales" "abreviatura"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tipo_sucursales"}
