...
DEFINE VARIABLE h_bc_destinatarios AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-2 AT ROW 1.71 COL 9
     SPACE(7.99) SKIP(2.71)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_destinatarios.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_destinatarios ).
       RUN set-position IN h_bc_destinatarios ( 2.19 , 13.00 ) NO-ERROR.
       RUN set-size IN h_bc_destinatarios ( 6.71 , 66.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_destinatarios ,
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE dame-tipo-contacto D-Dialog 
