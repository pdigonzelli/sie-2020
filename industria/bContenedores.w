...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_envio ~
rowObject.nro_contenedor rowObject.fecha_entrega 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.nro_contenedor FORMAT "X(20)":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_envio
     _FldNameList[2]   > _<SDO>.rowObject.nro_contenedor
"rowObject.nro_contenedor" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[3]   = _<SDO>.rowObject.fecha_entrega
