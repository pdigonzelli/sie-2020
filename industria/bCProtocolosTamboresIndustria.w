...
rowObject.id_articulo rowObject.anio rowObject.id_empresa ~
rowObject.id_sucursal rowObject.id_tipotambor rowObject.nromov ~
rowObject.id_lote 
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dcprotocolostamboresindustria.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[4]   = _<SDO>.rowObject.id_empresa
     _FldNameList[5]   = _<SDO>.rowObject.id_sucursal
     _FldNameList[6]   = _<SDO>.rowObject.id_tipotambor
     _FldNameList[7]   = _<SDO>.rowObject.nromov
     _FldNameList[8]   = _<SDO>.rowObject.id_lote
