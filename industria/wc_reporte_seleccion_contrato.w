...
&Scoped-Define ENABLED-OBJECTS BUTTON-3 RECT-2 
...
ON END-ERROR OF W-Win /* Reporte Contratos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reporte Contratos */
DO:
...
DO:
    ...
    run get-rowid1 in h_bc_contratos (output r).
  ...
  do:                  
        v_filtro = "contratos.id_contrato = '" + contratos.id_contrato + 
                   "' and contratos.id_tipo_contrato = " + string(contratos.id_tipo_contrato) +  
                   " and contratos.anio = " + string(year(contratos.fecha)).
                           
                           
         RUN  aderb\_prntrb2(
         "..\industria\reports.prl", /* RB-REPORT-LIBRARY */
         "parte_estado_contratos",                    /* RB-REPORT-NAME */
         "",                             /* RB-DB-CONNECTION */
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 95.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 118.00 ) NO-ERROR.
       ...
       RUN set-position IN h_bc_contratos ( 3.62 , 4.00 ) NO-ERROR.
       RUN set-size IN h_bc_contratos ( 6.43 , 139.00 ) NO-ERROR.

       /* Links to csmartbrowser h_bc_contratos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_bc_contratos ).
