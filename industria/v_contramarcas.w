...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES contramarcas
&Scoped-define FIRST-EXTERNAL-TABLE contramarcas


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR contramarcas.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS contramarcas.id_contramarca ~
contramarcas.descripcion contramarcas.abreviatura 
&Scoped-define ENABLED-TABLES contramarcas
&Scoped-define FIRST-ENABLED-TABLE contramarcas
&Scoped-define DISPLAYED-TABLES contramarcas
&Scoped-define FIRST-DISPLAYED-TABLE contramarcas
&Scoped-Define DISPLAYED-FIELDS contramarcas.id_contramarca ~
contramarcas.descripcion contramarcas.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS contramarcas.id_contramarca 
...
DEFINE FRAME F-Main
     contramarcas.id_contramarca AT ROW 1 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     contramarcas.descripcion AT ROW 2 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     contramarcas.abreviatura AT ROW 3 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.contramarcas
...
/* SETTINGS FOR FILL-IN contramarcas.id_contramarca IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME contramarcas.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL contramarcas.abreviatura V-table-Win 
ON LEAVE OF contramarcas.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME contramarcas.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL contramarcas.descripcion V-table-Win 
ON LEAVE OF contramarcas.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME contramarcas.id_contramarca
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL contramarcas.id_contramarca V-table-Win 
ON LEAVE OF contramarcas.id_contramarca IN FRAME F-Main /* Cod Contramarca */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "contramarcas"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "contramarcas"}
