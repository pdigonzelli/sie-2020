...
DEFINE VARIABLE h_b_quimicos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_quimicos AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Quimicos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Quimicos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_quimicos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_quimicos ).
       RUN set-position IN h_b_quimicos ( 3.62 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_quimicos ( 6.71 , 76.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_quimicos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_quimicos ).
       RUN set-position IN h_v_quimicos ( 11.24 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.05 , 72.80 ) */

       /* Links to csmartbrowser h_b_quimicos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_quimicos ).

       /* Links to SmartViewer h_v_quimicos. */
       RUN add-link IN adm-broker-hdl ( h_b_quimicos , 'Record':U , h_v_quimicos ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_quimicos ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_quimicos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_quimicos ,
             h_b_quimicos , 'AFTER':U ).
    END. /* Page 0 */
