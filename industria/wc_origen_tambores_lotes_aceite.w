...
&Scoped-Define ENABLED-OBJECTS BUTTON-1 BUTTON-2 RECT-4 
...
DEFINE VARIABLE h_bc_origen_tambores_lotes_aceit AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 20.05 COL 98
     BUTTON-2 AT ROW 20.05 COL 116
     RECT-4 AT ROW 19.57 COL 96
...
DO:
  ...
  run get-seleccion in h_bc_origen_tambores_lotes_aceit (output elegidos, output num).
  ...
  CASE choice:
    WHEN TRUE THEN /* Yes */ DO:
        DO i = 1 to num:
            ...
            APPLY "window-close" TO h_bc_origen_tambores_lotes_aceit. 
        END.      
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_origen_tambores_lotes_aceite.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_origen_tambores_lotes_aceit ).
       RUN set-position IN h_bc_origen_tambores_lotes_aceit ( 2.43 , 3.00 ) NO-ERROR.
       RUN set-size IN h_bc_origen_tambores_lotes_aceit ( 16.33 , 139.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_origen_tambores_lotes_aceit ,
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-1 BUTTON-2 RECT-4 
