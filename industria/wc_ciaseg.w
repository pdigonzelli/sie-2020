...
DEFINE VARIABLE h_b_ciaseg AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_ciaseg.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_ciaseg ).
       RUN set-position IN h_b_ciaseg ( 2.43 , 12.00 ) NO-ERROR.
       RUN set-size IN h_b_ciaseg ( 6.71 , 66.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_ciaseg ,
