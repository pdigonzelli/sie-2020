...
rowObject.anio rowObject.fecha rowObject.Clausula rowObject.Agencia ~
rowObject.cerrado rowObject.semana_embarque rowObject.contenedores 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.anio FORMAT "9999":U
      rowObject.fecha FORMAT "99/99/99":U
      rowObject.Clausula FORMAT "x(20)":U
      rowObject.Agencia FORMAT "x(25)":U
      rowObject.cerrado FORMAT "SI/NO":U
      rowObject.semana_embarque COLUMN-LABEL "Semana" FORMAT ">9":U
            WIDTH 8.6
      rowObject.contenedores FORMAT ">>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"rowObject.anio" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[4]   > _<SDO>.rowObject.Clausula
"rowObject.Clausula" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[5]   = _<SDO>.rowObject.Agencia
     _FldNameList[6]   > _<SDO>.rowObject.cerrado
"rowObject.cerrado" ? ? "logical" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[7]   > _<SDO>.rowObject.semana_embarque
"rowObject.semana_embarque" "Semana" ? "integer" ? ? ? ? ? ? no "?" no no "8.6" yes no no "U" "" ""
     _FldNameList[8]   = _<SDO>.rowObject.contenedores
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE onRowSelected bTableWin 
...
------------------------------------------------------------------------------*/
  ...
  IF VALID-HANDLE(hCont) AND hCont:FILE-NAME MATCHES "*wOEIndustria.w" THEN DO:
    RUN setTotals IN hCont.
  END.
