...
DEFINE VARIABLE h_b_r_gastos_agencias_clausulas AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_r_gastos_agencias_clausulas AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 11.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 45.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 68.80 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_r_gastos_agencias_clausulas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_r_gastos_agencias_clausulas ).
       RUN set-position IN h_b_r_gastos_agencias_clausulas ( 3.86 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_r_gastos_agencias_clausulas ( 6.71 , 96.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_r_gastos_agencias_clausulas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_r_gastos_agencias_clausulas ).
       RUN set-position IN h_v_r_gastos_agencias_clausulas ( 11.71 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.10 , 70.00 ) */

       /* Links to csmartbrowser h_b_r_gastos_agencias_clausulas. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_r_gastos_agencias_clausulas ).

       /* Links to SmartViewer h_v_r_gastos_agencias_clausulas. */
       RUN add-link IN adm-broker-hdl ( h_b_r_gastos_agencias_clausulas , 'Record':U , h_v_r_gastos_agencias_clausulas ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_r_gastos_agencias_clausulas ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_r_gastos_agencias_clausulas ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_r_gastos_agencias_clausulas ,
             h_b_r_gastos_agencias_clausulas , 'AFTER':U ).
    END. /* Page 0 */
