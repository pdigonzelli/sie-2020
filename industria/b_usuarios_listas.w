...
&Scoped-define INTERNAL-TABLES usuarios_listas listas_correos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table listas_correos.descripcion ~
usuarios_listas.id_usuario usuarios_listas.usuario 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH usuarios_listas WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH listas_correos OF usuarios_listas NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table usuarios_listas listas_correos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table usuarios_listas
...
<FOREIGN-KEYS>
id_lista|y|y|general.usuarios_listas.id_lista
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "id_lista",
     Keys-Supplied = "id_lista"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      listas_correos.descripcion
      usuarios_listas.id_usuario
      usuarios_listas.usuario
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 96 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.usuarios_listas,industria.listas_correos OF general.usuarios_listas"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.listas_correos.descripcion
     _FldNameList[2]   = general.usuarios_listas.id_usuario
     _FldNameList[3]   = general.usuarios_listas.usuario
...
define sub-menu Ordena 
  menu-item listas_correos-descripcion
label 'descripcion( listas_correos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=listas_correos.descripcion').
                  run set-attribute-list('titulo=Lista').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by listas_correos.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item usuarios_listas-id_usuario
label 'id_usuario( usuarios_listas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=usuarios_listas.id_usuario').
                  run set-attribute-list('titulo=CodUsuario').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by usuarios_listas.id_usuario
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item usuarios_listas-usuario
label 'usuario( usuarios_listas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=usuarios_listas.usuario').
                  run set-attribute-list('titulo=Nombre de Usuario').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by usuarios_listas.usuario
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by listas_correos.descripcion
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_lista':U THEN DO:
       &Scope KEY-PHRASE usuarios_listas.id_lista eq INTEGER(key-value)
       {&OPEN-QUERY-{&BROWSE-NAME}}
    END. /* id_lista */
    OTHERWISE DO:
...
case p:
  WHEN 'usuarios_listas.id_usuario' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_usuario = integer(valor)  no-lock no-error .
  WHEN 'usuarios_listas.usuario' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  usuario begins valor  no-lock no-error .
end.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_lista" "usuarios_listas" "id_lista"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "listas_correos"}
