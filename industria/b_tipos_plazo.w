...
&Scoped-define INTERNAL-TABLES tipos_plazo

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipos_plazo.id_tipo_plazo ~
tipos_plazo.descripcion tipos_plazo.descripcion_ingles 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_plazo WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipos_plazo
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_plazo
...
<FOREIGN-KEYS>
id_tipo_plazo||y|general.tipos_plazo.id_tipo_plazo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_plazo.id_tipo_plazo
      tipos_plazo.descripcion
      tipos_plazo.descripcion_ingles
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_plazo"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tipos_plazo.id_tipo_plazo
     _FldNameList[2]   = general.tipos_plazo.descripcion
     _FldNameList[3]   = general.tipos_plazo.descripcion_ingles
...
define sub-menu Ordena 
  menu-item tipos_plazo-id_tipo_plazo
label 'id_tipo_plazo( tipos_plazo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_plazo.id_tipo_plazo').
                  run set-attribute-list('titulo=Cod Tipo Plazo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_plazo.id_tipo_plazo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipos_plazo-descripcion
label 'descripcion( tipos_plazo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_plazo.descripcion').
                  run set-attribute-list('titulo=Tipo de Pazo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_plazo.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipos_plazo-descripcion_ingles
label 'descripcion_ingles( tipos_plazo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_plazo.descripcion_ingles').
                  run set-attribute-list('titulo=Tipos Plazos Ingles').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_plazo.descripcion_ingles
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipos_plazo.id_tipo_plazo
...
case p:
  WHEN 'tipos_plazo.id_tipo_plazo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_plazo = integer(valor)  no-lock no-error .
  WHEN 'tipos_plazo.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'tipos_plazo.descripcion_ingles' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_plazo" "tipos_plazo" "id_tipo_plazo"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tipos_plazo"}
