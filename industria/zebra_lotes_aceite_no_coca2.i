        ...
        */
        ...
        put control "^FO410,710^A0R,50,50^FD" string(tambores_industria.id_tambor,">>9") + "/" + string(total,">>9") "^FS".
        
        put control "^FO310,32^A0R,50,60^FD" "GROSS WEIGHT" "^FS".
        put control "^FO310,710^A0R,50,50^FD" string((round(tambores_industria.tara,2) + tambores_industria.kilos_tambor),"999.99") "^FS".
        ...
        put control "^FO120,710^A0R,50,50^FD" string(tambores_industria.kilos_tambor,"999.99") "^FS".
