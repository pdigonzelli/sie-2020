...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-21 
...
DEFINE FRAME D-Dialog
     ...
     RECT-21 AT ROW 1.95 COL 6
     SPACE(4.99) SKIP(2.23)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_aromas_sabores_prot ( 2.67 , 8.00 ) NO-ERROR.
       RUN set-size IN h_b_aromas_sabores_prot ( 6.71 , 75.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-21 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
