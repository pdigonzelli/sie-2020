...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.brix rowObject.pe ~
rowObject.solido_soluble 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.pe ~
rowObject.solido_soluble 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.brix
"brix" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.pe
"pe" ? ? "decimal" ? ? ? ? ? ? yes "?" no no ? yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.solido_soluble
"solido_soluble" ? ? "decimal" ? ? ? ? ? ? yes "?" no no ? yes no no "U" "" ""
