...
rowObject.Producto rowObject.Calidad rowObject.Envase rowObject.Origen ~
rowObject.Destino rowObject.tambor_desde rowObject.tambor_hasta ~
rowObject.id_sucursal_ubicacion_anterior ~
rowObject.id_sucursal_ubicacion_destino rowObject.id_ajuste 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Calidad FORMAT "x(20)":U
      Envase FORMAT "x(20)":U
      Origen FORMAT "x(15)":U
      Destino FORMAT "x(15)":U
      tambor_desde FORMAT ">>>,>>>,>>9":U
      tambor_hasta FORMAT ">>>,>>>,>>9":U
      id_sucursal_ubicacion_anterior FORMAT ">>,>>9":U
      id_sucursal_ubicacion_destino FORMAT ">>,>>9":U
      id_ajuste FORMAT "->,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = _<SDO>.rowObject.Producto
     _FldNameList[4]   = _<SDO>.rowObject.Calidad
     _FldNameList[5]   = _<SDO>.rowObject.Envase
     _FldNameList[6]   = _<SDO>.rowObject.Origen
     _FldNameList[7]   = _<SDO>.rowObject.Destino
     _FldNameList[8]   = _<SDO>.rowObject.tambor_desde
     _FldNameList[9]   = _<SDO>.rowObject.tambor_hasta
     _FldNameList[10]   = _<SDO>.rowObject.id_sucursal_ubicacion_anterior
     _FldNameList[11]   = _<SDO>.rowObject.id_sucursal_ubicacion_destino
     _FldNameList[12]   = _<SDO>.rowObject.id_ajuste
...
DO:
  ...
  ASSIGN rowObject.id_lote:BGCOLOR IN BROWSE br_table                         = ibgcolor
         ...
         rowObject.origen:BGCOLOR IN BROWSE br_table                          = ibgcolor
         rowObject.tambor_desde:BGCOLOR IN BROWSE br_table                    = ibgcolor
         rowObject.tambor_hasta:BGCOLOR IN BROWSE br_table                    = ibgcolor
         rowObject.id_sucursal_ubicacion_anterior:BGCOLOR IN BROWSE br_table  = ibgcolor
         rowObject.id_sucursal_ubicacion_destino:BGCOLOR IN BROWSE br_table   = ibgcolor
         rowObject.id_ajuste:BGCOLOR IN BROWSE br_table                       = ibgcolor
         .
END.
