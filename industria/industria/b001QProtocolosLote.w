...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_lote rowObject.Anio-2 ~
rowObject.id_protocolo rowObject.anio rowObject.id_articulo ~
rowObject.nromov 
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "d001qprotocoloslote.w"
   Allow: Basic,Browse
   Frames: 1
...
"id_lote" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.Anio-2
     _FldNameList[3]   > _<SDO>.rowObject.id_protocolo
