...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_arrastre ~
rowObject.Envase rowObject.cantidad rowObject.kilos_tambor ~
rowObject.volumen rowObject.fecha rowObject.nromov_arrastre 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_arrastre
     _FldNameList[2]   = _<SDO>.rowObject.Envase
     _FldNameList[3]   = _<SDO>.rowObject.cantidad
     _FldNameList[4]   = _<SDO>.rowObject.kilos_tambor
     _FldNameList[5]   = _<SDO>.rowObject.volumen
     _FldNameList[6]   = _<SDO>.rowObject.fecha
     _FldNameList[7]   = _<SDO>.rowObject.nromov_arrastre
