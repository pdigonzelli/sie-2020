...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.nro_lote ~
rowObject.desde_lote rowObject.hasta_lote rowObject.Articulo ~
rowObject.Calidad rowObject.FechaFact rowObject.nroFactura ~
rowObject.TipoComp rowObject.item rowObject.nro_contenedor ~
rowObject.nro_release rowObject.nromov rowObject.id_punto_venta ~
rowObject.impreso rowObject.c_fecha 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      nro_lote FORMAT "X(8)":U
      desde_lote FORMAT ">>>>>9":U
      hasta_lote FORMAT ">>>>>9":U
      Articulo FORMAT "x(20)":U
      Calidad FORMAT "x(20)":U
      FechaFact FORMAT "99/99/9999":U
      nroFactura FORMAT ">>>,>>>,>>9":U
      TipoComp FORMAT "x(8)":U
      item FORMAT ">>>9":U
      nro_contenedor FORMAT "X(18)":U
      nro_release FORMAT "X(15)":U
      nromov FORMAT "->,>>>,>>9":U
      id_punto_venta FORMAT ">>>9":U
      impreso FORMAT "x(8)":U
      c_fecha FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.nro_lote
"nro_lote" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.desde_lote
     _FldNameList[3]   = _<SDO>.rowObject.hasta_lote
     _FldNameList[4]   = _<SDO>.rowObject.Articulo
     _FldNameList[5]   = _<SDO>.rowObject.Calidad
     _FldNameList[6]   = _<SDO>.rowObject.FechaFact
     _FldNameList[7]   = _<SDO>.rowObject.nroFactura
     _FldNameList[8]   = _<SDO>.rowObject.TipoComp
     _FldNameList[9]   = _<SDO>.rowObject.item
     _FldNameList[10]   = _<SDO>.rowObject.nro_contenedor
     _FldNameList[11]   = _<SDO>.rowObject.nro_release
     _FldNameList[12]   = _<SDO>.rowObject.nromov
     _FldNameList[13]   = _<SDO>.rowObject.id_punto_venta
     _FldNameList[14]   = _<SDO>.rowObject.impreso
     _FldNameList[15]   = _<SDO>.rowObject.c_fecha
