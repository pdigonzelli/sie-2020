...
&Scoped-define INTERNAL-TABLES tipos_contactos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipos_contactos.id_tipo_contacto ~
tipos_contactos.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_contactos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipos_contactos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_contactos
...
<FOREIGN-KEYS>
id_tipo_contacto||y|general.tipos_contactos.id_tipo_contacto
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_contactos.id_tipo_contacto COLUMN-LABEL "Cod" FORMAT ">>9":U
            WIDTH 9.2
      tipos_contactos.descripcion FORMAT "X(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_contactos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.tipos_contactos.id_tipo_contacto
"id_tipo_contacto" "Cod" ? "integer" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" ""
     _FldNameList[2]   = general.tipos_contactos.descripcion
...
define sub-menu Ordena 
  menu-item tipos_contactos-id_tipo_contacto
label 'id_tipo_contacto( tipos_contactos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_contactos.id_tipo_contacto').
                  run set-attribute-list('titulo=CodTContacto').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_contactos.id_tipo_contacto
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipos_contactos-descripcion
label 'descripcion( tipos_contactos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_contactos.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_contactos.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipos_contactos.id_tipo_contacto
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_contacto" "tipos_contactos" "id_tipo_contacto"}
