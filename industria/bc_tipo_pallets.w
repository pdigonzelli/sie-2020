...
&Scoped-define INTERNAL-TABLES tipo_pallets

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipo_pallets.id_tipo_pallet ~
tipo_pallets.descripcion tipo_pallets.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipo_pallets WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipo_pallets
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipo_pallets
...
<FOREIGN-KEYS>
id_tipo_pallet||y|general.tipo_pallets.id_tipo_pallet
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_tipo_pallet"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipo_pallets.id_tipo_pallet FORMAT ">>9":U
      tipo_pallets.descripcion COLUMN-LABEL "Descripcion" FORMAT "X(30)":U
      tipo_pallets.abreviatura FORMAT "X(5)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipo_pallets"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tipo_pallets.id_tipo_pallet
     _FldNameList[2]   > general.tipo_pallets.descripcion
"descripcion" "Descripcion" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   = general.tipo_pallets.abreviatura
...
define sub-menu Ordena 
  menu-item tipo_pallets-id_tipo_pallet
label 'id_tipo_pallet( tipo_pallets ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_pallets.id_tipo_pallet').
                  run set-attribute-list('titulo=Tipo Pallet').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_pallets.id_tipo_pallet
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_pallets-descripcion
label 'descripcion( tipo_pallets ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_pallets.descripcion').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_pallets.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_pallets-abreviatura
label 'abreviatura( tipo_pallets ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_pallets.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_pallets.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipo_pallets.id_tipo_pallet
...
case p:
  WHEN 'tipo_pallets.id_tipo_pallet' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_pallet = integer(valor)  no-lock no-error .
  WHEN 'tipo_pallets.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'tipo_pallets.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_pallet" "tipo_pallets" "id_tipo_pallet"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tipo_pallets"}
