...
&Scoped-define INTERNAL-TABLES envases_prod r_productos_calidad_envase
...
envases_prod.descripcion envases_prod.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH envases_prod WHERE ~{&KEY-PHRASE} ~
      AND envases_prod.id_envase >= 500 ~
 AND envases_prod.id_envase < 600 NO-LOCK, ~
      EACH r_productos_calidad_envase OF envases_prod ~
      WHERE r_productos_calidad_envase.id_articulo = v_articulo ~
 AND r_productos_calidad_envase.id_calidad = v_calidad NO-LOCK ~
...
&Scoped-define SECOND-TABLE-IN-QUERY-br_table r_productos_calidad_envase
...
DEFINE QUERY br_table FOR 
      envases_prod, 
      r_productos_calidad_envase SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      envases_prod.abreviatura FORMAT "x(12)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.envases_prod,general.r_productos_calidad_envase OF general.envases_prod"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "general.envases_prod.id_envase >= 500
 AND general.envases_prod.id_envase < 600"
     _Where[2]         = "general.r_productos_calidad_envase.id_articulo = v_articulo
 AND general.r_productos_calidad_envase.id_calidad = v_calidad"
     _FldNameList[1]   = general.envases_prod.id_envase
     _FldNameList[2]   = general.envases_prod.descripcion
     _FldNameList[3]   = general.envases_prod.abreviatura
...
case p:
  ...
  WHEN 'envases_prod.abreviatura' then  
...
RUN dame-datos IN hcon(OUTPUT v_articulo,
                       OUTPUT v_calidad).
