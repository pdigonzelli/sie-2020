...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipo_contenedor
&Scoped-define FIRST-EXTERNAL-TABLE tipo_contenedor


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipo_contenedor.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipo_contenedor.id_tipo_contenedor ~
...
&Scoped-define FIELD-PAIRS~
 ...
 ~{&FP1}precio_thc ~{&FP2}precio_thc ~{&FP3}
&Scoped-define ENABLED-TABLES tipo_contenedor
&Scoped-define FIRST-ENABLED-TABLE tipo_contenedor
&Scoped-Define DISPLAYED-FIELDS tipo_contenedor.id_tipo_contenedor ~
tipo_contenedor.descripcion tipo_contenedor.precio_thc 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipo_contenedor.id_tipo_contenedor 
...
DEFINE FRAME F-Main
     tipo_contenedor.id_tipo_contenedor AT ROW 1 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     tipo_contenedor.descripcion AT ROW 2 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipo_contenedor.precio_thc AT ROW 3.14 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipo_contenedor
...
/* SETTINGS FOR FILL-IN tipo_contenedor.id_tipo_contenedor IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipo_contenedor.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipo_contenedor.descripcion V-table-Win
ON LEAVE OF tipo_contenedor.descripcion IN FRAME F-Main /* Contenedor */
DO:
...
&Scoped-define SELF-NAME tipo_contenedor.id_tipo_contenedor
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipo_contenedor.id_tipo_contenedor V-table-Win
ON LEAVE OF tipo_contenedor.id_tipo_contenedor IN FRAME F-Main /* Tipo de Contenedor */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tipo_contenedor.precio_thc
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipo_contenedor.precio_thc V-table-Win
ON LEAVE OF tipo_contenedor.precio_thc IN FRAME F-Main /* Precio THC */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipo_contenedor"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipo_contenedor"}
