...
&Scoped-define INTERNAL-TABLES porcentaje_reint_articulo ~
...
porcentaje_reint_articulo.id_porcentaje ~
porcentaje_reint_articulo.id_articulo productos_terminados.descripcion ~
porcentaje_reint_articulo.porcentaje 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH porcentaje_reint_articulo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH productos_terminados OF porcentaje_reint_articulo NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table porcentaje_reint_articulo ~
productos_terminados
&Scoped-define FIRST-TABLE-IN-QUERY-br_table porcentaje_reint_articulo
...
<FOREIGN-KEYS>
id_articulo||y|general.porcentaje_reint_articulo.id_articulo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      porcentaje_reint_articulo.id_porcentaje COLUMN-LABEL "CodPorc." FORMAT ">>9":U
            WIDTH 11.2
      porcentaje_reint_articulo.id_articulo COLUMN-LABEL "Art" FORMAT ">9":U
            WIDTH 8.4
      productos_terminados.descripcion COLUMN-LABEL "Articulo" FORMAT "x(30)":U
      porcentaje_reint_articulo.porcentaje COLUMN-LABEL "Porcentaje" FORMAT ">>9.99":U
            WIDTH 16.8
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 81 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.porcentaje_reint_articulo,general.productos_terminados OF general.porcentaje_reint_articulo"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.porcentaje_reint_articulo.id_porcentaje
"general.porcentaje_reint_articulo.id_porcentaje" "CodPorc." ? "integer" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[2]   > general.porcentaje_reint_articulo.id_articulo
"general.porcentaje_reint_articulo.id_articulo" "Art" ? "integer" ? ? ? ? ? ? no ? no no "8.4" yes no no "U" "" ""
...
"general.productos_terminados.descripcion" "Articulo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > general.porcentaje_reint_articulo.porcentaje
"general.porcentaje_reint_articulo.porcentaje" "Porcentaje" ? "decimal" ? ? ? ? ? ? no ? no no "16.8" yes no no "U" "" ""
...
define sub-menu Ordena 
  menu-item porcentaje_reint_articulo-id_porcentaje
label 'id_porcentaje( porcentaje_reint_articulo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=porcentaje_reint_articulo.id_porcentaje').
                  run set-attribute-list('titulo=CodPorcentaje').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by porcentaje_reint_articulo.id_porcentaje
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item porcentaje_reint_articulo-id_articulo
label 'id_articulo( porcentaje_reint_articulo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=porcentaje_reint_articulo.id_articulo').
                  run set-attribute-list('titulo=Articulo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by porcentaje_reint_articulo.id_articulo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'descripcion( productos_terminados ) '
  ...
  menu-item porcentaje_reint_articulo-porcentaje
label 'porcentaje( porcentaje_reint_articulo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=porcentaje_reint_articulo.porcentaje').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by porcentaje_reint_articulo.porcentaje
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by porcentaje_reint_articulo.id_porcentaje
...
case p:
  WHEN 'porcentaje_reint_articulo.id_porcentaje' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_porcentaje = integer(valor)  no-lock no-error .
  WHEN 'porcentaje_reint_articulo.id_articulo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_articulo = integer(valor)  no-lock no-error .
  WHEN 'porcentaje_reint_articulo.porcentaje' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  porcentaje = decimal(valor)  no-lock no-error .
end.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_articulo" "porcentaje_reint_articulo" "id_articulo"}
