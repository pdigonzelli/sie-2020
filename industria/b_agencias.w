...
&Scoped-define FIELDS-IN-QUERY-br_table agencias.id_agencia ~
agencias.descripcion agencias.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH agencias WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table agencias
&Scoped-define FIRST-TABLE-IN-QUERY-br_table agencias
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.agencias"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.agencias.id_agencia
...
define sub-menu Ordena 
  menu-item agencias-id_agencia
label 'id_agencia( agencias ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=agencias.id_agencia').
                  run set-attribute-list('titulo=Cod.Agencia').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by agencias.id_agencia
