...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-23 
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b_couriers ).
       RUN set-position IN h_b_couriers ( 2.43 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-23 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
