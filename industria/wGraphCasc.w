...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD getLotesSucursal wWin  _DB-REQUIRED
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Informacion Modulo Cascara"
         HEIGHT             = 15.62
         WIDTH              = 138.4
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
/* CtrlFrame-2 OCXINFO:CREATE-CONTROL from: {827E9F50-96A4-11CF-823E-000021570103} type: Graph */
      CtrlFrame:MOVE-BEFORE(BUTTON-2:HANDLE IN FRAME fMain).
...
ON END-ERROR OF wWin /* Informacion Modulo Cascara */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Informacion Modulo Cascara */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dlotescascara ( 14.57 , 62.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dloteubicacion ( 14.57 , 79.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
...
OCXFile = SEARCH( "wGraphCasc.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "wGraphCasc.wrx":U SKIP(1)
