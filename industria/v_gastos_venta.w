...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES gastos_venta
&Scoped-define FIRST-EXTERNAL-TABLE gastos_venta


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR gastos_venta.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS gastos_venta.id_gasto ~
gastos_venta.descripcion gastos_venta.abreviatura 
&Scoped-define ENABLED-TABLES gastos_venta
&Scoped-define FIRST-ENABLED-TABLE gastos_venta
&Scoped-define DISPLAYED-TABLES gastos_venta
&Scoped-define FIRST-DISPLAYED-TABLE gastos_venta
&Scoped-Define DISPLAYED-FIELDS gastos_venta.id_gasto ~
gastos_venta.descripcion gastos_venta.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS gastos_venta.id_gasto 
...
DEFINE FRAME F-Main
     gastos_venta.id_gasto AT ROW 1 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     gastos_venta.descripcion AT ROW 2 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     gastos_venta.abreviatura AT ROW 3 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.gastos_venta
...
/* SETTINGS FOR FILL-IN gastos_venta.id_gasto IN FRAME F-Main
   1                                                                    */
...
general.gastos_venta.id_clausula;wc_clausulas.w;clausulas.descripcion;;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME gastos_venta.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gastos_venta.abreviatura V-table-Win
ON LEAVE OF gastos_venta.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME gastos_venta.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gastos_venta.descripcion V-table-Win
ON LEAVE OF gastos_venta.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME gastos_venta.id_gasto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gastos_venta.id_gasto V-table-Win
ON LEAVE OF gastos_venta.id_gasto IN FRAME F-Main /* Codigo Gasto */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "gastos_venta"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "gastos_venta"}
