...
permisos_embarque.fecha_oficializacion permisos_embarque.fecha_envio_tuc 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH permisos_embarque WHERE ~{&KEY-PHRASE} ~
      AND permisos_embarque.tipo_pe = 1 NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      aduanas.descripcion FORMAT "X(20)":U
      ...
      permisos_embarque.id_orden_entrega FORMAT ">>>>9":U
      permisos_embarque.item_oe COLUMN-LABEL "ParteOE" FORMAT ">>>9":U
            WIDTH 10.4
      permisos_embarque.rectificado COLUMN-LABEL "Rect." FORMAT "Si/No":U
      permisos_embarque.fecha_oficializacion FORMAT "99/99/99":U
      permisos_embarque.fecha_envio_tuc FORMAT "99/99/99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "general.permisos_embarque.tipo_pe = 1"
...
"general.aduanas.descripcion" ? "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > general.permisos_embarque.id_permiso_embarque
"general.permisos_embarque.id_permiso_embarque" ? "XXXX 999999 X" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   = general.permisos_embarque.fecha
     _FldNameList[6]   > general.permisos_embarque.importe
"general.permisos_embarque.importe" ? "->,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[7]   > general.permisos_embarque.id_orden_entrega
"general.permisos_embarque.id_orden_entrega" ? ">>>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[8]   > general.permisos_embarque.item_oe
"general.permisos_embarque.item_oe" "ParteOE" ? "integer" ? ? ? ? ? ? no ? no no "10.4" yes no no "U" "" ""
     _FldNameList[9]   > general.permisos_embarque.rectificado
"general.permisos_embarque.rectificado" "Rect." ? "logical" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[10]   = general.permisos_embarque.fecha_oficializacion
     _FldNameList[11]   = general.permisos_embarque.fecha_envio_tuc
