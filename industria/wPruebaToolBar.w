...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dreleasedelivery ( 14.57 , 15.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_vreleasedelivery ( 3.62 , 7.00 ) NO-ERROR.
       ...
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 67.60 ) NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE btnChoose wWin 
PROCEDURE btnChoose :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
MESSAGE "Funciona!!!" VIEW-AS ALERT-BOX.
...
------------------------------------------------------------------------------*/
  ...
  DYNAMIC-FUNCTION('enableActions' IN h_dyntoolbar, "ActionName").
  SUBSCRIBE TO "btnChoose" IN h_dyntoolbar.

  DYNAMIC-FUNCTION('enableActions' IN h_dyntoolbar, "ActionName2").
  SUBSCRIBE TO "btnChoose2" IN h_dyntoolbar.
