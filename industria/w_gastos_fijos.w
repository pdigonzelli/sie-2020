...
DEFINE VARIABLE h_b_gastos_fijos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_gastos_fijos AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Gastos fijos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Gastos fijos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_gastos_fijos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_gastos_fijos ).
       RUN set-position IN h_b_gastos_fijos ( 3.86 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 99.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_gastos_fijos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_gastos_fijos ).
       RUN set-position IN h_v_gastos_fijos ( 11.48 , 26.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.00 , 50.00 ) */

       /* Links to csmartbrowser h_b_gastos_fijos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_gastos_fijos ).

       /* Links to SmartViewer h_v_gastos_fijos. */
       RUN add-link IN adm-broker-hdl ( h_b_gastos_fijos , 'Record':U , h_v_gastos_fijos ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_gastos_fijos ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_gastos_fijos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_gastos_fijos ,
             h_b_gastos_fijos , 'AFTER':U ).
    END. /* Page 0 */
