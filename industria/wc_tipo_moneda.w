...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-1 aceptar salir 
...
DEFINE VARIABLE h_bc_tipo_moneda AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_tipo_moneda.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_tipo_moneda ).
       RUN set-position IN h_bc_tipo_moneda ( 2.43 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_tipo_moneda ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-6 RECT-1 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
