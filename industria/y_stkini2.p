...
{s_priini.i
   ...
   &footing       = "s_nada.foo"
      ...
      */
for each tipostambor where id_tipotambor = 2 no-lock:
for each productos_terminados where 
/* productos_terminados.id_articulo = 52 and         */
 ...
 for each btam where 
    ...
    btam.id_tipotambor     = tipostambor.id_tipotambor 
/*    and btam.id_lote = 608 and btam.anio = 2003 */
...
procedure genera_movimiento.
 /*---- Creacion de Movimientos de Stock -----*/
        ...
        movimientos_tambores.id_sucursal        = vsuc
        movimientos_tambores.id_suc_origen      = vsuc
        movimientos_tambores.id_suc_des         = vsuc
        movimientos_tambores.id_tipotambor      = btam.id_tipotambor                   movimientos_tambores.id_tipo_movimiento = 100
