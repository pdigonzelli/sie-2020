...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES vapores
&Scoped-define FIRST-EXTERNAL-TABLE vapores


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR vapores.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS vapores.id_vapor vapores.descripcion ~
vapores.abreviatura 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_vapor ~{&FP2}id_vapor ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}~
 ~{&FP1}abreviatura ~{&FP2}abreviatura ~{&FP3}
&Scoped-define ENABLED-TABLES vapores
&Scoped-define FIRST-ENABLED-TABLE vapores
&Scoped-Define DISPLAYED-FIELDS vapores.id_vapor vapores.descripcion ~
vapores.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS vapores.id_vapor 
...
DEFINE FRAME F-Main
     vapores.id_vapor AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     vapores.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     vapores.abreviatura AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: comercial.vapores
...
/* SETTINGS FOR FILL-IN vapores.id_vapor IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME vapores.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL vapores.abreviatura V-table-Win
ON LEAVE OF vapores.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME vapores.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL vapores.descripcion V-table-Win
ON LEAVE OF vapores.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME vapores.id_vapor
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL vapores.id_vapor V-table-Win
ON LEAVE OF vapores.id_vapor IN FRAME F-Main /* Vapor */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "vapores"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "vapores"}
