...
&Scoped-Define ENABLED-FIELDS items_contratos.precio_origen ~
...
&Scoped-Define DISPLAYED-FIELDS items_contratos.precio_origen ~
items_contratos.id_moneda_origen ~
items_contratos.id_tipo_unidad_venta_origen 
&Scoped-define DISPLAYED-TABLES items_contratos
&Scoped-define FIRST-DISPLAYED-TABLE items_contratos
&Scoped-Define DISPLAYED-OBJECTS fi-tipo_moneda-descripcion ~
fi-tipo_unidad_venta-descripcio 
...
DEFINE FRAME F-Main
     items_contratos.precio_origen AT ROW 1 COL 15 COLON-ALIGNED
          LABEL "Precio Venta"
          VIEW-AS FILL-IN 
          SIZE 21 BY 1
     items_contratos.id_moneda_origen AT ROW 1 COL 63 COLON-ALIGNED
          LABEL "Moneda"
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     fi-tipo_moneda-descripcion AT ROW 1 COL 75 COLON-ALIGNED NO-LABEL
     items_contratos.id_tipo_unidad_venta_origen AT ROW 1.95 COL 63 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     fi-tipo_unidad_venta-descripcio AT ROW 1.95 COL 75 COLON-ALIGNED NO-LABEL
...
/* SETTINGS FOR FILL-IN fi-tipo_unidad_venta-descripcio IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN items_contratos.id_moneda_origen IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN items_contratos.precio_origen IN FRAME F-Main
   EXP-LABEL                                                            */
...
general.items_contratos.id_moneda_origen;wc_tipo_moneda.w;tipo_moneda.descripcion;id_moneda;
general.items_contratos.id_tipo_unidad_venta_origen;wc_tipo_unidad_venta.w;tipo_unidad_venta.descripcion;id_tipo_unidad_venta;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME items_contratos.id_moneda_origen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.id_moneda_origen V-table-Win
ON GO OF items_contratos.id_moneda_origen IN FRAME F-Main /* Moneda */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.id_moneda_origen V-table-Win
ON LEAVE OF items_contratos.id_moneda_origen IN FRAME F-Main /* Moneda */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.id_moneda_origen V-table-Win
ON MOUSE-SELECT-DBLCLICK OF items_contratos.id_moneda_origen IN FRAME F-Main /* Moneda */
do: 
...
general.items_contratos.id_moneda_origen:screen-value = string(tipo_moneda.id_moneda).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.id_moneda_origen V-table-Win
ON U1 OF items_contratos.id_moneda_origen IN FRAME F-Main /* Moneda */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&Scoped-define SELF-NAME items_contratos.id_tipo_unidad_venta_origen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.id_tipo_unidad_venta_origen V-table-Win
ON GO OF items_contratos.id_tipo_unidad_venta_origen IN FRAME F-Main /* Unidad Venta */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.id_tipo_unidad_venta_origen V-table-Win
ON LEAVE OF items_contratos.id_tipo_unidad_venta_origen IN FRAME F-Main /* Unidad Venta */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.id_tipo_unidad_venta_origen V-table-Win
ON MOUSE-SELECT-DBLCLICK OF items_contratos.id_tipo_unidad_venta_origen IN FRAME F-Main /* Unidad Venta */
do: 
define var r as rowid no-undo.
...
general.items_contratos.id_tipo_unidad_venta_origen:screen-value = string(tipo_unidad_venta.id_tipo_unidad_venta).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.id_tipo_unidad_venta_origen V-table-Win
ON U1 OF items_contratos.id_tipo_unidad_venta_origen IN FRAME F-Main /* Unidad Venta */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&Scoped-define SELF-NAME items_contratos.precio_origen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL items_contratos.precio_origen V-table-Win
ON LEAVE OF items_contratos.precio_origen IN FRAME F-Main /* Precio Venta */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE actualizo_campos V-table-Win 
PROCEDURE actualizo_campos :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
/* display items_contrato.precio_venta with frame F-Main.
display items_contrato.precio_origen with frame F-Main. */
END PROCEDURE.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
assign items_contratos.precio_venta = decimal(items_contratos.precio_origen:screen-value in frame F-Main).
...
find first tipo_moneda where tipo_moneda.id_moneda = integer(items_contratos.id_moneda_origen:screen-value in frame F-Main)  no-lock no-error .
if available tipo_moneda then 
...
find first tipo_unidad_venta where tipo_unidad_venta.id_tipo_unidad_venta = integer(items_contratos.id_tipo_unidad_venta_origen:screen-value in frame F-Main)  no-lock no-error .
if available tipo_unidad_venta then 
...
define var lista_relacion as character no-undo initial "id_moneda_origen,id_tipo_unidad_venta_origen".
