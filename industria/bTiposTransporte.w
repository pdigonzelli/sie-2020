...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_tipo_transporte ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_tipo_transporte FORMAT "->,>>>,>>9":U
      descripcion FORMAT "X(30)":U
      abreviatura FORMAT "X(15)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dTiposTransporte.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_tipo_transporte
"id_tipo_transporte" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
