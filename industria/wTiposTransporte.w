...
DEFINE VARIABLE h_btipostransporte AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dtipostransporte AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vtipotransporte AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Tipos de Transporte */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Tipos de Transporte */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dtipostransporte ( 14.81 , 69.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'btipostransporte.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'ScrollRemotenoNumDown0CalcWidthnoMaxWidth80FetchOnReposToEndyesDataSourceNamesUpdateTargetNamesLogicalObjectNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_btipostransporte ).
       RUN repositionObject IN h_btipostransporte ( 2.43 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_btipostransporte ( 9.52 , 79.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vtipotransporte.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_vtipotransporte ).
       RUN repositionObject IN h_vtipotransporte ( 12.91 , 8.00 ) NO-ERROR.
       /* Size in AB:  ( 3.19 , 62.60 ) */
       ...
       /* Links to SmartDataObject h_dtipostransporte. */
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dtipostransporte ).

       /* Links to SmartDataBrowser h_btipostransporte. */
       RUN addLink ( h_dtipostransporte , 'Data':U , h_btipostransporte ).

       /* Links to SmartDataViewer h_vtipotransporte. */
       RUN addLink ( h_dtipostransporte , 'Data':U , h_vtipotransporte ).
       RUN addLink ( h_vtipotransporte , 'Update':U , h_dtipostransporte ).
       RUN addLink ( h_dyntoolbar , 'TableIo':U , h_vtipotransporte ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_btipostransporte ,
             h_dyntoolbar , 'AFTER':U ).
       RUN adjustTabOrder ( h_vtipotransporte ,
             h_btipostransporte , 'AFTER':U ).
    END. /* Page 0 */
