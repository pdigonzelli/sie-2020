...
rowObject.contratoCliente rowObject.anio 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      contratoCliente FORMAT "x(50)":U
      anio FORMAT "9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS NO-COLUMN-SCROLLING SEPARATORS SIZE 66 BY 3.33 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   > _<SDO>.rowObject.contratoCliente
"contratoCliente" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
