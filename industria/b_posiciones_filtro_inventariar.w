...
define var v_emp as integer.
define var v_suc as integer.
define var v_loc as integer.
...
&Scoped-define INTERNAL-TABLES posiciones

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table posiciones.id_posicion ~
posiciones.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH posiciones WHERE ~{&KEY-PHRASE} ~
      AND posiciones.id_empresa = v_emp ~
 AND posiciones.id_sucursal = v_suc ~
 AND posiciones.id_locacion = v_loc NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table posiciones
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.posiciones"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "general.posiciones.id_empresa = v_emp
 AND general.posiciones.id_sucursal = v_suc
 AND general.posiciones.id_locacion = v_loc"
     _FldNameList[1]   = general.posiciones.id_posicion
     _FldNameList[2]   = general.posiciones.descripcion
...
run dame-parametros in hcon (output v_emp, output v_suc, output v_loc).
