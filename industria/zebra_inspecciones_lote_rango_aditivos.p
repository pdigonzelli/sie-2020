...
do:
  ...
  cZebraPrinter = "\\192.168.1.104\ibm4400".
        ...
        for each tambores_industria where tambores_industria.id_empresa = lotes_jugo.id_empresa 
                                      ...
                                      and tambores_industria.id_tambor <= p_tam_hasta
                                    no-lock
                                    by id_tambor desc.
/**********************************************************************************************************/
/*****************GENERO LA ETIQUETA NUMERO CERO***********************************************************/
            ...
            do:  
                ...
                find FIRST r_productos_calidad where r_productos_calidad.id_calidad = lotes_jugo.id_calidad
          ...
          if available inspecciones_lote then
           do:                                     
            ...
            ELSE DO: /*claro*/           
              ...
              put control "^FO030,920^A0N,20,25^FD" "Sodium Metabisulphite" "^FS".
