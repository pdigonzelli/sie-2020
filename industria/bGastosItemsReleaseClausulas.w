...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_clausula ~
rowObject.id_gasto rowObject.descripcion rowObject.descripcion-2 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_clausula FORMAT ">>9":U
      id_gasto FORMAT ">>9":U
      descripcion FORMAT "X(30)":U
      descripcion-2 FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 104 BY 6.67 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dgastositemsreleaseclausulas.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_clausula
     _FldNameList[2]   = _<SDO>.rowObject.id_gasto
     _FldNameList[3]   = _<SDO>.rowObject.descripcion
     _FldNameList[4]   > _<SDO>.rowObject.descripcion-2
"descripcion-2" ? ? "character" ? ? ? ? ? ? no ? no no "46" yes no no "U" "" ""
