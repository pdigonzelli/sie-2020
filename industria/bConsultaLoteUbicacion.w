...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_lote rowObject.lote ~
rowObject.id_sucursal rowObject.id_sucursal_ubicacion ~
rowObject.id_tipotambor rowObject.cantidad rowObject.id_articulo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.lote FORMAT "XXXXXXX/XXXX":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[4]   = _<SDO>.rowObject.id_sucursal_ubicacion
     _FldNameList[5]   = _<SDO>.rowObject.id_tipotambor
     _FldNameList[6]   = _<SDO>.rowObject.cantidad
     _FldNameList[7]   = _<SDO>.rowObject.id_articulo
