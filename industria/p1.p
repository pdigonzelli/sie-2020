...
DEFINE VAR v_precio_fob AS DECIMAL DECIMALS 10 FORMAT "->>>,>>>,>>9.9999".
DEFINE VAR v_precio     AS DECIMAL DECIMALS 10 FORMAT "->>>,>>>,>>9.9999".
...
FOR EACH contratos WHERE id_contrato = "152B-092002" 
    ...
    FOR EACH items_contratos OF contratos NO-LOCK.
            ...
            FOR EACH r_gastos_items_contrato OF items_contratos NO-LOCK.
                case r_gastos_items_contrato.id_tipo_unidad_venta:
                    ...
                    when 3 then /* GALONES */                    
                        do:
                            v_gastos = v_gastos + r_gastos_items_contrato.importe * 53.6 / 250.                                
                        end.
                    when 4 then /* LIBRAS */
                        do:
            ...
            v_precio_fob = items_contratos.precio_origen.
              ...
              /* PARA CALCULAR LOS IMPORTE DE CONTRATO */
                    case items_contratos.id_tipo_unidad_venta_origen:
                        ...
                        when 3 then /* GALONES */                    
                            do:
                                v_precio = items_contratos.precio_origen * 53.6 / 250.                                
                                v_precio_fob = v_precio_fob * 53.6 / 250.                                
                            end.
                        when 4 then /* LIBRAS */
                            do:
                ...
                v_fob_ton = 0.
                v_lotes_contrato = "".  
                FOR EACH orden_entrega OF items_contratos WHERE fob_ton > 0 NO-LOCK.
                    v_fob_ton = v_fob_ton + orden_entrega.fob_ton.
 ...
 /*          
          CASE items_contratos.id_tipo_unidad_venta_origen:
               when 3 then /* GALONES */                    
                   do:
                       v_importe_contrato = items_contratos.cantidad * v_precio.
                       v_importe_contrato_fob = items_contratos.cantidad * v_precio_fob.
                   end.
               OTHERWISE DO:
     ...
     /*       DISP v_precio_fob v_precio v_gastos.*/
...
/*
OUTPUT TO c:\temp\X.txt.
FOR EACH re_cial_completo.
    EXPORT DELIMITER re_cial_completo.
END.
OUTPUT CLOSE. */
