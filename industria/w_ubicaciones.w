...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-19 
...
ON END-ERROR OF W-Win /* Ubicaciones */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ubicaciones */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_ubicaciones ( 3.67 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 90.00 ) */
       ...
       RUN set-position IN h_v_ubicaciones ( 11.29 , 6.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_ubicaciones ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_ubicaciones ,
             h_b_ubicaciones , 'AFTER':U ).
    END. /* Page 0 */
