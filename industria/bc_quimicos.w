...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH LEGAJO WHERE ~{&KEY-PHRASE} ~
      AND LEGAJO.p-codi = 130  ~
or LEGAJO.p-codi = 144 ~
or LEGAJO.p-codi = 51 ~
or LEGAJO.p-codi = 145 NO-LOCK ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "comercial.LEGAJO.p-codi = 130 
or comercial.LEGAJO.p-codi = 144
or comercial.LEGAJO.p-codi = 51
or comercial.LEGAJO.p-codi = 145"
...
run dame-rowid in hcontainer (output v1).
