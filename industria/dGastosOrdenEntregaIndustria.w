...
&Scoped-Define DATA-FIELDS  id_gasto id_orden_entrega importe descripcion
...
&Scoped-Define DATA-FIELD-DEFS "dgastosordenentregaindustria.i"
&Scoped-define QUERY-STRING-Query-Main FOR EACH gastos_orden_entrega NO-LOCK, ~
      EACH gastos_venta OF gastos_orden_entrega NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gastos_orden_entrega NO-LOCK, ~
      EACH gastos_venta OF gastos_orden_entrega NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main gastos_orden_entrega gastos_venta
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "general.gastos_orden_entrega,industria.gastos_venta OF general.gastos_orden_entrega"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   > general.gastos_orden_entrega.id_gasto
"id_gasto" "id_gasto" ? ? "integer" ? ? ? ? ? ? yes ? no 7.8 yes
     _FldNameList[2]   > general.gastos_orden_entrega.id_orden_entrega
...
"importe" "importe" ? ? "decimal" ? ? ? ? ? ? yes ? no 13.2 yes
     _FldNameList[4]   > general.gastos_venta.descripcion
...
FOR EACH RowObjUpd WHERE RowObjUpd.RowMod = "A" OR RowObjUpd.RowMod = "C".
    ...
    RowObjUpd.changedFields = RowObjUpd.changedFields + ",id_orden_entrega".
