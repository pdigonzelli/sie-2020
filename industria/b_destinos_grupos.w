...
&Scoped-define INTERNAL-TABLES destinos_grupo

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table destinos_grupo.id_destino_grupo ~
destinos_grupo.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH destinos_grupo WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table destinos_grupo
&Scoped-define FIRST-TABLE-IN-QUERY-br_table destinos_grupo
...
<FOREIGN-KEYS>
id_destino_grupo||y|comercial.destinos_grupo.id_destino_grupo
abreviatura||y|comercial.destinos_grupo.abreviatura
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_destino_grupo,abreviatura"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      destinos_grupo.id_destino_grupo
      destinos_grupo.descripcion
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "comercial.destinos_grupo"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = comercial.destinos_grupo.id_destino_grupo
     _FldNameList[2]   = comercial.destinos_grupo.descripcion
...
define sub-menu Ordena 
  menu-item destinos_grupo-id_destino_grupo
label 'id_destino_grupo( destinos_grupo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=destinos_grupo.id_destino_grupo').
                  run set-attribute-list('titulo=Grupo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by destinos_grupo.id_destino_grupo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item destinos_grupo-descripcion
label 'descripcion( destinos_grupo ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=destinos_grupo.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by destinos_grupo.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by destinos_grupo.id_destino_grupo
...
case p:
  WHEN 'destinos_grupo.id_destino_grupo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_destino_grupo = integer(valor)  no-lock no-error .
  WHEN 'destinos_grupo.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_destino_grupo" "destinos_grupo" "id_destino_grupo"}
  {src/adm/template/sndkycas.i "abreviatura" "destinos_grupo" "abreviatura"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "destinos_grupo"}
