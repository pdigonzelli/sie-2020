...
&Scoped-define FIELDS-IN-QUERY-br_table items_orden_entrega.item_oe ~
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.items_orden_entrega OF general.orden_entrega"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.items_orden_entrega.item_oe
"items_orden_entrega.item_oe" "ParteOE" ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[2]   > general.items_orden_entrega.fecha
"items_orden_entrega.fecha" ? ? "date" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[3]   > general.items_orden_entrega.semana_entrega
"items_orden_entrega.semana_entrega" "Sem" ? "integer" ? ? ? ? ? ? no ? no no "6.8" yes no no "U" "" ""
     _FldNameList[4]   > general.items_orden_entrega.tambores_pedidos
"items_orden_entrega.tambores_pedidos" ? ? "integer" ? ? ? ? ? ? no ? no no "11.6" yes no no "U" "" ""
     _FldNameList[5]   > general.items_orden_entrega.cantidad_tambores
"items_orden_entrega.cantidad_tambores" "TambAsig" ? "integer" ? ? ? ? ? ? no ? no no "11.6" yes no no "U" "" ""
     _FldNameList[6]   > general.items_orden_entrega.kgs_netos_tambores
"items_orden_entrega.kgs_netos_tambores" ? ? "decimal" ? ? ? ? ? ? no ? no no "16.8" yes no no "U" "" ""
     _FldNameList[7]   > general.items_orden_entrega.total_factura
