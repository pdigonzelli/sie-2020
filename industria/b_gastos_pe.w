...
&Scoped-define FIELDS-IN-QUERY-br_table gastos_venta.descripcion ~
r_gastos_permiso_embarque.importe 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH r_gastos_permiso_embarque OF permisos_embarque WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH gastos_venta OF r_gastos_permiso_embarque NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH r_gastos_permiso_embarque OF permisos_embarque WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH gastos_venta OF r_gastos_permiso_embarque NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table r_gastos_permiso_embarque ~
gastos_venta
&Scoped-define FIRST-TABLE-IN-QUERY-br_table r_gastos_permiso_embarque
...
<FOREIGN-KEYS>
id_gasto||y|general.r_gastos_permiso_embarque.id_gasto
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      gastos_venta.descripcion COLUMN-LABEL "Gastos" FORMAT "X(12)":U
            WIDTH 14.2
      r_gastos_permiso_embarque.importe FORMAT "->,>>>,>>9.99":U
            WIDTH 11.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 39 BY 5.71
         BGCOLOR 15 FGCOLOR 1 FONT 0 ROW-HEIGHT-CHARS .62.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.r_gastos_permiso_embarque OF general.permisos_embarque,industria.gastos_venta OF general.r_gastos_permiso_embarque"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.gastos_venta.descripcion
"gastos_venta.descripcion" "Gastos" "X(12)" "character" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" ""
     _FldNameList[2]   > general.r_gastos_permiso_embarque.importe
"r_gastos_permiso_embarque.importe" ? "->,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "11.4" yes no no "U" "" ""
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_gasto" "r_gastos_permiso_embarque" "id_gasto"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "r_gastos_permiso_embarque"}
