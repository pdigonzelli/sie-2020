...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.item rowObject.id_gasto ~
rowObject.abreviatura rowObject.importe 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.id_gasto FORMAT ">>9":U WIDTH 5.4
      rowObject.abreviatura FORMAT "X(10)":U
      rowObject.importe FORMAT ">>>,>>>,>>9.9999":U WIDTH 15
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"rowObject.id_gasto" ? ? "integer" ? ? ? ? ? ? no ? no no "5.4" yes no no "U" "" ""
     _FldNameList[3]   = _<SDO>.rowObject.abreviatura
     _FldNameList[4]   > _<SDO>.rowObject.importe
"rowObject.importe" ? ? "decimal" ? ? ? ? ? ? no ? no no "15" yes no no "U" "" ""
