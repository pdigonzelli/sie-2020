...
&Scoped-define INTERNAL-TABLES estados_oe

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table estados_oe.id_estado ~
estados_oe.descripcion estados_oe.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH estados_oe WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table estados_oe
&Scoped-define FIRST-TABLE-IN-QUERY-br_table estados_oe
...
<FOREIGN-KEYS>
id_estado||y|general.estados_oe.id_estado
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      estados_oe.id_estado
      estados_oe.descripcion
      estados_oe.abreviatura
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.estados_oe"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.estados_oe.id_estado
     _FldNameList[2]   = general.estados_oe.descripcion
     _FldNameList[3]   = general.estados_oe.abreviatura
...
define sub-menu Ordena 
  menu-item estados_oe-id_estado
label 'id_estado( estados_oe ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=estados_oe.id_estado').
                  run set-attribute-list('titulo=Cod.Estado').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by estados_oe.id_estado
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item estados_oe-descripcion
label 'descripcion( estados_oe ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=estados_oe.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by estados_oe.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item estados_oe-abreviatura
label 'abreviatura( estados_oe ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=estados_oe.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by estados_oe.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by estados_oe.id_estado
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_estado" "estados_oe" "id_estado"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "estados_oe"}
