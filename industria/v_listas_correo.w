...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES listas_correos
&Scoped-define FIRST-EXTERNAL-TABLE listas_correos


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR listas_correos.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS listas_correos.id_lista ~
listas_correos.descripcion 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_lista ~{&FP2}id_lista ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}
&Scoped-define ENABLED-TABLES listas_correos
&Scoped-define FIRST-ENABLED-TABLE listas_correos
&Scoped-Define DISPLAYED-FIELDS listas_correos.id_lista ~
listas_correos.descripcion 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS listas_correos.id_lista 
...
DEFINE FRAME F-Main
     listas_correos.id_lista AT ROW 1 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     listas_correos.descripcion AT ROW 2 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.listas_correos
...
/* SETTINGS FOR FILL-IN listas_correos.id_lista IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME listas_correos.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL listas_correos.descripcion V-table-Win
ON LEAVE OF listas_correos.descripcion IN FRAME F-Main /* Lista */
DO:
...
&Scoped-define SELF-NAME listas_correos.id_lista
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL listas_correos.id_lista V-table-Win
ON LEAVE OF listas_correos.id_lista IN FRAME F-Main /* CodLista */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "listas_correos"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "listas_correos"}
