...
DEFINE VARIABLE h_b_contramarcas AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_contramarcas AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Contramarcas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Contramarcas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_contramarcas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_contramarcas ).
       RUN set-position IN h_b_contramarcas ( 3.86 , 8.00 ) NO-ERROR.
       RUN set-size IN h_b_contramarcas ( 6.71 , 67.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_contramarcas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_contramarcas ).
       RUN set-position IN h_v_contramarcas ( 11.48 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 52.00 ) */

       /* Links to csmartbrowser h_b_contramarcas. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_contramarcas ).

       /* Links to SmartViewer h_v_contramarcas. */
       RUN add-link IN adm-broker-hdl ( h_b_contramarcas , 'Record':U , h_v_contramarcas ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_contramarcas ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_contramarcas ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_contramarcas ,
             h_b_contramarcas , 'AFTER':U ).
    END. /* Page 0 */
