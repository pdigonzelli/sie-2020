...
&Scoped-Define ENABLED-FIELDS RowObject.id_material_sap ~
RowObject.descripcion_sap 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define DISPLAYED-FIELDS RowObject.id_material_sap ~
RowObject.descripcion_sap 
...
DEFINE FRAME F-Main
     RowObject.id_material_sap AT ROW 1 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     RowObject.descripcion_sap AT ROW 2 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 52 BY 1
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             OUTPUT h_dcalidades ).
       RUN repositionObject IN h_dcalidades ( 1.00 , 53.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dynselect-2 ( 4.00 , 20.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_denvasesprod ( 1.00 , 65.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN repositionObject IN h_dynselect-3 ( 5.00 , 20.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_dynselect ).
       RUN repositionObject IN h_dynselect ( 3.00 , 20.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_dynselect ,
             RowObject.descripcion_sap:HANDLE IN FRAME F-Main , 'AFTER':U ).
