...
rowObject.id_tipo_movsto rowObject.nro rowObject.nro_comprobante ~
rowObject.fecha rowObject.fecha_salida rowObject.fecha_llegada ~
rowObject.hora_salida rowObject.hora_llegada rowObject.FechaArribo ~
rowObject.LugarDescarga rowObject.Destino rowObject.id_orden_entrega 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.id_tipo_movsto FORMAT ">>9":U
      rowObject.nro FORMAT ">>>,>>9":U
      rowObject.nro_comprobante FORMAT "xxxx-xxxxxxxx":U
      rowObject.fecha FORMAT "99/99/99":U
      rowObject.fecha_salida FORMAT "99/99/99":U
      rowObject.fecha_llegada FORMAT "99/99/99":U
      rowObject.hora_salida FORMAT "X(8)":U
      rowObject.hora_llegada FORMAT "X(8)":U
      rowObject.FechaArribo COLUMN-LABEL "FechaArribo" FORMAT "99/99/9999":U
      rowObject.LugarDescarga FORMAT "x(20)":U
      rowObject.Destino FORMAT "x(15)":U
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dqRtosNoConfirmados.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.id_tipo_movsto
     _FldNameList[3]   = _<SDO>.rowObject.nro
     _FldNameList[4]   = _<SDO>.rowObject.nro_comprobante
     _FldNameList[5]   = _<SDO>.rowObject.fecha
     _FldNameList[6]   = _<SDO>.rowObject.fecha_salida
     _FldNameList[7]   = _<SDO>.rowObject.fecha_llegada
     _FldNameList[8]   = _<SDO>.rowObject.hora_salida
     _FldNameList[9]   = _<SDO>.rowObject.hora_llegada
     _FldNameList[10]   > _<SDO>.rowObject.FechaArribo
"rowObject.FechaArribo" "FechaArribo" ? "date" ? ? ? ? ? ? no "FechaArribo" no no ? yes no no "U" "" ""
     _FldNameList[11]   = _<SDO>.rowObject.LugarDescarga
     _FldNameList[12]   = _<SDO>.rowObject.Destino
     _FldNameList[13]   = _<SDO>.rowObject.id_orden_entrega
...
DO:
  ...
  /*para pantalla de remitos*/
  IF VALID-HANDLE(hCont) AND (hCont:FILE-NAME MATCHES "*wConfirmacionArribo.w" ) THEN DO:
    iBgColor = IF rowObject.rowNum MODULO 2 = 0 THEN 19 /*11 light blue*/ ELSE ? /*default*/.

    ASSIGN rowObject.id_sucursal:BGCOLOR IN BROWSE br_table           = ibgcolor
           rowObject.id_tipo_movsto:BGCOLOR IN BROWSE br_table        = ibgcolor
           rowObject.nro_comp:BGCOLOR IN BROWSE br_table              = ibgcolor
           rowObject.fecha:BGCOLOR IN BROWSE br_table                 = ibgcolor
           rowObject.destino:BGCOLOR IN BROWSE br_table               = ibgcolor
           rowObject.lugardescarga:BGCOLOR IN BROWSE br_table         = ibgcolor
           rowObject.nro:BGCOLOR IN BROWSE br_table                   = ibgcolor
           rowObject.id_orden_entrega:BGCOLOR IN BROWSE br_table      = ibgcolor
           rowObject.fechaArribo:BGCOLOR IN BROWSE br_table           = ibgcolor
           rowObject.fecha_salida:BGCOLOR IN BROWSE br_table          = ibgcolor
           rowObject.fecha_llegada:BGCOLOR IN BROWSE br_table         = ibgcolor
           rowObject.hora_salida:BGCOLOR IN BROWSE br_table           = ibgcolor
           rowObject.hora_llegada:BGCOLOR IN BROWSE br_table          = ibgcolor
           .
  END.  
END.
