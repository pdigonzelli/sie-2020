...
------------------------------------------------------------------------------*/
  ...
  hLib   = DYNAMIC-FUNCTION('getPersistentLib' IN hLibCom, 'libControlCalidad.p'). 
  DELETE OBJECT hLibCom.
  
  RUN fillTreeView IN hLib (phTree, pcArgs).
...
------------------------------------------------------------------------------*/
  ...
  RUN nodeClick IN hLib (selectedNode, "").

  RUN openAprobacion IN hLib.
