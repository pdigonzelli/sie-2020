...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_despachante ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_despachante
