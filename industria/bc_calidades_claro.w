...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH calidades WHERE ~{&KEY-PHRASE} ~
      AND calidades.id_calidad = 52 ~
 OR calidades.id_calidad = 51 ~
 OR calidades.id_calidad = 64 ~
 OR calidades.id_calidad = 68 NO-LOCK ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "general.calidades.id_calidad = 52
 OR general.calidades.id_calidad = 51
 OR general.calidades.id_calidad = 64
 OR general.calidades.id_calidad = 68"
