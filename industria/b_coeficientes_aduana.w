...
&Scoped-define INTERNAL-TABLES coeficientes_aduana

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table coeficientes_aduana.id_coeficiente ~
coeficientes_aduana.coeficiente coeficientes_aduana.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH coeficientes_aduana WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table coeficientes_aduana
&Scoped-define FIRST-TABLE-IN-QUERY-br_table coeficientes_aduana
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      coeficientes_aduana.id_coeficiente FORMAT ">>9":U WIDTH 10.2
      coeficientes_aduana.coeficiente FORMAT "->>,>>9.999999":U
            WIDTH 16.2
      coeficientes_aduana.descripcion FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.coeficientes_aduana"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.coeficientes_aduana.id_coeficiente
"id_coeficiente" ? ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[2]   > general.coeficientes_aduana.coeficiente
"coeficiente" ? ? "decimal" ? ? ? ? ? ? no ? no no "16.2" yes no no "U" "" ""
     _FldNameList[3]   = general.coeficientes_aduana.descripcion
...
define sub-menu Ordena 
  menu-item coeficientes_aduana-id_coeficiente
label 'id_coeficiente( coeficientes_aduana ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=coeficientes_aduana.id_coeficiente').
                  run set-attribute-list('titulo=CodCoef').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by coeficientes_aduana.id_coeficiente
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item coeficientes_aduana-coeficiente
label 'coeficiente( coeficientes_aduana ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=coeficientes_aduana.coeficiente').
                  run set-attribute-list('titulo=Coeficiente').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by coeficientes_aduana.coeficiente
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item coeficientes_aduana-descripcion
label 'descripcion( coeficientes_aduana ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=coeficientes_aduana.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by coeficientes_aduana.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by coeficientes_aduana.id_coeficiente
...
case p:
  WHEN 'coeficientes_aduana.id_coeficiente' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_coeficiente = integer(valor)  no-lock no-error .
  WHEN 'coeficientes_aduana.coeficiente' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  coeficiente = decimal(valor)  no-lock no-error .
  WHEN 'coeficientes_aduana.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "coeficientes_aduana"}
