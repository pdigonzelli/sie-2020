...
/* Local Variable Definitions ---                                       */
  ...
  DEFINE OUTPUT PARAMETER p_tambores AS INTEGER no-undo.
...
&Scoped-Define ENABLED-OBJECTS tambores aceptar salir RECT-1 
&Scoped-Define DISPLAYED-OBJECTS tambores 
...
DEFINE FRAME D-Dialog
     tambores AT ROW 1.95 COL 22 COLON-ALIGNED
     aceptar AT ROW 4.81 COL 32
     salir AT ROW 4.81 COL 44
     RECT-1 AT ROW 4.57 COL 29
...
DO:
  ...
  p_tambores = INTEGER(tambores:SCREEN-VALUE IN FRAME D-Dialog).
  IF p_tambores > 0 THEN DO:
    APPLY "END-ERROR":U TO frame d-dialog.
  END.
  ELSE MESSAGE "por favor ingrese la cantidad de tambores" VIEW-AS ALERT-BOX.
...
------------------------------------------------------------------------------*/
  DISPLAY tambores 
      WITH FRAME D-Dialog.
  ENABLE tambores aceptar salir RECT-1 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
