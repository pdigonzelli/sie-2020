...
&Scoped-define INTERNAL-TABLES lotes_ind sucursales
...
lotes_ind.id_lote lotes_ind.anio lotes_ind.citral lotes_ind.Fecha ~
lotes_ind.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH lotes_ind WHERE ~{&KEY-PHRASE} ~
      AND lotes_ind.id_tipo_lote_ind = 1 NO-LOCK, ~
      EACH sucursales OF lotes_ind OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table lotes_ind sucursales
&Scoped-define FIRST-TABLE-IN-QUERY-br_table lotes_ind
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      lotes_ind.id_lote FORMAT ">>>9":U
      lotes_ind.anio FORMAT ">>>9":U
      lotes_ind.citral FORMAT "->>,>>9.99":U
      lotes_ind.Fecha FORMAT "99/99/99":U
      lotes_ind.descripcion FORMAT "X(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 88 BY 5
         BGCOLOR 3 FGCOLOR 15 FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_ind,comercial.sucursales OF general.lotes_ind"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", OUTER"
     _Where[1]         = "general.lotes_ind.id_tipo_lote_ind = 1"
     _FldNameList[1]   > comercial.sucursales.abreviatura
"sucursales.abreviatura" "Sucursal" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > general.lotes_ind.id_lote
"lotes_ind.id_lote" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   = general.lotes_ind.anio
     _FldNameList[4]   = general.lotes_ind.citral
     _FldNameList[5]   > general.lotes_ind.Fecha
"lotes_ind.Fecha" ? "99/99/99" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > general.lotes_ind.descripcion
"lotes_ind.descripcion" ? "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
label 'abreviatura( sucursales ) '
  ...
  menu-item lotes_ind-id_lote
label 'id_lote( lotes_ind ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_ind.id_lote').
                  run set-attribute-list('titulo=Lote').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_ind.id_lote
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item lotes_ind-anio
label 'anio( lotes_ind ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_ind.anio').
                  run set-attribute-list('titulo=Año').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_ind.anio
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item lotes_ind-citral
label 'citral( lotes_ind ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_ind.citral').
                  run set-attribute-list('titulo=Citral').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_ind.citral
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item lotes_ind-Fecha
label 'Fecha( lotes_ind ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lotes_ind.Fecha').
                  run set-attribute-list('titulo=Fecha').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lotes_ind.Fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by sucursales.abreviatura
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE carga-origen B-table-Win 
PROCEDURE carga-origen :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
run get-container (output hcon).
  ...
  run ocultar-objetos-pag2 in hcon. 
