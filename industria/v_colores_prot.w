...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES colores_prot
&Scoped-define FIRST-EXTERNAL-TABLE colores_prot


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR colores_prot.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS colores_prot.id_color ~
colores_prot.descripcion colores_prot.abreviatura 
&Scoped-define ENABLED-TABLES colores_prot
&Scoped-define FIRST-ENABLED-TABLE colores_prot
&Scoped-define DISPLAYED-TABLES colores_prot
&Scoped-define FIRST-DISPLAYED-TABLE colores_prot
&Scoped-Define DISPLAYED-FIELDS colores_prot.id_color ~
colores_prot.descripcion colores_prot.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS colores_prot.id_color 
...
DEFINE FRAME F-Main
     colores_prot.id_color AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     colores_prot.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 57 BY 1
     colores_prot.abreviatura AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.colores_prot
...
/* SETTINGS FOR FILL-IN colores_prot.id_color IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME colores_prot.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL colores_prot.abreviatura V-table-Win
ON LEAVE OF colores_prot.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME colores_prot.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL colores_prot.descripcion V-table-Win
ON LEAVE OF colores_prot.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME colores_prot.id_color
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL colores_prot.id_color V-table-Win
ON LEAVE OF colores_prot.id_color IN FRAME F-Main /* CodColores */
DO:
{custom/support/validacion.i}
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN colores_prot.c_usuario = USERID("userdb")
       colores_prot.c_fecha   = TODAY
       colores_prot.c_hora    = string(TIME,"HH:MM:SS").
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "colores_prot"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "colores_prot"}
