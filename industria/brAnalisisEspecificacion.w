...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_analisis ~
rowObject.Analisis rowObject.valor rowObject.Unidad ~
rowObject.Especificacion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_analisis FORMAT "->,>>>,>>9":U
      Analisis FORMAT "x(20)":U
      valor FORMAT "->>,>>>,>>9.99":U
      Unidad FORMAT "x(15)":U
      Especificacion FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_analisis
     _FldNameList[2]   = _<SDO>.rowObject.Analisis
     _FldNameList[3]   = _<SDO>.rowObject.valor
     _FldNameList[4]   = _<SDO>.rowObject.Unidad
     _FldNameList[5]   = _<SDO>.rowObject.Especificacion
