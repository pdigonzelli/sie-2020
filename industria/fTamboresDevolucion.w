...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_btamboresindustria ( 6.00 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_btamboresindustria ( 7.38 , 65.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_dynfilter ).
       RUN repositionObject IN h_dynfilter ( 1.24 , 1.00 ) NO-ERROR.
