...
&Scoped-define INTERNAL-TABLES r_clausulas_gastos_item_oe clausulas ~
gastos_venta
...
&Scoped-define FIELDS-IN-QUERY-br_table r_clausulas_gastos_item_oe.programa ~
clausulas.descripcion gastos_venta.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH r_clausulas_gastos_item_oe WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH clausulas OF r_clausulas_gastos_item_oe NO-LOCK, ~
      EACH gastos_venta WHERE gastos_venta.id_gasto = r_clausulas_gastos_item_oe.id_gasto_venta NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table r_clausulas_gastos_item_oe ~
clausulas gastos_venta
&Scoped-define FIRST-TABLE-IN-QUERY-br_table r_clausulas_gastos_item_oe
&Scoped-define SECOND-TABLE-IN-QUERY-br_table clausulas
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      r_clausulas_gastos_item_oe.programa FORMAT "X(30)":U
      clausulas.descripcion COLUMN-LABEL "Clausula" FORMAT "x(10)":U
      gastos_venta.descripcion COLUMN-LABEL "Gasto" FORMAT "X(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 70 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.r_clausulas_gastos_item_oe,general.clausulas OF general.r_clausulas_gastos_item_oe,industria.gastos_venta WHERE general.r_clausulas_gastos_item_oe ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[3]      = "general.gastos_venta.id_gasto = general.r_clausulas_gastos_item_oe.id_gasto_venta"
     _FldNameList[1]   = general.r_clausulas_gastos_item_oe.programa
     _FldNameList[2]   > general.clausulas.descripcion
"general.clausulas.descripcion" "Clausula" "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > general.gastos_venta.descripcion
"general.gastos_venta.descripcion" "Gasto" "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
define sub-menu Ordena 
  menu-item r_clausulas_gastos_item_oe-programa
label 'programa( r_clausulas_gastos_item_oe ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_clausulas_gastos_item_oe.programa').
                  run set-attribute-list('titulo=Programa').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_clausulas_gastos_item_oe.programa
...
case p:
  WHEN 'r_clausulas_gastos_item_oe.programa' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "r_clausulas_gastos_item_oe"}
