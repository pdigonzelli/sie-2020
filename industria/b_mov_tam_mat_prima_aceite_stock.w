...
tambores_industria.Fecha tambores_industria.id_articulo ~
tambores_industria.id_sucursal tambores_industria.kilos_tambor ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria WHERE ~{&KEY-PHRASE} ~
 ...
 AND tambores_industria.Fecha >= 01/01/2002 ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tambores_industria.Fecha FORMAT "99/99/9999":U WIDTH 15.4
      tambores_industria.id_articulo FORMAT ">>>,>>9":U WIDTH 12.2
      tambores_industria.id_sucursal FORMAT ">>,>>9":U WIDTH 10.2
      tambores_industria.kilos_tambor FORMAT ">>>,>>9.999":U WIDTH 16.2
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 114 BY 19.29
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "general.tambores_industria.id_tambor|yes,industria.tambores_industria.id_sucursal|yes"
     _Where[1]         = "general.tambores_industria.id_articulo = 511
 AND general.tambores_industria.Fecha >= 01/01/2002
 AND general.tambores_industria.id_locacion_ubicacion = 4"
     _FldNameList[1]   = general.tambores_industria.id_tambor
     _FldNameList[2]   > general.tambores_industria.Fecha
"tambores_industria.Fecha" ? ? "date" ? ? ? ? ? ? no ? no no "15.4" yes no no "U" "" ""
     _FldNameList[3]   > general.tambores_industria.id_articulo
"tambores_industria.id_articulo" ? ? "integer" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[4]   > general.tambores_industria.id_sucursal
"tambores_industria.id_sucursal" ? ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[5]   > general.tambores_industria.kilos_tambor
"tambores_industria.kilos_tambor" ? ? "decimal" ? ? ? ? ? ? no ? no no "16.2" yes no no "U" "" ""
     _FldNameList[6]   > general.tambores_industria.id_sucursal_ubicacion
"tambores_industria.id_sucursal_ubicacion" ? ? "integer" ? ? ? ? ? ? yes ? no no "13.2" yes no no "U" "" ""
     _FldNameList[7]   > general.tambores_industria.id_locacion_ubicacion
"tambores_industria.id_locacion_ubicacion" ? ? "integer" ? ? ? ? ? ? yes ? no no "13.2" yes no no "U" "" ""
...
label 'id_articulo( tambores_industria ) '
  ...
  menu-item tambores_industria-id_sucursal
label 'id_sucursal( tambores_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_industria.id_sucursal').
                  run set-attribute-list('titulo=Sucursal').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tambores_industria.id_sucursal
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
case p:
  ...
  WHEN 'tambores_industria.id_sucursal' then  
