...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-28 
...
DEFINE VARIABLE h_b_tipos_origenes_materia_prima AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_origenes_materia_prima AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Tipos Origenes de Materia Prima"
         HEIGHT             = 16.29
         WIDTH              = 80.4
         MAX-HEIGHT         = 19.52
         MAX-WIDTH          = 107
...
ON END-ERROR OF W-Win /* Tipos Origenes de Materia Prima */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipos Origenes de Materia Prima */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_origenes_materia_prima.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_origenes_materia_prima ).
       RUN set-position IN h_b_tipos_origenes_materia_prima ( 4.10 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_origenes_materia_prima ( 6.71 , 71.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_origenes_materia_prima.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_origenes_materia_prima ).
       RUN set-position IN h_v_tipos_origenes_materia_prima ( 11.95 , 15.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 47.00 ) */

       /* Links to csmartbrowser h_b_tipos_origenes_materia_prima. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_origenes_materia_prima ).

       /* Links to SmartViewer h_v_tipos_origenes_materia_prima. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_origenes_materia_prima , 'Record':U , h_v_tipos_origenes_materia_prima ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_origenes_materia_prima ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_origenes_materia_prima ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_origenes_materia_prima ,
             h_b_tipos_origenes_materia_prima , 'AFTER':U ).
    END. /* Page 0 */
