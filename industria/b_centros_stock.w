...
&Scoped-define INTERNAL-TABLES centros_stock

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table centros_stock.id_centro_stock ~
centros_stock.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH centros_stock WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table centros_stock
&Scoped-define FIRST-TABLE-IN-QUERY-br_table centros_stock
...
<FOREIGN-KEYS>
id_centro_stock||y|general.centros_stock.id_centro_stock
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.centros_stock"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.centros_stock.id_centro_stock
     _FldNameList[2]   = general.centros_stock.descripcion
...
define sub-menu Ordena 
  menu-item centros_stock-id_centro_stock
label 'id_centro_stock( centros_stock ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=centros_stock.id_centro_stock').
                  run set-attribute-list('titulo=Centros Stock').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by centros_stock.id_centro_stock
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item centros_stock-descripcion
label 'descripcion( centros_stock ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=centros_stock.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by centros_stock.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by centros_stock.id_centro_stock
...
case p:
  WHEN 'centros_stock.id_centro_stock' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_centro_stock = integer(valor)  no-lock no-error .
  WHEN 'centros_stock.descripcion' then  
