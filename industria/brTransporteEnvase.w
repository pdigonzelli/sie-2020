...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Tipo rowObject.Envase ~
rowObject.Producto rowObject.capacidad rowObject.id_tipo_transporte ~
rowObject.id_evnase rowObject.id_proveedor 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.Tipo FORMAT "x(25)":U
      rowObject.Envase FORMAT "x(25)":U
      rowObject.Producto FORMAT "x(25)":U
      rowObject.capacidad FORMAT "->>,>>9.99":U
      rowObject.id_tipo_transporte FORMAT "->,>>>,>>9":U
      rowObject.id_evnase FORMAT "->,>>>,>>9":U
      rowObject.id_proveedor FORMAT "->,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Tipo
     _FldNameList[2]   = _<SDO>.rowObject.Envase
     _FldNameList[3]   = _<SDO>.rowObject.Producto
     _FldNameList[4]   = _<SDO>.rowObject.capacidad
     _FldNameList[5]   = _<SDO>.rowObject.id_tipo_transporte
     _FldNameList[6]   = _<SDO>.rowObject.id_evnase
     _FldNameList[7]   = _<SDO>.rowObject.id_proveedor
