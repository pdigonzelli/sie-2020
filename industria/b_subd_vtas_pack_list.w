...
&Scoped-define INTERNAL-TABLES r_items_venta_pack_list subd_vtas ~
packing_list
...
subd_vtas.nro_comp subd_vtas.estado packing_list.id_packing_list ~
packing_list.nro_pack_list packing_list.nro_contrato packing_list.fecha 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH r_items_venta_pack_list WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH subd_vtas OF r_items_venta_pack_list NO-LOCK, ~
      EACH packing_list OF r_items_venta_pack_list NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table r_items_venta_pack_list subd_vtas ~
packing_list
&Scoped-define FIRST-TABLE-IN-QUERY-br_table r_items_venta_pack_list
...
<FOREIGN-KEYS>
id_sucursal|y|y|ventas.r_items_venta_pack_list.id_sucursal
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      subd_vtas.id_punto_venta FORMAT ">>>9":U
      subd_vtas.nro_comp FORMAT ">>>>>>>9":U
      subd_vtas.estado FORMAT "Vigente/Anulado":U
      packing_list.id_packing_list FORMAT "->,>>>,>>9":U
      packing_list.nro_pack_list FORMAT "X(15)":U
      packing_list.nro_contrato FORMAT "X(20)":U
      packing_list.fecha FORMAT "99/99/99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 96 BY 18.33
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "ventas.r_items_venta_pack_list,ventas.subd_vtas OF ventas.r_items_venta_pack_list,ventas.packing_list OF ventas.r_items_venta_pack_list"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = ventas.subd_vtas.id_punto_venta
     _FldNameList[2]   = ventas.subd_vtas.nro_comp
     _FldNameList[3]   = ventas.subd_vtas.estado
     _FldNameList[4]   = ventas.packing_list.id_packing_list
     _FldNameList[5]   = ventas.packing_list.nro_pack_list
     _FldNameList[6]   = ventas.packing_list.nro_contrato
     _FldNameList[7]   = ventas.packing_list.fecha
...
label 'nro_comp( subd_vtas ) '
  ...
  menu-item subd_vtas-estado
label 'estado( subd_vtas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=subd_vtas.estado').
                  run set-attribute-list('titulo=Estado').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by subd_vtas.estado
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item packing_list-id_packing_list
label 'id_packing_list( packing_list ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=packing_list.id_packing_list').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by packing_list.id_packing_list
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item packing_list-nro_pack_list
label 'nro_pack_list( packing_list ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=packing_list.nro_pack_list').
                  run set-attribute-list('titulo=Nro Packing List').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by packing_list.nro_pack_list
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item packing_list-nro_contrato
label 'nro_contrato( packing_list ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=packing_list.nro_contrato').
                  run set-attribute-list('titulo=Nro Contrato').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by packing_list.nro_contrato
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item packing_list-fecha
label 'fecha( packing_list ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=packing_list.fecha').
                  run set-attribute-list('titulo=Fecha').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by packing_list.fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by subd_vtas.id_punto_venta
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_sucursal':U THEN DO:
       &Scope KEY-PHRASE r_items_venta_pack_list.id_sucursal eq INTEGER(key-value)
       {&OPEN-QUERY-{&BROWSE-NAME}}
    END. /* id_sucursal */
    OTHERWISE DO:
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_sucursal" "r_items_venta_pack_list" "id_sucursal"}
