...
&Scoped-define INTERNAL-TABLES lotes_aceite envases_prod ~
...
sucursales.abreviatura lotes_aceite.fecha productos_terminados.descripcion ~
lotes_aceite.Peso_neto envases_prod.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH lotes_aceite WHERE ~{&KEY-PHRASE} ~
      AND lotes_aceite.id_tipotambor = 6 ~
 OR lotes_aceite.id_tipotambor = 7  NO-LOCK, ~
      EACH envases_prod OF lotes_aceite NO-LOCK, ~
      EACH productos_terminados OF lotes_aceite NO-LOCK, ~
      EACH sucursales OF lotes_aceite NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table lotes_aceite envases_prod ~
productos_terminados sucursales
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      lotes_aceite.Peso_neto FORMAT "->>,>>9.999":U
      envases_prod.descripcion FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_aceite,general.envases_prod OF general.lotes_aceite,general.productos_terminados OF general.lotes_aceite,comercial.sucursales OF general.lotes_aceite"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "general.lotes_aceite.id_tipotambor = 6
 OR general.lotes_aceite.id_tipotambor = 7 "
     _FldNameList[1]   > general.lotes_aceite.id_lote
"lotes_aceite.id_lote" ? ">,>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
"productos_terminados.descripcion" ? "x(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   = general.lotes_aceite.Peso_neto
     _FldNameList[6]   > general.envases_prod.descripcion
"envases_prod.descripcion" ? "x(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
