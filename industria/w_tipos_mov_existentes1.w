...
DEFINE VARIABLE h_v_tipos_mov_existentes1 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_tipos_mov_existentes ( 4.71 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 124.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_mov_existentes1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_mov_existentes1 ).
       RUN set-position IN h_v_tipos_mov_existentes1 ( 12.43 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.00 , 144.00 ) */
       ...
       /* Links to SmartViewer h_v_tipos_mov_existentes1. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_mov_existentes , 'Record':U , h_v_tipos_mov_existentes1 ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_mov_existentes1 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_mov_existentes ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_mov_existentes1 ,
