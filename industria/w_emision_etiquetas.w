...
ON END-ERROR OF W-Win /* Emisión de Etiquetas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Emisión de Etiquetas */
DO:
...
/*                output to \\gabriel\zebra. */
        ...
        else message "Está mandando a imprimir mas etiquetas que el Total de etiquetas establecido." .
    end.
