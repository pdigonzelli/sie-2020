...
DEFINE VARIABLE h_b_subd_vtas_pack_list AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_subd_vtas_pack_list.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_subd_vtas_pack_list ).
       RUN set-position IN h_b_subd_vtas_pack_list ( 3.86 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b_subd_vtas_pack_list ( 18.33 , 96.00 ) NO-ERROR.

       /* Links to csmartbrowser h_b_subd_vtas_pack_list. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_subd_vtas_pack_list ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_subd_vtas_pack_list ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
