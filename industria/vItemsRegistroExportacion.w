...
&Scoped-Define ENABLED-FIELDS RowObject.anio RowObject.Fecha ~
RowObject.cantidad 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define DISPLAYED-FIELDS RowObject.anio RowObject.Fecha ~
RowObject.cantidad 
...
DEFINE VARIABLE h_dempresaexportadora AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     RowObject.anio AT ROW 1.1 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     RowObject.Fecha AT ROW 6.62 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     RowObject.cantidad AT ROW 6.71 COL 53 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dItemsRegistroExportacion.w"
...
------------------------------------------------------------------------------*/
  ...
  vcQry = "FOR EACH productos_terminados WHERE id_tipo_articulo = 2 OR id_tipo_articulo = 1 BY id_articulo".
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dlugardescargas ( 1.00 , 57.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.00 ) */

       RUN constructObject (
             INPUT  'adm2/dynselect.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'AutoRefreshnoChangedEventDisplayedFielddescripcionKeyFieldid_lugdesDataSourceFilterNumRows15OptionalnoOptionalString':U + '<none>' + 'LabelPuerto DestinoSortyesViewAsBrowserToolTipFormatHelpId0BrowseTitleBrowseFieldsid_lugdes,descripcionExitBrowseOnActionyesCancelBrowseOnExityesRepositionDataSourcenoDefineAnyKeyTriggeryesStartBrowseKeysNEXT-FRAMEFieldNameid_puerto_destinoDisplayFieldyesEnableFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynselect-2 ).
       RUN repositionObject IN h_dynselect-2 ( 3.29 , 18.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dproductosterminados ( 4.67 , 2.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'adm2/dynselect.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'AutoRefreshnoChangedEventDisplayedFielddescripcionKeyFieldid_articuloDataSourceFilterNumRows15OptionalnoOptionalString':U + '<none>' + 'LabelProductoSortyesViewAsBrowserToolTipFormatHelpId0BrowseTitleBrowseFieldsid_articulo,descripcionExitBrowseOnActionyesCancelBrowseOnExityesRepositionDataSourcenoDefineAnyKeyTriggeryesStartBrowseKeysNEXT-FRAMEFieldNameid_productoDisplayFieldyesEnableFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynselect-3 ).
       RUN repositionObject IN h_dynselect-3 ( 4.43 , 18.00 ) NO-ERROR.
       RUN resizeObject IN h_dynselect-3 ( 1.00 , 50.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'dempresaexportadora.wDB-AWARE':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedempresaexportadoraUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dempresaexportadora ).
       RUN repositionObject IN h_dempresaexportadora ( 5.38 , 44.00 ) NO-ERROR.
       /* Size in AB:  ( 2.14 , 10.80 ) */

       RUN constructObject (
             INPUT  'adm2/dynselect.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'AutoRefreshnoChangedEventDisplayedFieldnombreKeyFieldid_empresa_exportadoraDataSourceFilterNumRows15OptionalnoOptionalString':U + '<none>' + 'LabelCompañiaSortyesViewAsBrowserToolTipFormatHelpId0BrowseTitleBrowseFieldsid_empresa_exportadora,nombreExitBrowseOnActionyesCancelBrowseOnExityesRepositionDataSourcenoDefineAnyKeyTriggeryesStartBrowseKeysNEXT-FRAMEFieldNameid_empresa_exportadoraDisplayFieldyesEnableFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynselect ).
       ...
       RUN constructObject (
             ...
             OUTPUT h_dvapores ).
       RUN repositionObject IN h_dvapores ( 5.62 , 34.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'adm2/dynselect.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'AutoRefreshnoChangedEventDisplayedFielddescripcionKeyFieldid_vaporDataSourceFilterNumRows15OptionalnoOptionalString':U + '<none>' + 'LabelVaporSortyesViewAsBrowserToolTipFormatHelpId0BrowseTitleBrowseFieldsid_vapor,descripcionExitBrowseOnActionyesCancelBrowseOnExityesRepositionDataSourcenoDefineAnyKeyTriggeryesStartBrowseKeysNEXT-FRAMEFieldNameid_vaporDisplayFieldyesEnableFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynselect-4 ).
       RUN repositionObject IN h_dynselect-4 ( 5.52 , 18.00 ) NO-ERROR.
       ...
       RUN addLink ( h_dproductosterminados , 'Data':U , h_dynselect-3 ).

       /* Links to SmartDataField h_dynselect. */
       RUN addLink ( h_dempresaexportadora , 'Data':U , h_dynselect ).

       /* Links to SmartDataField h_dynselect-4. */
       RUN addLink ( h_dvapores , 'Data':U , h_dynselect-4 ).
