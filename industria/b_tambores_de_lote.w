...
tambores_industria.kilos_tambor tambores_industria.c_fecha ~
tambores_industria.id_sucursal_remito tambores_industria.id_tipo_movsto ~
tambores_industria.nro_remito 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria OF lotes_jugo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
  ...
  AND locaciones.id_locacion = tambores_industria.id_locacion_ubicacion NO-LOCK, ~
      EACH sucursales WHERE sucursales.id_sucursal = tambores_industria.id_sucursal_ubicacion NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tambores_industria.id_sucursal_ubicacion COLUMN-LABEL "SucUbi." FORMAT ">>9":U
      sucursales.abreviatura COLUMN-LABEL "Sucursal" FORMAT "X(10)":U
      tambores_industria.id_locacion_ubicacion COLUMN-LABEL "LocUbi" FORMAT ">>9":U
      locaciones.descripcion COLUMN-LABEL "Locacion" FORMAT "x(20)":U
      tambores_industria.kilos_tambor FORMAT ">>>>9.999":U
      tambores_industria.c_fecha FORMAT "99/99/99":U
      tambores_industria.id_sucursal_remito COLUMN-LABEL "Suc.Rem." FORMAT ">>9":U
      tambores_industria.id_tipo_movsto COLUMN-LABEL "TipoMov" FORMAT ">>9":U
      tambores_industria.nro_remito COLUMN-LABEL "NroRemi" FORMAT ">>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 149 BY 6.91
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_industria OF general.lotes_jugo,industria.locaciones WHERE general.tambores_industria ...,comercial.sucursales WHERE general.tambores_industria ...,general.envases_prod OF general.tambores_industria"
...
"general.tambores_industria.id_tambor" ? ">>>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > general.tambores_industria.id_sucursal_ubicacion
"general.tambores_industria.id_sucursal_ubicacion" "SucUbi." ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
"general.tambores_industria.id_locacion_ubicacion" "LocUbi" ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > general.locaciones.descripcion
"general.locaciones.descripcion" "Locacion" "x(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > general.tambores_industria.kilos_tambor
"general.tambores_industria.kilos_tambor" ? ">>>>9.999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[7]   = general.tambores_industria.c_fecha
     _FldNameList[8]   > general.tambores_industria.id_sucursal_remito
"general.tambores_industria.id_sucursal_remito" "Suc.Rem." ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[9]   > general.tambores_industria.id_tipo_movsto
"general.tambores_industria.id_tipo_movsto" "TipoMov" ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[10]   > general.tambores_industria.nro_remito
"general.tambores_industria.nro_remito" "NroRemi" ">>>>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
