...
&Scoped-Define ENABLED-OBJECTS RECT-16 RECT-22 RECT-21 RECT-23 RECT-24 ~
RECT-4 b-detalle FILL-IN-3 FILL-IN-1 date_manufacture BUTTON-10 FILL-IN-2 ~
BUTTON-12 desde hasta BUTTON-11 BUTTON-6 BUTTON-5 BUTTON-3 
...
DEFINE VARIABLE h_b_lotes_aceite AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_origen_tambores_lote_aceite AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_sobrante_lote_aceite AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "ORIGEN DE ACEITE" VIEW-AS TEXT
          SIZE 144 BY .95 AT ROW 17.67 COL 3
          BGCOLOR 1 FGCOLOR 15 
...
DO:
  ...
  run get-rowid1 in h_b_lotes_aceite (output r).
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_lotes_aceite.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_lotes_aceite ).
       RUN set-position IN h_b_lotes_aceite ( 3.38 , 4.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_origen_tambores_lote_aceite ( 20.33 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.62 , 149.00 ) */

       /* Links to csmartbrowser h_b_lotes_aceite. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_lotes_aceite ).

       /* Links to SmartViewer h_v_lotes_aceite. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_aceite , 'Record':U , h_v_lotes_aceite ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_sobrante_lote_aceite.w':U ,
             INPUT  {&WINDOW-NAME} ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_sobrante_lote_aceite ).
       RUN set-position IN h_b_sobrante_lote_aceite ( 14.38 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 145.00 ) */
       ...
       /* Links to csmartbrowser h_b_sobrante_lote_aceite. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_aceite , 'Record':U , h_b_sobrante_lote_aceite ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav-3 , 'TableIO':U , h_b_sobrante_lote_aceite ).

       /* Links to csmartbrowser h_b_composicion_lote_aceite. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_aceite , 'record':U , h_b_composicion_lote_aceite ).
       ...
       RUN add-link IN adm-broker-hdl ( h_b_lotes_aceite , 'Record':U , h_q_sobrante_lotes_aceite ).
...
run get-rowid1 in h_b_lotes_aceite (output pr).
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-3 FILL-IN-1 date_manufacture FILL-IN-2 desde hasta 
      WITH FRAME F-Main.
  ENABLE RECT-16 RECT-22 RECT-21 RECT-23 RECT-24 RECT-4 b-detalle FILL-IN-3 
         FILL-IN-1 date_manufacture BUTTON-10 FILL-IN-2 BUTTON-12 desde hasta 
         BUTTON-11 BUTTON-6 BUTTON-5 BUTTON-3 
      WITH FRAME F-Main.
