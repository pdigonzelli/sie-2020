...
&Scoped-Define ENABLED-OBJECTS RECT-15 RECT-2 RECT-18 
...
DEFINE VARIABLE h_b_ubicaciones AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_ubicaciones AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_ubicaciones.w':U ,
             INPUT  {&WINDOW-NAME} ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_ubicaciones ).
       RUN set-position IN h_v_ubicaciones ( 11.48 , 22.60 ) NO-ERROR.
       /* Size in UIB:  ( 5.00 , 80.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_ubicaciones.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_ubicaciones ).
       RUN set-position IN h_b_ubicaciones ( 3.86 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 120.00 ) */

       /* Links to SmartViewer h_v_ubicaciones. */
       RUN add-link IN adm-broker-hdl ( h_b_ubicaciones , 'Record':U , h_v_ubicaciones ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_ubicaciones ).

       /* Links to csmartbrowser h_b_ubicaciones. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_ubicaciones ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_ubicaciones ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
