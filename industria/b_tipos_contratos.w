...
&Scoped-define INTERNAL-TABLES tipos_contratos calidades ~
...
&Scoped-define FIELDS-IN-QUERY-br_table tipos_contratos.id_tipo_contrato ~
tipos_contratos.descripcion productos_terminados.abreviatura ~
calidades.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_contratos WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH calidades OF tipos_contratos OUTER-JOIN NO-LOCK, ~
      EACH productos_terminados OF tipos_contratos OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipos_contratos calidades ~
productos_terminados
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_contratos
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_contratos.id_tipo_contrato
      tipos_contratos.descripcion
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_contratos,general.calidades OF general.tipos_contratos,general.productos_terminados OF general.tipos_contratos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", OUTER, OUTER"
     _FldNameList[1]   = general.tipos_contratos.id_tipo_contrato
     _FldNameList[2]   = general.tipos_contratos.descripcion
...
define sub-menu Ordena 
  menu-item tipos_contratos-id_tipo_contrato
label 'id_tipo_contrato( tipos_contratos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_contratos.id_tipo_contrato').
                  run set-attribute-list('titulo=Tipo de contrato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_contratos.id_tipo_contrato
