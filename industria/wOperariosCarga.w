...
DEFINE VARIABLE h_foperarioscarga AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Responsables de Carga */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Responsables de Carga */
DO:
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             OUTPUT h_foperarioscarga ).
       RUN repositionObject IN h_foperarioscarga ( 1.24 , 2.00 ) NO-ERROR.
       /* Size in AB:  ( 18.29 , 100.80 ) */
