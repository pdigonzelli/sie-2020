...
DEFINE VARIABLE h_b_producciones_cascara AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_producciones_cascara AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Producciones de Cascara */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Producciones de Cascara */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_producciones_cascara.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_producciones_cascara ).
       RUN set-position IN h_b_producciones_cascara ( 3.86 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_producciones_cascara ( 6.71 , 88.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_producciones_cascara.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_producciones_cascara ).
       RUN set-position IN h_v_producciones_cascara ( 11.48 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.95 , 75.00 ) */

       /* Links to csmartbrowser h_b_producciones_cascara. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_producciones_cascara ).

       /* Links to SmartViewer h_v_producciones_cascara. */
       RUN add-link IN adm-broker-hdl ( h_b_producciones_cascara , 'Record':U , h_v_producciones_cascara ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_producciones_cascara ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_producciones_cascara ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_producciones_cascara ,
             h_b_producciones_cascara , 'AFTER':U ).
    END. /* Page 0 */
