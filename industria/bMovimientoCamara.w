...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Sucursal rowObject.fecha ~
rowObject.Turno rowObject.id_movimiento_camara 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Turno FORMAT "x(15)":U
      id_movimiento_camara FORMAT ">>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = _<SDO>.rowObject.Turno
     _FldNameList[4]   = _<SDO>.rowObject.id_movimiento_camara
