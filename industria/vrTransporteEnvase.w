...
&Scoped-define DATA-FIELD-DEFS "drTransporteEnvase.i"

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME F-Main

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS RowObject.capacidad 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define DISPLAYED-FIELDS RowObject.capacidad 
...
DEFINE FRAME F-Main
     RowObject.capacidad AT ROW 4 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "drTransporteEnvase.w"
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dtipostransporte ( 1.00 , 70.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'adm2/dynselect.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'AutoRefreshnoChangedEventDisplayedFielddescripcionKeyFieldid_tipo_transporteDataSourceFilterNumRows20OptionalnoOptionalString':U + '<none>' + 'LabelTipo TransporteSortyesViewAsBrowserToolTipFormatHelpId0BrowseTitleTipos TransporteBrowseFieldsdescripcion,id_tipo_transporteExitBrowseOnActionyesCancelBrowseOnExityesRepositionDataSourcenoDefineAnyKeyTriggeryesStartBrowseKeysNEXT-FRAMEFieldNameid_tipo_transporteDisplayFieldyesEnableFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynselect ).
       ...
       RUN repositionObject IN h_dproductosterminados ( 1.95 , 1.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'adm2/dynselect.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'AutoRefreshnoChangedEventDisplayedFielddescripcionKeyFieldid_articuloDataSourceFilterNumRows20OptionalnoOptionalString':U + '<none>' + 'LabelProductoSortyesViewAsBrowserToolTipFormatHelpId0BrowseTitleProductosBrowseFieldsdescripcion,id_articuloExitBrowseOnActionyesCancelBrowseOnExityesRepositionDataSourcenoDefineAnyKeyTriggeryesStartBrowseKeysNEXT-FRAMEFieldNameid_articuloDisplayFieldyesEnableFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynselect-3 ).
       RUN repositionObject IN h_dynselect-3 ( 3.00 , 22.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_denvasesprod ( 2.91 , 70.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'adm2/dynselect.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'AutoRefreshnoChangedEventDisplayedFieldEnvaseKeyFieldid_envaseDataSourceFilterNumRows20OptionalnoOptionalString':U + '<none>' + 'LabelEnvaseSortyesViewAsBrowserToolTipFormatHelpId0BrowseTitleEnvasesBrowseFieldsid_envase,EnvaseExitBrowseOnActionyesCancelBrowseOnExityesRepositionDataSourcenoDefineAnyKeyTriggeryesStartBrowseKeysNEXT-FRAMEFieldNameid_evnaseDisplayFieldyesEnableFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynselect-2 ).
       RUN repositionObject IN h_dynselect-2 ( 2.00 , 22.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_dynselect ,
             RowObject.capacidad:HANDLE IN FRAME F-Main , 'BEFORE':U ).
...
/*  
  ...
  cSrt = "BY proveedores.razon_social".
  DYNAMIC-FUNCTION('setQuerySort' IN h_dqProveedores, cSrt).
  DYNAMIC-FUNCTION('openQuery' IN h_dqProveedores).
*/
END PROCEDURE.
