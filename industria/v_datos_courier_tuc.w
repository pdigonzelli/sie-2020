...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-12 fi-couriers-descripcion 
...
DEFINE VARIABLE FILL-IN-12 AS CHARACTER FORMAT "X(256)":U INITIAL "Envio de Muestras desde Tucuman" 
     VIEW-AS FILL-IN 
     SIZE 62 BY 1
...
DEFINE FRAME F-Main
     FILL-IN-12 AT ROW 1 COL 2 NO-LABEL
     items_muestras.fecha_enviado_tuc AT ROW 2.43 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
     fi-couriers-descripcion AT ROW 3.38 COL 22 COLON-ALIGNED NO-LABEL
     items_muestras.id_courier_tuc AT ROW 3.43 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     items_muestras.nro_guia_tuc AT ROW 4.43 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 42 BY 1
...
/* SETTINGS FOR FILL-IN items_muestras.fecha_enviado_tuc IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       items_muestras.fecha_enviado_tuc:READ-ONLY IN FRAME F-Main        = TRUE.
...
/* SETTINGS FOR FILL-IN FILL-IN-12 IN FRAME F-Main
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-12:READ-ONLY IN FRAME F-Main        = TRUE.

/* SETTINGS FOR FILL-IN items_muestras.id_courier_tuc IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       items_muestras.id_courier_tuc:READ-ONLY IN FRAME F-Main        = TRUE.

/* SETTINGS FOR FILL-IN items_muestras.nro_guia_tuc IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       items_muestras.nro_guia_tuc:READ-ONLY IN FRAME F-Main        = TRUE.
...
define var lista_relacion as character no-undo initial "id_courier_tuc".
