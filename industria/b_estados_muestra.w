...
&Scoped-define INTERNAL-TABLES estados_muestra

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table estados_muestra.id_estado_muestra ~
estados_muestra.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH estados_muestra WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH estados_muestra WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table estados_muestra
&Scoped-define FIRST-TABLE-IN-QUERY-br_table estados_muestra
...
<FOREIGN-KEYS>
id_estado_muestra||y|estados_muestra.id_estado_muestra
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_estado_muestra"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      estados_muestra.id_estado_muestra FORMAT ">>>9":U
      estados_muestra.descripcion FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 75 BY 6.71
         FONT 0 ROW-HEIGHT-CHARS .52.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.estados_muestra"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.estados_muestra.id_estado_muestra
     _FldNameList[2]   = general.estados_muestra.descripcion
...
define sub-menu Ordena 
  menu-item estados_muestra-id_estado_muestra
label 'id_estado_muestra( estados_muestra ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=estados_muestra.id_estado_muestra').
                  run set-attribute-list('titulo=Muestas').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by estados_muestra.id_estado_muestra
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item estados_muestra-descripcion
label 'descripcion( estados_muestra ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=estados_muestra.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by estados_muestra.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by estados_muestra.id_estado_muestra
...
run set-attribute-list('orden=estados_muestra-id_estado_muestra').
run set-attribute-list('titulo=Muestras').
/********** TERMINA MENU ***********/
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_estado_muestra" "estados_muestra" "id_estado_muestra"}
