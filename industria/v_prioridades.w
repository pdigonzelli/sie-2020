...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES prioridades
&Scoped-define FIRST-EXTERNAL-TABLE prioridades


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR prioridades.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS prioridades.id_prioridad ~
prioridades.descripcion prioridades.abreviatura 
&Scoped-define ENABLED-TABLES prioridades
&Scoped-define FIRST-ENABLED-TABLE prioridades
&Scoped-Define DISPLAYED-FIELDS prioridades.id_prioridad ~
prioridades.descripcion prioridades.abreviatura 
&Scoped-define DISPLAYED-TABLES prioridades
&Scoped-define FIRST-DISPLAYED-TABLE prioridades
...
DEFINE FRAME F-Main
     prioridades.id_prioridad AT ROW 1 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     prioridades.descripcion AT ROW 2 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     prioridades.abreviatura AT ROW 3 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.prioridades
...
&Scoped-define SELF-NAME prioridades.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL prioridades.abreviatura V-table-Win
ON LEAVE OF prioridades.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME prioridades.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL prioridades.descripcion V-table-Win
ON LEAVE OF prioridades.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME prioridades.id_prioridad
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL prioridades.id_prioridad V-table-Win
ON LEAVE OF prioridades.id_prioridad IN FRAME F-Main /* CodPrioridad */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
    prioridades.c_usuario = USERID("userdb")
    prioridades.c_fecha   = TODAY
    prioridades.c_hora    = STRING(TIME,"HH:MM:SS").
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "prioridades"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "prioridades"}
