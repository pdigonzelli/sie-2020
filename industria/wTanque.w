...
DEFINE VARIABLE h_btanque AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dtanque AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dynfilter AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vtanque AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Tanques */
DO:
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             OUTPUT h_dtanque ).
       RUN repositionObject IN h_dtanque ( 5.76 , 72.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_btanque ).
       RUN repositionObject IN h_btanque ( 7.19 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_btanque ( 6.67 , 82.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_vtanque ).
       RUN repositionObject IN h_vtanque ( 14.33 , 7.00 ) NO-ERROR.
       /* Size in AB:  ( 7.10 , 70.60 ) */
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsid_sucursal,id_tanqueOperatorStyleImplicitOperatorViewAsCombo-boxOperator=UseBeginsyesUseContainsyesDefaultWidth16DefaultCharWidth20DefaultEditorLines1ViewAsFieldsFieldOperatorStylesFieldFormatsFieldWidthsFieldLabelsFieldToolTipsFieldHelpIdsDesignDataObjectFieldColumn20HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynfilter ).
       RUN repositionObject IN h_dynfilter ( 2.91 , 3.00 ) NO-ERROR.
       RUN resizeObject IN h_dynfilter ( 3.71 , 79.00 ) NO-ERROR.

       /* Links to SmartDataObject h_dtanque. */
       RUN addLink ( h_dynfilter , 'Filter':U , h_dtanque ).
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dtanque ).

       /* Links to SmartDataBrowser h_btanque. */
       RUN addLink ( h_dtanque , 'Data':U , h_btanque ).

       /* Links to SmartDataViewer h_vtanque. */
       RUN addLink ( h_dtanque , 'Data':U , h_vtanque ).
       RUN addLink ( h_vtanque , 'Update':U , h_dtanque ).
       RUN addLink ( h_dyntoolbar , 'TableIo':U , h_vtanque ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_dynfilter ,
             h_dyntoolbar , 'AFTER':U ).
       RUN adjustTabOrder ( h_btanque ,
             h_dynfilter , 'AFTER':U ).
       RUN adjustTabOrder ( h_vtanque ,
             h_btanque , 'AFTER':U ).
    END. /* Page 0 */
