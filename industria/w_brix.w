...
DEFINE VARIABLE h_b_brix AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Brix con Peso específico"
         HEIGHT             = 23.91
         WIDTH              = 80.4
         MAX-HEIGHT         = 23.91
         MAX-WIDTH          = 107
...
ON END-ERROR OF W-Win /* Brix con Peso específico */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Brix con Peso específico */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_brix.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_brix ).
       RUN set-position IN h_b_brix ( 3.67 , 23.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.62 , 33.00 ) */

       /* Links to csmartbrowser h_b_brix. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_brix ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_b_brix ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_brix ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
