...
&Scoped-define INTERNAL-TABLES tambores_lote envases_prod

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tambores_lote.id_tambor ~
envases_prod.descripcion tambores_lote.fecha_elaboracion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_lote OF lotes_jugo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH envases_prod OF tambores_lote NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tambores_lote envases_prod
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tambores_lote
...
<FOREIGN-KEYS>
id_envase||y|general.tambores_lote.id_envase
nro||y|general.tambores_lote.nro
id_sucursal||y|general.tambores_lote.id_sucursal
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tambores_lote.id_tambor
      envases_prod.descripcion
      tambores_lote.fecha_elaboracion
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_lote OF general.lotes_jugo,general.envases_prod OF general.tambores_lote"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tambores_lote.id_tambor
     _FldNameList[2]   = general.envases_prod.descripcion
     _FldNameList[3]   = general.tambores_lote.fecha_elaboracion
...
define sub-menu Ordena 
  menu-item tambores_lote-Nro
label 'Nro( tambores_lote ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_lote.Nro').
                  run set-attribute-list('titulo=Nro orden').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tambores_lote.Nro
...
label 'descripcion( envases_prod ) '
  ...
  menu-item tambores_lote-fecha_elaboracion
label 'fecha_elaboracion( tambores_lote ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_lote.fecha_elaboracion').
                  run set-attribute-list('titulo=Fecha Elaboración').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tambores_lote.fecha_elaboracion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tambores_lote.Nro
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_envase" "tambores_lote" "id_envase"}
  {src/adm/template/sndkycas.i "nro" "tambores_lote" "nro"}
  {src/adm/template/sndkycas.i "id_sucursal" "tambores_lote" "id_sucursal"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tambores_lote"}
