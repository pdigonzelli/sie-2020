...
De forma transitoria, en Portugal se utilizan los patrones NNNN (forma antigua) y NNNN-NNN (después de la reforma de los códigos postales) si se ha configurado la regla de verificación "9".
