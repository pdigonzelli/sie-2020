...
&Scoped-Define ENABLED-FIELDS protocolos.cantidad_tambores ~
protocolos.desde_tambor protocolos.hasta_tambor protocolos.peso_neto ~
protocolos.peso_bruto_tambor protocolos.galones_tambores 
&Scoped-define ENABLED-TABLES protocolos
&Scoped-define FIRST-ENABLED-TABLE protocolos
&Scoped-Define DISPLAYED-FIELDS protocolos.cantidad_tambores ~
protocolos.desde_tambor protocolos.hasta_tambor protocolos.peso_neto ~
protocolos.peso_bruto_tambor protocolos.galones_tambores 
...
DEFINE FRAME F-Main
     protocolos.cantidad_tambores AT ROW 1 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     protocolos.desde_tambor AT ROW 2 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     protocolos.hasta_tambor AT ROW 1.95 COL 39 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     protocolos.peso_neto AT ROW 2.91 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
     protocolos.peso_bruto_tambor AT ROW 3.91 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
     protocolos.galones_tambores AT ROW 4.91 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
...
&Scoped-define SELF-NAME protocolos.cantidad_tambores
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.cantidad_tambores V-table-Win
ON LEAVE OF protocolos.cantidad_tambores IN FRAME F-Main /* Cantidad Tambores */
DO:
...
&Scoped-define SELF-NAME protocolos.desde_tambor
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.desde_tambor V-table-Win
ON LEAVE OF protocolos.desde_tambor IN FRAME F-Main /* Desde Tambor */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME protocolos.galones_tambores
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.galones_tambores V-table-Win
ON LEAVE OF protocolos.galones_tambores IN FRAME F-Main /* Galones */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME protocolos.hasta_tambor
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.hasta_tambor V-table-Win
ON LEAVE OF protocolos.hasta_tambor IN FRAME F-Main /* Hasta */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME protocolos.peso_bruto_tambor
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.peso_bruto_tambor V-table-Win
ON LEAVE OF protocolos.peso_bruto_tambor IN FRAME F-Main /* Peso Bruto */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME protocolos.peso_neto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.peso_neto V-table-Win
ON LEAVE OF protocolos.peso_neto IN FRAME F-Main /* Peso Neto */
DO:
{custom/support/validacion.i}
END.
