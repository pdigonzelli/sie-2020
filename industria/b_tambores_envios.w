...
&Scoped-define INTERNAL-TABLES tambores_industria tambores_transporte
...
tambores_industria.id_tambor tambores_industria.id_etiqueta ~
tambores_transporte.en_remito 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria WHERE TRUE /* Join to envios_items incomplete */ NO-LOCK, ~
      EACH tambores_transporte WHERE tambores_transporte.id_etiqueta = tambores_industria.id_etiqueta NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tambores_transporte.en_remito COLUMN-LABEL "Remito"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 43 BY 12.86
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_industria WHERE general.envios_items <external> ... ...,industria.tambores_transporte WHERE general.tambores_industria ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[2]      = "general.tambores_transporte.id_etiqueta = general.tambores_industria.id_etiqueta"
...
"tambores_industria.id_tambor" ? ">>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[3]   = general.tambores_industria.id_etiqueta
     _FldNameList[4]   > general.tambores_transporte.en_remito
"tambores_transporte.en_remito" "Remito" ? "logical" ? ? ? ? ? ? no ?
