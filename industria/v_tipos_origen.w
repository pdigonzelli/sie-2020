...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipos_origen
&Scoped-define FIRST-EXTERNAL-TABLE tipos_origen


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipos_origen.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipos_origen.id_tipo_origen ~
tipos_origen.descripcion 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_tipo_origen ~{&FP2}id_tipo_origen ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}
&Scoped-define ENABLED-TABLES tipos_origen
&Scoped-define FIRST-ENABLED-TABLE tipos_origen
&Scoped-Define DISPLAYED-FIELDS tipos_origen.id_tipo_origen ~
tipos_origen.descripcion 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipos_origen.id_tipo_origen 
...
<FOREIGN-KEYS>
id_tipo_origen|y|y|general.tipos_origen.id_tipo_origen
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
DEFINE FRAME F-Main
     tipos_origen.id_tipo_origen AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     tipos_origen.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 40 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipos_origen
...
/* SETTINGS FOR FILL-IN tipos_origen.id_tipo_origen IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipos_origen.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_origen.descripcion V-table-Win
ON LEAVE OF tipos_origen.descripcion IN FRAME F-Main /* Descripción */
DO:
...
&Scoped-define SELF-NAME tipos_origen.id_tipo_origen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_origen.id_tipo_origen V-table-Win
ON LEAVE OF tipos_origen.id_tipo_origen IN FRAME F-Main /* Tipo Origen */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_tipo_origen':U THEN
       {src/adm/template/find-tbl.i
           &TABLE = tipos_origen
           &WHERE = "WHERE tipos_origen.id_tipo_origen eq INTEGER(key-value)"
       }
  END CASE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipos_origen"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipos_origen"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_origen" "tipos_origen" "id_tipo_origen"}
