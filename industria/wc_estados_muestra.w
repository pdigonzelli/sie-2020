...
DEFINE VARIABLE h_b_estados_muestras AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b_estados_muestra.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_estados_muestras ).
       RUN set-position IN h_b_estados_muestras ( 2.43 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b_estados_muestras ( 6.71 , 80.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_estados_muestras ,
