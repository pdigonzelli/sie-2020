...
&Scoped-Define ENABLED-OBJECTS RECT-37 
...
DEFINE VARIABLE h_blineasproduccion AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dlineasproduccion AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vlineasproduccion AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Lineas de Produccion */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Lineas de Produccion */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dlineasproduccion ( 10.76 , 98.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'blineasproduccion.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'ScrollRemotenoNumDown0CalcWidthnoMaxWidth80FetchOnReposToEndyesDataSourceNamesUpdateTargetNamesLogicalObjectNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_blineasproduccion ).
       RUN repositionObject IN h_blineasproduccion ( 2.43 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_blineasproduccion ( 7.14 , 110.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vlineasproduccion.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_vlineasproduccion ).
       RUN repositionObject IN h_vlineasproduccion ( 10.52 , 15.00 ) NO-ERROR.
       /* Size in AB:  ( 3.19 , 81.80 ) */
       ...
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 110.00 ) NO-ERROR.

       /* Links to SmartDataObject h_dlineasproduccion. */
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dlineasproduccion ).

       /* Links to SmartDataBrowser h_blineasproduccion. */
       RUN addLink ( h_dlineasproduccion , 'Data':U , h_blineasproduccion ).

       /* Links to SmartDataViewer h_vlineasproduccion. */
       RUN addLink ( h_dlineasproduccion , 'Data':U , h_vlineasproduccion ).
       RUN addLink ( h_vlineasproduccion , 'Update':U , h_dlineasproduccion ).
       RUN addLink ( h_dyntoolbar , 'TableIo':U , h_vlineasproduccion ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_blineasproduccion ,
             h_dyntoolbar , 'AFTER':U ).
       RUN adjustTabOrder ( h_vlineasproduccion ,
             h_blineasproduccion , 'AFTER':U ).
    END. /* Page 0 */
