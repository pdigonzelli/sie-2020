...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-3 
...
DEFINE VARIABLE h_bc_destinos_depositos AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.52 COL 102
     salir AT ROW 10.52 COL 114
     RECT-1 AT ROW 10.29 COL 99
     RECT-3 AT ROW 2.19 COL 2
     SPACE(1.39) SKIP(2.23)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_destinos_depositos.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_destinos_depositos ).
       RUN set-position IN h_bc_destinos_depositos ( 2.67 , 5.00 ) NO-ERROR.
       RUN set-size IN h_bc_destinos_depositos ( 6.71 , 121.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_destinos_depositos ,
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-3 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
