...
DEFINE VARIABLE h_b_lotes_destino AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_lotes_origen AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_tambores_origen AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_lotes_origen.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_lotes_origen ).
       RUN set-position IN h_b_lotes_origen ( 3.62 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 101.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tambores_origen.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tambores_origen ).
       RUN set-position IN h_b_tambores_origen ( 10.52 , 19.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_lotes_destino.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_lotes_destino ).
       RUN set-position IN h_b_lotes_destino ( 17.67 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 79.00 ) */

       /* Links to csmartbrowser h_b_lotes_origen. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_lotes_origen ).

       /* Links to csmartbrowser h_b_tambores_origen. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_origen , 'Record':U , h_b_tambores_origen ).

       /* Links to csmartbrowser h_b_lotes_destino. */
       RUN add-link IN adm-broker-hdl ( h_b_tambores_origen , 'Record':U , h_b_lotes_destino ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_lotes_origen ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tambores_origen ,
             h_b_lotes_origen , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_lotes_destino ,
             h_b_tambores_origen , 'AFTER':U ).
    END. /* Page 0 */
