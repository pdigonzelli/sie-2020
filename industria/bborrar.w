...
rowObject.id_tambor rowObject.Articulo rowObject.Calidad rowObject.Envase ~
rowObject.Ubicacion rowObject.id_empresa rowObject.id_sucursal ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Calidad FORMAT "x(25)":U
      Envase FORMAT "x(25)":U
      Ubicacion FORMAT "x(10)":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[7]   = _<SDO>.rowObject.Ubicacion
     _FldNameList[8]   = _<SDO>.rowObject.id_empresa
     _FldNameList[9]   = _<SDO>.rowObject.id_sucursal
