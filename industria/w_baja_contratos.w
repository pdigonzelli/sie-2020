...
DEFINE VARIABLE h_b_baja_contratos AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_baja_contratos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_baja_contratos ).
       RUN set-position IN h_b_baja_contratos ( 3.86 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.14 , 104.00 ) */

       /* Links to csmartbrowser h_b_baja_contratos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_baja_contratos ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_baja_contratos ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
