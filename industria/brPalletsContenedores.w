...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.contenedor ~
rowObject.tipopallet 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      contenedor FORMAT "X(30)":U
      tipopallet FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 84 BY 6.67 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.contenedor
     _FldNameList[2]   > _<SDO>.rowObject.tipopallet
"tipopallet" ? ? "character" ? ? ? ? ? ? no ? no no "48.8" yes no no "U" "" ""
