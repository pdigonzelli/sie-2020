...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipos_origenes_materia_prima
&Scoped-define FIRST-EXTERNAL-TABLE tipos_origenes_materia_prima


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipos_origenes_materia_prima.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipos_origenes_materia_prima.id_tipo_origen ~
tipos_origenes_materia_prima.descripcion ~
tipos_origenes_materia_prima.abreviatura 
&Scoped-define ENABLED-TABLES tipos_origenes_materia_prima
&Scoped-define FIRST-ENABLED-TABLE tipos_origenes_materia_prima
&Scoped-define DISPLAYED-TABLES tipos_origenes_materia_prima
&Scoped-define FIRST-DISPLAYED-TABLE tipos_origenes_materia_prima
&Scoped-Define DISPLAYED-FIELDS tipos_origenes_materia_prima.id_tipo_origen ~
tipos_origenes_materia_prima.descripcion ~
tipos_origenes_materia_prima.abreviatura 
...
tipos_origenes_materia_prima.id_tipo_origen 
...
DEFINE FRAME F-Main
     tipos_origenes_materia_prima.id_tipo_origen AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     tipos_origenes_materia_prima.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipos_origenes_materia_prima.abreviatura AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipos_origenes_materia_prima
...
/* SETTINGS FOR FILL-IN tipos_origenes_materia_prima.id_tipo_origen IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipos_origenes_materia_prima.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_origenes_materia_prima.abreviatura V-table-Win 
ON LEAVE OF tipos_origenes_materia_prima.abreviatura IN FRAME F-Main /* Abrevitura */
DO:
...
&Scoped-define SELF-NAME tipos_origenes_materia_prima.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_origenes_materia_prima.descripcion V-table-Win 
ON LEAVE OF tipos_origenes_materia_prima.descripcion IN FRAME F-Main /* Decripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tipos_origenes_materia_prima.id_tipo_origen
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_origenes_materia_prima.id_tipo_origen V-table-Win 
ON LEAVE OF tipos_origenes_materia_prima.id_tipo_origen IN FRAME F-Main /* CodTOrigen */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipos_origenes_materia_prima"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipos_origenes_materia_prima"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tipos_origenes_materia_prima"}
