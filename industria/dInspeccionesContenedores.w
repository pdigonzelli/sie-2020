...
sanidad_estado_desc tipo_contenedor calificacion 
...
"tipo_contenedor" "tipo_contenedor" ? ? "character" ? ? ? ? ? ? yes ? no 50 yes
     _FldNameList[33]   > general.inspeccion_contenedores.calificacion
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH rowObjUpd WHERE rowObjUpd.rowMod = "A" OR rowObjUpd.rowMod = "C". 
    ...
    ASSIGN rowObjUpd.id_sucursal_remito     = iSuc
           ...
           rowObjUpd.id_inspeccion          = getNextId()
...
------------------------------------------------------------------------------*/
  ...
  FOR LAST inspeccion_contenedores NO-LOCK.
    iRet = inspeccion_contenedores.id_inspeccion.
  END.
