...
DEFINE VARIABLE h_b_tipos_origen AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_origen AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_origen.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_origen ).
       RUN set-position IN h_b_tipos_origen ( 4.05 , 8.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_origen.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_origen ).
       RUN set-position IN h_v_tipos_origen ( 12.33 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 55.00 ) */

       /* Links to csmartbrowser h_b_tipos_origen. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_origen ).

       /* Links to SmartViewer h_v_tipos_origen. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_origen , 'Record':U , h_v_tipos_origen ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_origen ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_origen ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_origen ,
             h_b_tipos_origen , 'AFTER':U ).
    END. /* Page 0 */
