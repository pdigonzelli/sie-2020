...
DEFINE VARIABLE h_bc_calidades_claro AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.54 COL 63
     salir AT ROW 10.54 COL 75
     RECT-1 AT ROW 10.31 COL 60
     SPACE(3.99) SKIP(0.55)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_calidades_claro.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_calidades_claro ).
       RUN set-position IN h_bc_calidades_claro ( 2.50 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.69 , 75.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_calidades_claro ,
