...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tambores_industria.id_lote FORMAT ">>>9":U WIDTH 7.6
      tambores_industria.Anio FORMAT ">>>9":U WIDTH 8.2
      productos_terminados.descripcion COLUMN-LABEL "Producto" FORMAT "x(25)":U
      tambores_industria.id_tambor FORMAT ">>>9":U WIDTH 10.8
...
"tambores_industria.id_lote" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "7.6" yes no no "U" "" ""
     _FldNameList[3]   > general.tambores_industria.Anio
"tambores_industria.Anio" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
...
"tambores_industria.id_tambor" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "10.8" yes no no "U" "" ""
     _FldNameList[6]   > general.tambores_industria.kilos_tambor
"tambores_industria.kilos_tambor" ? ">>>>9.99" "decimal" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[7]   > general.tambores_industria.Fecha_cierre
"tambores_industria.Fecha_cierre" "Fecha" "99/99/99" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
