...
DEFINE FRAME D-Dialog
     ...
     RECT-6 AT ROW 1.95 COL 6
     SPACE(8.99) SKIP(2.23)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_caracteristicas_quimicas ( 2.43 , 9.00 ) NO-ERROR.
       RUN set-size IN h_b_caracteristicas_quimicas ( 6.71 , 66.00 ) NO-ERROR.
