...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES r_subd_ventas_embarque
&Scoped-define FIRST-EXTERNAL-TABLE r_subd_ventas_embarque


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR r_subd_ventas_embarque.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS r_subd_ventas_embarque.anio_permiso ~
r_subd_ventas_embarque.id_aduana r_subd_ventas_embarque.nro_embarque 
&Scoped-define ENABLED-TABLES r_subd_ventas_embarque
&Scoped-define FIRST-ENABLED-TABLE r_subd_ventas_embarque
&Scoped-define DISPLAYED-TABLES r_subd_ventas_embarque
&Scoped-define FIRST-DISPLAYED-TABLE r_subd_ventas_embarque
&Scoped-Define DISPLAYED-FIELDS r_subd_ventas_embarque.anio_permiso ~
r_subd_ventas_embarque.id_aduana r_subd_ventas_embarque.nro_embarque 
...
DEFINE FRAME F-Main
     r_subd_ventas_embarque.anio_permiso AT ROW 1 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     r_subd_ventas_embarque.id_aduana AT ROW 1.95 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     r_subd_ventas_embarque.nro_embarque AT ROW 3 COL 20.8 COLON-ALIGNED
          LABEL "Permiso de Embarque" FORMAT "XXXX 999999 X"
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: ventas.r_subd_ventas_embarque
...
/* SETTINGS FOR FILL-IN r_subd_ventas_embarque.nro_embarque IN FRAME F-Main
...
&Scoped-define SELF-NAME r_subd_ventas_embarque.anio_permiso
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL r_subd_ventas_embarque.anio_permiso V-table-Win 
ON LEAVE OF r_subd_ventas_embarque.anio_permiso IN FRAME F-Main /* Anio Permiso */
DO:
...
&Scoped-define SELF-NAME r_subd_ventas_embarque.id_aduana
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL r_subd_ventas_embarque.id_aduana V-table-Win 
ON LEAVE OF r_subd_ventas_embarque.id_aduana IN FRAME F-Main /* Cod.Aduana */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME r_subd_ventas_embarque.nro_embarque
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL r_subd_ventas_embarque.nro_embarque V-table-Win 
ON LEAVE OF r_subd_ventas_embarque.nro_embarque IN FRAME F-Main /* Permiso de Embarque */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "r_subd_ventas_embarque"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "r_subd_ventas_embarque"}
