...
rowObject.Moneda rowObject.importe rowObject.Unidad 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.Gasto FORMAT "x(25)":U
      rowObject.Moneda FORMAT "x(25)":U
      rowObject.importe FORMAT "->>>,>>>,>>9.9999":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = _<SDO>.rowObject.Moneda
     _FldNameList[4]   = _<SDO>.rowObject.importe
     _FldNameList[5]   = _<SDO>.rowObject.Unidad
