...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-20 
...
DEFINE VARIABLE h_b_aromas_sabores_prot AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_aromas_sabores_prot AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Aromas y Sabores */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Aromas y Sabores */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_aromas_sabores_prot.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_aromas_sabores_prot ).
       RUN set-position IN h_b_aromas_sabores_prot ( 3.62 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b_aromas_sabores_prot ( 6.71 , 76.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_aromas_sabores_prot.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_aromas_sabores_prot ).
       RUN set-position IN h_v_aromas_sabores_prot ( 11.24 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 63.00 ) */

       /* Links to csmartbrowser h_b_aromas_sabores_prot. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_aromas_sabores_prot ).

       /* Links to SmartViewer h_v_aromas_sabores_prot. */
       RUN add-link IN adm-broker-hdl ( h_b_aromas_sabores_prot , 'Record':U , h_v_aromas_sabores_prot ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_aromas_sabores_prot ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_aromas_sabores_prot ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_aromas_sabores_prot ,
             h_b_aromas_sabores_prot , 'AFTER':U ).
    END. /* Page 0 */
