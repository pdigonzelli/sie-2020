...
&Scoped-Define ENABLED-FIELDS orden_entrega.pendiente orden_entrega.cheque ~
orden_entrega.cotizacion orden_entrega.observaciones ~
orden_entrega.id_tipo_venta orden_entrega.cerrado 
...
&Scoped-Define DISPLAYED-FIELDS orden_entrega.pendiente ~
orden_entrega.cheque orden_entrega.cotizacion orden_entrega.observaciones ~
orden_entrega.id_tipo_venta orden_entrega.cerrado 
...
DEFINE FRAME F-Main
     orden_entrega.pendiente AT ROW 1 COL 9.8 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.4 BY 1
     orden_entrega.cheque AT ROW 1 COL 26 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.4 BY 1
     orden_entrega.cotizacion AT ROW 1 COL 47 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     orden_entrega.observaciones AT ROW 1 COL 92 NO-LABEL
          VIEW-AS EDITOR
          SIZE 50 BY 2
     orden_entrega.id_tipo_venta AT ROW 1.95 COL 10 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     fi-tipo_venta-descripcion AT ROW 1.95 COL 17 COLON-ALIGNED NO-LABEL
     orden_entrega.cerrado AT ROW 1.95 COL 68 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     "Observaciones:" VIEW-AS TEXT
          SIZE 18 BY .95 AT ROW 1 COL 73
...
general.orden_entrega.id_tipo_venta;w_tipo_venta.w;tipo_venta.descripcion;;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME orden_entrega.cerrado
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL orden_entrega.cerrado V-table-Win 
ON LEAVE OF orden_entrega.cerrado IN FRAME F-Main /* Cerrado */
DO:
...
&Scoped-define SELF-NAME orden_entrega.cheque
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL orden_entrega.cheque V-table-Win
ON LEAVE OF orden_entrega.cheque IN FRAME F-Main /* Cheque */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME orden_entrega.id_tipo_venta
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL orden_entrega.id_tipo_venta V-table-Win
ON GO OF orden_entrega.id_tipo_venta IN FRAME F-Main /* TipoVenta */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL orden_entrega.id_tipo_venta V-table-Win
ON LEAVE OF orden_entrega.id_tipo_venta IN FRAME F-Main /* TipoVenta */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL orden_entrega.id_tipo_venta V-table-Win
ON MOUSE-SELECT-DBLCLICK OF orden_entrega.id_tipo_venta IN FRAME F-Main /* TipoVenta */
do: 
define var r as rowid no-undo.
run w_tipo_venta.w(output r).
find tipo_venta where rowid(tipo_venta) = r no-lock no-error.
if available tipo_venta then 
general.orden_entrega.id_tipo_venta:screen-value = string(tipo_venta.id_tipo_venta).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL orden_entrega.id_tipo_venta V-table-Win
ON U1 OF orden_entrega.id_tipo_venta IN FRAME F-Main /* TipoVenta */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&Scoped-define SELF-NAME orden_entrega.pendiente
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL orden_entrega.pendiente V-table-Win
ON LEAVE OF orden_entrega.pendiente IN FRAME F-Main /* Pendiente */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE carga-tipo-venta V-table-Win 
...
general.orden_entrega.id_tipo_venta:SCREEN-VALUE IN FRAME F-Main = STRING(p_tipo_venta).
END PROCEDURE.
...
find first tipo_venta where tipo_venta.id_tipo_venta = integer(orden_entrega.id_tipo_venta:screen-value in frame F-Main)  no-lock no-error .
if available tipo_venta then 
...
define var lista_relacion as character no-undo initial "id_tipo_venta".
