...
&Scoped-define INTERNAL-TABLES tipos_articulos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipos_articulos.id_tipo_articulo ~
tipos_articulos.descripcion tipos_articulos.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_articulos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipos_articulos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_articulos
...
<FOREIGN-KEYS>
id_tipo_articulo||y|general.tipos_articulos.id_tipo_articulo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_tipo_articulo"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_articulos.id_tipo_articulo
      tipos_articulos.descripcion
      tipos_articulos.abreviatura
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_articulos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tipos_articulos.id_tipo_articulo
     _FldNameList[2]   = general.tipos_articulos.descripcion
     _FldNameList[3]   = general.tipos_articulos.abreviatura
...
define sub-menu Ordena 
  menu-item tipos_articulos-id_tipo_articulo
label 'id_tipo_articulo( tipos_articulos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_articulos.id_tipo_articulo').
                  run set-attribute-list('titulo=Tipo de Articulo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_articulos.id_tipo_articulo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipos_articulos-descripcion
label 'descripcion( tipos_articulos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_articulos.descripcion').
                  run set-attribute-list('titulo=Descripción').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_articulos.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipos_articulos-abreviatura
label 'abreviatura( tipos_articulos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_articulos.abreviatura').
                  run set-attribute-list('titulo=Descripción').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_articulos.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipos_articulos.id_tipo_articulo
...
case p:
  WHEN 'tipos_articulos.id_tipo_articulo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_articulo = integer(valor)  no-lock no-error .
  WHEN 'tipos_articulos.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'tipos_articulos.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_articulo" "tipos_articulos" "id_tipo_articulo"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tipos_articulos"}
