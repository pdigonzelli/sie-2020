...
&Scoped-define INTERNAL-TABLES vapores

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table vapores.id_vapor ~
vapores.descripcion vapores.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH vapores WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table vapores
&Scoped-define FIRST-TABLE-IN-QUERY-br_table vapores
...
<FOREIGN-KEYS>
abreviatura||y|comercial.vapores.abreviatura
id_vapor||y|comercial.vapores.id_vapor
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "abreviatura,id_vapor"':U).
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "comercial.vapores"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = comercial.vapores.id_vapor
     _FldNameList[2]   = comercial.vapores.descripcion
     _FldNameList[3]   = comercial.vapores.abreviatura
...
define sub-menu Ordena 
  menu-item vapores-id_vapor
label 'id_vapor( vapores ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=vapores.id_vapor').
                  run set-attribute-list('titulo=Vapor').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by vapores.id_vapor
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item vapores-descripcion
label 'descripcion( vapores ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=vapores.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by vapores.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
case p:
  WHEN 'vapores.id_vapor' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_vapor = integer(valor)  no-lock no-error .
  WHEN 'vapores.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'vapores.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "abreviatura" "vapores" "abreviatura"}
  {src/adm/template/sndkycas.i "id_vapor" "vapores" "id_vapor"}
