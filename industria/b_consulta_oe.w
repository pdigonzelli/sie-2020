...
orden_entrega.semana_embarque orden_entrega.fecha orden_entrega.anio 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      orden_entrega.id_orden_entrega FORMAT ">>>>>9":U WIDTH 10.2
      orden_entrega.semana_embarque COLUMN-LABEL "Semana" FORMAT ">9":U
            WIDTH 10.2
      orden_entrega.fecha FORMAT "99/99/99":U WIDTH 12.2
      orden_entrega.anio FORMAT "9999":U WIDTH 7.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 50 BY 5.71
         FONT 0.
...
"id_orden_entrega" ? ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[2]   > general.orden_entrega.semana_embarque
"semana_embarque" "Semana" ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[3]   > general.orden_entrega.fecha
"fecha" ? ? "date" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[4]   > general.orden_entrega.anio
"anio" ? ? "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
