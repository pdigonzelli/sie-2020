...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Confeccion ~
rowObject.Envase rowObject.Calidad rowObject.Articulo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Confeccion FORMAT "X(30)":U WIDTH 20
      Envase FORMAT "x(30)":U WIDTH 25
      Calidad FORMAT "X(30)":U WIDTH 25
      Articulo FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.Confeccion
"Confeccion" ? ? "character" ? ? ? ? ? ? no "?" no no "20" yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Envase
"Envase" ? ? "character" ? ? ? ? ? ? no ? no no "25" yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.Calidad
"Calidad" ? ? "character" ? ? ? ? ? ? no ? no no "25" yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.Articulo
"Articulo" ? ? "character" ? ? ? ? ? ? no ? no no "33.2" yes no no "U" "" ""
