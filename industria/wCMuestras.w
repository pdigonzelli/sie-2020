...
DEFINE VARIABLE h_dcitemsmuestras-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcitemsmuestras-4 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcitemsprotocolos AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcitemsprotocolos-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcitemsprotocolos-4 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcmuestras AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcmuestras-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcmuestras-4 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcprotocolos AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcprotocolos-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcprotocolos-4 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcprotocolosfulljoin AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcrmuestrasprotocolo AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcrmuestrasprotocolo-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcrmuestrasprotocolo-4 AS HANDLE NO-UNDO.
...
DEFINE BUTTON BUTTON-1 
     LABEL "Lotes y Prot Sin Muestras" 
     SIZE 28.6 BY 1.14.
...
ON CHOOSE OF BUTTON-1 IN FRAME fMain /* Lotes y Prot Sin Muestras */
DO:
  RUN w001QProtocolosLote.w.
END.
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             INPUT  'FolderLabels':U + 'Consulta por Muestras|Consulta por Lotes|Por Contratos' + 'FolderTabWidth0FolderFont-1HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcmuestrasUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcmuestras ).
       ...
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 56.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN constructObject (
             INPUT  'dcmuestras.wDB-AWARE':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsmuestras.id_muestra,id_muestra,muestras.anio_muestra,anio_muestraRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcmuestrasUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcmuestras-2 ).
       RUN repositionObject IN h_dcmuestras-2 ( 6.95 , 13.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsitems_muestras.id_muestra,id_muestra,items_muestras.anio_muestra,anio_muestraRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcitemsmuestrasUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcitemsmuestras-2 ).
       RUN repositionObject IN h_dcitemsmuestras-2 ( 6.95 , 23.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'dcrmuestrasprotocolo.wDB-AWARE':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsr_muestras_protocolos.id_muestra,id_muestra,r_muestras_protocolos.anio,anio_muestra,r_muestras_protocolos.item_muestra,item_muestraRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcrmuestrasprotocoloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcrmuestrasprotocolo-2 ).
       RUN repositionObject IN h_dcrmuestrasprotocolo-2 ( 6.95 , 30.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsprotocolos.id_protocolo,id_protocolo,protocolos.anio,anio,protocolos.id_articulo,id_articuloRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcprotocolosUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcprotocolos-2 ).
       RUN repositionObject IN h_dcprotocolos-2 ( 6.95 , 37.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsitems_protocolos.id_protocolo,id_protocolo,items_protocolos.anio,anio,items_protocolos.id_articulo,id_articuloRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcitemsprotocolosUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcitemsprotocolos-2 ).
       RUN repositionObject IN h_dcitemsprotocolos-2 ( 6.95 , 43.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN repositionObject IN h_dyntoolbar-2 ( 1.00 , 79.60 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar-2 ( 1.24 , 22.40 ) NO-ERROR.
       ...
       /* Links to SmartDataObject h_dcmuestras-2. */
       RUN addLink ( h_dcprotocolosfulljoin , 'Data':U , h_dcmuestras-2 ).

       /* Links to SmartDataObject h_dcitemsmuestras-2. */
       RUN addLink ( h_dcmuestras-2 , 'Data':U , h_dcitemsmuestras-2 ).

       /* Links to SmartDataObject h_dcrmuestrasprotocolo-2. */
       RUN addLink ( h_dcitemsmuestras-2 , 'Data':U , h_dcrmuestrasprotocolo-2 ).

       /* Links to SmartDataObject h_dcprotocolos-2. */
       RUN addLink ( h_dcrmuestrasprotocolo-2 , 'Data':U , h_dcprotocolos-2 ).

       /* Links to SmartDataObject h_dcitemsprotocolos-2. */
       RUN addLink ( h_dcprotocolos-2 , 'Data':U , h_dcitemsprotocolos-2 ).

       /* Links to SmartDataBrowser h_bcitemsprotocolo-2. */
       RUN addLink ( h_dcitemsprotocolos-2 , 'Data':U , h_bcitemsprotocolo-2 ).

       /* Links to SmartDataBrowser h_bcprotocolos-2. */
       RUN addLink ( h_dcprotocolos-2 , 'Data':U , h_bcprotocolos-2 ).

       /* Links to SmartDataBrowser h_bcitemsmuestras-2. */
       RUN addLink ( h_dcitemsmuestras-2 , 'Data':U , h_bcitemsmuestras-2 ).

       /* Links to SmartDataBrowser h_bcmuestras-2. */
       RUN addLink ( h_dcmuestras-2 , 'Data':U , h_bcmuestras-2 ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsmuestras.id_muestra,id_muestra,muestras.anio_muestra,anio_muestraRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcmuestrasUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcmuestras-4 ).
       RUN repositionObject IN h_dcmuestras-4 ( 6.95 , 9.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsitems_muestras.id_muestra,id_muestra,items_muestras.anio_muestra,anio_muestraRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcitemsmuestrasUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcitemsmuestras-4 ).
       RUN repositionObject IN h_dcitemsmuestras-4 ( 6.95 , 16.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'dcrmuestrasprotocolo.wDB-AWARE':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsr_muestras_protocolos.id_muestra,id_muestra,r_muestras_protocolos.anio_muestra,anio_muestra,r_muestras_protocolos.item_muestra,item_muestraRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcrmuestrasprotocoloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcrmuestrasprotocolo-4 ).
       RUN repositionObject IN h_dcrmuestrasprotocolo-4 ( 6.95 , 24.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsprotocolos.id_protocolo,id_protocolo,protocolos.anio,anio,protocolos.id_articulo,id_articuloRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcprotocolosUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcprotocolos-4 ).
       RUN repositionObject IN h_dcprotocolos-4 ( 6.95 , 31.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsitems_protocolos.id_protocolo,id_protocolo,items_protocolos.anio,anio,items_protocolos.id_articulo,id_articuloRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedcitemsprotocolosUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dcitemsprotocolos-4 ).
       RUN repositionObject IN h_dcitemsprotocolos-4 ( 6.95 , 43.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       /* Links to SmartDataObject h_dcmuestras-4. */
       RUN addLink ( h_sdojoincontratos , 'Data':U , h_dcmuestras-4 ).

       /* Links to SmartDataObject h_dcitemsmuestras-4. */
       RUN addLink ( h_dcmuestras-4 , 'Data':U , h_dcitemsmuestras-4 ).

       /* Links to SmartDataObject h_dcrmuestrasprotocolo-4. */
       RUN addLink ( h_dcitemsmuestras-4 , 'Data':U , h_dcrmuestrasprotocolo-4 ).

       /* Links to SmartDataObject h_dcprotocolos-4. */
       RUN addLink ( h_dcrmuestrasprotocolo-4 , 'Data':U , h_dcprotocolos-4 ).

       /* Links to SmartDataObject h_dcitemsprotocolos-4. */
       RUN addLink ( h_dcprotocolos-4 , 'Data':U , h_dcitemsprotocolos-4 ).

       /* Links to SmartDataBrowser h_bcprotocolos-4. */
       RUN addLink ( h_dcprotocolos-4 , 'Data':U , h_bcprotocolos-4 ).

       /* Links to SmartDataBrowser h_bcitemsmuestras-4. */
       RUN addLink ( h_dcitemsmuestras-4 , 'Data':U , h_bcitemsmuestras-4 ).

       /* Links to SmartDataBrowser h_bcmuestras-4. */
       RUN addLink ( h_dcmuestras-4 , 'Data':U , h_bcmuestras-4 ).
