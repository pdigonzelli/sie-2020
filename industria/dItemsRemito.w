...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _FldNameList[1]   > general.items_factura.id_sucursal
"id_sucursal" "id_sucursal" ? ? "integer" ? ? ? ? ? ? yes ? no 8.2 yes
     _FldNameList[2]   > general.items_factura.id_tipo_movsto
"id_tipo_movsto" "id_tipo_movsto" ? ? "integer" ? ? ? ? ? ? yes ? no 9.4 yes
     _FldNameList[3]   > general.items_factura.nro
"nro" "nro" ? ">>>,>>>,>>9" "integer" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[4]   > general.items_factura.item
"item" "item" ? ? "integer" ? ? ? ? ? ? yes ? no 4 yes
     _FldNameList[5]   > general.items_factura.nro_lote
...
"kilos" "kilos" ? ? "decimal" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[9]   > general.items_factura.id_articulo
"id_articulo" "id_articulo" ? ? "integer" ? ? ? ? ? ? yes ? no 10.8 yes
     _FldNameList[10]   > general.items_factura.id_calidad
"id_calidad" "id_calidad" ? ? "integer" ? ? ? ? ? ? yes ? no 7 yes
     _FldNameList[11]   > general.items_factura.id_envase
"id_envase" "id_envase" ? ? "integer" ? ? ? ? ? ? yes ? no 7.2 yes
     _FldNameList[12]   > general.items_factura.id_tipotambor
"id_tipotambor" "id_tipotambor" ? ? "integer" ? ? ? ? ? ? yes ? no 12.6 yes
     _FldNameList[13]   > "_<CALC>"
"getArticulo()" "Articulo" "Articulo" "x(20)" "character" ? ? ? ? ? ? no ? no 20 no
     _FldNameList[14]   > general.items_factura.c_fecha
"c_fecha" "c_fecha" ? ? "date" ? ? ? ? ? ? yes ? no 9.2 yes
     _FldNameList[15]   > general.items_factura.c_hora
"c_hora" "c_hora" ? ? "character" ? ? ? ? ? ? yes ? no 8 yes
     _FldNameList[16]   > general.items_factura.c_usuario
"c_usuario" "c_usuario" ? ? "character" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[17]   > general.items_factura.cantidad
"cantidad" "cantidad" ? ? "decimal" ? ? ? ? ? ? yes ? no 12.6 yes
     _FldNameList[18]   > "_<CALC>"
"getCalidad()" "Calidad" "Calidad" "x(20)" "character" ? ? ? ? ? ? no ? no 20 no
     _FldNameList[19]   > general.items_factura.peso
"peso" "peso" ? ? "decimal" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[20]   > general.items_factura.descripcion
