...
&Scoped-define INTERNAL-TABLES tipo_contenedor

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipo_contenedor.id_tipo_contenedor ~
tipo_contenedor.descripcion tipo_contenedor.precio_thc 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipo_contenedor WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipo_contenedor
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipo_contenedor
...
<FOREIGN-KEYS>
id_tipo_contrato||y|general.tipos_contratos.id_tipo_contrato
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tipo_contenedor.precio_thc
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 74 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipo_contenedor"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tipo_contenedor.id_tipo_contenedor
     _FldNameList[2]   = general.tipo_contenedor.descripcion
     _FldNameList[3]   = general.tipo_contenedor.precio_thc
...
define sub-menu Ordena 
  menu-item tipo_contenedor-id_tipo_contenedor
label 'id_tipo_contenedor( tipo_contenedor ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_contenedor.id_tipo_contenedor').
                  run set-attribute-list('titulo=Tipo de Contenedor').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_contenedor.id_tipo_contenedor
...
label 'descripcion( tipo_contenedor ) '
  ...
  menu-item tipo_contenedor-precio_thc
label 'precio_thc( tipo_contenedor ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_contenedor.precio_thc').
                  run set-attribute-list('titulo=Precio THC').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_contenedor.precio_thc
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipo_contenedor.id_tipo_contenedor
...
case p:
  WHEN 'tipo_contenedor.id_tipo_contenedor' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_contenedor = integer(valor)  no-lock no-error .
  WHEN 'tipo_contenedor.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'tipo_contenedor.precio_thc' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  precio_thc = decimal(valor)  no-lock no-error .
end.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_contrato" "tipos_contratos" "id_tipo_contrato"}
