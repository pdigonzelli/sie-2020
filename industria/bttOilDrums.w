...
rowObject.calidad rowObject.envase rowObject.id_articulo ~
rowObject.id_sucursal_ubicacion rowObject.nromov ~
rowObject.id_locacion_ubicacion 
...
"rowObject.id_lote_prod" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[3]   = _<SDO>.rowObject.id_tambor
     ...
     _FldNameList[11]   = _<SDO>.rowObject.id_locacion_ubicacion
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND hCont:FILE-NAME MATCHES "*fComposicionLoteAceite.w*" THEN DO:
