...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.52 COL 93
     salir AT ROW 10.52 COL 105
     RECT-1 AT ROW 10.29 COL 90
     SPACE(4.79) SKIP(0.56)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_gastos_venta ( 2.67 , 4.00 ) NO-ERROR.
