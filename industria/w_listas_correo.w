...
DEFINE VARIABLE h_b_listas_correo AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_listas_correo AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Listas de Correo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Listas de Correo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_listas_correo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_listas_correo ).
       RUN set-position IN h_b_listas_correo ( 4.10 , 8.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_listas_correo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_listas_correo ).
       RUN set-position IN h_v_listas_correo ( 11.95 , 20.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 44.00 ) */

       /* Links to csmartbrowser h_b_listas_correo. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_listas_correo ).

       /* Links to SmartViewer h_v_listas_correo. */
       RUN add-link IN adm-broker-hdl ( h_b_listas_correo , 'Record':U , h_v_listas_correo ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_listas_correo ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_listas_correo ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_listas_correo ,
             h_b_listas_correo , 'AFTER':U ).
    END. /* Page 0 */
