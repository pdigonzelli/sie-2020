...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES estados_oe
&Scoped-define FIRST-EXTERNAL-TABLE estados_oe


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR estados_oe.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS estados_oe.id_estado estados_oe.descripcion ~
estados_oe.abreviatura 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_estado ~{&FP2}id_estado ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}~
 ~{&FP1}abreviatura ~{&FP2}abreviatura ~{&FP3}
&Scoped-define ENABLED-TABLES estados_oe
&Scoped-define FIRST-ENABLED-TABLE estados_oe
&Scoped-Define DISPLAYED-FIELDS estados_oe.id_estado estados_oe.descripcion ~
estados_oe.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS estados_oe.id_estado 
...
DEFINE FRAME F-Main
     estados_oe.id_estado AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     estados_oe.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     estados_oe.abreviatura AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.estados_oe
...
/* SETTINGS FOR FILL-IN estados_oe.id_estado IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME estados_oe.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL estados_oe.abreviatura V-table-Win
ON LEAVE OF estados_oe.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME estados_oe.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL estados_oe.descripcion V-table-Win
ON LEAVE OF estados_oe.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME estados_oe.id_estado
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL estados_oe.id_estado V-table-Win
ON LEAVE OF estados_oe.id_estado IN FRAME F-Main /* Cod.Estado */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "estados_oe"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "estados_oe"}
