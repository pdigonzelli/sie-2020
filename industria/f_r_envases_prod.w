...
&Scoped-Define ENABLED-OBJECTS RECT-16 RECT-15 RECT-2 
...
DEFINE VARIABLE h_b_r_envases_prod AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_r_envases_prod AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_r_envases_prod.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_r_envases_prod ).
       RUN set-position IN h_b_r_envases_prod ( 3.76 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 122.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_r_envases_prod.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_r_envases_prod ).
       RUN set-position IN h_v_r_envases_prod ( 11.48 , 30.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 64.00 ) */

       /* Links to csmartbrowser h_b_r_envases_prod. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_r_envases_prod ).

       /* Links to SmartViewer h_v_r_envases_prod. */
       RUN add-link IN adm-broker-hdl ( h_b_r_envases_prod , 'Record':U , h_v_r_envases_prod ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_r_envases_prod ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_r_envases_prod ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_r_envases_prod ,
             h_b_r_envases_prod , 'AFTER':U ).
    END. /* Page 0 */
