  FIELD id_lote LIKE lotes_ubicacion.id_lote VALIDATE  FORMAT ">>>>9" LABEL "Lote"~
  FIELD lote LIKE lotes_ubicacion.lote VALIDATE ~
  FIELD id_sucursal LIKE lotes_ubicacion.id_sucursal VALIDATE  FORMAT ">>9" LABEL "Suc"~
  FIELD id_sucursal_ubicacion LIKE lotes_ubicacion.id_sucursal_ubicacion VALIDATE  FORMAT ">>9"~
  FIELD id_tipotambor LIKE lotes_ubicacion.id_tipotambor VALIDATE  FORMAT ">>9" LABEL "TTambor"~
  FIELD cantidad LIKE lotes_ubicacion.cantidad VALIDATE ~
  FIELD id_articulo LIKE lotes_ubicacion.id_articulo VALIDATE  FORMAT ">>9"~
