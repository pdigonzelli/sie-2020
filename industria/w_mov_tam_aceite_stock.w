...
DEFINE VARIABLE h_b_mov_tam_mat_prima_aceite_sto AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_mov_tam_mat_prima_aceite_stock.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_mov_tam_mat_prima_aceite_sto ).
       RUN set-position IN h_b_mov_tam_mat_prima_aceite_sto ( 3.62 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b_mov_tam_mat_prima_aceite_sto ( 19.29 , 114.00 ) NO-ERROR.

       /* Links to csmartbrowser h_b_mov_tam_mat_prima_aceite_sto. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_mov_tam_mat_prima_aceite_sto ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_b_mov_tam_mat_prima_aceite_sto ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_mov_tam_mat_prima_aceite_sto ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
