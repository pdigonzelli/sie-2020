...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_lista ~
rowObject.Agencia rowObject.nombre rowObject.fecha_desde ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_lista FORMAT "->,>>>,>>9":U
      rowObject.Agencia FORMAT "x(25)":U
      rowObject.nombre FORMAT "X(25)":U
      rowObject.fecha_desde FORMAT "99/99/9999":U
      rowObject.fecha_hasta FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_lista
     _FldNameList[2]   = _<SDO>.rowObject.Agencia
     _FldNameList[3]   = _<SDO>.rowObject.nombre
     _FldNameList[4]   = _<SDO>.rowObject.fecha_desde
     _FldNameList[5]   = _<SDO>.rowObject.fecha_hasta
