...
DEFINE FRAME F-Main
     RowObject.id_orden_entrega AT ROW 1 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     RowObject.importe AT ROW 3.19 COL 9 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 18.8 BY 1
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dGastosOrdenEntrega.w"
...
------------------------------------------------------------------------------*/
  ...
  RUN enableField IN h_dynselect.
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dgastosventa ( 1.00 , 34.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_dynselect ).
       RUN repositionObject IN h_dynselect ( 2.10 , 11.00 ) NO-ERROR.
