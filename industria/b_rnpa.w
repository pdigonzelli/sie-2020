...
&Scoped-define INTERNAL-TABLES RNPA

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table RNPA.id_rnpa RNPA.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table RNPA.id_rnpa ~
RNPA.descripcion 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table~
 ~{&FP1}id_rnpa ~{&FP2}id_rnpa ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table RNPA
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table RNPA
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH RNPA WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table RNPA
&Scoped-define FIRST-TABLE-IN-QUERY-br_table RNPA
...
<FOREIGN-KEYS>
id_rnpa||y|general.RNPA.id_rnpa
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.RNPA"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.RNPA.id_rnpa
"id_rnpa" ? ? "character" ? ? ? ? ? ? yes ?
     _FldNameList[2]   > general.RNPA.descripcion
...
define sub-menu Ordena 
  menu-item RNPA-id_rnpa
label 'id_rnpa( RNPA ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=RNPA.id_rnpa').
                  run set-attribute-list('titulo=Nro. RNPA').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by RNPA.id_rnpa
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item RNPA-descripcion
label 'descripcion( RNPA ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=RNPA.descripcion').
                  run set-attribute-list('titulo=Descripción').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by RNPA.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by RNPA.id_rnpa
...
case p:
  WHEN 'RNPA.id_rnpa' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_rnpa begins valor  no-lock no-error .
  WHEN 'RNPA.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_rnpa" "RNPA" "id_rnpa"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "RNPA"}
