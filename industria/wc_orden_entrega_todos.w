...
DEFINE VARIABLE h_bc_orden_entrega_todos AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.52 COL 95
     salir AT ROW 10.52 COL 107
     RECT-1 AT ROW 10.29 COL 92
     RECT-2 AT ROW 2.19 COL 3
     SPACE(2.59) SKIP(2.47)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_orden_entrega_todos.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_orden_entrega_todos ).
       RUN set-position IN h_bc_orden_entrega_todos ( 3.14 , 6.00 ) NO-ERROR.
       RUN set-size IN h_bc_orden_entrega_todos ( 5.48 , 118.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_orden_entrega_todos ,
