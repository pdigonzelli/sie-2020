...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.kilos_tambor ~
rowObject.id_lote rowObject.Anio rowObject.id_articulo rowObject.id_calidad ~
rowObject.id_envase rowObject.calidad rowObject.envase 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      envase FORMAT "x(20)":U WIDTH 13.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 93 BY 6.67 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dtamborindustria.w"
   Allow: Basic,Browse
   Frames: 1
