...
&Scoped-define INTERNAL-TABLES cia_seguro

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table cia_seguro.id_ciaseg ~
cia_seguro.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH cia_seguro WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table cia_seguro
&Scoped-define FIRST-TABLE-IN-QUERY-br_table cia_seguro
...
<FOREIGN-KEYS>
id_ciaseg||y|comercial.cia_seguro.id_ciaseg
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      cia_seguro.id_ciaseg FORMAT ">>9":U WIDTH 9.2
      cia_seguro.descripcion FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "comercial.cia_seguro"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > comercial.cia_seguro.id_ciaseg
"id_ciaseg" ? ? "integer" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" ""
     _FldNameList[2]   = comercial.cia_seguro.descripcion
...
define sub-menu Ordena 
  menu-item cia_seguro-id_ciaseg
label 'id_ciaseg( cia_seguro ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=cia_seguro.id_ciaseg').
                  run set-attribute-list('titulo=Cía. de seguro').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by cia_seguro.id_ciaseg
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item cia_seguro-descripcion
label 'descripcion( cia_seguro ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=cia_seguro.descripcion').
                  run set-attribute-list('titulo=Descripción').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by cia_seguro.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by cia_seguro.id_ciaseg
...
case p:
  WHEN 'cia_seguro.id_ciaseg' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_ciaseg = integer(valor)  no-lock no-error .
  WHEN 'cia_seguro.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_ciaseg" "cia_seguro" "id_ciaseg"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "cia_seguro"}
