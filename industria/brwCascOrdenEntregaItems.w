...
rowObject.fecha rowObject.semana_embarque rowObject.item_oe ~
rowObject.tambores_pedidos rowObject.id_articulo rowObject.id_contrato ~
rowObject.orden_fabricacion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      semana_embarque FORMAT ">9":U
      item_oe FORMAT ">>>9":U
      tambores_pedidos FORMAT ">>>>>>>>>>>9":U WIDTH 20
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "sdocascordenentregaitems.w"
   Allow: Basic,Browse
   Frames: 1
...
ASSIGN 
       rowObject.id_orden_entrega:AUTO-RESIZE IN BROWSE br_table = TRUE
       rowObject.fecha:AUTO-RESIZE IN BROWSE br_table = TRUE
       rowObject.semana_embarque:AUTO-RESIZE IN BROWSE br_table = TRUE
       rowObject.item_oe:AUTO-RESIZE IN BROWSE br_table = TRUE
       rowObject.tambores_pedidos:AUTO-RESIZE IN BROWSE br_table = TRUE
       rowObject.id_articulo:AUTO-RESIZE IN BROWSE br_table = TRUE
       rowObject.id_contrato:AUTO-RESIZE IN BROWSE br_table = TRUE
       rowObject.orden_fabricacion:AUTO-RESIZE IN BROWSE br_table = TRUE.
...
"id_orden_entrega" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes yes no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.fecha
"fecha" ? ? "date" ? ? ? ? ? ? no ? no no ? yes yes no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.semana_embarque
"semana_embarque" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes yes no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.item_oe
"item_oe" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes yes no "U" "" ""
     _FldNameList[5]   > _<SDO>.rowObject.tambores_pedidos
"tambores_pedidos" ? ? "integer" ? ? ? ? ? ? no "?" no no "20" yes yes no "U" "" ""
     _FldNameList[6]   > _<SDO>.rowObject.id_articulo
"id_articulo" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes yes no "U" "" ""
     _FldNameList[7]   > _<SDO>.rowObject.id_contrato
"id_contrato" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes yes no "U" "" ""
     _FldNameList[8]   > _<SDO>.rowObject.orden_fabricacion
"orden_fabricacion" ? ? "integer" ? ? ? ? ? ? no ? no no ? yes yes no "U" "" ""
