...
&Scoped-define INTERNAL-TABLES contratos
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH contratos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table contratos
...
<FOREIGN-KEYS>
id_tipo_contrato|y|y|general.contratos.id_tipo_contrato
id_responsable||y|general.contratos.id_responsable
...
RUN set-attribute-list (
    'Keys-Accepted = "id_tipo_contrato",
     Keys-Supplied = "id_tipo_contrato,id_responsable,id_tipo_plazo"':U).
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 31 BY 6.71
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.contratos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.contratos.id_contrato
     _FldNameList[2]   = general.contratos.anio
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_tipo_contrato':U THEN DO:
       &Scope KEY-PHRASE contratos.id_tipo_contrato eq INTEGER(key-value)
       {&OPEN-QUERY-{&BROWSE-NAME}}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_responsable" "contratos" "id_responsable"}
