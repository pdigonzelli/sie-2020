...
DEFINE VARIABLE h_bc_sucursales AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-1 AT ROW 10.29 COL 61
     RECT-19 AT ROW 1.71 COL 11
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_sucursales.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_sucursales ).
       RUN set-position IN h_bc_sucursales ( 2.43 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_sucursales ,
