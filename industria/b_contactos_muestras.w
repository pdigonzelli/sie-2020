...
&Scoped-define INTERNAL-TABLES contactos_muestras

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table contactos_muestras.id_contacto ~
contactos_muestras.nombre 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH contactos_muestras WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH contactos_muestras WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table contactos_muestras
&Scoped-define FIRST-TABLE-IN-QUERY-br_table contactos_muestras
...
<FOREIGN-KEYS>
id_contacto|y|y|general.contactos_muestras.id_contacto
id_tipo_contacto||y|general.contactos_muestras.id_tipo_contacto
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "id_contacto",
     Keys-Supplied = "id_contacto,id_tipo_contacto"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      contactos_muestras.id_contacto COLUMN-LABEL "Cod" FORMAT ">>>9":U
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.contactos_muestras"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.contactos_muestras.id_contacto
"id_contacto" "Cod" ">>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = general.contactos_muestras.nombre
...
define sub-menu Ordena 
  menu-item contactos_muestras-id_contacto
label 'id_contacto( contactos_muestras ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=contactos_muestras.id_contacto').
                  run set-attribute-list('titulo=Cod. Contacto').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by contactos_muestras.id_contacto
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_contacto':U THEN DO:
       &Scope KEY-PHRASE contactos_muestras.id_contacto eq INTEGER(key-value)
       {&OPEN-QUERY-{&BROWSE-NAME}}
    END. /* id_contacto */
    OTHERWISE DO:
...
RUN dame-tipo-contacto IN hcon (OUTPUT v_tipo).
*/
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_contacto" "contactos_muestras" "id_contacto"}
  {src/adm/template/sndkycas.i "id_tipo_contacto" "contactos_muestras" "id_tipo_contacto"}
