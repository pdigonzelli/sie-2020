  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 4.00 ) NO-ERROR.
       RUN set-size IN h_cus-updsav ( 1.91 , 36.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 45.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_consulta_new_remitos ).
