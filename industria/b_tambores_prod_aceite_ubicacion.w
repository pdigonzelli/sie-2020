...
tambores_industria.id_etiqueta tambores_industria.id_articulo ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria WHERE ~{&KEY-PHRASE} ~
      AND tambores_industria.id_tipotambor = 2 NO-LOCK, ~
...
sucursales productos_terminados envases_prod
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tambores_industria.id_sucursal_ubicacion COLUMN-LABEL "Suc" FORMAT ">>9"
      sucursales.abreviatura
      tambores_industria.id_locacion_ubicacion COLUMN-LABEL "Loc" FORMAT ">>9"
      locaciones.descripcion FORMAT "x(20)"
      tambores_industria.id_etiqueta
      tambores_industria.id_articulo COLUMN-LABEL "Art." FORMAT ">>9"
      productos_terminados.descripcion
      envases_prod.descripcion FORMAT "x(20)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 151 BY 12.62
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_industria,industria.locaciones WHERE general.tambores_industria ...,comercial.sucursales WHERE general.tambores_industria ...,general.productos_terminados OF general.tambores_industria,general.envases_prod OF general.tambores_industria"
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ",,,,"
     _OrdList          = "general.tambores_industria.id_tambor|yes"
