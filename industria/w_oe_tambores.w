...
&Scoped-Define ENABLED-OBJECTS RECT-2 FILL-IN-1 FILL-IN-2 
...
DEFINE VARIABLE h_b_oe_tambores AS HANDLE NO-UNDO.
...
DEFINE VARIABLE FILL-IN-1 AS CHARACTER FORMAT "X(256)":U INITIAL "Ordenes de Entrega" 
     VIEW-AS FILL-IN 
     SIZE 69 BY 1
     BGCOLOR 4 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FILL-IN-2 AS CHARACTER FORMAT "X(256)":U INITIAL "Tambores Asignados" 
     VIEW-AS FILL-IN 
     SIZE 117 BY 1
...
DEFINE FRAME F-Main
     FILL-IN-1 AT ROW 2.91 COL 4 COLON-ALIGNED NO-LABEL
     FILL-IN-2 AT ROW 11.24 COL 3 COLON-ALIGNED NO-LABEL
     RECT-2 AT Y 0 X 375
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Tambores asginados a las OE"
         HEIGHT             = 24.52
         WIDTH              = 125.4
         MAX-HEIGHT         = 24.52
         MAX-WIDTH          = 142.6
...
ON END-ERROR OF W-Win /* Tambores asginados a las OE */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tambores asginados a las OE */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 77.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 100.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_orden_entrega ( 4.10 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 118.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_oe_tambores.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_oe_tambores ).
       RUN set-position IN h_b_oe_tambores ( 12.43 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.62 , 105.00 ) */

       /* Links to csmartbrowser h_b_orden_entrega. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_orden_entrega ).

       /* Links to csmartbrowser h_b_oe_tambores. */
       RUN add-link IN adm-broker-hdl ( h_b_orden_entrega , 'Record':U , h_b_oe_tambores ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_oe_tambores ,
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-2 FILL-IN-1 FILL-IN-2 
      WITH FRAME F-Main IN WINDOW W-Win.
