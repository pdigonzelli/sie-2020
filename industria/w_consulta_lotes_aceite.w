...
&Scoped-Define ENABLED-OBJECTS RECT-23 RECT-2 
...
DEFINE VARIABLE h_b_consulta_lotes_aceite AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_tambores_lotes_aceite AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Consulta de Tambores por Lote de Aceite"
         HEIGHT             = 18.57
         WIDTH              = 134.6
         MAX-HEIGHT         = 19.52
         MAX-WIDTH          = 149.4
...
ON END-ERROR OF W-Win /* Consulta de Tambores por Lote de Aceite */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Consulta de Tambores por Lote de Aceite */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_lotes_aceite.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_lotes_aceite ).
       RUN set-position IN h_b_consulta_lotes_aceite ( 3.57 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 127.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tambores_lotes_aceite.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tambores_lotes_aceite ).
       RUN set-position IN h_b_tambores_lotes_aceite ( 11.19 , 40.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 54.00 ) */

       /* Links to csmartbrowser h_b_consulta_lotes_aceite. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_consulta_lotes_aceite ).

       /* Links to csmartbrowser h_b_tambores_lotes_aceite. */
       RUN add-link IN adm-broker-hdl ( h_b_consulta_lotes_aceite , 'Record':U , h_b_tambores_lotes_aceite ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_lotes_aceite ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tambores_lotes_aceite ,
             h_b_consulta_lotes_aceite , 'AFTER':U ).
    END. /* Page 0 */
