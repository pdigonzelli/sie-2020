...
items_factura.hasta_lote items_factura.cantidad items_factura.kilos 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH items_factura OF remitos WHERE ~{&KEY-PHRASE} NO-LOCK, ~
...
<FOREIGN-KEYS>
nro||y|general.items_factura.nro
id_sucursal||y|general.items_factura.id_sucursal
descripcion||y|general.items_factura.descripcion
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro,id_sucursal,descripcion"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      items_factura.kilos COLUMN-LABEL "KilosTotal" FORMAT ">>>>>9.99":U
            WIDTH 14.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 97 BY 5.24
         FONT 0 ROW-HEIGHT-CHARS .67.
...
"items_factura.id_articulo" "Art" ">>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
"SUBSTRING (items_factura.nro_lote,1,4) @ nroloteremito" "Lote" "9999" ? ? ? ? ? ? ? no ? no no "7" yes no no "U" "" ""
     _FldNameList[5]   > general.items_factura.desde_lote
...
"2000 + integer(substring(items_factura.nro_lote,6,2)) @ nroanio" "Año" "9999" ? ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[7]   > general.items_factura.hasta_lote
"items_factura.hasta_lote" ? ">>>>9" "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
     _FldNameList[8]   > general.items_factura.cantidad
"items_factura.cantidad" ? ">>>>>9" "decimal" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[9]   > general.items_factura.kilos
"items_factura.kilos" "KilosTotal" ">>>>>9.99" "decimal" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" ""
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nro" "items_factura" "nro"}
  {src/adm/template/sndkycas.i "id_sucursal" "items_factura" "id_sucursal"}
  {src/adm/template/sndkycas.i "descripcion" "items_factura" "descripcion"}
