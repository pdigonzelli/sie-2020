...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES centros_stock
&Scoped-define FIRST-EXTERNAL-TABLE centros_stock


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR centros_stock.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS centros_stock.id_centro_stock ~
centros_stock.descripcion 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_centro_stock ~{&FP2}id_centro_stock ~{&FP3}~
 ~{&FP1}descripcion ~{&FP2}descripcion ~{&FP3}
&Scoped-define ENABLED-TABLES centros_stock
&Scoped-define FIRST-ENABLED-TABLE centros_stock
&Scoped-Define DISPLAYED-FIELDS centros_stock.id_centro_stock ~
centros_stock.descripcion 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS centros_stock.id_centro_stock 
...
<FOREIGN-KEYS>
id_centro_stock|y|y|general.centros_stock.id_centro_stock
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "id_centro_stock",
     Keys-Supplied = "id_centro_stock"':U).
/**************************
</EXECUTING-CODE> */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     centros_stock.id_centro_stock AT ROW 1 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     centros_stock.descripcion AT ROW 2 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.centros_stock
...
/* SETTINGS FOR FILL-IN centros_stock.id_centro_stock IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME centros_stock.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL centros_stock.descripcion V-table-Win
ON LEAVE OF centros_stock.descripcion IN FRAME F-Main /* Descripcion */
DO:
...
&Scoped-define SELF-NAME centros_stock.id_centro_stock
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL centros_stock.id_centro_stock V-table-Win
ON LEAVE OF centros_stock.id_centro_stock IN FRAME F-Main /* Centros Stock */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_centro_stock':U THEN
       {src/adm/template/find-tbl.i
           &TABLE = centros_stock
           &WHERE = "WHERE centros_stock.id_centro_stock eq INTEGER(key-value)"
       }
  END CASE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "centros_stock"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "centros_stock"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_centro_stock" "centros_stock" "id_centro_stock"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "centros_stock"}
