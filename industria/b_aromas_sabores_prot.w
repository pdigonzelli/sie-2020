...
&Scoped-define INTERNAL-TABLES aromas_sabores_prot

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table aromas_sabores_prot.id_aroma_sabor ~
aromas_sabores_prot.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH aromas_sabores_prot WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table aromas_sabores_prot
&Scoped-define FIRST-TABLE-IN-QUERY-br_table aromas_sabores_prot
...
<FOREIGN-KEYS>
id_aroma_sabor||y|general.aromas_sabores_prot.id_aroma_sabor
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_aroma_sabor"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      aromas_sabores_prot.id_aroma_sabor FORMAT ">>9":U WIDTH 11.2
      aromas_sabores_prot.descripcion FORMAT "X(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.aromas_sabores_prot"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.aromas_sabores_prot.id_aroma_sabor
"id_aroma_sabor" ? ? "integer" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[2]   = general.aromas_sabores_prot.descripcion
...
define sub-menu Ordena 
  menu-item aromas_sabores_prot-id_aroma_sabor
label 'id_aroma_sabor( aromas_sabores_prot ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=aromas_sabores_prot.id_aroma_sabor').
                  run set-attribute-list('titulo=CodAromaSabor').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by aromas_sabores_prot.id_aroma_sabor
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item aromas_sabores_prot-descripcion
label 'descripcion( aromas_sabores_prot ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=aromas_sabores_prot.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by aromas_sabores_prot.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by aromas_sabores_prot.id_aroma_sabor
...
case p:
  WHEN 'aromas_sabores_prot.id_aroma_sabor' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_aroma_sabor = integer(valor)  no-lock no-error .
  WHEN 'aromas_sabores_prot.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_aroma_sabor" "aromas_sabores_prot" "id_aroma_sabor"}
