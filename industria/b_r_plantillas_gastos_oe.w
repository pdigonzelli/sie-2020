...
&Scoped-define INTERNAL-TABLES r_plantillas_gastos_oe
...
r_plantillas_gastos_oe.id_condicion_venta ~
r_plantillas_gastos_oe.id_gasto_incluido ~
r_plantillas_gastos_oe.tabla_relacionada 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH r_plantillas_gastos_oe WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table r_plantillas_gastos_oe
&Scoped-define FIRST-TABLE-IN-QUERY-br_table r_plantillas_gastos_oe
...
DEFINE QUERY br_table FOR 
      r_plantillas_gastos_oe SCROLLING.
&ANALYZE-RESUME
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 77 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.r_plantillas_gastos_oe"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.r_plantillas_gastos_oe.id_condicion_venta
     _FldNameList[2]   = general.r_plantillas_gastos_oe.id_gasto_incluido
     _FldNameList[3]   = general.r_plantillas_gastos_oe.tabla_relacionada
...
define sub-menu Ordena 
  menu-item r_plantillas_gastos_oe-id_condicion_venta
label 'id_condicion_venta( r_plantillas_gastos_oe ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_plantillas_gastos_oe.id_condicion_venta').
                  run set-attribute-list('titulo=Cod. Condicion Venta').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_plantillas_gastos_oe.id_condicion_venta
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item r_plantillas_gastos_oe-id_gasto_incluido
label 'id_gasto_incluido( r_plantillas_gastos_oe ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_plantillas_gastos_oe.id_gasto_incluido').
                  run set-attribute-list('titulo=Cod.Gastos Incluidos').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_plantillas_gastos_oe.id_gasto_incluido
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item r_plantillas_gastos_oe-tabla_relacionada
label 'tabla_relacionada( r_plantillas_gastos_oe ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_plantillas_gastos_oe.tabla_relacionada').
                  run set-attribute-list('titulo=Tabla Relacionada').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_plantillas_gastos_oe.tabla_relacionada
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by r_plantillas_gastos_oe.id_condicion_venta
...
case p:
  WHEN 'r_plantillas_gastos_oe.id_condicion_venta' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_condicion_venta = integer(valor)  no-lock no-error .
  WHEN 'r_plantillas_gastos_oe.id_gasto_incluido' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_gasto_incluido = integer(valor)  no-lock no-error .
  WHEN 'r_plantillas_gastos_oe.tabla_relacionada' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  tabla_relacionada begins valor  no-lock no-error .
end.
END PROCEDURE.
