...
&Scoped-define INTERNAL-TABLES prioridades

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table prioridades.id_prioridad ~
prioridades.descripcion prioridades.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH prioridades WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH prioridades WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table prioridades
&Scoped-define FIRST-TABLE-IN-QUERY-br_table prioridades
...
<FOREIGN-KEYS>
id_prioridad||y|general.prioridades.id_prioridad
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      prioridades.id_prioridad FORMAT ">>9":U
      prioridades.descripcion FORMAT "X(30)":U
      prioridades.abreviatura FORMAT "X(12)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.prioridades"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.prioridades.id_prioridad
     _FldNameList[2]   = general.prioridades.descripcion
     _FldNameList[3]   = general.prioridades.abreviatura
...
define sub-menu Ordena 
  menu-item prioridades-id_prioridad
label 'id_prioridad( prioridades ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=prioridades.id_prioridad').
                  run set-attribute-list('titulo=CodPrioridad').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by prioridades.id_prioridad
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item prioridades-descripcion
label 'descripcion( prioridades ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=prioridades.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by prioridades.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item prioridades-abreviatura
label 'abreviatura( prioridades ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=prioridades.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by prioridades.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by prioridades.id_prioridad
...
case p:
  WHEN 'prioridades.id_prioridad' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_prioridad = integer(valor)  no-lock no-error .
  WHEN 'prioridades.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'prioridades.abreviatura' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_prioridad" "prioridades" "id_prioridad"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "prioridades"}
