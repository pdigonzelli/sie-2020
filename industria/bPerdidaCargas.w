...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_proceso ~
rowObject.id_carga rowObject.anio rowObject.fecha rowObject.kilos ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_proceso
     _FldNameList[2]   = _<SDO>.rowObject.id_carga
     _FldNameList[3]   = _<SDO>.rowObject.anio
     _FldNameList[4]   = _<SDO>.rowObject.fecha
     _FldNameList[5]   = _<SDO>.rowObject.kilos
     _FldNameList[6]   = _<SDO>.rowObject.kilos_400
     _FldNameList[7]   = _<SDO>.rowObject.brix_20_20
     _FldNameList[8]   = _<SDO>.rowObject.acidez_p_p
     _FldNameList[9]   = _<SDO>.rowObject.litros
     _FldNameList[10]   > _<SDO>.rowObject.solidos
"solidos" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
