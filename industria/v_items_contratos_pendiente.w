...
&Scoped-Define ENABLED-FIELDS items_contratos.pendiente 
...
&Scoped-Define DISPLAYED-FIELDS items_contratos.pendiente 
...
DEFINE FRAME F-Main
     items_contratos.pendiente AT ROW 1 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.4 BY 1
...
assign baja_contrato.id_contrato        = items_contrato.id_contrato
       baja_contrato.id_tipo_contrato   = items_contrato.id_tipo_contrato
       baja_contrato.anio               = items_contrato.anio
       baja_contrato.item               = items_contrato.item
       baja_contrato.c_usuario          = userid("userdb") + "-pen"
