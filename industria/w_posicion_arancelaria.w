...
DEFINE VARIABLE h_b_posicion_arancelaria AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_posicion_arancelaria AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_posicion_arancelaria.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_posicion_arancelaria ).
       RUN set-position IN h_b_posicion_arancelaria ( 3.62 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 85.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_posicion_arancelaria.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_posicion_arancelaria ).
       RUN set-position IN h_v_posicion_arancelaria ( 11.24 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.81 , 72.00 ) */

       /* Links to csmartbrowser h_b_posicion_arancelaria. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_posicion_arancelaria ).

       /* Links to SmartViewer h_v_posicion_arancelaria. */
       RUN add-link IN adm-broker-hdl ( h_b_posicion_arancelaria , 'Record':U , h_v_posicion_arancelaria ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_posicion_arancelaria ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_posicion_arancelaria ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_posicion_arancelaria ,
             h_b_posicion_arancelaria , 'AFTER':U ).
    END. /* Page 0 */
