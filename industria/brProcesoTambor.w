...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Articulo FORMAT "x(15)":U
      Calidad FORMAT "x(15)":U
      Envase FORMAT "x(15)":U
      nromov FORMAT ">>>,>>>,>>9":U
      nromov_proceso COLUMN-LABEL "NromovProceso" FORMAT ">>>,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"Lote" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[10]   > _<SDO>.rowObject.nromov_proceso
"nromov_proceso" "NromovProceso" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
