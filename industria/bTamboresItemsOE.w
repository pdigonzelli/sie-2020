...
rowObject.abreviatura rowObject.id_lote rowObject.Anio rowObject.id_tambor ~
rowObject.id_articulo rowObject.descripcion rowObject.Fecha ~
rowObject.id_contrato_of rowObject.item_of rowObject.id_orden_entrega ~
rowObject.item_oe 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.abreviatura FORMAT "X(10)":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 140 BY 6.67 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dtamboresitemsoe.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.abreviatura
     _FldNameList[3]   = _<SDO>.rowObject.id_lote
     _FldNameList[4]   = _<SDO>.rowObject.Anio
     _FldNameList[5]   = _<SDO>.rowObject.id_tambor
     _FldNameList[6]   = _<SDO>.rowObject.id_articulo
     _FldNameList[7]   = _<SDO>.rowObject.descripcion
     _FldNameList[8]   = _<SDO>.rowObject.Fecha
     _FldNameList[9]   = _<SDO>.rowObject.id_contrato_of
     _FldNameList[10]   = _<SDO>.rowObject.item_of
     _FldNameList[11]   = _<SDO>.rowObject.id_orden_entrega
     _FldNameList[12]   = _<SDO>.rowObject.item_oe
