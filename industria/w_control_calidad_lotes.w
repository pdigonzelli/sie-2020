...
DEFINE VARIABLE h_b_control_calidad_lotes AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_control_calidad_lotes AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Control de Calidad de los Lotes de Jugo"
         HEIGHT             = 15.48
         WIDTH              = 130.6
         MAX-HEIGHT         = 20.33
         MAX-WIDTH          = 139.2
...
ON END-ERROR OF W-Win /* Control de Calidad de los Lotes de Jugo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Control de Calidad de los Lotes de Jugo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_control_calidad_lotes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_control_calidad_lotes ).
       RUN set-position IN h_b_control_calidad_lotes ( 3.76 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b_control_calidad_lotes ( 6.71 , 122.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_control_calidad_lotes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_control_calidad_lotes ).
       RUN set-position IN h_v_control_calidad_lotes ( 12.05 , 37.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 64.00 ) */

       /* Links to csmartbrowser h_b_control_calidad_lotes. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_control_calidad_lotes ).

       /* Links to SmartViewer h_v_control_calidad_lotes. */
       RUN add-link IN adm-broker-hdl ( h_b_control_calidad_lotes , 'Record':U , h_v_control_calidad_lotes ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_control_calidad_lotes ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_control_calidad_lotes ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_control_calidad_lotes ,
             h_b_control_calidad_lotes , 'AFTER':U ).
    END. /* Page 0 */
...
alta = false.
run dispatch in h_b_control_calidad_lotes ('open_query':U).
