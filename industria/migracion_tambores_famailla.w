...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Migración de datos de Famailla"
         HEIGHT             = 9.71
         WIDTH              = 122.4
         MAX-HEIGHT         = 23.71
         MAX-WIDTH          = 122.4
...
ON END-ERROR OF W-Win /* Migración de datos de Famailla */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Migración de datos de Famailla */
DO:
...
ON CHOOSE OF BUTTON-2 IN FRAME F-Main /* Migración de datos */
DO:
...
------------------------------------------------------------------------------*/
                ...
                */
                ...
                message "Se terminó la importación de datos de Lavalle" view-as alert-box.
