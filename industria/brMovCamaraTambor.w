...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.item rowObject.Lote ~
rowObject.Anio rowObject.id_tambor rowObject.Kilos rowObject.Articulo ~
rowObject.Calidad rowObject.Envase rowObject.FilaOrigen ~
rowObject.ColumnaOrigen rowObject.FilaDestino rowObject.ColumnaDestino ~
rowObject.id_sucursal rowObject.nromov 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.FilaOrigen FORMAT "x(8)":U
      rowObject.ColumnaOrigen FORMAT "x(8)":U
      rowObject.FilaDestino FORMAT "x(8)":U
      rowObject.ColumnaDestino FORMAT "x(8)":U
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "drMovCamaraTambor.w"
   Allow: Basic,Browse
   Frames: 1
...
"rowObject.item" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[5]   = _<SDO>.rowObject.Kilos
     _FldNameList[6]   = _<SDO>.rowObject.Articulo
     _FldNameList[7]   = _<SDO>.rowObject.Calidad
     _FldNameList[8]   = _<SDO>.rowObject.Envase
     _FldNameList[9]   > _<SDO>.rowObject.FilaOrigen
"rowObject.FilaOrigen" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[10]   = _<SDO>.rowObject.ColumnaOrigen
     _FldNameList[11]   = _<SDO>.rowObject.FilaDestino
     _FldNameList[12]   > _<SDO>.rowObject.ColumnaDestino
"rowObject.ColumnaDestino" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[13]   > _<SDO>.rowObject.id_sucursal
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND hCont:FILE-NAME MATCHES "*wMovimientosCamara.w" THEN DO:
    ...
    ASSIGN rowObject.ITEM:BGCOLOR IN BROWSE br_table           = ibgcolor
           rowObject.lote:BGCOLOR IN BROWSE br_table           = ibgcolor
           ...
           rowObject.id_sucursal:BGCOLOR IN BROWSE br_table    = ibgcolor
           rowObject.nromov:BGCOLOR IN BROWSE br_table         = ibgcolor
           rowObject.filaorigen:BGCOLOR IN BROWSE br_table     = ibgcolor
           rowObject.columnaorigen:BGCOLOR IN BROWSE br_table  = ibgcolor
           rowObject.filadestino:BGCOLOR IN BROWSE br_table    = ibgcolor
           rowObject.columnadestino:BGCOLOR IN BROWSE br_table = ibgcolor.
