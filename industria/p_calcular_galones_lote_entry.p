DEFINE INPUT PARAMETER p_nromov AS INTEGER.
DEFINE INPUT PARAMETER p_id_orden_entrega AS INTEGER.
...
for each tambores_industria where tambores_industria.nromov             = p_nromov
                              AND tambores_industria.id_orden_entrega   = p_id_orden_entrega
