...
&Scoped-define FIELDS-IN-QUERY-br_table items_factura.fecha ~
items_factura.id_articulo items_factura.id_calidad items_factura.nro_lote ~
items_factura.desde_lote items_factura.hasta_lote items_factura.peso ~
items_factura.kilos 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH items_factura OF remitos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table items_factura
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      items_factura.fecha FORMAT "99/99/99":U
      items_factura.id_articulo FORMAT ">>>>>>>>9":U WIDTH 12.2
      items_factura.id_calidad FORMAT "->>9":U WIDTH 11.2
      items_factura.nro_lote FORMAT "999/9999":U WIDTH 11.2
      items_factura.desde_lote FORMAT ">>>>>9":U WIDTH 9.2
      items_factura.hasta_lote FORMAT ">>>>>9":U WIDTH 10.2
      items_factura.peso FORMAT ">>,>>9.9999":U WIDTH 14.2
      items_factura.kilos FORMAT ">>,>>9.9999":U WIDTH 14.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.items_factura OF general.remitos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.items_factura.fecha
     _FldNameList[2]   > general.items_factura.id_articulo
"items_factura.id_articulo" ? ? "integer" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[3]   > general.items_factura.id_calidad
"items_factura.id_calidad" ? ? "integer" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[4]   > general.items_factura.nro_lote
"items_factura.nro_lote" ? ? "character" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[5]   > general.items_factura.desde_lote
"items_factura.desde_lote" ? ? "integer" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" ""
     _FldNameList[6]   > general.items_factura.hasta_lote
"items_factura.hasta_lote" ? ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[7]   > general.items_factura.peso
"items_factura.peso" ? ? "decimal" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" ""
     _FldNameList[8]   > general.items_factura.kilos
"items_factura.kilos" ? ? "decimal" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" ""
