...
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-1 aceptar salir 
...
DEFINE VARIABLE h_bc_envases AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_envases.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_envases ).
       RUN set-position IN h_bc_envases ( 2.43 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 77.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_envases ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-4 RECT-1 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
