...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-3 aceptar salir 
...
DEFINE VARIABLE h_b_destinos_grupos AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     RECT-3 AT ROW 1.71 COL 7
     SPACE(7.99) SKIP(2.47)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_destinos_grupos.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_destinos_grupos ).
       RUN set-position IN h_b_destinos_grupos ( 2.43 , 12.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_destinos_grupos ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-1 RECT-3 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
