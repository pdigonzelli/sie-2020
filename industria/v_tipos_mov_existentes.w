...
tipos_mov_existentes.id_posicion_origen ~
tipos_mov_existentes.id_posicion_destino 
&Scoped-Define DISPLAYED-OBJECTS fi-tipos_movimientos-descripcio emp_des ~
emp_or suc_or suc_des loc_or loc_des fi-posiciones-descripcion ~
fi-posiciones-descripcion-1 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipos_mov_existentes.id_empresa_destino ~
tipos_mov_existentes.id_empresa_origen ~
tipos_mov_existentes.id_sucursal_destino ~
tipos_mov_existentes.id_sucursal_origen ~
tipos_mov_existentes.id_locacion_destino ~
...
DEFINE VARIABLE emp_des AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 38 BY .95
     FGCOLOR 1  NO-UNDO.

DEFINE VARIABLE emp_or AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 40 BY .95
     FGCOLOR 1  NO-UNDO.
...
DEFINE VARIABLE loc_des AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 38 BY .95
     FGCOLOR 1  NO-UNDO.

DEFINE VARIABLE loc_or AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 40 BY .95
     FGCOLOR 1  NO-UNDO.

DEFINE VARIABLE suc_des AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 38 BY .95
     FGCOLOR 1  NO-UNDO.

DEFINE VARIABLE suc_or AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 40 BY 1.05
     FGCOLOR 1  NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     tipos_mov_existentes.id_tipo_mov_existente AT ROW 2 COL 25 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     tipos_mov_existentes.id_empresa_destino AT ROW 2.91 COL 93 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     emp_des AT ROW 2.91 COL 103 COLON-ALIGNED NO-LABEL
     tipos_mov_existentes.id_empresa_origen AT ROW 3 COL 25 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     emp_or AT ROW 3 COL 35 COLON-ALIGNED NO-LABEL
     tipos_mov_existentes.id_sucursal_destino AT ROW 3.91 COL 93 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     suc_or AT ROW 3.95 COL 35 COLON-ALIGNED NO-LABEL
     suc_des AT ROW 3.95 COL 103 COLON-ALIGNED NO-LABEL
     tipos_mov_existentes.id_sucursal_origen AT ROW 4 COL 25 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     tipos_mov_existentes.id_locacion_destino AT ROW 4.91 COL 93 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     tipos_mov_existentes.id_locacion_origen AT ROW 5 COL 25 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     loc_or AT ROW 5 COL 35 COLON-ALIGNED NO-LABEL
     loc_des AT ROW 5 COL 103 COLON-ALIGNED NO-LABEL
     ...
     tipos_mov_existentes.id_posicion_origen AT ROW 6 COL 25 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     tipos_mov_existentes.id_posicion_destino AT ROW 6.05 COL 93 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     fi-posiciones-descripcion-1 AT ROW 6.05 COL 103 COLON-ALIGNED NO-LABEL
...
/* SETTINGS FOR FILL-IN emp_des IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN emp_or IN FRAME F-Main
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN fi-tipos_movimientos-descripcio IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN tipos_mov_existentes.id_empresa_destino IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN tipos_mov_existentes.id_empresa_origen IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN tipos_mov_existentes.id_locacion_destino IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN tipos_mov_existentes.id_locacion_origen IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN tipos_mov_existentes.id_sucursal_destino IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN tipos_mov_existentes.id_sucursal_origen IN FRAME F-Main
   1                                                                    */
/* SETTINGS FOR FILL-IN loc_des IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN loc_or IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN suc_des IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN suc_or IN FRAME F-Main
   NO-ENABLE                                                            */
...
general.tipos_mov_existentes.id_posicion_origen;wc_posiciones.w;posiciones.descripcion;;
general.tipos_mov_existentes.id_posicion_destino;wc_posiciones.w;posiciones.descripcion;;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME emp_des
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL emp_des V-table-Win
ON LEAVE OF emp_des IN FRAME F-Main
DO:
...
&Scoped-define SELF-NAME emp_or
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL emp_or V-table-Win
ON LEAVE OF emp_or IN FRAME F-Main
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME fi-posiciones-descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-posiciones-descripcion V-table-Win
ON LEAVE OF fi-posiciones-descripcion IN FRAME F-Main
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME fi-posiciones-descripcion-1
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-posiciones-descripcion-1 V-table-Win
ON LEAVE OF fi-posiciones-descripcion-1 IN FRAME F-Main
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME fi-tipos_movimientos-descripcio
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-tipos_movimientos-descripcio V-table-Win
ON LEAVE OF fi-tipos_movimientos-descripcio IN FRAME F-Main
DO:
{custom/support/validacion.i}
END.
...
do:
    ...
    general.tipos_mov_existentes.id_empresa_destino:screen-value = string(posiciones.id_empresa).
    general.tipos_mov_existentes.id_sucursal_destino:screen-value = string(posiciones.id_sucursal).
    general.tipos_mov_existentes.id_locacion_destino:screen-value = string(posiciones.id_locacion).
end.    
apply 'U1' to self.
end.
...
do: 
    ...
    general.tipos_mov_existentes.id_empresa_origen:screen-value = string(posiciones.id_empresa).
    general.tipos_mov_existentes.id_sucursal_origen:screen-value = string(posiciones.id_sucursal).
    general.tipos_mov_existentes.id_locacion_origen:screen-value = string(posiciones.id_locacion).
...
&Scoped-define SELF-NAME loc_des
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL loc_des V-table-Win
ON LEAVE OF loc_des IN FRAME F-Main
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME loc_or
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL loc_or V-table-Win
ON LEAVE OF loc_or IN FRAME F-Main
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME suc_des
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL suc_des V-table-Win
ON LEAVE OF suc_des IN FRAME F-Main
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME suc_or
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL suc_or V-table-Win
ON LEAVE OF suc_or IN FRAME F-Main
DO:
{custom/support/validacion.i}
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
message "post-create" tipos_mov_existentes.id_sucursal_origen:screen-value in frame F-Main view-as alert-box.
END PROCEDURE.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
message "pre-create" tipos_mov_existentes.id_sucursal_origen:screen-value in frame F-Main view-as alert-box.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE backup-del-dobleclick V-table-Win 
PROCEDURE backup-del-dobleclick :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
------------------------------------------------------------------------------*/
/*********************empresas*************************************************/
find first empresas where empresas.id_empresa = integer(tipos_mov_existentes.id_empresa_origen:screen-value in frame F-Main)  no-lock no-error .
if available empresas then 
emp_or:screen-value in frame F-Main = string(empresas.razon_social).
else
emp_or:screen-value in frame F-Main = ''.

find first empresas where empresas.id_empresa = integer(tipos_mov_existentes.id_empresa_destino:screen-value in frame F-Main)  no-lock no-error .
if available empresas then 
emp_des:screen-value in frame F-Main = string(empresas.razon_social).
else
emp_des:screen-value in frame F-Main = ''.


/*******************sucursales***********************************************/
find first sucursales where sucursales.id_sucursal = integer(tipos_mov_existentes.id_sucursal_origen:screen-value in frame F-Main)  no-lock no-error .
if available sucursales then 
suc_or:screen-value in frame F-Main = string(sucursales.nombre).
else
suc_or:screen-value in frame F-Main = ''.

find first sucursales where sucursales.id_sucursal = integer(tipos_mov_existentes.id_sucursal_destino:screen-value in frame F-Main)  no-lock no-error .
if available empresas then 
suc_des:screen-value in frame F-Main = string(sucursales.nombre).
else
suc_des:screen-value in frame F-Main = ''.


/******************locaciones************************************************/
find first locaciones where locaciones.id_locacion = integer(tipos_mov_existentes.id_locacion_origen:screen-value in frame F-Main)  no-lock no-error .
if available locaciones then 
loc_or:screen-value in frame F-Main = string(locaciones.descripcion).
else
loc_or:screen-value in frame F-Main = ''.

find first locaciones where locaciones.id_locacion = integer(tipos_mov_existentes.id_locacion_destino:screen-value in frame F-Main)  no-lock no-error .
if available locaciones then 
loc_des:screen-value in frame F-Main = string(locaciones.descripcion).
else
loc_des:screen-value in frame F-Main = ''.
