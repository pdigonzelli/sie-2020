...
/* ***************************  Definitions  ************************** */
 ...
 DEFINE INPUT PARAMETER v_nombre_impresora AS CHARACTER FORMAT "x(60)".
...
IF AVAILABLE vapor THEN
   ...
   IF v_fda-2 <> " " Then
   DO:
      v_texto_prod = "produced in FAMAILLA (PLANT II) - FDA # 18228479994".
...
IF v_cascara = NO THEN
   RUN  aderb\_prntrb2(
       ...
       v_nombre_impresora,                /* RB-PRINTER-NAME */
       "",                              /* RB-PRINTER-PORT */
       "",                              /* RB-OUTPUT-FILE */
