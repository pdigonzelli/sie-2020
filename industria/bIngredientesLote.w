...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_articulo_insumo ~
rowObject.Insumo rowObject.cantidad rowObject.Unidad rowObject.inicial ~
rowObject.final 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_articulo_insumo FORMAT "->,>>>,>>9":U
      rowObject.Insumo FORMAT "x(30)":U
      rowObject.cantidad FORMAT ">>,>>>,>>9":U
      rowObject.Unidad FORMAT "x(20)":U
      rowObject.inicial FORMAT ">,>>>,>>9":U
      rowObject.final FORMAT "->,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_articulo_insumo
     _FldNameList[2]   = _<SDO>.rowObject.Insumo
     _FldNameList[3]   = _<SDO>.rowObject.cantidad
     _FldNameList[4]   = _<SDO>.rowObject.Unidad
     _FldNameList[5]   = _<SDO>.rowObject.inicial
     _FldNameList[6]   = _<SDO>.rowObject.final
