...
DEFINE FRAME D-Dialog
     ...
     RECT-24 AT ROW 1.71 COL 5
     SPACE(8.99) SKIP(2.71)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_contramarcas ( 2.43 , 11.00 ) NO-ERROR.
       RUN set-size IN h_b_contramarcas ( 6.71 , 66.00 ) NO-ERROR.
