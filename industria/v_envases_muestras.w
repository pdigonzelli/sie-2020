...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES envases_muestras
&Scoped-define FIRST-EXTERNAL-TABLE envases_muestras


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR envases_muestras.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS envases_muestras.id_envase ~
envases_muestras.descripcion envases_muestras.abreviatura ~
envases_muestras.descripcion_ingles envases_muestras.volumen 
&Scoped-define ENABLED-TABLES envases_muestras
&Scoped-define FIRST-ENABLED-TABLE envases_muestras
&Scoped-define DISPLAYED-TABLES envases_muestras
&Scoped-define FIRST-DISPLAYED-TABLE envases_muestras
&Scoped-Define DISPLAYED-FIELDS envases_muestras.id_envase ~
envases_muestras.descripcion envases_muestras.abreviatura ~
envases_muestras.descripcion_ingles envases_muestras.volumen 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS envases_muestras.id_envase 
...
DEFINE FRAME F-Main
     envases_muestras.id_envase AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     envases_muestras.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 42 BY 1
     envases_muestras.abreviatura AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
     envases_muestras.descripcion_ingles AT ROW 4.1 COL 14 COLON-ALIGNED
          LABEL "Desc. Ingles"
          VIEW-AS FILL-IN 
          SIZE 42 BY 1
     envases_muestras.volumen AT ROW 5.05 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 18 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.envases_muestras
...
/* SETTINGS FOR FILL-IN envases_muestras.descripcion_ingles IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN envases_muestras.id_envase IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME envases_muestras.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL envases_muestras.abreviatura V-table-Win
ON LEAVE OF envases_muestras.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME envases_muestras.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL envases_muestras.descripcion V-table-Win
ON LEAVE OF envases_muestras.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME envases_muestras.id_envase
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL envases_muestras.id_envase V-table-Win
ON LEAVE OF envases_muestras.id_envase IN FRAME F-Main /* CodEnvase */
DO:
{custom/support/validacion.i}
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN envases_muestras.c_usuario   = USERID("userdb")
       envases_muestras.c_fecha     = TODAY
       envases_muestras.c_hora      = STRING(TIME,"HH:MM:SS").
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "envases_muestras"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "envases_muestras"}
