...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_articulo ~
rowObject.articulo rowObject.litros rowObject.kilos rowObject.kilos400 ~
rowObject.solidos 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_articulo
...
"kilos" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[6]   = _<SDO>.rowObject.solidos
