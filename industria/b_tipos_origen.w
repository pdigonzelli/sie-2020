...
&Scoped-define INTERNAL-TABLES tipos_origen

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipos_origen.id_tipo_origen ~
tipos_origen.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_origen WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table tipos_origen
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_origen
...
<FOREIGN-KEYS>
id_tipo_origen||y|general.tipos_origen.id_tipo_origen
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_origen"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tipos_origen.id_tipo_origen
...
define sub-menu Ordena 
  menu-item tipos_origen-id_tipo_origen
label 'id_tipo_origen( tipos_origen ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_origen.id_tipo_origen').
                  run set-attribute-list('titulo=Tipo Origen').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_origen.id_tipo_origen
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipos_origen-descripcion
label 'descripcion( tipos_origen ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_origen.descripcion').
                  run set-attribute-list('titulo=Descripción').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_origen.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipos_origen.id_tipo_origen
