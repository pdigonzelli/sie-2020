...
&Scoped-Define ENABLED-OBJECTS RECT-7 RECT-9 RECT-6 RECT-5 RECT-2 RECT-8 ~
RECT-4 sucursal articulo calidad BUTTON-3 BUTTON-4 BUTTON-20 BUTTON-24 ~
BUTTON-5 BUTTON-6 BUTTON-21 BUTTON-23 BUTTON-13 BUTTON-15 BUTTON-14 ~
BUTTON-19 BUTTON-16 BUTTON-17 BUTTON-18 nombre_articulo nombre_calidad 
&Scoped-Define DISPLAYED-OBJECTS sucursal articulo calidad FILL-IN-6 ~
FILL-IN-10 FILL-IN-7 FILL-IN-9 FILL-IN-8 nombre_articulo nombre_calidad 
...
DEFINE VARIABLE FILL-IN-6 AS CHARACTER FORMAT "X(256)":U INITIAL "Listados Stock Completos" 
     VIEW-AS FILL-IN 
     SIZE 57 BY 1
...
DEFINE FRAME F-Main
     ...
     FILL-IN-6 AT ROW 7.67 COL 2 COLON-ALIGNED NO-LABEL
     FILL-IN-10 AT ROW 7.67 COL 66 COLON-ALIGNED NO-LABEL
     BUTTON-3 AT ROW 9.1 COL 5
     BUTTON-4 AT ROW 9.1 COL 33
     BUTTON-20 AT ROW 9.1 COL 68
     BUTTON-24 AT ROW 9.1 COL 97
     BUTTON-5 AT ROW 10.52 COL 5
     BUTTON-6 AT ROW 10.52 COL 33
     BUTTON-21 AT ROW 10.52 COL 68
     BUTTON-23 AT ROW 10.52 COL 97
     ...
     RECT-9 AT ROW 7.19 COL 65
     RECT-6 AT ROW 12.43 COL 2
     RECT-5 AT ROW 7.19 COL 2
...
ON CHOOSE OF BUTTON-3 IN FRAME F-Main /* Listado desde Lavalle */
DO:
  define var v_filtro as char.
  define var v_articulo as integer.
  define var v_calidad as integer.
...
if integer(sucursal:screen-value in frame F-Main) = 95 or 
  ...
  run w_calculo_stock_tambores.p (input integer(sucursal:screen-value in frame F-Main)).
...
ON CHOOSE OF BUTTON-4 IN FRAME F-Main /* Stock x OF desde Lavalle */
DO:
  define var v_filtro as char.
  define var v_articulo as integer.
  define var v_calidad as integer.
...
if integer(sucursal:screen-value in frame F-Main) = 95 or 
  ...
  /************************************************************************************************************/
         ...
         RUN  aderb\_prntrb2(
         "..\industria\reports.prl", /* RB-REPORT-LIBRARY */
         "rep_stock_agrupado_of",                    /* RB-REPORT-NAME */
         "",                             /* RB-DB-CONNECTION */
         "O",                             /* RB-INCLUDE-RECORDS */
         v_filtro,                              /* RB-FILTER */
         RB-MEMO-FILE,                              /* RB-MEMO-FILE */
...
ON CHOOSE OF BUTTON-5 IN FRAME F-Main /* Listado desde Famailla */
DO:
  define var v_filtro as char.
  define var v_articulo as integer.
  define var v_calidad as integer.
...
ON CHOOSE OF BUTTON-6 IN FRAME F-Main /* Stock x OF desde Famailla */
DO:
  define var v_filtro as char.
  define var v_articulo as integer.
  define var v_calidad as integer.
...
if integer(sucursal:screen-value in frame F-Main) = 95 or 
  ...
  /************************************************************************************************************/
         ...
         RUN  aderb\_prntrb2(
         "..\industria\reports.prl", /* RB-REPORT-LIBRARY */
         "rep_stock_agrupado_of_citrix",                    /* RB-REPORT-NAME */
         "",                             /* RB-DB-CONNECTION */
         "O",                             /* RB-INCLUDE-RECORDS */
         v_filtro,                              /* RB-FILTER */
         RB-MEMO-FILE,                              /* RB-MEMO-FILE */
...
------------------------------------------------------------------------------*/
  DISPLAY sucursal articulo calidad FILL-IN-6 FILL-IN-10 FILL-IN-7 FILL-IN-9 
          FILL-IN-8 nombre_articulo nombre_calidad 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-7 RECT-9 RECT-6 RECT-5 RECT-2 RECT-8 RECT-4 sucursal articulo 
         calidad BUTTON-3 BUTTON-4 BUTTON-20 BUTTON-24 BUTTON-5 BUTTON-6 
         BUTTON-21 BUTTON-23 BUTTON-13 BUTTON-15 BUTTON-14 BUTTON-19 BUTTON-16 
         BUTTON-17 BUTTON-18 nombre_articulo nombre_calidad 
      WITH FRAME F-Main IN WINDOW W-Win.
