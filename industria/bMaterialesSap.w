...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_material_sap ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_material_sap FORMAT "X(18)":U
      descripcion_sap FORMAT "X(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_material_sap
     _FldNameList[2]   = _<SDO>.rowObject.descripcion_sap
