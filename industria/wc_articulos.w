...
DEFINE VARIABLE h_bc_articulos AS HANDLE NO-UNDO.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Consulta de Articulos */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_articulos.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_articulos ).
       RUN set-position IN h_bc_articulos ( 2.19 , 12.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_articulos ,
