...
DEFINE FRAME F-Main
     ...
     FILL-IN-4 AT ROW 10.05 COL 3 NO-LABEL
     FILL-IN-5 AT ROW 18.38 COL 3 NO-LABEL
     BUTTON-1 AT ROW 19.81 COL 92
     BUTTON-2 AT ROW 21.71 COL 92
...
run dispatch in h_b_tambores_de_lote ('open-query':U).
...
DO:
  ...
  run get-rowid1 in h_b_tambores_de_lote (output r).
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_lotes_jugo_consulta ( 2.43 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_lotes_jugo_consulta ( 7.38 , 150.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_tambores_de_lote ( 11.24 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_tambores_de_lote ( 6.91 , 138.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_seleccion_locaciones ( 19.57 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 19.81 , 124.00 ) NO-ERROR.
