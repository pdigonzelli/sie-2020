...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_composicion_cascara.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_bolsas_cascara_en_lote.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_composicion_cascara.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_stock_cascara.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
