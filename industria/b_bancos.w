...
&Scoped-define FIELDS-IN-QUERY-br_table bancos.id_banco bancos.nombre ~
bancos.domicilio bancos.localidad bancos.provincia bancos.pais 
...
<FOREIGN-KEYS>
id_banco||y|comercial.bancos.id_banco
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      bancos.id_banco
      bancos.nombre FORMAT "x(25)"
      bancos.domicilio FORMAT "x(25)"
      bancos.localidad
      bancos.provincia FORMAT "x(15)"
      bancos.pais FORMAT "x(10)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "comercial.bancos"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = comercial.bancos.id_banco
     _FldNameList[2]   > comercial.bancos.nombre
"nombre" ? "x(25)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > comercial.bancos.domicilio
"domicilio" ? "x(25)" "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   = comercial.bancos.localidad
     _FldNameList[5]   > comercial.bancos.provincia
"provincia" ? "x(15)" "character" ? ? ? ? ? ? no ?
     _FldNameList[6]   > comercial.bancos.pais
"pais" ? "x(10)" "character" ? ? ? ? ? ? no ?
...
define sub-menu Ordena 
  menu-item bancos-id_banco
label 'id_banco( bancos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=bancos.id_banco').
                  run set-attribute-list('titulo=Cód.Banco').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by bancos.id_banco
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item bancos-nombre
label 'nombre( bancos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=bancos.nombre').
                  run set-attribute-list('titulo=Nombre').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by bancos.nombre
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item bancos-domicilio
label 'domicilio( bancos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=bancos.domicilio').
                  run set-attribute-list('titulo=Domicilio').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by bancos.domicilio
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item bancos-localidad
label 'localidad( bancos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=bancos.localidad').
                  run set-attribute-list('titulo=Localidad').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by bancos.localidad
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item bancos-provincia
label 'provincia( bancos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=bancos.provincia').
                  run set-attribute-list('titulo=Provincia').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by bancos.provincia
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item bancos-pais
label 'pais( bancos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=bancos.pais').
                  run set-attribute-list('titulo=País').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by bancos.pais
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by bancos.id_banco
...
case p:
  WHEN 'bancos.id_banco' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_banco = integer(valor)  no-lock no-error .
  WHEN 'bancos.nombre' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  nombre begins valor  no-lock no-error .
  WHEN 'bancos.domicilio' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  domicilio begins valor  no-lock no-error .
  WHEN 'bancos.localidad' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  localidad begins valor  no-lock no-error .
  WHEN 'bancos.provincia' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  provincia begins valor  no-lock no-error .
  WHEN 'bancos.pais' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  pais begins valor  no-lock no-error .
end.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_banco" "bancos" "id_banco"}
