...
DEFINE VARIABLE h_b_tipo_unidad_venta AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipo_unidad_venta AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tipo de Inidad de Venta */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipo de Inidad de Venta */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipo_unidad_venta.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipo_unidad_venta ).
       RUN set-position IN h_b_tipo_unidad_venta ( 3.86 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 76.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipo_unidad_venta.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipo_unidad_venta ).
       RUN set-position IN h_v_tipo_unidad_venta ( 11.95 , 17.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 49.00 ) */

       /* Links to csmartbrowser h_b_tipo_unidad_venta. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipo_unidad_venta ).

       /* Links to SmartViewer h_v_tipo_unidad_venta. */
       RUN add-link IN adm-broker-hdl ( h_b_tipo_unidad_venta , 'Record':U , h_v_tipo_unidad_venta ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipo_unidad_venta ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipo_unidad_venta ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipo_unidad_venta ,
             h_b_tipo_unidad_venta , 'AFTER':U ).
    END. /* Page 0 */
