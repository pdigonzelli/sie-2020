...
<FOREIGN-KEYS>
id_tipotambor||y|general.composicion_lote.id_tipotambor
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      composicion_lote.Fecha FORMAT "99/99/99":U
      composicion_lote.Numeracion_desde COLUMN-LABEL "Desde Bolsa" FORMAT ">>>>>9":U
            WIDTH 16.2
      composicion_lote.Numeracion_hasta COLUMN-LABEL "Hasta" FORMAT ">>>>>9":U
      composicion_lote.cantidad_tambores COLUMN-LABEL "Cantidad Bolsas" FORMAT ">>>>9":U
            WIDTH 22
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"composicion_lote.Fecha" ? "99/99/99" "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > general.composicion_lote.Numeracion_desde
"composicion_lote.Numeracion_desde" "Desde Bolsa" ">>>>>9" "integer" ? ? ? ? ? ? no ? no no "16.2" yes no no "U" "" ""
     _FldNameList[3]   > general.composicion_lote.Numeracion_hasta
"composicion_lote.Numeracion_hasta" "Hasta" ">>>>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > general.composicion_lote.cantidad_tambores
"composicion_lote.cantidad_tambores" "Cantidad Bolsas" ">>>>9" "integer" ? ? ? ? ? ? no ? no no "22" yes no no "U" "" ""
...
define sub-menu Ordena 
  menu-item composicion_lote-Fecha
label 'Fecha( composicion_lote ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=composicion_lote.Fecha').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by composicion_lote.Fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item composicion_lote-Numeracion_desde
label 'Numeracion_desde( composicion_lote ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=composicion_lote.Numeracion_desde').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by composicion_lote.Numeracion_desde
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item composicion_lote-Numeracion_hasta
label 'Numeracion_hasta( composicion_lote ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=composicion_lote.Numeracion_hasta').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by composicion_lote.Numeracion_hasta
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item composicion_lote-cantidad_tambores
label 'cantidad_tambores( composicion_lote ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=composicion_lote.cantidad_tambores').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by composicion_lote.cantidad_tambores
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by composicion_lote.Fecha
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipotambor" "composicion_lote" "id_tipotambor"}
