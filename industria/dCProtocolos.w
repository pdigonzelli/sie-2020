...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "general.protocolos,industria.aromas_sabores_prot WHERE general.protocolos ...,industria.cuerpo_prot WHERE general.protocolos ...,industria.colores_prot OF general.protocolos,industria.contramarcas OF general.protocolos,industria.tipos_protocolos OF general.protocolos"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ", OUTER, OUTER, OUTER,,"
     _JoinCode[2]      = "general.aromas_sabores_prot.id_aroma_sabor = general.protocolos.id_smell_flavor"
     _JoinCode[3]      = "general.cuerpo_prot.id_cuerpo = general.protocolos.id_smell_flavor"
