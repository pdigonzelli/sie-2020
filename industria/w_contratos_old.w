...
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-5 b-detalle 
...
DEFINE FRAME F-Main
     b-detalle AT ROW 1.48 COL 120
     RECT-4 AT ROW 1 COL 30
     RECT-5 AT ROW 10.52 COL 1
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 65.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 87.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 31.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_contratos ( 3.62 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v_contratos ( 10.76 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.05 , 151.00 ) */
       ...
       RUN add-link IN adm-broker-hdl ( h_b_contratos , 'Record':U , h_v_contratos ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_contratos ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_cus-updsav-2 ( 1.24 , 31.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_items_contratos ( 3.62 , 2.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b_contratos , 'Record':U , h_b_items_contratos ).
...
------------------------------------------------------------------------------*/
  ENABLE RECT-4 RECT-5 b-detalle 
