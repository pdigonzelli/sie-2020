...
&Scoped-define INTERNAL-TABLES quimicos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table quimicos.id_quimico quimicos.nombre 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH quimicos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table quimicos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table quimicos
...
<FOREIGN-KEYS>
id_quimico||y|general.quimicos.id_quimico
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.quimicos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.quimicos.id_quimico
     _FldNameList[2]   = general.quimicos.nombre
...
define sub-menu Ordena 
  menu-item quimicos-id_quimico
label 'id_quimico( quimicos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=quimicos.id_quimico').
                  run set-attribute-list('titulo=Quimicos').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by quimicos.id_quimico
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item quimicos-nombre
label 'nombre( quimicos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=quimicos.nombre').
                  run set-attribute-list('titulo=Nombre').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by quimicos.nombre
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by quimicos.id_quimico
...
case p:
  WHEN 'quimicos.id_quimico' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_quimico = integer(valor)  no-lock no-error .
  WHEN 'quimicos.nombre' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_quimico" "quimicos" "id_quimico"}
