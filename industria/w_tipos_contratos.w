...
DEFINE VARIABLE h_b_tipos_contratos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_contratos AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tipos de Contratos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipos de Contratos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_contratos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_contratos ).
       RUN set-position IN h_b_tipos_contratos ( 3.62 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 72.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_contratos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_contratos ).
       RUN set-position IN h_v_tipos_contratos ( 11.24 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.10 , 72.00 ) */

       /* Links to csmartbrowser h_b_tipos_contratos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_contratos ).

       /* Links to SmartViewer h_v_tipos_contratos. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_contratos , 'Record':U , h_v_tipos_contratos ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_contratos ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_contratos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_contratos ,
             h_b_tipos_contratos , 'AFTER':U ).
    END. /* Page 0 */
