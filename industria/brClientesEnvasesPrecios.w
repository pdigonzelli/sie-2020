...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.nombre rowObject.articulo ~
rowObject.envase rowObject.calibre 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      nombre COLUMN-LABEL "Cliente" FORMAT "x(30)":U
      articulo COLUMN-LABEL "Articulo" FORMAT "x(30)":U
      envase COLUMN-LABEL "Envase" FORMAT "x(30)":U WIDTH 32
      calibre FORMAT "XXX/X":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 114 BY 6.67 EXPANDABLE.
...
"nombre" "Cliente" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.articulo
"articulo" "Articulo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.envase
"envase" "Envase" ? "character" ? ? ? ? ? ? no ? no no "32" yes no no "U" "" ""
