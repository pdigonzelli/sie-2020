...
&Scoped-define INTERNAL-TABLES r_productos_calidad_envase envases_prod ~
...
r_productos_calidad_envase.id_articulo productos_terminados.descripcion ~
r_productos_calidad_envase.id_calidad calidades.abreviatura ~
r_productos_calidad_envase.id_envase envases_prod.descripcion ~
r_productos_calidad_envase.Kilos 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH r_productos_calidad_envase WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH envases_prod OF r_productos_calidad_envase NO-LOCK, ~
      EACH productos_terminados OF r_productos_calidad_envase NO-LOCK, ~
      EACH calidades OF r_productos_calidad_envase NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table r_productos_calidad_envase ~
envases_prod productos_terminados calidades
&Scoped-define FIRST-TABLE-IN-QUERY-br_table r_productos_calidad_envase
...
<FOREIGN-KEYS>
id_calidad||y|general.r_productos_calidad_envase.id_calidad
id_envase||y|general.r_productos_calidad_envase.id_envase
id_articulo||y|general.r_productos_calidad_envase.id_articulo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_calidad,id_envase,id_articulo"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      r_productos_calidad_envase.id_articulo FORMAT ">>9"
      productos_terminados.descripcion FORMAT "x(25)"
      r_productos_calidad_envase.id_calidad FORMAT ">>9"
      calidades.abreviatura
      r_productos_calidad_envase.id_envase
      envases_prod.descripcion FORMAT "x(25)"
      r_productos_calidad_envase.Kilos FORMAT ">>>>>9.99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 141 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.r_productos_calidad_envase,general.envases_prod OF general.r_productos_calidad_envase,general.productos_terminados OF general.r_productos_calidad_envase,general.calidades OF general.r_productos_calidad_envase"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.r_productos_calidad_envase.id_articulo
"r_productos_calidad_envase.id_articulo" ? ">>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   > general.productos_terminados.descripcion
"productos_terminados.descripcion" ? "x(25)" "character" ? ? ? ? ? ? no ?
     _FldNameList[3]   > general.r_productos_calidad_envase.id_calidad
"r_productos_calidad_envase.id_calidad" ? ">>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[4]   = general.calidades.abreviatura
     _FldNameList[5]   = general.r_productos_calidad_envase.id_envase
     _FldNameList[6]   > general.envases_prod.descripcion
"envases_prod.descripcion" ? "x(25)" "character" ? ? ? ? ? ? no ?
     _FldNameList[7]   > general.r_productos_calidad_envase.Kilos
"r_productos_calidad_envase.Kilos" ? ">>>>>9.99" "decimal" ? ? ? ? ? ? no ?
...
define sub-menu Ordena 
  menu-item r_productos_calidad_envase-id_articulo
label 'id_articulo( r_productos_calidad_envase ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_productos_calidad_envase.id_articulo').
                  run set-attribute-list('titulo=Código').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_productos_calidad_envase.id_articulo
...
label 'descripcion( productos_terminados ) '
  ...
  menu-item r_productos_calidad_envase-id_calidad
label 'id_calidad( r_productos_calidad_envase ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_productos_calidad_envase.id_calidad').
                  run set-attribute-list('titulo=Calidad').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_productos_calidad_envase.id_calidad
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'abreviatura( calidades ) '
  ...
  menu-item r_productos_calidad_envase-id_envase
label 'id_envase( r_productos_calidad_envase ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_productos_calidad_envase.id_envase').
                  run set-attribute-list('titulo=Envase').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_productos_calidad_envase.id_envase
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'descripcion( envases_prod ) '
  ...
  menu-item r_productos_calidad_envase-Kilos
label 'Kilos( r_productos_calidad_envase ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_productos_calidad_envase.Kilos').
                  run set-attribute-list('titulo=Kilos').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_productos_calidad_envase.Kilos
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by r_productos_calidad_envase.id_articulo
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_calidad" "r_productos_calidad_envase" "id_calidad"}
  {src/adm/template/sndkycas.i "id_envase" "r_productos_calidad_envase" "id_envase"}
  {src/adm/template/sndkycas.i "id_articulo" "r_productos_calidad_envase" "id_articulo"}
