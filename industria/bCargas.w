...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Tanque FORMAT "x(10)":U
      litros FORMAT "->,>>>,>>9":U
      Fecha FORMAT "99/99/9999":U
      volumen_final FORMAT ">>,>>9.99":U
      Sucursal FORMAT "x(15)":U
      nromov FORMAT ">>>,>>>,>>9":U
      SolSolubles FORMAT "->>,>>>,>>9.99":U
      Coef FORMAT ">,>>9.99":U
      Kilos FORMAT ">>>,>>>,>>9.99":U
      Kilos400 FORMAT ">>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"id_carga" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
...
"Sucursal" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
