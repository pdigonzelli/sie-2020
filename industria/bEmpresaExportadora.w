...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_empresa_exportadora ~
rowObject.nombre 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_empresa_exportadora FORMAT ">>>>>9":U
      nombre FORMAT "X(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_empresa_exportadora
     _FldNameList[2]   > _<SDO>.rowObject.nombre
"nombre" ? ? "character" ? ? ? ? ? ? no ? no no "45" yes no no "U" "" ""
