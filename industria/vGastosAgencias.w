...
&Scoped-Define DISPLAYED-FIELDS RowObject.id_agencia RowObject.importe 
...
DEFINE FRAME F-Main
     RowObject.id_agencia AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     RowObject.importe AT ROW 3 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
...
/* SETTINGS FOR FILL-IN RowObject.id_agencia IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dgastosventa ( 2.19 , 35.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_dynselect ).
       RUN repositionObject IN h_dynselect ( 2.00 , 16.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_dynselect ,
             RowObject.id_agencia:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
