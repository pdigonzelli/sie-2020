...
DEFINE VARIABLE h_b_tipos_limon AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_limon AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tipos Limon */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipos Limon */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_limon.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_limon ).
       RUN set-position IN h_b_tipos_limon ( 3.76 , 8.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_limon.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_limon ).
       RUN set-position IN h_v_tipos_limon ( 11.29 , 18.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 48.00 ) */

       /* Links to csmartbrowser h_b_tipos_limon. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_limon ).

       /* Links to SmartViewer h_v_tipos_limon. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_limon , 'Record':U , h_v_tipos_limon ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_limon ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_limon ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_limon ,
             h_b_tipos_limon , 'AFTER':U ).
    END. /* Page 0 */
