...
DEFINE VARIABLE h_b_lugar_descarga AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_lugar_descarga AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Lugares de Descarga */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Lugares de Descarga */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_lugar_descarga.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_lugar_descarga ).
       RUN set-position IN h_b_lugar_descarga ( 3.86 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_lugar_descarga ( 6.71 , 77.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_lugar_descarga.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_lugar_descarga ).
       RUN set-position IN h_v_lugar_descarga ( 11.24 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.14 , 71.00 ) */

       /* Links to csmartbrowser h_b_lugar_descarga. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_lugar_descarga ).

       /* Links to SmartViewer h_v_lugar_descarga. */
       RUN add-link IN adm-broker-hdl ( h_b_lugar_descarga , 'Record':U , h_v_lugar_descarga ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_lugar_descarga ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_lugar_descarga ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_lugar_descarga ,
             h_b_lugar_descarga , 'AFTER':U ).
    END. /* Page 0 */
