...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH contactos_muestras WHERE ~{&KEY-PHRASE} ~
      AND contactos_muestras.id_tipo_contacto <> 2 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "general.contactos_muestras.id_tipo_contacto <> 2"
     _FldNameList[1]   > general.contactos_muestras.id_contacto
"contactos_muestras.id_contacto" "Cod" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
