...
items_contratos.id_contrato items_contratos.anio items_contratos.item ~
items_contratos.cantidad items_contratos.semana_entrega ~
items_contratos.semana_entrega_hasta 
...
<FOREIGN-KEYS>
id_tipo_contrato|y|y|general.items_contratos.id_tipo_contrato
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      items_contratos.semana_entrega COLUMN-LABEL "Semana desde"
      items_contratos.semana_entrega_hasta COLUMN-LABEL "Semana hasta"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 114 BY 6.71
         BGCOLOR 6 FGCOLOR 15 FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[6]   > general.items_contratos.semana_entrega
"semana_entrega" "Semana desde" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[7]   > general.items_contratos.semana_entrega_hasta
"semana_entrega_hasta" "Semana hasta" ? "integer" ? ? ? ? ? ? no ?
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_tipo_contrato':U THEN DO:
       &Scope KEY-PHRASE items_contratos.id_tipo_contrato eq INTEGER(key-value)
