...
&Scoped-define FIELDS-IN-QUERY-br_table envases_prod.id_envase ~
envases_prod.id_articulo_stock envases_prod.descripcion ~
envases_prod.envase_packing envases_prod.pallets envases_prod.produccion ~
envases_prod.Tara 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH envases_prod WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table envases_prod
&Scoped-define FIRST-TABLE-IN-QUERY-br_table envases_prod
...
<FOREIGN-KEYS>
id_envase||y|general.envases_prod.id_envase
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      envases_prod.id_envase FORMAT ">>9":U
      envases_prod.id_articulo_stock FORMAT ">>>>>>>>9":U
      envases_prod.descripcion FORMAT "x(30)":U
      envases_prod.envase_packing FORMAT "SI/NO":U
      envases_prod.pallets FORMAT ">>9":U
      envases_prod.produccion FORMAT "si/no":U
      envases_prod.Tara FORMAT ">>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 129 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = general.envases_prod.id_envase
     _FldNameList[2]   = general.envases_prod.id_articulo_stock
     _FldNameList[3]   = general.envases_prod.descripcion
     _FldNameList[4]   = general.envases_prod.envase_packing
     _FldNameList[5]   = general.envases_prod.pallets
     _FldNameList[6]   = general.envases_prod.produccion
     _FldNameList[7]   = general.envases_prod.Tara
...
define sub-menu Ordena 
  menu-item envases_prod-id_envase
label 'id_envase( envases_prod ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=envases_prod.id_envase').
                  run set-attribute-list('titulo=Envase').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by envases_prod.id_envase
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item envases_prod-id_articulo_stock
label 'id_articulo_stock( envases_prod ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=envases_prod.id_articulo_stock').
                  run set-attribute-list('titulo=Código Stock').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by envases_prod.id_articulo_stock
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'descripcion( envases_prod ) '
  ...
  menu-item envases_prod-envase_packing
label 'envase_packing( envases_prod ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=envases_prod.envase_packing').
                  run set-attribute-list('titulo=Envase Packing').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by envases_prod.envase_packing
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item envases_prod-pallets
label 'pallets( envases_prod ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=envases_prod.pallets').
                  run set-attribute-list('titulo=Pallets').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by envases_prod.pallets
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item envases_prod-produccion
label 'produccion( envases_prod ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=envases_prod.produccion').
                  run set-attribute-list('titulo=Produccion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by envases_prod.produccion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item envases_prod-Tara
label 'Tara( envases_prod ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=envases_prod.Tara').
                  run set-attribute-list('titulo=Tara').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by envases_prod.Tara
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by envases_prod.id_envase
...
case p:
  WHEN 'envases_prod.id_envase' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_envase = integer(valor)  no-lock no-error .
  WHEN 'envases_prod.id_articulo_stock' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_articulo_stock = integer(valor)  no-lock no-error .
  WHEN 'envases_prod.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'envases_prod.envase_packing' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  envase_packing no-lock no-error .
  WHEN 'envases_prod.pallets' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  pallets = integer(valor)  no-lock no-error .
  WHEN 'envases_prod.produccion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  produccion no-lock no-error .
  WHEN 'envases_prod.Tara' then  
