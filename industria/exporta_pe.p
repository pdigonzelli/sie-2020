 ...
 lst-titulos = "Anio,PE,Aduana,OE,Fecha Of.,Importe,Gastos,Fecha Ingreso,Ingresado,Saldo,Fecha Vto.,FechaEnvioTuc,Facturas".
 lst-width   = "8,15,20,10,8,10,10,10,10,10,8,8,40".
 ...
 chWorkSheet:Columns("I"):NumberFormat = "dd/mm/yy".
 chWorkSheet:Columns("L"):NumberFormat = "dd/mm/yy".
 ...
 for each permisos_embarque 
     where length(permisos_embarque.id_permiso_embarque) = 11 AND 
           ...
           ,first aduanas where aduanas.id_aduana = permisos_embarque.id_aduana NO-LOCK BY permisos_embarque.fecha_oficializacion .
            ...
            FIND FIRST orden_entrega where orden_entrega.id_orden_entrega = permisos_embarque.id_orden_entrega no-lock no-error.
          ...
          /*>> CALCULO DEL MONTO INGRESADO <<*/
            ...
            for each r_ingresos_pe where  r_ingresos_pe.anio = permisos_embarque.anio and
                ...
                vfechaing = r_ingresos_pe.fecha_ingreso.
            end.                               
          ...
          /* FACTURAS VINCULADAS CON EL PERMISO DE EMBARQUE*/
           ...
           IF vfact <> ""  THEN DO:
            ...
            lst-valores = string(permisos_embarque.anio) + "," + 
                          ...
                          STRING(permisos_embarque.fecha_envio_tuc) + "," + 
                          vfact.
            ...
            do i=1 to num-entries(lst-valores):
              ...
              IF CHR(97 + i) = "f" OR CHR(97 + i) = "l" OR CHR(97 + i) = "i" THEN
