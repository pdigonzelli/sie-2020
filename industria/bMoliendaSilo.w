...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Linea rowObject.fecha ~
rowObject.id_turno rowObject.Molienda rowObject.responsable_turno 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_turno FORMAT "->,>>>,>>9":U
      Molienda FORMAT ">>>,>>>,>>9.99":U
      responsable_turno FORMAT "X(25)":U WIDTH 24
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Linea
     _FldNameList[2]   = _<SDO>.rowObject.fecha
     _FldNameList[3]   = _<SDO>.rowObject.id_turno
     _FldNameList[4]   = _<SDO>.rowObject.Molienda
     _FldNameList[5]   > _<SDO>.rowObject.responsable_turno
"responsable_turno" ? ? "character" ? ? ? ? ? ? no ? no no "24" yes no no "U" "" ""
...
DO:
  ...
  CASE rowObject.id_turno:
    WHEN 1 THEN iBgColor = 23.
    WHEN 2 THEN iBgColor = 19.
    WHEN 3 THEN iBgColor = 25.
  END CASE.

  ASSIGN rowObject.linea:BGCOLOR IN BROWSE br_table             = ibgcolor
         rowObject.fecha:BGCOLOR IN BROWSE br_table             = ibgcolor
         rowObject.id_turno:BGCOLOR IN BROWSE br_table          = ibgcolor
         rowObject.responsable_turno:BGCOLOR IN BROWSE br_table = ibgcolor
         rowObject.molienda:BGCOLOR IN BROWSE br_table          = ibgcolor
         .
