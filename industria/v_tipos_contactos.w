...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipos_contactos
&Scoped-define FIRST-EXTERNAL-TABLE tipos_contactos


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipos_contactos.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipos_contactos.id_tipo_contacto ~
tipos_contactos.descripcion tipos_contactos.abreviatura 
&Scoped-define ENABLED-TABLES tipos_contactos
&Scoped-define FIRST-ENABLED-TABLE tipos_contactos
&Scoped-define DISPLAYED-TABLES tipos_contactos
&Scoped-define FIRST-DISPLAYED-TABLE tipos_contactos
&Scoped-Define DISPLAYED-FIELDS tipos_contactos.id_tipo_contacto ~
tipos_contactos.descripcion tipos_contactos.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipos_contactos.id_tipo_contacto 
...
DEFINE FRAME F-Main
     tipos_contactos.id_tipo_contacto AT ROW 1 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     tipos_contactos.descripcion AT ROW 2 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 42 BY 1
     tipos_contactos.abreviatura AT ROW 3 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipos_contactos
...
/* SETTINGS FOR FILL-IN tipos_contactos.id_tipo_contacto IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipos_contactos.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contactos.abreviatura V-table-Win 
ON LEAVE OF tipos_contactos.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME tipos_contactos.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contactos.descripcion V-table-Win 
ON LEAVE OF tipos_contactos.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tipos_contactos.id_tipo_contacto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_contactos.id_tipo_contacto V-table-Win 
ON LEAVE OF tipos_contactos.id_tipo_contacto IN FRAME F-Main /* CodTContacto */
DO:
{custom/support/validacion.i}
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN tipos_contactos.c_usuario   = USERID("userdb")
       tipos_contactos.c_fecha     = TODAY
       tipos_contactos.c_hora      = STRING(TIME,"HH:MM:SS").
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipos_contactos"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipos_contactos"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tipos_contactos"}
