...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipos_pe
&Scoped-define FIRST-EXTERNAL-TABLE tipos_pe


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipos_pe.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipos_pe.id_tipo_pe tipos_pe.descripcion 
&Scoped-define ENABLED-TABLES tipos_pe
&Scoped-define FIRST-ENABLED-TABLE tipos_pe
&Scoped-define DISPLAYED-TABLES tipos_pe
&Scoped-define FIRST-DISPLAYED-TABLE tipos_pe
&Scoped-Define DISPLAYED-FIELDS tipos_pe.id_tipo_pe tipos_pe.descripcion 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipos_pe.id_tipo_pe 
...
DEFINE FRAME F-Main
     tipos_pe.id_tipo_pe AT ROW 1 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     tipos_pe.descripcion AT ROW 2 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipos_pe
...
/* SETTINGS FOR FILL-IN tipos_pe.id_tipo_pe IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipos_pe.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_pe.descripcion V-table-Win 
ON LEAVE OF tipos_pe.descripcion IN FRAME F-Main /* Descripcion */
DO:
...
&Scoped-define SELF-NAME tipos_pe.id_tipo_pe
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_pe.id_tipo_pe V-table-Win 
ON LEAVE OF tipos_pe.id_tipo_pe IN FRAME F-Main /* Cod.TipoPE */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipos_pe"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipos_pe"}
