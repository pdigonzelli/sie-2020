...
DEFINE VARIABLE h_bc_envases_ff AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_envases_ff.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_envases_ff ).
       RUN set-position IN h_bc_envases_ff ( 2.43 , 6.00 ) NO-ERROR.
       RUN set-size IN h_bc_envases_ff ( 6.71 , 77.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_envases_ff ,
