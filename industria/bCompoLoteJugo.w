...
rowObject.id_tambor rowObject.kilos_tambor rowObject.id_sucursal_ubicacion ~
rowObject.id_articulo rowObject.id_calidad rowObject.id_envase ~
rowObject.id_locacion_ubicacion rowObject.Brix 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      id_locacion_ubicacion FORMAT ">>,>>9":U
      Brix FORMAT ">>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"id_lote" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[3]   = _<SDO>.rowObject.kilos_tambor
...
"id_sucursal_ubicacion" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[6]   = _<SDO>.rowObject.id_calidad
     _FldNameList[7]   = _<SDO>.rowObject.id_envase
     _FldNameList[8]   = _<SDO>.rowObject.id_locacion_ubicacion
     _FldNameList[9]   = _<SDO>.rowObject.Brix
