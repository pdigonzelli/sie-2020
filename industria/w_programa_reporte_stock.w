...
&Scoped-Define ENABLED-OBJECTS RECT-3 RECT-2 BUTTON-2 BUTTON-1 
...
DEFINE VARIABLE h_bc_locaciones AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     BUTTON-2 AT ROW 12.19 COL 79
     BUTTON-1 AT ROW 12.19 COL 104
     RECT-3 AT ROW 11.71 COL 75
     RECT-2 AT Y 0 X 500
...
ON END-ERROR OF W-Win /* Reportes de Stock */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reportes de Stock */
DO:
...
ON CHOOSE OF BUTTON-1 IN FRAME F-Main /* Reporte Común */
DO:
  define var r as rowid.
  define var v_filtro as char.
  DEFINE VAR RB-MEMO-FILE AS CHARACTER INITIAL "".
    
    run get-rowid1 in h_bc_locaciones (output r).
  ...
  /************************************************************************************************************/
    ...
    if available locaciones then
        do:
            v_filtro = "tambores_industria.id_sucursal_ubicacion = " + string(locaciones.id_sucursal) +
                        " and tambores_industria.id_locacion_ubicacion = " + string(locaciones.id_locacion) + 
                        " and tambores_industria.fecha > " + " 01/01/01 " + 
                        " and (tambores_industria.id_tipotambor = 3 or tambores_industria.id_tipotambor = 6)".
...
ON CHOOSE OF BUTTON-2 IN FRAME F-Main /* Reporte Detallado */
DO:
  define var r as rowid.
  define var v_filtro as char.
  DEFINE VAR RB-MEMO-FILE AS CHARACTER INITIAL "".
  ...
  /************************************************************************************************************/
    ...
    if available locaciones then
        do:
         ...
         RUN  aderb\_prntrb2(
         "..\industria\reports.prl", /* RB-REPORT-LIBRARY */
         "rep_stock_clientes",                    /* RB-REPORT-NAME */
         "",                             /* RB-DB-CONNECTION */
         "O",                             /* RB-INCLUDE-RECORDS */
         v_filtro,                              /* RB-FILTER */
         RB-MEMO-FILE,                              /* RB-MEMO-FILE */
         ...
         0,                              /* RB-END-PAGE - zero */
         no,                              /* RB-TEST-PATTERN */
         "Reporte de Contratos Detallado",         /* RB-WINDOW-TITLE */
         yes,                           /* RB-DISPLAY-ERRORS */
         yes,                           /* RB-DISPLAY-STATUS */
         no,                              /* RB-NO-WAIT */
         "" /* RB-OTHER-PARAMETERS */,
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 102.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 125.00 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_locaciones.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_locaciones ).
       RUN set-position IN h_bc_locaciones ( 3.86 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 134.00 ) */

       /* Links to csmartbrowser h_bc_locaciones. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_bc_locaciones ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_locaciones ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE RECT-3 RECT-2 BUTTON-2 BUTTON-1 
