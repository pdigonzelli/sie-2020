...
DEFINE VARIABLE h_bc_posiciones AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.29 COL 131
     salir AT ROW 10.29 COL 143
     RECT-1 AT ROW 10.05 COL 128
     SPACE(5.99) SKIP(0.80)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_posiciones.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_posiciones ).
       RUN set-position IN h_bc_posiciones ( 2.05 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 155.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_posiciones ,
