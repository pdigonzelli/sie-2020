...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.NroComp ~
rowObject.Cantidad rowObject.FechaRemito rowObject.Sucursal ~
rowObject.LugDesc rowObject.SucDestino rowObject.nro_remito 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.NroComp FORMAT "XXXX-XXXXXXXX":U
      rowObject.Cantidad FORMAT ">>>>>":U
      rowObject.FechaRemito FORMAT "99/99/9999":U
      rowObject.Sucursal FORMAT "x(30)":U
      rowObject.LugDesc FORMAT "x(30)":U
      rowObject.SucDestino FORMAT "x(30)":U
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "drLoteCascaraRemito.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.NroComp
"rowObject.NroComp" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.Cantidad
     _FldNameList[3]   = _<SDO>.rowObject.FechaRemito
     _FldNameList[4]   > _<SDO>.rowObject.Sucursal
"rowObject.Sucursal" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[5]   = _<SDO>.rowObject.LugDesc
     _FldNameList[6]   = _<SDO>.rowObject.SucDestino
     _FldNameList[7]   = _<SDO>.rowObject.nro_remito
