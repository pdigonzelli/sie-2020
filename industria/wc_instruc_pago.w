...
DEFINE FRAME D-Dialog
     aceptar AT ROW 10.52 COL 112
     salir AT ROW 10.52 COL 124
     RECT-1 AT ROW 10.29 COL 109
     RECT-4 AT ROW 1.48 COL 3
     SPACE(2.59) SKIP(2.70)
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_instruc_pago ( 2.19 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b_instruc_pago ( 6.71 , 137.00 ) NO-ERROR.
