...
DEFINE VARIABLE h_bc_clientes AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 9.33 COL 132
     salir AT ROW 9.33 COL 144
     RECT-1 AT ROW 9.1 COL 129
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Consultas clientes */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_clientes.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_clientes ).
       RUN set-position IN h_bc_clientes ( 1.71 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 154.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_clientes ,
