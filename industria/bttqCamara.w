...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.camara rowObject.id_lote ~
rowObject.anio rowObject.fila rowObject.columna rowObject.tambores ~
rowObject.articulo rowObject.calidad rowObject.envase rowObject.nromov 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.camara FORMAT "X(15)":U
      rowObject.id_lote FORMAT "->,>>>,>>9":U
      rowObject.anio FORMAT "->,>>>,>>9":U
      rowObject.fila FORMAT "X(15)":U
      rowObject.columna FORMAT "X(15)":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.camara
"rowObject.camara" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.id_lote
     _FldNameList[3]   = _<SDO>.rowObject.anio
     _FldNameList[4]   = _<SDO>.rowObject.fila
     _FldNameList[5]   = _<SDO>.rowObject.columna
     _FldNameList[6]   = _<SDO>.rowObject.tambores
     _FldNameList[7]   = _<SDO>.rowObject.articulo
     _FldNameList[8]   = _<SDO>.rowObject.calidad
     _FldNameList[9]   = _<SDO>.rowObject.envase
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND (hCont:FILE-NAME MATCHES "*wqTamboresCamara.w")  THEN DO:
    iBgColor = IF rowObject.rowNum MODULO 2 = 0 THEN 25 /*11 light blue*/ ELSE ? /*default*/.
    
    ASSIGN rowObject.camara:BGCOLOR IN BROWSE br_table   = ibgcolor
           rowObject.id_lote:BGCOLOR IN BROWSE br_table  = ibgcolor
           rowObject.anio:BGCOLOR IN BROWSE br_table     = ibgcolor
           rowObject.fila:BGCOLOR IN BROWSE br_table     = ibgcolor
           rowObject.columna:BGCOLOR IN BROWSE br_table  = ibgcolor
