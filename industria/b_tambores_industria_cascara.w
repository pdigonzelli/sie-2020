...
tambores_industria.id_sucursal tambores_industria.id_tipotambor ~
tambores_industria.nromov tambores_industria.id_tambor ~
tambores_industria.id_etiqueta tambores_industria.id_sucursal_ubicacion ~
tambores_industria.nromov_destino 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria OF produccion_jugo WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tambores_industria.id_empresa FORMAT ">9":U
      tambores_industria.id_sucursal FORMAT ">>,>>9":U
      tambores_industria.id_tipotambor FORMAT ">,>>9":U
      ...
      tambores_industria.nromov_destino FORMAT ">>>,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 69 BY 6.71
         TITLE "tambores_industria_cascara".
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_industria OF general.produccion_jugo"
     ...
     _FldNameList[7]   = general.tambores_industria.id_sucursal_ubicacion
     _FldNameList[8]   = general.tambores_industria.nromov_destino
...
ON F3 OF br_table IN FRAME F-Main /* tambores_industria_cascara */
DO:
  run buscar.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON MOUSE-SELECT-DBLCLICK OF br_table IN FRAME F-Main /* tambores_industria_cascara */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-ENTRY OF br_table IN FRAME F-Main /* tambores_industria_cascara */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* tambores_industria_cascara */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* tambores_industria_cascara */
DO:
