...
&Scoped-Define ENABLED-FIELDS  kilos_tambor id_lote Anio id_articulo id_calidad id_envase~
 id_sucursal_ubicacion
&Scoped-define ENABLED-FIELDS-IN-tambores_industria kilos_tambor id_lote ~
Anio id_articulo id_calidad id_envase id_sucursal_ubicacion 
&Scoped-Define DATA-FIELDS  kilos_tambor calidad id_lote envase Anio id_articulo id_calidad id_envase~
 id_sucursal_ubicacion
&Scoped-define DATA-FIELDS-IN-tambores_industria kilos_tambor id_lote Anio ~
id_articulo id_calidad id_envase id_sucursal_ubicacion 
&Scoped-Define MANDATORY-FIELDS  id_lote id_calidad id_sucursal_ubicacion
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST 
&Scoped-Define DATA-FIELD-DEFS "dTamborIndustria.i"
&Scoped-define QUERY-STRING-Query-Main FOR EACH tambores_industria ~
      WHERE tambores_industria.id_tipotambor = 3 ~
 AND tambores_industria.id_tipotambor = 6 ~
 AND tambores_industria.id_tipotambor = 7 NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _Where[1]         = "general.tambores_industria.id_tipotambor = 3
 AND general.tambores_industria.id_tipotambor = 6
 AND general.tambores_industria.id_tipotambor = 7"
     _FldNameList[1]   > general.tambores_industria.kilos_tambor
"kilos_tambor" "kilos_tambor" ? ? "decimal" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[2]   > "_<CALC>"
"getCalidad()" "calidad" ? "x(20)" "character" ? ? ? ? ? ? no ? no 20 no
...
"id_articulo" "id_articulo" ? ? "integer" ? ? ? ? ? ? yes ? no 7.8 yes
     _FldNameList[7]   > general.tambores_industria.id_calidad
...
"id_envase" "id_envase" ? ? "integer" ? ? ? ? ? ? yes ? no 7.8 yes
     _FldNameList[9]   > general.tambores_industria.id_sucursal_ubicacion
...
/*------------------------------------------------------------------------------
  Purpose:  
    Notes:  
------------------------------------------------------------------------------*/
  FIND calidades OF RowObject NO-LOCK NO-ERROR.
  IF AVAILABLE calidades THEN
      RETURN descripcion.
  RETURN "Sin Calidad".   /* Function return value. */
...
/*------------------------------------------------------------------------------
  Purpose:  
    Notes:  
------------------------------------------------------------------------------*/
  FIND envases_prod OF RowObject NO-LOCK NO-ERROR.
  IF AVAILABLE envases_prod THEN
      RETURN descripcion.
  RETURN "Sin Envase".   /* Function return value. */
