...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_instrumento_pago ~
rowObject.descripcion rowObject.descripcion_ingles 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_instrumento_pago FORMAT ">>>,>>9":U
      rowObject.descripcion FORMAT "X(30)":U
      rowObject.descripcion_ingles FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 73 BY 6.67 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dinstrumentospagos.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_instrumento_pago
     _FldNameList[2]   = _<SDO>.rowObject.descripcion
     _FldNameList[3]   > _<SDO>.rowObject.descripcion_ingles
"rowObject.descripcion_ingles" ? ? "character" ? ? ? ? ? ? no ? no no "29.6" yes no no "U" "" ""
