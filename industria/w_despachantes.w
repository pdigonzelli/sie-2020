...
&Scoped-Define ENABLED-OBJECTS RECT-18 RECT-2 
...
DEFINE VARIABLE h_b_despachantes AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_despachantes AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* ABM de Despachantes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* ABM de Despachantes */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_despachantes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_despachantes ).
       RUN set-position IN h_b_despachantes ( 3.86 , 7.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_despachantes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_despachantes ).
       RUN set-position IN h_v_despachantes ( 11.48 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 53.00 ) */

       /* Links to csmartbrowser h_b_despachantes. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_despachantes ).

       /* Links to SmartViewer h_v_despachantes. */
       RUN add-link IN adm-broker-hdl ( h_b_despachantes , 'Record':U , h_v_despachantes ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_despachantes ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_despachantes ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_despachantes ,
             h_b_despachantes , 'AFTER':U ).
    END. /* Page 0 */
