...
lotes_jugo.id_lote productos_terminados.descripcion calidades.descripcion ~
lotes_jugo.Fecha 
...
<FOREIGN-KEYS>
id_tipotambor|y|y|general.lotes_jugo.id_tipotambor
...
RUN set-attribute-list (
    'Keys-Accepted = "id_tipotambor",
     Keys-Supplied = "id_tipotambor,id_orden_entrega,id_tipolimon"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      lotes_jugo.id_lote FORMAT ">>>9"
      productos_terminados.descripcion COLUMN-LABEL "Articulos" FORMAT "x(25)"
      calidades.descripcion COLUMN-LABEL "Calidad" FORMAT "X(25)"
      lotes_jugo.Fecha FORMAT "99/99/99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.lotes_jugo,comercial.sucursales OF general.lotes_jugo,general.productos_terminados OF general.lotes_jugo,general.calidades OF general.lotes_jugo"
...
"general.lotes_jugo.id_lote" ? ">>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[3]   > general.productos_terminados.descripcion
"general.productos_terminados.descripcion" "Articulos" "x(25)" "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   > general.calidades.descripcion
"general.calidades.descripcion" "Calidad" "X(25)" "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > general.lotes_jugo.Fecha
"general.lotes_jugo.Fecha" ? "99/99/99" "date" ? ? ? ? ? ? no ?
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_tipotambor':U THEN DO:
       &Scope KEY-PHRASE lotes_jugo.id_tipotambor eq INTEGER(key-value)
       {&OPEN-QUERY-{&BROWSE-NAME}}
    END. /* id_tipotambor */
    OTHERWISE DO:
