...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-4 FILL-IN-5 
...
DEFINE VARIABLE h_b_tambores_prod_aceite_ubicaci AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     FILL-IN-5 AT ROW 15.52 COL 3 NO-LABEL
     BUTTON-1 AT ROW 17.19 COL 92
...
DO:
  ...
  run get-rowid1 in h_b_tambores_prod_aceite_ubicaci (output r).
...
run dispatch in h_b_tambores_prod_aceite_ubicaci ('open-query':U).
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tambores_prod_aceite_ubicacion.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tambores_prod_aceite_ubicaci ).
       RUN set-position IN h_b_tambores_prod_aceite_ubicaci ( 2.43 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.62 , 151.00 ) */
       ...
       RUN set-position IN h_b_seleccion_locaciones ( 16.71 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 16.95 , 131.00 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tambores_prod_aceite_ubicaci ,
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_b_seleccion_locaciones , 'AFTER':U ).
    END. /* Page 0 */
