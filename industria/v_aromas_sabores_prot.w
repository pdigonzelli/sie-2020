...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES aromas_sabores_prot
&Scoped-define FIRST-EXTERNAL-TABLE aromas_sabores_prot


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR aromas_sabores_prot.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS aromas_sabores_prot.id_aroma_sabor ~
aromas_sabores_prot.descripcion aromas_sabores_prot.abreviatura 
&Scoped-define ENABLED-TABLES aromas_sabores_prot
&Scoped-define FIRST-ENABLED-TABLE aromas_sabores_prot
&Scoped-define DISPLAYED-TABLES aromas_sabores_prot
&Scoped-define FIRST-DISPLAYED-TABLE aromas_sabores_prot
&Scoped-Define DISPLAYED-FIELDS aromas_sabores_prot.id_aroma_sabor ~
aromas_sabores_prot.descripcion aromas_sabores_prot.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS aromas_sabores_prot.id_aroma_sabor 
...
DEFINE FRAME F-Main
     aromas_sabores_prot.id_aroma_sabor AT ROW 1 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     aromas_sabores_prot.descripcion AT ROW 2 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 44 BY 1
     aromas_sabores_prot.abreviatura AT ROW 3 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.aromas_sabores_prot
...
/* SETTINGS FOR FILL-IN aromas_sabores_prot.id_aroma_sabor IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME aromas_sabores_prot.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL aromas_sabores_prot.abreviatura V-table-Win 
ON LEAVE OF aromas_sabores_prot.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME aromas_sabores_prot.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL aromas_sabores_prot.descripcion V-table-Win 
ON LEAVE OF aromas_sabores_prot.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME aromas_sabores_prot.id_aroma_sabor
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL aromas_sabores_prot.id_aroma_sabor V-table-Win 
ON LEAVE OF aromas_sabores_prot.id_aroma_sabor IN FRAME F-Main /* CodAromaSabor */
DO:
{custom/support/validacion.i}
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN aromas_sabores_prot.c_usuario = USERID("userdb")
       aromas_sabores_prot.c_fecha   = TODAY
       aromas_sabores_prot.c_hora    = STRING(TIME,"HH:MM:SS").
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "aromas_sabores_prot"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "aromas_sabores_prot"}
