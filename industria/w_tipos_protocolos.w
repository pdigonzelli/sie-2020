...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-23 
...
DEFINE VARIABLE h_b_tipos_protocolos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_protocolos AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tipos Protocolos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipos Protocolos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_protocolos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_protocolos ).
       RUN set-position IN h_b_tipos_protocolos ( 3.86 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_protocolos ( 6.71 , 78.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_protocolos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_protocolos ).
       RUN set-position IN h_v_tipos_protocolos ( 11.71 , 11.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 53.00 ) */

       /* Links to csmartbrowser h_b_tipos_protocolos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_protocolos ).

       /* Links to SmartViewer h_v_tipos_protocolos. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_protocolos , 'Record':U , h_v_tipos_protocolos ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_protocolos ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_protocolos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_protocolos ,
             h_b_tipos_protocolos , 'AFTER':U ).
    END. /* Page 0 */
