...
&Scoped-Define ENABLED-FIELDS protocolos.lote protocolos.anio_lote ~
protocolos.tipo_cascara protocolos.id_envase 
&Scoped-define ENABLED-TABLES protocolos
&Scoped-define FIRST-ENABLED-TABLE protocolos
&Scoped-Define DISPLAYED-FIELDS protocolos.lote protocolos.anio_lote ~
protocolos.tipo_cascara protocolos.id_envase 
...
DEFINE FRAME F-Main
     protocolos.lote AT ROW 1 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     protocolos.anio_lote AT ROW 1 COL 31 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     protocolos.tipo_cascara AT ROW 1.95 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.6 BY 1
     protocolos.id_envase AT ROW 2.91 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     fi-envases_muestras-descripcion AT ROW 2.91 COL 23 COLON-ALIGNED NO-LABEL
...
general.protocolos.id_envase;wc_envases_muestras.w;envases_muestras.descripcion_ingles;;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME protocolos.anio_lote
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.anio_lote V-table-Win
ON LEAVE OF protocolos.anio_lote IN FRAME F-Main /* Año */
DO:
...
&Scoped-define SELF-NAME protocolos.id_envase
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.id_envase V-table-Win
ON GO OF protocolos.id_envase IN FRAME F-Main /* Envase */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.id_envase V-table-Win
ON LEAVE OF protocolos.id_envase IN FRAME F-Main /* Envase */
DO:
{custom/support/validacion.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.id_envase V-table-Win
ON MOUSE-SELECT-DBLCLICK OF protocolos.id_envase IN FRAME F-Main /* Envase */
do: 
...
general.protocolos.id_envase:screen-value = string(envases_muestras.id_envase).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.id_envase V-table-Win
ON U1 OF protocolos.id_envase IN FRAME F-Main /* Envase */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&Scoped-define SELF-NAME protocolos.lote
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.lote V-table-Win
ON LEAVE OF protocolos.lote IN FRAME F-Main /* Lote */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME protocolos.tipo_cascara
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.tipo_cascara V-table-Win
ON LEAVE OF protocolos.tipo_cascara IN FRAME F-Main /* Tipo Cascara */
DO:
{custom/support/validacion.i}
END.
...
find first envases_muestras where envases_muestras.id_envase = integer(protocolos.id_envase:screen-value in frame F-Main)  no-lock no-error .
if available envases_muestras then 
fi-envases_muestras-descripcion:screen-value in frame F-Main = string(envases_muestras.descripcion_ingles).
else
