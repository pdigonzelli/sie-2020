...
rowObject.id_lote_deposito rowObject.cantidad rowObject.articulo ~
rowObject.calidad rowObject.envase rowObject.tambor_desde ~
rowObject.tambor_hasta rowObject.id_sucursal_ubicacion rowObject.nromov 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.lote FORMAT "X(10)":U
      rowObject.id_lote_deposito FORMAT "X(15)":U
      ...
      rowObject.tambor_desde FORMAT "->,>>>,>>9":U
      rowObject.tambor_hasta FORMAT "->,>>>,>>9":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.id_lote_deposito
     _FldNameList[3]   = _<SDO>.rowObject.cantidad
     _FldNameList[4]   = _<SDO>.rowObject.articulo
     _FldNameList[5]   = _<SDO>.rowObject.calidad
     _FldNameList[6]   = _<SDO>.rowObject.envase
     _FldNameList[7]   = _<SDO>.rowObject.tambor_desde
     _FldNameList[8]   = _<SDO>.rowObject.tambor_hasta
     _FldNameList[9]   = _<SDO>.rowObject.id_sucursal_ubicacion
     _FldNameList[10]   = _<SDO>.rowObject.nromov
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND hCont:FILE-NAME MATCHES "*wGetLoteUbicacion.w" THEN DO:
    ...
    ASSIGN rowObject.lote:BGCOLOR IN BROWSE br_table                  = ibgcolor
           rowObject.id_lote_deposito:BGCOLOR IN BROWSE br_table      = ibgcolor
