...
&Scoped-define FIELDS-IN-QUERY-br_table locaciones.id_empresa ~
locaciones.id_sucursal sucursales.nombre locaciones.id_locacion ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      locaciones.id_empresa
      locaciones.id_sucursal
      sucursales.nombre
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = general.locaciones.id_empresa
     _FldNameList[2]   = general.locaciones.id_sucursal
     _FldNameList[3]   = comercial.sucursales.nombre
     _FldNameList[4]   = general.locaciones.id_locacion
...
define sub-menu Ordena 
  menu-item locaciones-id_empresa
label 'id_empresa( locaciones ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=locaciones.id_empresa').
                  run set-attribute-list('titulo=Empresa').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by locaciones.id_empresa
...
case p:
  WHEN 'locaciones.id_empresa' then  
