...
&Scoped-define FIELDS-IN-QUERY-br_table locaciones.id_locacion ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      locaciones.id_locacion COLUMN-LABEL "Loc." FORMAT ">>9":U
            WIDTH 6.2
      locaciones.descripcion FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 32 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > general.locaciones.id_locacion
"general.locaciones.id_locacion" "Loc." ">>9" "integer" ? ? ? ? ? ? no ? no no "6.2" yes no no "U" "" ""
     _FldNameList[2]   > general.locaciones.descripcion
"general.locaciones.descripcion" ? "x(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
