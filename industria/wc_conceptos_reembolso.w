...
&Scoped-Define ENABLED-OBJECTS RECT-5 RECT-1 aceptar salir 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_conceptos_reembolso ( 2.43 , 12.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-5 RECT-1 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
