...
rowObject.id_articulo rowObject.id_calidad rowObject.Calidad ~
rowObject.semana_entrega rowObject.anio_semana_entrega 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.semana_entrega FORMAT ">>9":U WIDTH 19.2
      rowObject.anio_semana_entrega FORMAT "9999":U WIDTH 9.6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 101 BY 6.67 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.id_articulo
     _FldNameList[3]   = _<SDO>.rowObject.id_calidad
     _FldNameList[4]   = _<SDO>.rowObject.Calidad
     _FldNameList[5]   > _<SDO>.rowObject.semana_entrega
"rowObject.semana_entrega" ? ? "integer" ? ? ? ? ? ? no ? no no "19.2" yes no no "U" "" ""
     _FldNameList[6]   > _<SDO>.rowObject.anio_semana_entrega
"rowObject.anio_semana_entrega" ? ? "integer" ? ? ? ? ? ? no ? no no "9.6" yes no no "U" "" ""
