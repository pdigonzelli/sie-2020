...
&Scoped-Define ENABLED-FIELDS calidades.id_calidad calidades.descripcion ~
calidades.abreviatura calidades.descripcion_ingles ~
calidades.Abreviatura_ingles calidades.empapelado calidades.id_sector 
&Scoped-define FIELD-PAIRS~
 ...
 ~{&FP1}id_sector ~{&FP2}id_sector ~{&FP3}
&Scoped-define ENABLED-TABLES calidades
&Scoped-define FIRST-ENABLED-TABLE calidades
&Scoped-Define DISPLAYED-FIELDS calidades.id_calidad calidades.descripcion ~
calidades.abreviatura calidades.descripcion_ingles ~
calidades.Abreviatura_ingles calidades.empapelado calidades.id_sector 
...
DEFINE FRAME F-Main
     calidades.id_calidad AT ROW 1 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.6 BY 1
     calidades.descripcion AT ROW 2 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     calidades.abreviatura AT ROW 3 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
     calidades.descripcion_ingles AT ROW 4 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     calidades.Abreviatura_ingles AT ROW 5 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
     calidades.empapelado AT ROW 6 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.4 BY 1
     calidades.id_sector AT ROW 7 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
...
&Scoped-define SELF-NAME calidades.id_sector
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL calidades.id_sector V-table-Win
ON LEAVE OF calidades.id_sector IN FRAME F-Main /* Sector */
DO:
{custom/support/validacion.i}
END.
