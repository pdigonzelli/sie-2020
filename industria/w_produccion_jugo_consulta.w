...
DEFINE VARIABLE h_b_produccion_jugo_consulta AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Producción de Jugo Disponible"
         HEIGHT             = 19.1
         WIDTH              = 156.6
         MAX-HEIGHT         = 21.48
         MAX-WIDTH          = 156.6
...
ON END-ERROR OF W-Win /* Producción de Jugo Disponible */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Producción de Jugo Disponible */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 41.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 75.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 98.80 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_produccion_jugo_consulta.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_produccion_jugo_consulta ).
       RUN set-position IN h_b_produccion_jugo_consulta ( 5.00 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.52 , 154.00 ) */

       /* Links to csmartbrowser h_b_produccion_jugo_consulta. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_produccion_jugo_consulta ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_produccion_jugo_consulta ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
