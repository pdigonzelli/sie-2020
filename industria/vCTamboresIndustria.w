...
DEFINE FRAME F-Main
     RowObject.id_lote AT ROW 1 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     RowObject.id_empresa AT ROW 2 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     RowObject.id_sucursal AT ROW 3 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dctamboresindustria.w"
...
/* SETTINGS FOR FILL-IN RowObject.id_empresa IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       RowObject.id_empresa:READ-ONLY IN FRAME F-Main        = TRUE.
