...
&Scoped-define INTERNAL-TABLES tambores_aceite productos_terminados ~
sucursales
...
productos_terminados.descripcion tambores_aceite.Fecha sucursales.nombre ~
tambores_aceite.citral 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_aceite WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH productos_terminados OF tambores_aceite NO-LOCK, ~
      EACH sucursales OF tambores_aceite NO-LOCK ~
    BY tambores_aceite.Fecha DESCENDING ~
       BY tambores_aceite.id_tambor DESCENDING.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tambores_aceite.id_tambor COLUMN-LABEL "Producción" FORMAT ">,>>9"
      productos_terminados.descripcion
      tambores_aceite.Fecha
      sucursales.nombre
      tambores_aceite.citral
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_aceite,general.productos_terminados OF general.tambores_aceite,comercial.sucursales OF general.tambores_aceite"
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ",,"
     _OrdList          = "general.tambores_aceite.Fecha|no,industria.tambores_aceite.id_tambor|no"
     _FldNameList[1]   > general.tambores_aceite.id_tambor
"tambores_aceite.id_tambor" "Producción" ">,>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   = general.productos_terminados.descripcion
     _FldNameList[3]   = general.tambores_aceite.Fecha
...
label 'descripcion( productos_terminados ) '
  ...
  menu-item tambores_aceite-Fecha
label 'Fecha( tambores_aceite ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_aceite.Fecha').
                  run set-attribute-list('titulo=Dato').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tambores_aceite.Fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'nombre( sucursales ) '
  ...
  menu-item tambores_aceite-citral
label 'citral( tambores_aceite ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tambores_aceite.citral').
                  run set-attribute-list('titulo=Citral').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tambores_aceite.citral
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tambores_aceite.id_tambor
