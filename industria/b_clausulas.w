...
&Scoped-define INTERNAL-TABLES clausulas

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table clausulas.id_clausula ~
clausulas.descripcion clausulas.id_termino 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH clausulas WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table clausulas
&Scoped-define FIRST-TABLE-IN-QUERY-br_table clausulas
...
<FOREIGN-KEYS>
id_clausula||y|general.clausulas.id_clausula
descripcion||y|general.clausulas.descripcion
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_clausula,descripcion"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      clausulas.id_clausula
      clausulas.descripcion
      clausulas.id_termino
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.clausulas"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.clausulas.id_clausula
     _FldNameList[2]   = general.clausulas.descripcion
     _FldNameList[3]   = general.clausulas.id_termino
...
define sub-menu Ordena 
  menu-item clausulas-id_clausula
label 'id_clausula( clausulas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=clausulas.id_clausula').
                  run set-attribute-list('titulo=Clausula').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by clausulas.id_clausula
...
label 'descripcion( clausulas ) '
  ...
  menu-item clausulas-id_termino
label 'id_termino( clausulas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=clausulas.id_termino').
                  run set-attribute-list('titulo=id_termino').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by clausulas.id_termino
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by clausulas.id_clausula
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_clausula" "clausulas" "id_clausula"}
  {src/adm/template/sndkycas.i "descripcion" "clausulas" "descripcion"}
