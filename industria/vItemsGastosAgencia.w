...
&Scoped-Define ENABLED-FIELDS RowObject.item RowObject.importe 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define DISPLAYED-FIELDS RowObject.item RowObject.importe 
...
DEFINE FRAME F-Main
     RowObject.item AT ROW 1 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     RowObject.importe AT ROW 3 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dItemsListaGastosAgencia.w"
...
------------------------------------------------------------------------------*/
  ...
  rowObject.ITEM:SCREEN-VALUE IN FRAME {&FRAME-NAME} = DYNAMIC-FUNCTION('getNextItem' IN hSource, DYNAMIC-FUNCTION('columnValue' IN hSource, 'id_lista')).
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dgastosventa ( 1.00 , 30.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_dynselect ).
       RUN repositionObject IN h_dynselect ( 2.00 , 13.00 ) NO-ERROR.
