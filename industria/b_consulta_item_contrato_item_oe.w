...
items_orden_entrega.fecha items_orden_entrega.semana_entrega ~
items_orden_entrega.tambores_pedidos items_orden_entrega.cantidad_tambores ~
items_orden_entrega.kgs_netos_tambores items_orden_entrega.total_factura ~
items_orden_entrega.pendiente 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH items_orden_entrega OF items_contratos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      items_orden_entrega.id_orden_entrega FORMAT ">>>>9":U
      items_orden_entrega.item_oe COLUMN-LABEL "ParteOE" FORMAT ">>>9":U
            WIDTH 10.2
      items_orden_entrega.fecha FORMAT "99/99/99":U WIDTH 11.2
      items_orden_entrega.semana_entrega COLUMN-LABEL "Sem" FORMAT ">>9":U
            WIDTH 6.8
      items_orden_entrega.tambores_pedidos FORMAT ">>>9":U WIDTH 11.6
      items_orden_entrega.cantidad_tambores COLUMN-LABEL "TambAsig" FORMAT ">>>>>9":U
            WIDTH 11.6
      items_orden_entrega.kgs_netos_tambores FORMAT ">>>>>>9.999":U
            WIDTH 16.8
      items_orden_entrega.total_factura COLUMN-LABEL "TotalFac" FORMAT ">>>>>>>9.999":U
            WIDTH 16.2
      items_orden_entrega.pendiente FORMAT "si/no":U WIDTH 13.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.items_orden_entrega OF general.items_contratos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.items_orden_entrega.id_orden_entrega
"items_orden_entrega.id_orden_entrega" ? ">>>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > general.items_orden_entrega.item_oe
"items_orden_entrega.item_oe" "ParteOE" ? "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
     _FldNameList[3]   > general.items_orden_entrega.fecha
"items_orden_entrega.fecha" ? ? "date" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[4]   > general.items_orden_entrega.semana_entrega
"items_orden_entrega.semana_entrega" "Sem" ? "integer" ? ? ? ? ? ? no ? no no "6.8" yes no no "U" "" ""
     _FldNameList[5]   > general.items_orden_entrega.tambores_pedidos
"items_orden_entrega.tambores_pedidos" ? ? "integer" ? ? ? ? ? ? no ? no no "11.6" yes no no "U" "" ""
     _FldNameList[6]   > general.items_orden_entrega.cantidad_tambores
"items_orden_entrega.cantidad_tambores" "TambAsig" ? "integer" ? ? ? ? ? ? no ? no no "11.6" yes no no "U" "" ""
     _FldNameList[7]   > general.items_orden_entrega.kgs_netos_tambores
"items_orden_entrega.kgs_netos_tambores" ? ? "decimal" ? ? ? ? ? ? no ? no no "16.8" yes no no "U" "" ""
     _FldNameList[8]   > general.items_orden_entrega.total_factura
"items_orden_entrega.total_factura" "TotalFac" ? "decimal" ? ? ? ? ? ? no ? no no "16.2" yes no no "U" "" ""
     _FldNameList[9]   > general.items_orden_entrega.pendiente
"items_orden_entrega.pendiente" ? ? "logical" ? ? ? ? ? ? no ? no no "13.4" yes no no "U" "" ""
