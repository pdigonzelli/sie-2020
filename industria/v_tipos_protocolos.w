...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipos_protocolos
&Scoped-define FIRST-EXTERNAL-TABLE tipos_protocolos


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipos_protocolos.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipos_protocolos.id_tipo_protocolo ~
tipos_protocolos.descripcion tipos_protocolos.abreviatura 
&Scoped-define ENABLED-TABLES tipos_protocolos
&Scoped-define FIRST-ENABLED-TABLE tipos_protocolos
&Scoped-define DISPLAYED-TABLES tipos_protocolos
&Scoped-define FIRST-DISPLAYED-TABLE tipos_protocolos
&Scoped-Define DISPLAYED-FIELDS tipos_protocolos.id_tipo_protocolo ~
tipos_protocolos.descripcion tipos_protocolos.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipos_protocolos.id_tipo_protocolo 
...
DEFINE FRAME F-Main
     tipos_protocolos.id_tipo_protocolo AT ROW 1 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     tipos_protocolos.descripcion AT ROW 2 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipos_protocolos.abreviatura AT ROW 3 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipos_protocolos
...
/* SETTINGS FOR FILL-IN tipos_protocolos.id_tipo_protocolo IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipos_protocolos.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_protocolos.abreviatura V-table-Win 
ON LEAVE OF tipos_protocolos.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME tipos_protocolos.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_protocolos.descripcion V-table-Win 
ON LEAVE OF tipos_protocolos.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tipos_protocolos.id_tipo_protocolo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipos_protocolos.id_tipo_protocolo V-table-Win 
ON LEAVE OF tipos_protocolos.id_tipo_protocolo IN FRAME F-Main /* CodTipoProtocolo */
DO:
{custom/support/validacion.i}
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN tipos_protocolos.c_usuario   = USERID("userdb")
       tipos_protocolos.c_fecha     = TODAY
       tipos_protocolos.c_hora      = STRING(TIME,"HH:MM:SS").
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipos_protocolos"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipos_protocolos"}
