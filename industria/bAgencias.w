...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_agencia ~
rowObject.descripcion rowObject.razon_social rowObject.abreviatura 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_agencia
"id_agencia" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.descripcion
"descripcion" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[3]   = _<SDO>.rowObject.razon_social
     _FldNameList[4]   > _<SDO>.rowObject.abreviatura
