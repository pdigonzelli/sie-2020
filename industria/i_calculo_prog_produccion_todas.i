    ...
    ASSIGN prog_produccion.orden_fabricacion        = string(contratos.orden_fabricacion)
           ...
           prog_produccion.id_articulo              = items_contratos.id_articulo
           prog_produccion.articulo                 = IF AVAILABLE productos_terminados THEN productos_terminados.descripcion ELSE "NONE"
           prog_produccion.id_cliente               = contratos.id_cliente
           prog_produccion.cliente                  = IF AVAILABLE clientes THEN clientes.nombre ELSE "NONE"
           prog_produccion.total_kgs_contrato       = v_total_kgs_contratos
           
           prog_produccion.cantidad_tambores        = items_contratos.cantidad
           ...
           prog_produccion.kgs_pendientes_of        = v_total_kgs_contratos - v_kgs_acum_asignados_of.
