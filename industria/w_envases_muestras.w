...
DEFINE VARIABLE h_b_envases_muestras AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_envases_muestras AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Envases */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_envases_muestras.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_envases_muestras ).
       RUN set-position IN h_b_envases_muestras ( 3.86 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_envases_muestras ( 6.71 , 76.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_envases_muestras.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_envases_muestras ).
       RUN set-position IN h_v_envases_muestras ( 11.71 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.10 , 57.00 ) */

       /* Links to csmartbrowser h_b_envases_muestras. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_envases_muestras ).

       /* Links to SmartViewer h_v_envases_muestras. */
       RUN add-link IN adm-broker-hdl ( h_b_envases_muestras , 'Record':U , h_v_envases_muestras ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_envases_muestras ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_envases_muestras ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_envases_muestras ,
             h_b_envases_muestras , 'AFTER':U ).
    END. /* Page 0 */
