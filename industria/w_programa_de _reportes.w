...
&Scoped-Define ENABLED-OBJECTS RECT-2 BUTTON-1 BUTTON-2 
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 4.57 COL 15
     BUTTON-2 AT ROW 6 COL 15
     RECT-2 AT Y 0 X 290
...
DO:
  ...
  define var pname  as character no-undo format "x(80)".
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 60.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-2 BUTTON-1 BUTTON-2 
