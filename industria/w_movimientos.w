...
&Scoped-Define ENABLED-OBJECTS BUTTON-5 BUTTON-12 BUTTON-3 BUTTON-7 ~
BUTTON-9 BUTTON-8 BUTTON-6 BUTTON-11 BUTTON-13 BUTTON-10 BUTTON-14 RECT-3 
...
DEFINE BUTTON BUTTON-10 
     LABEL "Movimiento Tambores Productos de Terceros" 
     SIZE 60 BY 1.43.

DEFINE BUTTON BUTTON-11 
     LABEL "Movimiento Tambores Sobrante Lotes de Aceite" 
     SIZE 60 BY 1.43.

DEFINE BUTTON BUTTON-12 
     LABEL "Movimiento Tambores Produccion de Aceite" 
     SIZE 60 BY 1.19.

DEFINE BUTTON BUTTON-13 
     LABEL "Movimiento Tambores Foldeado" 
     SIZE 60 BY 1.43.

DEFINE BUTTON BUTTON-14 
     LABEL "Movimiento Tambores para MP Reproceso" 
     SIZE 60 BY 1.43.
...
DEFINE BUTTON BUTTON-5 
     LABEL "Movimiento Tambores Produccion de Jugo" 
     SIZE 60 BY 1.43.

DEFINE BUTTON BUTTON-6 
     LABEL "Movimiento Tambores Lotes de Aceite" 
     SIZE 60 BY 1.43.

DEFINE BUTTON BUTTON-7 
     LABEL "Movimiento Tambores Lotes de Jugo" 
     SIZE 60 BY 1.43.

DEFINE BUTTON BUTTON-8 
     LABEL "Movimiento Tambores Arrastre Lotes de Jugo" 
     SIZE 60 BY 1.43.

DEFINE BUTTON BUTTON-9 
     LABEL "Movimiento Tambores Sobrante Lotes de Jugo" 
     SIZE 60 BY 1.43.
...
DEFINE FRAME F-Main
     BUTTON-5 AT ROW 1.95 COL 11
     BUTTON-12 AT ROW 3.86 COL 11
     BUTTON-3 AT ROW 5.05 COL 11
     BUTTON-7 AT ROW 5.76 COL 11
     BUTTON-9 AT ROW 7.67 COL 11
     BUTTON-8 AT ROW 9.57 COL 11
     BUTTON-6 AT ROW 11.48 COL 11
     BUTTON-11 AT ROW 13.38 COL 11
     BUTTON-13 AT ROW 15.29 COL 11
     BUTTON-10 AT ROW 17.19 COL 11
     BUTTON-14 AT ROW 19.1 COL 11
     RECT-3 AT ROW 1.48 COL 4
...
ON END-ERROR OF W-Win /* Movimientos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Movimientos */
DO:
...
ON CHOOSE OF BUTTON-10 IN FRAME F-Main /* Movimiento Tambores Productos de Terceros */
DO:
  run w_productos_terceros_movimientos.w.
END.
...
ON CHOOSE OF BUTTON-11 IN FRAME F-Main /* Movimiento Tambores Sobrante Lotes de Aceite */
DO:
  run w_movimiento_sobrante_aceite.w.
END.
...
ON CHOOSE OF BUTTON-12 IN FRAME F-Main /* Movimiento Tambores Produccion de Aceite */
DO:
  run w_movi_prod_aceite.w.
END.
...
ON CHOOSE OF BUTTON-13 IN FRAME F-Main /* Movimiento Tambores Foldeado */
DO:
  run w_lotes_aceite_foldeado_ubicacion.w.
END.
...
ON CHOOSE OF BUTTON-14 IN FRAME F-Main /* Movimiento Tambores para MP Reproceso */
DO:
  RUN wMatPrimaJugo.w.
END.
...
DO:
  run w_tamb_prod_aceite_ubicacicon.w.
END.
...
ON CHOOSE OF BUTTON-5 IN FRAME F-Main /* Movimiento Tambores Produccion de Jugo */
DO:
  run w_tamb_prod_jugo_ubicacion.w.
END.
...
ON CHOOSE OF BUTTON-6 IN FRAME F-Main /* Movimiento Tambores Lotes de Aceite */
DO:
  run w_lotes_aceite_ubicacion.w.
END.
...
ON CHOOSE OF BUTTON-7 IN FRAME F-Main /* Movimiento Tambores Lotes de Jugo */
DO:
  run w_consulta_de_tambores_stock.w.
END.
...
ON CHOOSE OF BUTTON-8 IN FRAME F-Main /* Movimiento Tambores Arrastre Lotes de Jugo */
DO:
  run w_movimiento_arrastres.w.
END.
...
ON CHOOSE OF BUTTON-9 IN FRAME F-Main /* Movimiento Tambores Sobrante Lotes de Jugo */
DO:
  run w_movimiento_sobrante.w.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 21.00 , 50.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-5 BUTTON-12 BUTTON-3 BUTTON-7 BUTTON-9 BUTTON-8 BUTTON-6 
         BUTTON-11 BUTTON-13 BUTTON-10 BUTTON-14 RECT-3 
