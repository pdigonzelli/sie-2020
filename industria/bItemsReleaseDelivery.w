...
rowObject.tambores rowObject.id_lote_deposito rowObject.Peso ~
rowObject.Galones rowObject.contenedor rowObject.Vapor 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.id_lote_deposito FORMAT "X(40)":U WIDTH 20
      rowObject.Peso FORMAT "<<<<<<<9":U
      rowObject.Galones FORMAT "<<<<<<<9":U
      rowObject.contenedor FORMAT "X(20)":U
      rowObject.Vapor FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 85 BY 6.67 EXPANDABLE.
...
"rowObject.id_lote" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.tambores
"rowObject.tambores" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.id_lote_deposito
"rowObject.id_lote_deposito" ? ? "character" ? ? ? ? ? ? no "?" no no "20" yes no no "U" "" ""
     _FldNameList[4]   = _<SDO>.rowObject.Peso
     _FldNameList[5]   = _<SDO>.rowObject.Galones
     _FldNameList[6]   = _<SDO>.rowObject.contenedor
     _FldNameList[7]   = _<SDO>.rowObject.Vapor
