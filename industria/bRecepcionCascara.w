...
rowObject.cantidad rowObject.fecha rowObject.kilos rowObject.Transporte 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Origen FORMAT "x(50)":U WIDTH 18.2
      Destino FORMAT "x(50)":U WIDTH 20.2
      cantidad FORMAT ">>>>>9":U
      fecha FORMAT "99/99/99":U
      kilos FORMAT ">>>>>9":U
      Transporte FORMAT "x(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
