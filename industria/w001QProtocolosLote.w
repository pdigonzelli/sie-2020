...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_d001qprotocoloslote ( 11.95 , 58.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_b001qprotocoloslote ( 7.67 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_b001qprotocoloslote ( 10.48 , 76.00 ) NO-ERROR.
       ...
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 76.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'adm2/dynfilter.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsid_lote,id_protocolo,Anio-2OperatorStyleImplicitOperatorViewAsCombo-boxOperator=UseBeginsyesUseContainsyesDefaultWidth16DefaultCharWidth20DefaultEditorLines1ViewAsFieldsFieldOperatorStylesFieldFormatsFieldWidthsFieldLabelsFieldToolTipsFieldHelpIdsid_lote0id_protocolo0DesignDataObjectFieldColumn20HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynfilter ).
