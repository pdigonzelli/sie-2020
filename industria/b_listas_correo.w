...
&Scoped-define INTERNAL-TABLES listas_correos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table listas_correos.id_lista ~
listas_correos.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH listas_correos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table listas_correos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table listas_correos
...
<FOREIGN-KEYS>
id_lista||y|general.listas_correos.id_lista
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.listas_correos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.listas_correos.id_lista
     _FldNameList[2]   = general.listas_correos.descripcion
...
define sub-menu Ordena 
  menu-item listas_correos-id_lista
label 'id_lista( listas_correos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=listas_correos.id_lista').
                  run set-attribute-list('titulo=CodLista').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by listas_correos.id_lista
...
case p:
  WHEN 'listas_correos.id_lista' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_lista = integer(valor)  no-lock no-error .
  WHEN 'listas_correos.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_lista" "listas_correos" "id_lista"}
