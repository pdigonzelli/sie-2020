...
ON LEAVE OF bancos.id_banco IN FRAME F-Main /* Cód.Banco */
DO:
{custom/support/validacion.i}
END.
...
ON LEAVE OF bancos.observaciones IN FRAME F-Main /* Observación */
DO:
{custom/support/validacion.i}
END.
...
ON LEAVE OF bancos.pais IN FRAME F-Main /* País */
DO:
{custom/support/validacion.i}
END.
...
ON LEAVE OF bancos.postal IN FRAME F-Main /* Cód. Postal */
DO:
{custom/support/validacion.i}
END.
...
ON LEAVE OF bancos.telefono[1] IN FRAME F-Main /* Teléfono[1] */
DO:
{custom/support/validacion.i}
END.
...
ON LEAVE OF bancos.telefono[2] IN FRAME F-Main /* Teléfono[2] */
DO:
{custom/support/validacion.i}
END.
...
ON LEAVE OF bancos.telefono[3] IN FRAME F-Main /* Teléfono[3] */
DO:
{custom/support/validacion.i}
END.
