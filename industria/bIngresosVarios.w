...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_punto_venta ~
rowObject.nro_comprobante rowObject.fecha 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.fecha FORMAT "99/99/99":U WIDTH 10
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_punto_venta
     _FldNameList[2]   = _<SDO>.rowObject.nro_comprobante
     _FldNameList[3]   > _<SDO>.rowObject.fecha
"rowObject.fecha" ? ? "date" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" ""
