...
DEFINE VARIABLE h_b_oe_factura_packing AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.00 , 89.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.00 , 115.00 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_oe_factura_packing.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_oe_factura_packing ).
       RUN set-position IN h_b_oe_factura_packing ( 2.91 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b_oe_factura_packing ( 22.86 , 156.00 ) NO-ERROR.

       /* Links to csmartbrowser h_b_oe_factura_packing. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_oe_factura_packing ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_oe_factura_packing ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
