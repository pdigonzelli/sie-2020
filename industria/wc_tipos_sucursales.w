...
DEFINE VARIABLE h_bc_tipos_sucursales AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_tipos_sucursales.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_tipos_sucursales ).
       RUN set-position IN h_bc_tipos_sucursales ( 2.43 , 11.00 ) NO-ERROR.
       RUN set-size IN h_bc_tipos_sucursales ( 6.71 , 66.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_tipos_sucursales ,
