...
DEFINE VARIABLE h_bc_productos_calidades AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_productos_calidades.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_productos_calidades ).
       RUN set-position IN h_bc_productos_calidades ( 2.43 , 4.00 ) NO-ERROR.
       RUN set-size IN h_bc_productos_calidades ( 6.71 , 91.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_productos_calidades ,
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEFINE OUTPUT PARAMETER p2_articulo AS INTEGER.

p2_articulo = p_articulo.
END PROCEDURE.
