...
&Scoped-define INTERNAL-TABLES estados_lotes

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table estados_lotes.id_estado_lote ~
estados_lotes.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH estados_lotes WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table estados_lotes
&Scoped-define FIRST-TABLE-IN-QUERY-br_table estados_lotes
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.estados_lotes"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.estados_lotes.id_estado_lote
     _FldNameList[2]   = general.estados_lotes.descripcion
...
define sub-menu Ordena 
  menu-item estados_lotes-id_estado_lote
label 'id_estado_lote( estados_lotes ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=estados_lotes.id_estado_lote').
                  run set-attribute-list('titulo=Cod.Estado Lote').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by estados_lotes.id_estado_lote
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item estados_lotes-descripcion
label 'descripcion( estados_lotes ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=estados_lotes.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by estados_lotes.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by estados_lotes.id_estado_lote
...
case p:
  WHEN 'estados_lotes.id_estado_lote' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_estado_lote = integer(valor)  no-lock no-error .
  WHEN 'estados_lotes.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "estados_lotes"}
