...
DEFINE VARIABLE h_b_cobranza_me_pe AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 15.29 COL 111
     salir AT ROW 15.29 COL 123
     RECT-1 AT ROW 15.05 COL 108
     SPACE(9.79) SKIP(0.51)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_cobranza_me_pe.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_cobranza_me_pe ).
       RUN set-position IN h_b_cobranza_me_pe ( 1.95 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b_cobranza_me_pe ( 12.14 , 133.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_cobranza_me_pe ,
