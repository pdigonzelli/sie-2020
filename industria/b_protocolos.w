...
&Scoped-define INTERNAL-TABLES protocolos contramarcas
...
protocolos.anio contramarcas.abreviatura protocolos.aprobado 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH protocolos WHERE ~{&KEY-PHRASE} ~
      AND protocolos.anio >= 3 ~
 NO-LOCK, ~
      EACH contramarcas OF protocolos OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH protocolos WHERE ~{&KEY-PHRASE} ~
      AND protocolos.anio >= 3 ~
 NO-LOCK, ~
      EACH contramarcas OF protocolos OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table protocolos contramarcas
&Scoped-define FIRST-TABLE-IN-QUERY-br_table protocolos
&Scoped-define SECOND-TABLE-IN-QUERY-br_table contramarcas
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      protocolos.id_protocolo COLUMN-LABEL "Protocolo" FORMAT "->>>>>9":U
            WIDTH 12.2
      protocolos.anio FORMAT ">>>9":U WIDTH 6.2
      contramarcas.abreviatura FORMAT "X(12)":U WIDTH 17.2
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.protocolos,industria.contramarcas OF general.protocolos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", OUTER"
     _Where[1]         = "general.protocolos.anio >= 3
"
     _FldNameList[1]   > general.protocolos.id_protocolo
"protocolos.id_protocolo" "Protocolo" ? "integer" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[2]   > general.protocolos.anio
"protocolos.anio" ? ? "integer" ? ? ? ? ? ? no ? no no "6.2" yes no no "U" "" ""
     _FldNameList[3]   > general.contramarcas.abreviatura
"contramarcas.abreviatura" ? ? "character" ? ? ? ? ? ? no ? no no "17.2" yes no no "U" "" ""
     _FldNameList[4]   > general.protocolos.aprobado
"protocolos.aprobado" "Aprob" ? "logical" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
