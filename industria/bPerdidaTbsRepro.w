...
rowObject.anio_lote rowObject.brix_20_20 rowObject.acidez_p_p ~
rowObject.tambores rowObject.kilos rowObject.kilos_400 ~
rowObject.id_sucursal rowObject.fecha rowObject.nromov 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.anio_lote FORMAT ">>99":U
      rowObject.brix_20_20 FORMAT "->>,>>9.99":U
      rowObject.acidez_p_p FORMAT "->>,>>9.99":U
      rowObject.tambores FORMAT ">>,>>9":U
      rowObject.kilos FORMAT ">>>,>>9.999":U
      rowObject.kilos_400 FORMAT ">,>>>,>>9.999":U
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dPerdidaTbsRepro.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = _<SDO>.rowObject.brix_20_20
     _FldNameList[4]   = _<SDO>.rowObject.acidez_p_p
     _FldNameList[5]   = _<SDO>.rowObject.tambores
     _FldNameList[6]   = _<SDO>.rowObject.kilos
     _FldNameList[7]   = _<SDO>.rowObject.kilos_400
     _FldNameList[8]   = _<SDO>.rowObject.id_sucursal
     _FldNameList[9]   = _<SDO>.rowObject.fecha
