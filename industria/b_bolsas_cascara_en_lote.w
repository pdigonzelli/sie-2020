...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria WHERE tambores_industria.id_empresa_destino = composicion_lote.id_empresa ~
  AND tambores_industria.id_sucursal_destino = composicion_lote.id_sucursal ~
  AND tambores_industria.id_tipotambor_destino = composicion_lote.id_tipotambor ~
  AND tambores_industria.nromov_destino = composicion_lote.nromov ~
  AND tambores_industria.id_tambor >= composicion_lote.Numeracion_desde ~
  AND tambores_industria.id_tambor <= composicion_lote.Numeracion_hasta NO-LOCK ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tambores_industria.id_tambor COLUMN-LABEL "Bolsa" FORMAT ">>>>9":U
            WIDTH 10.2
      tambores_industria.Fecha FORMAT "99/99/99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 35 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_industria WHERE general.composicion_lote ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _OrdList          = "general.tambores_industria.id_tambor|yes"
     _JoinCode[1]      = "general.tambores_industria.id_empresa_destino = general.composicion_lote.id_empresa
  AND general.tambores_industria.id_sucursal_destino = general.composicion_lote.id_sucursal
  AND general.tambores_industria.id_tipotambor_destino = general.composicion_lote.id_tipotambor
  AND general.tambores_industria.nromov_destino = general.composicion_lote.nromov
  AND general.tambores_industria.id_tambor >= general.composicion_lote.Numeracion_desde
  AND general.tambores_industria.id_tambor <= general.composicion_lote.Numeracion_hasta"
     _FldNameList[1]   > general.tambores_industria.id_tambor
"tambores_industria.id_tambor" "Bolsa" ">>>>9" "integer" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
