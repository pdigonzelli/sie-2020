...
rowObject.anio rowObject.item rowObject.semana_entrega rowObject.cantidad ~
rowObject.Articulos rowObject.Calidades 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      anio FORMAT ">>>9":U
      item FORMAT ">>>,>>9":U
      semana_entrega COLUMN-LABEL "Semana Entrega" FORMAT ">>9":U
      cantidad FORMAT "->>>,>>>,>>9.99":U
      Articulos FORMAT "x(30)":U
      Calidades FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "sdocontratosrelease.w"
   Allow: Basic,Browse
   Frames: 1
...
"anio" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.item
"item" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.semana_entrega
"semana_entrega" "Semana Entrega" ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[5]   > _<SDO>.rowObject.cantidad
"cantidad" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[6]   = _<SDO>.rowObject.Articulos
     _FldNameList[7]   = _<SDO>.rowObject.Calidades
