...
&Scoped-Define ENABLED-OBJECTS RECT-15 RECT-2 RECT-19 
...
DEFINE VARIABLE h_b_tipos_movimientos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_movimientos AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_movimientos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_movimientos ).
       RUN set-position IN h_b_tipos_movimientos ( 4.33 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 72.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_movimientos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_movimientos ).
       RUN set-position IN h_v_tipos_movimientos ( 11.95 , 7.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.24 , 68.00 ) */

       /* Links to csmartbrowser h_b_tipos_movimientos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_movimientos ).

       /* Links to SmartViewer h_v_tipos_movimientos. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_movimientos , 'Record':U , h_v_tipos_movimientos ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_movimientos ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_movimientos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_movimientos ,
             h_b_tipos_movimientos , 'AFTER':U ).
    END. /* Page 0 */
