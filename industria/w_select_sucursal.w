...
/* Local Variable Definitions ---                                       */
  ...
  DEFINE OUTPUT PARAMETER p_suc AS INTEGER no-undo.
  DEFINE OUTPUT PARAMETER p_tip AS INTEGER no-undo.
...
&Scoped-Define ENABLED-OBJECTS id_sucursal id_tipocomp aceptar salir RECT-1 
&Scoped-Define DISPLAYED-OBJECTS id_sucursal id_tipocomp 
...
DEFINE VARIABLE id_sucursal AS INTEGER FORMAT ">>9":U INITIAL 0 
     LABEL "Sucursal" 
     VIEW-AS FILL-IN 
     SIZE 9 BY 1 NO-UNDO.

DEFINE VARIABLE id_tipocomp AS INTEGER FORMAT ">>9":U INITIAL 123 
...
DEFINE FRAME D-Dialog
     id_sucursal AT ROW 1.95 COL 22 COLON-ALIGNED
     id_tipocomp AT ROW 2.91 COL 22 COLON-ALIGNED
     aceptar AT ROW 5.52 COL 48
     salir AT ROW 5.52 COL 60
     RECT-1 AT ROW 5.29 COL 45
     "122 - Remito Manual" VIEW-AS TEXT
          SIZE 22 BY .62 AT ROW 3.14 COL 38
     "123 - Remito Automatico" VIEW-AS TEXT
          SIZE 25 BY .62 AT ROW 3.86 COL 38
     SPACE(10.19) SKIP(2.61)
...
DO:
  ...
  p_suc = INTEGER(id_sucursal:SCREEN-VALUE IN FRAME D-Dialog).
  p_tip = INTEGER(id_tipocomp:SCREEN-VALUE IN FRAME D-Dialog).
...
------------------------------------------------------------------------------*/
  DISPLAY id_sucursal id_tipocomp 
      WITH FRAME D-Dialog.
  ENABLE id_sucursal id_tipocomp aceptar salir RECT-1 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
