...
find items_orden_entrega where items_orden_entrega.id_orden_entrega = p_id_orden_entrega 
                           ...
                           no-error.
/* MESSAGE "Estoy en p_calculo_fob_ton_item_oe.p" VIEW-AS ALERT-BOX.*/
FOR EACH r_clausulas_gastos_item_oe WHERE r_clausulas_gastos_item_oe.id_clausula = items_orden_entrega.id_condicion_venta NO-LOCK.
    ...
    /* MESSAGE "Gasto " r_clausulas_gastos_item_oe.id_gasto VIEW-AS ALERT-BOX. */
    ...
    IF AVAILABLE gastos_items_orden_entrega THEN DO:
        ...
        IF gastos_items_orden_entrega.id_gasto = 5 /* FLETE */ THEN 
        ...
        IF gastos_items_orden_entrega.id_gasto <> 13 THEN 
          p_gastos = p_gastos + gastos_items_orden_entrega.importe.
        /* MESSAGE "Importe del Gasto " gastos_items_orden_entrega.importe VIEW-AS ALERT-BOX. */
    END.
    ELSE DO:
...
ELSE DO:
    ...
    /* MESSAGE "Total Factura " v_total_factura " gastos " p_gastos VIEW-AS ALERT-BOX. */
    assign items_orden_entrega.fob_ton = v_total_factura - p_gastos.
    p_fob_ton = v_total_factura - p_gastos.

    /* MESSAGE "Fob " p_fob_ton VIEW-AS ALERT-BOX. */
    ...
    CASE items_orden_entrega.id_tipo_unidad_venta:
        ...
        WHEN 2 THEN /* KILOS */ DO:
            ...
            /* MESSAGE "Fob unitario " v_fob_unitario " = " p_fob_ton " / " items_orden_entrega.kgs_netos_tambores VIEW-AS ALERT-BOX. */
        END.
    ...
    END CASE.
     ...
     /* MESSAGE "Fob unitario " v_fob_unitario VIEW-AS ALERT-BOX. */
