...
&Scoped-Define ENABLED-FIELDS RowObject.kilos_envase 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define DISPLAYED-FIELDS RowObject.kilos_envase 
...
DEFINE FRAME F-Main
     RowObject.kilos_envase AT ROW 2.24 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.4 BY 1
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_denvasesprod ( 1.48 , 36.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_dynselect ,
             RowObject.kilos_envase:HANDLE IN FRAME F-Main , 'BEFORE':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  cQry = "envases_prod.id_envase >= 500 AND envases_prod.id_envase <= 600".
