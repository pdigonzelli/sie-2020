...
&Scoped-Define ENABLED-OBJECTS RECT-2 BUTTON-17 
...
DEFINE VARIABLE h_v_lotes_jugo_orden_entrega AS HANDLE NO-UNDO.
...
if available lotes_jugo then
    do:
        find orden_entrega of lotes_jugo no-lock no-error.
        if available lotes_jugo then
            do:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 34.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_lotes_orden_fabricacion_todo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_lotes_jugo_orden_entrega.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_lotes_jugo_orden_entrega ).
       RUN set-position IN h_v_lotes_jugo_orden_entrega ( 11.48 , 42.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 63.00 ) */
       ...
       /* Links to SmartViewer h_v_lotes_jugo_orden_entrega. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_orden_fabricacion_todo , 'Record':U , h_v_lotes_jugo_orden_entrega ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_lotes_jugo_orden_entrega ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_lotes_jugo_orden_entrega ,
