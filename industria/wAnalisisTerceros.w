...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Analisis Lotes de Terceros"
         HEIGHT             = 22.81
         WIDTH              = 130.2
         MAX-HEIGHT         = 33.38
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF wWin /* Analisis Lotes de Terceros */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Analisis Lotes de Terceros */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dproductosterceros ( 8.62 , 82.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_bproductosterceros ( 1.00 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_bproductosterceros ( 9.76 , 78.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dinspeccioneslote ( 8.38 , 96.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN repositionObject IN h_binspeccioneslote ( 11.24 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_binspeccioneslote ( 4.29 , 130.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_vinspeccioneslote ( 17.43 , 25.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_dyntoolbar ).
       RUN repositionObject IN h_dyntoolbar ( 1.00 , 80.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 51.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'adm2/dynfilter.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsid_lote,anio_lote,id_sucursal,nromovOperatorStyleImplicitOperatorViewAsCombo-boxOperator=UseBeginsyesUseContainsyesDefaultWidth10DefaultCharWidth20DefaultEditorLines1ViewAsFieldsFieldOperatorStylesFieldFormatsFieldWidthsFieldLabelsFieldToolTipsFieldHelpIdsDesignDataObjectFieldColumn20HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynfilter ).
       RUN repositionObject IN h_dynfilter ( 3.14 , 81.00 ) NO-ERROR.
       RUN resizeObject IN h_dynfilter ( 5.57 , 48.20 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dyntoolbar-2 ( 15.76 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntoolbar-2 ( 1.24 , 130.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_dyntoolbar ,
             h_bproductosterceros , 'AFTER':U ).
       RUN adjustTabOrder ( h_dynfilter ,
             h_dyntoolbar , 'AFTER':U ).
       RUN adjustTabOrder ( h_binspeccioneslote ,
             h_dynfilter , 'AFTER':U ).
       RUN adjustTabOrder ( h_dyntoolbar-2 ,
             h_binspeccioneslote , 'AFTER':U ).
       RUN adjustTabOrder ( h_vinspeccioneslote ,
