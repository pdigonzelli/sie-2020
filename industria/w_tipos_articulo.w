...
DEFINE VARIABLE h_b_tipos_articulo AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_articulo AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_articulo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_articulo ).
       RUN set-position IN h_b_tipos_articulo ( 3.86 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 77.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_articulo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_articulo ).
       RUN set-position IN h_v_tipos_articulo ( 11.71 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 51.00 ) */

       /* Links to csmartbrowser h_b_tipos_articulo. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_articulo ).

       /* Links to SmartViewer h_v_tipos_articulo. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_articulo , 'Record':U , h_v_tipos_articulo ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_articulo ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_articulo ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_articulo ,
             h_b_tipos_articulo , 'AFTER':U ).
    END. /* Page 0 */
