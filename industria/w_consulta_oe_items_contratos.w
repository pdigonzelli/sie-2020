...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_consulta_oe ( 2.67 , 16.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.86 , 96.00 ) */
       ...
       RUN set-position IN h_b_consulta_items_contratos ( 16.00 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 117.00 ) */
       ...
       RUN add-link IN adm-broker-hdl ( h_b_consulta_oe , 'Record':U , h_b_consulta_items_contratos ).
