...
DEFINE FRAME F-Main
     ...
     BUTTON-1 AT ROW 18.14 COL 88
     BUTTON-2 AT ROW 18.14 COL 116
...
DO:
  ...
  RUN get-rowid1 IN h_bc_items_contratos (OUTPUT rresult).
  r = rresult.  
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_bc_contratos ( 6.43 , 139.00 ) NO-ERROR.
       ...
       RUN set-size IN h_bc_items_contratos ( 6.71 , 121.00 ) NO-ERROR.
