...
&Scoped-define INTERNAL-TABLES Caracteristicas_quimicas
...
Caracteristicas_quimicas.descripcion Caracteristicas_quimicas.programa 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Caracteristicas_quimicas WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Caracteristicas_quimicas
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Caracteristicas_quimicas
...
<FOREIGN-KEYS>
id_caracteristica||y|general.Caracteristicas_quimicas.id_caracteristica
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_caracteristica"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Caracteristicas_quimicas.id_caracteristica COLUMN-LABEL "Cod" FORMAT ">>9":U
            WIDTH 7.2
      Caracteristicas_quimicas.descripcion FORMAT "X(60)":U WIDTH 60.2
      Caracteristicas_quimicas.programa FORMAT "X(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.Caracteristicas_quimicas"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.Caracteristicas_quimicas.id_caracteristica
"id_caracteristica" "Cod" ? "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
     _FldNameList[2]   > general.Caracteristicas_quimicas.descripcion
"descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "60.2" yes no no "U" "" ""
     _FldNameList[3]   = general.Caracteristicas_quimicas.programa
...
label 'descripcion( Caracteristicas_quimicas ) '
  ...
  menu-item Caracteristicas_quimicas-programa
label 'programa( Caracteristicas_quimicas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=Caracteristicas_quimicas.programa').
                  run set-attribute-list('titulo=Programa').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by Caracteristicas_quimicas.programa
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by Caracteristicas_quimicas.id_caracteristica
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_caracteristica" "Caracteristicas_quimicas" "id_caracteristica"}
