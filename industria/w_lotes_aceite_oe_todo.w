...
DEFINE VARIABLE h_b_lotes_aceite_contratos_todo AS HANDLE NO-UNDO.
...
run get-rowid1 in h_b_lotes_aceite_contratos_todo (output r).
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 6.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_lotes_aceite_contratos_todo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_lotes_aceite_contratos_todo ).
       RUN set-position IN h_b_lotes_aceite_contratos_todo ( 4.10 , 5.00 ) NO-ERROR.
       ...
       /* Links to csmartbrowser h_b_lotes_aceite_contratos_todo. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_lotes_aceite_contratos_todo ).

       /* Links to SmartViewer h_v_lotes_aceite_oe. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_aceite_contratos_todo , 'Record':U , h_v_lotes_aceite_oe ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_lotes_aceite_oe ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_lotes_aceite_contratos_todo ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_lotes_aceite_oe ,
             h_b_lotes_aceite_contratos_todo , 'AFTER':U ).
    END. /* Page 0 */
