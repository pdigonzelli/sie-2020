...
fiSucursal BUTTON-46 BUTTON-1 BUTTON-2 BUTTON-3 BUTTON-47 
...
DEFINE FRAME fMain
     ...
     BUTTON-46 AT ROW 9.33 COL 70
     BUTTON-1 AT ROW 4.81 COL 70
     BUTTON-2 AT ROW 6.24 COL 70
     BUTTON-3 AT ROW 7.91 COL 70
...
DO:
  ...
  END.
  ELSE DO:
    RUN callReportePerdida IN hLib (DATE(fi-Desde:SCREEN-VALUE), 
                                    DATE(fi-Hasta:SCREEN-VALUE), 
                                    INTEGER(fiSucursal:SCREEN-VALUE), 
                                    TRUE).
  ...
  RUN exportExcelPerdida IN hLibRep.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE chkCargas optTipoTambor fi-desde fi-hasta fiSucursal BUTTON-46 
         BUTTON-1 BUTTON-2 BUTTON-3 BUTTON-47 
      WITH FRAME fMain IN WINDOW wWin.
