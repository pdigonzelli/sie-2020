...
rowObject.item_oe rowObject.semana rowObject.OrdenFab ~
rowObject.fecha_despacho rowObject.fecha_arribo rowObject.Tambores ~
rowObject.Lote rowObject.Producto rowObject.Envase rowObject.Cliente ~
rowObject.Naviera rowObject.TipoTrans 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.OrdenFab FORMAT ">>>>>9":U
      rowObject.fecha_despacho FORMAT "99/99/9999":U
      rowObject.fecha_arribo FORMAT "99/99/9999":U
      rowObject.Tambores FORMAT ">>>9":U
      rowObject.Lote FORMAT "x(15)":U
      rowObject.Producto FORMAT "x(20)":U
      rowObject.Envase FORMAT "x(20)":U
      rowObject.Cliente FORMAT "x(30)":U
      rowObject.Naviera FORMAT "x(25)":U
      rowObject.TipoTrans FORMAT "x(25)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"rowObject.id_orden_entrega" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     ...
     _FldNameList[3]   = _<SDO>.rowObject.semana
     _FldNameList[4]   = _<SDO>.rowObject.OrdenFab
     _FldNameList[5]   = _<SDO>.rowObject.fecha_despacho
     _FldNameList[6]   = _<SDO>.rowObject.fecha_arribo
     _FldNameList[7]   = _<SDO>.rowObject.Tambores
     _FldNameList[8]   = _<SDO>.rowObject.Lote
     _FldNameList[9]   = _<SDO>.rowObject.Producto
     _FldNameList[10]   = _<SDO>.rowObject.Envase
     _FldNameList[11]   = _<SDO>.rowObject.Cliente
     _FldNameList[12]   = _<SDO>.rowObject.Naviera
     _FldNameList[13]   = _<SDO>.rowObject.TipoTrans
