...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_tipo_movimiento ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.descripcion FORMAT "X(30)":U WIDTH 50.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 65.4 BY 6.67 ROW-HEIGHT-CHARS .52 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_tipo_movimiento
"rowObject.id_tipo_movimiento" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.descripcion
"rowObject.descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "50.2" yes no no "U" "" ""
