...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Compania ~
rowObject.Destino rowObject.cantidad rowObject.Vapor rowObject.Fecha ~
rowObject.semana 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.Compania FORMAT "X(50)":U WIDTH 16.2
      rowObject.Destino FORMAT "X(30)":U
      rowObject.cantidad FORMAT ">>>9":U
      rowObject.Vapor COLUMN-LABEL "Vapor" FORMAT "x(30)":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.Compania
"rowObject.Compania" ? ? "character" ? ? ? ? ? ? no "?" no no "16.2" yes no no "U" "" ""
...
"rowObject.cantidad" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.Vapor
"rowObject.Vapor" "Vapor" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
