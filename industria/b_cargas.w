...
&Scoped-define INTERNAL-TABLES cargas sucursales productos_terminados
...
sucursales.abreviatura cargas.id_carga cargas.Fecha cargas.id_articulo ~
productos_terminados.descripcion cargas.c_usuario 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH cargas WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH sucursales OF cargas NO-LOCK, ~
      EACH productos_terminados OF cargas NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table cargas sucursales ~
productos_terminados
&Scoped-define FIRST-TABLE-IN-QUERY-br_table cargas
...
<FOREIGN-KEYS>
id_tipotambor||y|general.cargas.id_tipotambor
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.cargas,comercial.sucursales OF general.cargas,general.productos_terminados OF general.cargas"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = comercial.sucursales.id_sucursal
     _FldNameList[2]   = comercial.sucursales.abreviatura
     _FldNameList[3]   = general.cargas.id_carga
     _FldNameList[4]   = general.cargas.Fecha
     _FldNameList[5]   = general.cargas.id_articulo
     _FldNameList[6]   = general.productos_terminados.descripcion
     _FldNameList[7]   = general.cargas.c_usuario
...
label 'abreviatura( sucursales ) '
  ...
  menu-item cargas-id_carga
label 'id_carga( cargas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=cargas.id_carga').
                  run set-attribute-list('titulo=NroCarga').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by cargas.id_carga
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item cargas-Fecha
label 'Fecha( cargas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=cargas.Fecha').
                  run set-attribute-list('titulo=Fecha').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by cargas.Fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item cargas-id_articulo
label 'id_articulo( cargas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=cargas.id_articulo').
                  run set-attribute-list('titulo=Artículo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by cargas.id_articulo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
...
label 'descripcion( productos_terminados ) '
  ...
  menu-item cargas-c_usuario
label 'c_usuario( cargas ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=cargas.c_usuario').
                  run set-attribute-list('titulo=Usuario').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by cargas.c_usuario
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by sucursales.id_sucursal
...
case p:
  WHEN 'cargas.id_carga' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_carga = integer(valor)  no-lock no-error .
  WHEN 'cargas.Fecha' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  Fecha = date(valor)  no-lock no-error .
  WHEN 'cargas.id_articulo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_articulo = integer(valor)  no-lock no-error .
  WHEN 'cargas.c_usuario' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipotambor" "cargas" "id_tipotambor"}
