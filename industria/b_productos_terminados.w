...
&Scoped-define INTERNAL-TABLES productos_terminados

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table productos_terminados.id_articulo ~
productos_terminados.descripcion productos_terminados.abreviatura ~
productos_terminados.kilos productos_terminados.costo ~
productos_terminados.unidad_almacen ~
productos_terminados.unidad_distribucion productos_terminados.fecha_baja 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH productos_terminados WHERE ~{&KEY-PHRASE} ~
      AND productos_terminados.id_tipo_articulo = 2 NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table productos_terminados
&Scoped-define FIRST-TABLE-IN-QUERY-br_table productos_terminados
...
<FOREIGN-KEYS>
id_articulo||y|general.productos_terminados.id_articulo
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      productos_terminados.kilos
      productos_terminados.costo
      productos_terminados.unidad_almacen
      productos_terminados.unidad_distribucion
      productos_terminados.fecha_baja
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.productos_terminados"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "general.productos_terminados.id_tipo_articulo = 2"
     _FldNameList[1]   = general.productos_terminados.id_articulo
     _FldNameList[2]   = general.productos_terminados.descripcion
     _FldNameList[3]   = general.productos_terminados.abreviatura
     _FldNameList[4]   = general.productos_terminados.kilos
     _FldNameList[5]   = general.productos_terminados.costo
     _FldNameList[6]   = general.productos_terminados.unidad_almacen
     _FldNameList[7]   = general.productos_terminados.unidad_distribucion
     _FldNameList[8]   = general.productos_terminados.fecha_baja
...
define sub-menu Ordena 
  menu-item productos_terminados-id_articulo
label 'id_articulo( productos_terminados ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=productos_terminados.id_articulo').
                  run set-attribute-list('titulo=Código').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by productos_terminados.id_articulo
...
label 'abreviatura( productos_terminados ) '
  ...
  menu-item productos_terminados-kilos
label 'kilos( productos_terminados ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=productos_terminados.kilos').
                  run set-attribute-list('titulo=Kilos').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by productos_terminados.kilos
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item productos_terminados-costo
label 'costo( productos_terminados ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=productos_terminados.costo').
                  run set-attribute-list('titulo=Costo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by productos_terminados.costo
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item productos_terminados-unidad_almacen
label 'unidad_almacen( productos_terminados ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=productos_terminados.unidad_almacen').
                  run set-attribute-list('titulo=Un.Almacen').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by productos_terminados.unidad_almacen
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item productos_terminados-unidad_distribucion
label 'unidad_distribucion( productos_terminados ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=productos_terminados.unidad_distribucion').
                  run set-attribute-list('titulo=Un.Distrib.').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by productos_terminados.unidad_distribucion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item productos_terminados-fecha_baja
label 'fecha_baja( productos_terminados ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=productos_terminados.fecha_baja').
                  run set-attribute-list('titulo=Fecha baja').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by productos_terminados.fecha_baja
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by productos_terminados.id_articulo
...
case p:
  WHEN 'productos_terminados.id_articulo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_articulo = integer(valor)  no-lock no-error .
  WHEN 'productos_terminados.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'productos_terminados.abreviatura' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  abreviatura begins valor  no-lock no-error .
  WHEN 'productos_terminados.kilos' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  kilos = decimal(valor)  no-lock no-error .
  WHEN 'productos_terminados.costo' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  costo = decimal(valor)  no-lock no-error .
  WHEN 'productos_terminados.unidad_almacen' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  unidad_almacen = integer(valor)  no-lock no-error .
  WHEN 'productos_terminados.unidad_distribucion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  unidad_distribucion = integer(valor)  no-lock no-error .
  WHEN 'productos_terminados.fecha_baja' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  fecha_baja = date(valor)  no-lock no-error .
end.
END PROCEDURE.
