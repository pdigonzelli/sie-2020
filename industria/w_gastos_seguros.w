...
&Scoped-Define ENABLED-OBJECTS RECT-9 RECT-2 
...
DEFINE VARIABLE h_b_gastos_seguros AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_gastos_seguros AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Gastos Seguro */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Gastos Seguro */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 13.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 47.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 70.80 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_gastos_seguros.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_gastos_seguros ).
       RUN set-position IN h_b_gastos_seguros ( 3.86 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 101.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_gastos_seguros.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_gastos_seguros ).
       RUN set-position IN h_v_gastos_seguros ( 11.24 , 23.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.00 , 54.00 ) */

       /* Links to csmartbrowser h_b_gastos_seguros. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_gastos_seguros ).

       /* Links to SmartViewer h_v_gastos_seguros. */
       RUN add-link IN adm-broker-hdl ( h_b_gastos_seguros , 'Record':U , h_v_gastos_seguros ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_gastos_seguros ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_gastos_seguros ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_gastos_seguros ,
             h_b_gastos_seguros , 'AFTER':U ).
    END. /* Page 0 */
