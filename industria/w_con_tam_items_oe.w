...
DEFINE VARIABLE h_bc_consulta_items_orden_entreg AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_new_orden_entrega AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b_tambores_items_orden_entrega AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_new_orden_entrega ( 1.24 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_new_orden_entrega ( 5.48 , 123.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 129.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 3.14 , 129.00 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 24.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/bc_consulta_items_orden_entrega.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_bc_consulta_items_orden_entreg ).
       RUN set-position IN h_bc_consulta_items_orden_entreg ( 6.95 , 3.00 ) NO-ERROR.
       RUN set-size IN h_bc_consulta_items_orden_entreg ( 5.24 , 148.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tambores_items_orden_entrega.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tambores_items_orden_entrega ).
       RUN set-position IN h_b_tambores_items_orden_entrega ( 12.43 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_tambores_items_orden_entrega ( 10.24 , 87.00 ) NO-ERROR.
       ...
       /* Links to csmartbrowser h_bc_consulta_items_orden_entreg. */
       RUN add-link IN adm-broker-hdl ( h_b_new_orden_entrega , 'Record':U , h_bc_consulta_items_orden_entreg ).

       /* Links to csmartbrowser h_b_tambores_items_orden_entrega. */
       RUN add-link IN adm-broker-hdl ( h_bc_consulta_items_orden_entreg , 'record':U , h_b_tambores_items_orden_entrega ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_bc_consulta_items_orden_entreg ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tambores_items_orden_entrega ,
             h_bc_consulta_items_orden_entreg , 'AFTER':U ).
    END. /* Page 0 */
