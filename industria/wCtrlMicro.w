...
ON END-ERROR OF wWin /* Control Microbiologia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Control Microbiologia */
DO:
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeSTATE-RESETDestroyStatelessnoDisconnectAppServernoObjectNamedlotesjugoUpdateFromSourcenoToggleDataTargetsyesOpenOnInityes':U ,
             OUTPUT h_dlotesjugo ).
       RUN repositionObject IN h_dlotesjugo ( 9.81 , 91.00 ) NO-ERROR.
       ...
       RUN resizeObject IN h_blotesjugo ( 11.43 , 101.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsid_sucursal,microbiologia,Fecha,id_lote,anio,id_articuloOperatorStyleImplicitOperatorViewAsCombo-boxOperator=UseBeginsyesUseContainsyesDefaultWidth16DefaultCharWidth20DefaultEditorLines1ViewAsFieldsFieldOperatorStylesFieldFormatsFieldWidthsFieldLabelsid_loteLoteid_sucursalSucursalFieldToolTipsFieldHelpIdsid_lote0id_sucursal0microbiologia0DesignDataObjectFieldColumn20HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynfilter ).
...
------------------------------------------------------------------------------*/
  ...
  /*Boton de Aprobacion Control Microbiologia*/
  RUN ToolBarButtonAdd.p (h_dyntoolbar, 
                          "aproveAction", 
                          "tlbAprobar", 
                          "Aprobar Lote Microbiologia", 
                          "check.bmp", 
                          "tlbAprobar", 
                          "FUNCTION").
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN setControlMicrobiologia IN h_dLotesJugo (TRUE).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN setControlMicrobiologia IN h_dLotesJugo (FALSE).
