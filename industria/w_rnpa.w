...
DEFINE VARIABLE h_b_rnpa AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_rnpa.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_rnpa ).
       RUN set-position IN h_b_rnpa ( 4.14 , 8.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       /* Links to csmartbrowser h_b_rnpa. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_rnpa ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_b_rnpa ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_rnpa ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
