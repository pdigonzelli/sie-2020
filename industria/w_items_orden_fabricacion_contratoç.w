...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b_items_orden_fabricacion_cont ( 4.33 , 10.00 ) NO-ERROR.
       RUN set-size IN h_b_items_orden_fabricacion_cont ( 6.71 , 82.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v_items_orden_fabricacion_cont ( 12.19 , 9.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b_envios_items_contrato ( 4.33 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_envios_items_contrato ( 6.71 , 78.00 ) NO-ERROR.
