...
&Scoped-define QUERY-STRING-br_table FOR EACH proveedores WHERE ~{&KEY-PHRASE} ~
      AND proveedores.estado = TRUE NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH proveedores WHERE ~{&KEY-PHRASE} ~
      AND proveedores.estado = TRUE NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      proveedores.id_proveedor FORMAT ">>>,>>9":U
      proveedores.nombre FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 69 BY 6.71
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "comercial.proveedores.estado = TRUE"
