...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "general.items_release_delivery"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   > general.items_release_delivery.container
"container" "container" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes
     _FldNameList[2]   > general.items_release_delivery.galones
"galones" "galones" ? ? "integer" ? ? ? ? ? ? yes ? no 10.2 yes
     _FldNameList[3]   > general.items_release_delivery.id_lote
"id_lote" "id_lote" ? ? "integer" ? ? ? ? ? ? yes ? no 10.2 yes
     _FldNameList[4]   > general.items_release_delivery.id_lote_deposito
"id_lote_deposito" "id_lote_deposito" ? ? "character" ? ? ? ? ? ? yes ? no 40 yes
     _FldNameList[5]   > general.items_release_delivery.id_release_delivery
"id_release_delivery" "id_release_delivery" ? ? "integer" ? ? ? ? ? ? yes ? no 18 yes
     _FldNameList[6]   > general.items_release_delivery.id_vapor
"id_vapor" "id_vapor" ? ? "integer" ? ? ? ? ? ? yes ? no 10.2 yes
     _FldNameList[7]   > general.items_release_delivery.item_release_delivery
