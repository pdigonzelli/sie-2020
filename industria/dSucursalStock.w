...
&Scoped-Define DATA-FIELD-DEFS "dsucursalstock.i"
&Scoped-define QUERY-STRING-Query-Main FOR EACH sucursales ~
      WHERE sucursales.id_tipo_sucursal = 6 NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH sucursales ~
      WHERE sucursales.id_tipo_sucursal = 6 NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _Where[1]         = "comercial.sucursales.id_tipo_sucursal = 6"
...
"codigo_dgi" "codigo_dgi" ? ? "integer" ? ? ? ? ? ? yes ? no 11 yes
...
"id_categoria" "id_categoria" ? ? "integer" ? ? ? ? ? ? yes ? no 6.2 yes
...
"id_tipo_sucursal" "id_tipo_sucursal" ? ? "integer" ? ? ? ? ? ? yes ? no 6.8 yes
...
"metros_servicios" "metros_servicios" ? ? "decimal" ? ? ? ? ? ? yes ? no 12.2 yes
...
"postal" "postal" ? ? "integer" ? ? ? ? ? ? yes ? no 5.8 yes
