...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tabla_entry
&Scoped-define FIRST-EXTERNAL-TABLE tabla_entry


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tabla_entry.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tabla_entry.id_articulo ~
tabla_entry.Brix_desde tabla_entry.Brix_hasta tabla_entry.grados 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_articulo ~{&FP2}id_articulo ~{&FP3}~
 ~{&FP1}Brix_desde ~{&FP2}Brix_desde ~{&FP3}~
 ~{&FP1}Brix_hasta ~{&FP2}Brix_hasta ~{&FP3}~
 ~{&FP1}grados ~{&FP2}grados ~{&FP3}
&Scoped-define ENABLED-TABLES tabla_entry
&Scoped-define FIRST-ENABLED-TABLE tabla_entry
&Scoped-Define DISPLAYED-FIELDS tabla_entry.id_articulo ~
tabla_entry.Brix_desde tabla_entry.Brix_hasta tabla_entry.grados 
...
DEFINE FRAME F-Main
     tabla_entry.id_articulo AT ROW 1 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     fi-productos_terminados-descrip AT ROW 1 COL 29 COLON-ALIGNED NO-LABEL
     tabla_entry.Brix_desde AT ROW 2 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     tabla_entry.Brix_hasta AT ROW 3 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     tabla_entry.grados AT ROW 4 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tabla_entry
...
general.tabla_entry.id_articulo;wc_articulos.w;productos_terminados.descripcion;;
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME tabla_entry.Brix_desde
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tabla_entry.Brix_desde V-table-Win
ON LEAVE OF tabla_entry.Brix_desde IN FRAME F-Main /* Brix Inicial */
DO:
...
&Scoped-define SELF-NAME tabla_entry.Brix_hasta
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tabla_entry.Brix_hasta V-table-Win
ON LEAVE OF tabla_entry.Brix_hasta IN FRAME F-Main /* Brix Final */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tabla_entry.grados
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tabla_entry.grados V-table-Win
ON LEAVE OF tabla_entry.grados IN FRAME F-Main /* Grados */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tabla_entry.id_articulo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tabla_entry.id_articulo V-table-Win
ON GO OF tabla_entry.id_articulo IN FRAME F-Main /* Artículo */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tabla_entry.id_articulo V-table-Win
ON LEAVE OF tabla_entry.id_articulo IN FRAME F-Main /* Artículo */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tabla_entry.id_articulo V-table-Win
ON MOUSE-SELECT-DBLCLICK OF tabla_entry.id_articulo IN FRAME F-Main /* Artículo */
do: 
define var r as rowid no-undo.
run wc_articulos.w(output r).
find productos_terminados where rowid(productos_terminados) = r no-lock no-error.
if available productos_terminados then 
general.tabla_entry.id_articulo:screen-value = string(productos_terminados.id_articulo).
apply 'U1' to self.
end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tabla_entry.id_articulo V-table-Win
ON U1 OF tabla_entry.id_articulo IN FRAME F-Main /* Artículo */
DO:
{custom/support/validacion.i}
     run descriptivos.
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tabla_entry"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tabla_entry"}
...
find first productos_terminados where productos_terminados.id_articulo = integer(tabla_entry.id_articulo:screen-value in frame F-Main)  no-lock no-error .
if available productos_terminados then 
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tabla_entry"}
