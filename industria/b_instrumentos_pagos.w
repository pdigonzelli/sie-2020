...
&Scoped-define INTERNAL-TABLES instrumentos_pagos
...
instrumentos_pagos.id_instrumento_pago instrumentos_pagos.descripcion ~
instrumentos_pagos.descripcion_ingles 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH instrumentos_pagos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table instrumentos_pagos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table instrumentos_pagos
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      instrumentos_pagos.id_instrumento_pago
      instrumentos_pagos.descripcion
      instrumentos_pagos.descripcion_ingles
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.instrumentos_pagos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.instrumentos_pagos.id_instrumento_pago
     _FldNameList[2]   = general.instrumentos_pagos.descripcion
     _FldNameList[3]   = general.instrumentos_pagos.descripcion_ingles
...
define sub-menu Ordena 
  menu-item instrumentos_pagos-id_instrumento_pago
label 'id_instrumento_pago( instrumentos_pagos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=instrumentos_pagos.id_instrumento_pago').
                  run set-attribute-list('titulo=Cod. Ins. Pago').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by instrumentos_pagos.id_instrumento_pago
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item instrumentos_pagos-descripcion
label 'descripcion( instrumentos_pagos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=instrumentos_pagos.descripcion').
                  run set-attribute-list('titulo=Instrumento de Pago').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by instrumentos_pagos.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item instrumentos_pagos-descripcion_ingles
label 'descripcion_ingles( instrumentos_pagos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=instrumentos_pagos.descripcion_ingles').
                  run set-attribute-list('titulo=Int. Pagos Inlges').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by instrumentos_pagos.descripcion_ingles
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by instrumentos_pagos.id_instrumento_pago
...
case p:
  WHEN 'instrumentos_pagos.id_instrumento_pago' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_instrumento_pago = integer(valor)  no-lock no-error .
  WHEN 'instrumentos_pagos.descripcion' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  descripcion begins valor  no-lock no-error .
  WHEN 'instrumentos_pagos.descripcion_ingles' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "instrumentos_pagos"}
