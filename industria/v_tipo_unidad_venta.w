...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES tipo_unidad_venta
&Scoped-define FIRST-EXTERNAL-TABLE tipo_unidad_venta


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR tipo_unidad_venta.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS tipo_unidad_venta.id_tipo_unidad_venta ~
tipo_unidad_venta.descripcion tipo_unidad_venta.abreviatura 
...
&Scoped-define ENABLED-TABLES tipo_unidad_venta
&Scoped-define FIRST-ENABLED-TABLE tipo_unidad_venta
&Scoped-Define DISPLAYED-FIELDS tipo_unidad_venta.id_tipo_unidad_venta ~
tipo_unidad_venta.descripcion tipo_unidad_venta.abreviatura 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS tipo_unidad_venta.id_tipo_unidad_venta 
...
<FOREIGN-KEYS>
id_tipo_unidad_venta|y|y|general.tipo_unidad_venta.id_tipo_unidad_venta
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "id_tipo_unidad_venta",
     Keys-Supplied = "id_tipo_unidad_venta"':U).
/**************************
</EXECUTING-CODE> */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     tipo_unidad_venta.id_tipo_unidad_venta AT ROW 1 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     tipo_unidad_venta.descripcion AT ROW 2 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     tipo_unidad_venta.abreviatura AT ROW 3 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.4 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.tipo_unidad_venta
...
/* SETTINGS FOR FILL-IN tipo_unidad_venta.id_tipo_unidad_venta IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME tipo_unidad_venta.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipo_unidad_venta.abreviatura V-table-Win
ON LEAVE OF tipo_unidad_venta.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME tipo_unidad_venta.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipo_unidad_venta.descripcion V-table-Win
ON LEAVE OF tipo_unidad_venta.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME tipo_unidad_venta.id_tipo_unidad_venta
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tipo_unidad_venta.id_tipo_unidad_venta V-table-Win
ON LEAVE OF tipo_unidad_venta.id_tipo_unidad_venta IN FRAME F-Main /* Unidad Venta */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'id_tipo_unidad_venta':U THEN
       {src/adm/template/find-tbl.i
           &TABLE = tipo_unidad_venta
           &WHERE = "WHERE tipo_unidad_venta.id_tipo_unidad_venta eq INTEGER(key-value)"
       }
  END CASE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "tipo_unidad_venta"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "tipo_unidad_venta"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_unidad_venta" "tipo_unidad_venta" "id_tipo_unidad_venta"}
