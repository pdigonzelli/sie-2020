...
&Scoped-Define ENABLED-OBJECTS FILL-IN-2 remito 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-2 remito 
...
DEFINE VARIABLE FILL-IN-2 AS CHARACTER FORMAT "X(256)":U INITIAL "Recepción de Remitos" 
     VIEW-AS FILL-IN 
     SIZE 24 BY 1
     BGCOLOR 2 FGCOLOR 0  NO-UNDO.

DEFINE VARIABLE remito AS CHARACTER FORMAT "xxxx-xxxxxxxx":U 
     LABEL "Remito" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     FILL-IN-2 AT ROW 1.95 COL 26 COLON-ALIGNED NO-LABEL
     remito AT ROW 3.62 COL 27 COLON-ALIGNED
...
ON END-ERROR OF W-Win /* Recepción de Remitos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Recepción de Remitos */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-2 remito 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE FILL-IN-2 remito 
      WITH FRAME F-Main IN WINDOW W-Win.
