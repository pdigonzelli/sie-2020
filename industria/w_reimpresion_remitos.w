...
&Scoped-Define ENABLED-OBJECTS RECT-2 BUTTON-2 
...
propath = "..\ventas," + propath.
  find last remitos where remitos.id_sucursal = 96 and id_tipo_movsto = 123
                          no-lock no-error.
