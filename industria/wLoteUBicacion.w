...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dloteubicacion ( 13.71 , 85.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_bloteubicacion ( 2.43 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_bloteubicacion ( 10.71 , 104.40 ) NO-ERROR.
       ...
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 22.80 ) NO-ERROR.
