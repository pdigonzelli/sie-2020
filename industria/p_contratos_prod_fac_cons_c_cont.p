...
FOR EACH items_contratos NO-LOCK WHERE items_contratos.id_tipo_contrato < 100
                                 /*  AND items_contratos.id_contrato = "AR-1839B"
                                     AND items_contratos.ITEM = 11
                                   AND items_contratos.fecha >= DATE("01/01/2002") */ 
                ...
                DO:
                    ...
                    IF AVAILABLE subd_vtas THEN
                        DO:
                            ...
                            /* MESSAGE subd_vtas.estado VIEW-AS ALERT-BOX. */
                        END.
                END.
