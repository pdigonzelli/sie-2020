...
&Scoped-Define ENABLED-FIELDS RowObject.fecha_elaboracion RowObject.volumen ~
...
RowObject.volumen RowObject.cantidad RowObject.kilos_tambor ~
...
DEFINE FRAME F-Main
     RowObject.fecha_elaboracion AT ROW 1 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
     RowObject.volumen AT ROW 2.14 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     RowObject.cantidad AT ROW 4.43 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     RowObject.kilos_tambor AT ROW 5.57 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.4 BY 1
     RowObject.identificacion AT ROW 6.71 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 22 BY 1
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_denvasesprod ( 1.24 , 42.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_dynselect ).
       RUN repositionObject IN h_dynselect ( 3.29 , 23.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_dynselect ,
             RowObject.volumen:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
