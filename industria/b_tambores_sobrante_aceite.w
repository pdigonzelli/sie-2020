...
&Scoped-define INTERNAL-TABLES sobrante_lotes_aceite tambores_industria ~
locaciones sucursales envases_prod
...
tambores_industria.id_sucursal_ubicacion sucursales.nombre ~
tambores_industria.id_locacion_ubicacion tambores_industria.id_envase ~
tambores_industria.kilos_tambor tambores_industria.id_articulo ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH sobrante_lotes_aceite OF lotes_aceite WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH tambores_industria WHERE tambores_industria.id_empresa = sobrante_lotes_aceite.id_empresa ~
  ...
  AND tambores_industria.nromov = sobrante_lotes_aceite.nromov_sobrante NO-LOCK, ~
  ...
  AND locaciones.id_locacion = tambores_industria.id_locacion_ubicacion NO-LOCK, ~
    ...
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table sobrante_lotes_aceite ~
tambores_industria locaciones sucursales envases_prod
&Scoped-define FIRST-TABLE-IN-QUERY-br_table sobrante_lotes_aceite
&Scoped-define SECOND-TABLE-IN-QUERY-br_table tambores_industria
&Scoped-define THIRD-TABLE-IN-QUERY-br_table locaciones
&Scoped-define FOURTH-TABLE-IN-QUERY-br_table sucursales
&Scoped-define FIFTH-TABLE-IN-QUERY-br_table envases_prod
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tambores_industria.id_sucursal_ubicacion FORMAT ">>9":U WIDTH 7.2
      sucursales.nombre FORMAT "x(25)":U
      tambores_industria.id_locacion_ubicacion COLUMN-LABEL "Loc" FORMAT ">>9":U
            WIDTH 5.4
      tambores_industria.id_envase COLUMN-LABEL "Env." FORMAT ">>9":U
            WIDTH 6.2
      tambores_industria.kilos_tambor FORMAT ">>>9.999":U WIDTH 12.2
      tambores_industria.id_articulo COLUMN-LABEL "Art." FORMAT ">>9":U
            WIDTH 7.2
      tambores_industria.id_calidad COLUMN-LABEL "Cal." FORMAT ">>9":U
            WIDTH 8.2
  ENABLE
      tambores_industria.id_sucursal_ubicacion
      tambores_industria.id_locacion_ubicacion
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 124 BY 6.95
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.sobrante_lotes_aceite OF general.lotes_aceite,industria.tambores_industria WHERE general.sobrante_lotes_aceite ...,industria.locaciones WHERE general.tambores_industria ...,comercial.sucursales WHERE general.tambores_industria ...,general.envases_prod OF general.sobrante_lotes_aceite"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[2]      = "general.tambores_industria.id_empresa = general.sobrante_lotes_aceite.id_empresa
  AND general.tambores_industria.id_sucursal = general.sobrante_lotes_aceite.id_sucursal
  AND general.tambores_industria.id_tipotambor = general.sobrante_lotes_aceite.id_tipotambor_sobrante
  AND general.tambores_industria.nromov = general.sobrante_lotes_aceite.nromov_sobrante"
...
"general.tambores_industria.id_sucursal_ubicacion" ? ">>9" "integer" ? ? ? ? ? ? yes ? no no "7.2" yes no no "U" "" ""
     _FldNameList[3]   > comercial.sucursales.nombre
"comercial.sucursales.nombre" ? "x(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > general.tambores_industria.id_locacion_ubicacion
"general.tambores_industria.id_locacion_ubicacion" "Loc" ">>9" "integer" ? ? ? ? ? ? yes ? no no "5.4" yes no no "U" "" ""
     _FldNameList[5]   > general.tambores_industria.id_envase
"general.tambores_industria.id_envase" "Env." ">>9" "integer" ? ? ? ? ? ? no ? no no "6.2" yes no no "U" "" ""
     _FldNameList[6]   > general.tambores_industria.kilos_tambor
"general.tambores_industria.kilos_tambor" ? ">>>9.999" "decimal" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[7]   > general.tambores_industria.id_articulo
"general.tambores_industria.id_articulo" "Art." ">>9" "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
     _FldNameList[8]   > general.tambores_industria.id_calidad
"general.tambores_industria.id_calidad" "Cal." ">>9" "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
