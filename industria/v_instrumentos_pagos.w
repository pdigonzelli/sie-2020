...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES instrumentos_pagos
&Scoped-define FIRST-EXTERNAL-TABLE instrumentos_pagos


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR instrumentos_pagos.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS instrumentos_pagos.id_instrumento_pago ~
instrumentos_pagos.descripcion instrumentos_pagos.descripcion_ingles 
...
&Scoped-define ENABLED-TABLES instrumentos_pagos
&Scoped-define FIRST-ENABLED-TABLE instrumentos_pagos
&Scoped-Define DISPLAYED-FIELDS instrumentos_pagos.id_instrumento_pago ~
instrumentos_pagos.descripcion instrumentos_pagos.descripcion_ingles 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS instrumentos_pagos.id_instrumento_pago 
...
DEFINE FRAME F-Main
     instrumentos_pagos.id_instrumento_pago AT ROW 1 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.8 BY 1
     instrumentos_pagos.descripcion AT ROW 2 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     instrumentos_pagos.descripcion_ingles AT ROW 2.91 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.instrumentos_pagos
...
/* SETTINGS FOR FILL-IN instrumentos_pagos.id_instrumento_pago IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME instrumentos_pagos.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL instrumentos_pagos.descripcion V-table-Win
ON LEAVE OF instrumentos_pagos.descripcion IN FRAME F-Main /* Instrumento de Pago */
DO:
...
&Scoped-define SELF-NAME instrumentos_pagos.descripcion_ingles
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL instrumentos_pagos.descripcion_ingles V-table-Win
ON LEAVE OF instrumentos_pagos.descripcion_ingles IN FRAME F-Main /* Int. Pagos Inlges */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME instrumentos_pagos.id_instrumento_pago
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL instrumentos_pagos.id_instrumento_pago V-table-Win
ON LEAVE OF instrumentos_pagos.id_instrumento_pago IN FRAME F-Main /* Cod. Ins. Pago */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "instrumentos_pagos"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "instrumentos_pagos"}
