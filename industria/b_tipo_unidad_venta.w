...
&Scoped-define INTERNAL-TABLES tipo_unidad_venta
...
tipo_unidad_venta.id_tipo_unidad_venta tipo_unidad_venta.descripcion ~
tipo_unidad_venta.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipo_unidad_venta WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipo_unidad_venta
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipo_unidad_venta
...
<FOREIGN-KEYS>
id_tipo_unidad_venta||y|general.tipo_unidad_venta.id_tipo_unidad_venta
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipo_unidad_venta.id_tipo_unidad_venta
      tipo_unidad_venta.descripcion
      tipo_unidad_venta.abreviatura
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipo_unidad_venta"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.tipo_unidad_venta.id_tipo_unidad_venta
     _FldNameList[2]   = general.tipo_unidad_venta.descripcion
     _FldNameList[3]   = general.tipo_unidad_venta.abreviatura
...
define sub-menu Ordena 
  menu-item tipo_unidad_venta-id_tipo_unidad_venta
label 'id_tipo_unidad_venta( tipo_unidad_venta ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_unidad_venta.id_tipo_unidad_venta').
                  run set-attribute-list('titulo=Unidad Venta').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_unidad_venta.id_tipo_unidad_venta
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_unidad_venta-descripcion
label 'descripcion( tipo_unidad_venta ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_unidad_venta.descripcion').
                  run set-attribute-list('titulo=Descripcion').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_unidad_venta.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_unidad_venta-abreviatura
label 'abreviatura( tipo_unidad_venta ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_unidad_venta.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_unidad_venta.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipo_unidad_venta.id_tipo_unidad_venta
