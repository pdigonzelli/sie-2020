...
DEFINE VARIABLE h_b_r_agencias_contenedores AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_r_agencias_contenedores AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Agencias Contenedores */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Agencias Contenedores */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 18.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 52.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 75.80 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_r_agencias_contenedores.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_r_agencias_contenedores ).
       RUN set-position IN h_b_r_agencias_contenedores ( 3.86 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 110.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_r_agencias_contenedores.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_r_agencias_contenedores ).
       RUN set-position IN h_v_r_agencias_contenedores ( 11.95 , 20.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 64.00 ) */

       /* Links to csmartbrowser h_b_r_agencias_contenedores. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_r_agencias_contenedores ).

       /* Links to SmartViewer h_v_r_agencias_contenedores. */
       RUN add-link IN adm-broker-hdl ( h_b_r_agencias_contenedores , 'Record':U , h_v_r_agencias_contenedores ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_r_agencias_contenedores ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_r_agencias_contenedores ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_r_agencias_contenedores ,
             h_b_r_agencias_contenedores , 'AFTER':U ).
    END. /* Page 0 */
