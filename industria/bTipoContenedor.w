...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_tipo_contenedor ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_tipo_contenedor
