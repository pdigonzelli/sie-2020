...
DEFINE VARIABLE h_b_tipo_contenedor AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipo_contenedor AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tipos de Contenedores */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipos de Contenedores */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipo_contenedor.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipo_contenedor ).
       RUN set-position IN h_b_tipo_contenedor ( 3.86 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 74.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipo_contenedor.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipo_contenedor ).
       RUN set-position IN h_v_tipo_contenedor ( 11.48 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.14 , 55.00 ) */

       /* Links to csmartbrowser h_b_tipo_contenedor. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipo_contenedor ).

       /* Links to SmartViewer h_v_tipo_contenedor. */
       RUN add-link IN adm-broker-hdl ( h_b_tipo_contenedor , 'Record':U , h_v_tipo_contenedor ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipo_contenedor ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipo_contenedor ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipo_contenedor ,
             h_b_tipo_contenedor , 'AFTER':U ).
    END. /* Page 0 */
