...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tambores_industria OF productos_terceros WHERE ~{&KEY-PHRASE} NO-LOCK, ~
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tambores_industria OF general.productos_terceros,industria.locaciones WHERE general.tambores_industria ...,comercial.sucursales WHERE general.tambores_industria ..."
...
"general.tambores_industria.id_lote" ? ">>>,>>9" "integer" ? ? ? ? ? ? no ?
...
"general.tambores_industria.id_sucursal_ubicacion" "Suc" ">>9" "integer" ? ? ? ? ? ? no ?
...
"general.tambores_industria.id_locacion_ubicacion" "Loc" ">>9" "integer" ? ? ? ? ? ? no ?
