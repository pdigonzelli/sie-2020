...
&Scoped-Define ENABLED-OBJECTS RECT-16 RECT-2 BUTTON-17 
...
DEFINE VARIABLE h_v_lotes_aceite_oe AS HANDLE NO-UNDO.
...
if available lotes_aceite then
    do:
        find orden_entrega of lotes_aceite no-lock no-error.
        if available lotes_aceite then
            do:
               run p_correo_aviso_contrato.p (input 3, 
                                              input rowid(orden_entrega), 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_lotes_aceite_oe.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_lotes_aceite_oe ).
       RUN set-position IN h_v_lotes_aceite_oe ( 11.95 , 7.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 65.00 ) */
       ...
       /* Links to SmartViewer h_v_lotes_aceite_oe. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_aceite_contratos , 'Record':U , h_v_lotes_aceite_oe ).
       RUN add-link IN adm-broker-hdl ( h_cus-update-only , 'TableIO':U , h_v_lotes_aceite_oe ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_lotes_aceite_contratos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_lotes_aceite_oe ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-16 RECT-2 BUTTON-17 
