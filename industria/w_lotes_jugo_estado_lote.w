...
&Scoped-Define ENABLED-OBJECTS RECT-20 RECT-2 
...
DEFINE VARIABLE h_v_lotes_jugo_estado_lote AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_lotes_jugo_consulta ( 3.86 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.38 , 150.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_lotes_jugo_estado_lote.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_lotes_jugo_estado_lote ).
       RUN set-position IN h_v_lotes_jugo_estado_lote ( 11.95 , 41.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.00 , 64.00 ) */
       ...
       /* Links to SmartViewer h_v_lotes_jugo_estado_lote. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_jugo_consulta , 'Record':U , h_v_lotes_jugo_estado_lote ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_lotes_jugo_estado_lote ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_lotes_jugo_consulta ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_lotes_jugo_estado_lote ,
