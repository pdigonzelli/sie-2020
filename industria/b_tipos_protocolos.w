...
&Scoped-define INTERNAL-TABLES tipos_protocolos

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tipos_protocolos.id_tipo_protocolo ~
tipos_protocolos.descripcion tipos_protocolos.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipos_protocolos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipos_protocolos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipos_protocolos
...
<FOREIGN-KEYS>
id_tipo_protocolo||y|general.tipos_protocolos.id_tipo_protocolo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_tipo_protocolo"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      tipos_protocolos.id_tipo_protocolo FORMAT ">>9":U WIDTH 11.2
      tipos_protocolos.descripcion FORMAT "X(30)":U
      tipos_protocolos.abreviatura FORMAT "X(12)":U WIDTH 16.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tipos_protocolos"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.tipos_protocolos.id_tipo_protocolo
"id_tipo_protocolo" ? ? "integer" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[2]   = general.tipos_protocolos.descripcion
     _FldNameList[3]   > general.tipos_protocolos.abreviatura
...
define sub-menu Ordena 
  menu-item tipos_protocolos-id_tipo_protocolo
label 'id_tipo_protocolo( tipos_protocolos ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipos_protocolos.id_tipo_protocolo').
                  run set-attribute-list('titulo=CodTipoProtocolo').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipos_protocolos.id_tipo_protocolo
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_protocolo" "tipos_protocolos" "id_tipo_protocolo"}
