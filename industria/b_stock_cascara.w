...
&Scoped-define FIELDS-IN-QUERY-br_table produccion_jugo.id_turno ~
produccion_jugo.id_sucursal produccion_jugo.id_produccion ~
produccion_jugo.id_tipotambor produccion_jugo.hasta_bolsa ~
produccion_jugo.desde_bolsa 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH produccion_jugo WHERE produccion_jugo.id_sucursal = lotes_jugo.id_sucursal ~
  AND produccion_jugo.id_articulo = lotes_jugo.id_articulo ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      produccion_jugo.id_sucursal FORMAT "->,>>>,>>9":U
      produccion_jugo.id_produccion FORMAT ">>>,>>9":U
      produccion_jugo.id_tipotambor FORMAT ">,>>9":U
      produccion_jugo.hasta_bolsa FORMAT ">>>>>9":U
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.produccion_jugo WHERE general.lotes_jugo ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "general.produccion_jugo.id_sucursal = general.lotes_jugo.id_sucursal
  AND general.produccion_jugo.id_articulo = general.lotes_jugo.id_articulo"
     _Where[1]         = "general.produccion_jugo.id_tipotambor = 11"
     _FldNameList[1]   = general.produccion_jugo.id_turno
     _FldNameList[2]   = general.produccion_jugo.id_sucursal
     _FldNameList[3]   = general.produccion_jugo.id_produccion
     _FldNameList[4]   = general.produccion_jugo.id_tipotambor
     _FldNameList[5]   = general.produccion_jugo.hasta_bolsa
     _FldNameList[6]   = general.produccion_jugo.desde_bolsa
