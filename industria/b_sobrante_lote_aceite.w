...
sobrante_lotes_aceite.fecha_elaboracion sobrante_lotes_aceite.volumen ~
sobrante_lotes_aceite.tipo_almacenamiento sobrante_lotes_aceite.id_envase ~
...
sobrante_lotes_aceite.fecha_elaboracion sobrante_lotes_aceite.volumen ~
sobrante_lotes_aceite.tipo_almacenamiento sobrante_lotes_aceite.id_envase ~
sobrante_lotes_aceite.cantidad sobrante_lotes_aceite.kilos ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      sobrante_lotes_aceite.fecha_elaboracion COLUMN-LABEL "Fecha"
      sobrante_lotes_aceite.volumen COLUMN-LABEL "Volumen" FORMAT ">>>>9.99"
      sobrante_lotes_aceite.tipo_almacenamiento COLUMN-LABEL "T.Almace.(tanque/envase)"
      sobrante_lotes_aceite.id_envase COLUMN-LABEL "Env."
      envases_prod.abreviatura
      sobrante_lotes_aceite.cantidad COLUMN-LABEL "Tambores" FORMAT ">>>>9"
      sobrante_lotes_aceite.kilos FORMAT ">>>>9.999"
      sobrante_lotes_aceite.identificacion COLUMN-LABEL "Identificacion"
  ENABLE
      sobrante_lotes_aceite.fecha_elaboracion
      sobrante_lotes_aceite.volumen
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.sobrante_lotes_aceite OF general.lotes_aceite,general.envases_prod OF general.sobrante_lotes_aceite"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > general.sobrante_lotes_aceite.fecha_elaboracion
"general.sobrante_lotes_aceite.fecha_elaboracion" "Fecha" ? "date" ? ? ? ? ? ? yes ?
     _FldNameList[2]   > general.sobrante_lotes_aceite.volumen
"general.sobrante_lotes_aceite.volumen" "Volumen" ">>>>9.99" "decimal" ? ? ? ? ? ? yes ?
     _FldNameList[3]   > general.sobrante_lotes_aceite.tipo_almacenamiento
"general.sobrante_lotes_aceite.tipo_almacenamiento" "T.Almace.(tanque/envase)" ? "logical" ? ? ? ? ? ? yes "tanque/envases"
     _FldNameList[4]   > general.sobrante_lotes_aceite.id_envase
"general.sobrante_lotes_aceite.id_envase" "Env." ? "integer" ? ? ? ? ? ? yes ?
     _FldNameList[5]   = general.envases_prod.abreviatura
     _FldNameList[6]   > general.sobrante_lotes_aceite.cantidad
"general.sobrante_lotes_aceite.cantidad" "Tambores" ">>>>9" "decimal" ? ? ? ? ? ? yes ?
     _FldNameList[7]   > general.sobrante_lotes_aceite.kilos
"general.sobrante_lotes_aceite.kilos" ? ">>>>9.999" "decimal" ? ? ? ? ? ? yes ?
     _FldNameList[8]   > general.sobrante_lotes_aceite.identificacion
"general.sobrante_lotes_aceite.identificacion" "Identificacion" ? "character" ? ? ? ? ? ? yes ?
