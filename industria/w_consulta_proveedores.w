...
DEFINE VARIABLE h_b_consulta_proveedores AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_proveedores.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_proveedores ).
       RUN set-position IN h_b_consulta_proveedores ( 3.95 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.00 , 130.00 ) */

       /* Links to csmartbrowser h_b_consulta_proveedores. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_consulta_proveedores ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cus-misc ,
             h_cus-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_proveedores ,
             h_cus-misc , 'AFTER':U ).
    END. /* Page 0 */
