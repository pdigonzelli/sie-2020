...
&Scoped-Define ENABLED-OBJECTS aceptar salir RECT-1 RECT-12 
...
DEFINE VARIABLE h_b_sel_lote_jugo_protocolos AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     aceptar AT ROW 16.95 COL 112
     salir AT ROW 16.95 COL 124
     RECT-1 AT ROW 16.71 COL 109
     RECT-12 AT ROW 1.71 COL 3
     SPACE(3.39) SKIP(2.09)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_sel_lote_jugo_protocolos.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_sel_lote_jugo_protocolos ).
       RUN set-position IN h_b_sel_lote_jugo_protocolos ( 2.19 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b_sel_lote_jugo_protocolos ( 13.57 , 129.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_sel_lote_jugo_protocolos ,
...
------------------------------------------------------------------------------*/
  ENABLE aceptar salir RECT-1 RECT-12 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
