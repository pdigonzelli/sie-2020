...
&Scoped-Define ENABLED-FIELDS RowObject.cantidad RowObject.kilos_tambor ~
RowObject.fecha RowObject.volumen 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define DISPLAYED-FIELDS RowObject.cantidad RowObject.kilos_tambor ~
RowObject.fecha RowObject.volumen 
...
DEFINE FRAME F-Main
     RowObject.cantidad AT ROW 2.14 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     RowObject.kilos_tambor AT ROW 3.29 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.4 BY 1
     RowObject.fecha AT ROW 4.43 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
     RowObject.volumen AT ROW 5.57 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_denvasesprod ( 4.10 , 39.00 ) NO-ERROR.
