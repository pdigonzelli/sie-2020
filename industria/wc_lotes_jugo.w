...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-12 aceptar salir 
...
DEFINE VARIABLE h_b_consulta_lote_jugo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_consulta_lote_jugo.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_consulta_lote_jugo ).
       RUN set-position IN h_b_consulta_lote_jugo ( 2.19 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.33 , 145.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_consulta_lote_jugo ,
...
------------------------------------------------------------------------------*/
  ENABLE RECT-1 RECT-12 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
