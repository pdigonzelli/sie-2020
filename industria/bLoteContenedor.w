...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.fecha_entrega ~
rowObject.nro_contenedor rowObject.nro_lote rowObject.observaciones 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      fecha_entrega FORMAT "99/99/9999":U
      nro_contenedor FORMAT "X(8)":U
      nro_lote FORMAT "x(8)":U
      observaciones FORMAT "X(200)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.fecha_entrega
     _FldNameList[2]   = _<SDO>.rowObject.nro_contenedor
     _FldNameList[3]   = _<SDO>.rowObject.nro_lote
     _FldNameList[4]   = _<SDO>.rowObject.observaciones
