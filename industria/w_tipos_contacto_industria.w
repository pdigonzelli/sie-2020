...
DEFINE VARIABLE h_b_tipos_contacto_industria AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_contacto_industria AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Tipos Contacto Industria"
         HEIGHT             = 20.19
         WIDTH              = 80.2
         MAX-HEIGHT         = 20.19
         MAX-WIDTH          = 107
...
ON END-ERROR OF W-Win /* Tipos Contacto Industria */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipos Contacto Industria */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b_tipos_contacto_industria.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_contacto_industria ).
       RUN set-position IN h_b_tipos_contacto_industria ( 4.10 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_contacto_industria ( 6.71 , 72.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v_tipos_contacto_industria.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_contacto_industria ).
       RUN set-position IN h_v_tipos_contacto_industria ( 12.19 , 15.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 52.00 ) */

       /* Links to csmartbrowser h_b_tipos_contacto_industria. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_contacto_industria ).

       /* Links to SmartViewer h_v_tipos_contacto_industria. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_contacto_industria , 'Record':U , h_v_tipos_contacto_industria ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_contacto_industria ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_contacto_industria ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_contacto_industria ,
             h_b_tipos_contacto_industria , 'AFTER':U ).
    END. /* Page 0 */
