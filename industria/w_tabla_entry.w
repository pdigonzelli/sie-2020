...
DEFINE VARIABLE h_b_tabla_entry AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tabla_entry AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tabla de Entries */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tabla de Entries */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tabla_entry.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tabla_entry ).
       RUN set-position IN h_b_tabla_entry ( 3.86 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 97.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tabla_entry.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tabla_entry ).
       RUN set-position IN h_v_tabla_entry ( 11.48 , 22.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 64.00 ) */

       /* Links to csmartbrowser h_b_tabla_entry. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tabla_entry ).

       /* Links to SmartViewer h_v_tabla_entry. */
       RUN add-link IN adm-broker-hdl ( h_b_tabla_entry , 'Record':U , h_v_tabla_entry ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tabla_entry ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tabla_entry ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tabla_entry ,
             h_b_tabla_entry , 'AFTER':U ).
    END. /* Page 0 */
