...
&Scoped-Define UpdTable1 dreleasedelivery
&Scoped-Define SDOInclude1 "dreleasedelivery.i"
&Scoped-Define UpdTable2 ditemsreleasedelivery
&Scoped-Define SDOInclude2 "ditemsreleasedelivery.i"
&Scoped-Define UpdTable3 dloteubicacion
&Scoped-Define SDOInclude3 "dloteubicacion.i"
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dreleasedelivery ( 1.14 , 2.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_ditemsreleasedelivery ( 1.24 , 11.20 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
       ...
       RUN repositionObject IN h_dloteubicacion ( 1.43 , 21.20 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */
