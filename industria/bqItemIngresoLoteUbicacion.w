...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.cantidad ~
rowObject.id_lote_deposito rowObject.id_sucursal_ubicacion rowObject.nombre ~
rowObject.id_lote 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      cantidad FORMAT ">>>>>9":U
      id_lote_deposito FORMAT "X(40)":U WIDTH 15
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dqitemingresoloteubicacion.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.cantidad
     _FldNameList[2]   > _<SDO>.rowObject.id_lote_deposito
"id_lote_deposito" ? ? "character" ? ? ? ? ? ? no ? no no "15" yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.id_sucursal_ubicacion
"id_sucursal_ubicacion" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
