...
&Scoped-Define ENABLED-OBJECTS RECT-18 RECT-16 REC1 RECT-17 RECT-4 REC4 ~
REC3 RECT-19 b-detalle BUTTON-8 BUTTON-1 Boton1 BUTTON-6 BUTTON-5 BUTTON-3 ~
BUTTON-7 BUTTON-9 
&Scoped-Define DISPLAYED-OBJECTS FILL-2 FILL1 
...
DEFINE VARIABLE h_b_envasadores_fabrica1 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     b-detalle AT ROW 1.38 COL 109
     FILL-2 AT ROW 4.05 COL 2 COLON-ALIGNED NO-LABEL
     BUTTON-8 AT ROW 4.05 COL 120
     BUTTON-1 AT ROW 12.52 COL 49
     FILL1 AT ROW 18.14 COL 2 COLON-ALIGNED NO-LABEL
     Boton1 AT ROW 19.19 COL 117
     BUTTON-6 AT ROW 19.38 COL 4
     BUTTON-5 AT ROW 19.38 COL 21
     BUTTON-3 AT ROW 19.38 COL 36
     BUTTON-7 AT ROW 21.38 COL 49
     BUTTON-9 AT ROW 21.48 COL 127
     RECT-18 AT ROW 11.1 COL 76
     RECT-16 AT ROW 1 COL 1
     REC1 AT ROW 9 COL 3
     "SOBRANTE" VIEW-AS TEXT
          SIZE 43 BY .86 AT ROW 21.48 COL 5
          BGCOLOR 1 FGCOLOR 15 FONT 6
     RECT-17 AT ROW 18.05 COL 2
     "TAMBORES" VIEW-AS TEXT
          SIZE 43 BY .95 AT ROW 12.62 COL 5
          BGCOLOR 1 FGCOLOR 15 FONT 6
     RECT-4 AT ROW 1.24 COL 2
     "ENVASADORES" VIEW-AS TEXT
          SIZE 67 BY .95 AT ROW 12.62 COL 81
          BGCOLOR 1 FGCOLOR 15 FONT 6
     REC4 AT ROW 19.1 COL 2
     "ARRASTRE" VIEW-AS TEXT
          SIZE 44 BY .86 AT ROW 21.48 COL 82
          BGCOLOR 1 FGCOLOR 15 FONT 6
     REC3 AT ROW 10.52 COL 2
     RECT-19 AT ROW 19.1 COL 77
...
define var r as rowid.
  ...
  if available lotes_jugo then message "veamos" lotes_jugo.id_empresa view-as alert-box.
  */  
...
DO:
  ...
  if available composicion_lote then
    do:
        ...
        /* message string(composicion_lote.cantidad_tambores) + " anio " + anio. */
...
ON CHOOSE OF BUTTON-8 IN FRAME F-Main /* Imprimir Inspección */
DO:
define var hcontainer as handle.
define var r as rowid.
RUN get-rowid1 in h_b_lotes_jugo (output r).
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.29 , 37.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.29 , 59.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.29 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_lotes_jugo ( 3.38 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.62 , 150.00 ) */
       ...
       RUN set-position IN h_v_lotes_jugo ( 9.10 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.71 , 146.40 ) */
       ...
       RUN set-position IN h_b_origen_tambores_lote ( 21.10 , 3.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b_inspecciones_lote1 ( 5.48 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.76 , 146.00 ) */
       ...
       RUN set-position IN h_cus-updsav-5 ( 10.62 , 5.00 ) NO-ERROR.
       ...
       RUN set-position IN h_cus-updsav-4 ( 10.71 , 80.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_composicion_lote ( 13.95 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.76 , 51.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_envasadores_fabrica1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     Hide-on-Init = no,
                     Disable-on-Init = no,
                     Layout = ,
                     Create-On-Add = No':U ,
             OUTPUT h_b_envasadores_fabrica1 ).
       RUN set-position IN h_b_envasadores_fabrica1 ( 13.95 , 81.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.76 , 67.00 ) */
       ...
       RUN set-position IN h_cus-updsav-6 ( 19.19 , 81.00 ) NO-ERROR.
       ...
       RUN set-position IN h_cus-updsav-3 ( 19.29 , 4.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v_arrastre_lote ( 22.91 , 82.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q_arrastre_lote ( 23.86 , 141.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.05 , 11.60 ) */
       ...
       /* Links to csmartbrowser h_b_envasadores_fabrica1. */
       RUN add-link IN adm-broker-hdl ( h_b_composicion_lote , 'record':U , h_b_envasadores_fabrica1 ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav-4 , 'TableIO':U , h_b_envasadores_fabrica1 ).

       /* Links to SmartViewer h_v_sobrante. */
       RUN add-link IN adm-broker-hdl ( h_cus-updsav-3 , 'TableIO':U , h_v_sobrante ).
       RUN add-link IN adm-broker-hdl ( h_q_sobrante , 'Record':U , h_v_sobrante ).

       /* Links to SmartViewer h_v_arrastre_lote. */
       RUN add-link IN adm-broker-hdl ( h_cus-updsav-6 , 'TableIO':U , h_v_arrastre_lote ).
       RUN add-link IN adm-broker-hdl ( h_q_arrastre_lote , 'Record':U , h_v_arrastre_lote ).

       /* Links to SmartQuery h_q_sobrante. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_jugo , 'Record':U , h_q_sobrante ).

       /* Links to SmartQuery h_q_arrastre_lote. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_jugo , 'record':U , h_q_arrastre_lote ).
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-2 FILL1 
      WITH FRAME F-Main.
  ENABLE RECT-18 RECT-16 REC1 RECT-17 RECT-4 REC4 REC3 RECT-19 b-detalle 
         BUTTON-8 BUTTON-1 Boton1 BUTTON-6 BUTTON-5 BUTTON-3 BUTTON-7 BUTTON-9 
      WITH FRAME F-Main.
...
if deshabilita then
    do:
        ...
        /*run dispatch in h_cus-updsav-6 ('enable':U).*/
    end.


/*
message "HABILITAAAAAAAAAAAA" view-as alert-box.

if deshabilita then run dispatch in h_b_envasado_lote ('enable':U).
*/
END PROCEDURE.
...
/*run dispatch in h_cus-updsav-6 ('disable':U).*/
deshabilita = true.
END PROCEDURE.
