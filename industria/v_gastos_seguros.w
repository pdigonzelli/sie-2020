...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES gastos_seguros
&Scoped-define FIRST-EXTERNAL-TABLE gastos_seguros


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR gastos_seguros.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS gastos_seguros.id_gasto_seguro ~
gastos_seguros.descripcion gastos_seguros.abreviatura ~
gastos_seguros.fecha_inicio gastos_seguros.fecha_fin gastos_seguros.importe 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}id_gasto_seguro ~{&FP2}id_gasto_seguro ~{&FP3}~
...
&Scoped-define ENABLED-TABLES gastos_seguros
&Scoped-define FIRST-ENABLED-TABLE gastos_seguros
&Scoped-Define DISPLAYED-FIELDS gastos_seguros.id_gasto_seguro ~
gastos_seguros.descripcion gastos_seguros.abreviatura ~
gastos_seguros.fecha_inicio gastos_seguros.fecha_fin gastos_seguros.importe 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,List-3,List-4,List-5,List-6      */
&Scoped-define ADM-CREATE-FIELDS gastos_seguros.id_gasto_seguro 
...
DEFINE FRAME F-Main
     gastos_seguros.id_gasto_seguro AT ROW 1 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     gastos_seguros.descripcion AT ROW 2 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     gastos_seguros.abreviatura AT ROW 3 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 17.6 BY 1
     gastos_seguros.fecha_inicio AT ROW 4 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
     gastos_seguros.fecha_fin AT ROW 5 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
     gastos_seguros.importe AT ROW 6 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 23 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: general.gastos_seguros
...
/* SETTINGS FOR FILL-IN gastos_seguros.id_gasto_seguro IN FRAME F-Main
   1                                                                    */
...
&Scoped-define SELF-NAME gastos_seguros.abreviatura
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gastos_seguros.abreviatura V-table-Win
ON LEAVE OF gastos_seguros.abreviatura IN FRAME F-Main /* Abreviatura */
DO:
...
&Scoped-define SELF-NAME gastos_seguros.descripcion
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gastos_seguros.descripcion V-table-Win
ON LEAVE OF gastos_seguros.descripcion IN FRAME F-Main /* Descripcion */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME gastos_seguros.fecha_fin
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gastos_seguros.fecha_fin V-table-Win
ON LEAVE OF gastos_seguros.fecha_fin IN FRAME F-Main /* Fecha Fin */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME gastos_seguros.fecha_inicio
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gastos_seguros.fecha_inicio V-table-Win
ON LEAVE OF gastos_seguros.fecha_inicio IN FRAME F-Main /* Fecha Inicio */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME gastos_seguros.id_gasto_seguro
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gastos_seguros.id_gasto_seguro V-table-Win
ON LEAVE OF gastos_seguros.id_gasto_seguro IN FRAME F-Main /* Cod. Gasto Seguro */
DO:
{custom/support/validacion.i}
END.
...
&Scoped-define SELF-NAME gastos_seguros.importe
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gastos_seguros.importe V-table-Win
ON LEAVE OF gastos_seguros.importe IN FRAME F-Main /* Importe */
DO:
{custom/support/validacion.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "gastos_seguros"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "gastos_seguros"}
