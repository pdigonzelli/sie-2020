...
DEFINE VARIABLE h_b_tipos_movimientos_existentes AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_movimientos_industria AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_movimientos_existentes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_movimientos_existentes ).
       RUN set-position IN h_b_tipos_movimientos_existentes ( 3.86 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 132.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_movimientos_industria.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_movimientos_industria ).
       RUN set-position IN h_v_movimientos_industria ( 11.86 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.95 , 117.00 ) */

       /* Links to csmartbrowser h_b_tipos_movimientos_existentes. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_movimientos_existentes ).

       /* Links to SmartViewer h_v_movimientos_industria. */
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_movimientos_industria ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_movimientos_existentes ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_movimientos_industria ,
             h_b_tipos_movimientos_existentes , 'AFTER':U ).
    END. /* Page 0 */
