...
DEFINE VARIABLE h_b_tipos_contactos AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_tipos_contactos AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_tipos_contactos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_tipos_contactos ).
       RUN set-position IN h_b_tipos_contactos ( 4.10 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_tipos_contactos ( 6.71 , 74.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_tipos_contactos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_tipos_contactos ).
       RUN set-position IN h_v_tipos_contactos ( 12.19 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 60.00 ) */

       /* Links to csmartbrowser h_b_tipos_contactos. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_tipos_contactos ).

       /* Links to SmartViewer h_v_tipos_contactos. */
       RUN add-link IN adm-broker-hdl ( h_b_tipos_contactos , 'Record':U , h_v_tipos_contactos ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_tipos_contactos ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_tipos_contactos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_tipos_contactos ,
             h_b_tipos_contactos , 'AFTER':U ).
    END. /* Page 0 */
