...
&Scoped-Define ENABLED-OBJECTS b-detalle 
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.00 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.00 , 37.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b_lotes ).
       RUN set-position IN h_b_lotes ( 3.14 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.00 , 88.00 ) */
       ...
       RUN set-position IN h_cus-updsav-3 ( 8.14 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_new_lotes_aceite ( 10.05 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.00 , 89.00 ) */
       ...
       RUN set-position IN h_cus-updsav-2 ( 15.76 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b_new_composicion_lote_aceite ( 18.62 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 105.00 ) */

       /* Links to csmartbrowser h_b_lotes. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_lotes ).
