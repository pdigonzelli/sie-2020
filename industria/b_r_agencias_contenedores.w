...
&Scoped-define INTERNAL-TABLES r_agencias_contenedores agencias ~
tipo_contenedor
...
&Scoped-define FIELDS-IN-QUERY-br_table r_agencias_contenedores.id_agencia ~
agencias.abreviatura r_agencias_contenedores.id_tipo_contenedor ~
tipo_contenedor.descripcion r_agencias_contenedores.importe 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH r_agencias_contenedores WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH agencias WHERE agencias.id_agencia = r_agencias_contenedores.id_agencia NO-LOCK, ~
      EACH tipo_contenedor OF r_agencias_contenedores NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table r_agencias_contenedores agencias ~
tipo_contenedor
&Scoped-define FIRST-TABLE-IN-QUERY-br_table r_agencias_contenedores
...
<FOREIGN-KEYS>
id_tipo_contenedor||y|general.r_agencias_contenedores.id_tipo_contenedor
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_tipo_contenedor"':U).
...
DEFINE QUERY br_table FOR 
      r_agencias_contenedores, 
      agencias, 
      tipo_contenedor SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      r_agencias_contenedores.id_agencia COLUMN-LABEL "C.Agencia"
      agencias.abreviatura
      r_agencias_contenedores.id_tipo_contenedor
      tipo_contenedor.descripcion
      r_agencias_contenedores.importe
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.r_agencias_contenedores,industria.agencias WHERE general.r_agencias_contenedores ...,industria.tipo_contenedor OF general.r_agencias_contenedores"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[2]      = "general.agencias.id_agencia = general.r_agencias_contenedores.id_agencia"
     _FldNameList[1]   > general.r_agencias_contenedores.id_agencia
"r_agencias_contenedores.id_agencia" "C.Agencia" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   = general.agencias.abreviatura
     _FldNameList[3]   = general.r_agencias_contenedores.id_tipo_contenedor
     _FldNameList[4]   = general.tipo_contenedor.descripcion
     _FldNameList[5]   = general.r_agencias_contenedores.importe
...
define sub-menu Ordena 
  menu-item r_agencias_contenedores-id_agencia
label 'id_agencia( r_agencias_contenedores ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_agencias_contenedores.id_agencia').
                  run set-attribute-list('titulo=Cod.Agencia').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_agencias_contenedores.id_agencia
...
label 'abreviatura( agencias ) '
  ...
  menu-item r_agencias_contenedores-id_tipo_contenedor
label 'id_tipo_contenedor( r_agencias_contenedores ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_agencias_contenedores.id_tipo_contenedor').
                  run set-attribute-list('titulo=Tipo de Contenedor').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_agencias_contenedores.id_tipo_contenedor
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_contenedor-descripcion
label 'descripcion( tipo_contenedor ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_contenedor.descripcion').
                  run set-attribute-list('titulo=Contenedor').
                  run set-attribute-list('busca= no').
                  &SCOPE SORTBY-PHRASE  by tipo_contenedor.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item r_agencias_contenedores-importe
label 'importe( r_agencias_contenedores ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=r_agencias_contenedores.importe').
                  run set-attribute-list('titulo=Importe').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by r_agencias_contenedores.importe
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by r_agencias_contenedores.id_agencia
...
case p:
  WHEN 'r_agencias_contenedores.id_agencia' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_agencia = integer(valor)  no-lock no-error .
  WHEN 'r_agencias_contenedores.id_tipo_contenedor' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_tipo_contenedor = integer(valor)  no-lock no-error .
  WHEN 'r_agencias_contenedores.importe' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipo_contenedor" "r_agencias_contenedores" "id_tipo_contenedor"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tipo_contenedor"}
