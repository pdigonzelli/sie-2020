...
DEFINE VARIABLE h_b_sucursales AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_sucursales AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_sucursales.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_sucursales ).
       RUN set-position IN h_b_sucursales ( 3.62 , 7.00 ) NO-ERROR.
       RUN set-size IN h_b_sucursales ( 6.71 , 72.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_sucursales.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_sucursales ).
       RUN set-position IN h_v_sucursales ( 11.24 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.10 , 77.00 ) */

       /* Links to csmartbrowser h_b_sucursales. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_sucursales ).

       /* Links to SmartViewer h_v_sucursales. */
       RUN add-link IN adm-broker-hdl ( h_b_sucursales , 'Record':U , h_v_sucursales ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_sucursales ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_sucursales ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_sucursales ,
             h_b_sucursales , 'AFTER':U ).
    END. /* Page 0 */
