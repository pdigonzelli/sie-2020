...
/* Local Variable Definitions ---                                       */
  ...
  DEFINE OUTPUT PARAMETER p_nro_comp AS INTEGER no-undo.
  DEFINE OUTPUT PARAMETER p_punto_venta AS INTEGER no-undo.
  DEFINE OUTPUT PARAMETER p_fecha_remito AS DATE no-undo.
...
&Scoped-Define ENABLED-OBJECTS v_punto_venta v_nro_comp v_fecha aceptar ~
salir RECT-1 
&Scoped-Define DISPLAYED-OBJECTS v_punto_venta v_nro_comp v_fecha 
...
DEFINE VARIABLE v_fecha AS DATE FORMAT "99/99/99":U INITIAL ? 
     LABEL "Fecha Remito" 
     VIEW-AS FILL-IN 
     SIZE 13 BY 1 NO-UNDO.

DEFINE VARIABLE v_nro_comp AS INTEGER FORMAT "99999999":U INITIAL 0 
     LABEL "Nro Comprobante" 
     VIEW-AS FILL-IN 
     SIZE 13 BY 1 NO-UNDO.

DEFINE VARIABLE v_punto_venta AS INTEGER FORMAT "9999":U INITIAL 0 
     LABEL "Punto Venta" 
     VIEW-AS FILL-IN 
     SIZE 9 BY 1 NO-UNDO.
...
DEFINE FRAME D-Dialog
     v_punto_venta AT ROW 1.71 COL 22 COLON-ALIGNED
     v_nro_comp AT ROW 2.67 COL 22 COLON-ALIGNED
     v_fecha AT ROW 3.62 COL 22 COLON-ALIGNED
     aceptar AT ROW 5.52 COL 32
     salir AT ROW 5.52 COL 44
     RECT-1 AT ROW 5.29 COL 29
     SPACE(4.99) SKIP(0.18)
...
DO:
  define var rresult as INTEGER no-undo.

  p_nro_comp    = INTEGER(v_nro_comp:SCREEN-VALUE IN FRAME D-Dialog).
  p_punto_venta = INTEGER(v_punto_venta:SCREEN-VALUE IN FRAME D-Dialog).
  p_fecha_remito = DATE(v_fecha:SCREEN-VALUE IN FRAME D-Dialog).
...
------------------------------------------------------------------------------*/
  DISPLAY v_punto_venta v_nro_comp v_fecha 
      WITH FRAME D-Dialog.
  ENABLE v_punto_venta v_nro_comp v_fecha aceptar salir RECT-1 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
