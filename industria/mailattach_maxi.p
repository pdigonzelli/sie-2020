...
RUN mapi ( "maxivm@sa-sanmiguel.com",
           "gabriel@sa-sanmiguel.com ; pdigonze@sa-sanmiguel.com",
           "prueba",
           "prueba",
           "c:\temp\adrian.txt"
          ).
...
RUN MAPISendMail IN hpApi
 (INPUT 0,
  ...
  INPUT 1, /* 1 = MAPI_LOGON_UI + 2 = MAPI_NEW_SESSION + 8 = MAPI_DIALOG */
  INPUT 0,     
  OUTPUT ResultInt). 
  IF ResultInt<>0 THEN MESSAGE "Correo no enviado mensaje de error=" REsultInt VIEW-AS ALERT-BOX.  /* dealloc memory */ 
