...
&Scoped-Define ENABLED-FIELDS  nromov Anio-2
&Scoped-define ENABLED-FIELDS-IN-tambores_industria nromov Anio-2 
&Scoped-Define DATA-FIELDS  id_lote id_protocolo id_articulo anio nromov Anio-2
&Scoped-define DATA-FIELDS-IN-protocolos id_protocolo id_articulo anio 
&Scoped-define DATA-FIELDS-IN-tambores_industria id_lote nromov Anio-2 
&Scoped-Define MANDATORY-FIELDS  id_lote
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST   rowObject.Anio-2 = tambores_industria.Anio
&Scoped-Define DATA-FIELD-DEFS "d001qprotocoloslote.i"
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "general.protocolos,industria.tambores_industria WHERE general.protocolos ..."
...
"id_lote" "id_lote" ? ? "integer" ? ? ? ? ? ? no ? yes 10.2 yes
     _FldNameList[2]   > general.protocolos.id_protocolo
...
"id_articulo" "id_articulo" ? ? "integer" ? ? ? ? ? ? no ? no 10.8 yes
     _FldNameList[4]   > general.protocolos.anio
"anio" "anio" ? ? "integer" ? ? ? ? ? ? no ? no 4.8 yes
     _FldNameList[5]   > general.tambores_industria.nromov
"nromov" "nromov" ? ? "integer" ? ? ? ? ? ? yes ? no 12 yes
     _FldNameList[6]   > general.tambores_industria.Anio
"Anio" "Anio-2" ? ? "integer" ? ? ? ? ? ? yes ? no 7.8 yes
