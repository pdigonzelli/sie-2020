...
define input parameter a2 as integer.
...
&Scoped-Define ENABLED-OBJECTS RECT-2 sucursal BUTTON-12 
...
DEFINE FRAME F-Main
     sucursal AT ROW 2.91 COL 15 COLON-ALIGNED
     BUTTON-12 AT ROW 2.91 COL 36
     RECT-2 AT Y 105 X 175
...
DO:
  ...
  run zebra_lotes_aceite_no_coca_suc.p (input r, 
                                        input a1, 
                                        input a2,
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 6.24 , 37.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-2 sucursal BUTTON-12 
      WITH FRAME F-Main IN WINDOW W-Win.
