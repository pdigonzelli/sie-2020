...
&Scoped-define FIELDS-IN-QUERY-br_table Inspecciones_lote.Acidez_w_v ~
Inspecciones_lote.Acidez_w_w Inspecciones_lote.Bx_20_20 ~
Inspecciones_lote.Bx_correg Inspecciones_lote.Hora Inspecciones_lote.Litros ~
Inspecciones_lote.Porcentaje_pulpa Inspecciones_lote.Ratio 
...
<FOREIGN-KEYS>
id_tipotambor||y|general.Inspecciones_lote.id_tipotambor
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Inspecciones_lote.Acidez_w_v FORMAT "->>,>>9.99":U WIDTH 18.2
      Inspecciones_lote.Acidez_w_w FORMAT "->>,>>9.99":U WIDTH 17.2
      Inspecciones_lote.Bx_20_20 FORMAT "->>,>>9.99":U WIDTH 14.2
      Inspecciones_lote.Bx_correg FORMAT "->>,>>9.99":U WIDTH 18.2
      Inspecciones_lote.Hora FORMAT "99:99":U WIDTH 12.2
      Inspecciones_lote.Litros FORMAT "->,>>>,>>9":U WIDTH 13.2
      Inspecciones_lote.Porcentaje_pulpa FORMAT "->>,>>9.99":U
            WIDTH 23.2
      Inspecciones_lote.Ratio FORMAT "->>,>>9.99":U WIDTH 12.8
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 144 BY 5
         FONT 0 .
...
"Inspecciones_lote.Acidez_w_v" ? ? "decimal" ? ? ? ? ? ? no ? no no "18.2" yes no no "U" "" ""
     _FldNameList[2]   > general.Inspecciones_lote.Acidez_w_w
"Inspecciones_lote.Acidez_w_w" ? ? "decimal" ? ? ? ? ? ? no ? no no "17.2" yes no no "U" "" ""
     _FldNameList[3]   > general.Inspecciones_lote.Bx_20_20
"Inspecciones_lote.Bx_20_20" ? ? "decimal" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" ""
     _FldNameList[4]   > general.Inspecciones_lote.Bx_correg
"Inspecciones_lote.Bx_correg" ? ? "decimal" ? ? ? ? ? ? no ? no no "18.2" yes no no "U" "" ""
     _FldNameList[5]   > general.Inspecciones_lote.Hora
"Inspecciones_lote.Hora" ? ? "character" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[6]   > general.Inspecciones_lote.Litros
"Inspecciones_lote.Litros" ? ? "integer" ? ? ? ? ? ? no ? no no "13.2" yes no no "U" "" ""
     _FldNameList[7]   > general.Inspecciones_lote.Porcentaje_pulpa
"Inspecciones_lote.Porcentaje_pulpa" ? ? "decimal" ? ? ? ? ? ? no ? no no "23.2" yes no no "U" "" ""
     _FldNameList[8]   > general.Inspecciones_lote.Ratio
"Inspecciones_lote.Ratio" ? ? "decimal" ? ? ? ? ? ? no ? no no "12.8" yes no no "U" "" ""
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_tipotambor" "Inspecciones_lote" "id_tipotambor"}
