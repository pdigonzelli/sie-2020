...
rowObject.desde_lote rowObject.hasta_lote rowObject.kilos ~
rowObject.Articulo rowObject.Calidad rowObject.Envase rowObject.TipoTambor ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[9]   = _<SDO>.rowObject.TipoTambor
     _FldNameList[10]   = _<SDO>.rowObject.descripcion
...
DO:
 ...
 /* IF VALID-HANDLE(hCont) AND (hCont:FILE-NAME MATCHES "*wRemitos.w" ) THEN DO:*/
    iBgColor = IF rowObject.rowNum MODULO 2 = 0 THEN 22 /*11 light blue*/ ELSE ? /*default*/.
    
    ASSIGN rowObject.ITEM:BGCOLOR IN BROWSE br_table        = ibgcolor
           rowObject.nro_lote:BGCOLOR IN BROWSE br_table    = ibgcolor
           rowObject.desde_lote:BGCOLOR IN BROWSE br_table  = ibgcolor
           rowObject.hasta_lote:BGCOLOR IN BROWSE br_table  = ibgcolor
           ...
           rowObject.tipotambor:BGCOLOR IN BROWSE br_table  = ibgcolor
           rowObject.descripcion:BGCOLOR IN BROWSE br_table = ibgcolor
           .
  END.  
/*END.*/
