...
&Scoped-Define ENABLED-OBJECTS BUTTON-1 RECT-16 RECT-2 
...
DEFINE VARIABLE h_v_lotes_aceite_contrato AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 20.05 COL 61
     RECT-16 AT ROW 11.48 COL 5
     RECT-2 AT Y 0 X 90
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Lotes de Aceite con Items Contratos"
         HEIGHT             = 20.62
         WIDTH              = 91
         MAX-HEIGHT         = 20.62
         MAX-WIDTH          = 107
...
ON END-ERROR OF W-Win /* Lotes de Aceite con Items Contratos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Lotes de Aceite con Items Contratos */
DO:
...
DO:
  ...
  if available lotes_aceite then
    do:
        assign lotes_aceite.id_contrato_of = ""
               lotes_aceite.id_tipocontrato_of = 0
               lotes_aceite.anio_of = 0
               lotes_aceite.item_of = 0.
        ...
        run limpiar_campos in h_v_lotes_aceite_contrato.
    end.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_lotes_aceite_contrato.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_lotes_aceite_contrato ).
       RUN set-position IN h_v_lotes_aceite_contrato ( 12.19 , 7.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.95 , 79.00 ) */
       ...
       /* Links to SmartViewer h_v_lotes_aceite_contrato. */
       RUN add-link IN adm-broker-hdl ( h_b_lotes_aceite_contratos , 'Record':U , h_v_lotes_aceite_contrato ).
       RUN add-link IN adm-broker-hdl ( h_cus-update-only , 'TableIO':U , h_v_lotes_aceite_contrato ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_lotes_aceite_contratos ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_lotes_aceite_contrato ,
...
------------------------------------------------------------------------------*/
  ENABLE BUTTON-1 RECT-16 RECT-2 
