...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.numero_release ~
rowObject.nombre rowObject.tambores rowObject.id_lote_deposito ~
rowObject.id_lote rowObject.item_release_delivery rowObject.id_empresa ~
rowObject.id_sucursal rowObject.id_release_delivery rowObject.id_tipotambor ~
rowObject.nromov rowObject.id_sucursal_ubicacion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      numero_release FORMAT "->,>>>,>>9":U
      nombre FORMAT "x(30)":U
      tambores FORMAT "->,>>>,>>9":U
      id_lote_deposito FORMAT "X(40)":U
      id_lote FORMAT "->,>>>,>>9":U
      item_release_delivery FORMAT "->,>>>,>>9":U
      id_empresa FORMAT ">>9":U
      id_sucursal FORMAT ">>9":U
      id_release_delivery COLUMN-LABEL "Cod.Release" FORMAT "->,>>>,>>9":U
      id_tipotambor FORMAT ">>9":U
      nromov FORMAT ">>>>>>9":U
      id_sucursal_ubicacion FORMAT "->,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.numero_release
"numero_release" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.nombre
     _FldNameList[3]   = _<SDO>.rowObject.tambores
     _FldNameList[4]   > _<SDO>.rowObject.id_lote_deposito
"id_lote_deposito" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[5]   = _<SDO>.rowObject.id_lote
     _FldNameList[6]   > _<SDO>.rowObject.item_release_delivery
"item_release_delivery" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[7]   > _<SDO>.rowObject.id_empresa
"id_empresa" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[8]   > _<SDO>.rowObject.id_sucursal
"id_sucursal" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[9]   > _<SDO>.rowObject.id_release_delivery
"id_release_delivery" "Cod.Release" ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[10]   = _<SDO>.rowObject.id_tipotambor
     _FldNameList[11]   > _<SDO>.rowObject.nromov
