...
&Scoped-Define ENABLED-OBJECTS RECT-20 RECT-1 aceptar salir 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b_despachantes ( 2.43 , 11.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-20 RECT-1 aceptar salir 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
