...
ON END-ERROR OF wWin /* Administracion de Puertos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Administracion de Puertos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dlugardescargas ( 10.05 , 56.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_vlugardescarga ( 9.57 , 7.00 ) NO-ERROR.
