...
&Scoped-define FIELDS-IN-QUERY-br_table lugar_descarga.id_lugdes ~
lugar_descarga.descripcion lugar_descarga.id_sucursal 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH lugar_descarga WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table lugar_descarga
&Scoped-define FIRST-TABLE-IN-QUERY-br_table lugar_descarga
...
<FOREIGN-KEYS>
id_lugdes||y|comercial.lugar_descarga.id_lugdes
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      lugar_descarga.id_lugdes COLUMN-LABEL "Cod." FORMAT ">>9":U
            WIDTH 8.2
      lugar_descarga.descripcion COLUMN-LABEL "Lugar Descarga" FORMAT "X(30)":U
            WIDTH 46.2
      lugar_descarga.id_sucursal FORMAT ">>>>9":U WIDTH 9.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > comercial.lugar_descarga.id_lugdes
"id_lugdes" "Cod." ? "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[2]   > comercial.lugar_descarga.descripcion
"descripcion" "Lugar Descarga" ? "character" ? ? ? ? ? ? no ? no no "46.2" yes no no "U" "" ""
     _FldNameList[3]   > comercial.lugar_descarga.id_sucursal
"id_sucursal" ? ? "integer" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" ""
...
define sub-menu Ordena 
  menu-item lugar_descarga-id_lugdes
label 'id_lugdes( lugar_descarga ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=lugar_descarga.id_lugdes').
                  run set-attribute-list('titulo=Lugar de descarga').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by lugar_descarga.id_lugdes
...
case p:
  WHEN 'lugar_descarga.id_lugdes' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_lugdes = integer(valor)  no-lock no-error .
  WHEN 'lugar_descarga.descripcion' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_lugdes" "lugar_descarga" "id_lugdes"}
