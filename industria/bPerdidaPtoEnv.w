...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Lote rowObject.kilos ~
rowObject.kilos_400 rowObject.brix_20_20 rowObject.acidez_p_p ~
rowObject.fecha rowObject.nromov rowObject.nromov_proceso rowObject.litros ~
rowObject.solidos 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Lote FORMAT "x(50)":U WIDTH 31.2
      kilos FORMAT ">>>,>>9.999":U
      kilos_400 FORMAT ">,>>>,>>9.999":U
      brix_20_20 FORMAT "->>,>>9.99":U
      acidez_p_p FORMAT "->>,>>9.99":U
      fecha FORMAT "99/99/9999":U
      nromov FORMAT ">>>>>>9":U
      nromov_proceso FORMAT ">>>>>>9":U
      litros FORMAT ">>>,>>>,>>9.99":U
      solidos FORMAT ">>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"Lote" ? ? "character" ? ? ? ? ? ? no ? no no "31.2" yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.kilos
     _FldNameList[3]   = _<SDO>.rowObject.kilos_400
     _FldNameList[4]   = _<SDO>.rowObject.brix_20_20
     _FldNameList[5]   = _<SDO>.rowObject.acidez_p_p
     _FldNameList[6]   = _<SDO>.rowObject.fecha
     _FldNameList[7]   = _<SDO>.rowObject.nromov
     _FldNameList[8]   = _<SDO>.rowObject.nromov_proceso
     _FldNameList[9]   = _<SDO>.rowObject.litros
     _FldNameList[10]   = _<SDO>.rowObject.solidos
