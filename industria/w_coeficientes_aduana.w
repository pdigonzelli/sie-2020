...
DEFINE VARIABLE h_b_coeficientes_aduana AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_coeficientes_aduana AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_coeficientes_aduana.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_coeficientes_aduana ).
       RUN set-position IN h_b_coeficientes_aduana ( 3.86 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_coeficientes_aduana ( 6.71 , 77.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_coeficientes_aduana.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_coeficientes_aduana ).
       RUN set-position IN h_v_coeficientes_aduana ( 11.48 , 16.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 47.00 ) */

       /* Links to csmartbrowser h_b_coeficientes_aduana. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_coeficientes_aduana ).

       /* Links to SmartViewer h_v_coeficientes_aduana. */
       RUN add-link IN adm-broker-hdl ( h_b_coeficientes_aduana , 'Record':U , h_v_coeficientes_aduana ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_coeficientes_aduana ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_coeficientes_aduana ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_coeficientes_aduana ,
             h_b_coeficientes_aduana , 'AFTER':U ).
    END. /* Page 0 */
