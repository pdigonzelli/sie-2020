...
DEFINE VARIABLE h_blugardescarga AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dlugardescargas AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vlugardescarga AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Administracion de Lugares de Descarga"
         HEIGHT             = 11.95
         WIDTH              = 67.4
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Administracion de Lugares de Descarga */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Administracion de Lugares de Descarga */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dlugardescargas ( 10.05 , 57.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'blugardescarga.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'ScrollRemotenoNumDown0CalcWidthnoMaxWidth80FetchOnReposToEndyesDataSourceNamesUpdateTargetNamesLogicalObjectNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_blugardescarga ).
       RUN repositionObject IN h_blugardescarga ( 2.43 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_blugardescarga ( 6.67 , 67.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'vlugardescarga.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_vlugardescarga ).
       RUN repositionObject IN h_vlugardescarga ( 9.81 , 7.00 ) NO-ERROR.
       /* Size in AB:  ( 2.38 , 52.60 ) */
       ...
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dlugardescargas ).

       /* Links to SmartDataBrowser h_blugardescarga. */
       RUN addLink ( h_dlugardescargas , 'Data':U , h_blugardescarga ).

       /* Links to SmartDataViewer h_vlugardescarga. */
       RUN addLink ( h_dlugardescargas , 'Data':U , h_vlugardescarga ).
       RUN addLink ( h_vlugardescarga , 'Update':U , h_dlugardescargas ).
       RUN addLink ( h_dyntoolbar , 'TableIo':U , h_vlugardescarga ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_blugardescarga ,
             h_dyntoolbar , 'AFTER':U ).
       RUN adjustTabOrder ( h_vlugardescarga ,
             h_blugardescarga , 'AFTER':U ).
    END. /* Page 0 */
