...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES programa_despacho
&Scoped-define FIRST-EXTERNAL-TABLE programa_despacho


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR programa_despacho.
/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES items_programa_despacho marcas_prod ~
calidades envases_prod clientes

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table items_programa_despacho.item ~
marcas_prod.abreviatura calidades.abreviatura envases_prod.abreviatura ~
items_programa_despacho.pallets items_programa_despacho.cajas_por_pallets ~
items_programa_despacho.kilos_por_envase 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH items_programa_despacho OF programa_despacho WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH marcas_prod OF items_programa_despacho NO-LOCK, ~
      EACH calidades OF items_programa_despacho NO-LOCK, ~
      EACH envases_prod OF items_programa_despacho NO-LOCK, ~
      EACH clientes OF items_programa_despacho NO-LOCK ~
    BY items_programa_despacho.id_envase.
&Scoped-define TABLES-IN-QUERY-br_table items_programa_despacho marcas_prod ~
calidades envases_prod clientes
&Scoped-define FIRST-TABLE-IN-QUERY-br_table items_programa_despacho
&Scoped-define SECOND-TABLE-IN-QUERY-br_table marcas_prod
&Scoped-define THIRD-TABLE-IN-QUERY-br_table calidades
&Scoped-define FOURTH-TABLE-IN-QUERY-br_table envases_prod
&Scoped-define FIFTH-TABLE-IN-QUERY-br_table clientes
...
<FOREIGN-KEYS>
id_calidad||y|general.items_programa_despacho.id_calidad
id_envase||y|general.items_programa_despacho.id_envase
id_marca||y|general.items_programa_despacho.id_marca
id_articulo||y|general.items_programa_despacho.id_articulo
id_programa_despacho||y|general.items_programa_despacho.id_programa_despacho
id_tipo_pallet||y|general.items_programa_despacho.id_tipo_pallet
id_variedad||y|general.items_programa_despacho.id_variedad
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      items_programa_despacho.item FORMAT ">>>9":U WIDTH 7.2
      marcas_prod.abreviatura COLUMN-LABEL "Marca" FORMAT "X(10)":U
            WIDTH 12.2
      calidades.abreviatura COLUMN-LABEL "Calidad" FORMAT "X(10)":U
            WIDTH 14.2
      envases_prod.abreviatura COLUMN-LABEL "Envase" FORMAT "x(12)":U
            WIDTH 14.2
      items_programa_despacho.pallets COLUMN-LABEL "Pallets" FORMAT "->>,>>9.99":U
      items_programa_despacho.cajas_por_pallets COLUMN-LABEL "Cajas x pallets" FORMAT "->>,>>9.99":U
            WIDTH 21
      items_programa_despacho.kilos_por_envase COLUMN-LABEL "kilos x Envase" FORMAT "->>,>>9.99":U
            WIDTH 22.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   Type: csmartbrowser
   External Tables: general.programa_despacho
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.items_programa_despacho OF general.programa_despacho,general.marcas_prod OF general.items_programa_despacho,general.calidades OF general.items_programa_despacho,general.envases_prod OF general.items_programa_despacho,general.clientes OF general.items_programa_despacho"
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ",,,,"
     _OrdList          = "general.items_programa_despacho.id_envase|yes"
     _FldNameList[1]   > general.items_programa_despacho.item
"general.items_programa_despacho.item" ? ? "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
     _FldNameList[2]   > general.marcas_prod.abreviatura
"general.marcas_prod.abreviatura" "Marca" ? "character" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[3]   > general.calidades.abreviatura
"general.calidades.abreviatura" "Calidad" ? "character" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" ""
     _FldNameList[4]   > general.envases_prod.abreviatura
"general.envases_prod.abreviatura" "Envase" ? "character" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" ""
     _FldNameList[5]   > general.items_programa_despacho.pallets
"general.items_programa_despacho.pallets" "Pallets" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > general.items_programa_despacho.cajas_por_pallets
"general.items_programa_despacho.cajas_por_pallets" "Cajas x pallets" ? "decimal" ? ? ? ? ? ? no ? no no "21" yes no no "U" "" ""
     _FldNameList[7]   > general.items_programa_despacho.kilos_por_envase
"general.items_programa_despacho.kilos_por_envase" "kilos x Envase" ? "decimal" ? ? ? ? ? ? no ? no no "22.2" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE br_table */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "programa_despacho"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "programa_despacho"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "items_programa_despacho"}
  {src/adm/template/snd-list.i "marcas_prod"}
