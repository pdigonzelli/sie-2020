...
rowObject.cantidad rowObject.Unidad rowObject.Envase 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.Articulo FORMAT "x(30)":U WIDTH 15.2
      rowObject.cantidad FORMAT ">>,>>9.99":U
      rowObject.Unidad FORMAT "x(15)":U
...
"rowObject.Articulo" ? ? "character" ? ? ? ? ? ? no ? no no "15.2" yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.cantidad
     _FldNameList[3]   = _<SDO>.rowObject.Unidad
...
DO:
  ...
  IF VALID-HANDLE(hCont) AND (hCont:FILE-NAME MATCHES "*wProcesos.w") THEN DO:
    ...
    ASSIGN rowObject.articulo:BGCOLOR IN BROWSE br_table = ibgcolor
