...
&Scoped-define INTERNAL-TABLES movimientos_industria sucursales
...
movimientos_industria.id_etiqueta movimientos_industria.fecha 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH movimientos_industria WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH sucursales WHERE sucursales.id_sucursal = movimientos_industria.id_sucursal NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table movimientos_industria sucursales
&Scoped-define FIRST-TABLE-IN-QUERY-br_table movimientos_industria
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.movimientos_industria,comercial.sucursales WHERE general.movimientos_industria ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[2]      = "comercial.sucursales.id_sucursal = general.movimientos_industria.id_sucursal"
     _FldNameList[1]   = comercial.sucursales.nombre
     _FldNameList[2]   = general.movimientos_industria.id_etiqueta
     _FldNameList[3]   = general.movimientos_industria.fecha
...
label 'nombre( sucursales ) '
  ...
  menu-item movimientos_industria-id_etiqueta
label 'id_etiqueta( movimientos_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=movimientos_industria.id_etiqueta').
                  run set-attribute-list('titulo=Etiqueta').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by movimientos_industria.id_etiqueta
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item movimientos_industria-fecha
label 'fecha( movimientos_industria ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=movimientos_industria.fecha').
                  run set-attribute-list('titulo=Fecha').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by movimientos_industria.fecha
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by sucursales.nombre
