...
&Scoped-define FIELDS-IN-QUERY-br_table tipo_moneda.id_moneda ~
tipo_moneda.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tipo_moneda WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tipo_moneda
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tipo_moneda
...
<FOREIGN-KEYS>
id_moneda||y|comercial.tipo_moneda.id_moneda
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = comercial.tipo_moneda.id_moneda
     _FldNameList[2]   = comercial.tipo_moneda.descripcion
...
define sub-menu Ordena 
  menu-item tipo_moneda-id_moneda
label 'id_moneda( tipo_moneda ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_moneda.id_moneda').
                  run set-attribute-list('titulo=Tipo moneda').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_moneda.id_moneda
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tipo_moneda-descripcion
label 'descripcion( tipo_moneda ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tipo_moneda.descripcion').
                  run set-attribute-list('titulo=Descripción').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tipo_moneda.descripcion
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by tipo_moneda.id_moneda
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_moneda" "tipo_moneda" "id_moneda"}
