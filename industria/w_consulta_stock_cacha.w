...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-2 RECT-7 RECT-10 RECT-8 RECT-4 ~
RECT-9 sucursal articulo calidad BUTTON-20 BUTTON-24 semana BUTTON-25 ~
BUTTON-15 BUTTON-13 BUTTON-19 BUTTON-17 BUTTON-16 nombre_articulo ~
nombre_calidad 
&Scoped-Define DISPLAYED-OBJECTS sucursal articulo calidad FILL-IN-10 ~
FILL-IN-11 semana FILL-IN-7 FILL-IN-9 FILL-IN-8 nombre_articulo ~
nombre_calidad 
...
DEFINE FRAME F-Main
     ...
     FILL-IN-11 AT ROW 7.67 COL 64 COLON-ALIGNED NO-LABEL
     BUTTON-20 AT ROW 9.1 COL 5
     BUTTON-24 AT ROW 9.1 COL 34
     semana AT ROW 9.33 COL 73 COLON-ALIGNED
     BUTTON-25 AT ROW 9.33 COL 83
     FILL-IN-7 AT ROW 11.48 COL 2 COLON-ALIGNED NO-LABEL
     FILL-IN-9 AT ROW 11.48 COL 72 COLON-ALIGNED NO-LABEL
     BUTTON-15 AT ROW 12.91 COL 6
     BUTTON-13 AT ROW 12.91 COL 6
     BUTTON-19 AT ROW 12.91 COL 75
     FILL-IN-8 AT ROW 15.29 COL 2 COLON-ALIGNED NO-LABEL
     BUTTON-17 AT ROW 16.71 COL 6
     BUTTON-16 AT ROW 16.71 COL 6
     ...
     "89 -> Swiff" VIEW-AS TEXT
          SIZE 38 BY .71 AT ROW 4.1 COL 74
     RECT-6 AT ROW 11 COL 2
     RECT-2 AT Y 315 X 500
     RECT-7 AT ROW 14.81 COL 2
     RECT-10 AT ROW 7.19 COL 65
     RECT-8 AT ROW 11 COL 72
     "95 -> Famailla" VIEW-AS TEXT
          SIZE 38 BY .71 AT ROW 4.81 COL 74
     RECT-4 AT ROW 1.48 COL 2
     "87 -> Metan" VIEW-AS TEXT
          SIZE 38 BY .71 AT ROW 2.67 COL 74
     "96 -> Lavalle" VIEW-AS TEXT
          SIZE 38 BY .71 AT ROW 5.52 COL 74
     "88 -> Cool Queen" VIEW-AS TEXT
          SIZE 38 BY .71 AT ROW 3.38 COL 74
     RECT-9 AT ROW 7.19 COL 2
     "86 -> Hiwa" VIEW-AS TEXT
          SIZE 38 BY .71 AT ROW 1.95 COL 74
...
ON CHOOSE OF BUTTON-13 IN FRAME F-Main /* Stock */
DO:
...
ON CHOOSE OF BUTTON-16 IN FRAME F-Main /* Stock */
DO:
  define var v_filtro as char.
  define var v_articulo as integer.
  define var v_calidad as integer.
...
if integer(sucursal:screen-value in frame F-Main) = 95 or 
  ...
  /************************************************************************************************************/
          ...
          v_filtro = "tambores_industria.id_tipotambor = 2 and " + 
                     ...
                     " tambores_industria.id_sucursal_ubicacion = " + sucursal:screen-value in frame F-Main .                    
...
ON CHOOSE OF BUTTON-20 IN FRAME F-Main /* Listado */
DO:
  define var v_filtro as char.
  define var v_articulo as integer.
  define var v_calidad as integer.
...
if integer(sucursal:screen-value in frame F-Main) = 95 or 
  ...
  run w_calculo_stock_nuevo_tambores_cacha.p (input integer(sucursal:screen-value in frame F-Main)).
  ...
  /************************************************************************************************************/
         ...
         RUN  aderb\_prntrb2(
         "..\industria\reports.prl", /* RB-REPORT-LIBRARY */
         "reporte_stock_rapido_cacha",                    /* RB-REPORT-NAME */
         "",                             /* RB-DB-CONNECTION */
         "O",                             /* RB-INCLUDE-RECORDS */
         v_filtro,                              /* RB-FILTER */
         RB-MEMO-FILE,                              /* RB-MEMO-FILE */
...
ON CHOOSE OF BUTTON-24 IN FRAME F-Main /* Stock x OF */
DO:
  define var v_filtro as char.
  define var v_articulo as integer.
  define var v_calidad as integer.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 16.24 , 102.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY sucursal articulo calidad FILL-IN-10 FILL-IN-11 semana FILL-IN-7 
          FILL-IN-9 FILL-IN-8 nombre_articulo nombre_calidad 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-6 RECT-2 RECT-7 RECT-10 RECT-8 RECT-4 RECT-9 sucursal articulo 
         calidad BUTTON-20 BUTTON-24 semana BUTTON-25 BUTTON-15 BUTTON-13 
         BUTTON-19 BUTTON-17 BUTTON-16 nombre_articulo nombre_calidad 
      WITH FRAME F-Main IN WINDOW W-Win.
