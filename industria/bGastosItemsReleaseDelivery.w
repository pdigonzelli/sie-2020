...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_gasto ~
rowObject.descripcion rowObject.importe_unidad_venta ~
rowObject.importe_por_tonelada rowObject.importe rowObject.importe_total 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_gasto FORMAT ">>>9":U WIDTH 5.2
      rowObject.descripcion FORMAT "X(30)":U
      rowObject.importe_unidad_venta FORMAT "->>>,>>9.9999999":U
            WIDTH 11.8
      rowObject.importe_por_tonelada FORMAT "->>>>>9.9999999":U
      rowObject.importe FORMAT ">>>,>>9.9999":U WIDTH 9.4
      rowObject.importe_total FORMAT "->>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 96 BY 6.67 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dgastositemsreleasedelivery.w"
   Allow: Basic,Browse
   Frames: 1
...
"rowObject.id_gasto" ? ? "integer" ? ? ? ? ? ? no "?" no no "5.2" yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.descripcion
     _FldNameList[3]   > _<SDO>.rowObject.importe_unidad_venta
"rowObject.importe_unidad_venta" ? ? "decimal" ? ? ? ? ? ? no ? no no "11.8" yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.importe_por_tonelada
"rowObject.importe_por_tonelada" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[5]   > _<SDO>.rowObject.importe
"rowObject.importe" ? ? "decimal" ? ? ? ? ? ? no "?" no no "9.4" yes no no "U" "" ""
     _FldNameList[6]   > _<SDO>.rowObject.importe_total
"rowObject.importe_total" ? ? "decimal" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
