...
&Scoped-define INTERNAL-TABLES tabla_entry productos_terminados
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tabla_entry WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH productos_terminados OF tabla_entry NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tabla_entry productos_terminados
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tabla_entry
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tabla_entry.Brix_desde
      tabla_entry.Brix_hasta
      tabla_entry.grados
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.tabla_entry,general.productos_terminados OF general.tabla_entry"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.productos_terminados.descripcion
     _FldNameList[2]   = general.tabla_entry.Brix_desde
     _FldNameList[3]   = general.tabla_entry.Brix_hasta
     _FldNameList[4]   = general.tabla_entry.grados
...
label 'descripcion( productos_terminados ) '
  ...
  menu-item tabla_entry-Brix_desde
label 'Brix_desde( tabla_entry ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tabla_entry.Brix_desde').
                  run set-attribute-list('titulo=Brix Inicial').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tabla_entry.Brix_desde
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tabla_entry-Brix_hasta
label 'Brix_hasta( tabla_entry ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tabla_entry.Brix_hasta').
                  run set-attribute-list('titulo=Brix Final').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tabla_entry.Brix_hasta
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item tabla_entry-grados
label 'grados( tabla_entry ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=tabla_entry.grados').
                  run set-attribute-list('titulo=Grados').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by tabla_entry.grados
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by productos_terminados.descripcion
...
case p:
  WHEN 'tabla_entry.Brix_desde' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  Brix_desde = decimal(valor)  no-lock no-error .
  WHEN 'tabla_entry.Brix_hasta' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  Brix_hasta = decimal(valor)  no-lock no-error .
  WHEN 'tabla_entry.grados' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  grados = decimal(valor)  no-lock no-error .
end.
END PROCEDURE.
