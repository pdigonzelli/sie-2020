...
rowObject.id_tambor rowObject.id_articulo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.id_lote FORMAT ">>>9":U WIDTH 7.2
      rowObject.Anio FORMAT ">>>9":U WIDTH 7.2
      rowObject.id_tambor FORMAT ">>>9":U WIDTH 8.2
      rowObject.id_articulo FORMAT ">>9":U WIDTH 36.6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dtaratamboresindustria.w"
   Allow: Basic,Browse
   Frames: 1
...
"rowObject.id_lote" ? ? "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Anio
"rowObject.Anio" ? ? "integer" ? ? ? ? ? ? no ? no no "7.2" yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.id_tambor
"rowObject.id_tambor" ? ? "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.id_articulo
"rowObject.id_articulo" ? ? "integer" ? ? ? ? ? ? no ? no no "36.6" yes no no "U" "" ""
