...
&Scoped-Define ENABLED-OBJECTS RECT-10 RECT-2 
...
DEFINE VARIABLE h_b_r_clausulas_gastos_item_oe AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_r_clausulas_gastos_item_oe AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-updsav ).
       RUN set-position IN h_cus-updsav ( 1.24 , 9.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_cus-navico ).
       RUN set-position IN h_cus-navico ( 1.24 , 43.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_cus-misc ).
       RUN set-position IN h_cus-misc ( 1.24 , 66.80 ) NO-ERROR.
       RUN set-size IN h_cus-misc ( 1.91 , 21.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_r_clausulas_gastos_item_oe.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_r_clausulas_gastos_item_oe ).
       RUN set-position IN h_b_r_clausulas_gastos_item_oe ( 3.62 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b_r_clausulas_gastos_item_oe ( 6.71 , 92.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_r_clausulas_gastos_item_oe.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_r_clausulas_gastos_item_oe ).
       RUN set-position IN h_v_r_clausulas_gastos_item_oe ( 11.00 , 22.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 49.00 ) */

       /* Links to csmartbrowser h_b_r_clausulas_gastos_item_oe. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_r_clausulas_gastos_item_oe ).

       /* Links to SmartViewer h_v_r_clausulas_gastos_item_oe. */
       RUN add-link IN adm-broker-hdl ( h_b_r_clausulas_gastos_item_oe , 'Record':U , h_v_r_clausulas_gastos_item_oe ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_r_clausulas_gastos_item_oe ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_r_clausulas_gastos_item_oe ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_r_clausulas_gastos_item_oe ,
             h_b_r_clausulas_gastos_item_oe , 'AFTER':U ).
    END. /* Page 0 */
