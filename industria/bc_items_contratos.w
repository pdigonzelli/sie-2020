...
&Scoped-define INTERNAL-TABLES items_contratos destinos
...
items_contratos.semana_entrega items_contratos.cantidad ~
items_contratos.id_destino destinos.descripcion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH items_contratos OF contratos WHERE ~{&KEY-PHRASE} ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH items_contratos OF contratos WHERE ~{&KEY-PHRASE} ~
 ...
 AND items_contratos.pendiente = TRUE NO-LOCK, ~
      EACH destinos OF items_contratos OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table items_contratos destinos
&Scoped-define FIRST-TABLE-IN-QUERY-br_table items_contratos
&Scoped-define SECOND-TABLE-IN-QUERY-br_table destinos
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      items_contratos.semana_entrega FORMAT ">>9":U WIDTH 24.6
      items_contratos.cantidad FORMAT ">>>,>>>,>>9":U
      items_contratos.id_destino COLUMN-LABEL "CodDes" FORMAT ">>>>9":U
            WIDTH 12.4
      destinos.descripcion COLUMN-LABEL "Destinos" FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.items_contratos OF general.contratos,comercial.destinos OF general.items_contratos"
 ...
 AND general.items_contratos.pendiente = TRUE"
     ...
     _FldNameList[2]   > general.items_contratos.semana_entrega
"general.items_contratos.semana_entrega" ? ? "integer" ? ? ? ? ? ? no ? no no "24.6" yes no no "U" "" ""
     _FldNameList[3]   > general.items_contratos.cantidad
"general.items_contratos.cantidad" ? ">>>,>>>,>>9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > general.items_contratos.id_destino
"general.items_contratos.id_destino" "CodDes" ">>>>9" "integer" ? ? ? ? ? ? no ? no no "12.4" yes no no "U" "" ""
     _FldNameList[5]   > comercial.destinos.descripcion
"comercial.destinos.descripcion" "Destinos" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
