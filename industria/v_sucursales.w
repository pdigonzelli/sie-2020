...
ON LEAVE OF sucursales.codigo_dgi IN FRAME F-Main /* Código D.G.I */
DO:
{custom/support/validacion.i}
END.
...
ON LEAVE OF sucursales.pais IN FRAME F-Main /* País */
DO:
{custom/support/validacion.i}
END.
...
ON LEAVE OF sucursales.postal IN FRAME F-Main /* Cód. Postal */
DO:
{custom/support/validacion.i}
END.
...
ON LEAVE OF sucursales.telefono[1] IN FRAME F-Main /* Teléfono[1] */
DO:
{custom/support/validacion.i}
END.
