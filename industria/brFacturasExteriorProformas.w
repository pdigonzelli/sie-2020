...
rowObject.importe rowObject.id_punto_venta rowObject.nro_comp 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      nro_proforma FORMAT ">>>>>9":U
      importe FORMAT ">>>,>>>,>>9.9999":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.importe
     _FldNameList[3]   = _<SDO>.rowObject.id_punto_venta
     _FldNameList[4]   = _<SDO>.rowObject.nro_comp
