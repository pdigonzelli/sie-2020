...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.id_devolucion ~
rowObject.anio_devolucion rowObject.fecha_devolucion rowObject.id_lote ~
rowObject.Anio rowObject.id_articulo rowObject.id_sucursal_ubicacion ~
rowObject.id_sucursal_devolucion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_devolucion FORMAT "->,>>>,>>9":U
      anio_devolucion FORMAT ">>>9":U
      fecha_devolucion FORMAT "99/99/9999":U
      id_lote FORMAT "->,>>>,>>9":U
      Anio FORMAT ">>>,>>9":U
      id_articulo FORMAT ">>>,>>9":U
      id_sucursal_ubicacion FORMAT ">,>>9":U
      id_sucursal_devolucion FORMAT ">>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.id_devolucion
     _FldNameList[2]   = _<SDO>.rowObject.anio_devolucion
     _FldNameList[3]   = _<SDO>.rowObject.fecha_devolucion
     _FldNameList[4]   = _<SDO>.rowObject.id_lote
     _FldNameList[5]   = _<SDO>.rowObject.Anio
     _FldNameList[6]   = _<SDO>.rowObject.id_articulo
     _FldNameList[7]   = _<SDO>.rowObject.id_sucursal_ubicacion
     _FldNameList[8]   = _<SDO>.rowObject.id_sucursal_devolucion
