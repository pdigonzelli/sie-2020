...
&Scoped-Define ENABLED-OBJECTS RECT-19 RECT-15 RECT-2 
...
DEFINE VARIABLE h_b_unidad_medida AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v_unidad_medida AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/b_unidad_medida.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b_unidad_medida ).
       RUN set-position IN h_b_unidad_medida ( 4.33 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.71 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '../industria/v_unidad_medida.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v_unidad_medida ).
       RUN set-position IN h_v_unidad_medida ( 11.86 , 21.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.00 , 39.00 ) */

       /* Links to csmartbrowser h_b_unidad_medida. */
       RUN add-link IN adm-broker-hdl ( h_cus-navico , 'Navigation':U , h_b_unidad_medida ).

       /* Links to SmartViewer h_v_unidad_medida. */
       RUN add-link IN adm-broker-hdl ( h_b_unidad_medida , 'Record':U , h_v_unidad_medida ).
       RUN add-link IN adm-broker-hdl ( h_cus-updsav , 'TableIO':U , h_v_unidad_medida ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b_unidad_medida ,
             h_cus-misc , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v_unidad_medida ,
             h_b_unidad_medida , 'AFTER':U ).
    END. /* Page 0 */
