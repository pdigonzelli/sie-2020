...
&Scoped-define INTERNAL-TABLES productos_terceros proveedores sucursales ~
...
productos_terceros.id_lote proveedores.nombre ~
productos_terminados.descripcion productos_terceros.fecha 
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH productos_terceros WHERE ~{&KEY-PHRASE} NO-LOCK, ~
    ...
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table productos_terceros proveedores ~
sucursales productos_terminados
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      productos_terceros.id_lote FORMAT ">>>,>>9"
      proveedores.nombre FORMAT "x(20)"
      productos_terminados.descripcion FORMAT "x(20)"
      productos_terceros.fecha FORMAT "99/99/99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.productos_terceros,comercial.proveedores OF general.productos_terceros,comercial.sucursales OF general.productos_terceros,general.productos_terminados OF general.productos_terceros"
...
"general.productos_terceros.id_lote" ? ">>>,>>9" "integer" ? ? ? ? ? ? no ?
     _FldNameList[3]   > comercial.proveedores.nombre
"comercial.proveedores.nombre" ? "x(20)" "character" ? ? ? ? ? ? no ?
     _FldNameList[4]   > general.productos_terminados.descripcion
"general.productos_terminados.descripcion" ? "x(20)" "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > general.productos_terceros.fecha
"general.productos_terceros.fecha" ? "99/99/99" "date" ? ? ? ? ? ? no ?
