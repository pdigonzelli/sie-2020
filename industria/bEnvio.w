...
rowObject.id_envio rowObject.Vapor rowObject.origen rowObject.destino ~
rowObject.semana rowObject.id_origen rowObject.id_destino ~
rowObject.id_vapor rowObject.fecha_llegada_destino ~
rowObject.fecha_salida_destino rowObject.fecha_salida_origen 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.id_envio FORMAT ">>>>>9":U
      rowObject.Vapor FORMAT "x(30)":U WIDTH 18.2
      rowObject.origen FORMAT "x(40)":U
      rowObject.destino FORMAT "x(40)":U
      rowObject.semana FORMAT ">9":U
      rowObject.id_origen FORMAT ">>>>>9":U
      rowObject.id_destino FORMAT ">>>>>9":U
      rowObject.id_vapor FORMAT ">>>>>9":U
      rowObject.fecha_llegada_destino FORMAT "99/99/99":U
      rowObject.fecha_salida_destino FORMAT "99/99/99":U
      rowObject.fecha_salida_origen FORMAT "99/99/99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   > _<SDO>.rowObject.id_envio
"rowObject.id_envio" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.Vapor
"rowObject.Vapor" ? ? "character" ? ? ? ? ? ? no ? no no "18.2" yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.origen
"rowObject.origen" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[5]   > _<SDO>.rowObject.destino
"rowObject.destino" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[6]   > _<SDO>.rowObject.semana
"rowObject.semana" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[7]   > _<SDO>.rowObject.id_origen
"rowObject.id_origen" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[8]   > _<SDO>.rowObject.id_destino
"rowObject.id_destino" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[9]   = _<SDO>.rowObject.id_vapor
     _FldNameList[10]   > _<SDO>.rowObject.fecha_llegada_destino
"rowObject.fecha_llegada_destino" ? ? "date" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[11]   = _<SDO>.rowObject.fecha_salida_destino
     _FldNameList[12]   = _<SDO>.rowObject.fecha_salida_origen
