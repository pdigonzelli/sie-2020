...
&Scoped-define INTERNAL-TABLES gastos_seguros

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table gastos_seguros.id_gasto_seguro ~
gastos_seguros.abreviatura gastos_seguros.importe ~
gastos_seguros.fecha_inicio gastos_seguros.fecha_fin 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH gastos_seguros WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table gastos_seguros
&Scoped-define FIRST-TABLE-IN-QUERY-br_table gastos_seguros
...
<FOREIGN-KEYS>
id_gasto_seguro||y|general.gastos_seguros.id_gasto_seguro
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "id_gasto_seguro"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      gastos_seguros.id_gasto_seguro
      gastos_seguros.abreviatura
      gastos_seguros.importe
      gastos_seguros.fecha_inicio
      gastos_seguros.fecha_fin
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "general.gastos_seguros"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = general.gastos_seguros.id_gasto_seguro
     _FldNameList[2]   = general.gastos_seguros.abreviatura
     _FldNameList[3]   = general.gastos_seguros.importe
     _FldNameList[4]   = general.gastos_seguros.fecha_inicio
     _FldNameList[5]   = general.gastos_seguros.fecha_fin
...
define sub-menu Ordena 
  menu-item gastos_seguros-id_gasto_seguro
label 'id_gasto_seguro( gastos_seguros ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_seguros.id_gasto_seguro').
                  run set-attribute-list('titulo=Cod. Gasto Seguro').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_seguros.id_gasto_seguro
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item gastos_seguros-abreviatura
label 'abreviatura( gastos_seguros ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_seguros.abreviatura').
                  run set-attribute-list('titulo=Abreviatura').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_seguros.abreviatura
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item gastos_seguros-importe
label 'importe( gastos_seguros ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_seguros.importe').
                  run set-attribute-list('titulo=Importe').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_seguros.importe
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item gastos_seguros-fecha_inicio
label 'fecha_inicio( gastos_seguros ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_seguros.fecha_inicio').
                  run set-attribute-list('titulo=Fecha Inicio').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_seguros.fecha_inicio
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
  menu-item gastos_seguros-fecha_fin
label 'fecha_fin( gastos_seguros ) '
          triggers: 
              on choose 
                       do:
                  run set-attribute-list('orden=gastos_seguros.fecha_fin').
                  run set-attribute-list('titulo=Fecha Fin').
                  run set-attribute-list('busca= yes').
                  &SCOPE SORTBY-PHRASE  by gastos_seguros.fecha_fin
                  {&OPEN-QUERY-{&BROWSE-NAME}} 
              end.
          end.
&SCOPE SORTBY-PHRASE by gastos_seguros.id_gasto_seguro
...
case p:
  WHEN 'gastos_seguros.id_gasto_seguro' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  id_gasto_seguro = integer(valor)  no-lock no-error .
  WHEN 'gastos_seguros.abreviatura' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  abreviatura begins valor  no-lock no-error .
  WHEN 'gastos_seguros.importe' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  importe = decimal(valor)  no-lock no-error .
  WHEN 'gastos_seguros.fecha_inicio' then  
       find first {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} where  fecha_inicio = date(valor)  no-lock no-error .
  WHEN 'gastos_seguros.fecha_fin' then  
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "id_gasto_seguro" "gastos_seguros" "id_gasto_seguro"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "gastos_seguros"}
