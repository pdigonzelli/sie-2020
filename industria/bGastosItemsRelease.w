...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.NroRelease ~
rowObject.item_release_delivery rowObject.tambores rowObject.id_contrato ~
rowObject.Cliente rowObject.Broker rowObject.Producto rowObject.Destino ~
rowObject.CondicionVta rowObject.Plazos rowObject.Moneda ~
rowObject.UnidadVta rowObject.Peso rowObject.Galones rowObject.Envase ~
rowObject.Calidad 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      NroRelease FORMAT "zzzzz999":U
      item_release_delivery FORMAT "->,>>>,>>9":U
      tambores FORMAT "->,>>>,>>9":U
      id_contrato FORMAT "X(12)":U
      Cliente FORMAT "x(25)":U
      Broker FORMAT "x(20)":U
      Producto FORMAT "x(15)":U
      Destino FORMAT "x(20)":U
      CondicionVta FORMAT "x(15)":U
      Plazos FORMAT "x(15)":U
      Moneda FORMAT "x(10)":U
      UnidadVta FORMAT "x(10)":U
      Peso FORMAT "zzzzz9,99":U
      Galones FORMAT "zzzzz9,99":U
      Envase FORMAT "x(15)":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.NroRelease
     _FldNameList[2]   = _<SDO>.rowObject.item_release_delivery
     _FldNameList[3]   = _<SDO>.rowObject.tambores
     _FldNameList[4]   = _<SDO>.rowObject.id_contrato
     _FldNameList[5]   = _<SDO>.rowObject.Cliente
     _FldNameList[6]   = _<SDO>.rowObject.Broker
     _FldNameList[7]   = _<SDO>.rowObject.Producto
     _FldNameList[8]   = _<SDO>.rowObject.Destino
     _FldNameList[9]   = _<SDO>.rowObject.CondicionVta
     _FldNameList[10]   = _<SDO>.rowObject.Plazos
     _FldNameList[11]   = _<SDO>.rowObject.Moneda
     _FldNameList[12]   = _<SDO>.rowObject.UnidadVta
     _FldNameList[13]   = _<SDO>.rowObject.Peso
     _FldNameList[14]   = _<SDO>.rowObject.Galones
     _FldNameList[15]   = _<SDO>.rowObject.Envase
     _FldNameList[16]   = _<SDO>.rowObject.Calidad
