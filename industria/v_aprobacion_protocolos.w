...
&Scoped-Define ENABLED-FIELDS protocolos.aprobado 
&Scoped-define ENABLED-TABLES protocolos
&Scoped-define FIRST-ENABLED-TABLE protocolos
&Scoped-Define DISPLAYED-FIELDS protocolos.aprobado 
...
DEFINE FRAME F-Main
     protocolos.aprobado AT ROW 1 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.4 BY 1
...
&Scoped-define SELF-NAME protocolos.aprobado
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL protocolos.aprobado V-table-Win
ON LEAVE OF protocolos.aprobado IN FRAME F-Main /* Aprobado */
DO:
...
IF UPPER(protocolos.aprobado:SCREEN-VALUE IN FRAME F-Main) = "SI" THEN DO:
    ASSIGN protocolos.quimico           = "SI" + SUBSTRING(USERID("userdb"),2,9)
           protocolos.fecha_aprobacion  = TODAY.
END.
ELSE DO:
    IF UPPER(protocolos.aprobado:SCREEN-VALUE IN FRAME F-Main) = "NO" THEN DO:
        ASSIGN protocolos.quimico           = "NO" + SUBSTRING(USERID("userdb"),2,9)
               protocolos.fecha_aprobacion  = TODAY.
    END.
END.
END PROCEDURE.
