...
locaciones.descripcion sucursales.abreviatura 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tambores_industria.id_articulo COLUMN-LABEL "CodArt" FORMAT ">>9":U
            WIDTH 9.2
      locaciones.descripcion COLUMN-LABEL "Locacion" FORMAT "x(30)":U
...
"general.tambores_industria.id_articulo" "CodArt" ">>9" "integer" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" ""
     _FldNameList[4]   > general.locaciones.descripcion
"general.locaciones.descripcion" "Locacion" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
