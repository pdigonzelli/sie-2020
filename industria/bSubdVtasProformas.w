...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.nro_proforma ~
rowObject.fecha rowObject.estado rowObject.vencimiento rowObject.id_cliente ~
rowObject.nombre rowObject.transito rowObject.id_punto_venta ~
rowObject.nro_comp 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.nro_proforma COLUMN-LABEL "Proforma" FORMAT ">,>>>,>>9":U
            WIDTH 10.2
      rowObject.fecha FORMAT "99/99/99":U WIDTH 12.2
      rowObject.estado FORMAT "Vigente/Anulado":U WIDTH 12.2
      rowObject.vencimiento FORMAT "99/99/9999":U WIDTH 12.4
      rowObject.id_cliente FORMAT ">>>,>>9":U
      rowObject.nombre FORMAT "x(30)":U WIDTH 41.6
      rowObject.transito FORMAT ">>>,>>9":U
      rowObject.id_punto_venta FORMAT ">>>9":U
      rowObject.nro_comp COLUMN-LABEL "Nro Comp" FORMAT ">>>>>>>9":U
            WIDTH 12.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 142 BY 6.67 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "dsubdvtasproformas.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.nro_proforma
"rowObject.nro_proforma" "Proforma" ? "integer" ? ? ? ? ? ? no "?" no no "10.2" yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.fecha
"rowObject.fecha" ? ? "date" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.estado
"rowObject.estado" ? ? "logical" ? ? ? ? ? ? no ? no no "12.2" yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.vencimiento
"rowObject.vencimiento" ? ? "date" ? ? ? ? ? ? no ? no no "12.4" yes no no "U" "" ""
     _FldNameList[5]   = _<SDO>.rowObject.id_cliente
     _FldNameList[6]   > _<SDO>.rowObject.nombre
"rowObject.nombre" ? ? "character" ? ? ? ? ? ? no ? no no "41.6" yes no no "U" "" ""
     _FldNameList[7]   = _<SDO>.rowObject.transito
     _FldNameList[8]   = _<SDO>.rowObject.id_punto_venta
     _FldNameList[9]   > _<SDO>.rowObject.nro_comp
"rowObject.nro_comp" "Nro Comp" ? "integer" ? ? ? ? ? ? no ? no no "12.4" yes no no "U" "" ""
