...
&Scoped-define FIELDS-IN-QUERY-br_table bultos calibre cert_china ~
codigo_trazabilidad certificado cod_trazabilidad contramarca fecha_ingreso ~
fecha_operativa unidad_productora zona_up renspa nro_certificado 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      bultos FORMAT ">>,>>9":U
      calibre FORMAT "XXX/XX":U
      cert_china FORMAT "X(8)":U
      codigo_trazabilidad FORMAT "X(7)":U
      certificado FORMAT "X(8)":U
      cod_trazabilidad FORMAT "X(12)":U
      contramarca FORMAT "X(4)":U
      fecha_ingreso FORMAT "99/99/99":U
      fecha_operativa FORMAT "99/99/99":U
      unidad_productora FORMAT "X(3)":U
      zona_up FORMAT "x(4)":U
      renspa FORMAT "X(21)":U
      nro_certificado FORMAT ">>>,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "d:\sanmiguel\software\bases\produccion\packing\ditempalletsap.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.bultos
     _FldNameList[2]   = _<SDO>.rowObject.calibre
     _FldNameList[3]   = _<SDO>.rowObject.cert_china
     _FldNameList[4]   = _<SDO>.rowObject.codigo_trazabilidad
     _FldNameList[5]   = _<SDO>.rowObject.certificado
     _FldNameList[6]   = _<SDO>.rowObject.cod_trazabilidad
     _FldNameList[7]   = _<SDO>.rowObject.contramarca
     _FldNameList[8]   = _<SDO>.rowObject.fecha_ingreso
     _FldNameList[9]   = _<SDO>.rowObject.fecha_operativa
     _FldNameList[10]   = _<SDO>.rowObject.unidad_productora
     _FldNameList[11]   = _<SDO>.rowObject.zona_up
     _FldNameList[12]   = _<SDO>.rowObject.renspa
     _FldNameList[13]   = _<SDO>.rowObject.nro_certificado
