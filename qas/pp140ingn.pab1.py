...
#    cparametro = 'SPL,424964,30300010101,,400,KG,1109,PG,LIMON,EUREKA,80A03,LULES,3,UP-TU-0154-003,PINTO,20160315,1,20160315,TT,NOUE,NOUSA,NOCHINA,,'
...
#object.momento2 = momento2
    ...
    result = client.service.SI_OS_PP140ING('PRD300',momento1,momento2,)
