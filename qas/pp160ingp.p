...
DO:
 ...
 /*   RUN PREPARA-CAJAS. */
    ...
    ARCHIVO  = SESSION:TEMP-DIRECTORY + 'P160Q' + CPALLET + '.XML'.
    ARCHIVO1 = SESSION:TEMP-DIRECTORY + 'P160Q' + CPALLET + '.RES'.
    
    RUN EXPORTAXML160.P( ARCHIVO , INPUT TABLE TTPALLET , INPUT TABLE TTPOSICIONPALLET).
