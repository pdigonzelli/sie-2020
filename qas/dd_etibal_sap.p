...
/*                
        DEFINE VAR VLOTESAP AS CHARACTER NO-UNDO.
        DEFINE VAR VCANTENVASES AS INTEGER NO-UNDO.
        
        VLOTESAP     = SUBSTRING(balanza_tickets.cod_barra_sap,12).
        FOR EACH MOVSUCU WHERE movsucu.id_sucursal = 110 AND movsucu.ID_TIPO_MOVSTO = 78 AND ORDEN_ENTREGA_PROCESADO = STRING(balanza_tickets.ID_PESADA, '9999999999'), FIRST ITEMS_STOCK OF MOVSUCU 
            WHERE items_stock.orden_entrega_sap = VLOTESAP NO-LOCK.
                VCANTENVASES = items_stock.cantidad1 / 20.
        END.        
*/                        
