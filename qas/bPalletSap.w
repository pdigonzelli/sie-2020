...
&Scoped-define FIELDS-IN-QUERY-br_table id_suc_trabajo id_pallet ~
id_pallet_sap fecha_operativa fecha_prod id_estado_pallet id_packing ~
id_tipo_pallet pallet_senasa bultos 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      id_suc_trabajo FORMAT ">>9":U
      id_pallet FORMAT ">>,>>>,>>9":U
      id_pallet_sap FORMAT "x(20)":U
      fecha_operativa FORMAT "99/99/99":U
      fecha_prod FORMAT "99/99/99":U
      id_estado_pallet FORMAT ">>9":U
      id_packing FORMAT ">>9":U
      id_tipo_pallet FORMAT ">>9":U
      pallet_senasa FORMAT "X(18)":U
      bultos FORMAT ">>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "d:\sanmiguel\software\bases\produccion\packing\dpalletssap.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.id_suc_trabajo
"id_suc_trabajo" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.id_pallet
"id_pallet" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.id_pallet_sap
"id_pallet_sap" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = _<SDO>.rowObject.fecha_operativa
     _FldNameList[5]   = _<SDO>.rowObject.fecha_prod
     _FldNameList[6]   = _<SDO>.rowObject.id_estado_pallet
     _FldNameList[7]   > _<SDO>.rowObject.id_packing
"id_packing" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   = _<SDO>.rowObject.id_tipo_pallet
     _FldNameList[9]   > _<SDO>.rowObject.pallet_senasa
"pallet_senasa" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > _<SDO>.rowObject.bultos
"bultos" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
