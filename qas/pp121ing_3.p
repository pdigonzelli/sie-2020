...
PROCEDURE CREATABLATEMPORAL.
    ...
    FOR EACH POSICION.
          ...
          CASE SUBSTRING(POSICION.PUNIDAD,2,1):
            WHEN 'A' THEN IUNIDAD = 100 + INTEGER(SUBSTRING(PUNIDAD,3,1)).
            WHEN 'B' THEN IUNIDAD = 110 + INTEGER(SUBSTRING(PUNIDAD,3,1)).
            WHEN 'C' THEN IUNIDAD = 120 + INTEGER(SUBSTRING(PUNIDAD,3,1)).
            WHEN 'D' THEN IUNIDAD = 130 + INTEGER(SUBSTRING(PUNIDAD,3,1)).
            WHEN 'E' THEN IUNIDAD = 140 + INTEGER(SUBSTRING(PUNIDAD,3,1)).
            WHEN 'F' THEN IUNIDAD = 150 + INTEGER(SUBSTRING(PUNIDAD,3,1)).
            WHEN 'G' THEN IUNIDAD = 160 + INTEGER(SUBSTRING(PUNIDAD,3,1)).
            OTHERWISE IUNIDAD = INTEGER(SUBSTRING(PUNIDAD,2)).
          END.        
        ISERIE = ISERIE + 1.
        ...
        FOR EACH CALIBRE-TEMPORAL.
            ...
            DO:
                ...
                {assignposicion_2.i}
            END.
            POSICION-TEMPORAL.PCANTIDAD = INTEGER(INTEGER(POSICION.PCANTIDADORDEN) * CALIBRE-TEMPORAL.PPORCENTAJE / IUNIDAD).
            ITOT1 = ITOT1 + POSICION-TEMPORAL.PCANTIDAD.
        END.
        FIND LAST POSICION-TEMPORAL NO-ERROR.
        POSICION-TEMPORAL.PCANTIDAD = POSICION-TEMPORAL.PCANTIDAD   + INTEGER(POSICION.PCANTIDADORDEN) / IUNIDAD - ITOT1.
    END.
    MESSAGE 'TABLA TEMPORAL'. 
END PROCEDURE.
