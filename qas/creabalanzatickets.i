...
/* ***************************  Main Block  *************************** */
        ...
        ASSIGN 
            ...
            balanza_tickets.nro_partida_serial      = VPARTIDASERIALENTREGA
            balanza_tickets.nro_partida             = VPARTIDAENTREGA
       ...
       ASSIGN
            balanza_tickets.id_lote_senasa          = IF vunioneuropea  THEN vlotesenasa ELSE 0
            balanza_tickets.id_lote                 = vlote
            balanza_tickets.id_finca_senasa         = IF vunioneuropea THEN  vfincasenasa ELSE 0
      ...
      ASSIGN
            ...
            balanza_tickets.especieSap              = PSESPECIE
            balanza_tickets.variedadSap             = PSVARIEDAD
            balanza_tickets.fincasap                = PSFINCA
            balanza_tickets.usa                     = vusa
            balanza_tickets.id_mercado              = IF AVAILABLE mercados THEN mercados.id_mercado ELSE 0.
            
            balanza_tickets.nombrePerfil            = 'SM'.
