...
ARCHIVOL = SESSION:TEMP-DIRECTORY + 'QL' +  STRING(ISUCTRABAJO) + STRING(IPALLET).
...
/*               TTPOSICIONPALLET.orden_mts = /* '000300000129'*/ ENTRY(3,ENTRY(2,ENTRY(1,items_stock.documento_sap,';'),'|'),'&') */
    ...
    ARCHIVO  = SESSION:TEMP-DIRECTORY + 'PQ' + STRING(TTPALLET.pallet_id) + '.XML'.
    ARCHIVO1 = SESSION:TEMP-DIRECTORY + 'PQ' + STRING(TTPALLET.pallet_id) + '.RES'.
