...
/*
        ...
        IF pallets.id_suc_trabajo = 97 AND /* (PALLETS.TIPO_PROCESO = 'V' OR PALLETS.TIPO_PROCESO = 'Q' OR PALLETS.TIPO_PROCESO = 'W') */  pallets.id_caract = 2 THEN
            XOMTS = '10004464'.
        ELSE
            XOMTS = '10004462'.
        ...
        IF productos_terminados.ID_ARTICULO = 3 THEN
        DO:
             XOMTS = '10004466'.
        END.
