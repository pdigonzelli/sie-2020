...
/********************************************/
/* Valida Mercado - Tipo de Proceso - Color */
/********************************************/
...
/****************************/
/*
RUN declaraPalletSapNuevo(xSucTrabajo , xpallet) NO-ERROR.
IF ERROR-STATUS:ERROR THEN
    MESSAGE 'Error en interface SAP. ' SKIP
...
MESSAGE 'El pallet se grabo con' SKIP
    'numero de Lote SAP: ' SKIP 
    STRING (tpallets.id_pallet_sap,"99999999999999999999")  
