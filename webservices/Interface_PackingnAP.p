...
MESSAGE 'EJECUTANDO INTERFACE_PACKINGAP' XSUCURSAL XTIPOMOV XSUCENVIO XNRO.
...
/*        PIMATERIALSAP = SUBSTRING(balanza_tickets.cod_barra_sap,1,11) */
    ...
    CPARAMETROS =   PISUCURSAL + ',' + STRING(items_stock.NRO_PARTIDA) + ',' + TRIM(PIMATERIALSAP) + ',' + /*PILOTESAP*/ '' + ',' + STRING(ITEMS_STOCK.PESO) + ',KG,' + STRING(PIALMACEN) 
        ...
        + ',' +  /*origenes.id_origen_sap*/ balanza_tickets.FINCASAP + ',' + balanza_tickets.loteagricolaSap + ',' + XUNIDPROD + ',' + colores.DESCRIPCION + ',' + DFECHA + ',' + STRING(ICANTIDAD)
