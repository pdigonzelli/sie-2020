...
PROCEDURE declaraPalletSapNuevo.
    ...
    RUN declaraPalletL.p (bpallets.id_suc_trabajo , bpallets.id_pallet , 'PRD' , OUTPUT cStatus , OUTPUT CPALLET) NO-ERROR.
...
PROCEDURE anulaPalletSap.
    ...
    RUN anulaPallet.P ( PALLETS.ID_PALLET_SAP , 'PRD' , OUTPUT cStatus) NO-ERROR.
